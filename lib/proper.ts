...
export class Section {
	...
	constructor(id: string, body: string[] | null = null, label: string | null = null) {
		this.id = id;
		this.body = body || [];
		this.label = label || id;
	}
		...
		for (const commemoration of commemorations) {
			if (commemoration) {
				...
				for (const [commemoratedSectionName, sourceSectionName] of [
					...
					commemoratedSection.label = this.commemorationsNamesTranslations[commemoratedSectionName];
