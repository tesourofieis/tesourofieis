...
export const THIS_DIR = '/lib'; // Replace with the actual path
export const RESOURCES_DIR = `${THIS_DIR}/../resources`;
export const DIVOFF_DIR = `${RESOURCES_DIR}/divinum-officium`;
export const CUSTOM_DIVOFF_DIR = `${RESOURCES_DIR}/divinum-officium-custom`;
export const PROPERS_DIR = `${RESOURCES_DIR}/propers`;
export const SUPPLEMENT_DIR = `${RESOURCES_DIR}/supplement`;

export const SUNDAY = 0;
export const LANGUAGE_LATIN = 'Latin';
export const LANGUAGE = 'Portugues';
...
export const TYPE_TEMPORA = 'tempora';
export const TYPE_SANCTI = 'sancti';
export const PREFATIO_COMMUNIS = 'Communis';
export const PREFATIO_TRINITATE = 'Trinitate';
export const PREFATIO_PASCHAL = 'Pasch';
export const PREFATIO_APOSTOLIS = 'Apostolis';
export const PREFATIO_NAT = 'Nat';
export const PREFATIO_EPI = 'Epi';
export const PREFATIO_OMIT = 'prefatio_omit';
export const PREFATIO_LENT = 'Quad';
export const PREFATIO_JOSEPH = 'Joseph';
export const PREFATIO_ASCENSION = 'Asc';
export const ASTERISK = '*';

export const PATTERN_TEMPORA = /^tempora:.*/;
export const PATTERN_SANCTI_CLASS_3_LOCAL = new RegExp(
	`^sancti:.*(?:${Object.keys(LANGUAGES).join('|')}):3:\\w$`
);
export const PATTERN_ADVENT = /^tempora:Adv\d/;
export const PATTERN_ADVENT_SUNDAY = /^tempora:Adv\d-0/;
export const PATTERN_ADVENT_FERIA = /tempora:Adv\d-[1-6]/;
export const PATTERN_ADVENT_FERIA_BETWEEN_17_AND_23 = /tempora:Adv\d-[1-6]:2/;
export const PATTERN_ADVENT_FERIA_BEFORE_17 = /tempora:Adv\d-[1-6]:3/;
export const PATTERN_POST_EPIPHANY_SUNDAY = /^tempora:Epi\d-0/;
export const PATTERN_PRE_LENTEN = /^tempora:Quadp\d/;
export const PATTERN_LENT = /^tempora:Quad(p3-[3-6]|\d)/;
export const PATTERN_LENT_PREFATIO = /^tempora:Quad(p3-[3-6]|[1-4]-\d)/;
export const PATTERN_EASTER = /^tempora:Pasc\d/;
export const PATTERN_EASTER_PREFATIO = /^tempora:Pasc([0-4]|5-0|5-1|5-2|5-3)/;
export const PATTERN_ASCENSION_PREFATIO = /^tempora:Pasc(5-4|5-5|5-6|6-0|6-1|6-2|6-3|6-4|6-5)/;
export const PATTERN_LENT_SUNDAY = /^tempora:Quad\d-0.*/;
export const PATTERN_TEMPORA_SUNDAY = /^tempora:.*/;
export const PATTERN_TEMPORA_SUNDAY_CLASS_1 = /^tempora:.*:1:.*/;
export const PATTERN_TEMPORA_SUNDAY_CLASS_2 = /^tempora:(.*:2|Nat1-0).*/;
export const PATTERN_TEMPORA_CLASS_1 = /^tempora:.*:1:.*/;
export const PATTERN_TEMPORA_CLASS_2 = /^tempora:.*:2:.*/;
export const PATTERN_TEMPORA_CLASS_3 = /^tempora:.*:3:.*/;
export const PATTERN_TEMPORA_CLASS_4 = /^tempora:.*:4:.*/;
export const PATTERN_SANCTI = /^sancti:.*/;
export const PATTERN_SANCTI_CLASS_1 = /^sancti:.*:1:.*/;
export const PATTERN_SANCTI_CLASS_2 = /^sancti:.*:2:.*/;
export const PATTERN_SANCTI_CLASS_3 = /^sancti:.*:3:.*/;
export const PATTERN_SANCTI_CLASS_4 = /^sancti:.*:4:.*/;
export const PATTERN_SANCTI_CLASS_1_OR_2 = /^sancti:.*:[12]:.*/;
export const PATTERN_CLASS_1 = /^[a-z]+:.*:1:.*/;
export const PATTERN_CLASS_2 = /^[a-z]+:.*:2:.*/;
export const PATTERN_CLASS_3 = /^[a-z]+:.*:3:.*/;
export const PATTERN_COMMEMORATION = 'wspomnienie';
export const PATTERN_ALLELUIA = /allel[uú][ij]a.*/i;
export const PATTERN_TRACT = /.*tra[ck]t.*/i;

export const INTROIT = 'Introitus';
export const ORATIO = 'Oratio';
export const LECTIO = 'Lectio';
export const TRACTUS = 'Tractus';
export const GRADUALE = 'Graduale';
export const GRADUALE_PASCHAL = 'GradualeP';
export const EVANGELIUM = 'Evangelium';
export const OFFERTORIUM = 'Offertorium';
export const SECRETA = 'Secreta';
export const COMMUNIO = 'Communio';
export const POSTCOMMUNIO = 'Postcommunio';
export const COMMEMORATION = 'Commemoratio';
export const COMMEMORATED_ORATIO = 'Commemoratio Oratio';
export const COMMEMORATED_SECRETA = 'Commemoratio Secreta';
export const COMMEMORATED_POSTCOMMUNIO = 'Commemoratio Postcommunio';
export const PREFATIO = 'Prefatio';
...
export const EXCLUDE_SECTIONS: ExcludeSection[] = [
	{ id: SANCTI_06_25, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_06_26, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_06_30, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_07_01, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_07_05, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_08_17, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_08_19, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_08_20, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_08_21, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_09_14, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_12_07, sections: COMMEMORATION_SECTIONS },
	{ id: SANCTI_12_11, sections: COMMEMORATION_SECTIONS },
	{ id: TEMPORA_EPI1_0, sections: COMMEMORATION_SECTIONS },
	{ id: TEMPORA_PENT02_0, sections: COMMEMORATION_SECTIONS },
	{ id: TEMPORA_PENT03_0, sections: COMMEMORATION_SECTIONS },
	{ id: TEMPORA_PASC5_3, sections: COMMEMORATION_SECTIONS },
	{ id: TEMPORA_PASC6_0, sections: COMMEMORATION_SECTIONS },
	{ id: TEMPORA_PENT02_0, sections: ['Sequentia'] },
];

// EXCLUDE_SECTIONS organized by section ID
export const EXCLUDE_SECTIONS_IDX: { [section: string]: Set<string> } = {};
for (const { id, sections } of EXCLUDE_SECTIONS) {
	for (const section of sections) {
		if (!EXCLUDE_SECTIONS_IDX[section]) {
			EXCLUDE_SECTIONS_IDX[section] = new Set();
		}
		EXCLUDE_SECTIONS_IDX[section].add(id);
	}
}
...
export const REFERENCE_REGEX = /^@([\w/\-]*):?([^:]*)[: ]*(.*)/;
...
export const TITLES: Record<string, string> = {
	...
	[SANCTI_01_27]: 'S. Joannis Chrysostomi Episcopi Confessoris Ecclesiæ Doctoris',
	...
	[SANCTI_05_09]: 'S. Gregorii Nazianzeni Episcopi Confessoris Ecclesiæ Doctoris',
	[SANCTI_05_10]: 'S. Antonii Episcopi Confessoris',
	[SANCTI_05_12]: 'Ss. Nerei, Achillei et Domitillæ Virginis atque Pancratii Martyrum',
	[SANCTI_05_13]: 'S. Roberti Bellarmino Episcopi Confessoris et Ecclesiæ Doctoris',
	...
	[SANCTI_07_10]: 'Ss. Septem Fratrum Martyrum, ac Rufinæ et Secundæ Virginum et Martyrum',
	...
	[SANCTI_08_02]: 'S. Alfonsi Mariæ de Ligorio Episcopi Confessoris et Ecclesiæ Doctoris',
	...
	[SANCTI_11_02_1]: 'In Commemoratione Omnium Fidelium Defunctorum Ad primam Missam',
	[SANCTI_11_02_2]: 'In Commemoratione Omnium Fidelium Defunctorum Ad secundam Missam',
	[SANCTI_11_02_3]: 'In Commemoratione Omnium Fidelium Defunctorum Ad tertiam Missam',
	...
	[SANCTI_12_04]: 'S. Petri Chrysologi Episcopi Confessoris et Ecclesiæ Doctoris',
	...
	[VOTIVE_JESUSETERNALPRIEST]: 'Missa de D. N. Iesu Christo summo et aeterno Sacerdote',
...
export const EMBER_DAYS_SEPTEMBER = [TEMPORA_PENT_3, '', TEMPORA_PENT_5, TEMPORA_PENT_6];
...
export const TITLES_PT: Record<string, string> = {
	...
	[TEMPORA_QUAD1_3]: 'Quarta-feira da 1ª Semana da Quaresma, Têmporas da Primavera',
	...
	[SANCTI_02_09]: 'S. Cirilo de Alexandria, Bispo, Confessor e Doutor da Igreja',
	...
	[SANCTI_05_09]: 'S. Gregório de Nazianzeno, Bispo, Confessor e Doutor da Igreja',
	...
	[SANCTI_07_10]: 'Os Sete Irmãos Mártires e S.S. Rufina e Secunda, Virgens e Mártires',
	...
	[VOTIVE_JESUSETERNALPRIEST]: 'Our Lord Jesus Christ, Supreme and Eternal Priest',
