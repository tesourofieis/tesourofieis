      ...
      <ScrollView>
        <View className="docs">
          ...
          <Language>
            ...
            <Text className="vernacular">
              Mão direita do Pai, pedra angular, caminho da salvação, porta do
              céu: lavai as manchas do nosso pecado.
            </Text>
            <Text className="latin">
            ...
            <Text className="vernacular">
              Nós Vos confessamos os pecados cometidos, com coração arrependido
              Vos manifestamos os ocultos: que vossa Misericórdia perdoe, ó
              Redentor.
            </Text>
            <Text className="latin">
            ...
            <Text className="vernacular">
              ...
              pecadores, por falsas testemunhas: conservai, ó Cristo, aqueles
              que salvastes!
            </Text>
          </Language>
