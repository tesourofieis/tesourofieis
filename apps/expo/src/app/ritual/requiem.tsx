    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">N.</Text> que mandastes sair deste mundo:
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          serva) <Text className="vernacular">N.</Text>, em favor da qual Vos
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          servo (ou vossa serva) <Text className="vernacular">N.</Text>, que
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          serva) <Text className="vernacular">N.</Text>, cujo... (terceiro ou
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">N.</Text>, a fim de que, purificada com
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">N.</Text>, a fim de que, se ainda está
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          vossa serva <Text className="vernacular">N.</Text>), de cujo dia da
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          servo (ou vossa serva) <Text className="vernacular">N.</Text>, cujo
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          serva) <Text className="vernacular">N.</Text>, cujo aniversário da sua
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>E alcancem a bem-aventurança da
          luz eterna.
        </Text>
      </Language>
