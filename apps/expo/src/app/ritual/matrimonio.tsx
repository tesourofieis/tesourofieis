...
export default function PageMatrimonio() {
  return (
    <div className="docs">
      <h1>Matrimónio</h1>
      Os noivos, tendo entrado na igreja e depois de haverem feito oração diante
      do Altar do Santíssimo Sacramento dirigem-se para o Altar onde será
      celebrado o Matrimónio, ficando o noivo à direita da noiva, com a face
      para o Altar, e aguardando a chegada do Sacerdote. Se os noivos usarem
      luvas devem tirá-las. As testemunhas do Matrimónio tomarão lugar ao lado
      ou atrás dos noivos. Tendo chegado o Sacerdote, convenientemente
      ...
      ℣. <span className="text-red-500">N.</span> quereis receber{" "}
      <span className="text-red-500">N.</span>, aqui presente, como vossa
      legítima esposa, segundo o rito da Santa Madre Igreja?
      <span className="text-red-500">℟.</span> Quero! E logo, dirigindo-se à
      noiva, interroga-a também: ℣. <span className="text-red-500">N.</span>{" "}
      quereis receber <span className="text-red-500">N.</span>, aqui presente,
      como vossa legítima esposo, segundo o rito da Santa Madre Igreja?
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> et Fílii, et Spíritus
          Sancti.
        </p>
        <p>
          Eu vos uno em Matrimónio, em Nome do Pai, e do Filho{" "}
          <span className="cross text-red-500">✠</span>, e do Espírito Santo.
        </p>
        <p>
      ...
      <div className="side-by-side">
        ...
        <p>
          Benedic, <span className="cross text-red-500">✠</span> Dómine, ánnulum
          hunc, quem nos in tuo nómine benedícimus,{" "}
          <span className="cross text-red-500">✠</span> ut quæ eum gestáverit,
        ...
        <p>
          Abençoai, <span className="cross text-red-500">✠</span> Senhor, este
          anel, que nós benzemos <span className="cross text-red-500">✠</span>{" "}
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> A templo sancto tuo, quod est
          in Jerúsalem.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Do vosso templo Santo, que é
        ...
        <p>
          <span className="text-red-500">℟.</span> Que esperam em Vós, ó Deus.
        </p>
        ...
        <p>
          <span className="text-red-500">℟.</span> E de Sião, amparai-os.
        </p>
      ...
      <div className="side-by-side">
        <p>
          ...
          Allelúja, allelúja.) <em>Ps. 127, 1</em> Beáti omnes, qui timent
          Dóminum: qui ámbulant in viis ejus. ℣. Gloria Patri...
        </p>
        <p>
          ...
          louvem plenamente. (T. P. Aleluia, aleluia.) <em>Sl. 127, 1</em>{" "}
      ...
      <div className="side-by-side">
        ...
        <p>
          A vossa esposa será como uma vinha fecunda no seio da vossa casa: ℣. E
          os vossos filhos como rebentos de oliveira, em torno da vossa mesa.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 19, 3</em> Mittat vobis Dóminus
          auxílium de sancto: et de Sion tueátur vos. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Ps. 19, 3</em> Que a graça do Senhor desça do
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          abençoe lá de Sião, e possais gozar a felicidade de Jerusalém todos os
          dias da vossa vida. ℣. E ver os filhos dos vossos filhos e a paz em
          Israel.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 19, 3</em> Mittat vobis Dóminus
          auxílium de sancto: et de Sion tueátur vos. Allelúja. ℣.{" "}
          <em>Ps. 133, 3</em> Benedícat vobis Dóminus ex Sion: qui fecit cœlum
          et terram. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 19, 3</em> Que a graça do Senhor desça do
          seu santuário e de Sião e vos socorra e proteja. Aleluia. ℣.{" "}
          <em>Sl. 133, 3</em> Que o Senhor, que criou o céu e a terra, vos
          abençoe lá de Sião. Aleluia.
        </p>
      </div>
      <h2>Evangelho</h2>
      <em>Mt. 19, 3-6</em>
