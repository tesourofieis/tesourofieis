    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> dic nostræ conversatióni:
        ...
        <Text className="vernacular">
          ...
          abençoai <Text className="cross"> ✠ </Text> o nosso ministério.
        ...
        <Text className="latin">
          ...
          bene <Text className="cross"> ✠ </Text> dicat hoc tabernáculum, et
        ...
        <Text className="vernacular">
          ...
          bênçãos <Text className="cross"> ✠ </Text> esta casa e todos aqueles
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="cross"> ✠ </Text> Santo, pela imposição das nossas
      ...
      <Language>
        ...
        <Text className="vernacular">
          Em virtude desta santa Unção <Text className="cross"> ✠ </Text>, que o
      ...
      <Language>
        ...
        <Text className="latin">
          Pater noster <Text className="latin">secreto usque ad</Text> Pai Nosso{" "}
          <Text className="em">Em silêncio até</Text>
        </Text>
        <Text className="vernacular">
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Mitte ei, Dómine, auxílium de
          sancto.
        </Text>
        <Text className="latin">
        ...
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Sede, Senhor, a sua fortaleza.
        </Text>
        <Text className="vernacular">
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Nihil profíciat inimícus in eo
          (ea).
        </Text>
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Que o inimigo não tenha poder
          algum nele.
        </Text>
        <Text className="vernacular">
        ...
        <Text className="latin">
          <Text className="response"> ℟. </Text> E que o Filho da iniquidade não
          possa prejudicá-lo.
        </Text>
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Dómine, exáudi oratiónem meam.
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">N.</Text>, que sucumbe sob a enfermidade
