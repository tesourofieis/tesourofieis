  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Para alcançar a vida eterna.
        </Text>
        <Text className="latin">
          <Text className="latin">Sac.</Text> Si ígitur vis ad vitam íngredi,
        ...
        <Text className="vernacular">
          <Text className="vernacular">Sac.</Text> Se, portanto, queres alcançar
      ...
      <Language>
        <Text className="latin">
          Accipe signum Crucis tam in fron <Text className="cross"> ✠ </Text>{" "}
          te, quam in cor <Text className="cross"> ✠ </Text> de, sume fidem
          cæléstium præceptórum: et talis esto móribus, ut templum Dei jam esse
          possis.
        </Text>
        <Text className="vernacular">
          Recebe o sinal da Cruz, na fronte <Text className="cross"> ✠ </Text> e
          no coração <Text className="cross"> ✠ </Text> ; abraça a fé nos
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          serva) <Text className="vernacular">N.</Text>, que Vos dignastes
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> Patris omnipoténtis, et in caritáte
          Dómini nostri Jesu <Text className="cross"> ✠ </Text> Christi, et in
          virtúte Spíritus <Text className="cross"> ✠ </Text> Sancti. Exorcízo
          te per Deum <Text className="cross"> ✠ </Text> vivum, per Deum{" "}
          <Text className="cross"> ✠ </Text> verum, per Deum{" "}
          <Text className="cross"> ✠ </Text> sanctum, per Deum{" "}
          <Text className="cross"> ✠ </Text> qui te ad tutélam humáni géneris
          ...
          <Text className="cross"> ✠ </Text> fices, et benedicéndo bene{" "}
          <Text className="cross"> ✠ </Text> dícas, ut fiat ómnibus
        ...
        <Text className="vernacular">
          ...
          nosso Senhor Jesus <Text className="cross"> ✠ </Text> Cristo, e com o
          poder do Espírito <Text className="cross"> ✠ </Text> Santo. Eu te
          exorcizo em Nome do span <Text className="cross"> ✠ </Text> vivo, do
          Deus <Text className="cross"> ✠ </Text> verdadeiro, do Deus{" "}
          <Text className="cross"> ✠ </Text> santo, do Deus{" "}
          ...
          Deus, Vos rogamos que santifiqueis <Text className="cross"> ✠ </Text>{" "}
          e abençoeis <Text className="cross"> ✠ </Text> esta criatura de sal,
      ...
      <Language>
        <Text className="latin">
          <Text className="latin">N.</Text> Accipe sal sapiéntiæ: propitiátio
          sit tibi in vitam ætérnam.
        </Text>
        <Text className="vernacular">
          <Text className="vernacular">N.</Text> Recebe o sal da sabedoria; que
      ...
      <Language>
        <Text className="latin">
          Et hoc signum sanctæ Cru <Text className="cross"> ✠ </Text> cis, quod
        ...
        <Text className="vernacular">
          ...
          <Text className="cross"> ✠ </Text> da santa Cruz que imprimimos na sua
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          (ou serva) <Text className="vernacular">N.</Text>, a fim de que Vos
      ...
      <Language>
        <Text className="latin">
          <Text className="latin">N.</Text> Ingrédere in templum Dei, ut hábeas
          partem cum Christo in vitam ætérnam.
        </Text>
        <Text className="vernacular">
          <Text className="vernacular">N.</Text> Entra no Templo de Deus, a fim
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> Patris omnipoténtis, et in nómine
        ...
        <Text className="vernacular">
          ...
          <Text className="cross"> ✠ </Text> Pai omnipotente, e em nome de Jesus{" "}
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> óleo salútis in Christo Jesu Dómino
      ...
      <Language>
        ...
        <Text className="latin">
          <Text className="latin">Sac.</Text> Credis in Jesum Christum, Fílium
        ...
        <Text className="vernacular">
          <Text className="vernacular">Sac.</Text> Crês no Espírito Santo, na
      ...
      <Language>
        ...
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> Chrísmate salútis in eódem Christo
        ...
        <Text className="vernacular">
          ...
          salvação <Text className="cross"> ✠ </Text> para a vida eterna, em o
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="vernacular">Sac.</Text> Recebe a Veste branca, a qual
