  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          <Typography className="latin">Sac.</Typography> Si ígitur vis ad vitam íngredi,
          serva mandáta. Díliges Dóminum Deum tuum ex toto corde tuo, et ex tota
          ánima tua, et ex tota mente tua, et próximum tuum sicut teípsum.
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">Sac.</Typography> Se, portanto, queres alcançar
          a vida eterna, observa os Mandamentos. Amarás o Senhor, teu Deus, com
          todo teu coração, com toda tua alma e com toda tua inteligência, e
          amarás o próximo como a ti próprio.
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          Accipe signum Crucis tam in fron <Typography className="cross"> ✠ </Typography>{" "}
          te, quam in cor <Typography className="cross"> ✠ </Typography> de, sume fidem
          cæléstium præceptórum: et talis esto móribus, ut templum Dei jam esse
          possis.
        </Typography>
        <Typography className="vernacular">
          Recebe o sinal da Cruz, na fronte <Typography className="cross"> ✠ </Typography> e
          no coração <Typography className="cross"> ✠ </Typography> ; abraça a fé nos
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          <Typography className="text-red-500">N.</Typography>) crucis Domínicæ impressióne
        ...
        <Typography className="vernacular">
          ...
          <Typography className="text-red-500">N.</Typography>) que acaba de ser assinalado
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          <Typography className="text-red-500">N.</Typography>) quem (quam) ad rudiménta
        ...
        <Typography className="vernacular">
          ...
          serva) <Typography className="vernacular">N.</Typography>, que Vos dignastes
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="cross"> ✠ </Typography> Patris omnipoténtis, et in caritáte
          Dómini nostri Jesu <Typography className="cross"> ✠ </Typography> Christi, et in
          virtúte Spíritus <Typography className="cross"> ✠ </Typography> Sancti. Exorcízo
          te per Deum <Typography className="cross"> ✠ </Typography> vivum, per Deum{" "}
          ...
          procreávit, et pópulo veniénti ad credulitátem per servos suos
          consecrári præcépit, ut in nómine sanctæ Trinitátis efficiáris
          salutáre sacraméntum ad effugándum inimícum. Proínde rogámus te,
          Dómine Deus noster, ut hanc creatúram salis sanctificándo sanctí{" "}
          <Typography className="cross"> ✠ </Typography> fices, et benedicéndo bene{" "}
          <Typography className="cross"> ✠ </Typography> dícas, ut fiat ómnibus
          accipiéntibus perfécta medicína, pérmanens in viscéribus eórum, in
          nómine ejúsdem Dómini nostri Jesu Christi, qui ventúrus est judicáre
          vivos et mórtuos, et sæculum per ignem.
        </Typography>
        <Typography className="vernacular">
          Eu te exorcizo, criatura de sal, em Nome de Deus{" "}
          <Typography className="cross"> ✠ </Typography> Pai omnipotente, na caridade de
          nosso Senhor Jesus <Typography className="cross"> ✠ </Typography> Cristo, e com o
          poder do Espírito <Typography className="cross"> ✠ </Typography> Santo. Eu te
          exorcizo em Nome do span <Typography className="cross"> ✠ </Typography> vivo, do
          Deus <Typography className="cross"> ✠ </Typography> verdadeiro, do Deus{" "}
          <Typography className="cross"> ✠ </Typography> santo, do Deus{" "}
          <Typography className="cross"> ✠ </Typography> que te criou para proveito do
          género humano, e ordenou aos seus servos te consagrassem para o povo
          chamado à Fé, a fim de que em Nome da Santíssima Trindade possas ser
          instrumento salutar para afugentar o inimigo. Por isso, Senhor, nosso
          Deus, Vos rogamos que santifiqueis <Typography className="cross"> ✠ </Typography>{" "}
          e abençoeis <Typography className="cross"> ✠ </Typography> esta criatura de sal,
      ...
      <Language>
        <Typography className="latin">
          <Typography className="latin">N.</Typography> Accipe sal sapiéntiæ: propitiátio
          sit tibi in vitam ætérnam.
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">N.</Typography> Recebe o sal da sabedoria; que
          ele te seja propício para a vida eterna.
        </Typography>
        <Typography className="latin">
          <Typography className="response"> ℟. </Typography> Amen.
        </Typography>
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          exorámus, ut hunc fámulum tuum <Typography className="latin">N.</Typography> (hanc
          fámulam tuam
          <Typography className="text-red-500">N.</Typography>) respícere dignéris
        ...
        <Typography className="vernacular">
          ...
          <Typography className="text-red-500">N.</Typography>) que, que havendo provado
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="cross"> ✠ </Typography> Sancti, ut éxeas, et recédas ab hoc
          fámulo (hac fámula) Dei <Typography className="text-red-500">N.</Typography>: Ipse
        ...
        <Typography className="vernacular">
          ...
          <Typography className="cross"> ✠ </Typography> Santo, eu te exorcizo, ó espírito
          impuro, a fim de que saias e te afastes deste servo (ou serva) de
          Deus, <Typography className="text-red-500">N.</Typography> Quem isto te ordena, ó
        ...
        <Typography className="latin">
          ...
          <Typography className="text-red-500">N.</Typography>, quia istum (istam) sibi
        ...
        <Typography className="vernacular">
          ...
          <Typography className="text-red-500">N.</Typography>, porque Deus assim manda, e
      ...
      <Language>
        <Typography className="latin">
          Et hoc signum sanctæ Cru <Typography className="cross"> ✠ </Typography> cis, quod
          nos fronti ejus damus, tu, maledícte diábole, numquam áudeas violáre.
          Per eúmdem Christum Dóminum nostrum.
        </Typography>
        <Typography className="vernacular">
          E te não atrevas nunca, ó demónio maldito, a violar este sinal{" "}
          <Typography className="cross"> ✠ </Typography> da santa Cruz que imprimimos na sua
          fronte. Pelo mesmo Cristo, nosso Senhor.
        </Typography>
        <Typography className="latin">
          <Typography className="response"> ℟. </Typography> Amen.
        </Typography>
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          <Typography className="text-red-500">N.</Typography>) ut dignéris eum (eam)
        ...
        <Typography className="vernacular">
          ...
          (ou serva) <Typography className="vernacular">N.</Typography>, a fim de que Vos
      ...
      <Language>
        <Typography className="latin">
          <Typography className="latin">N.</Typography> Ingrédere in templum Dei, ut hábeas
          partem cum Christo in vitam ætérnam.
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">N.</Typography> Entra no Templo de Deus, a fim
          de que tenhas parte com Cristo na vida eterna.
        </Typography>
        <Typography className="latin">
          <Typography className="response"> ℟. </Typography> Amen.
        </Typography>
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="cross"> ✠ </Typography> Patris omnipoténtis, et in nómine
          Jesu <Typography className="cross"> ✠ </Typography> Christi Fílii ejus, Dómini et
          Júdicis nostri, et in virtúte Spíritus{" "}
          <Typography className="cross"> ✠ </Typography> Sancti, ut discédas ab hoc plásmate
          Dei <Typography className="text-red-500">N.</Typography>, quod Dóminus noster ad
        ...
        <Typography className="vernacular">
          ...
          <Typography className="cross"> ✠ </Typography> Cristo, seu Filho, nosso Senhor e
          nosso Juiz, e pelo poder do Espírito{" "}
          <Typography className="cross"> ✠ </Typography> Santo, para que saias desta
          criatura de Deus, <Typography className="text-red-500">N.</Typography>, que nosso
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="cross"> ✠ </Typography> óleo salútis in Christo Jesu Dómino
          nostro, ut hábeas vitam ætérnam.
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">Sac.</Typography> Eu te unjo{" "}
          <Typography className="cross"> ✠ </Typography> com o Óleo da salvação em nosso
      ...
      <Language>
        <Typography className="latin">
          <Typography className="latin">Sac.</Typography>{" "}
          <Typography className="text-red-500">N.</Typography> Credis in Deum Patrem
        ...
        <Typography className="latin">
          <Typography className="latin">Sac.</Typography> Credis in Jesum Christum, Fílium
          ejus únicum, Dóminum nostrum, natum, et passum?
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">Sac.</Typography> Crês em Jesus Cristo, seu
        ...
        <Typography className="latin">
          <Typography className="latin">Sac.</Typography> Credis et in Spíritum Sanctum,
          sanctam Ecclésiam cathólicam, Sanctórum communiónem, remissiónem
          peccatórum, carnis resurrectiónem, et vitam ætérnam?
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">Sac.</Typography> Crês no Espírito Santo, na
      ...
      <Language>
        <Typography className="latin">
          <Typography className="latin">Sac.</Typography>{" "}
          <Typography className="text-red-500">N.</Typography> Si non es baptizátus (-a),
          ego te baptízo in nómine Pa <Typography className="cross"> ✠ </Typography> tris,
          et Fí <Typography className="cross"> ✠ </Typography> lii, et Spíritus{" "}
          <Typography className="cross"> ✠ </Typography> Sancti.
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">Sac.</Typography>{" "}
          <Typography className="text-red-500">N.</Typography> Se não és baptizado (a), eu
          te baptizo em Nome do Pai <Typography className="cross"> ✠ </Typography>, e do Fi{" "}
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          <Typography className="cross"> ✠ </Typography> Chrísmate salútis in eódem Christo
        ...
        <Typography className="vernacular">
          ...
          salvação <Typography className="cross"> ✠ </Typography> para a vida eterna, em o
      ...
      <Language>
        <Typography className="latin">
          <Typography className="latin">Sac.</Typography> Accipe vestem cándidam, quam
        ...
        <Typography className="vernacular">
          ...
          apresentarás imaculada ante o tribunal de nosso Senhor Jesus Cristo, a
          fim de alcançares a vida eterna.
        </Typography>
        <Typography className="latin">
          <Typography className="response"> ℟. </Typography> Amen.
        </Typography>
      ...
      <Language>
        <Typography className="latin">
          ...
          irreprehensíbilis custódi Baptísmum tuum: serva Dei mandáta, ut, cum
          Dóminus vénerit ad núptias, possis occúrrere ei una cum ómnibus
          Sanctis in aula cælésti, et vivas in sæcula sæculórum.
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">Sac.</Typography> Recebe esta Vela acesa e
          guarda a graça do teu Baptismo com fidelidade irrepreensível: cumpre
          os Mandamentos de Deus, a fim de que, quando o Senhor vier para as
          bodas, possas ir ao seu encontro com todos os Santos na corte
      ...
      <Language>
        <Typography className="latin">
          <Typography className="latin">Sac.</Typography>{" "}
          <Typography className="text-red-500">N.</Typography> Vade in pace, et Dóminus sit
          tecum.
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">Sac.</Typography>{" "}
