        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              <Text className="versicle"> ℣. </Text>Que o Espírito Santo desça
              sobre vós e que a virtude do Altíssimo vos livre de todos os
              pecados.
            </Text>
            <Text className="latin">
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              <Text className="versicle"> ℣. </Text>Spíritum sciéntiæ, et
              pietátis.
            </Text>
            <Text className="vernacular">
            ...
            <Text className="latin">
              ...
              Cru <Text className="cross"> ✠ </Text> cis Christi, in vitam
              propitiátus ætérnam. Per eúmdem Dóminum nostrum Jesum Christum,
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              salútis. In nómine Pa <Text className="cross"> ✠ </Text> tris, et
              Fí <Text className="cross"> ✠ </Text> lii, et Spíritus{" "}
              <Text className="cross"> ✠ </Text> Sancti.
            </Text>
            <Text className="vernacular">
              <Text className="vernacular">N.</Text>, eu te marco com o sinal da
              Cruz <Text className="cross"> ✠ </Text> e te confirmo com o Crisma
              da salvação: em Nome do Pai <Text className="cross"> ✠ </Text> e
              do Filho <Text className="cross"> ✠ </Text> e do Espírito{" "}
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              Spirítui Sancto: Sicut erat in princípio, et nunc, et semper, et
              in sæcula sæculórum.
            </Text>
            <Text className="vernacular">
              <Text className="versicle"> ℣. </Text>Confirmai, ó Deus, o que
              acabais de operar em nós, lá do vosso santo templo que é Jerusalém
              celestial.<Text className="versicle"> ℣. </Text>Glória ao Pai e ao
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              Bene <Text className="cross"> ✠ </Text> dicat vos Dóminus ex Sion,
              ut videátis bona Jerúsalem ómnibus diébus vitæ vestræ, et habeátis
              vitam ætérnam.
            </Text>
            <Text className="vernacular">
              Que o Senhor vos abençoe <Text className="cross"> ✠ </Text> lá do
              alto de Sião, a fim de que vejais os bens de Jerusalém todos os
              dias da vossa vida e alcanceis a vida eterna.
            </Text>
            <Text className="latin">
              <Text className="response"> ℟. </Text> Amen.
            </Text>
