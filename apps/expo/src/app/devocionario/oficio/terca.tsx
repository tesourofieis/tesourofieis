...
export default function PageTerca() {
  return (
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          <em>Ant.</em> Maria Virgo assumpta est ad ætherum thalamum, in quo Rex
          regum stellato sedet solio.
        </p>
        <p>
          <em>Ant.</em> A Virgem Maria foi exaltada ao tálamo celeste, onde o
          Rei dos reis está sentado num trono de estrelas.
        </p>
      </div>
      ...
      <Tabs>
        ...
        <TabItem label="No Adveno">
          ...
          <div className="side-by-side">
            ...
            <p>
              <span className="text-red-500">℟.</span> Por isso Deus vos
