          ...
          <Tabs>
            <TabItem label="Depois da Purificação">
              ...
              <Language>
                ...
                <Text className="vernacular">
                  <Text className="versicle"> ℣. </Text>Rogai por nós, Santa Mãe
                  de Deus.
                </Text>
                <Text className="latin">
              ...
              <Language>
                ...
                <Text className="vernacular">
                  ...
                  recorremos, Santa Mãe de Deus; não desprezeis as nossas
                  súplicas em nossas necessidades; mas livrai-nos sempre de
              ...
              <Language>
                ...
                <Text className="vernacular">
                  ...
                  por nós a Deus, Aleluia! Alegrai-Vos e exultai, ó Virgem
            ...
            <TabItem label="No Advento">
              ...
              <Language>
                ...
                <Text className="vernacular">
                  <Text className="versicle"> ℣. </Text>O Anjo do Senhor
                  anunciou a Maria.
                </Text>
                <Text className="latin">
                ...
                <Text className="vernacular">
                  <Text className="response"> ℟. </Text> E Ela concebeu do
                  Espírito Santo.
                </Text>
                <Text className="latin">
                  <Text className="latin">Nunc. Ant.</Text> Spiritus Sanctus in
                  te descendet, Maria: ne timeas, habebis in utero Filium Dei,
                  (Allelúja).
                </Text>
                <Text className="vernacular">
                  <Text className="vernacular">Nunc. Ant.</Text> O Espírito
            ...
            <TabItem label="No Natal">
              ...
              <Language>
                ...
                <Text className="vernacular">
                  <Text className="vernacular">Nunc. Ant.</Text> Magnum
