    ...
    <PageWrapper>
      ...
      <Tabs>
        <TabItem label="Depois da Purificação">
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Maria Virgo
              assumpta est ad ætherum thalamum, in quo Rex regum stellato sedet
              solio.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> A Virgem
              Maria foi exaltada ao tálamo celeste, onde o Rei dos reis está
              sentado num trono de estrelas.
            </Typography>
          </Language>
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Benedicta filia tu
              a Domino: quia per te fructum vitaæ communicavimus.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Sois a filha
              bendita do Senhor, porque por vós recebemos o fruto da vida.
            </Typography>
          </Language>
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Beata dei
              genitrix, Maria, Virgo perpetua, templum Domini, sacrarium
              Spiritus Sancti, sola sine exemplo placuisti Domino nostro Jesu
              Christo: ora pro populo, interveni pro clero, intercede pro devoto
              femineo sexu.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Ó Santa Mãe
              de Deus, Maria sempre Virgem, templo de Deus, sacrário do Espírito
              Santo; vós apenas, sem exemplo, agradastes Nosso Senhor Jesus
          ...
          <Language>
            ...
            <Typography className="vernacular">
              ...
              de Deus, Maria sempre Virgem, templo de Deus, sacrário do Espírito
              Santo; vós apenas, sem exemplo, agradastes Nosso Senhor Jesus
              Cristo: reza por nós, intervém pelo clero, intercede pelo devoto
              sexo feminino.
            </Typography>
          </Language>
        ...
        <TabItem label="No Advento">
          <Language>
            ...
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Missus est
              Gábriel Angelus ad Maríam Vírginem desponsátam Joseph.
            </Typography>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> O Anjo Gabriel foi
        ...
        <TabItem label="No Natal">
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Et benedicta
              fructus ventris tui.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> E bendito é o
            ...
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Mirabile mysterium
              declaratur hodie: innovantur naturæ, Deus homo factus est: id quod
              fuit permansit, et quod non erat assumpsit; non commixtionem
              passus, neque divisionem.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Hoje se
              manifesta um admirável mystério: renovam-se as naturezas; Deus
              faz-se homem: ficando o que era, tomando o que não era, sem
