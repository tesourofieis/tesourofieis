      ...
      <Tabs>
        <TabItem label="Depois da Purificação">
          <Language>
            ...
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Assumpta est Maria in cælum:
              gaudete angeli, laudantes benedicunt Dominum.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Maria foi exaltada ao
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> In odorem unguentorum tuorum
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Benedicta filia tu a Domino:
              quia per te fructum vitaæ communicavimus.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Sois a filha bendita do
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Pulchra es et decora, filia
              Jerusalem: terribus ut castrorum acies ordinara.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Filha de Jerusalém, sois
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Beata dei genitrix, Maria,
              Virgo perpetua, templum Domini, sacrarium Spiritus Sancti, sola
              sine exemplo placuisti Domino nostro Jesu Christo: ora pro populo,
              interveni pro clero, intercede pro devoto femineo sexu.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Ó Santa Mãe de Deus,
              Maria sempre Virgem, templo de Deus, sacrário do Espírito Santo;
              vós apenas, sem exemplo, agradastes Nosso Senhor Jesus Cristo:
              rezei por nós, intervinde pelo clero, intercedei pelo devoto sexo
              feminino.
            </Typography>
          </Language>
          ...
          <Language>
            <Typography className="latin">
              ...
              allelúja; Ora pro nóbis Deum, allelúja.
            </Typography>
            <Typography className="vernacular">
        ...
        <TabItem label="No Advento">
          <Language>
            ...
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Glória Patri, et Fílio, et
              Spíritui Sancto.<Typography className="versicle"> ℣. </Typography>
            ...
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Missus est Gábriel
              Angelus ad Maríam Vírginem desponsátam Joseph.
            </Typography>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> O Anjo Gabriel foi mandado à
          ...
          <Language>
            ...
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Bendita sois vóo entre as
              mulheres.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Et benedictus fructus
              ventris tui.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> E bendito é o fruto do
              vosso ventre.
            </Typography>
          </Language>
        ...
        <TabItem label="No Natal">
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Et benedicta fructus
              ventris tui.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> E bendito é o fruto do
            ...
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Mirabile mysterium declaratur
              hodie: innovantur naturæ, Deus homo factus est: id quod fuit
              permansit, et quod non erat assumpsit; non commixtionem passus,
              neque divisionem.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Hoje se manifesta um
              admirável mystério: renovam-se as naturezas; Deus faz-se homem:
              ficando o que era, tomando o que não era, sem permitir divisão nem
              mistura.
            </Typography>
          </Language>
