      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              <Text className="response"> ℟. </Text> Et os meum annuntiabit
              laudem tuam.
            </Text>
            <Text className="vernacular">
          ...
          <Tabs>
            ...
            <TabItem label="Terça e Sexta feira">
              ...
              <View className="side-by-side">
                ...
                <Text className="vernacular">
                  <Text className="vernacular">Ant.</Text> Santa Mãe de Deus,
              ...
              <Tabs>
                <TabItem label="Depois da Purificação">
                  <View className="side-by-side">
                    ...
                    <Text className="vernacular">
                      <Text className="vernacular">Ant.</Text> Alegrai-vos,
          ...
          <Tabs>
            <TabItem label="Depois da Natal">
              ...
              <View className="side-by-side">
                ...
                <Text className="latin">
                  <Text className="versicle"> ℣. </Text>Tu autem, Dómine,
                  miserére nobis.
                </Text>
                <Text className="vernacular">
                ...
                <Text className="vernacular">
                  <Text className="versicle"> ℣. </Text>Bendita sois vós entre
                  as mulheres e bendito é o fruto do vosso ventre.
                </Text>
                <Text className="latin">
                  <Text className="response"> ℟. </Text> Quia quem cæli cápere
                  non póterant, tuo gremio contulisti.
                </Text>
                <Text className="vernacular">
                  <Text className="response"> ℟. </Text> Porque encerrastes no
              ...
              <View className="side-by-side">
                ...
                <Text className="latin">
                  <Text className="response"> ℟. </Text> Beata es, Virgo Maria,
                  quæ Dominum portasti, Creatorem mundi: Genuisti qui te fecit,
                  et in æternum permanes Virgo.
                </Text>
                <Text className="vernacular">
                  <Text className="response"> ℟. </Text> Bem-aventurada sois, ó
                  Virgem Maria, que trouxestes no vosso ventre o Criador do
                ...
                <Text className="vernacular">
                  <Text className="versicle"> ℣. </Text>Ave Maria, cheia de
                  graça, o Senhor é convosco.
                </Text>
                <Text className="latin">
                  <Text className="response"> ℟. </Text> Genuisti qui te fecit,
                  et in æternum permanes Virgo.
                </Text>
                <Text className="vernacular">
              ...
              <View className="side-by-side">
                ...
                <Text className="vernacular">
                  <Text className="versicle"> ℣. </Text>Glória ao Pai e ao Filho
                  e ao Espírito Santo.
                </Text>
                <Text className="latin">
                  <Text className="response"> ℟. </Text> Genuisti qui te fecit,
              ...
              <View className="side-by-side">
                ...
                <Text className="latin">
                  <Text className="response"> ℟. </Text> Quia ex te ortus est
                  sol justitiæ.
                </Text>
                <Text className="vernacular">
                  <Text className="response"> ℟. </Text> Porque de ti nasceu o
                  Sol de justiça.
                </Text>
                <Text className="latin">
                  <Text className="versicle"> ℣. </Text>Glória Patri, et Fílio,
            ...
            <TabItem label="No Advento">
              ...
              <View className="side-by-side">
                ...
                <Text className="latin">
                  <Text className="response"> ℟. </Text> Missus est Gabriel
                ...
                <Text className="vernacular">
                  <Text className="response"> ℟. </Text> O Anjo Gabriel foi
                ...
                <Text className="latin">
                  <Text className="versicle"> ℣. </Text>Dabit ei Dóminus Deus
                  sedem David, patris ejus, et regnábit in domo Jacob in
                  ætérnum.
                </Text>
                <Text className="vernacular">
                  <Text className="versicle"> ℣. </Text>O Senhor Deus lhe dará o
                  trono de David seu Pai, e reinará eternamente na casa de
                  Jacob.
                </Text>
                <Text className="latin">
                  <Text className="response"> ℟. </Text> Ecce concipies et
                  paries, et vocábitur Altíssimi Fílius.
                </Text>
                <Text className="vernacular">
                  <Text className="response"> ℟. </Text> Conceberás, e darás á
                ...
                <Text className="vernacular">
                  <Text className="versicle"> ℣. </Text>Dai-me, ó Senhor, a
                  vossa bênção.
                </Text>
                <Text className="latin">
                  Ipsa Virgo Vírginum intercédat pro nobis ad Dóminum.
              ...
              <View className="side-by-side">
                ...
                <Text className="latin">
                  <Text className="response"> ℟. </Text> Ave, María, grátia
                ...
                <Text className="vernacular">
                  <Text className="response"> ℟. </Text> Ave, Maria, cheia de
                ...
                <Text className="latin">
                  <Text className="versicle"> ℣. </Text>Quómodo fiet istud,
                  quóniam virum non cognósco? Et respóndens Angelus, dixit ei.
                </Text>
                <Text className="vernacular">
                  <Text className="versicle"> ℣. </Text>Como se fará isto, pois
                  não conheço varão? E respondendo o Anjo, lhe disse:
                </Text>
                <Text className="latin">
                ...
                <Text className="vernacular">
                  <Text className="response"> ℟. </Text> Virá sobre vós o
              ...
              <View className="side-by-side">
                ...
                <Text className="vernacular">
                  <Text className="response"> ℟. </Text> Recebei, Maria Virgem,
                  a palavra que Senhor vos transmite pelo seu Anjo. Concebereis,
                  e dareis à luz a Deus e Homem juntamente: pelo que sereis
                  chamada Bendita entre todas as mulheres.
                </Text>
                <Text className="latin">
                  <Text className="versicle"> ℣. </Text>Paries quidem fílium, et
                  virginitátis non patiéris detriméntum: efficiéris grávida, et
                  eris mater semper intácta.
                </Text>
                <Text className="vernacular">
                  <Text className="versicle"> ℣. </Text>Dareis à luz um filho, e
                  ficareis sempre Virgem. Concebereis e ficareis mãe,
                  continuareis sempre pura e imaculada.
                </Text>
                <Text className="latin">
                  <Text className="response"> ℟. </Text> Ut benedícta dicáris
