  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          <Typography className="response"> ℟. </Typography> Et os meum
          annuntiabit laudem tuam.
        </Typography>
        <Typography className="vernacular">
          <Typography className="response"> ℟. </Typography> E a minha boca
      ...
      <Tabs>
        <TabItem label="Domingo, Segunda e Quinta feira">
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Benedicta tu in
              mulieribus, et benedictus fructus ventris tui.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Bendita sois
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Sicut myrrha
              electa, odorem dedisti suavitatis, sancta Dei Genitrix.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Como a
              preciosa mirra, exalastes suavíssima fragrância, ó santa Mãe de
              Deus.
            </Typography>
          </Language>
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Ante torum hujus
              Virginis frequentate nobis dulcia cantica dramatis.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography>{" "}
              Multiplicai-nos doces cânticos ante o precioso leito desta Virgem.
            </Typography>
          </Language>
        ...
        <TabItem label="Terça e Sexta feira">
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Specie tua et
              pulchritudine tua intende, prospere procede, et regna.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Ornada de
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Adjuvabit eam Deus
              vultu suo: Deus in medio ejus, non commovebitur.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Ajudou-a Deus
              com seu favorável aspecto; e como Deus assiste no meio dela, não
              se verá perturbada.
            </Typography>
          </Language>
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Sicut lætantium
              omnium nostrum habitatio est in te, sancta Dei Genitrix.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Santa Mãe de
              Deus, todos nossos que por amor habitam convosco estão cheios de
              alegria.
            </Typography>
          </Language>
        ...
        <TabItem label="Quarta-feira e Sábado">
          ...
          <Tabs>
            <TabItem label="Depois da Purificação">
              <Language>
                <Typography className="latin">
                  <Typography className="latin">Ant.</Typography> Gaude, Maria
            ...
            <TabItem label="No Advento">
              <Language>
                <Typography className="latin">
                  <Typography className="latin">Ant.</Typography> Angelus Domini
                  nuntiavit Mariæ, et concepit de Spiritu Sancto, (Allelúja)
                </Typography>
                <Typography className="vernacular">
                  <Typography className="vernacular">Ant.</Typography> O Anjo do
          ...
          <Language>
            ...
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Alegrai-vos,
              Virgem Maria: porque só vós haveis destruído todas as heresias em
              todo o mundo.
            </Typography>
          </Language>
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Dignare me laudare
              te, Virgo sacrata: da mihi virtutem contra hostes tuos.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Dignai-vos,
              sagrada Virgem, de que eu vos louve; dai-me esforço contra vossos
              inimigos.
            </Typography>
          </Language>
          ...
          <Tabs>
            <TabItem label="Depois da Purificação">
              <Language>
                <Typography className="latin">
                  <Typography className="latin">Ant.</Typography> Post partum
                  virgo inviolata permansisti: Dei Genitrix, intercede pro
                  nobis.
                </Typography>
                <Typography className="vernacular">
                  <Typography className="vernacular">Ant.</Typography> Depois do
                  parto permanecestes virgem imaculada; Mãe de Deus, intercedei
                  por nós.
                </Typography>
              </Language>
            </TabItem>
      ...
      <Language>
        <Typography className="latin">
          <Typography className="versicle"> ℣. </Typography>Diffusa est gratia
          in labiis tuis.
        </Typography>
        <Typography className="vernacular">
          <Typography className="versicle"> ℣. </Typography>Estão cheios de
          graça vossos lábios.
        </Typography>
        <Typography className="latin">
          <Typography className="response"> ℟. </Typography> Propterea benedixit
          te Deum in æternum.
        </Typography>
        <Typography className="vernacular">
          <Typography className="response"> ℟. </Typography> Por isso Deus vos
        ...
        <Typography className="vernacular">
          <Typography className="versicle"> ℣. </Typography>E nos não deixeis
          cair em tentação.
        </Typography>
        <Typography className="latin">
      ...
      <Language>
        ...
        <Typography className="latin">
          <Typography className="versicle"> ℣. </Typography>Jube, Domine,
          benedicere.
        </Typography>
        <Typography className="vernacular">
          <Typography className="versicle"> ℣. </Typography>Dai-me, Senhor, a
          vossa bênção.
        </Typography>
      </Language>
      ...
      <Tabs>
        <TabItem label="Depois da Natal">
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Tu autem,
              Dómine, miserére nobis.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>E Vós, Senhor,
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Sancta et
              immaculáta virginitas, quibus te laudibus efferam nescio: Quia
              quem cæli cápere non póterant, tuo gremio contulísti.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Santa e
              imaculada Virgindade, não sei com que louvores possa exaltar-vos.
              Porque encerrastes no vosso seio Aquele a quem os céus não podiam
              abranger.
            </Typography>
            <Typography className="latin">
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Quia quem cæli
              cápere non póterant, tuo gremio contulisti.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Porque
              encerrastes no vosso seio Aquele a quem os céus não podiam
              abranger.
            </Typography>
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Iube domne
              benedicere.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Dai-me, Senhor,
              a vossa bênção.
            </Typography>
            <Typography className="latin">
          ...
          <Language>
            ...
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Demos graças a
              Deus.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Beata es, Virgo
              Maria, quæ Dominum portasti, Creatorem mundi: Genuisti qui te
              fecit, et in æternum permanes Virgo.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Bem-aventurada
              sois, ó Virgem Maria, que trouxestes no vosso ventre o Criador do
              mundo. Gerastes o que vos deu o ser, e ficastes para sempre
              Virgem.
            </Typography>
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Ave Maria,
              gratia plena, Dominus tecum.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Ave Maria, cheia
              de graça, o Senhor é convosco.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Genuisti qui te
              fecit, et in æternum permanes Virgo.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Gerastes O que
              vos deu o ser, e ficastes para sempre Virgem.
            </Typography>
          </Language>
          ...
          <Language>
            ...
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Glória ao Pai e
          ...
          <Language>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Felix namque
              es, sacra Virgo Maria, et omni laude dignissima: Quia ex te ortus
              est sol justitiæ, Christus Deus noster.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Ditosa sois, ó
              sagrada Virgem Maria, e digníssima de todo o louvor. Porque de vós
              nasceu o sol de justiça, Jesus Cristo nosso Deus.
            </Typography>
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Ora pro populo,
              interveni pro clero, intercede pro devoto femineo sexu: sentiant
              omnes tuum juvamen, quicumque celebrant tuam sanctam
              commemorationem.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Rogai pelo povo,
              intercedei pelo clero, advogai pelo devoto sexo feminino;
              experimentem o vosso patrocínio os que celebram a vossa santa
              memória. Porque de vós nasceu o Sol de justiça, Jesus Cristo,
              nosso Deus.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Quia ex te
              ortus est sol justitiæ.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Porque de ti
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Christus Deus
              noster.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Jesus Cristo,
              nosso Deus.
            </Typography>
          </Language>
        </TabItem>
        ...
        <TabItem label="No Advento">
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Missus est
              Gabriel Angelus ad Maríam Vírginem desponsatam Joseph, nuntians ei
              verbum; et expavescit Virgo de lúmine: ne timeas, María, invenísti
              grátiam apud Dóminum: Ecce concipies et paries, et vocábitur
              Altíssimi Fílius.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> O Anjo Gabriel
              foi enviado a Maria Virgem, desposada com José, para lhe anunciar
              o verbo; e a Virgem assustou-se com o esplendor da sua luz. Não
              temas, Maria, que achaste graça para com o Senhor. Conceberás, e
              darás à luz um filho que será chamado o filho do Altíssimo.
            </Typography>
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Dabit ei Dóminus
              Deus sedem David, patris ejus, et regnábit in domo Jacob in
              ætérnum.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>O Senhor Deus
              lhe dará o trono de David seu Pai, e reinará eternamente na casa
              de Jacob.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Ecce concipies
              et paries, et vocábitur Altíssimi Fílius.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Conceberás, e
            ...
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Dai-me, ó
              Senhor, a vossa bênção.
            </Typography>
            <Typography className="latin">
              Ipsa Virgo Vírginum intercédat pro nobis ad Dóminum.
            </Typography>
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Ave, María,
              grátia plena; Dóminus tecum: Spíritus Sanctus supervéniet in te,
              et virtus Altíssimi obumbrábit tibi: quod enim ex te nascétur
              Sanctum, vocábitur Fílius Dei.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Ave, Maria,
            ...
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Quómodo fiet
              istud, quóniam virum non cognósco? Et respóndens Angelus, dixit
              ei.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Como se fará
              isto, pois não conheço varão? E respondendo o Anjo, lhe disse:
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Spíritus
              Sanctus supervéniet in te, et virtus Altíssimi obumbrábit tibi:
              quod enim ex te nascétur Sanctum, vocábitur Fílius Dei.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Virá sobre vós
              o Espírito Santo, e a virtude do Altíssimo vos fará sombra; por
          ...
          <Language>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Súscipe verbum,
              Virgo María, quod tibi a Dómino per Angelum transmíssum est:
              concípies et páries Deum páriter et hóminem, ut benedícta dicáris
              inter omnes mulíeres.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Recebei, Maria
              Virgem, a palavra que Senhor vos transmite pelo seu Anjo.
              Concebereis, e dareis à luz a Deus e Homem juntamente: pelo que
              sereis chamada Bendita entre todas as mulheres.
            </Typography>
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Paries quidem
              fílium, et virginitátis non patiéris detriméntum: efficiéris
              grávida, et eris mater semper intácta.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Dareis à luz um
              filho, e ficareis sempre Virgem. Concebereis e ficareis mãe,
              continuareis sempre pura e imaculada.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Ut benedícta
              dicáris inter omnes mulíeres.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Pelo que sereis
