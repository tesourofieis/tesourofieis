  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          <Typography className="response"> ℟. </Typography> Et os meum annuntiabit laudem
          tuam.
        </Typography>
        <Typography className="vernacular">
          <Typography className="response"> ℟. </Typography> E a minha boca anunciará o
          vosso louvor.
        </Typography>
        <Typography className="latin">
      ...
      <Tabs>
        <TabItem label="Domingo, Segunda e Quinta feira">
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Sicut myrrha electa, odorem
              dedisti suavitatis, sancta Dei Genitrix.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Como a preciosa mirra,
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Ante torum hujus Virginis
              frequentate nobis dulcia cantica dramatis.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Multiplicai-nos doces
        ...
        <TabItem label="Terça e Sexta feira">
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Specie tua et pulchritudine
              tua intende, prospere procede, et regna.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Ornada de glória e de
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Adjuvabit eam Deus vultu suo:
              Deus in medio ejus, non commovebitur.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Ajudou-a Deus com seu
          ...
          <Language>
            ...
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Santa Mãe de Deus, todos
        ...
        <TabItem label="Quarta-feira e Sábado">
          ...
          <Tabs>
            <TabItem label="Depois da Purificação">
              <Language>
                <Typography className="latin">
                  <Typography className="latin">Ant.</Typography> Gaude, Maria Virgo:
                  cunctas hæreses sola intermenisti in universo mundo.
                </Typography>
                <Typography className="vernacular">
                  <Typography className="vernacular">Ant.</Typography> Alegrai-vos, Virgem
            ...
            <TabItem label="No Advento">
              <Language>
                <Typography className="latin">
                  <Typography className="latin">Ant.</Typography> Angelus Domini nuntiavit
                  Mariæ, et concepit de Spiritu Sancto, (Allelúja)
                </Typography>
                <Typography className="vernacular">
                  <Typography className="vernacular">Ant.</Typography> O Anjo do Senhor
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Dignare me laudare te, Virgo
              sacrata: da mihi virtutem contra hostes tuos.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Dignai-vos, sagrada
          ...
          <Tabs>
            <TabItem label="Depois da Purificação">
              <Language>
                <Typography className="latin">
                  <Typography className="latin">Ant.</Typography> Post partum virgo
                  inviolata permansisti: Dei Genitrix, intercede pro nobis.
                </Typography>
                <Typography className="vernacular">
                  <Typography className="vernacular">Ant.</Typography> Depois do parto
      ...
      <Language>
        ...
        <Typography className="latin">
          <Typography className="response"> ℟. </Typography> Propterea benedixit te Deum in
          æternum.
        </Typography>
        <Typography className="vernacular">
          <Typography className="response"> ℟. </Typography> Por isso Deus vos abençoou para
          sempre.
        </Typography>
        ...
        <Typography className="vernacular">
          <Typography className="versicle"> ℣. </Typography>E nos não deixeis cair em
          tentação.
        </Typography>
        <Typography className="latin">
      ...
      <Tabs>
        <TabItem label="Depois da Natal">
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Tu autem, Dómine, miserére
              nobis.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>E Vós, Senhor, tende
              misericórdia de nós.
            </Typography>
            <Typography className="latin">
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Quia quem cæli cápere non
              póterant, tuo gremio contulisti.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Porque encerrastes no vosso
            ...
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Dai-me, Senhor, a vossa
              bênção.
            </Typography>
            <Typography className="latin">
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Genuisti qui te fecit, et
              in æternum permanes Virgo.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Gerastes O que vos deu o
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Quia ex te ortus est sol
              justitiæ.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Porque de ti nasceu o Sol
              de justiça.
            </Typography>
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Glória Patri, et Fílio, et
        ...
        <TabItem label="No Advento">
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Missus est Gabriel Angelus
            ...
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> O Anjo Gabriel foi enviado
            ...
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Dabit ei Dóminus Deus sedem
              David, patris ejus, et regnábit in domo Jacob in ætérnum.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>O Senhor Deus lhe dará o
              trono de David seu Pai, e reinará eternamente na casa de Jacob.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Ecce concipies et paries,
              et vocábitur Altíssimi Fílius.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Conceberás, e darás á luz
            ...
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Dai-me, ó Senhor, a vossa
              bênção.
            </Typography>
            <Typography className="latin">
              Ipsa Virgo Vírginum intercédat pro nobis ad Dóminum.
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Ave, María, grátia plena;
            ...
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Ave, Maria, cheia de graça;
            ...
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Quómodo fiet istud, quóniam
              virum non cognósco? Et respóndens Angelus, dixit ei.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Como se fará isto, pois não
              conheço varão? E respondendo o Anjo, lhe disse:
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Spíritus Sanctus
              supervéniet in te, et virtus Altíssimi obumbrábit tibi: quod enim
              ex te nascétur Sanctum, vocábitur Fílius Dei.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Virá sobre vós o Espírito
          ...
          <Language>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Súscipe verbum, Virgo
            ...
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Recebei, Maria Virgem, a
            ...
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Dareis à luz um filho, e
              ficareis sempre Virgem. Concebereis e ficareis mãe, continuareis
              sempre pura e imaculada.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Ut benedícta dicáris inter
              omnes mulíeres.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Pelo que sereis chamada
              Bendita entre todas as mulheres.
            </Typography>
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Glória Patri, et Fílio, et
