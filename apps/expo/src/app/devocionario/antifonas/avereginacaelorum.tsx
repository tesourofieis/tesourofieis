      ...
      <ScrollView>
        <View className="docs">
          ...
          <Language>
            ...
            <Text className="vernacular">
              <Text className="versicle"> ℣. </Text>Dignai-Vos aceitar, Senhora,
              os meus louvores.
            </Text>
            <Text className="latin">
              <Text className="response"> ℟. </Text> Da mihi virtútem contra
              hostes tuos.
            </Text>
            <Text className="vernacular">
              <Text className="response"> ℟. </Text> E dai-me coragem para
