  ...
  return (
    <PageWrapper>
      ...
      <Text className="text-base">
        ...
        amor pelas almas, eu Vos suplico pela agonia do vosso Santíssimo coração
      ...
      <Image
        ...
        style={{ height: 400 }}
      />
      <Text className="h3">Jesus é descido da Cruz e entregue a sua Mãe</Text>
      <Text className="text-base">
        ...
        denegrido com pancadas e coberto de feridas, e algumas tão profundas que
        deixam ver os seus ossos!... Ó Santa Mãe das dores, rogai a Jesus que
        nos perdoe os pecados, nos ajude a imitar as vossas virtudes, nos
