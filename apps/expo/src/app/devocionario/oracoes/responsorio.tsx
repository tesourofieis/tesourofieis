  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          <Typography className="latin">Ant.</Typography> Cedunt mare, víncula:
          membra, resque pérditas, pétunt et accípiunt juvénes et cani.
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">Ant.</Typography> Cede o mar
          embravecido, recupera-se o perdido, pedem e recebem, tanto velhos como
          mancebos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          <Typography className="versicle"> ℣. </Typography>Ora pro nobis, beate
          Antoni.
        </Typography>
        <Typography className="vernacular">
