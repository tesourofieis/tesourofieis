  ...
  return (
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> Panem nostrum quotidiánum da
        ...
        <p>
          <span className="text-red-500">℟.</span> O pão nosso de cada dia nos
          dai hoje; perdoai-nos as nossas dívidas, assim como nós perdoamos aos
