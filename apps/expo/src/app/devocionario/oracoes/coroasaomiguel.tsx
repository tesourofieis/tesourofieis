    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Deus, vinde em nosso auxílio.
        </Text>
        <Text className="latin">
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="vernacular">Ant.</Text> Glorioso São Miguel, chefe e
        ...
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Ora pro nobis, O Gloriose Sancte
          Michael, Princeps Ecclesiae Jesus Christi.
        </Text>
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Rogai por nós, ó bem-aventurado
