  ...
  return (
    <PageWrapper>
      ...
      <Text className="text-pretty">
        ...
        ingrato!... Quanto me tenho extraviado!... Perdoai-me. Não mais quero
      ...
      <Text className="text-pretty">
        ...
        delicadeza, que se impacienta com a menor contrariedade. Ah! meu amado
        Jesus, infundi no meu coração um constante e forte amor às tribulações,
