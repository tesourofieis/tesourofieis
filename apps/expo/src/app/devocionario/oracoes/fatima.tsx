  ...
  return (
    <PageWrapper>
      ...
      <Text className="text-base">
        ...
        da terra, em reparação dos ultrajes, sacrilégios e indiferenças com que
      ...
      <Text className="text-base">
        ...
        palavras, Mandou-nos rezar, A Virgem Maria, Para nos salvar. Mas jamais
        esqueçam, Nossos corações, Que nos fez a Virgem, Determinações. Falou
        contra o luxo, Contra o impudor, De modestas modas, De uso pecador.
        Disse que a pureza, Agrada a Jesus, Disse que a luxúria, Ao fogo conduz.
        A treze de Outubro, Foi o seu adeus, E a Virgem Maria, Voltou para os
        céus. À Pátria que é vossa, Senhora dos Céus, Dai honra, alegria, E a
        graça de Deus. À Virgem bendita, Cante seu louvor, Toda nossa terra, Um
        hino de amor. Todo o mundo a louve, Para se salvar, Desde o vale ao
        monte, Desde o monte ao mar. Ah! Demos-Lhe graças, Por nos dar seu bem,
      ...
      <Text className="text-base">
        ...
        a Senhora, Dos seus filhos peregrinos, Carinhosa protectora, Sacrifício
        e oração, Foi a vossa vida inteira, Ao convite maternal, Da Senhora da
        azinheira. Praticando a caridade, Entregáveis com carinho, A merenda que
        leváveis, Ao primeiro pobrezinho, Caminhantes neste mundo, Ajudai-nos,
        cada dia, A viver sempre seguros, Sob o manto de Maria, A Senhora do
        Rosário, Pela vossa intercessão, Abençoe o Santo Padre, E nos leve à
