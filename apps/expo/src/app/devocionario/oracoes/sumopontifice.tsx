        ...
        <View className="docs">
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              vivifique, que o faça santo na terra e o não entregue à vontade
              dos seus inimigos.
            </Text>
            ...
            <Text className="latin">
              ...
              Deus, ómnium fidélium pastor et rector, fámulum tuum N., quem
              pastórem Ecclésiæ tuæ præésse voluísti, propítius réspice: da ei,
              quǽsumus, verbo et exémplo, quibus præest, profícere: ut ad vitam,
              una cum grege sibi crédito, pervéniat sempitérnam. Per Christum,
              Dóminum nostrum.
            </Text>
            <Text className="vernacular">
              <Text className="vernacular">
