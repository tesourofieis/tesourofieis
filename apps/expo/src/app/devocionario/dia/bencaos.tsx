  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Bénedic, Dómine, nos et hæc tua
          dona quæ de tua largitáte sumus sumptúri. Per Christum Dóminum
          nostrum.
        </Text>
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Abençoai-nos, Senhor, e a estes
      ...
      <Language>
        ...
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Ágimus tibi grátias, omnipotens
