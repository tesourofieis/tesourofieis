  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">O Anjo do Senhor anunciou a Maria.</Text>
        ...
        <Text className="latin">
          <Text className="response"> ℟. </Text> Fiat mihi secúndum verbum tuum.
        </Text>
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Faça-se em mim segundo a vossa
          Palavra.
        </Text>
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Ave, María, grátia plena,
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Rogai por nós Santa Mãe de Deus.
        </Text>
        <Text className="latin">
