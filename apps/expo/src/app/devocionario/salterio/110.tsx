      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base latin">
              <Text className="text-base latin">fit reverentia</Text> Sanctum,
              et terríbile nomen ejus: * inítium sapiéntiæ timor Dómini.
            </Text>
            <Text className="text-base vernacular">
              <Text className="text-base vernacular">inclinar a cabeça</Text>{" "}
              Santo e terrível é o seu nome: * o temor do Senhor é o princípio
              da sabedoria.
            </Text>
            <Text className="text-base latin">
