  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          Sua obra é glória e magnificência: * e a sua justiça permanece pelos
          séculos dos séculos.
        </Text>
        <Text className="latin">
        ...
        <Text className="latin">
          <Text className="latin">fit reverentia</Text> Sanctum, et terríbile
          nomen ejus: * inítium sapiéntiæ timor Dómini.
        </Text>
        <Text className="vernacular">
          <Text className="vernacular">inclinar a cabeça</Text> Santo e terrível
