        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              Bem-aventurados todos os que temem o Senhor, * e que andam nos
              seus caminhos.
            </Text>
            <Text className="latin">
              Labóres mánuum tuárum quia manducábis: * beátus es, et bene tibi
              erit.
            </Text>
            <Text className="vernacular">
              Pois comerás dos labores de tuas mãos: * bem-aventurado és e
              ficarás bem.
            </Text>
            <Text className="latin">
            ...
            <Text className="vernacular">
              Tua esposa será como uma videira fecunda, * no interior de tua
              casa.
            </Text>
            <Text className="latin">
            ...
            <Text className="vernacular">
              Te abençoe o Senhor desde Sião: * e vejas os bens de Jerusalém
