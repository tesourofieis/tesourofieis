  ...
  return (
    <div className="docs">
      ...
      <p>
        ...
        levantar da cama e enquanto nos vestimos, deveríamos pensar que Deus
        está presente, que este dia pode ser o último da nossa vida; ademais,
        devíamos levantar-nos e vestir-nos com toda a modéstia possível. A um
        bom cristão, apenas se tenha levantado e vestido, convém pôr-se na
        presença de Deus e ajoelhar-se, se pode, diante de alguma devota imagem,
      ...
      <p>
        ...
        de que eu nunca Vos ofenda»; ou então fazer o sinal da Cruz, evitando,
        porém, que as outras pessoas, pelos sinais externos, suspeitem da
        tentação. Quando uma pessoa reconhece ou receia ter cometido algum
        pecado, convém fazer imediatamente um acto de contrição, e procurar
        confessar-se quanto antes. Quando fora da igreja se ouve o sinal de
        elevação da Hóstia na Missa solene, ou da bênção do Santíssimo
      ...
      <p>«Senhor, seja feita vossa santíssima vontade»;</p>

      <p>«Meu Jesus, eu quero ser todo vosso»;</p>

      <p>«Meu Jesus, misericórdia»;</p>
      ...
      <p>
        ...
        Sacramento levado a um enfermo, devemos, sendo possível, acompanhá-Lo
        com modéstia e recolhimento; e, se não é possível acompanhá-Lo, fazer um
      ...
      <p>
        ...
        profundis»](/devocionario/salterio/129) ou um «Réquiem», ou um Pai-Nosso
        e uma Ave-Maria, pela alma desse defunto, e renovarei o pensamento da
        morte.
      </p>
    </div>
  );
