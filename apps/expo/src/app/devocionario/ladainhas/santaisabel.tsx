      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="text-base">
            ...
            Santa Isabel, que pernoitáveis na oração e contemplação, rogai por
            nós.{"\n"}
            Santa Isabel, consolada muitas vezes com visões divinas, rogai por
            nós.{"\n"}
            Santa Isabel, amável a Deus e aos homens, rogai por nós.{"\n"}
            Santa Isabel, admirável desprezadora do mundo, rogai por nós.{"\n"}
            Santa Isabel, modelo de pobreza, castidade e obediência, rogai por
            nós.{"\n"}
            ...
            Santa Isabel, que desprezastes as delícias da real casa paterna,
            rogai por nós.{"\n"}
