  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="latin">Spiritus Sancte, Deus, miserere nobis.</Text>
        <Text className="vernacular">
        ...
        <Text className="latin">
          <Text className="response"> ℟. </Text> Redimisti nos, Domine, in
          sanguine tuo.
        </Text>
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Remiste-nos, Senhor, com vosso
          Sangue.
        </Text>
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Et fecisti nos Deo nostro
          regnum.
        </Text>
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>E fizestes de nós um reino para
          o nosso Deus.
        </Text>
        <Text className="latin">
