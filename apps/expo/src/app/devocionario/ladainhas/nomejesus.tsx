      ...
      <ScrollView>
        <View className="docs">
          ...
          <Language>
            ...
            <Text className="vernacular">
              Pela vossa instituição da Santíssima Eucaristia, livrai-nos,
              Jesus.
            </Text>
            <Text className="latin">
            ...
            <Text className="latin">
              ...
              et invenietis; pulsate, et aperietur vobis: quǽsumus, da nobis
              petentibus spaninissimi tui amoris affectum, ut te toto corde, ore
              et opere diligamus, et a tua nunquam laude cessemus. Sancti
              noministui, domine, timorem pariter et amorem fac nos habere
              perpetuum, quianunquam tua gubernatione destituis quos in
              soliditate tuæ dilectionis instituis. Qui vivis et regnas. Amen.
            </Text>
            <Text className="vernacular">
              Senhor Jesus Cristo, que dissestes: «Pedi e recebereis; buscai e
              achareis; batei e abrir-se-vos-á», nós Vos suplicamos que
              concedais a nós, que Vo-lo pedimos, os sentimentos afectivos do
              vosso spanino amor, a fim de que nós Vos amemos de todo o coração
              e que esse amor transcenda por nossas acções. Permiti que tenhamos
              sempre, Senhor, um igual temor e amor pelo vosso Santo Nome, pois
