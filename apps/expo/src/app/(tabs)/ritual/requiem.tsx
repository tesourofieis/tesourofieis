    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          exorámus pro ánima fámuli tui <span className="text-red-500">N.</span>{" "}
          (fámulæ tuæ <span className="text-red-500">N.</span>), quam hódie de
        ...
        <p>
          ...
          <span className="text-red-500">N.</span> que mandastes sair deste
          mundo: a não abandoneis, Senhor, nas mãos do inimigo, nem a esqueçais
          para sempre, mas dignai-Vos ordenar aos vossos Santos Anjos que a
          acolham e introduzam na pátria do paraíso, a fim de que, depois de
          haver acreditado e esperado em Vós, não seja condenada ao sofrimento
          das penas do inferno, mas goze as alegrias eternas. Por nosso
          Senhor...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> (fámulæ tuæ{" "}
          <span className="text-red-500">N.</span>), pro qua hóstiam laudis tibi
        ...
        <p>
          ...
          serva) <span className="text-red-500">N.</span>, em favor da qual Vos
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> (fámulæ tuæ{" "}
          <span className="text-red-500">N.</span>), quæ hódie de hoc sǽculo
        ...
        <p>
          ...
          servo (ou vossa serva) <span className="text-red-500">N.</span>, que
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> (fámulæ tuæ{" "}
          <span className="text-red-500">N.</span>), cujus depositiónis diem
        ...
        <p>
          ...
          serva) <span className="text-red-500">N.</span>, cujo... (terceiro ou
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> (fámulæ tuæ{" "}
          <span className="text-red-500">N.</span>) offérimus, placátus inténde:
        ...
        <p>
          ...
          <span className="text-red-500">N.</span>, a fim de que, purificada com
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> (fámulæ tuæ{" "}
          <span className="text-red-500">N.</span>): ut, si quæ ei máculæ de
        ...
        <p>
          ...
          <span className="text-red-500">N.</span>, a fim de que, se ainda está
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> (fámulæ tuæ{" "}
          <span className="text-red-500">N.</span>, vel animábus famulórum
        ...
        <p>
          ...
          vossa serva <span className="text-red-500">N.</span>), de cujo dia da
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          servo (ou vossa serva) <span className="text-red-500">N.</span>, cujo
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> (fámulæ tuæ{" "}
          <span className="text-red-500">N.</span>, vel ánimæ famulórum
          famularúmque tuárum), cujus (quorum) anniversárium depositiónis diem
        ...
        <p>
          ...
          serva) <span className="text-red-500">N.</span>, cujo aniversário da
          sua morte hoje comemoramos, havendo sido purificada pela virtude
          destes sacrifícios, receba ao mesmo tempo a indulgência e o sempiterno
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          da vingança: ℣. E alcancem a bem-aventurança da luz eterna.
        </p>
      </div>
