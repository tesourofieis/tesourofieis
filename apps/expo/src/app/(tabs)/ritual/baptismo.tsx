      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              <Text className="em">Sac.</Text> Fides, quid tibi præstat?
            </Text>
            <Text className="text-base">
              <Text className="em">Sac.</Text> Para que te serve a Fé?
            </Text>
            <Text className="text-base">
            ...
            <Text className="text-base">
              <Text className="em">Sac.</Text> Si ígitur vis ad vitam íngredi,
              serva mandáta. Díliges Dóminum Deum tuum ex toto corde tuo, et ex
              tota ánima tua, et ex tota mente tua, et próximum tuum sicut
              teípsum.
            </Text>
            <Text className="text-base">
              <Text className="em">Sac.</Text> Se, portanto, queres alcançar a
              vida eterna, observa os Mandamentos. Amarás o Senhor, teu Deus,
              com todo teu coração, com toda tua alma e com toda tua
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="cross text-red-500">✠</Text> te, quam in cor{" "}
            ...
            <Text className="text-base">
              ...
              <Text className="cross text-red-500">✠</Text> e no coração{" "}
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              eléctum tuum <Text className="text-red-500">N.</Text> (hanc
            ...
            <Text className="text-base">
              ...
              escolhido <Text className="text-red-500">N.</Text> (ou esta vossa
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text> (hanc fámulam tuam{" "}
            ...
            <Text className="text-base">
              ...
              vossa serva) <Text className="text-red-500">N.</Text>, que Vos
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="cross text-red-500">✠</Text> Patris omnipoténtis,
              et in caritáte Dómini nostri Jesu{" "}
            ...
            <Text className="text-base">
              ...
              <Text className="cross text-red-500">✠</Text> Pai omnipotente, na
          ...
          <View className="side-by-side">
            <Text className="text-base">
              <Text className="text-red-500">N.</Text> Accipe sal sapiéntiæ:
              propitiátio sit tibi in vitam ætérnam.
            </Text>
            <Text className="text-base">
              <Text className="text-red-500">N.</Text> Recebe o sal da
            ...
            <Text className="text-base">
              <Text className="em">Sac.</Text> Pax tecum.
            </Text>
            <Text className="text-base">
              <Text className="em">Sac.</Text> A paz seja contigo.
            </Text>
            <Text className="text-base">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text> (para a vossa serva{" "}
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="cross text-red-500">✠</Text> cis, quod nos fronti
            ...
            <Text className="text-base">
              ...
              <Text className="cross text-red-500">✠</Text> da santa Cruz que
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              hunc fámulum tuum <Text className="text-red-500">N.</Text> (hanc
              fámulam tuam <Text className="text-red-500">N.</Text>) ut dignéris
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text>, a fim de que Vos digneis
          ...
          <View className="side-by-side">
            <Text className="text-base">
              <Text className="text-red-500">N.</Text> Ingrédere in templum Dei,
              ut hábeas partem cum Christo in vitam ætérnam.
            </Text>
            <Text className="text-base">
              <Text className="text-red-500">N.</Text> Entra no Templo de Deus,
              a fim de que tenhas parte com Cristo na vida eterna.
            </Text>
            <Text className="text-base">
              <Text className="text-red-500">℟.</Text> Amen.
            </Text>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="cross text-red-500">✠</Text> Patris omnipoténtis,
              et in nómine Jesu <Text className="text-red-500">✠</Text> Christi
            ...
            <Text className="text-base">
              ...
              Deus <Text className="cross text-red-500">✠</Text> Pai
          ...
          <View className="side-by-side">
            <Text className="text-base">Ephpheta, quod est, Adaperire.</Text>
            <Text className="text-base">Éfeta, isto é: Abre-te.</Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              <Text className="em">Sac.</Text> Et ómnibus opéribus ejus?
            </Text>
            <Text className="text-base">
              <Text className="em">Sac.</Text> E a todas suas obras?
            </Text>
            <Text className="text-base">
              <Text className="text-red-500">℟.</Text> Abrenúntio.
            </Text>
            ...
            <Text className="text-base">
              <Text className="em">Sac.</Text> Et ómnibus pompis ejus?
            </Text>
            <Text className="text-base">
              <Text className="em">Sac.</Text> E a todas suas seduções?
            </Text>
            <Text className="text-base">
              <Text className="text-red-500">℟.</Text> Abrenúntio.
            </Text>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              <Text className="em">Sac.</Text> Credis in Jesum Christum, Fílium
              ejus únicum, Dóminum nostrum, natum, et passum?
            </Text>
            <Text className="text-base">
              <Text className="em">Sac.</Text> Crês em Jesus Cristo, seu Filho
            ...
            <Text className="text-base">
              <Text className="em">Sac.</Text> Credis et in Spíritum Sanctum,
              sanctam Ecclésiam cathólicam, Sanctórum communiónem, remissiónem
              peccatórum, carnis resurrectiónem, et vitam ætérnam?
            </Text>
            <Text className="text-base">
              <Text className="em">Sac.</Text> Crês no Espírito Santo, na Santa
              Igreja Católica, na comunicação dos Santos, na remissão dos
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="cross text-red-500">✠</Text> Chrísmate salútis in
            ...
            <Text className="text-base">
              ...
              salvação <Text className="cross text-red-500">✠</Text> para a vida
            ...
            <Text className="text-base">
              <Text className="em">Sac.</Text> Pax tibi.
            </Text>
            <Text className="text-base">
              <Text className="em">Sac.</Text> A paz seja contigo.
            </Text>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              <Text className="em">Sac.</Text> Accipe vestem cándidam, quam
              pérferas immaculátam ante tribúnal Dómini nostri Jesu Christi, ut
              hábeas vitam ætérnam.
            </Text>
            <Text className="text-base">
              <Text className="em">Sac.</Text> Recebe a Veste branca, a qual
              apresentarás imaculada ante o tribunal de nosso Senhor Jesus
          ...
          <View className="side-by-side">
            <Text className="text-base">
              <Text className="em">Sac.</Text> Accipe lámpadem ardéntem, et
            ...
            <Text className="text-base">
              <Text className="em">Sac.</Text> Recebe esta Vela acesa e guarda a
              graça do teu Baptismo com fidelidade irrepreensível: cumpre os
              Mandamentos de Deus, a fim de que, quando o Senhor vier para as
