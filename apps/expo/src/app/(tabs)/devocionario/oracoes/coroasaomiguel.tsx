      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">℣. Deus, vinde em nosso auxílio.</Text>
            <Text className="text-base">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              <Text className="em">Ant.</Text> O Princeps Gloriose sancte
            ...
            <Text className="text-base">
              <Text className="em">Ant.</Text> Glorioso São Miguel, chefe e
              príncipe dos exércitos celestes, fiel guardião das almas, vencedor
              dos espíritos rebeldes, amado da casa de Deus, nosso admirável
              guia depois de Cristo; vós, cuja excelência e virtudes são
              eminentíssimas, dignai-vos livrar-nos de todos os males, a nós
            ...
            <Text className="text-base">Amén.</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
