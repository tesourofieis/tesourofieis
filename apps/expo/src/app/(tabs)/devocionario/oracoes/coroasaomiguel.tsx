        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              ...
              <Link
                className="text-base vernacular"
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              <Text className="text-base latin">Ant.</Text> O Princeps Gloriose
              sancte Michael, Dux et praeposite caelestium exercituum, Custos
              animarum, Domitor spirituum rebellum, Serve in domu Regis Divini,
              et conductor mirabilis noster, Qui cum excellentia et virtute
            ...
            <Text className="text-base vernacular">
              <Text className="text-base vernacular">Ant.</Text> Glorioso São
              Miguel, chefe e príncipe dos exércitos celestes, fiel guardião das
              almas, vencedor dos espíritos rebeldes, amado da casa de Deus,
              nosso admirável guia depois de Cristo; vós, cuja excelência e
              virtudes são eminentíssimas, dignai-vos livrar-nos de todos os
              males, a nós todos que recorremos a vós com confiança, e fazei,
              pela vossa incomparável proteção, que adiantemos, cada dia mais,
              na fidelidade em servir a Deus.
            </Text>
            <Text className="text-base latin">
              ℣. Ora pro nobis, O Gloriose Sancte Michael, Princeps Ecclesiae
              Jesus Christi.
            </Text>
            <Text className="text-base vernacular">
              ℣. Rogai por nós, ó bem-aventurado São Miguel, príncipe da Igreja
              de Cristo.
            </Text>
            <Text className="text-base latin">
            ...
            <Text className="text-base vernacular">Amén.</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
