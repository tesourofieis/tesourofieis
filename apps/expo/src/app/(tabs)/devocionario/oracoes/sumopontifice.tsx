      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">℣. Orémus pro Pontífice nostro N.</Text>
            <Text className="text-base">℣. Oremos pelo nosso Pontífice N.</Text>
            ...
            <Text className="text-base">Pater Noster... Ave Maria...</Text>
            <Text className="text-base">Pai Nosso... Ave Maria...</Text>
            <Text className="text-base">
              <Text className="text-red-500">℣. </Text>Deus, ómnium fidélium
            ...
            <Text className="text-base">
              <Text className="text-red-500">℣. </Text>Ó Deus, pastor e guia de
              todos os fieis, olhai misericordiosamente sobre vosso Servo N. que
              escolheestes para pastor da vossa Igreja; concedei-lhe que, com
              sua palavra e exemplo, encaminhe o rebanho que lhe confiastes, e
              juntamente com ele, possa alcançar a vida eterna. Por Cristo
              Senhor nosso.
            </Text>
            <Text className="text-base">
