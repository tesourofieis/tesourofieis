      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              Ouviu as minhas súplicas: * e tirou-me do abysmo da miséria e do
              lodo profundo.
            </Text>
            <Text className="text-base latin">
            ...
            <Text className="text-base vernacular">
              Bem-aventurado o varão, cuja esperança é o nome do Senhor: * e que
              não olhou para vaidades e falsas loucuras.
            </Text>
            <Text className="text-base latin">
            ...
            <Text className="text-base vernacular">
              Está escrito de mim na capa do livro, para fazer a vossa vontade:
              * ó Deus meu, assim o quis e a vossa lei está no íntimo do meu
              coração.
            </Text>
            <Text className="text-base latin">
            ...
            <Text className="text-base vernacular">
              Anunciei a vossa justiça numa grande igreja, * eis que não
              fecharei os meus lábios: ó Senhor, Vós o sabeis.
            </Text>
            <Text className="text-base latin">
            ...
            <Text className="text-base vernacular">
              Não escondi a vossa justiça no meu coração: * declarei a vossa
              verdade e a salvação que vem de Vós.
            </Text>
            <Text className="text-base latin">
            ...
            <Text className="text-base vernacular">
              Vós, ó Senhor, não afasteis de mim as vossas misericórdias: * a
              vossa misericórdia e a vossa verdade sempre me ampararam.
            </Text>
            <Text className="text-base latin">
            ...
            <Text className="text-base vernacular">
              Simultaneamente sejam confundidos e envergonhados, os que minha
              vida * procuram tirar.
            </Text>
            <Text className="text-base latin">
            ...
            <Text className="text-base vernacular">
              Sofram imediatamente a sua confusão, * aqueles que me dizem: bem,
              bem!
            </Text>
            <Text className="text-base latin">
            ...
            <Text className="text-base vernacular">
              Regozijem-se e alegrem-se em Vós todos os que Vos buscam: * e os
              que amam a vossa salvação digam sempre: o Senhor seja glorificado.
            </Text>
            <Text className="text-base latin">
            ...
            <Text className="text-base vernacular">
              Vós sois o meu auxílio e o meu protector: * não tardeis, ó meu
              Deus.
            </Text>
          </View>
        </View>
