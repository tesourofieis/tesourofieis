          ...
          <Tabs>
            <TabItem label="Depois da Purificação">
              <View className="side-by-side">
                ...
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Dum esset Rex in acubitu suo,
                  nardus mea dedit odorem suavitatis.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Estando o Rei no seu repouso,
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Læva ejus sub capite meo, et
                  dextera ilius amplexabitur me.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Sua mão esquerda estará
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Nigra sum, sed formosa, filiæ
                  Jerusalem; ideo dilexit me rex, et introduxit me in cubiculom
                  suum.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Sou negra, mas sou formosa, ó
                  filhas de Jerusalém; por isso o Rei me amou, e me levou a seu
                  aposento.
                </Text>
              </View>
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Jam hiems transiit, imber
                  abiit et recessit: surge, amica mea, et veni.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Já se foi o Inverno, e passou
                  o chuveiro; levanta-te e vem, ó minha amada.
                </Text>
              </View>
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Speciosa facta es et suavis
                  in deliciis tuis, sancta Dei Genitrix.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Especiosa sois, e suave nas
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Beata Mater et intacta Virgo,
                  gloriosa Regina mundi, intercede pro nobis ad Dominum.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Santa Mãe e Virgem intacta,
            ...
            <TabItem label="No Natal">
              ...
              <View className="side-by-side">
                ...
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Magnum hæreditatis mysterium:
                  templum Dei factus est uterus nescientis virum: non est
                  pollutus ex ea carnem assumens; omnes gentes venient,
                  dicentes: Gloria tibi, Domine.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Grande mystério de herança: o
                  ventre daquela que não conheceu varão, é feito templo de Deus;
                  o qual se não manchou, tomando dela carne humana. Virão todas
                  as gentes, dizendo: Glória a Vós, ó Senhor.
                </Text>
              </View>
