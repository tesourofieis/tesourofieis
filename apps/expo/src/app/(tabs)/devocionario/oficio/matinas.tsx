        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ℣. Domine, <Text className="cross text-red-500">✠</Text> labia mea
              aperies.
            </Text>
            <Text className="text-base">
              ℣. Abri, Senhor, <Text className="cross text-red-500">✠</Text> os
              meus lábios.
            </Text>
            <Text className="text-base">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">Dominus tecum.</Text>
            <Text className="text-base">O Senhor é convosco.</Text>
            <Text className="text-base">
          ...
          <Tabs>
            <TabItem label="Domingo, Segunda e Quinta feira">
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Benedicta tu in mulieribus,
                  et benedictus fructus ventris tui.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Bendita sois vós entre as
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Sicut myrrha electa, odorem
                  dedisti suavitatis, sancta Dei Genitrix.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Como a preciosa mirra,
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Ante torum hujus Virginis
                  frequentate nobis dulcia cantica dramatis.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Multiplicai-nos doces
            ...
            <TabItem label="Terça e Sexta feira">
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Specie tua et pulchritudine
                  tua intende, prospere procede, et regna.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Ornada de glória e de
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Adjuvabit eam Deus vultu suo:
                  Deus in medio ejus, non commovebitur.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Ajudou-a Deus com seu
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Sicut lætantium omnium
                  nostrum habitatio est in te, sancta Dei Genitrix.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Santa Mãe de Deus, todos
            ...
            <TabItem label="Quarta-feira e Sábado">
              ...
              <Tabs>
                <TabItem label="Depois da Purificação">
                  <View className="side-by-side">
                    <Text className="text-base">
                      <Text className="em">Ant.</Text> Gaude, Maria Virgo:
                      cunctas hæreses sola intermenisti in universo mundo.
                    </Text>
                    <Text className="text-base">
                      <Text className="em">Ant.</Text> Alegrai-vos, Virgem
                ...
                <TabItem label="No Advento">
                  <View className="side-by-side">
                    <Text className="text-base">
                      <Text className="em">Ant.</Text> Angelus Domini nuntiavit
                      Mariæ, et concepit de Spiritu Sancto, (Allelúja)
                    </Text>
                    <Text className="text-base">
                      <Text className="em">Ant.</Text> O Anjo do Senhor anunciou
                      a Maria, e ela concebeu do Espírito Santo.
                    </Text>
                  </View>
                </TabItem>
              </Tabs>
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Gaude, Maria Virgo: cunctas
                  hæreses sola intermenisti in universo mundo.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Alegrai-vos, Virgem Maria:
                  porque só vós haveis destruído todas as heresias em todo o
                  mundo.
                </Text>
              </View>
              ...
              <View className="side-by-side">
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Dignare me laudare te, Virgo
                  sacrata: da mihi virtutem contra hostes tuos.
                </Text>
                <Text className="text-base">
                  <Text className="em">Ant.</Text> Dignai-vos, sagrada Virgem,
                  de que eu vos louve; dai-me esforço contra vossos inimigos.
                </Text>
              </View>
              ...
              <Tabs>
                <TabItem label="Depois da Purificação">
                  <View className="side-by-side">
                    <Text className="text-base">
                      <Text className="em">Ant.</Text> Post partum virgo
                      inviolata permansisti: Dei Genitrix, intercede pro nobis.
                    </Text>
                    <Text className="text-base">
                      <Text className="em">Ant.</Text> Depois do parto
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">Pater Noster (secreto usque ad).</Text>
            <Text className="text-base">Pai Nosso (em silêncio).</Text>
            <Text className="text-base">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">℣. Jube, Domine, benedicere.</Text>
            <Text className="text-base">
          ...
          <Tabs>
            <TabItem label="Depois da Natal">
              ...
              <View className="side-by-side">
                ...
                <Text className="text-base">℣. Iube domne benedicere.</Text>
                <Text className="text-base">
                  ℣. Dai-me, Senhor, a vossa bênção.
                </Text>
                <Text className="text-base">
