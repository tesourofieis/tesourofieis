      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base latin">Jesu, audi nos.</Text>
            <Text className="text-base vernacular">
              Jesus Cristo, ouvi-nos.
            </Text>
            <Text className="text-base latin">Jesu, exaudi nos.</Text>
            <Text className="text-base vernacular">
            ...
            <Text className="text-base latin">Jesu, audi nos.</Text>
            <Text className="text-base vernacular">Jesus, ouvi-nos.</Text>
            <Text className="text-base latin">Jesu, exaudi nos.</Text>
            <Text className="text-base vernacular">Jesus, atendei-nos.</Text>
            <Text className="text-base latin">
