      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base latin">Christe, áudi nos.</Text>
            <Text className="text-base vernacular">
            ...
            <Text className="text-base latin">Spíritus Sancte, Deus,</Text>
            <Text className="text-base vernacular">
              Espírito Santo, que sois Deus,
            </Text>
            <Text className="text-base latin">Sancta Trínitas, unus Deus,</Text>
            <Text className="text-base vernacular">
            ...
            <Text className="text-base latin">Domus áurea, ora pro nobis.</Text>
            <Text className="text-base vernacular">
            ...
            <Text className="text-base latin">Jánua cæli, ora pro nobis.</Text>
            <Text className="text-base vernacular">
