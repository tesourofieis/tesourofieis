        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 77, 1</Text> Ó meu povo, escutai a minha
              lei: inclinai os vosso ouvidos às palavras da minha boca. ℣.
              Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Sois a esperança de Israel e o seu Salvador, no tempo da
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 78, 9-10</Text>{" "}
              Propítius esto, Dómine, peccátis nostris: ne quando dicant gentes:
              Ubi est Deus eórum? Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 78, 9-10</Text>{" "}
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              quia, quodcúmque díxerit, fiat, fiet ei. Proptérea dico vobis:
              Omnia quæcúmque orántes pétitis, crédite quia accipiétis, et
              evénient vobis. Et cum stábitis ad orándum, dimíttite, si quid
              habétis advérsus áliquem: ut et Pater vester, qui in cælis est,
            ...
            <Text className="text-base">
              ...
              acreditar que acontecerá tudo quanto ele tiver dito, tudo será
              feito, como ele tiver dito. Por isso vos digo: tudo quanto
              pedirdes, orando, crede que o recebereis, e que assim acontecerá.
              Quando fordes orar, se tiverdes alguma coisa contra alguém,
              perdoai-lhe, para que o vosso Pai, que está nos céus, perdoe
