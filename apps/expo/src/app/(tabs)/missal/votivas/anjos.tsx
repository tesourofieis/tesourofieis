  ...
  return (
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          Louvai o Senhor nos céus! Louvai-O nas alturas celestiais. ℣. Louvai-O
          vós, Anjos; louvai-O vós, que constituís o seu exército.
        </p>
        <p>
        ...
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 137, 1-2</em> Cantarei louvores em vossa
          honra diante dos Anjos; adorar-Vos-ei no vosso santo templo: e
      ...
      <div className="side-by-side">
        <p>
          ...
          verbum ejus. ℣. <em>ibid., 21-22</em> Benedícite Dómino, omnes
          virtútes ejus: minístri ejus, qui fácitis voluntátem ejus. ℣.
          Benedicite Dómino, ómnia ópera ejus: in omni loco dominatiónis ejus,
        ...
        <p>
          ...
          <em>ibid., 21-22</em> Bendizei o Senhor, vós todos, que formais o seu
          exército; sois os seus ministros e cumpris a sua vontade! Bendizei o
          Senhor, ó obras todas do mesmo Senhor! Bendizei o Senhor em todos os
          lugares do seu domínio, ó minha alma.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 137, 1-2</em> In conspéctu Angelórum
          psallam tibi: adorábo ad templum sanctum tuum, et confitébor nómini
          tuo Allelúja. ℣. <em>Matth. 28, 2</em> Angelus Dómini descéndit de
          cœlo, et accédens revólvit lápidem, et sedébat super eum. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 137, 1-2</em> Cantarei louvores em vossa
          honra diante dos Anjos; adorar-Vos-ei no vosso santo templo; e
          glorificarei o vosso nome. Aleluia. ℣. <em>Mt. 28, 2</em> Um Anjo do
          Senhor, havendo descido do céu, afastou a pedra e assentou-se sobre
          ela. Aleluia.
        </p>
      </div>
      <h3>Evangelho</h3>
