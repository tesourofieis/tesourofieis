        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Aleluia, aleluia.) <Text className="em">Sl. 131, 1</Text>{" "}
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              similári. ℣. <Text className="em">Hebr. 2, 17</Text> Ut miséricors
              fíeret, et fidélis póntifex ad Deum: ut repropitiáret delícta
              pópuli.
            </Text>
            <Text className="text-base">
              ...
              <Text className="em">Heb. 2, 17</Text> A fim de ser um Pontífice
              misericordioso e fiel junto de Deus, para expiar os pecados do
              povo.
            </Text>
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Levit. 21, 8</Text>{" "}
              Sacerdos sit sanctus, sicut et ego sanctus sum, Dóminus, qui
              sanctífico vos. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Lv. 21, 8</Text> Que o
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Levit. 21, 8</Text>{" "}
              Sacérdos sit sanctus, sicut et ego sanctus sum, Dóminus, qui
              sanctífico vos. Allelúja. ℣.{" "}
