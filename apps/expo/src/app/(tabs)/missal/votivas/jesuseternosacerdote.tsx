        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. ibid., 1</Text> Dixit Dóminus Dómino meo:
              Sede a dextris meis. ℣. Gloria Patri...
            </Text>
            <Text className="text-base">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Hebr. 7, 24</Text>{" "}
              Jesus autem eo quod máneat in ætérnum, sempitérnum habet
              sacerdótium. Allelúja. ℣. <Text className="em">Luc. 4, 18</Text>{" "}
              Spíritus Dómini super me: propter quod unxit me, evangelizáre
              paupéribus misit me, sanáre contrítos corde. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Heb. 7, 24</Text> Jesus,
