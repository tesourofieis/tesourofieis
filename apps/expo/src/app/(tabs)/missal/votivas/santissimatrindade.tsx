      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">ibid., 52</Text>{" "}
              Benedíctus es, Dómine, Deus patrum nostrórum, et laudábilis in
              sǽcula. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">ibid., 52</Text> Sois
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Dan. 3, 52</Text>{" "}
              Benedíctus es, Dómine, Deus patrum nostrórum, et laudábilis in
              sǽcula. Allelúja. ℣. Benedicámus Patrem et Fílium cum Sancto
              Spíritu. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Dn. 3, 52</Text> Sois
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              comigo desde o princípio, Lhe dareis também testemunho de mim.
              Digo-vos estas coisas para que vos não escandalizeis:
              expulsar-vos-ão das sinagogas; e vem a hora em que qualquer que
              vos mate, julgará que presta um serviço a Deus. Tratar-vos-ão
              deste modo, porque não conhecem nem o Pai, nem me conhecem a mim.
