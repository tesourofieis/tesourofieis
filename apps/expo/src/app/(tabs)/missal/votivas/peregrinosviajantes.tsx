    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 1</em> Júdica me. Dómine, quóniam ego in innocéntia mea
          ingréssus sum: et in Dómino sperans non infirmábor. ℣. Gloria Patri...
        </p>
        <p>
          ...
          Aleluia, aleluia.) <em>Sl. ibid., 1</em> Julgai-me, Senhor, porquanto
          tenho caminhado com a minha inocência, e, confiando no Senhor, não
          vacilarei. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          corno chegasse a certo lugar, preparou-se para passar ali a noite,
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          algum, porque Vós, Senhor, estareis comigo. ℣. Vossa vara e o vosso
          bastão me consolarão.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 118, 133</em> Gressus meos dírige
          secúndum elóquium tuum: ut non dominétur mei omnis injustítia.
          Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 118, 133</em> Encaminhei os meus passos
          segundo a vossa doutrina, para que nenhuma injustiça me possa dominar.
          Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          tuum. ℣. Super áspidem et basilíscum ambulábis, et conculcábis leónem
          et dracónem.
        </p>
        <p>
          Ordenou Deus aos seus Anjos que te guardassem em todos teus caminhos.
          ℣. Conduzir-te-ão com suas mãos, para que as pedras te não magoem. ℣.
          Caminharás sobre a áspide e o basilisco e calcarás o leão e o dragão.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 118, 133</em> Gressus meos dírige
          secúndum elóquium tuum: ut non dominétur mei omnis injustítia.
          Allelúja. ℣. <em>Ps. 121, 1</em> Lætátus sum in his, quæ dicta sunt
          mihi: in domum Dómini íbimus. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 118, 133</em> Encaminhei os meus passos
          segundo a vossa doutrina, para que nenhuma injustiça me possa dominar.
          Aleluia. ℣. <em>Sl. 121, 1</em> Alegrei-me quando me foram ditas estas
