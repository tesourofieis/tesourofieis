    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          nostrórum, neque vindíctam sumas de peccátis nostris. (T. P.
          Allelúja.)
        </p>
        <p>
          <em>Ant.</em> Não Vos recordeis, Senhor, dos nossos delitos, nem dos
          delitos de nossos pais; não queirais vingar-Vos dos nossos pecados.
          (T. P. Aleluia.)
        </p>
      </div>
      <h2>Salmo 83</h2>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          tentatiónem. <span className="text-red-500">℟.</span> Sed líbera nos a
          malo.
        </p>
        <p>
        ...
        <p>
          ...
          <span className="text-red-500">℟.</span> Sana ánimam meam, quia
          peccávi tibi.
        </p>
        <p>
          ℣. Eu disse: Senhor, tende piedade de mim.{" "}
          <span className="text-red-500">℟.</span> Curai a minha alma, pois
          pequei contra Vós.
        </p>
        <p>
          ℣. Convértere, Dómine, aliquántulum.{" "}
          <span className="text-red-500">℟.</span> Et deprecáre super servos
          tuos.
        </p>
        <p>
          ℣. Senhor, volvei-Vos um pouco para nós.{" "}
          <span className="text-red-500">℟.</span> Enchei-Vos de piedade para
          com vossos servos.
        </p>
        <p>
          ℣. Fiat misericórdia tua, Dómine, super nos.{" "}
          <span className="text-red-500">℟.</span> Quemádmodum sperávimus in te.
        </p>
        <p>
          ℣. Senhor, venha a nós a vossa misericórdia.{" "}
          <span className="text-red-500">℟.</span> Pois esperamos em Vós.
        </p>
        <p>
          ℣. Sacerdótes tui induántur justítiam.{" "}
          <span className="text-red-500">℟.</span> Et Sancti tui exsúltent.
        </p>
        <p>
          ℣. Que os vossos sacerdotes se revistam de justiça.{" "}
          <span className="text-red-500">℟.</span> E os vossos santos exultem de
          alegria.
        </p>
        <p>
          ℣. Ab occúltis meis munda me, Dómine.{" "}
          <span className="text-red-500">℟.</span> Et ab aliénis parce servo
          tuo.
        </p>
        <p>
          ℣. Senhor, lavai-me das minhas faltas ocultas.{" "}
          <span className="text-red-500">℟.</span> E perdoai ao vosso servo as
          faltas alheias.
        </p>
        <p>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          firmíssima tuítio. <span className="text-red-500">℟.</span> Amen.
        </p>
        <p>
