        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              <Text className="em">Ant.</Text> Ne reminiscáris, Dómine, delícta
              nostra vel paréntum nostrórum, neque vindíctam sumas de peccátis
              nostris. (T. P. Allelúja.)
            </Text>
            <Text className="text-base">
              <Text className="em">Ant.</Text> Não Vos recordeis, Senhor, dos
              nossos delitos, nem dos delitos de nossos pais; não queirais
