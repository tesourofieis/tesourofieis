...
export default function PagePent40() {
  return (
    <div className="docs">
      <h1>Quarto Domingo depois de Pentecostes</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          infirmáti sunt, et cecidérunt. <em>Ps. ibid., 3</em> Si consístant
        ...
        <p>
          ...
          <em>Sl. ibid., 3</em> Ainda que um exército me cercasse, o meu coração
          não temeria. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          est, non volens, sed propter eum, qui subjécit eam in spe: quia et
          ipsa creatúra liberábitur a servitúte corruptiónis, in libertátem
          glóriæ filiórum Dei. Scimus enim, quod omnis creatúra ingemíscit et
          párturit usque adhuc. Non solum autem illa, sed et nos ipsi primítias
        ...
        <p>
          ...
          dos filhos de Deus; pois elas, agora, estão sujeitas à vaidade, não
          voluntariamente, mas pela vontade daquele que as sujeitou, com a
          esperança de que seriam livres da servidão da corrupção para
          participar da liberdade da glória dos filhos de Deus. Na verdade,
          sabemos que todas as criaturas gemem e estão como que com as dores da
          maternidade até ao presente. Também nós, que possuímos as primícias do
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          está o seu Deus? ℣. Auxiliai-nos, ó Senhor, nosso Salvador: e, pela
          glória do vosso nome, livrai-nos, Senhor.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 9, 5 & 10</em> Deus, qui sedes su per
          thronum, et júdicas æquitátem: esto refúgium páuperum in tribulatióne.
          Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 9, 5 & 10 Ó</em> Deus, que estais
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Ascéndens autem in unam navim, quæ erat Simónis, rogávit eum a terra
          redúcere pusíllum. Et sedens docébat de navícula turbas. Ut cessávit
          ...
          fecíssent, conclusérunt píscium multitúdinem copiósam: rumpebátur
          autem rete eórum. Et annuérunt sóciis, qui erant in ália navi, ut
          venírent et adjuvárent eos. Et venérunt, et implevérunt ambas
          navículas, ita ut pæne mergeréntur. Quod cum vidéret Simon Petrus,
          prócidit ad génua Jesu, dicens: Exi a me, quia homo peccátor sum,
          Dómine. Stupor enim circumdéderat eum et omnes, qui cum illo erant, in
          captúra píscium, quam céperant: simíliter autem Jacóbum et Joánnem,
        ...
        <p>
          ...
          redes. Então, entrou Jesus em uma das barcas, a qual pertencia a
          Simão, pedindo-lhe que a desviasse um pouco da terra. Depois
          assentou-se na barca e começou a doutrinar o povo. Quando Jesus acabou
          de falar, disse a Simão: «Afasta-te para o largo e lança as redes para
          pescares». Simão respondeu-Lhe: «Mestre, trabalhámos toda a noite e
          não pescámos nada; mas, obedecendo à vossa palavra, lançarei a rede».
          E, lançando-a, pescaram tão grande quantidade de peixes, que a rede se
          rompia! Logo fizeram sinal aos companheiros, que estavam na outra
          barca, para que fossem auxiliá-los. Foram eles e encheram ambas as
          barcas; e de tal sorte que quase se afundavam! Simão-Pedro, vendo
          isto, caiu de joelhos aos pés de Jesus e disse: «Afastai-Vos de mim,
          Senhor, pois sou um homem pecador!». Simão estava atónito, assim como
          os companheiros, por causa da pesca que haviam feito! O mesmo
          acontecia a Tiago e a João, filhos de Zebedeu, que estavam com Simão.
