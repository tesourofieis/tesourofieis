        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              ...
              Deus, como no seu monte santo. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              ...
              salvar. ℣. <Text className="text-base vernacular">Sl. 70, 1</Text>{" "}
              Ó Deus, em Vós pus a minha esperança: não serei para sempre
              confundido, Senhor.
            </Text>
            <Text className="text-base latin">
              Allelúja, allelúja. ℣.{" "}
            ...
            <Text className="text-base vernacular">
              ...
              grande e digno de todos os louvores, tanto na cidade de Deus, como
              no seu monte santo. Aleluia.
            </Text>
          </View>
