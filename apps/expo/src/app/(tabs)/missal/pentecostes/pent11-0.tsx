...
export default function PagePent110() {
  return (
    <div className="docs">
      <h1>Décimo Primeiro Domingo depois de Pentecostes</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          ipse dabit virtútem et fortitúdinem plebi suæ. <em>Ps. ibid., 2</em>{" "}
          Exsúrgat Deus, et dissipéntur inimíci ejus: et fúgiant, qui odérunt
          eum, a fácie ejus. ℣. Gloria Patri...
        </p>
        <p>
          ...
          constância. <em>Sl. ibid., 2</em> Erga-se Deus e sejam dispersos os
          seus inimigos: Que aqueles que o odeiam fujam da sua presença. ℣.
          Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          vobis in primis, quod et accépi: quóniam Christus mortuus est pro
          peccátis nostris secúndum Scriptúras: et quia sepúltus est, et quia
          resurréxit tértia die secúndum Scriptúras: et quia visus est Cephæ, et
          post hoc úndecim. Deinde visus est plus quam quingéntis frátribus
          simul, ex quibus multi manent usque adhuc, quidam autem dormiérunt.
          Deinde visus est Jacóbo, deinde Apóstolis ómnibus: novíssime autem
          ómnium tamquam abortívo, visus est et mihi. Ego enim sum mínimus
        ...
        <p>
          ...
          não fora assim, teríeis abraçado a fé inutilmente. Em primeiro lugar,
          ensinei-vos o que também aprendi, isto é: Que Cristo morreu por causa
          dos nossos pecados, segundo as Escrituras; que foi sepultado e
          ressuscitou ao terceiro dia, segundo as mesmas Escrituras; que
          apareceu a Cefas e seguidamente aos outros Onze Apóstolos; que,
          depois, foi visto por mais de quinhentos irmãos, que estavam reunidos,
          alguns dos quais estão vivos e outros já morreram; que, igualmente,
          foi visto por Tiago e logo pelos outros Apóstolos. Finalmente, depois
          dos outros, foi visto por mim, que sou o mais imperfeito de todos.
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Clamei por Vós, Senhor! Meu Deus, não fecheis os ouvidos à minha voz,
          nem Vos afasteis de mim.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 80, 2-3</em> Exsultáte Deo, adjutóri
          nostro, jubiláte Deo Jacob: súmite psalmum jucúndum cum cíthara.
          Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 80, 2-3</em> Exultai de alegria em Deus,
          que é o nosso protector: Cantai hinos em honra de Deus de Jacob: Tocai
          em tom alegre o saltério e a cítara. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          eum de turba seórsum, misit dígitos suos in aurículas ejus: et
          éxspuens, tétigit linguam ejus: et suspíciens in cœlum, ingémuit, et
          ait illi: Ephphetha, quod est adaperíre. Et statim apértæ sunt aures
          ejus, et solútum est vínculum linguæ ejus, et loquebátur recte. Et
        ...
        <p>
          ...
          separando-o da multidão, pôs-lhe os dedos nos ouvidos e saliva na
          língua. Depois, erguendo os olhos ao céu, deu um suspiro e disse:
          «Ephpheta», isto é, abre-te! E logo se abriram os ouvidos deste homem
          e se partiu a prisão da sua língua, falando distintamente. Então Jesus
