        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. ibid., 2</Text> Exsúrgat Deus, et
            ...
            <Text className="text-base">
              ...
              fortaleza e constância. <Text className="em">Sl. ibid., 2</Text>{" "}
              Erga-se Deus e sejam dispersos os seus inimigos: Que aqueles que o
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              aqueles castigos, que a nossa consciência teme, e nos sejam
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Trádidi enim vobis in primis, quod et accépi: quóniam Christus
              mortuus est pro peccátis nostris secúndum Scriptúras: et quia
              sepúltus est, et quia resurréxit tértia die secúndum Scriptúras:
              et quia visus est Cephæ, et post hoc úndecim. Deinde visus est
              plus quam quingéntis frátribus simul, ex quibus multi manent usque
              adhuc, quidam autem dormiérunt. Deinde visus est Jacóbo, deinde
              Apóstolis ómnibus: novíssime autem ómnium tamquam abortívo, visus
              est et mihi. Ego enim sum mínimus Apostolórum, qui non sum dignus
            ...
            <Text className="text-base">
              ...
              pois, se não fora assim, teríeis abraçado a fé inutilmente. Em
              primeiro lugar, ensinei-vos o que também aprendi, isto é: Que
              Cristo morreu por causa dos nossos pecados, segundo as Escrituras;
              que foi sepultado e ressuscitou ao terceiro dia, segundo as mesmas
              Escrituras; que apareceu a Cefas e seguidamente aos outros Onze
              Apóstolos; que, depois, foi visto por mais de quinhentos irmãos,
              que estavam reunidos, alguns dos quais estão vivos e outros já
              morreram; que, igualmente, foi visto por Tiago e logo pelos outros
              Apóstolos. Finalmente, depois dos outros, foi visto por mim, que
              sou o mais imperfeito de todos. Sim; sou o mínimo dos Apóstolos,
              assim como sou indigno de ser chamado Apóstolo, pois fui
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 80, 2-3</Text>{" "}
              Exsultáte Deo, adjutóri nostro, jubiláte Deo Jacob: súmite psalmum
              jucúndum cum cíthara. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 80, 2-3</Text>{" "}
              Exultai de alegria em Deus, que é o nosso protector: Cantai hinos
              em honra de Deus de Jacob: Tocai em tom alegre o saltério e a
              cítara. Aleluia.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              apprehéndens eum de turba seórsum, misit dígitos suos in aurículas
              ejus: et éxspuens, tétigit linguam ejus: et suspíciens in cœlum,
              ingémuit, et ait illi: Ephphetha, quod est adaperíre. Et statim
              apértæ sunt aures ejus, et solútum est vínculum linguæ ejus, et
              loquebátur recte. Et præcépit illis, ne cui dícerent. Quanto autem
              eis præcipiébat, tanto magis plus prædicábant: et eo ámplius
            ...
            <Text className="text-base">
              ...
              mãos sobre ele. Jesus, separando-o da multidão, pôs-lhe os dedos
              nos ouvidos e saliva na língua. Depois, erguendo os olhos ao céu,
              deu um suspiro e disse: «Ephpheta», isto é, abre-te! E logo se
              abriram os ouvidos deste homem e se partiu a prisão da sua língua,
              falando distintamente. Então Jesus impôs-lhes que não dissessem a
              ninguém o que se passara; mas, quanto mais os proibia, mais o
