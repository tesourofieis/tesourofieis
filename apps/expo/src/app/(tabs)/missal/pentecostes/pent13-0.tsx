        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. ibid., 1</Text> Ut quid, Deus, reppulísti
              in finem: irátus est furor tuus super oves páscuæ tuæ? ℣. Gloria
              Patri...
            </Text>
            <Text className="text-base">
              ...
              <Text className="em">Sl. ibid., 1</Text> Porque, ó Deus, cresceu a
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Deo, quæ post quadringéntos et trigínta annos facta est lex, non
              írritum facit ad evacuándam promissiónem. Nam si ex lege
              heréditas, jam non ex promissióne. Abrahæ autem per repromissiónem
              donávit Deus. Quid igitur lex? Propter transgressiónes pósita est,
              donec veníret semen, cui promíserat, ordináta per Angelos in manu
              mediatóris. Mediátor autem uníus non est: Deus autem unus est. Lex
              ergo advérsus promíssa Dei? Absit. Si enim data esset lex, quæ
              posset vivificáre, vere ex lege esset justítia. Sed conclúsit
            ...
            <Text className="text-base">
              ...
              Àquele que nascerá de vós, isto é, Cristo». Portanto digo: Deus,
              tendo feito e confirmado uma aliança, a Lei, que foi dada somente
              quatrocentos e trinta anos depois, não poderá anular nem destruir
              a promessa. Ora, se pela Lei é que somos herdeiros da bênção, já
              esta não vem da promessa, ainda que tenha sido em virtude da
              promessa que a bênção foi dada a Abraão. Para que serve, pois, a
              Lei? Ela foi dada por causa das transgressões, até que viesse «a
              descendência», à qual havia sido feita a promessa. Ela foi
              promulgada pelos Anjos por meio dum mediador. Ora, um mediador o
              não é para um só, e Deus é um só. Logo é a Lei contrária à
              promessa de Deus? De nenhum modo. Se a Lei tivesse podido dar a
              vida verdadeira, então a justiça viria também, verdadeiramente, da
              Lei; mas a Escritura encerrou tudo sob o pecado, a fim de que a
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 89, 1</Text>{" "}
              Dómine, refúgium factus es nobis a generatióne et progénie.
              Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 89, 1</Text> De
              geração em geração, Senhor tendes sido o nosso refúgio. Aleluia.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              levavérunt vocem dicéntes: Jesu præcéptor, miserére nostri. Quos
              ut vidit, dixit: Ite, osténdite vos sacerdótibus. Et factum est,
              dum irent, mundáti sunt. Unus autem ex illis, ut vidit quia
              mundátus est, regréssus est, cum magna voce magníficans Deum, et
              cecidit in fáciem ante pedes ejus, grátias agens: et hic erat
              Samaritánus. Respóndens autem Jesus, dixit: Nonne decem mundáti
            ...
            <Text className="text-base">
              ...
              glorificando Deus em voz alta; e, prostrando-se com o rosto no
              chão, aos pés de Jesus, deu-Lhe graças! Este era samaritano. Jesus
              disse: «Porventura não foram os dez curados? Onde estão, pois, os
              outros nove? Não houve senão este estrangeiro que viesse e
