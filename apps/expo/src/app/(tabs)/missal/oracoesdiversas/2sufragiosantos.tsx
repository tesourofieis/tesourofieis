    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> et ómnibus Sanctis, salutem
          nobis tríbue benígnus et pacem; ut, destrúctis adversitátibus et
          erróribus univérsis, Ecclésia tua secúra tibi sérviat libertáte. Per
          eúndem Dóminum...
        </p>
        <p>
          ...
          <span className="text-red-500">N.</span> (nome do Patrono da Igreja) e
          de todos os Santos, concedei-nos benigno a salvação e a paz, a fim de
          que, destruídas todas as adversidades e erros, a vossa Igreja possa
          servir-Vos com segurança e liberdade. Pelo mesmo nosso Senhor...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> et ómnibus Sanctis; a cunctis
          nos reddat et perversitátibus expiátos, et adversitátibus expedítos.
          Per eúndem Dóminum...
        </p>
        <p>
          ...
          B. <span className="text-red-500">N.</span> (nome do Patrono da
          Igreja) e de todos os Santos, nos sirva de expiação dos nossos pecados
