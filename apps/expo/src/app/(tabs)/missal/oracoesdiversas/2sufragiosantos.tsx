        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              Paulo, atque beáto <Text className="text-base latin">N.</Text> et
            ...
            <Text className="text-base vernacular">
              ...
              Paulo, do B. <Text className="text-base vernacular">N.</Text>{" "}
              (nome do Patrono da Igreja) e de todos os Santos, concedei-nos
              benigno a salvação e a paz, a fim de que, destruídas todas as
              adversidades e erros, a vossa Igreja possa servir-Vos com
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              <Text className="text-base latin">N.</Text> et ómnibus Sanctis; a
            ...
            <Text className="text-base vernacular">
              ...
              Paulo, do B. <Text className="text-base vernacular">N.</Text>{" "}
              (nome do Patrono da Igreja) e de todos os Santos, nos sirva de
              expiação dos nossos pecados e nos livre de todas as adversidades.
