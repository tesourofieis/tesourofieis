        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              <Text className="text-base latin">N.</Text>, quem pastórem
              Ecclésiæ tuæ præésse voluísti, propítius réspice: da ei, quǽsumus,
              verbo et exémplo, quibus præest, profícere; ut ad vitam, una cum
              grege sibi crédito, pervéniat sempitérnam. Per Dóminum...
            </Text>
            <Text className="text-base vernacular">
              Ó Deus, pastor e guia de todos os fiéis, olhai propício para o
              vosso servo <Text className="text-base vernacular">N.</Text>, que
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              et fámulum tuum <Text className="text-base latin">N.</Text>, quem
              pastórem Ecclésiæ tuæ præésse voluísti; una cum commísso sibi
