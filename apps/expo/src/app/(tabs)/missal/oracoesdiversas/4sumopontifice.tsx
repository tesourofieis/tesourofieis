        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text>, quem pastórem Ecclésiæ
            ...
            <Text className="text-base">
              ...
              vosso servo <Text className="text-red-500">N.</Text>, que
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text>, que constituístes Pastor
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              et fámulum tuum <Text className="text-red-500">N.</Text>, quem
