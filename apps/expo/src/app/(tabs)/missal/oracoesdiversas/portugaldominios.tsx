      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="text-base">
            ...
            exército; concedei a paz e a prosperidade aos nossos tempos e
            afastai da nossa Igreja toda a maldade, destruindo a soberba dos
            pagãos e dos hereges com o poder da vossa dextra. (Por nosso
            Senhor... ou Pelo mesmo nosso Senhor segundo a conclusão da Oração,
            da Secreta ou do Postcomúnio a que fica acrescentada) ADVERTÊNCIAS:
          </Text>
          <Text className="aside">
            ...
            «Pelo Papa», omitir-se-ão as Palavras «o nosso Papa»; o mesmo quanto
            ao nome do Antístite, quando a Sé Diocesana estiver vaga. Se se
            recitar a Oração «A Cunctis», omitir-se-ão as Palavras: «concedei a
            paz e a prosperidade aos nossos tempos e afastai da nossa Igreja
            toda a maldade». Quando se diz a Oração «Pela Igreja omitem-se estas
            Palavras: «afastai da nossa Igreja toda a maldade». Quando se diz a
