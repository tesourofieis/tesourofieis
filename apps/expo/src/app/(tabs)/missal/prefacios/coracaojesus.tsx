        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              nostri flagráre numquam déstitit, piis esset réquies et
              pœniténtibus pater et salútis refúgium. Et ídeo cum Angelis et
            ...
            <Text className="text-base vernacular">
              ...
              Unigénito, suspenso na Cruz, fosse trespassado pela lança do
              soldado, a fim de que, aberto o Coração - sacrário da liberdade
              divina -, lançasse sobre nós torrentes de misericórdia e de graça;
              e, ardendo incessantemente de amor por nós, sirva de descanso aos
              piedosos e de asilo de salvação aos penitentes. E por isso, com os
              Anjos e Arcanjos, com os Tronos e Dominações e com toda a milícia
              celestial, cantamos o hino da vossa glória, dizendo sem cessar:
            </Text>
          </View>
        </View>
      </ScrollView>
