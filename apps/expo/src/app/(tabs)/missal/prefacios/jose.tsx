        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              magnificáre præcóniis, benedícere et prædicáre. Qui et vir justus,
              a te Deíparæ Vírgini Sponsus est datus: et fidélis servus ac
              prudens, super Famíliam tuam est constitútus: ut Unigénitum tuum,
              Sancti Spíritus obumbratióne concéptum, paterna vice custodíret,
              Jesum Christum, Dóminum nostrum. Per quem majestátem tuam laudant
              Angeli, adórant Dominatiónes, tremunt Potestátes. Cœli cœlorúmque
              Virtútes ac beáta Séraphim sócia exsultatióne concélebrant. Cum
            ...
            <Text className="text-base">
              ...
              proclamar, como convém, as vossas grandezas, bendizer-Vos e
              louvar-Vos. É ele o homem justo, que destinastes para esposo da
              Virgem Mãe de Deus; é ele o servo fiel e prudente, que colocastes
              na Sagrada Família, a fim de que guardasse, como se fora pai, o
              vosso Filho Unigénito, Jesus Cristo, nosso Senhor, concebido por
              operação do Espírito Santo; pelo qual os Anjos louvam a vossa
              majestade, as Dominações a adoram, as Potestades se prostram
              reverentes, os Céus e os bem-aventurados Serafins a celebram em
