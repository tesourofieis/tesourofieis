    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          quebrado. <em>Sl. ibid., 2</em> Bendirei o Senhor em todo o tempo: os
          seus louvores estarão sempre na minha boca. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Exultábunt Sancti in glória: lætabúntur in cubílibus suis. ℣. Cantáte
          Dómino cánticum novum: laus ejus in Ecclésia Sanctórum.
        </p>
        <p>
          Os Santos exultarão na glória: alegrar-se-ão na sua mansão. ℣. Cantai
          ao Senhor um cântico novo: que seus louvores permaneçam na assembleia
          dos Santos.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 67</em> Justi epuléntur, et exsúltent
          in conspéctu Dei: et delecténtur in lætítia. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 67</em> Inebriem-se os justos e exultem
          de alegria na presença de Deus! Que se deliciem na alegria. Aleluia.
        </p>
      </div>
