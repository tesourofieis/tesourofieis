        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              feridos. <Text className="em">Sl. 77, 1</Text> Atendei à minha
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              ℣. <Text className="em">Ps. 39, 11</Text> Justítiam tuam non
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 39, 11</Text> Não ocultei a vossa justiça
              no meu coração, publiquei a vossa verdade e a vossa salvação.
            </Text>
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Eccli. 49, 3-4</Text>{" "}
              Ipse est diréctus divínitus in pœniténtiam gentis, et tulit
              abominatiónes impietátis: et gubernávit ad Dóminum cor ipsíus: et
              in diébus peccatórum corroborávit pietátem. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Ecl. 49, 3-4</Text> Foi
