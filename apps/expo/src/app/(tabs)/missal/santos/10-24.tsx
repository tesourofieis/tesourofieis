    ...
    <SafeAreaView>
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">Léctio libri Tobíæ.</Text>
            <Text className="text-base">Lição do Livro de Tobias.</Text>
            <Text className="text-base">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. 146, 5</Text> Magnus Dóminus noster, et
              magna virtus ejus.
            </Text>
            <Text className="text-base">
              Rafael, o Anjo do Senhor, dominou o demónio e amarrou-o. ℣.{" "}
              <Text className="em">Sl. 146, 5</Text> Grande é o Senhor, nosso
              Deus; grande é o seu poder.
            </Text>
            <Text className="text-base">
