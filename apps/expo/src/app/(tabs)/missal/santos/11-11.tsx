  ...
  return (
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          Aleluia, aleluia. ℣. O bem-aventurado varão Martinho, Bispo de Tours,
          dormiu no Senhor: e os Anjos, os Arcanjos, os Tronos, as Dominações e
          as Virtudes o acolheram. Aleluia.
        </p>
      </div>
