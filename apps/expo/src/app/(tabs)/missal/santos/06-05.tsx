        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. 43, 2</Text> Deus, áuribus nostris
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 43, 2</Text> Ó Deus, ouvimos com os
              nossos ouvidos; os nossos pais contaram-nos o que fizestes nos
              seus dias. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Is. 66, 12</Text>{" "}
              Declinábo super eum quasi flúvium pacis, et quasi torréntem
              inundántem glóriam. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Is. 66, 12</Text> Farei
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Is. 66, 10 & 14</Text>{" "}
              Lætámini cum Jerúsalem, et exsultáte in ea, omnes, qui dilígitis
              Dóminum. Allelúja. ℣. Vidébitis, et gaudébit cor vestrum:
              cognoscétur manus Dómini servis ejus. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Is. 66, 10 & 14</Text>{" "}
