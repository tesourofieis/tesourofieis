        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. 95, 1</Text> Cantáte Dómino cánticum
            ...
            <Text className="text-base">
              ...
              cheias da glória do Senhor. <Text className="em">Sl. 95, 1</Text>{" "}
              Cantai ao Senhor um cântico novo: cantai ao Senhor, ó habitantes
              de toda a terra. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              tuæ comédit me. ℣. <Text className="em">Isai. 49, 2</Text> Pósuit
              os meum quasi gládium acutum: in umbra manus suæ protéxit me, et
            ...
            <Text className="text-base">
              ...
              <Text className="em">Is. 49, 2</Text> O Senhor tornou a minha boca
              como uma espada aguda: protegeu-me com a sombra da sua mão: e fez
              de mim como que uma seta escolhida.
            </Text>
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 70, 7</Text>{" "}
              Tamquam prodígium factus sum multis: et tu adjútor fortis,
              Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 70, 7</Text> Fui
