        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              cujus regni non erit finis. <Text className="em">Ps. 92, 1</Text>{" "}
              Dominus regnávit, decorem indutus est: indutus est Dominus
              fortitudinem, et præcínxit se. ℣. Gloria Patri...
            </Text>
            <Text className="text-base">
              ...
              seu reino não terá fim. <Text className="em">Sl. 92, 1</Text> O
              Senhor reinou e revestiu-se de majestade: o Senhor revestiu-se com
              a túnica da fortaleza e cingiu-se para o combate. ℣. Glória ao
              Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Christum, Salvatorem nostrum: ut, justificáti grátia ipsíus,
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 92, 1</Text> O
              Senhor reina e revestiu-se de majestade: o Senhor revestiu-se com
              a túnica da fortaleza e cingiu-se para o combate. Aleluia.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Joseph et Infántem pósitum in præsépio. Vidéntes autem cognovérunt
              de verbo, quod dictum erat illis de Púero hoc. Et omnes, qui
              audiérunt, miráti sunt: et de his, quæ dicta erant a pastóribus ad
              ipsos. María autem conservábat ómnia verba hæc, cónferens in corde
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              homem fez ao mesmo tempo realçar a sua divindade, assim também
