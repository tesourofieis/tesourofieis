        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              <Text className="text-base latin">ibid., 5</Text> Vitam pétiit a
              te: et tribuísti ei longitúdinem diérum in sæculum sæculi.
            </Text>
            <Text className="text-base vernacular">
              Concedestes-lhe, Senhor, bênçãos escolhidas, as mais suaves, e
              impusestes na sua cabeça uma coroa de pedras preciosas. ℣.{" "}
              <Text className="text-base vernacular">ibid., 5</Text>{" "}
              Concedestes-lhe a vida que Vos suplicou e prolongastes-lhe a
