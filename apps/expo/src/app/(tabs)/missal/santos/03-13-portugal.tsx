        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              Dómini. <Text className="text-base latin">Ps. ibid., 2</Text>{" "}
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              solíus. ℣. <Text className="text-base latin">Ps. 23, 6</Text> Hæc
              est generátio quæréntium Dóminum, quærémtium fáciem Dei Jacbob.
            </Text>
            <Text className="text-base vernacular">
              Que as virgens louvem o nome do Senhor: pois só o seu nome foi
              exaltado. ℣. Esta pertence à gereção das que procuram a face de
              Deus de Jacob.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              tui. <Text className="text-base latin">Ps. ibid., 13 & 10</Text>{" "}
              Vultum tuum deprecabúntur omnes divites plebis: filiæ regum in
              honóre tuo. ℣. <Text className="em">Ps. ibid., 16</Text>{" "}
            ...
            <Text className="text-base vernacular">
              ...
              vosso reino.{" "}
              <Text className="text-base vernacular">Ps. ibid., 13 & 10</Text>{" "}
              Todos os ricos da terra implorarão o vosso olhar: as filhas dos
              reis formarão a vossa corte. ℣.{" "}
