        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              Dómini. <Text className="em">Ps. ibid., 2</Text> Eructávit cor
            ...
            <Text className="text-base">
              ...
              palavra sublime: «Consagro ao Rei as minhas obras». ℣. Glória ao
              Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              solíus. ℣. <Text className="em">Ps. 23, 6</Text> Hæc est generátio
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              tui. <Text className="em">Ps. ibid., 13 & 10</Text> Vultum tuum
            ...
            <Text className="text-base">
              ...
              vosso reino. <Text className="em">Ps. ibid., 13 & 10</Text> Todos
              os ricos da terra implorarão o vosso olhar: as filhas dos reis
