    ...
    <SafeAreaView>
      <ScrollView>
        <View className="docs">
          ...
          tropece na pedra. Aquele que se abriga sob a protecção do Altíssimo e
          habita à sombra de Deus do céu. ℣. Glória ao Pai...
          <Text className="h3">Oração</Text>Ó Deus omnipotente e sempiterno, que
          com inefável providência destinais para cada nação um Anjo, que a
          guarde, concedei-nos, Vos suplicamos, que, pelas súplicas e pelo
          patrocínio do Anjo Custódio da nossa Nação, sejamos sempre livres de
          ...
          castelo, nem a sitiará com suas paliçadas. Volverá pelo mesmo caminho
          que veio e não entrará nesta cidade: assim diz o Senhor. Protegerei
          esta cidade e salvá-la-ei por amor de mim e por amor do meu servo
          Daniel», Naquela mesma noite, veio o Anjo do Senhor e feriu no
          acampamento dos Assírios cento e vinte e cinco mil homens; e, ao
          romper da manhã, viu-se que todos estavam mortos. Então Senaqueribe,
          rei dos Assírios, partiu e voltou para os seus domínios.
          <Text className="h3">Gradual</Text>O Anjo do Senhor acampará em redor
          dos que o temem e salvá-los-á. Clamaram os justos e o Senhor ouviu-os:
          ...
          ali até que te avise, porque Herodes procura o Menino para lhe tirar a
          vida». E José, então, levantando-se de noite, tomou o Menino e sua Mãe
          e partiu para o Egipto, onde permaneceu até à morte de Herodes, a fim
          de se cumprir o que havia sido anunciado pelo Senhor por meio do seu
          ...
          oferecemos, suplicando-Vos que, pelos sufrágios do vosso Anjo
          Custódio, sejamos livres de todas as adversidades. Por nosso Senhor...
