    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          in sanctificatióne ejus. <em>Ps. ibid., 1</em> Cantáte Dómino cánticum
          novum: cantáte Dómino, omnis terra. ℣. Gloria Patri...
        </p>
        <p>
          Rodeiam-no a glória e a majestade: e no seu santuário reluzem a
          santidade e a magnificência. <em>Sl. ibid., 1</em> Cantai em honra do
          Senhor um hino novo: que toda a terra cante hinos ao Senhor. ℣. Glória
          ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Probásti, Dómine, cor meum, et visitásti nocte. ℣. Igne me examinásti,
        ...
        <p>
          Allelúja, allelúja. ℣. Levíta Lauréntius bonum opus operátus est: qui
          per signum crucis cœcos illuminávit. Allelúja.
        </p>
        <p>
