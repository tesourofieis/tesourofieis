      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="comment">
            ...
            so santuários do Oriente. Morreu no século V, sob o pontificado de
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base latin">
              ...
              simus. Nam qui volunt dívites fíeri, incídunt in tentatiónem et in
              láqueum diáboli, et desidéria multa inutília et nocíva: quæ
              mergunt hómines in intéritum et perditiónem. Radix enim ómnium
              malórum est cupíditas: quam quidam appeténtes, erravérunt a fide,
              et inseruérunt se dolóribus multis. Tu autem, o homo Dei, hæc
              fuge: sectáre vero justítiam, pietátem, fidem, caritátem,
            ...
            <Text className="text-base vernacular">
              ...
              e de vestir, estejamos contentes, pois aqueles que querem ser
              ricos caem nas tentações e nas ciladas do demónio e em muitos
              outros desejos inúteis e perniciosos, que arrastam o homem para a
              ruína e perdição. A raiz de todos os males é, na verdade, a
              cobiça; e, assim, alguns, guiando-se por ela, afastaram-se da fé e
              enredaram-se em muitas aflições. Porém tu, ó homem de Deus, foge
              destas coisas e procura a justiça, a piedade, a fé, a caridade, a
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              ...
              quando, no tempo da regeneração, o Filho do homem se assentar no
              trono da sua glória, também vos assentareis sobre doze tronos,
              para julgar as doze tribos de Israel. Todo aquele que deixar a sua
              casa, ou os seus irmãos, ou os seus campos, ou o seu pai, ou a sua
