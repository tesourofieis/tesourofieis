      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="aside">
            ...
            torná-l'O simples criatura mais elevada que as outras, em graça.
            Deus suscita Santo Atanásio «enriquecendo-o do Espírito de
            sabedora», e «ungindo-o Bispo de Alexandria, com seu óleo santo»,
            pois o atleta de Cristo, pregou a verdade do Mestre, com inumerosos
            sacrifícios. Atanásio em 325 foi o arauto da ilustre assembleia dos
            318 bispos que condenaram Ario, no Concílio de Niceia, proclamando a
            Jesus, Filho consubstancial do Pai. É representado, muitas vezes,
          ...
          <View className="side-by-side not-content">
            <Text className="text-base">
              ...
              allelúja. <Text className="em">Ps. 91, 2</Text> Bonum est
            ...
            <Text className="text-base">
              ...
              glória, aleluia, aleluia. <Text className="em">Sl. 91, 2</Text> É
              bom louvar o Senhor e cantar o vosso nome, ó Altíssimo. ℣. Glória
              ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side not-content">
            ...
            <Text className="text-base">
              ...
              nostris ad illuminatiónem sciéntiæ claritátis Dei, in fácie
              Christi Jesu. Habémus autem thesáurum istum in vasis fictílibus:
              ut sublímitas sit virtútis Dei, et non ex nobis. In ómnibus
              tribulatiónem pátimur, sed non angustiámur: aperiántur, sed non
              destitúimur: persecutiónem pátimur, sed non derelínquimur:
              dejícimur, sed non perímus: semper mortificatiónem Jesu in córpore
              nostro circumferéntes, ut et vita Jesu manifestétur in corpóribus
              nostris. Semper enim nos, qui vívimus, in mortem trádimur propter
              Jesum: ut et vita Jesu manifestétur in carne nostra mortáli. Ergo
              mors in nobis operátur, vita autem in vobis. Habéntes autem eúndem
              spíritum fidei, sicut scriptum est: Crédidi, propter quod locútus
              sum: et nos crédimus, propter quod et lóquimur: sciéntes, quóniam,
            ...
            <Text className="text-base">
              ...
              sua luz nos nossos corações, a fim de que pudéssemos iluminar os
              outros com o conhecimento da glória de Deus, que resplandece na
              face de Jesus Cristo. Porém, possuímos este tesouro em vasos de
              barro, para que a sublimidade deste trabalho seja atribuída a Deus
              e não a nós. Sofremos tribulações em todas as coisas, mas não
              desanimamos; encontramo-nos em grandes apuros, mas não sucumbimos;
              somos perseguidos, mas não desesperamos; somos esmagados, mas não
              perecemos. Trazemos sempre no nosso corpo a morte de Jesus, a fim
              de que a vida de Jesus se manifeste também na nossa carne mortal;
              porque nós, que vivemos, somos incessantemente entregues à morte
              por causa de Jesus, a fim de que a vida de Jesus seja manifestada
              em nós. Desta maneira a morte opera em nós, e a vida em vós. Mas,
              visto que temos um mesmo espírito de fé, conforme o que está
              escrito: «acreditei e por isso falei», nós também acreditamos, por
              isso mesmo é que falamos, convencidos de que Aquele que
