        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              súpplices exorámus; ut, ipso intercedénte, eam advérsus erróris et
              pravitátis insídias perénni tua virtúte deféndas. Per Dóminum...
            </Text>
            <Text className="text-base vernacular">
              Ó Deus, que quisestes ilustrar a vossa Igreja com a brilhante
              erudição e com os méritos da preclara vida do B. Efrém, vosso
              Confessor e Doutor, humildemente Vos suplicamos que pela sua
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              ...
              que pela intercessão dos vossos Santos Mártires Marcos e
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              et Marcelliáno, renovémur efféctu. Per Dóminum...
            </Text>
            <Text className="text-base vernacular">
              Saciados com este dom salutar, humildemente Vos suplicamos que,
              havendo recebido com alegria este sacramento, sejamos, por
