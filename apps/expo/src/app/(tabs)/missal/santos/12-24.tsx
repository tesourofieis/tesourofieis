        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              vidébitis glóriam ejus. <Text className="em">Ps. 23, 1</Text>{" "}
              Dómini est terra, et plenitúdo ejus: orbis terrárum, et univérsi,
              qui hábitant in eo. ℣. Gloria Patri...
            </Text>
            <Text className="text-base">
              Sabereis hoje que o Senhor virá e nos salvará: e amanhã vereis a
              sua glória. <Text className="em">Sl. 23, 1</Text> Pertence ao
              Senhor a terra e tudo o que ela encerra: o orbe da terra e todos
              que nele habitam. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              secúndum carnem: qui prædestinátus est Fílius Dei in virtúte
              secúndum spíritum sanctificatiónis ex resurrectióne mortuórum Jesu
              Christi, Dómini nostri: per quem accépimus grátiam, et apostolátum
            ...
            <Text className="text-base">
              ...
              nasceu da geração de David, segundo a carne, e foi predestinado
              Filho de Deus, com o poder, segundo o Espírito de santidade, para
              ressuscitar dos mortos) N. S. Jesus Cristo, de quem recebemos a
              graça e o apostolado para chamar em seu nome à obediência da fé
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              queria difamá-la. Resolveu, pois, deixá-la secretamente. Pensando
              ele nisto, eis que um Anjo do Senhor lhe apareceu em sonhos e lhe
              disse: «José, filho de David, não temas receber Maria como tua
              esposa, porquanto o que ela concebeu é obra do Espírito Santo. Ela
