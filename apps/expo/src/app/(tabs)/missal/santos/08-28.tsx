      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base latin">
              Allelúja, allelúja. ℣.{" "}
              <Text className="text-base latin">Ps. 88, 21</Text> Invéni David
              servum meum, óleo sancto meo unxi eum. Allelúja.
            </Text>
            <Text className="text-base vernacular">
              Aleluia, aleluia. ℣.{" "}
              <Text className="text-base vernacular">Sl. 88, 21</Text> Encontrei
              o meu servo David e ungi-o com meu óleo sagrado. Aleluia.
            </Text>
          </View>
        </View>
      </ScrollView>
