        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. ibid., 1</Text> Beátus vir, qui timet
            ...
            <Text className="text-base">
              ...
              exaltado com glória. <Text className="em">Sl. ibid., 1</Text>{" "}
              Bem-aventurado o varão que teme o Senhor e que põe todo seu zelo
              em cumprir os seus Mandamentos. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Distribuiu liberalmente os seus bens pelos pobres: a sua justiça
              subsistirá em todos os séculos dos séculos. ℣. Sua descendência
