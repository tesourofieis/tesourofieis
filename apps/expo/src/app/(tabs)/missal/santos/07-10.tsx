        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. ibid., 2</Text> Sit nomen Dómini
              benedíctum: ex hoc nunc, ei usque in sǽculum. ℣. Gloria Patri...
            </Text>
            <Text className="text-base">
              ...
              <Text className="em">Sl. ibid., 2</Text> Bendito seja o nome do
              Senhor, agora e em todos os séculos. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Vos procuram. Jesus, respondendo àqueles que Lhe falaram, disse:
              «Quem é a minha mãe e quem são os meus irmãos?». E, estendendo a
              mão para os seus discípulos, disse: «Eis a minha mãe e os meus
