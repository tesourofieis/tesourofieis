        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. ibid., 1</Text> Bendizei o Senhor, ó
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              nunc egréssus sum, ut docérem te et intellégeres. Ab exórdio
              precum tuárum egréssus est sermo: ego autem veni, ut indicárem
              tibi, quia vir desideriórum es: tu ergo animadvérte sermónem et
              intéllege visiónem. Septuagínta hebdómades abbreviátæ sunt super
              pópulum tuum et super urbem sanctam tuam, ut consummétur
              prævaricátio, et finem accípiat peccatum, et deleátur iníquitas,
              et adducátur justítia sempitérna, et impleátur visio et prophetia,
              et ungátur Sanctus sanctórum. Scito ergo et animadvérte: Ab éxitu
              sermónis, ut íterum ædificétur Jerúsalem, usque ad Christum ducem,
              hebdómades septem et hebdómades sexagínta duæ erunt: et rursum
              ædificábitur platéa et muri in angustia temporum. Et post
              hebdómades sexagínta duas occidétur Christus: et non erit ejus
              pópulus, qui eum negatúrus est. Et civitátem et sanctuárium
            ...
            <Text className="text-base">
              ...
              «Daniel, eu vim, agora, para iluminar a tua inteligência. Desde o
              princípio das tuas preces foi proferida uma palavra. Ora, eu venho
              para que possas compreendê-la, pois és um varão favorecido por
              Deus. Medita, portanto, nessa palavra e compreende a visão.
              Setenta semanas estão marcadas para o teu povo e para a tua
              cidade, a fim de que a prevaricação seja consumada, o pecado cesse
              e seja destruída a iniquidade; e apareça a justiça eterna,
              cumpra-se a visão e a profecia e seja ungido o Santo dos Santos.
              Fica, pois, sabendo e atende bem: Desde que foi publicado o
              decreto para reedificar Jerusalém até Cristo-Rei, haverá sete
              semanas e sessenta e duas semanas; e, então, novamente, será
              reedificada com praças e muralhas, nos tempos angustiosos. Após
              sessenta e duas semanas, Cristo será morto e o povo que O negar
              não mais será considerado como seu povo. Um povo virá conduzido
              pelo seu chefe, que destruirá a cidade e o santuário; o seu fim
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 103, 4</Text> Qui
              facit Angelos suos spíritus: et minístros suos flammam ignis.
              Allelúja. ℣. <Text className="em">Luc. 1, 28</Text> Ave, María,
              grátia plena; Dóminus tecum: benedícta tu in muliéribus. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 103, 4</Text> Fazeis
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Jacob in ǽtérnum, et regni ejus non erit finis. Dixit autem María
              ...
              te Sanctum, vocábitur Fílius Dei. Et ecce, Elísabeth, cognáta tua,
              et ipsa concépit fílium in senectúte sua: et hic mensis sextus est
            ...
            <Text className="text-base">
              ...
              Maria. Entrando o Anjo onde ela estava, disse: «Eu te saúdo, cheia
              de graça: o Senhor é contigo: bendita és tu entre todas as
              ...
              casa de Jacob; e o seu reino não terá fim». Porém Maria disse ao
              Anjo: «Como acontecerá isso, se não conheço varão?». O Anjo,
              respondendo, disse-lhe: «O Espírito Santo descerá sobre ti, e a
              virtude do Altíssimo te tocará com sua sombra. Por isso o Santo
              que nascer de ti será chamado Filho de Deus. E eis que Isabel, tua
              parenta, concebeu um filho na sua velhice: este é o sexto mês
              daquela que é chamada estéril: porque nada é impossível a Deus».
