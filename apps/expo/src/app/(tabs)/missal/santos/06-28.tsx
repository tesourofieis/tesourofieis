...
export default function Page0628() {
  return (
    <div className="docs">
      <h1>Vigília de S. S. Pedro e Paulo, Aps., a 28 de Junho</h1>
      ...
      <aside>
        ...
        conservada, escreve D. Guéranger, e mostra compreender ele a grandeza do
        objecto apresentado pela Santa Liturgia a seu culto». Pedro crucificado
        (Intr., Ev.) domina, como Cristo, o mundo; sela, com o seu sangue, a
      ...
      <div className="side-by-side">
        <p>
          ...
          clarificatúrus esset Deum. <em>Ps. 18, 1</em> Cœli enárrant glóriam
          Dei: et ópera mánuum ejus annúntiat firmaméntum. ℣. Gloria Patri...
        </p>
        <p>
          ...
          <em>Sl. 18, 1</em> Os céus proclamam a glória de Deus e o firmamento
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Speciósa, ut péteret eleemósynam ab introeúntibus in templum. Is cum
          vidísset Petrum et Joánnem incipiéntes introíre in templum, rogábat,
          ut eleemósynam acciperet. Intuens autem in eum Petrus cum Joánne,
          dixit: Réspice in nos. At ille intendébat in eos, sperans se áliquid
          acceptúrum ab eis. Petrus autem dixit: Argéntum et aurum non est mihi;
          quod autem habeo, hoc tibi do: In nómine Jesu Christi Nazaréni surge,
          et ámbula. Et apprehénsa manu ejus déxtera, allevávit eum, et protínus
        ...
        <p>
          ...
          pedir esmola àqueles que entravam. Ora, havendo este homem visto Pedro
          e João, que iam a entrar no templo, pediu-lhes esmola. Então Pedro
          fixou os olhos nele, ao mesmo tempo que João, e disse-lhe: «Olha para
          nós». Ele fitou-os atentamente, esperando que lhe dessem alguma coisa.
          Mas Pedro disse-lhe: «Eu não tenho ouro, nem prata; mas dou-te aquilo
          que tenho. Em nome de Jesus Cristo Nazareno, levanta-te e caminha!».
          E, segurando-o pela mão direita, ergueu-o. Logo as suas pernas e os
          seus pés se firmaram, e o coxo, saltando pelos seus pés, se pôs de pé
          e começou a andar, entrando com eles no templo e caminhando, saltando
          e louvando Deus. E todo o povo o via caminhar e louvar Deus; e,
      ...
      <div className="side-by-side">
        <p>
          ...
          eórum. ℣. Cœli enárrant glóriam Dei: et ópera mánuum ejus annúntiat
          firmaméntum.
        </p>
        <p>
          O eco da sua voz espalhou-se por toda a terra: e as suas palavras
          soaram até aos confins da terra. ℣. Os céus proclamam a glória de Deus
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          illi: Etiam, Dómine, tu scis, quia amo te. Dicit ei: Pasce agnos meos.
          Dicit ei tértio: Simon Joánnis, amas me? Contristátus est Petrus, quia
          dixit ei tértio, Amas me? et dixit ei: Dómine, tu ómnia nosti: tu
          scis, quia amo te. Dixit ei: Pasce oves meas. Amen, amen, dico tibi:
          cum esses júnior, cingébas te et ambulábas, ubi volébas: cum autem
        ...
        <p>
          ...
          Jesus lhe perguntou: «Simão, filho de João, tu amas-me?». Pedro
          respondeu-Lhe: «Sim, Senhor, sabeis que Vos amo». Jesus disse-lhe:
          «Apascenta os meus cordeiros». Ainda Jesus lhe perguntou terceira vez:
          «Simão, filho de João, tu amas-me?». Contristou-se Pedro de que Ele
          lhe tivesse perguntado terceira vez se o amava, e disse-Lhe: «Senhor,
          conheceis tudo, e portanto sabeis que Vos amo». E Jesus disse-lhe:
          «Apascenta as minhas ovelhas. Em verdade, em verdade vos digo: quando
          eras mais novo, cingias-te a ti mesmo e ias onde querias; mas, quando
