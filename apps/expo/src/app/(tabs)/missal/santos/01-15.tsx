        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. ibid., 2</Text> Bonum est confitéri
            ...
            <Text className="text-base">
              ...
              do nosso Deus. <Text className="em">Sl. ibid., 2</Text> É bom
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Christum defriménta. Verúmtamen exístimo ómnia detriméntum esse
              propter eminéntem sciéntiam Jesu Christi, Dómini mei: propter quem
              ómnia detriméntum feci et árbitror ut stércora, ut Christum
              lucrifáciam et invéniar in illo, non habens meam justítiam, quæ ex
              lege est, sed illam, quæ ex fide est Christi Jesu: quæ ex Deo est
              justítia in fide, ad cognoscéndum illum, et virtútem
              ...
              autem, si quo modo comprehéndam, in quo et comprehénsus sum a
              Christo Jesu.
            </Text>
            <Text className="text-base">
              ...
              considerando-as como poeira, a fim de que ganhe a Cristo e me
              encontre com Ele, não com a minha própria justiça (a que vem da
              Lei), mas com aquela que nasce da fé em Jesus Cristo (a justiça
              que vem de Deus pela fé), para que o conheça a Ele, assim como ao
              mystério da sua Ressurreição, e tome parte nos seus sofrimentos,
              havendo-me confortado com sua morte, a fim de que possa de algum
              modo conseguir a ressurreição dos mortos. Não que eu a tenha
              alcançado, isto é, me haja tornado já perfeito; mas prossigo o
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Senhor do céu e da terra, pois ocultastes estas coisas aos sábios
              e aos prudentes e as revelastes aos pequenos. Sim, ó Pai, dou-Vos
              graças, porque assim o quisestes. Todas as coisas me foram dadas
              pelo meu Pai; e ninguém conhece o Filho senão o Pai, nem ninguém
              conhece o Pai senão o Filho, e aquele a quem o Filho o revelar.
              Vinde a mim, vós, todos, que trabalhais e estais sobrecarregados,
              o vos confortarei. Tomai sobre vós o meu jugo e aprendei de mim;
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Com o vosso poder, ó Senhor, se alegrará o justo, o qual exultará
