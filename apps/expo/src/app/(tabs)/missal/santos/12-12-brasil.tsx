      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Cant. 2, 12</Text>{" "}
              Flores apparuérunt in terra nostra, tempus putatiónis advénit.
              Allelúia.
            </Text>
            <Text className="text-base">
              Aleluta, aleluia. ℣. <Text className="em">Ct. 2, 12</Text> As
              flores apareceram em nossa terra; chegou o tempo da poda. Aleluía.
            </Text>
          </View>
