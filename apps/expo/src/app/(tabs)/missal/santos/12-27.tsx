  ...
  return (
    <SafeAreaView>
      <ScrollView>
        <View className="docs">
          <Text className="h1">
            S. João, Apóstolo e Evangelista, a 27 de Dezembro
          </Text>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              da glória. <Text className="em">Sl. 91, 2</Text> É bom louvar o
          ...
          <View className="side-by-side">
            <Text className="text-base">Lectio libri Sapiéntiæ.</Text>
            ...
            <Text className="text-base">
              ...
              salutáris potábit illum: et firmábitur in illo, et non flectétur:
              et continébit illum, et non confundétur: et exaltábit illum apud
              próximos suos, et in médio ecclésiæ apériet os ejus, et adimplébit
              illum spíritu sapiéntiæ et intelléctus, et stola glóriæ véstiet
            ...
            <Text className="text-base">
              ...
              inteligência e lhe dará a beber a água da sabedoria, que produz a
              salvação. Ela lhe dará uma opinião firme, e o não deixará se
              curvar. Ela o sustentará, e o não deixará cair em confusão. Ela o
              elevará no meio dos semelhantes; lhe abrirá a boca no meio da
              Igreja; o encherá de sabedoria e inteligência; e o revestirá com a
              túnica da glória. Guardará para ele um tesouro de alegria e de
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">ibid., 24</Text> Hic
              est discípulus ille, qui testimónium pérhibet de his: et scimus,
              quia verum est testimónium ejus. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">ibid., 24</Text> Este é
              o próprio discípulo que dá testemunho destas coisas; e sabemos que
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              tradet te? Hunc ergo cum vidísset Petrus, dixit Jesu: Dómine, hic
              autem quid? Dicit ei Jesus: Sic eum volo manére, donec véniam,
              quid ad te? tu me séquere. Exiit ergo sermo iste inter fratres,
              quia discípulus ille non móritur. Et non dixit ei Jesus: Non
              móritur; sed: Sic eum volo manére, donec véniam: quid ad te? Hic
            ...
            <Text className="text-base">
              ...
              havia perguntado: «Quem é aquele que vos trairá?». E Pedro,
              tendo-o visto, disse a Jesus: «Senhor, o que acontecerá a este?».
              Respondeu-lhe Jesus: «Se quero que assim permaneça, até que Eu
              venha, que te importa? Segue-me tu». Correu, então, entre os
              irmãos que aquele discípulo não havia de morrer. Ora Jesus não
              havia dito: «Não morrerá». Mas disse: «Se quero que ele permaneça
              assim, até que Eu venha, que te importa?». Este é o próprio
