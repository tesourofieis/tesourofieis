        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              est principatus eórum. <Text className="em">Ps. ibid., 1-2</Text>{" "}
              Dómine, probásti me et cognovísti me: tu cognovisti sessiónem meam
              et resurrectionem meam. ℣. Gloria Patri...
            </Text>
            <Text className="text-base">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              curationum, opitulatiónes, gubernatiónes, genera linguarum,
              interpretatiónes sermonum. Numquid omnes apóstoli? numquid omnes
              prophétæ? numquid omnes doctóres? numquid omnes virtútes? numquid
            ...
            <Text className="text-base">
              ...
              fazem milagres, em seguida os que têm o dom de curar, de assistir,
              de governar, de falar várias línguas e de interpretá-las. Porém
              são todos Apóstolos? São todos Profetas? São todos Doutores? Fazem
              todos milagres? Têm todos o dom de curar? Falam todos as línguas?
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Simónem, quem cognominávit Petrum, et Andream fratrem ejus,
              Jacóbum et Joánnem, Philíppum et Bartholomǽum, Matthǽum et Thomam,
              Jacóbum Alphǽi et Simónem, qui vocátur Zelótes, et Judam Jacóbi,
              et Judam Iscariótem, qui fuit próditor. Et descéndens cum illis,
              stetit in loco campéstri, et turba discipulórum ejus, et multitúdo
              copiósa plebis ab omni Judǽa, et Jerúsalem, et marítima, et Tyri,
              et Sidónis, qui vénerant, ut audírent eum et sanaréntur a
              languóribus suis. Et, qui vexabántur a spirítibus immúndis,
            ...
            <Text className="text-base">
              ...
              Apóstolos: Simão, a quem deu o cognome de Pedro, e André, seu
              irmão, Tiago e João, Filipe e Bartolomeu, Mateus e Tomé, Tiago,
              filho de Alfeu, e Simão, chamado o Zelote, Judas, irmão de Tiago,
              e Judas Iscariotes, que foi o traidor. E, descendo com eles, parou
              em um campo, onde encontrou a turba dos discípulos e uma grande
              multidão de povo de toda a Judeia, de Jerusalém e das paragens de
              Tiro e de Sidónia, que tinham vindo para O ouvirem e para que seus
              enfermos fossem curados. Entre eles havia alguns que estavam
              possessos de espíritos imundos, os quais foram curados. Toda
