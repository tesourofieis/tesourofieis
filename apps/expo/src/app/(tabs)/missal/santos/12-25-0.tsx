        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. ib., 1</Text> Quare fremuérunt gentes: et
              pópuli meditáti sunt inánia? ℣. Gloria Patri...
            </Text>
            <Text className="text-base">
              O Senhor disse-me: Sois o meu Filho: Eu Vos gerei hoje.{" "}
              <Text className="em">Sl. ib., 1</Text> Porque se agitaram as
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Salvatóris nostri Jesu Christi: qui dedit semetípsum pro nobis: ut
              nos redímeret ab omni iniquitáte, et mundáret sibi pópulum
            ...
            <Text className="text-base">
              ...
              e piedade, pensando na esperança, na bem-aventurança eterna e na
              vinda da glória do nosso grande Deus e Salvador, Jesus Cristo: que
              se ofereceu espontaneamente por nós, para nos resgatar de todas as
              iniquidades, e tornar-nos numa raça purificada, escolhida e zelosa
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 2, 7</Text>{" "}
              Dóminus dixit ad me: Fílius meus es tu, ego hódie génui te.
              Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 2, 7</Text> O Senhor
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Ascéndit autem et Joseph a Galilǽa de civitáte Názareth, in Judǽam
              in civitátem David, quæ vocatur Béthlehem: eo quod esset de domo
              et fámilia David, ut profiterétur cum María desponsáta sibi uxóre
              prægnánte. Factum est autem, cum essent ibi, impléti sunt dies, ut
              páreret. Et péperit fílium suum primogénitum, et pannis eum
              invólvit, et reclinávit eum in præsépio: quia non erat eis locus
              in diversório. Et pastóres erant in regióne eádem vigilántes, et
              custodiéntes vigílias noctis super gregem suum. Et ecce, Angelus
              Dómini stetit juxta illos, et cláritas Dei circumfúlsit illos, et
              timuérunt timóre magno. Et dixit illis Angelus: Nolíte timére:
              ecce enim, evangelízo vobis gáudium magnum, quod erit omni pópulo:
              quia natus est vobis hódie Salvátor, qui est Christus Dóminus, in
            ...
            <Text className="text-base">
              ...
              Galileia, da cidade de Nazaré, para a Judeia, e foi a Belém,
              cidade de David, porque ele era da casa e da família de David,
              para aí ser recenseado com Maria, sua esposa, que estava próximo a
              dar à luz. Ora, aconteceu que, enquanto eles estavam em Belém,
              completaram-se os dias em que ela devia dar à luz. E, com efeito,
              ela deu à luz o seu Filho primogénito, envolvendo-O em uns panos e
              colocando-O em um presépio, porque não tiveram lugar na
              hospedaria. Ora, havia naquele lugar uns pastores, guardando
              durante a noite os seus gados; e eis que um Anjo do céu lhes
              apareceu, envolvendo-os com a claridade de Deus, o que os encheu
              de grande temor. Então, o Anjo disse-lhes: «Não tenhais receio,
              pois venho anunciar-vos uma grande alegria, que se estenderá a
              todo o povo: é que nasceu hoje, na cidade de David, um Salvador,
              que é o Cristo Senhor. Isto vos servirá de sinal: Achareis um
              Menino, envolvido em uns panos e deitado num presépio», E no mesmo
              instante reuniu-se com o Anjo uma multidão da milícia celestial,
