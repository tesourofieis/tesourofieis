        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 117, 1</Text> Louvai o Senhor, porque Ele
              é bom; a sua misericórdia permanecerá em todos os séculos dos
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Eccli. 24, 18</Text>{" "}
              Quasi palma exaltáta sum in Cades, et quasi plantátio rosæ in
              Jéricho. ℣. <Text className="em">ibid., 20</Text> Sicut cinnamómum
              et bálsamum aromatízans odórem dedi: quasi myrrha elécta dedi
              suavitátem odóris. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Ecl. 24, 18</Text> Fui
