      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="aside">
            ...
            Foram, em seguida para Milão, onde os pagãos os prenderam e os
            fizeram degolar, cerca do ano 68. Em 395 seus corpos foram
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              per aquam nímiam. Inimícos autem illórum demérsit in mare, et ab
            ...
            <Text className="text-base">
              ...
              atravessar o mar Vermelho e guiou-os através das águas caudalosas.
              E submergiu no mar os seus inimigos, arrojando à praia os
              cadáveres. Eis porque os justos arrebataram os despojos dos
