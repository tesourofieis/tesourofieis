...
export default function Page0716() {
  return (
    <div className="docs">
      <h1>B. Virgem Maria do Monte Carmelo, a 16 de Julho</h1>
      ...
      <aside>
        ...
        Jesus por João Baptista, abraçaram a fé cristã e foram os primeiros a
        erigir à Santíssima Virgem um Santuário sobre o Monte Carmelo, no mesmo
        lugar onde Elias tinha outrora visto levantar-se uma nuvem, figura da
        fecundidade da Mãe de Deus. Foram chamados: Irmãos da Bem-aventurada
        Maria do Monte Carmelo (Or.). Esses religiosos vieram à Europa, no
        século XIII e, em 1245, Inocêncio IV aprovou-lhes a regra sob o
        generalato se S. Simão Stock. A 16 de Julho de 1251, Maria apareceu a
        seu ferveroso servo, entregando-lhe o hábito que devia ser o sinal
        distintivo da Ordem. Inocêncio IV, abençoou essa veste, concedendo-lhe
        numerosos privilégios, não só para os membros da Ordem, mas também para
        todos os que entrassem para a Confraria de Nossa Senhora do Monte
        Carmelo. Trazendo o escapulário, redução do grande escapulário dos
        Padres Carmelitas, participam eles de todos os seus méritos, e podem
        esperar da Santíssima Virgem pronta libertação do purgatório, se forem
        fiéis em observar a abstinência, a castidade conforme o seu estado de
        vida e as orações prescritas por João XXII na bula dita Sabatina,
      ...
      <div className="side-by-side">
        <p>
          ...
          Fílium Dei. <em>Ps. 44, 2</em> Eructávit cor meum verbum bonum: dico
        ...
        <p>
          ...
          louvam unissonamente o Filho de Deus. <em>Sl. 44, 2</em> Meu coração
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          e da verdade; em mim existe toda a esperança da vida e da virtude.
          Vinde a mim, ó vós, que me desejais com ardor, e saciai-vos com meus
          frutos; pois o meu espírito é mais doce do que o mel e a minha herança
          excede em doçura o próprio favo de mel! Minha memória permanecerá nas
          gerações de todos os séculos. Aqueles que me comerem terão ainda fome;
      ...
      <div className="side-by-side">
        <p>
          ...
          invénta es Mater Salvatóris. ℣. Virgo, Dei Génetrix, quem totus non
          capit orbis, in tua se clausit víscera factus homo.
        </p>
        <p>
          Bendita e venerável sois, ó Virgem Maria, que, sem a mais leve mancha
          de impureza, fostes a Mãe do Salvador. ℣. Ó Virgem, Mãe de Deus,
          Aquele que nem todo o universo é capaz de conter, esteve encerrado no
          vosso seio, fazendo-se homem.
        </p>
        <p>
          Allelúja, allelúja. ℣. Per te, Dei Génetrix, nobis est vita pérdita
          data: quæ de cœlo suscepísti prolem, et mundo genuísti Salvatórem.
          Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. Por vós, ó Mãe de Deus, nos foi restituída a vida
          que havíamos perdido! Vós recebestes do céu a graça de serdes Mãe,
          gerando o Salvador do mundo. Aleluia.
        </p>
      </div>
