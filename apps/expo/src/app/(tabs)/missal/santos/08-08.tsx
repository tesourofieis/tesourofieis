        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              defícient omni bono. <Text className="em">Ps. ib., 2</Text>{" "}
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. ib., 2</Text> Bendirei o Senhor em todo o
              tempo: sempre estará na minha boca o seu louvor. ℣. Glória ao
              Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Sap. 3, 7</Text>{" "}
              Fulgébunt justi, et tamquam scintíllæ in arundinéto current in
              ætérnum. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sb. 3, 7</Text> Os
              justos brilharão; e, como as faíscas de fogo em um canavial,
