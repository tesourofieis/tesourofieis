        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. 83, 2</Text> Quam dilécta tabernácula
            ...
            <Text className="text-base">
              ...
              as suas maravilhas. <Text className="em">Sl. 83, 2</Text> Quão
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              caritátem autem non habúero, nihil sum. Et si distribúere in cibos
              páuperum omnes facultátes meas, et si tradídere corpus meum, ita
              ut árdeam, caritátem autem non habúero, nihil mihi prodest.
              Cáritas pátiens est, benígna est: cáritas non æmulátur, non agit
              pérperam, non inflátur, non est ambitiósa, non quærit quæ sua
              sunt, non irritátur, non cógitat malum, non gaudet super
              iniquitáte, congáudet autem veritáti: ómnia suffert, ómnia credit,
            ...
            <Text className="text-base">
              ...
              Se eu distribuir todos meus bens para sustento dos pobres, e se
              entregar o meu corpo para ser queimado, mas não tiver caridade, de
              nada me aproveitará, A caridade é paciente, é benigna: não é
              invejosa, não é leviana, não é soberba, não é ambiciosa, não
              procura o próprio interesse, não se irrita, não julga mal, não se
              alegra com a injustiça, antes se regozija com a verdade, sofre
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Eccli. 11, 13</Text>{" "}
              Oculus Dei respéxit illum in bono, et eréxit eum ab humilitáte
              ipsíus, et exaltávit caput ejus. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Ecl. 11, 13</Text> Deus
