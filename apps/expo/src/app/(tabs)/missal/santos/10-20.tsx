        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              pastor gregem suum. <Text className="em">Ps. 1, 1</Text> Beátus
              vir, qui non ábiit in consílio impiórum, et in via peccatórum non
              stetit, et in cáthedra pestiléntiæ non sedit. ℣. Gloria Patri...
            </Text>
            <Text className="text-base">
              ...
              guia o seu rebanho. <Text className="em">Sl. 1, 1</Text>{" "}
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Prov. 31, 20</Text>{" "}
              Manum suam apéruit ínopi: et palmas suas exténdit ad páuperem.
              Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Pr. 31, 20</Text> Abriu
              a sua mão para o indigente: e estendeu os seus braços para o
              pobre. Aleluia.
            </Text>
          </View>
