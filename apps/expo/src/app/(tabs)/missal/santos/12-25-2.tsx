...
export default function Page12252() {
  return (
    <SafeAreaView>
      <ScrollView>
        <View className="docs">
          <Text className="h1">Terceira Missa Natal de N. S. Jesus Cristo</Text>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              os seus ombros o manto da realeza, o qual será chamado «Anjo do
              admirável conselho». <Text className="em">Sl. 97, 1</Text> Cantai
              ao Senhor um hino novo, pois Ele praticou maravilhas. ℣. Glória ao
              Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Multifáriam, multísque modis olim Deus loquens pátribus in
              Prophétis: novíssime diébus istis locútus est nobis in Fílio, quem
              constítuit herédem universórum, per quem fecit et sǽcula: qui cum
              sit splendor glóriæ, et figúra substántia? ejus, portánsque ómnia
              verbo virtútis suæ, purgatiónem peccatórum fáciens, sedet ad
              déxteram majestátis in excélsis: tanto mélior Angelis efféctus,
              quanto differéntius præ illis nomen hereditávit. Cui enim dixit
              aliquándo Angelórum: Fílius meus es tu, ego hódie génui te? Et
              rursum: Ego ero illi in patrem, et ipse erit mihi in fílium? Et
              cum íterum introdúcit Primogénitum in orbem terræ, dicit: Et
              adórent eum omnes Angeli Dei. Et ad Angelos quidem dicit: Qui
              facit Angelos suos spíritus, et minístros suos flammam ignis. Ad
              Fílium autem: Thronus tuus, Deus, in sǽculum sǽculi: virga
              æquitátis, virga regni tui. Dilexísti justítiam et odísti
              iniquitátem: proptérea unxit te Deus, Deus tuus, óleo
              exsultatiónis præ particípibus tuis. Et: Tu in princípio, Dómine,
              terram fundásti: et ópera mánuum tuárum sunt cœli. Ipsi períbunt,
              tu autem permanébis; et omnes ut vestiméntum veteráscent: et velut
              amíctum mutábis eos, et mutabúntur: tu autem idem ipse es, et anni
              tui non defícient.
            </Text>
            <Text className="text-base">
              Deus, que falara muitas vezes e de muitas maneiras a nossos pais
              pelos Profetas, falou-nos nos últimos tempos pelo seu Filho, que
              constituíra herdeiro de todas as coisas, e por quem, também, criou
              os séculos, o qual, sendo a irradiação esplendorosa da sua glória
              e a figura da sua substância e sustentando todas as coisas com sua
              palavra omnipotente depois de nos haver purificado dos nossos
              pecados, assentou-se à dextra da majestade divina, no mais alto
              dos céus, tanto mais superior aos Anjos quanto mais excelente e
              maior é o nome que herdou. Com efeito, a qual dos Anjos disse Deus
              estas palavras: «Tu és o meu Filho, gerei-te hoje?». E ainda
              estoutras: «Eu serei sen Pai e Ele será para mim Filho?». E
              também, quando mandou o seu primogénito ao mundo, disse: «Que
              todos os Anjos de Deus O adorem!». E, pelo que respeita aos Anjos,
              a Escritura diz: «Ele, que aos Anjos faz ventos e aos seus
              ministros chamas de fogo». Mas a respeito do Filho exprime-se
              assim: «Vosso trono, ó Deus, será eterno; o ceptro da vossa
              realeza será um ceptro de justiça e de rectidão. Vós amastes a
              justiça e odiastes a iniquidade. Por isso, ó Deus, o vosso Deus (o
              Pai) Vos ungiu com o bálsamo da alegria, mais ainda do que àqueles
              que convosco participam da glória». E também disse: «Vós, Senhor,
              no princípio criastes a terra; os céus são obra das vossas mãos.
              Eles perecerão, mas Vós permanecereis; eles envelhecerão todos,
              como um vestido, e Vós os mudareis, como se fossem um manto, e
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Deus, ó povos de toda a terra. O Senhor manifestou o Salvador, que
              havia prometido: e manifestou a sua justiça aos olhos dos povos.
            </Text>
            <Text className="text-base">
              Allelúja, allelúja. ℣. Dies sanctificátus illúxit nobis: veníte,
              gentes, et adoráte Dóminum: quia hódie descéndit lux magna super
              terram. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. Um dia de santidade resplandeceu para nós:
              vinde, ó povos, e adorai o Senhor: pois hoje desceu a grande luz à
              terra. Aleluia.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Santificai, Senhor, pelo novo Nascimento do vosso Filho Unigénito,
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              sit ipse largítor: Qui tecum vivit et regnat...
            </Text>
            <Text className="text-base">
              Ó Deus omnipotente, dignai-Vos permitir que, assim como o Salvador
