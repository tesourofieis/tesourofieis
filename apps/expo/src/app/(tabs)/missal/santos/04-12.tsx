      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="text-base">
            Ó Deus, que pela pompa do martírio triunfal fizestes entrar glorioso
            na pátria celestial o B. Vítor, concedei-nos propício que, pugnando
            nós à sua imitação contra os nossos vícios, consigamos alcançar
          ...
          <Text className="text-base">
            ...
            pela intercessão dos vossos Santos fazei que sejamos participantes
