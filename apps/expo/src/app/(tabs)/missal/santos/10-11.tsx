  ...
  return (
    <SafeAreaView>
      <ScrollView>
        <View className="docs">
          <Text className="h1">
            Maternidade da B. Virgem Maria, a 11 de Outubro
          </Text>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              Emmánuel. <Text className="em">Ps. 97, 1</Text> Cantáte Dómino
              cánticum novum: quia mirabília fecit. ℣. Gloria Patri...
            </Text>
            <Text className="text-base">
              Eis que a virgem conceberá e dará à luz um Filho, cujo nome será
              Emanuel. <Text className="em">Sl. 97, 1</Text> Cantai ao Senhor um
              cântico novo, porque Ele praticou maravilhas. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              é verdadeira Mãe de Deus, assim sejamos auxiliados na vossa
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              et notos. Et non inveniéntes, regréssi sunt in Jerúsalem,
              requiréntes eum. Et factum est, post tríduum invenérunt illum in
              templo sedéntem in médio doctórum, audiéntem illos, et
              interrogántem eos. Stupébant autem omnes, qui eum audiébant, super
              prudéntia et respónsis ejus. Et vidéntes admiráti sunt. Et dixit
              mater ejus ad illum: Fili, quid fecísti nobis sic? ecce pater
              tuus, et ego doléntes quærebámus te. Et ait ad illos: Quid est
              quod me quærebátis? nesciebátis quia in his, quæ Patris mei sunt,
              opórtet me esse. Et ipsi non intellexérunt verbum, quod locútus
            ...
            <Text className="text-base">
              ...
              viagem, procurando-O depois entre os parentes e conhecidos. Não O
              encontrando, voltaram logo a Jerusalém pelo mesmo caminho. Então
              aconteceu que, depois de três dias, foram achá-l’O no templo,
              assentado entre os doutores, ouvindo-os e interrogando-os. E
              aqueles que O ouviam estavam admirados da sua sabedoria e das suas
              respostas. Quando os pais O encontraram, ficaram admirados,
              dizendo-Lhe logo a Mãe: «Meu Filho, porque procedestes assim para
              connosco? Eis que vosso Pai e eu Vos buscávamos aflitos?!». Ele
              disse-lhes: «Porque me procuráveis? Não sabeis que é preciso que
              me ocupe das coisas de meu Pai?». Porém, eles não compreenderam o
