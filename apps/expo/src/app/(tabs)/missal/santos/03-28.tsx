        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 80, 2</Text> Exultai de alegria, louvando
              Deus, que é o nosso sustentáculo: aclamai com júbilo Deus de
              Jacob. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              omnípotens nomen ejus. ℣. <Text className="em">Judith 16, 3</Text>{" "}
            ...
            <Text className="text-base">
              ...
              omnipotente. ℣. <Text className="em">Jdt. 16, 3</Text> O Senhor é
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 58, 17</Text> Ego
              autem cantábo fortitúdinem tuam: et exsultábo mane misericórdiam
              tuam. Allelúja. ℣. Quia factus es suscéptor meus, et refúgium meum
              in die tribulatiónis meæ. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 58, 17</Text> Eu,
