        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. 29, 2</Text> Exaltábo te, Dómine, quóniam
              suscepísti me: nec delectásti inimícos meos super me. ℣. Gloria
              Patri...
            </Text>
            <Text className="text-base">
              ...
              <Text className="em">Sl. 29, 2</Text> Louvar-Vos-ei, Senhor,
              porque me protegestes e não consentistes que meus inimigos
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              de toda a mácula, assim também por sua intercessão sejamos
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              cœlos, áderam: quando certa lege et gyro vallábat abýssos: quando
              ǽthera firmábat sursum et librábat fontes aquárum: quando
              circúmdabat mari términum suum et legem ponébat aquis, ne
              transírent fines suos: quando appendébat fundaménta terræ. Cum eo
              eram cuncta compónens: et delectábar per síngulos dies, ludens
              coram eo omni témpore: ludens in orbe terrárum: et delíciæ meæ
              esse cum filiis hóminum. Nunc ergo, filii, audíte me: Beáti, qui
              custódiunt vias meas. Audíte disciplínam, et estóte sapiéntes, et
              nolíte abjícere eam. Beátus homo, qui audit me et qui vígilat ad
            ...
            <Text className="text-base">
              ...
              fontes não brotavam águas; nem as montanhas se erguiam sobre as
              suas pesadas massas; nem existiam as colinas. Já eu tinha sido
              dada à luz, e ainda Ele não havia criado nem a terra, nem os rios,
              nem os primeiros elementos do globo terrestre! Quando Ele
              preparava os céus, já eu lá estava; quando Ele cercava os abysmos,
              sujeitando-os a uma lei certa; quando Ele segurava as nuvens no
              alto; quando regulava as fontes das águas; quando fixava ao mar os
              seus limites para que as águas não invadissem a terra; quando
              lançava as bases da terra: já eu estava lá com Ele, regulando
              todas estas coisas, regozijando-me em cada dia, gozando
              continuamente a sua companhia, alegrando-me no globo da terra e
              deliciando-me em estar com os filhos dos homens. E agora, meus
              filhos, escutai-me: Bem-aventurados aqueles que transitam pelas
              minhas vias. Atendei às instruções, para que sejais prudentes. Não
              as rejeiteis. Bem-aventurado o homem que me escuta; que vigia
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">ibid., 15, 10</Text> Tu glória Jerúsalem, tu
            ...
            <Text className="text-base">
              ...
              <Text className="em">ibid., 15, 10</Text> Sois a glória de
              Jerusalém; sois a alegria de Israel; sois a honra do nosso povo.
            </Text>
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Cant. 4, 7</Text> Tota
              pulchra es, María: et mácula originális non est in te. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Ct. 4, 7</Text> Toda
              sois formosa, ó Maria; e a mácula original não existe em vós.
              Aleluia.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              era Maria. E, entrando o Anjo onde ela estava, disse-lhe: «Ave, ó
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              graça, foi isenta de toda a mácula, assim também por sua
