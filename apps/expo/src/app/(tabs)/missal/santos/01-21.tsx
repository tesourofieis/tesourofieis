        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              tuum nimis. <Text className="em">Ps. ibid., 1</Text> Beáti
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              ætérnum. ℣. <Text className="em">ibid., 5</Text> Propter veritátem
              et mansuetúdinem et justítiam: et dedúcet te mirabíliter déxtera
              tua.
            </Text>
            <Text className="text-base">
              A graça espalhou-se nos vossos lábios; por isso Deus vos abençoou
              para a eternidade. ℣. <Text className="em">ibid., 5</Text> Por
              amor da verdade, da mansidão e da justiça a vossa mão direita vos
              levará a praticar maravilhas.
            </Text>
            <Text className="text-base">
              Allelúja, allelúja. ℣.{" "}
              <Text className="em">Matth. 25, 4 & 6</Text> Quinque prudéntes
            ...
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Mt. 25, 4 & 6</Text> As
