        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 32, 1</Text> Aclamai o Senhor, ó justos;
              pois é aos que possuem o coração recto que pertence louvar o
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Matth. 11, 28</Text>{" "}
              Veníte ad me, omnes, qui laborátis et oneráti estis: et ego
              refíciam vos. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Mt. 11, 28</Text> Vinde
              a mim, vós, todos, que estais aflitos: e Eu vos aliviarei.
              Aleluia.
            </Text>
          </View>
