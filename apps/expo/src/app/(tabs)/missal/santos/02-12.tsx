        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 8, 2</Text> Ó Senhor, nosso Deus, como o
              vosso nome é glorioso em toda a terra! ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              eórum cum eis. ℣. <Text className="em">Eccli. 44, 14</Text>{" "}
              Córpora ipsorum in pace sepúlta sunt, et nomen eórum vivit in
            ...
            <Text className="text-base">
              ...
              <Text className="em">Ecl. 44, 14</Text> Seus corpos foram
              sepultados em paz e o seu nome vive de geração em geração.
            </Text>
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">ibid., 15</Text>{" "}
              Sapiéntiam ipsorum narrent pópuli, et laudem eórum núntiet
              Ecclésia. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">ibid., 15</Text>{" "}
              Publiquem os povos a sua sabedoria e cante a Igreja os seus
              louvores. Aleluia.
            </Text>
          </View>
