...
export default function Page1028() {
  return (
    <SafeAreaView>
      <ScrollView>
        <View className="docs">
          <Text className="h1">S. Simão e S. Judas, a 28 de Outubro</Text>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              deito e me levanto. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              sempitérnam et proficiéndo celebráre, et celebrándo profícere. Per
              Dóminum...
            </Text>
            <Text className="text-base">
              Ó Deus, que pelos vossos B. B. Apóstolos Simão e Judas nos
              proporcionastes o conhecimento do vosso Nome, concedei-nos a graça
              de celebrar a sua eterna glória, progredindo na virtude, e
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 138, 17</Text>{" "}
              Nimis honoráti sunt amíci tui, Deus: nimis confortátus est
              principátus eórum. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 138, 17</Text>{" "}
              Honrais largamente os vossos filhos, ó Deus; o seu poder tem-se
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              diligátis ínvicem. Si mundus vos odit: scitóte, quia me priórem
              vobis odio hábuit. Si de mundo fuissétis, mundus quod suum erat
              dilígeret; quia vero de mundo non estis, sed ego elegi vos de
              mundo, proptérea odit vos mundus. Mementóte sermónis mei, quem ego
              dixi vobis: Non est servus major dómino suo. Si me persecúti sunt,
              et vos persequántur: si sermónem meum servavérunt, et vestrum
              servábunt. Sed hæc ómnia fácient vobis propter nomen meum: quia
              nésciunt eum, qui misit me. Si non veníssent et locútus fuíssem
              eis, peccátum non háberent: nunc autem excusatiónem non habent de
              peccáto suo. Qui me odit: et Patrem meum odit. Si ópera non
              fecíssem in eis, quæ nemo álius fecit, peccátum non háberent: nunc
              autem et vidérunt et odérunt et me et Patrem meum. Sed ut
              adimpleátur sermo, qui in lege eórum scriptus est: Quia ódio
              habuérunt me gratis.
            </Text>
            <Text className="text-base">
              Naquele tempo, disse Jesus aos seus discípulos: «Recomendo-vos que
              vos ameis uns aos outros. Se o mundo vos odeia, lembrai-vos de que
              me odiou a mim antes. Se fôsseis do mundo, o mundo amaria o que
              lhe pertenceria; mas, como não sois do mundo e Eu vos escolhi do
              mundo, por isso ele vos odiará. Lembrai-vos de que vos disse: «O
              servo mais não é do que o senhor». Se, pois, me perseguiram,
              perseguir-vos-ão, também; se guardaram as minhas palavras,
              guardarão também as vossas. Farão todas estas coisas por causa do
              meu nome, porque não conhecem Aquele que me mandou. Se não tivesse
              vindo e lhes não houvesse falado, não seriam culpados; mas agora
              não têm desculpa do seu pecado. Quem me odeia, odeia também meu
              Pai. Se Eu no meio de vós não houvesse praticado obras, que
              ninguém pratica, não teriam pecado; porém, as viram e me odeiam,
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Venerando nós, Senhor, a perpétua glória dos vossos Santos
              Apóstolos Simão e Judas, purificai-nos, Vos imploramos, por estes
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              illórum veneránda gérimus passióne, nobis profíciant ad medélam.
              Per Dóminum...
            </Text>
            <Text className="text-base">
              Havendo participado destes sacramentos, Vos pedimos humildemente,
              Senhor, que pela intercessão dos vossos B. B. Apóstolos Simão e
