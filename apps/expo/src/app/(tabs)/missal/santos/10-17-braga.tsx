      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="text-base">
            Ó Deus, que de um modo admirável nos destes como primeiro Pastor o
            B. Mártir Pedro, permiti, Vos imploramos, que, celebrando a sua
          ...
          <Text className="text-base">
            ...
            daquele cujos méritos Vos foram agradáveis, elas nos sejam
            salutares. Por nosso Senhor...
          </Text>
          <Text className="h3">Postcomúnio</Text>
          <Text className="text-base">
            Humildemente Vos suplicamos, Senhor, que nos guardeis com a graça da
            contínua oração do B. Pedro, vosso Mártir e Pontífice, para que
            pelos seus méritos seja dignamente governada a Igreja que se ufana
            de o haver possuído como seu Padroeiro e Chefe. Por nosso Senhor...
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
