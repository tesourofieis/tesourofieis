        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. 102, 1</Text> Benedic, ánima mea, Dómino:
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 102, 1</Text> Bendizei, ó minha alma, o
              Senhor: que tudo quanto me pertence bendiga o seu santo nome. ℣.
              Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Thren. 1, 13</Text> De
              excélso misit ignem in óssibus meis, et erudívit me. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Lm. 1, 13</Text> Do alto
