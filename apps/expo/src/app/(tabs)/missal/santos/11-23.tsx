        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. 111, 1</Text> Beátus vir, qui timet
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 111, 1</Text> Bem-aventurado o varão que
              teme o Senhor: e cujo zelo é ardente no cumprimento dos seus
              mandamentos. ℣. Glória ao Pai...
            </Text>
          </View>
