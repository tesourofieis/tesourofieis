      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">Lição do Livro Êxodo.</Text>
            <Text className="text-base">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 102, 21</Text>{" "}
              Benedícite Dómino, omnes virtútes ejus: minístri ejus, qui fácitis
              voluntátem ejus. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 102, 21</Text>{" "}
              Bendizei todos o Senhor, ó exércitos do Senhor; pois estais ao seu
              serviço e desempenhais as suas ordens. Aleluia.
            </Text>
          </View>
