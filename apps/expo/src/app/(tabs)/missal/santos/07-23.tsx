      ...
      <ScrollView>
        <View className="docs">
          ...
          <View className="aside">
            ...
            os deveres dos que devem dirigir a Igreja, não como dominadores,
            porém, como modelos do rebanho. O Evangelho diz também «o que é
            maior deve ser como o último, e o que governa, como o que serve».
            Preso pelos falsos padres dos ídolos, foi cruelmente espancado e
            lançado na prisão, depois enviado para o exílio nas margens do
            Danúbio, na Trácia. Voltando a Ravena, foi novamente perseguido
            sendo martirizado no ano de 79, fazendo valer os talentos que Deus
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              forma facti gregis ex ánimo. Et cum apparúerit princeps pastórum,
              percipiétis immarcescíbilem glóriæ corónam. Simíliter
              adolescéntes, súbditi estóte senióribus. Omnes autem ínvicem
              humilitátem insinuáte: quia Deus supérbis resístit, humílibus
              autem dat grátiam. Humiliámini ígitur sub poténti manu Dei, ut vos
              exáltet in témpore visitatiónis: omnem sollicitúdinem vestram
              projiciéntes in eum, quóniam ipsi cura est de vobis. Sobrii
              estóte, et vigiláte: quia adversárius vester diábolus tamquam leo
              rúgiens círcuit, quærens quem dévoret: cui resístite fortes in
              fide: scientes eándem passiónem ei, quæ in mundo est, vestræ
              fraternitáti fíeri. Deus autem omnis grátiæ, qui vocávit nos in
              ætérnam suam glóriam in Christo Jesu, módicum passos ipse
            ...
            <Text className="text-base">
              ...
              apascentai o rebanho de Deus, que vos foi confiado, vigiando-o não
              por força, mas espontaneamente, segundo Deus; não por amor de um
              lucro vergonhoso, mas com zelo; não como querendo ter domínio
              despótico naqueles que são a herança do Senhor, mas tornando-vos
              de todo o coração modelos do rebanho. E, quando aparecer o
              príncipe dos pastores, recebereis na glória a coroa incorruptível.
              E vós, também, ó jovens, sede submissos aos sacerdotes.
              Revesti-vos todos de humildade uns para com os outros, porque Deus
              resiste aos soberbos e dá a graça aos humildes. Humilhai-vos,
              pois, sob a mão poderosa de Deus, para que Ele vos exalte no tempo
              da sua visita; lançai no seu seio todas vossas inquietações, pois
              o demónio, vosso adversário, gira em torno de vós, como um leão a
              rugir, procurando devorar-vos. Resisti-lhe, portanto, permanecendo
              firmes na fé e recordando-vos de que os vossos irmãos, espalhados
              pelo mundo, sofrem as mesmas aflições que vós. Depois de haverdes
              padecido um pouco, Deus de toda a graça, que nos chamou em Jesus
              Cristo à eterna glória, vos aperfeiçoará, confirmará e
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Ps. 109, 4</Text> Jurou
              o Senhor e não se arrependerá: tu és sacerdote para sempre segundo
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              major est, qui recúmbit, an qui mínistrat? nonne qui recúmbit? Ego
              autem in médio vestrum sum, sicut qui mínistrat. Vos autem estis,
              qui permansístis mecum in tentatiónibus meis: et ego dispóno
              vobis, sicut dispósuii mihi Pater meus regnum, ut edátis et
            ...
            <Text className="text-base">
              ...
              poder nela são chamados benfeitores. Mas entre vós não será assim;
              pois aquele que é o maior, faça-se como se fosse o menor; e aquele
              que governa, que se torne como o que serve. Dizei: qual é o maior:
              o que está à mesa ou o que serve? Não é verdade que é aquele que
              está à mesa? Ora Eu estou no meio de vós como aquele que serve. Já
              que ficastes comigo, constantemente, durante as minhas provações,
              preparo-vos um reino, como meu Pai o preparou para mim, a fim de
