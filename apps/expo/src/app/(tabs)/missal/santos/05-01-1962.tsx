        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. 126, 1</Text> Nisi Dóminus ædificáverit
              domum, in vanum labórant qui ædíficant eam. ℣. Gloria Patri...
            </Text>
            <Text className="text-base">
              ...
              aleluia. <Text className="em">Sl. 126, 1</Text> Se o Senhor não
              edificar a casa, em vão trabalharão os que a constroem. ℣. Glória
              ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Patri per ipsum. Quodcúmque fácitis ex ánimo operámini sicut
            ...
            <Text className="text-base">
              ...
              Tudo quanto fizerdes, seja em palavras, seja em obras, fazei-o em
              nome do Senhor Jesus Cristo, rendendo por Ele acções de graças a
              Deus Pai. Tudo o que fizerdes, fazei-o com generosidade de
              coração, como se o fizésseis para o Senhor e não para os homens,
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 36</Text> De
              quacúmque tribulatióne clamáverint ad me, exáudiam eos, et ero
              protéctor eórum semper. Allelúja. ℣. Fac nos innócuam, Joseph,
              decúrrere vitam: sitque tuo semper tuta patrocínio. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 36</Text> Em
              qualquer tribulação em que se encontrem e a mim recorram,
              ouvi-los-ei, e serei sempre o seu protector. Aleluia. ℣.
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              ejus dícitur María, et fratres ejus Jacóbus et Joseph et Simon et
              Judas? Et soróres ejus nonne omnes apud nos sunt? Unde ergo huic
              ómnia ista? Et scandalizabántur in eo. Jesus autem dixit eis: Non
            ...
            <Text className="text-base">
              ...
              do carpinteiro? Sua Mãe se não chama Maria e seus irmãos não são
              Tiago e José, Simão e Judas? Suas irmãs não estão todas entre nós?
              Donde, pois, Lhe vem tudo quanto vemos?». escandalizavam-se por
              sua causa. Então, Jesus disse-lhes: «Somente na sua pátria e na
