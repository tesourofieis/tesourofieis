        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              Convém que nos gloriemos na Cruz de nosso Senhor Jesus Cristo, que
              é a nossa salvação, vida e ressurreição: por quem fomos salvos e
              livres. <Text className="text-base vernacular">Sl. 66, 2</Text>{" "}
              Que o Senhor tenha misericórdia de nós e nos abençoe; que o Senhor
              nos ilumine com o brilho que resplandece da sua face, e se
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              terra cognóvimus, ejus redemptiónis prǽmia in cœlo mereámur. Per
              eúndem Dóminum...
            </Text>
            <Text className="text-base vernacular">
              Ó Deus, que neste dia nos regozijais com a festividade anual da
              Exaltação da Santa Cruz, concedei-nos, Vos imploramos, que
              obtenhamos no céu as recompensas adquiridas pela redenção operada
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base latin">
              ...
              cum in forma Dei esset, non rapinam arbitrátus est esse se æquálem
              Deo: sed semetípsum exinanívit, formam servi accipiens, in
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              ...
              Eis porque Deus O exaltou e Lhe deu um nome que é superior a todo
              o nome.
            </Text>
            <Text className="text-base latin">
              Allelúja, allelúja. ℣. Dulce lignum, dulces clavos, dúlcia ferens
              póndera: quæ sola fuísti digna sustinére Regem cœlórum et Dóminum.
              Allelúja.
            </Text>
            <Text className="text-base vernacular">
              Aleluia, aleluia. ℣. Ó doce lenho, ó doces cravos, que segurais um
              peso mais doce ainda! Só tu fostes digno de segurar o Rei e o
              Senhor dos céus. Aleluia.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base latin">
              In illo témpore: Dixit Jesus turbis Judæórum: Nunc judícium est
              mundi: nunc princeps hujus mundi ejiciátur foras. Et ego si
              exaltátum fuero a terra, ómnia traham ad meipsum. (Hoc autem
              dicébat, signíficans, qua morte esset moritúrus.) Respóndit ei
              turba. Nos audívimus ex lege, quia Christus manet in ætérnum: et
              quómodo tu dicis: Opórtet exaltári Fílium hóminis? Quis est iste
              Fílius hóminis? Dixit ergo eis Jesus: Adhuc módicum lumen in vobis
              est. Ambuláte, dum lucem habétis, ut non vos ténebræ
              comprehéndant: et qui ámbulat in ténebris, nescit, quo vadat. Dum
              lucem habétis, crédite in lucem, ut fílii lucis sitis.
            </Text>
            <Text className="text-base vernacular">
              Naquele tempo, disse Jesus às turbas dos judeus: «É agora que o
              mundo vai ser julgado; é agora que o príncipe deste mundo vai ser
              expulso. E Eu, quando for elevado acima da terra, atrairei todos a
              mim». (Isto dizia Ele para indicar o género de morte de que
              morreria). As turbas responderam-Lhe: «Aprendemos na Lei que
              Cristo permanecerá para sempre. Como, pois, dizeis: é necessário
              que seja elevado o Filho do homem? Quem é este Filho do homem?». E
              Jesus retorquiu-lhes: «A luz estará no meio de vós, ainda por
              algum tempo. Caminhai, pois, enquanto tiverdes luz, receando que
              as trevas vos cerquem. Aquele que caminha nas trevas, não sabe
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              et acceptábile fiat sacrifícium nostrum, allelúja.
            </Text>
            <Text className="text-base vernacular">
              Senhor, com o sinal da Santa Cruz livrai o vosso povo das insídias
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              noster; ut, sicut illud adoráre merúimus, ita perénniter ejus
              glóriæ salutáris potiámur efféctu. Per eúndem Dóminum...
            </Text>
            <Text className="text-base vernacular">
              Devendo alimentar-nos com o Corpo e o Sangue de nosso Senhor Jesus
              Cristo, que santificou o estandarte da Cruz, Vos rogamos, ó
              Senhor, nosso Deus, que, assim como logramos adorá-l’O na terra,
