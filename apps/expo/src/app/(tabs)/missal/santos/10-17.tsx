        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              gútturi meo. <Text className="em">Ps. 83, 2-3</Text> Quam dilécta
            ...
            <Text className="text-base">
              ...
              ao meu paladar. <Text className="em">Sl. 83, 2-3</Text> Como são
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              óbruent illam. ℣. <Text className="em">Ps. 72, 26</Text> Defécit
              caro mea et cor meum: Deus cordis mei, et pars mea Deus in
              ætérnum.
            </Text>
            <Text className="text-base">
              As águas caudalosas não puderam extinguir a caridade, nem os rios
              a submergiram. ℣. <Text className="em">Sl. 72, 26</Text> Meu corpo
              e o meu coração desfaleceram, ó Deus, que sois o Deus do meu
              coração e a minha herança na eternidade!
            </Text>
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Cant. 7, 10</Text> Ego
              dilécto meo, et ad me conversio ejus. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Ct. 7, 10</Text> Eu sou
