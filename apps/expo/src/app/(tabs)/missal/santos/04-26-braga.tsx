    ...
    <SafeAreaView>
      <ScrollView>
        <View className="docs">
          ...
          vestígios daquele por cujo ministério ela recebeu as primícias da fé.
          Por nosso Senhor...
          ...
          mercenário e porque não tem cuidado com as ovelhas. Eu sou o bom
          Pastor: eu conheço as minhas ovelhas, e as minhas ovelhas conhecem-me;
          assim como meu Pai me conhece e eu conheço meu Pai. Eu dou a minha
          vida pelas minhas ovelhas. Tenho ainda outras ovelhas que não
          pertencem a este aprisco; mas é preciso que eu as atraia e ouçam a
          minha voz, para que não haja senão um só aprisco e um só Pastor».
          <Text className="h3">Secreta</Text>
          Santificai, Senhor, os dons que Vos oferecemos, e pela intercessão do
          B. Pedro, vosso Mártir e Pontífice, e em virtude desses dons,
