    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 1-2</em> Dómine, probásti me et cognovísti me: tu
        ...
        <p>
          ...
          aleluia. <em>Sl. ibid., 1-2</em> Experimentastes-me, Senhor, e
          ficastes-me conhecendo: Ficastes conhecendo quando me deito e quando
          me levanto. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          Eis o dia que o Senhor fez: exultemos e alegremo-nos n’Ele. ℣. Louvai
          o Senhor, porque Ele é bom: e porque a sua misericórdia é eterna.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>1 Cor. 5, 7</em> Pascha nostrum immolátus
          est Christus.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>1 Cor. 5, 7</em> Cristo nossa Páscoa, foi
          imolado.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Ele vive e reina. Diz-nos, ó Maria, o que viste no caminho? Vi o
          sepulcro de Cristo, que está vivo; vi a glória de Cristo ressuscitado.
          Vi presentes os Anjos, o sudário e as vestes. Ressuscitou Cristo,
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          diziam umas às outras: «Quem nos tirará a pedra da entrada do
          sepulcro?». Olhando, então, viram que a pedra estava desviada para o
          lado: a qual, com efeito, era muito grande. Entrando no sepulcro,
          viram um jovem, assentado ao lado direito, vestido com uma túnica
          branca. Ficaram atónitas! Mas o jovem disse-lhes: «Não tenhais medo!
          Procurais a Jesus Nazareno, que foi crucificado? Ressuscitou, não está
