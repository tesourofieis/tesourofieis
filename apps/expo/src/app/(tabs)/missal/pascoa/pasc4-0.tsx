...
export default function PagePasc40() {
  return (
    <div className="docs">
      <h1>Quarto Domingo depois da Páscoa</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          allelúja, allelúja. <em>Ps. ibid., 1</em> Salvávit sibi déxtera ejus:
          et bráchium sanctum ejus. ℣. Gloria Patri...
        </p>
        <p>
          ...
          povos, aleluia, aleluia, aleluia. <em>Sl. ibid., 1</em> Alcançou
          vitória com sua dextra e com seu santo braço. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          fôssemos como primícias de suas criaturas. Bem o sabeis, irmãos
          dilectíssimos: todo o homem esteja sempre pronto para ouvir; seja
          lento em falar; e mais tardo em irar-se, pois a ira do homem não está
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 117, 16</em> Déxtera Dómini fecit
          virtútem: déxtera Dómini exaltávit me. Allelúja. ℣. <em>Rom. 6, 9</em>{" "}
          Christus resúrgens ex mórtuis jam non móritur: mors illi ultra non
          dominábitur. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Ps. 117, 16</em> A dextra do Senhor mostrou o
          poder: a dextra do Senhor exaltou-me. Aleluia. ℣. <em>Rm. 6, 9</em>{" "}
          Cristo ressuscitou dos mortos, já não morrerá: a morte não mais O
          vencerá. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          vobis: expédit vobis, ut ego vadam: si enim non abíero, Paráclitus non
          véniet ad vos: si autem abíero, mittam eum ad vos. Et cum vénerit
          ille. árguet mundum de peccáto et de justítia et de judício. De
          peccáto quidem, quia non credidérunt in me: de justítia vero, quia ad
          Patrem vado, et jam non vidébitis me: de judício autem, quia princeps
          hujus mundi jam judicátus est. Adhuc multa hábeo vobis dícere: sed non
          potéstis portáre modo. Cum autem vénerit ille Spíritus veritátis,
        ...
        <p>
          ...
          digo-vos a verdade: É necessário que eu vá, porque, se não for, o
          Consolador não descerá a vós; mas, se for, eu vo-l’O enviarei. E,
          quando Ele vier, convencerá o mundo acerca do pecado, da justiça e do
          juízo: acerca do pecado, porque não acreditaram em mim; acerca da
          justiça, porque vou para o Pai, e já me não vereis; e acerca do juízo,
          porque o soberano deste mundo já está julgado. Muitas coisas tenho
          ainda para vos dizer; mas, agora, não podeis compreendê-las. Quando o
          Consolador o Espírito da verdade vier, ensinar-vos-á toda a verdade.
