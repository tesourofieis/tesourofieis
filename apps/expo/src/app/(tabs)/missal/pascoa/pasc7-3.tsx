        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              allelúja. <Text className="em">Ps. ibid., 2</Text> Exsúrgat Deus,
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. ibid., 2</Text> Erga-se Deus e os seus
              inimigos sejam dispersos: e os seus perseguidores fujam diante da
              sua face. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              sicut vos æstimátis, hi ébrii sunt, cum sit hora diéi tértia: sed
              hoc est, quod dictum est per Prophétam Joël: Et erit in novíssimis
              diébus (dicit Dóminus) effúndam de Spíritu meo super omnem carnem,
              et prophetábunt fílii vestri et fíliæ vestræ, et júvenes vestri
              visiónes vidébunt, et senióres vestri sómnia somniábunt. Et quidem
              super servos meos et super ancíllas meas in diébus illis effúndam
              de Spíritu meo, et prophetábunt: et dabo prodígia in cœlo sursum
              et signa in terra deórsum, sánguinem et ignem et vapórem fumi. Sol
              convertátur in ténebras et luna in sánguinem, antequam véniat dies
            ...
            <Text className="text-base">
              ...
              homens não estão ébrios, coma pensais, pois é a hora terceira do
              dia; mas isto que vedes, foi anunciado pelo Profeta Joel:
              «Acontecerá nos últimos dias, diz o Senhor, que espalharei o meu
              Espírito sobre toda a carne; vossos filhos e filhas profetizarão ;
              vossos jovens terão visões; e vossos anciãos sonharão. E então,
              naqueles dias, espalharei o meu Espírito sobre os meus servos e
              servas, que profetizarão; e praticarei prodígios no alto do céu e
              sinais cá em baixo, na terra: sangue, fogo, rolos de fumo. O sol
              se tornará em trevas e a lua em sangue, antes que venha o dia do
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja. ℣. <Text className="em">Ps. 32, 6</Text> Verbo Dómini
              cœli firmáti sunt, et Spíritu oris ejus omnis virtus eórum.
            </Text>
            <Text className="text-base">
              Aleluia. ℣. <Text className="em">Sl. 32, 6</Text> A palavra do
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              magnificábat eos pópulus. Magis autem augebátur credéntium in
              Dómino multitúdo virórum ac mulíerum, ita ut in pláteas ejícerent
              infírmos, et pónerent in léctulis ac grabátis, ut, veniénte Petro,
              saltem umbra illíus obumbráret quemquam illórum, et liberaréntur
              ab infirmitátibus suis. Concurrébat autem et multitúdo vicinárum
            ...
            <Text className="text-base">
              ...
              todos os louvassem. O número dos homens e das mulheres que
              acreditavam em Deus crescia cada vez mais, de modo que conduziam
              os enfermos para as ruas e colocavam-nos em leitos e catres, para
              que, quando Pedro passasse, ao menos a sua sombra cobrisse alguns
              deles e os curasse das suas enfermidades. Até das cidades vizinhas
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              docíbiles Dei. Omnis, qui audívit a Patre et dídicit, venit ad me.
              Non quia Patrem vidit quisquam, nisi is, qui est a Deo, hic vidit
              Patrem. Amen, amen, dico vobis: qui credit in me, habet vitam
              ætérnam. Ego sum panis vitæ. Patres vestri manducavérunt manna in
              desérto, et mórtui sunt. Hic est panis de cœlo descéndens: ut, si
              quis ex ipso manducáverit, non moriátur. Ego sum panis vivus, qui
            ...
            <Text className="text-base">
              ...
              todos ensinados por Deus». Todo o que ouviu o Pai e O compreendeu
              vem a mim. Ninguém viu o Pai senão Aquele que vem de Deus; esse,
              sim, viu o Pai. Em verdade, em verdade vos digo: aquele que crê em
              mim possui a vida eterna. Eu sou o pão da vida. Vossos pais
              comeram o maná do deserto e morreram. Este é o pão descido do céu,
              a fim de que aquele que comer dele não morra. Eu sou o pão descido
