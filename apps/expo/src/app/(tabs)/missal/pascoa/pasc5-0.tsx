...
export default function PagePasc50() {
  return (
    <SafeAreaView>
      <ScrollView>
        <View className="docs">
          <Text className="h1">Quinto Domingo depois da Páscoa</Text>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              allelúja. <Text className="em">Ps. 65, 1-2</Text> Jubiláte Deo,
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 65, 1-2</Text> Ó povos de toda a terra,
              aclamai Deus com júbilo: cantai hinos em honra do seu nome:
              rendei-Lhe honras e louvores. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              in spéculo: considerávit enim se et ábiit, et statim oblítus est,
              qualis fúerit. Qui autem perspéxerit in legem perfectam libertátis
              et permánserit in ea, non audítor obliviósus factus, sed factor
              óperis: hic beátus in facto suo erit. Si quis autem putat se
              religiósum esse, non refrénans linguam suam, sed sedúcens cor
              suum, hujus vana est relígio. Relígio munda et immaculáta apud
            ...
            <Text className="text-base">
              ...
              rosto natural e, apenas o vê, retira-se, esquecendo logo o que
              era. Aquele, porém, que grava bem no espírito a lei perfeita da
              liberdade, e a enraíza em si, não ouvindo para logo esquecer, mas
              para praticar com suas acções o que ouviu, esse encontrará a
              felicidade nas suas acções. Se alguém pensa ser religioso, e não
              refreia a língua, engana o seu Próprio coração, e a sua religião é
              vã. A religião pura e imaculada para com o nosso Deus ai consiste
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="em">Jo. 16, 28</Text> Eu saí do Pai e vim ao
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              ut gáudium vestrum sit plenum. Hæc in provérbiis locútus sum
              vobis. Venit hora, cum jam non in provérbiis loquar vobis, sed
              palam de Patre annuntiábo vobis. In illo die in nómine meo
              petétis: et non dico vobis, quia ego rogábo Patrem de vobis: ipse
              enim Pater amat vos, quia vos me amástis, et credidístis quia ego
              a Deo exívi. Exívi a Patre et veni in mundum: íterum relínquo
              mundum et vado ad Patrem. Dicunt ei discípuli ejus: Ecce, nunc
              palam loquéris et provérbium nullum dicis. Nunc scimus, quia scis
            ...
            <Text className="text-base">
              ...
              recebereis, para que a vossa alegria seja perfeita. Tenho-vos dito
              estas coisas, servindo-me de parábolas. Chegou a hora em que vos
              não falarei por meio de parábolas a respeito do Pai, mas
              claramente. Nesse dia pedireis em meu nome, e não digo que pedirei
              por vós ao Pai, porque o próprio Pai vos ama, pois me amais e
              acreditastes que saí do Pai. Eu saí do Pai e vim ao mundo; e,
              agora, deixo o mundo e volto para o Pai». Então os discípulos
              disseram-Lhe: «Agora falais claramente e sem parábolas; agora
