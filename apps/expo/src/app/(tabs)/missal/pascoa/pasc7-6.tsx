        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. 102, 1</Text> Benedic, anima mea, Dómino:
              et ómnia, quæ intra me sunt, nómini sancto ejus. ℣. Gloria
              Patri...
            </Text>
            <Text className="text-base">
              O amor de Deus espalhou-se nos nossos corações, aleluia: pelo seu
              Espírito que habita em nós, aleluia, aleluia.{" "}
              <Text className="em">Sl. 102, 1</Text> Bendize o Senhor, ó minha
              alma: e que tudo o que existe em mim bendiga o seu santo nome. ℣.
              Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              servos meos et ancíllas in diébus illis effúndam Spíritum meum. Et
              dabo prodígia in cœlo et in terra, sánguinem et ignem et vapórem
              fumi. Sol convertétur in ténebras et luna in sánguinem: ántequam
            ...
            <Text className="text-base">
              ...
              enviarei o meu Espírito aos meus servos e servas; e farei
              prodígios no céu e na terra: sangue, fogo e nuvens de fumo. O sol
              converter-se-á em trevas e a lua em sangue, antes que chegue o
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja. ℣. <Text className="em">Joann. 6, 64</Text> Spíritus
              est, qui vivíficat: caro autem non prodest quidquam.
            </Text>
            <Text className="text-base">
              Aleluia. ℣. <Text className="em">Jo. 6, 64</Text> O Espírito é que
              dá a vida; pois a carne não dá nenhum proveito.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              spicárum, primítias messis vestræ ad sacerdótem: qui elevábit
              fascículum coram Dómino, ut acceptábile sit pro vobis, áltero die
              sábbati, et sanctificábit illum. Numerábitis ergo ab áltero die
              sábbati, in quo obtulístis manípulum primitiárum, septem
              hebdómadas plenas, usque ad álteram diem expletiónis hebdómadæ
              séptiniæ, id est, quinquagínta dies: et sic offerétis sacrifícium
              novum Dómino ex ómnibus habitáculis vestris, panes primitiárum
              duos de duábus decimis símilæ fermentátæ, quos coquétis in
              primítias Dómini. Et vocábitis hunc diem celebérrimum atque
              sanctíssimum: omne opus servíle non faciétis in eo. Legítimum
            ...
            <Text className="text-base">
              ...
              primícias da vossa ceifa». O sacerdote no dia seguinte ao sábado o
              apresentará perante o Senhor e o santificará, para que seja
              recebido em vosso favor. Então, contareis, desde o dia seguinte ao
              sábado (dia em que foi oferecido o molho de primícias) sete
              semanas inteiras até ao dia seguinte da sétima semana, isto é,
              cinquenta dias, e oferecereis ao Senhor nova oblação. Também
              trareis de vossas casas dois pães de primícias, que serão
              fabricados de duas dezenas da flor de farinha fermentada, os quais
              cozereis para as primícias do Senhor, para um sacrifício novo. A
              este dia chamareis soleníssimo e santíssimo; e não praticareis
              durante ele nenhum trabalho servil. Esta ordem será uma lei
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja. ℣. <Text className="em">Job 26, 13</Text> Spíritus ejus
              ornávit cœlos.
            </Text>
            <Text className="text-base">
              Aleluia. ℣. <Text className="em">Jb 26, 13</Text> Seu Espírito
              aformoseou os céus.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            <Text className="text-base">Léctio libri Deuteronómii.</Text>
            <Text className="text-base">Lição do Livro Deuteronómio.</Text>
            <Text className="text-base">
              ...
              habitáveris in ea: tolles de cunctis frúgibus tuis primítias, et
              pones in cartállo, pergésque ad locum, quem Dóminus, Deus tuus,
              elégerit, ut ibi invocétur nomen ejus: accedésque ad sacerdótem,
              qui fúerit in diébus illis, et dices ad eum: Profíteor hódie coram
              Dómino, Deo tuo, qui exaudívit nos, et respexit humilitátem
              nostram et labórem atque angústiam: et edúxit nos de Ægýpto in
              manu forti et bráchio exténto, in ingénti pavóre, in signis atque
              porténtis: et introdúxit ad locum istum, et trádidit nobis terram
              lacte et melle manántem. Et idcírco nunc óffero primítias frugum
              terræ, quam Dóminus dedit mihi. Et dimíttes eas in conspéctu
            ...
            <Text className="text-base">
              ...
              habitardes, tomareis as primícias de todos vossos frutos e,
              colocando-os em um cesto, ireis ao lugar que o Senhor, vosso Deus,
              tiver escolhido para ser honrado, e apresentá-lo-eis ao sacerdote
              que estiver em funções naquele dia, dizendo: «Declaro, hoje,
              perante o Senhor Deus, que Ele nos ouviu, atendeu à nossa miséria,
              trabalho e opressão e nos fez sair do Egipto com sua mão forte e
              pela força do seu braço, espalhando grande terror entre os povos
              com muitos milagres e prodígios, conduzindo-nos a este lugar e
              dando-nos esta terra, onde correm leite e mel. Por isso, agora,
              Lhe ofereço as primícias da terra, que me deu». Então colocareis
              as primícias diante do Senhor Deus e O adorareis. Depois
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja. ℣. <Text className="em">Act. 2, 1</Text> Cum
              compleréntur dies Pentecóstes, erant omnes páriter sedéntes.
            </Text>
            <Text className="text-base">
              Aleluia. ℣. <Text className="em">Act. 2, 1</Text> Tendo já chegado
              o dia de Pentecostes, estavam todos reunidos em assembleia.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              suis, et terra gignet germen suum, et pomis árbores replebúntur.
              Apprehéndet méssium tritúra vindémiam, et vindémia occupábit
              seméntem: et comedétis panem vestrum in saturitáte, et absque
              pavóre habitábitis in terra vestra. Dabo pacem in fínibus vestris:
              dormiétis, et non erit, qui extérreat. Auferam malas béstias, et
              gládius non transíbit términos vestros. Persequémini inimícos
              vestros, et córruent coram vobis. Persequéntur quinque de vestris
              centum aliénos et centum de vobis decem mília: cadent inimíci
              vestri gládio in conspéctu vestro. Respíciam vos et créscere
              fáciam: multiplicábo mini, et firmábo pactum meum vobíscum.
              Comedétis vetustíssima véterum, et vétera novis superveniéntibus
              projiciétis. Ponam tabernáculum meum in médio vestri, et non
            ...
            <Text className="text-base">
              ...
              própria, produzindo a terra frutos com abundância, assim como as
              árvores. A colheita do trigo prolongar-se-á até à vindima, e a
              vindima até à sementeira. Comereis pão com fartura e habitareis
              sem temor na vossa terra. Conceder-vos-ei a paz dentro das vossas
              fronteiras e dormireis sem que ninguém vos perturbe. Afujentarei
              os animais ferozes e a espada não atravessará as vossas
              fronteiras. Perseguirei os vossos inimigos, que cairão diante de
              vós. Cinco de vós terão força para perseguir cem estrangeiros; cem
              de vós perseguirão dez mil; os vossos inimigos cairão diante de
              vós, sob o peso das espadas. Olharei por vós e vos farei crescer.
              Multiplicar-vos-ei e farei aliança convosco. Comereis os frutos
              das colheitas atrasadas e lançareis fora os frutos antigos por
              causa da abundância dos novos. Estabelecerei a minha morada no
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja. ℣. <Text className="em">ibid., 52</Text> Benedíctus es,
              Dómine, Deus patrum nostrórum, et laudábilis in sǽcula.
            </Text>
            <Text className="text-base">
              Aleluia. ℣. <Text className="em">ibid., 52</Text> Bendito sois,
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Dei. Non solum autem, sed et gloriámur in tribulatiónibus:
              scientes, quod tribulátio patiéntiam operátur, patiéntia autem
              probatiónem, probátio vero spem, spes autem non confúndit: quia
            ...
            <Text className="text-base">
              ...
              esperança de alcançarmos a glória dos filhos de Deus. E não
              somente na esperança, mas também devemos ter glória nas
              tribulações, sabendo que a tribulação produz a paciência, a
              paciência produz a provação, e a provação a esperança. Ora a
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              dimísit illam. Et contínuo surgens, ministrábat illis. Cum autem
              sol occidísset, omnes qui habébant infírmos váriis languóribus,
              ducébant illos ad eum. At ille síngulis manus impónens, curábat
              eos. Exíbant autem dæmónia a multis clamántia et dicéntia: Quia tu
              es Fílius Dei: et íncrepans non sinébat ea loqui, quia sciébant
              ipsum esse Christum. Facta autem die egréssus ibat in desértum
              locum, et turbæ requirébant eum, et venérunt usque ad ipsum: et
              detinébant illum, ne discéderet ab eis. Quibus ille ait: Quia et
            ...
            <Text className="text-base">
              ...
              febre, que logo deixou a doente, levantando-se e servindo-os.
              Sendo já sol posto, todos os que tinham enfermos, atacados de
              diversas doenças, traziam-Lhos. E Jesus, impondo as mãos sobre
              cada um dos doentes, curava-os. De muitos saíam também demónios,
              gritando e dizendo: «Sois o Filho de Deus!». Ele repreendia-os, e
              os não deixava dizer que sabiam que Jesus era o Cristo. Sendo já
              de manhã, saiu e foi para um lugar deserto. As turbas
              procuravam-n’O, vieram até onde Ele estava e detiveram-n’O, com
              medo de que se afastasse. Jesus disse-lhes: «É preciso que anuncie
