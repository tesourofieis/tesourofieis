        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              allelúja. <Text className="em">Ps. 104, 1</Text> Confitémini
            ...
            <Text className="text-base">
              ...
              sempre, aleluia, aleluia. <Text className="em">Sl. 104, 1</Text>{" "}
              Louvai o Senhor e aclamai o seu nome: publicai as suas obras em
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Jerúsalem, et príncipes ejus, ignorántes Jesum et voces
              Prophetárum, quæ per omne sábbatum legúntur, judicántes
              implevérunt: et nullam causam mortis inveniéntes in eo, petiérunt
              a Piláto, ut interfícerent eum. Cumque consummássent ómnia, quæ de
              eo scripta erant, deponéntes eum de ligno, posuérunt eum in
              monuménto. Deus vero suscitávit eum a mórtuis tértia die: qui
              visus est per dies multos his, qui simul ascénderant cum eo de
              Galilǽa in Jerúsalem, qui usque nunc sunt testes ejus ad plebem.
              Et nos vobis annuntiámus eam, quæ ad patres nostros repromíssio
            ...
            <Text className="text-base">
              ...
              de salvação é dirigida. Os habitantes de Jerusalém e seus
              discípulos, havendo desprezado Jesus e as palavras dos Profetas,
              que lhes foram lidas em cada sábado, as cumpriram, condenando-O;
              e, ainda que não tivessem encontrado n’Ele nada que merecesse a
              morte, pediram a Pilatos que mandasse matá-l’O. Quando se cumpriu
              tudo quanto estava escrito a seu respeito, desceram-n’O da cruz e
              depositaram-n’O no sepulcro. Mas Deus ressuscitou-O dos mortos ao
              terceiro dia; e, durante vários dias, em seguida, foi visto por
              aqueles que haviam subido com Ele da Galileia para Jerusalém, os
              quais agora são suas testemunhas junto do povo. Nós, pois, vos
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. 106, 2</Text> Dicant nunc, qui redémpti
              sunt a Dómino: quos rédemit de manu inimíci, et de regiónibus
              congregávit eos.
            </Text>
            <Text className="text-base">
              Eis o dia que o Senhor fez: exultemos e alegremo-nos nele. ℣.{" "}
              <Text className="em">Sl. 106, 2</Text> Assim devem cantar agora
              aqueles que o Senhor resgatou e tirou das mãos dos inimigos, e
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              turbáti estis, et cogitatiónes ascéndunt in corda vestra? Vidéte
              manus meas et pedes, quia ego ipse sum: palpáte et vidéte: quia
              spíritus carnem et ossa non habet, sicut me vidétis habére. Et cum
              hoc dixísset, osténdit eis manus et pedes. Adhuc autem illis non
              credéntibus et mirántibus præ gáudio, dixit: Habétis hic aliquid,
              quod manducétur? At illi obtulérunt ei partem piscis assi et favum
              mellis. Et cum manducásset coram eis, sumens relíquias, dedit eis.
              Et dixit ad eos: Hæc sunt verba, quæ locútus sum ad vos, cum adhuc
              essem vobíscum, quóniam necésse est impléri ómnia, quæ scripta
              sunt in lege Móysi et Prophétis et Psalmis de me. Tunc apéruit
              illis sensum, ut intellégerent Scriptúras. Et dixit eis: Quóniam
              sic scriptum est, et sic oportébat Christum pati, et resúrgere a
            ...
            <Text className="text-base">
              ...
              disse-lhes: «Porque vos perturbais e porque se levantam
              pensamentos de dúvida nos vossos corações? Vede as minhas mãos e
              os meus pés; sou Eu mesmo. Apalpai e vede; pois um espírito não
              tem carne, nem ossos, como Eu tenho». Depois que lhes disse isto,
              mostrou-lhes as mãos e os pés. Então, como não acreditassem ainda
              (na cegueira da alegria em que estavam), disse-lhes: «Tendes aí
              alguma coisa para comer?». Apresentaram-Lhe um bocado de peixe
              assado e um favo de mel. E, havendo comido perante eles, tomou os
              restos e deu-lhos. Depois disse-lhes: «Eis o que vos dizia quando
              ainda estava convosco: que era preciso que se cumprisse, tudo o
              que estava escrito a meu respeito na lei de Moisés, nos Profetas e
              nos Salmos». Então iluminou-lhes o espírito, para que
              compreendessem as Escrituras. Depois disse-lhes: «Está também
              escrito: «Convinha que Cristo padecesse, ressuscitasse dos mortos
