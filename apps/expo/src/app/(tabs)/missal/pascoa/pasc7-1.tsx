        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. ibid., 2</Text> Exsultáte Deo, adjutóri
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. ibid., 2</Text> Louvai alegremente o
              Senhor, que é o nosso sustentáculo; aclamai com hinos de alegria o
              Deus de Jacob. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              omnes Prophétæ testimónium pérhibent, remissiónem peccatórum
              accípere per nomen ejus omnes, qui credunt in eum. Adhuc loquénte
              Petro verba hæc, cecidit Spíritus Sanctus super omnes, qui
              audiébant verbum. Et obstupuérunt ex circumcisióne fidéles, qui
              vénerant cum Petro: quia et in natiónes grátia Spíritus Sancti
              effúsa est. Audiébant enim illos loquéntes linguis et
              magnificántes Deum. Tunc respóndit Petrus: Numquid aquam quis
              prohibére potest, ut non baptizéntur hi, qui Spíritum Sanctum
            ...
            <Text className="text-base">
              ...
              Profetas afirmam a seu respeito que aqueles que acreditarem n’Ele
              receberão a remissão dos pecados pelo poder do seu nome». Eis que,
              enquanto Pedro falava, desceu o Espírito Santo sobre aqueles que
              escutavam as suas palavras. E os fiéis circundados, que tinham
              vindo com Pedro, admiraram-se de que a graça do Espírito Santo
              descesse também sobre os pagãos, pois ouviram-nos falar diversas
              línguas e dar glória a Deus. Então, disse Pedro: «Acaso poder-se-á
              recusar e Baptismo àqueles que, como vós, receberam o Espírito
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Act. 2, 4</Text>{" "}
              Loquebántur váriis linguis Apóstoli magnália Dei. Allelúja.{" "}
              <Text className="em">hic genuflectitur</Text> ℣. Veni, Sancte
              Spiritus, reple tuorum corda fidélium: et tui amóris in eis ignem
              accénde.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Act. 2, 4</Text> Os
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              in mundum, ut júdicet mundum, sed ut salvétur mundus per ipsum.
              Qui credit in eum, non judicátur; qui autem non credit, jam
              judicátus est: quia non credit in nómine unigéniti Fílii Dei. Hoc
              est autem judícium: quia lux venit in mundum, et dilexérunt
              hómines magis ténebras quam lucem: erant enim eórum mala ópera.
              Omnis enim, qui male agit, odit lucem, et non venit ad lucem, ut
            ...
            <Text className="text-base">
              ...
              Deus não mandou o seu Filho ao Inundo para condenar o mundo, mas
              para o salvar por seu intermédio. Aquele que crê n’Elc não é
              condenado; mas aquele que não crê já está condenado, porque não
              acreditou no nome do Filho Unigénito de Deus. Eis qual a causa da
              condenação: é que a luz veio ao mundo, mas os homens amaram mais
              as trevas do que a luz; e as suas obras foram más. Todo o que
              procede mal detesta a luz e não aparece à luz, para que suas obras
              não sejam censuradas. Mas aquele que procede com rectidão aparece
