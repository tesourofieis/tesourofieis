        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. ibid., 1</Text> Bem-aventurados os que
              são imaculados em seus caminhos e cumprem a Lei do Senhor. ℣.
              Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text> Virgo et Martyr implóret:
              quæ tibi grata semper éxstitit, et mérito castitátis, et tuæ
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text>, que sempre Vos agradou,
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              superbórum sine adjutório. Laudábo nomen tuum assídue, et
              collaudábo illud in confessióne, et exaudíta est orátio mea. Et
            ...
            <Text className="text-base">
              ...
              da minha aflição e durante o poderio dos soberbos. Louvarei
              incessantemente o vosso nome e glorificá-lo-ei na minha acção de
              graças, porque ouvistes a minha oração, livrastes-me da perdição e
              arrancastes-me da ocasião iníqua! Eis porque Vos glorificarei,
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              odísti iniquitátem proptérea unxit te Deus, Deui tuus, óleo
            ...
            <Text className="text-base">
              ...
              Caminhai, pois, com beleza e majestade; ide gozar a vitória e
              reinai.
            </Text>
          </View>
          <View className="aside">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              quam pulchra et casta generátio cum claritáte! Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. Esta é a virgem sábia e uma das prudentes.
              Aleluia. ℣. <Text className="em">Sb. 4, 1</Text> Oh! como é bela a
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              quæ habet, et emit agrum illum. Iterum símile est regnum cœlórum
              hómini negotiatóri, quærénti bonas margarítas. Invénta autem una
              pretiósa margaríta, ábiit, et véndidit ómnia, quæ hábuit, et emit
              eam. Iterum símile est regnum cœlórum sagénse, missæ in mare et ex
              omni génere píscium congregánti. Quam, cum impléta esset,
              educéntes, et secus litus sedéntes, elegérunt bonos in vasa, malos
              autem foras misérunt. Sic erit in consummatióne sǽculi: exíbunt
              Angeli, et separábunt malos de médio justórum, et mittent eos in
              camínum ignis: ibi erit fletus et stridor déntium. Intellexístis
              hæc ómnia? Dicunt ei: Etiam. Ait illis: Ideo omnis scriba doctus
            ...
            <Text className="text-base">
              ...
              razão todo o escriba douto no que diz respeito ao reino dos céus é
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text>, e dignai-Vos permitir
              que ela nos sirva de perpétuo auxílio. Por nosso Senhor...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              ut, intercedénte beáta <Text className="text-red-500">N.</Text>{" "}
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text>, vossa Mártir, que
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              caro. Quod ergo Deus conjúnxit, homo non séparet. Dicunt illi:
              Quid ergo Móyses mandávit dare libéllum repúdii, et dimíttere? Ait
              illis: Quóniam Móyses ad durítiam cordis vestri permísit vobis
              dimíttere uxóres vestras: ab inítio autem non fuit sic. Dico autem
              vobis, quia, quicúmque dimíserit uxórem suam, nisi ob
              fornicatiónem, et áliam dúxerit, mœchátur: et qui dimíssam
              dúxerit, mœchátur. Dicunt ei discípuli ejus: Si ita est causa
              hóminis cum uxóre, non expédit núbere. Qui dixit illis: Non omnes
              cápiunt verbum istud, sed quibus datum est. Sunt enim eunúchi, qui
              de matris útero sic nati sunt; et sunt eunúchi, qui facti sunt ab
            ...
            <Text className="text-base">
              ...
              criou o homem no princípio do mundo criou um homem e uma mulher, e
              disse que por causa disto o homem deixará seu pai e sua mãe, e se
              unirá com sua mulher; e serão dois em uma só carne»? Assim, não
              serão mais dois; mas uma só carne. Que o homem, pois, não separe o
              que Deus uniu». Eles disseram-Lhe: «Porque mandou, então, Moisés
              dar carta de repúdio, e deixá-la?». Ele respondeu: «Foi por causa
              da dureza do vosso coração que Moisés permitiu que repudiásseis
              vossas mulheres; mas no princípio não foi assim. E eu vos digo:
              todo aquele que deixar sua mulher, a não ser por adultério, e
              casar com outra, comete adultério; e aquele que casar com uma
              mulher repudiada, também comete adultério». Disseram-Lhe, então,
              os discípulos: «Se tal é a situação do homem diante da mulher,
              melhor é não se casar». E Ele disse-lhes: «Nem todos são capazes
              de compreender esta palavra, mas só aqueles a quem isso é dado;
              pois há eunucos que já assim vieram do seio de sua mãe; há outros
              que foram feitos pelos homens; e há ainda outros que se fizeram a
