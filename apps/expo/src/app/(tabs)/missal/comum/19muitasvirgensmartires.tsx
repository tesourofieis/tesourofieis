        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              Virgens e Mártires <Text className="text-red-500">N.</Text>e{" "}
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              santas Virgens e Mártires <Text className="text-red-500">N.</Text>{" "}
              e <Text className="text-red-500">N.</Text>, a fim de que, assim
              como lhes concedestes a glória, assim também nos concedais o
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              et Martýribus tuis <Text className="text-red-500">N.</Text> et{" "}
