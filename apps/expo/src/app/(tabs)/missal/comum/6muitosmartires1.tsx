    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          qui effúsus est. <em>Ps. ibid., 1</em> Deus, venérunt gentes in
          hereditátem tuam: polluérunt templum sanctum tuum: posuérunt Jerúsalem
          in pomórum custódiam. ℣. Gloria Patri...
        </p>
        <p>
          ...
          vingai o sangue que os vossos Santos derramaram. <em>Ps. ibid., 1</em>{" "}
          Ó Deus, os povos invadiram a vossa herança, profanaram o vosso sagrado
          templo e reduziram Jerusalém a um monte de ruínas! ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Pontífices <span className="text-red-500">N.</span> e{" "}
          <span className="text-red-500">N.</span>, nos proteja, e que sua
      ...
      <div className="side-by-side">
        ...
        <p>
          Allelúja, allelúja. ℣. <em>Eccli. 44, 14</em> Córpora Sanctórum in
