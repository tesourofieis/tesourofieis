        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. ibid., 2</Text> É bom louvar o Senhor: e
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text> Confessóris tui
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              in hanc horam et esurímus, et sitímus, et nudi sumus, et cólaphis
              cǽdimur, et instábiles sumus, et laborámus operántes mánibus
              nostris: maledícimur, et benedícimus: persecutiónem pátimur, et
              sustinémus: blasphemámur, et obsecrámus: tamquam purgaménta hujus
              mundi facti sumus, ómnium peripséma usque adhuc. Non ut confúndant
            ...
            <Text className="text-base">
              ...
              mas nós somos desprezados. Até agora padecemos a fome, a sede e a
              nudez; fomos maltratados; andamos errantes; trabalhamos
              penosamente com nossas próprias mãos. Somos amaldiçoados, mas
              abençoamos; somos perseguidos, e sofremos; somos blasfemados, e
              correspondemos com orações. Temos sido considerados até ao
              presente como o refugo deste mundo, como a escória de todos!
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Ps. 111, 1</Text>{" "}
              Beátus vir, qui timet Dóminum: in mandátis ejus cupit nimis.
              Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 111, 1</Text>{" "}
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              sácculos, qui non veteráscunt, thesáurum non deficiéntem in cœlis:
            ...
            <Text className="text-base">
              ...
              bolsas que se não estraguem com o tempo; ajuntai um tesouro no
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              intercedénte beáto <Text className="text-red-500">N.</Text>{" "}
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text> sejamos fortificados
