        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              P. Allelúja, allelúja.) <Text className="em">Ps. 29, 2</Text>{" "}
            ...
            <Text className="text-base">
              ...
              <Text className="em">Sl. 29, 2</Text> Louvar-Vos-ei, Senhor, pois
              me acolhestes e não permitistes que meus inimigos se rissem de
              mim. ℣. Glória ao Pai...
            </Text>
          </View>
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text> (Mártyrem tuum atque)
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text> (Vosso Mártir e) Sumo
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Allelúja, allelúja. ℣. <Text className="em">Matth. 16, 18</Text>{" "}
              Tu es Petrus, et super hanc petram ædificábo Ecclésiam meam.
              Allelúja. ℣. <Text className="em">Ps. 44, 17, 18</Text> Constítues
              eos príncipes super omnem terram: mémores erunt nóminis tui,
              Dómine. Allelúja.
            </Text>
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Mt. 16, 18</Text> Tu és
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text>, Ecclésia tua et fídei
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text>, a vossa. Igreja se
              alegre com a integridade da sua fé e sempre exulte com a
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              quem dedísti: ut beáti <Text className="text-red-500">N.</Text>{" "}
            ...
            <Text className="text-base">
              ...
              bem-aventurado <Text className="text-red-500">N.</Text> (Vosso
