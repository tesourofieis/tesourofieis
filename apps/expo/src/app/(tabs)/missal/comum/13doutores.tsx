        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              Allelúja, allelúja.) <Text className="em">Ps. 91, 2</Text> Bonum
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text> minístrum tribuísti:
            ...
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text> para ministro da eterna
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Ecl. 45, 9</Text> Amou-o
              o Senhor e revestiu-o com a túnica da glória. Aleluia.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Ecl. 45, 9</Text> Amou-o
              o Senhor, ornou-o e revestiu-o com a túnica da glória. Aleluia. ℣.{" "}
          ...
          <View className="side-by-side">
            <Text className="text-base">
              Sancti <Text className="text-red-500">N.</Text> Pontíficis tui at
              que Doctóris nobis, Dómine, pia non desit orátio: quæ et múnera
              nostra concíliet; et tuam nobis indulgéntiam semper obtíneat. Per
              Dóminum...
            </Text>
            <Text className="text-base">
              Senhor, que a piedosa oração de Santo{" "}
              <Text className="text-red-500">N.</Text> vosso Pontífice e Doutor,
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="text-red-500">N.</Text> Póntifex tuus et Doctor
            ...
            <Text className="text-base">
              ...
              ilustre Doutor, seja nosso intercessor perante Vós, a fim de que
