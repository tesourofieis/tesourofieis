...
export default function PageQuad40() {
  return (
    <div className="docs">
      <h1>Quarto Domingo da Quaresma</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          satiémini ab ubéribus consolatiónis vestræ. <em>Ps. 121, 1</em>{" "}
        ...
        <p>
          ...
          <em>Sl. 121, 1</em> Alegrei-me com estas palavras que me disseram:
          Iremos à Casa do Senhor. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Jerusalém do alto) é livre. Esta é a nossa mãe; pis está escrito:
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Senhor. ℣. Que a paz reine dentro dos teus muros: e a abundância nos
          teus palácios.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          que habita em Jerusalém nunca será abalado. ℣. O Senhor cerca com
