        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              ...
              e o nosso povo». ℣. Mas um deles, chamado Caifás, que era o
              Pontífice naquele ano, disse profeticamente: «É melhor que morra
            ...
            <Text className="text-base vernacular">
              ...
              contudo, faça-se a vossa vontade. ℣. Vigiai e orai, para não
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              ...
              que, triunfando do inimigo por meio dela, corresponda com amor à
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              autem in sancto hábitas, laus Israël. ℣. In te speravérunt patres
              nostri: speravérunt, et liberásti eos. ℣. Ad te clamavérunt, et
              salvi facti sunt: in te speravérunt, et non sunt confusi. ℣. Ego
              autem sum vermis, et non homo: oppróbrium hóminum et abjéctio
              plebis. ℣. Omnes, qui vidébant me, aspernabántur me: locúti sunt
              lábiis et movérunt caput. ℣. Sperávit in Dómino, erípiat eum:
              salvum fáciat eum, quóniam vult eum. ℣. Ipsi vero consideravérunt
              et conspexérunt me: divisérunt sibi vestiménta mea, et super
              vestem meam misérunt mortem. ℣. Líbera me de ore leónis: et a
              córnibus unicórnium humilitátem meam. ℣. Qui timétis Dóminum,
            ...
            <Text className="text-base vernacular">
              ...
              noite e não acharei consolação. ℣. Contudo, sois a glória de
              Israel e habitais no santuário. ℣. Os nossos pais esperaram em
              Vós: esperaram e fostes o seu libertador! ℣. Clamaram por Vós, e
              foram salvos; confiaram em Vós e não foram iludidos. ℣. Porém sou
              um verme e não um homem; sou o opróbrio dos homens, a irrisão do
              povo! ℣. Todos quantos me vêem, enchem-me de injúrias, murmuram de
              mim, abanando a cabeça e dizendo: ℣. «Esperou no Senhor; pois que
              venha salvá-l’O, já que O ama». ℣. Olharam para mim e
              desprezaram-me; repartiram entre si os meus vestidos e lançaram
              sortes sobre a minha túnica. ℣. Livrai-me, Senhor, da boca do leão
              e das pontas dos unicórnios, pois sou fraco. ℣. Louvai o Senhor, ó
              Vós, que O temeis! Cantai louvores em sua honra, ó filhos de
              Jacob. ℣. À geração futura será anunciado o Senhor; os céus
              proclamarão a sua justiça. ℣. Ao povo, que há-de nascer, ensinarão
              que o Senhor O fez aparecer.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              ...
              Jesus isto, disse-lhes:{" "}
              <Text className="cross text-red-500">✠</Text> «Para que causais
              pena a esta mulher? Foi uma boa obra para comigo, que ela
              praticou; pois pobres sempre os tereis convosco; porém a mim nem
              sempre me tereis. Espalhando este perfume sobre o meu corpo,
            ...
            <Text className="text-base latin">
              ...
              ipse respóndens, ait:{" "}
              <Text className="cross text-red-500">✠</Text> Qui intíngit mecum
              manum in parópside, hic me tradet. Fílius quidem hóminis vadit,
              sicut scriptum est de illo: væ autem hómini illi, per quem Fílius
              hóminis tradétur: bonum erat ei, si natus non fuísset homo ille.{" "}
              ...
              illi: <Text className="cross text-red-500">✠</Text> Tu dixísti.{" "}
              ...
              <Text className="cross text-red-500">✠</Text> Bíbite ex hoc omnes.
              Hic est enim sanguis meus novi Testaménti, qui pro multis
              effundétur in remissiónem peccatórum. Dico autem vobis: non bibam
              ámodo de hoc genímine vitis usque in diem illum, cum illud bibam
              vobíscum novum in regno Patris mei.{" "}
              <Text className="font-bold text-red-500">C.</Text> Et hymno dicto,
              exiérunt in montem Olivéti. Tunc dicit illis Jesus:{" "}
              <Text className="cross text-red-500">✠</Text> Omnes vos scándalum
              patiémini in me in ista nocte. Scriptum est enim: Percútiam
              pastórem, et dispergéntur oves gregis. Postquam autem resurréxero,
              præcédam vos in Galilǽam.{" "}
              <Text className="font-bold text-red-500">C.</Text> Respóndens
              autem Petrus, ait illi:{" "}
              ...
              <Text className="cross text-red-500">✠</Text> Amen, dico tibi,
              quia in hac nocte, antequam gallus cantet, ter me negábis.{" "}
            ...
            <Text className="text-base vernacular">
              ...
              cidade, a casa dum tal, e dizei-lhe: «O Mestre diz: «Meu tempo
              está próximo; quero celebrar a Páscoa com meus discípulos em tua
              casa». <Text className="font-bold text-red-500">C.</Text> Os
              discípulos fizeram o que Jesus lhes ordenara e prepararam a
              Páscoa. Chegada, pois, a tarde, achava-se Jesus à mesa com seus
              Doze Discípulos. E, estando eles a comer, disse-lhes:{" "}
              <Text className="cross text-red-500">✠</Text> «Em verdade vos digo
              que um de vós me trairá».{" "}
              <Text className="font-bold text-red-500">C.</Text> Então, cheios
              de profunda tristeza, começaram, individualmente, a dizer:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Serei eu,
              Senhor?» <Text className="font-bold text-red-500">C.</Text> Ele
              disse: <Text className="cross text-red-500">✠</Text> «O que me
              há-de trair é aquele que mete comigo a mão no prato! Com efeito, o
              Filho do homem vai ser traído, segundo o que está escrito a seu
              ...
              disse-lhe: <Text className="cross text-red-500">✠</Text> «Tu o
              disseste!». <Text className="font-bold text-red-500">C.</Text>{" "}
              Enquanto ceavam, tomou Jesus o pão, benzeu-o, partiu-o e deu-o aos
              discípulos, dizendo: <Text className="cross text-red-500">✠</Text>{" "}
              «Tomai e comei: Isto é o meu corpo».{" "}
              <Text className="font-bold text-red-500">C.</Text> E, pegando no
              cálice, deu graças e entregou-lho, dizendo-lhes:{" "}
              <Text className="cross text-red-500">✠</Text> «Bebei dele vós
              todos. Pois este é o meu sangue do Novo Testamento, que será
              derramado por muitos para remissão dos pecados. Digo-vos, porém,
              que não mais tornarei a beber deste fruto da videira, até ao dia
              em que o hei-de beber, novamente, convosco no reino de meu Pai».{" "}
              ...
              «Esta noite serei para vós todos motivo de escândalo; porque está
              escrito: «Ferirei o pastor e as ovelhas do rebanho serão
              dispersas». Mas, depois de ressuscitar, irei adiante de vós para a
              Galileia» <Text className="font-bold text-red-500">C.</Text>{" "}
              Porém, respondendo Pedro, disse-Lhe:{" "}
              ...
              retorquiu-lhe: <Text className="cross text-red-500">✠</Text> «Em
              verdade te digo: esta noite, antes de o galo cantar, negar-me-ás
              três vezes». <Text className="font-bold text-red-500">C.</Text>{" "}
              edro disse-Lhe: <Text className="font-bold text-red-500">S.</Text>{" "}
              «Ainda que tenha de morrer convosco, não Vos negarei!».{" "}
            ...
            <Text className="text-base latin">
              ...
              mecum. <Text className="font-bold text-red-500">C.</Text> Et
              progréssus pusíllum, prócidit in fáciem suam, orans et dicens:{" "}
              <Text className="cross text-red-500">✠</Text> Pater mi, si
              possíbile est, tránseat a me calix iste: Verúmtamen non sicut ego
              volo, sed sicut tu.{" "}
              <Text className="font-bold text-red-500">C.</Text> Et venit ad
              discípulos suos, et invénit eos dormiéntes: et dicit Petro:{" "}
              <Text className="cross text-red-500">✠</Text> Sic non potuístis
              ...
              ábiit et orávit, dicens:{" "}
              <Text className="cross text-red-500">✠</Text> Pater mi, si non
              potest hic calix transíre, nisi bibam illum, fiat volúntas tua.{" "}
              <Text className="font-bold text-red-500">C.</Text> Et venit
              íterum, et invenit eos dormiéntes: erant enim óculi eórum graváti.
              Et relíctis illis, íterum ábiit et orávit tértio, eúndem sermónem
              dicens. Tunc venit ad discípulos suos, et dicit illis:{" "}
              <Text className="cross text-red-500">✠</Text> Dormíte jam et
              requiéscite: ecce, appropinquávit hora, et Fílius hóminis tradétur
            ...
            <Text className="text-base vernacular">
              ...
              <Text className="cross text-red-500">✠</Text> «Meu Pai, se é
              possível, fazei que este cálice se afaste de mim; contudo faça-se
              a vossa vontade e não a minha».{" "}
              <Text className="font-bold text-red-500">C.</Text> Em seguida,
              veio ter com os discípulos, encontrando-os a dormir. Disse, então,
              a Pedro: <Text className="cross text-red-500">✠</Text> «Pois não
              pudestes vigiar uma hora comigo?! Vigiai e orai para não entrardes
              em tentação. Na verdade, o espírito está pronto, porém a carne é
              fraca». <Text className="font-bold text-red-500">C.</Text> De novo
              se retirou Jesus e, pela segunda vez orou, dizendo:{" "}
              <Text className="cross text-red-500">✠</Text> «Meu Pai, se este
              cálice não pode passar sem que Eu o beba, faça-se a vossa
              vontade». <Text className="font-bold text-red-500">C.</Text>{" "}
              Depois veio outra vez ter com os discípulos, que achou dormindo
              (até tinham os olhos colados de sono!), e, deixando-os, foi pela
              terceira vez orar, repetindo as mesmas palavras. Depois, veio ter
              com os discípulos e disse-lhes:{" "}
              <Text className="cross text-red-500">✠</Text> «Dormi agora e
              repousai: eis que se aproxima a hora em que o Filho do homem será
            ...
            <Text className="text-base vernacular">
              ...
              <Text className="cross text-red-500">✠</Text> «Mete a espada no
              seu lugar; pois todos quantos se servem da espada morrerão pela
              espada. Acaso pensas que não posso rogar auxílio a meu Pai, que
              ...
              Jesus disse às turbas:{" "}
              <Text className="cross text-red-500">✠</Text> «Viestes com espadas
              e paus para me prender, como se Eu fora um ladrão?! Todos os dias
              estava assentado convosco, ensinando no templo, e não me
              prendestes?! <Text className="font-bold text-red-500">C.</Text>{" "}
              Tudo isto aconteceu assim, para que se cumprissem as Escrituras
            ...
            <Text className="text-base latin">
              ...
              Jesus: <Text className="cross text-red-500">✠</Text> Tu dixísti.
            ...
            <Text className="text-base vernacular">
              ...
              disseste; contudo digo-vos que haveis de ver daqui a pouco o Filho
              do homem assentar-se à direita do poder de Deus, caminhando sobre
              as nuvens do céu».{" "}
              <Text className="font-bold text-red-500">C.</Text> Então o
            ...
            <Text className="text-base latin">
              ...
              dicens: <Text className="cross text-red-500">✠</Text> Eli, Eli,
              lamma sabactháni?{" "}
            ...
            <Text className="text-base vernacular">
              ...
              <Text className="cross text-red-500">✠</Text> «Elí, Elí, lamma
              sabatáni?». <Text className="font-bold text-red-500">C.</Text>{" "}
              Isto é: <Text className="cross text-red-500">✠</Text> «Meu Deus,
              meu Deus, porque me abandonastes?».{" "}
              <Text className="font-bold text-red-500">C.</Text> Alguns, porém,
