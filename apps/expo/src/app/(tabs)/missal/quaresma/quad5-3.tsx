        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              <Text className="em">Ps. ib., 2-3</Text> Díligam te, Dómine,
            ...
            <Text className="text-base">
              ...
              homem iníquo. <Text className="em">Sl. ib., 2-3</Text> Senhor, que
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              unusquísque próximum suum. Non perjurábis in nómine meo, nec
              póllues nomen Dei ;ui. Ego Dóminus. Non fácies calúmniam próximo
              tuo: nec vi ópprimes eum. Non morábitur opus mercennárii tui apud
              te usque mane. Non maledíces surdo, nec coram cæco pones
              offendículum: sed timébis Dóminum, Deum tuum, quia ego sum
              Dóminus. Non fácies quod iníquum est, nec injúste judicábis. Non
              consíderes persónam páuperis, nec honóres vultum poténtis. Juste
              júdica próximo tuo. Non eris criminátor, nec susúrro in pópulo.
              Non stabis contra sánguinem próximi tui. Ego Dóminus. Non óderis
              fratrem tuum in corde tuo, sed públice árgue eum, ne hábeas super
              illo peccátum. Non quæras ultiónem, nec memor eris injúriae cívium
            ...
            <Text className="text-base">
              ...
              próximo; não jurareis em vão, invocando o meu nome, nem
              profanareis o nome do vosso Deus. Sou o Senhor: não caluniareis o
              próximo e o não oprimireis com violência; o salário do jornaleiro
              não permanecerá na vossa mão até ao dia seguinte; não
              amaldiçoareis o surdo, nem colocareis obstáculos no caminho do
              cego; mas temereis o Senhor, vosso Deus, pois sou o Senhor. Não
              praticareis iniquidades, nem julgareis injustamente; não
              considerareis se uma pessoa é pobre, nem vos intimidareis com a
              presença do poderoso. Julgai o próximo com toda a justiça; não
              sejais acusador; não levanteis intrigas entre o povo; não
              prepareis vingança contra o sangue do vosso próximo. Sou o Senhor:
              não odiareis com o coração o vosso irmão, mas admoestá-lo-eis
              publicamente, para que não tenhais nele causa de pecado. Não
              procurareis vingar-vos e não guardareis rancor pela injúria dos
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              tu es Christus, dic nobis palam. Respóndit eis Jesus: Loquor
              vobis, et non créditis: Opera, quæ ego fácio in nómine Patris mei,
              hæc testimónium pérhibent de me: sed vos non créditis, quia non
              estis ex óvibus meis. Oves meæ vocem meam áudiunt: et ego cognósco
              eas, et sequúntur me: et ego vitam ætérnam do eis: et non períbunt
              in ætérnum, et non rápiet eas quisquam de manu mea. Pater meus
              quod dedit mihi, majus ómnibus est: et nemo potest rápere de manu
              Patris mei. Ego et Pater unum sumus. Sustulérunt ergo lápides
              Judǽi, ut lapidárent eum. Respóndit eis Jesus: Multa bona ópera
              osténdi vobis ex Patre meo, propter quod eórum opus me lapidátis?
              Respondérunt ei Judǽi: De bono ópere non lapidámus te, sed de
              blasphémia: et quia tu, homo cum sis, facis teípsum Deum.
              Respóndit eis Jesus: Nonne scriptum est in lege vestra: quia Ego
              dixi, dii estis? Si illos dixit deos, ad quos sermo Dei factus
              est, et non potest solvi Scriptúra: quem Pater sanctificávit, et
              misit in mundum, vos dicitis: Quia blasphémas: quia dixi, Fílius
              Dei sum? Si non fácio ópera Patris mei, nolíte crédere mihi. Si
            ...
            <Text className="text-base">
              ...
              francamente». Jesus respondeu-lhes: «Já vo-lo tenho dito; porém,
              não acreditais. As obras, que pratico em nome de meu Pai, dão
              testemunho de mim; mas vós não acreditais, porque não pertenceis
              às minhas ovelhas. Minhas ovelhas ouvem a minha voz: Eu conheço-as
              e elas seguem-me. Eu dou-lhes a vida eterna e não morrerão para
              sempre, nem ninguém as arrebatará da minha mão. O que meu Pai me
              deu é maior do que todas as coisas; e ninguém pode arrebatá-las da
              mão de meu Pai. Eu e o Pai somos um só». Os judeus, então,
              procuraram pedras para o apedrejar. E Jesus disse-lhes: «Tenho
              feito diante de vós muitas obras admiráveis, por poder de meu Pai;
              por qual delas, pois, quereis apedrejar-me?». Os judeus
              responderam-Lhe: «Não é pelas boas obras que Vos apedrejamos, mas
              pelas blasfémias; porquanto, declarai-Vos Deus, sendo, contudo,
              homem». Respondeu-lhes Jesus: «Não está escrito na vossa Lei: «Eu
              disse que sois deuses?» Se, pois a Lei chama deuses àqueles a quem
              a palavra de Deus foi dirigida (e a Escritura não pode ser
              desprezada), como chamais blasfemo Àquele que o Pai santificou e
              mandou ao mundo, porque disse «sou o Filho de Deus»? Se não faço
              as obras de meu Pai, não me acrediteis; mas, se as faço, embora
              não queirais acreditar em mim, acreditai nas minhas obras, a fim
