    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          conceder-lhe-ei longa vida. <em>Sl. ibid., 1</em> Aquele que habita à
      ...
      <div className="side-by-side">
        <p>
          ...
          commorántur. ℣. Dicet Dómino: Suscéptor meus es tu et refúgium meum:
          Deus meus, sperábo in eum. ℣. Quóniam ipse liberávit me de láqueo
          venántium et a verbo áspero. ℣. Scápulis suis obumbrábit tibi, et sub
          pennis ejus sperábis. ℣. Scuto circúmdabit te véritas ejus: non
          timébis a timóre noctúrno. ℣. A sagítta volánte per diem, a negótio
          perambulánte in ténebris, a ruína et dæmónio meridiáno. ℣. Cadent a
          látere tuo mille, et decem mília a dextris tuis: tibi autem non
          appropinquábit. ℣. Quóniam Angelis suis mandávit de te, ut custódiant
          te in ómnibus viis tuis. ℣. In mánibus portábunt te, ne umquam
          offéndas ad lápidem pedem tuum. ℣. Super áspidem et basilíscum
          ambulábis, et conculcábis leónem et dracónem. ℣. Quóniam in me
          ...
          Erípiam eum et glorificábo eum: longitúdine diérum adimplébo eum, et
          osténdam illi salutáre meum.
        </p>
        <p>
          Aquele que habita à sombra do Altíssimo descansará sob a protecção de
          Deus do céu. ℣. Ele dirá ao Senhor: sois o meu protector e o meu
          refúgio; sois o meu Deus, em quem confio! ℣. Pois livrastes-me do laço
          do caçador e das palavras funestas! ℣. O Senhor te acolherá sob a sua
          protecção: agasalhar-te-á sob as suas asas! ℣. Sua fidelidade é como
          um escudo: livrar-te-á dos terrores da noite; da seta, que voa de dia;
          das traições, que se tramam durante a noite; e dos assaltos do
          demónio, em pleno meio-dia. ℣. Cairão mil à tua esquerda e dez mil à
          tua direita; mas tu não serás atingido! ℣. Pois Deus ordenou aos seus
          Anjos que te guardassem em todos teus caminhos. ℣. Levar-te-ão nas
          suas mãos para que não tropeces nas pedras. ℣. Caminharás sobre a
          víbora e o basilisco; pisarás o leão e o dragão. ℣. Visto que esperou
          em mim, livrá-lo-ei; e protegê-lo-ei, pois, conhece e invoca o meu
          nome. ℣. Invocar-me-á e ouvi-lo-ei: estarei com ele nos dias da
          tribulação. ℣. Livrá-lo-ei e glorificá-lo-ei, conceder-lhe-ei longa
          vida e mostrar-lhe-ei a minha salvação.
        </p>
      </div>
