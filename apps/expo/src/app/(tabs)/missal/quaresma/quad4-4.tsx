...
export default function PageQuad44() {
  return (
    <div className="docs">
      <h1>Quinta-feira da 4.ª Semana da Quaresma</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          quǽrite fáciem ejus semper. <em>Ps. ibid., 1</em> Confitémini Dómino,
          et invocáte nomen ejus: annuntiáte inter gentes ópera ejus. ℣. Gloria
          Patri...
        </p>
        <p>
          ...
          presença. <em>Sl. ibid., 1</em> Louvai o Senhor e aclamai o seu nome:
          anunciai as suas obras no meio dos povos. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          circa te, et circa virum tuum, et circa fílium tuum? Quæ respóndit:
          Recte. Cumque venísset ad virum Dei in montem, apprehéndit pedes ejus:
          et accéssit Giézi, ut amovéret eam. Et ait homo Dei: Dimítte illam:
          ánima enim ejus in amaritúdine est, et Dóminus celávit a me, et non
          indicávit mihi. Quæ dixit illi: Numquid petívi fílium a dómino meo?
          Numquid non dixi tibi: Ne illúdas me? Et ille ait ad Giézi: Accínge
          lumbos tuos, et tolle báculum meum in manu tua, et vade. Si occurrérit
          tibi homo, non salútes eum: et si salutáverit te quíspiam, non
          respóndeas illi: et pones báculum meum super fáciem púeri. Porro mater
          pueri ait: Vivit Dóminus et vivit ánima tua, non dimíttam te. Surréxit
          ergo, et secútus est eam. Giézi autem præcésserat ante eos, et
          posúerat báculum super fáciem púeri, et non erat vox neque sensus:
          reversúsque est in occúrsum ejus, et nuntiávit ei, dicens: Non
          surréxit puer. Ingréssus est ergo Eliséus domum, et ecce, puer mórtuus
          jacébat in léctulo ejus: ingressúsque clausit óstium super se et super
          púerum: et orávit ad Dóminum. Et ascéndit, et incúbuit super púerum:
          posuítque os suum super os ejus, et óculos suos super óculos ejus, et
          manus suas super manus ejus: et incurvávit se super eum: et calefácta
          est caro púeri. At ille revérsus, de ambulávit in domo, semel huc
          atque illuc: et ascéndit et incúbuit super eum: et oscitávit puer
          sépties, aperuítque oculos. At ille vocávit Giézi, et dixit ei: Voca
          Sunamítidem hanc. Quæ vocáta ingréssa est ad eum. Qui ait: Tolle
        ...
        <p>
          ...
          diz-lhe: «Porventura corre tudo com exactidão em tua casa? O teu
          marido e o teu filho passam bem?». Ela respondeu: «Sim!». Logo que ela
          chegou ao monte, ao pé do homem de Deus, segurou-se-lhe aos pés. Giézi
          aproximou-se dela para a afastar. Mas o homem de Deus disse: «Deixa-a,
          pois a sua alma está amargurada, ainda que o Senhor me não deu a
          conhecer o motivo». Ela disse-lhe, então: «Porventura havia eu pedido
          um filho ao meu Senhor? Não te disse eu: não me iludas?». Logo Eliseu
          disse a Giézi: «Cinge os teus rins, toma o meu bordão na tua mão e
          parte. Se encontrares alguém, o não saúdes: se alguém te saudar, não
          correspondas; e colocarás o meu bordão em cima do rosto do menino».
          Mas a mãe do menino disse ao Profeta: «Viva o Senhor e viva a tua
          alma; eu, porém, te não deixarei!». Levantou-se, então, Eliseu e
          seguiu-a. Entretanto, Giézi, tendo partido antes deles, logo que lá
          chegou, pôs o bordão em cima do rosto do menino, que já não tinha voz,
          nem sentidos; e, voltando ao encontro de Eliseu, contou-lhe o que se
          passara, dizendo: «O menino não ressuscitou». Entrou, então, Eliseu em
          casa e encontrou o menino deitado no leito e já morto. Eliseu fechou a
          porta, ficando só com o menino, e orou ao Senhor. Depois subiu para o
          leito, estendeu-se em cima do menino, pôs a sua boca sobre a boca do
          menino, os seus olhos sobre os olhos dele, as suas mãos sobre as mãos
          dele e inclinou-se sobre ele. E logo a carne do menino adquiriu calor.
          Eliseu, tendo descido do leito, passeou pela casa duas vezes; depois
          tornou a subir e a inclinar-se sobre o menino. Então este bocejou sete
          vezes, abrindo os olhos. Eliseu chamou logo Giézi e disse-lhe: «Chama
          a Sunamite». Giézi chamou-a. Veio ela junto de Eliseu, que lhe disse:
      ...
      <div className="side-by-side">
        <p>
          ...
          obliviscáris in finem. ℣. Exsúrge, Dómine, júdica causam tuam: memor
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          hæc vidua erat, et turba civitátis multa cum illa. Quam cum vidísset
          Dóminus, misericórdia motus super eam, dixit illi: Noli flere. Et
          accéssit et tétigit lóculum. (Hi autem, qui portábant, steterunt.) Et
          ait: Adoléscens, tibi dico, surge. Et resédit, qui erat mórtuus, et
        ...
        <p>
          ...
          acompanhado por muitas pessoas da cidade. Vendo o Senhor a viúva,
          compadeceu-se dela e disse-lhe: «Não chores». E, aproximando-se, tocou
          no esquife (pois aqueles que o levavam tinham parado), dizendo:
          «Adolescente, eu te mando: levanta-te!». E no mesmo instante
          levantou-se o morto e começou a falar. Então Jesus entregou-o a sua
