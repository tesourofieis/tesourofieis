    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          tuárum prótege me. <em>Ps. ib., 1</em> Exáudi, Dómine, justítiam meam:
          inténde deprecatiónem meam. ℣. Gloria Patri...
        </p>
        <p>
          ...
          asas. <em>Sl. ib., 1</em> Ouvi, Senhor, a minha súplica, que é justa:
          atendei à minha oração, que é muito humilde. ℣. Glória ao Pai...
        </p>
      </div>
