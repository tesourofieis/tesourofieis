        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              suórum accusántibus, ante conspéctum divínæ cleméntiæ tuæ facínora
              sua deplorántibus, vel sereníssimam pietátem tuam supplíciter
            ...
            <Text className="text-base vernacular">
              ...
              delitos, a si mesmos se acusam, deplorando esses crimes, diante da
              vossa divina clemência, e suplicando instante e humildemente a
              vossa compassiva misericórdia. Dignai-Vos permitir que pela
              invocação do vosso santíssimo nome todos os que com estas Cinzas
              forem aspergidos alcancem, além da remissão dos pecados, saúde
              para o corpo e protecção para a alma. Por Cristo, nosso Senhor.{" "}
              <Text className="text-red-500">℟.</Text> Amen.
            </Text>
          </View>
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base vernacular">
              ...
              Cristo, nosso Senhor. <Text className="text-red-500">℟.</Text>{" "}
              Amen.
            </Text>
          </View>
