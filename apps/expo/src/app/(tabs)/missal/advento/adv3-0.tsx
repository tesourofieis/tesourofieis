        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base">
              ...
              innotéscant apud Deum. <Text className="em">Ps. 84, 2</Text>{" "}
            ...
            <Text className="text-base">
              ...
              necessidades. <Text className="em">Sl. 84, 2</Text> Abençoastes,
              Senhor, a vossa terra: e livrastes Jacob do cativeiro. ℣. Glória
              ao Pai...
            </Text>
          </View>
