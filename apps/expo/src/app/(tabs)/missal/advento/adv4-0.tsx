    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          et gérminet Salvatórem. <em>Ps. 18, 2</em> Cœli enárrant glóriam Dei:
        ...
        <p>
          ...
          <em>Sl. 18, 2</em> Os céus proclamam a glória de Deus: e o firmamento
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          que O invocam com verdade. ℣. Que minha boca publique os louvores do
          Senhor: e que toda minha pessoa bendiga seu santo Nome.
        </p>
        <p>
          Allelúja, allelúja. ℣. Veni, Dómine, et noli tardáre: reláxa facínora
          plebis tuæ Israël. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. Vinde, Senhor, e não retardeis mais: perdoai os
          crimes de Israel, vosso povo. Aleluia.
        </p>
      </div>
