        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              ...
              alegria. <Text className="em">Sl. 79, 2</Text> Ouvi, ó vós, que
              governais Israel; ó vós, que conduzis José, como um pastor conduz
          ...
          <View className="side-by-side">
            ...
            <Text className="text-base">
              Aleluia, aleluia. ℣. <Text className="em">Sl. 121, 1</Text>{" "}
              Rejubilo com aqueles que me disseram: «Iremos à casa do Senhor».
              Aleluia.
            </Text>
          </View>
