  ...
  return (
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> Ad Deum, qui lætíficat
          juventútem meam.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Até Deus, que é a alegria da
          minha juventude.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> Quia tu es, Deus, fortitudo
          mea: quare me reppulísti, et quare tristis incédo, dum afflígit me
          inimícus?
        </p>
        <p>
          <span className="text-red-500">℟.</span> Pois que Vós, ó Deus, sois a
        ...
        <p>
          ℣. Enviai a vossa luz e a vossa verdade; elas me guiarão e conduzirão
          até ao vosso santo monte, até aos vossos tabernáculos.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Et introíbo ad altáre Dei: ad
          Deum, qui lætíficat juventútem meam.
        </p>
        <p>
          <span className="text-red-500">℟.</span> E irei até ao Altar de Deus;
        ...
        <p>
          <span className="text-red-500">℟.</span> Spera in Deo, quóniam adhuc
          confitébor illi: salutáre vultus mei, et Deus meus.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Confia em Deus, pois ainda O
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> Sicut erat in princípio, et
      ...
      <div className="side-by-side">
        ...
        <p>
          ℣. Adjutórium nostrum <span className="cross text-red-500">✠</span> in
          nómine Dómini.
        </p>
        <p>
          ℣. O nosso auxílio está <span className="cross text-red-500">✠</span>{" "}
          no nome do Senhor.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Qui fecit cœlum et terram.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Que criou o céu e a terra.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> Misereátur vestri omnípotens
          Deus, et, dimíssis peccátis vestris, perdúcat vos ad vitam ætérnam.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Compadeça-se de vós o Senhor
      ...
      <div className="side-by-side">
        <p>
          <span className="text-red-500">℟.</span> Confíteor Deo omnipoténti,
        ...
        <p>
          <span className="text-red-500">℟.</span> Eu me confesso a Deus, todo
        ...
        <p>
          ℣. Compadeça-se de vós o Senhor omnipotente; vos perdoe os pecados e
        ...
        <p>
          ℣. Indulgéntiam, <span className="cross text-red-500">✠</span>{" "}
          absolutionem et remissiónem peccatórum nostrórum tríbuat nobis
          omnípotens et miséricors Dóminus.
        </p>
        <p>
          ℣. Que o Senhor <span className="cross text-red-500">✠</span>{" "}
          omnipotente e misericordioso nos conceda o perdão, a absolvição e a
        ...
        <p>
          <span className="text-red-500">℟.</span> Et plebs tua lætábitur in te.
        </p>
        <p>
          <span className="text-red-500">℟.</span> E o vosso povo se alegrará
          convosco.
        </p>
        <p>℣. Osténde nobis, Dómine, misericórdiam tuam.</p>
        <p>℣. Senhor, mostrai-nos a vossa misericórdia.</p>
        <p>
          <span className="text-red-500">℟.</span> Et salutáre tuum da nobis.
        </p>
        <p>
          <span className="text-red-500">℟.</span> E concedei-nos a vossa
          salvação.
        </p>
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> Kýrie eléison.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Senhor, tende piedade de nós.
        </p>
        <p>℣. Kýrie eléison.</p>
        <p>℣. Senhor, tende piedade de nós.</p>
        <p>
          <span className="text-red-500">℟.</span> Christe eléison.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Cristo, tende piedade de nós.
        </p>
        <p>℣. Christe eléison.</p>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> in glória Dei Patris.
        </p>
        <p>
          ...
          Espírito Santo <span className="cross text-red-500">✠</span> na glória
          de Deus Pai.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Amen.
      ...
      <div className="side-by-side">
        <p>
          <span className="text-red-500">℟.</span> Glória tibi, Dómine.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Glória a Vós, Senhor.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          <span className="text-red-500">℟.</span> Laus tibi, Christe.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Louvores a Vós, ó Cristo.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          <span className="cross text-red-500">✠</span> vitam ventúri sǽculi.
        </p>
        <p>
          ...
          <span className="cross text-red-500">✠</span> a vida do mundo que
          há-de vir.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Amen.
      ...
      <div className="side-by-side">
        <p>
          <span className="text-center text-red-500">℣. Orémus.</span>
        </p>
        <p>
          <span className="text-center text-red-500">℣. Oremos.</span>
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> dic hoc sacrifícium, tuo
          sancto nómini præparátum.
        </p>
        <p>
          Vinde, ó Santificador omnipotente, Deus eterno, e abençoai{" "}
          <span className="cross text-red-500">✠</span> este sacrifício,
      ...
      <div className="side-by-side">
        <p>
          ...
          Dóminus bene <span className="cross text-red-500">✠</span> dícere, et
        ...
        <p>
          ...
          eleitos, abençoar <span className="cross text-red-500">✠</span> este
      ...
      <div className="side-by-side">
        <p>
          <span className="text-red-500">℟.</span> Accéndat in nobis Dóminus
          ignem sui amóris, et flammam ætérnæ caritátis. Amen.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Que o Senhor acenda em nós o
      ...
      <div className="side-by-side">
        <p>
          ...
          memóriam passiónis, resurrectiónis, et ascensiónis Jesu Christi,
          Dómini nostri: et in honórem beátæ Maríæ semper Vírginis, et beáti
          Joannis Baptistæ, et sanctórum Apostolórum Petri et Pauli, et istórum
          et ómnium Sanctórum: ut illis profíciat ad honórem, nobis autem ad
          salútem: et illi pro nobis intercédere dignéntur in cœlis, quorum
        ...
        <p>
          ...
          memória da Paixão, da Ressurreição e da Ascensão de N. S. Jesus
          Cristo: e em honra da bem-aventurada sempre Virgem Maria, do
          bem-aventurado João Baptista e dos Santos Apóstolos Pedro e Paulo, e
          destes, que estão aqui, e de todos os Santos: para que esta oblação
          lhes sirva de glória e a nós de salvação: e aqueles, cuja memória
          honramos na terra, se dignem interceder por nós no céu. Pelo mesmo
      ...
      <div className="side-by-side">
        ...
        <p>
          ℣. Orai, meus irmãos, a fim de que meu sacrifício, que é também vosso,
          seja recebido por Deus Pai omnipotente.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Suscípiat Dóminus sacrifícium
          de mánibus tuis ad laudem et glóriam nominis sui, ad utilitátem quoque
          nostram, totiúsque Ecclésiæ suæ sanctæ.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Que o Senhor receba por
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> Dignum et justum est.
        </p>
        <p>
      ...
      <div className="side-by-side">
        ...
        <p>
          Benedíctus, <span className="cross text-red-500">✠</span> qui venit in
          nómine Dómini. Hosánna in excélsis.
        </p>
        <p>
          Bendito <span className="cross text-red-500">✠</span> o que vem em
      ...
      <div className="side-by-side">
        <p>
          ...
          benedícas, hæc <span className="cross text-red-500">✠</span> dona, hæc{" "}
          <span className="cross text-red-500">✠</span> múnera, hæc{" "}
          <span className="cross text-red-500">✠</span> sancta sacrifícia
          ...
          <span className="text-red-500">N.</span> et ómnibus orthodóxis, atque
        ...
        <p>
          ...
          <span className="cross text-red-500">✠</span> dons, estas{" "}
          <span className="cross text-red-500">✠</span> ofertas, estes{" "}
          <span className="cross text-red-500">✠</span> sacrifícios santos e
          ...
          <span className="text-red-500">N.</span> com o nosso Bispo{" "}
          <span className="text-red-500">N.</span> e com todos os ortodoxos e os
          que professam a fé católica e apostólica.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> et ómnium circumstántium,
        ...
        <p>
          ...
          <span className="text-red-500">N.</span>e{" "}
          <span className="text-red-500">N.</span> e de todos os que aqui estão
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> díctam, adscríp{" "}
          <span className="cross text-red-500">✠</span> tam, ra{" "}
          <span className="cross text-red-500">✠</span> tam, rationábilem,
          acceptabilémque fácere dignéris: ut nobis Cor{" "}
          <span className="cross text-red-500">✠</span> pus, et San{" "}
          <span className="text-red-500">✠</span> guis fiat dilectíssimi Fílii
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> dixit, fregit, dedítque
        ...
        <p>
          ...
          <span className="cross text-red-500">✠</span>, partiu-o e deu-o aos
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> dixit, dedítque
        ...
        <p>
          ...
          <span className="cross text-red-500">✠</span> e deu-o aos seus
          discípulos dizendo:
        </p>
        <p>
          <strong>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> puram, hóstiam{" "}
          <span className="cross text-red-500">✠</span> sanctam, hóstiam{" "}
          <span className="cross text-red-500">✠</span> immaculátam, Panem{" "}
          <span className="cross text-red-500">✠</span> sanctum vitæ ætérnæ, et
          Calicem <span className="cross text-red-500">✠</span> salútis
          perpétuæ.
        </p>
        <p>
          ...
          <span className="cross text-red-500">✠</span> pura, a Hóstia{" "}
          <span className="cross text-red-500">✠</span> santa, a Hóstia{" "}
          <span className="cross text-red-500">✠</span> imaculada, o Pão{" "}
          <span className="cross text-red-500">✠</span> santo da vida eterna e o
          Cálice <span className="cross text-red-500">✠</span> da salvação
          perpétua.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> pus, et Sán{" "}
          <span className="cross text-red-500">✠</span> guinem sumpsérimus, omni
        ...
        <p>
          ...
          <span className="cross text-red-500">✠</span> e Sangue{" "}
          <span className="cross text-red-500">✠</span> de vosso Filho sejam
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> et{" "}
          <span className="text-red-500">N.</span> , qui nos præcessérunt cum
          signo fídei, et dórmiunt in somno pacis.
        </p>
        <p>
          Lembrai-Vos também Senhor, dos vossos servos e servas{" "}
          <span className="text-red-500">N.</span> e{" "}
          <span className="text-red-500">N.</span>, que partiram antes de nós,
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          <span className="cross text-red-500">✠</span> ficas, viví{" "}
          <span className="cross text-red-500">✠</span> ficas, bene{" "}
          <span className="cross text-red-500">✠</span> dícis et præstas nobis.
        </p>
        <p>
          Por quem, Senhor, sempre criais estes bens e os santificais{" "}
          <span className="cross text-red-500">✠</span>, vivificais{" "}
          <span className="cross text-red-500">✠</span>, abençoais{" "}
          <span className="cross text-red-500">✠</span> e no-los concedeis.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Per ip <span className="cross text-red-500">✠</span> sum, et cum ip{" "}
          <span className="cross text-red-500">✠</span> so, et in ip{" "}
          <span className="cross text-red-500">✠</span> so, est tibi Deo Patri{" "}
          <span className="cross text-red-500">✠</span> omnipotenti, in unitáte
          Spíritus <span className="cross text-red-500">✠</span> Sancti, omnis
          honor, et glória.
        </p>
        <p>
          Por Ele <span className="cross text-red-500">✠</span>, com Ele{" "}
          <span className="cross text-red-500">✠</span> e n’Ele{" "}
          <span className="cross text-red-500">✠</span>, a Vós, ó Deus Pai
          todo-o-poderoso <span className="cross text-red-500">✠</span>, na
          unidade do Espírito <span className="cross text-red-500">✠</span>{" "}
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> Sed líbera nos a malo.
        </p>
        <p>
      ...
      <div className="side-by-side">
        <p>
          ℣. Pax <span className="cross text-red-500">✠</span> Dómini sit{" "}
          <span className="cross text-red-500">✠</span> semper{" "}
          <span className="cross text-red-500">✠</span> vobíscum.
        </p>
        <p>
          ℣. Que a paz <span className="cross text-red-500">✠</span> do Senhor
          esteja <span className="cross text-red-500">✠</span> sempre{" "}
          <span className="cross text-red-500">✠</span> convosco.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Et cum spíritu tuo.
        </p>
      ...
      <div className="side-by-side">
        <p>
          ℣. Corpus Dómini nostri Jesu Christi custódiat ánimam tuam in vitam
          ætérnam. Amen.
        </p>
        <p>
          ℣. Que o Corpo de nosso Senhor Jesus Cristo guarde a tua alma para a
          vida eterna. Amen.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ℣. Pláceat tibi, sancta Trínitas, obséquium servitútis meæ: et præsta;
          ut sacrifícium, quod óculis tuæ majestátis indígnus óbtuli, tibi sit
        ...
        <p>
          ...
          ofereci à vossa divina majestade, seja aceite por Vós, e, pela vossa
          misericórdia, se torne propiciatório para mim e para todos aqueles por
          quem o ofereci. Por Cristo, Nosso Senhor. Amen.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> et Spíritus Sanctus.
        </p>
        <p>
          ℣. Que desça sobre vós a bênção do omnipotente Deus: Pai, e Filho,{" "}
          <span className="cross text-red-500">✠</span> e Espírito Santo.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Amen.
        </p>
      ...
      <div className="side-by-side">
        <p>
          <span className="cross text-red-500">✠</span> Initium sancti Evangélii
          secúndum Joánnem.
        </p>
        <p>
          <span className="cross text-red-500">✠</span> Princípio do santo
        ...
        <p>
          ...
          carne <em>genuflecte-se</em> e habitou entre nós; e contemplamos a sua
          glória, como era própria do Filho Unigénito do Pai, cheio de graça e
          de verdade.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Deo grátias.
