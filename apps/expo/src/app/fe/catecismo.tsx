    ...
    <SafeAreaView className="flex-1">
      <ScrollView>
        <View className="docs">
          ...
          <Text className="text-base">
            Em seguida Barnabé foi para Tarso, à procura de Saulo. Encontrou-o e
            o levou para Antioquia. Durante um ano estiveram juntos naquela
            igreja e instruíram muita gente. Foi em Antioquia que, pela primeira
            vez, os discípulos foram chamados cristãos. At 11, 25-26.
          </Text>
          ...
          <Text className="text-base">
            Verdadeiro cristão é aquele que é baptizado, crê e professa a
            doutrina cristã e obedece aos legítimos Pastores da Igreja.
          </Text>
          <Text className="h5">4 - Que é a Doutrina Cristã?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            dependentes aprendam a Doutrina Cristã; e são culpados diante de
            Deus, se desprezarem esta obrigação.
          </Text>
          <Text className="h5">
            7 - De quem devemos nós receber e aprender a Doutrina Cristã?
          </Text>
          <Text className="text-base">
            Devemos receber e aprender a Doutrina Cristã da Santa Igreja
            Católica.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            doutrina, a confiou por meio aos seus Apóstolos à Igreja Católica,
            por Ele fundada e constituída Mestra infalível de todos os homens,
            prometendo-Lhe a sua divina assistência até à consumação dos
            séculos.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            As partes principais e mais necessárias da Doutrina Cristã são
            quatro: o Credo, o Padre-Nosso, os Mandamentos e os Sacramentos.
          </Text>
          <Text className="h5">11 - Que nos ensina o Credo?</Text>
          <Text className="text-base">
            O Credo ensina-nos os principais artigos da nossa santa Fé.
          </Text>
          <Text className="h5">12 - Que nos ensina o Padre-Nosso?</Text>
          <Text className="text-base">
            O Padre-Nosso ensina-nos tudo o que devemos esperar de Deus, e tudo
            o que Lhe devemos pedir.
          </Text>
          ...
          <Text className="text-base">
            ...
            Deus; em resumo, amar a Deus sobre todas as coisas, e amar ao
          ...
          <Text className="text-base">
            ...
            comunicar-nos a sua graça, e infundir e aumentar em nós as virtudes
          ...
          <Text className="text-base">
            ...
            que não se vêem. Foi a fé que fez a glória dos antigos. Pela fé
            sabemos que o universo foi criado pela palavra de Deus, de sorte que
            do invisível teve origem o visível. Pela fé Abel ofereceu a Deus
            ...
            Abel continua a falar. Epístola aos hebreus 4, 1-4
          </Text>
          ...
          <Text className="text-base">
            A primeira parte da Doutrina Cristã é o Símbolo dos Apóstolos,
            chamado vulgarmente Credo.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">17 - Quantos artigos tem o Credo?</Text>
          ...
          <Text className="text-base">
            Os artigos do Credo contêm tudo o que de mais importante devemos
          ...
          <Text className="text-base">
            ...
            todo- poderoso, e criou o céu e a terra e todas as coisas que no céu
            e na terra se contêm, isto é, todo o universo.
          </Text>
          ...
          <Text className="text-base">
            O Padre é a primeira Pessoa da Santíssima Trindade, porque não
            procede de outra Pessoa, mas é o princípio das outras duas Pessoas,
            isto é, do Filho e do Espírito Santo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Criar quer dizer fazer do nada; portanto, Deus diz-se Criador do céu
            e da terra, porque fez do nada o céu e a terra, e todas as coisas
            que no céu e na terra se contêm, isto é, todo o universo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            porque aquilo que uma Pessoa faz relativamente às criaturas,
            fazem-no com um só e o mesmo ato também as outras.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Sim, Deus cuida do mundo e de todas as coisas que criou, conserva-as
            e governa-as com a sua infinita bondade e sabedoria, e nada sucede
            no mundo, sem que Deus o queira, ou o permita.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Diz-se que nada sucede no mundo, sem que Deus o queira, ou o
            permita, porque há coisas que Deus quer e manda, e outras que Ele
            não quer, porém, não impede, como o pecado.
          </Text>
          ...
          <Text className="text-base">
            Vou declarar-vos toda a verdade e nada vos ocultarei. Já vos
            declarei e disse: É bom guardar oculto o segredo de um rei; as obras
            de Deus, porém, devem ser reveladas, com a glória devida. Quando tu
            e Sara fazíeis oração, eu apresentava o memorial de vossa prece
            diante da glória do Senhor; e fazia o mesmo quando tu, Tobi,
            enterravas os mortos. Quando não hesitaste em levantar-te e deixar
            tua refeição e saíste para resguardar o cadáver, fui enviado a ti
            para ter pôr à prova. E Deus me enviou, também, para curar a ti e a
            Sara, tua nora. Eu sou Rafael, um dos sete anjos que permanecem
            diante da glória do Senhor e têm acesso à sua presença. Atônitos, os
            dois, prostraram-se com a face por terra, cheios de temor. Mas ele
            prosseguiu: Não temais! A paz esteja convosco! bendizei a Deus por
            todos os séculos. Quando estava convosco, não era por benevolência
            minha que vos assistia, mas pela vontade de Deus. Bendizei-o todos
            os dias e cantai seus louvores. Vós me víeis comer, embora eu nada
          ...
          <Text className="text-base">
            ...
            pretenderam ser iguais a Ele, e independentes do seu poder; e por
            este pecado foram excluídos para sempre do Paraíso, e condenados ao
            Inferno.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Sim, os demônios podem fazer-nos muito mal à alma e ao corpo, se
            Deus lhes der licença, sobretudo tentando-nos a pecar.
          </Text>
          <Text className="h5">42 - Por que nos tentam os demônios?</Text>
          <Text className="text-base">
            Os demônios tentam-nos pela inveja que nos têm e que lhes faz
            desejar a nossa eterna condenação, e por ódio a Deus, cuja imagem em
            nós resplandece. E Deus permite as tentações, a fim de que nós,
          ...
          <Text className="text-base">
            Os Anjos que se conservaram fiéis a Deus, foram confirmados em
            graça, gozam para sempre da vista de Deus, amam-No, bendizem-No e
            louvam-No eternamente.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Sim, devemos ter particular devoção ao nosso Anjo da guarda,
            honrá-lo, implorar o seu auxílio, seguir as suas inspirações rações
            e ser-lhe reconhecidos pela assistência contínua que nos dá.
          </Text>

          <Text className="h4">3º - Do Homem</Text>

          <Text className="text-base">
            O Senhor Deus formou, pois, o homem do barro da terra, e inspirou no
            seu rosto um sopro de vida, e o homem tornou-se alma (pessoa)
            vivente. Ora, o Senhor Deus tinha plantado, desde o princípio um
            paraíso de delícias, no qual Pôs o homem que tinha formado. E o
            Senhor Deus tinha produzido da terra toda a casta de árvores
            formosas à vista, e de frutos doces para comer; e a árvore da vida
            no meio do paraíso, e a árvore da ciência do bem e do mal. Deste
            lugar de delícias saía um rio para regar o paraíso, o qual dali se
            divide em quatro braços. O nome do primeiro é Fison, e é aquele que
            torneia todo o país de Evilat, onde se encontra o ouro. E o ouro
            deste pais é ótimo; ali (também) se acha o bdélio e a pedra ônix. O
            nome do segundo rio é Gion; este é aquele que torneia toda a terra
          ...
          <Text className="h5">49 - Que é o homem?</Text>
          <Text className="text-base">
            O homem é uma criatura racional, composta de alma e corpo.
          </Text>
          <Text className="h5">50 - Que é a alma?</Text>
          <Text className="text-base">
            ...
            Deus e de O possuir eternamente.
          </Text>
          <Text className="h5">51 - Pode-se ver e apalpar a alma humana?</Text>
          <Text className="text-base">
            Não se pode ver nem apalpar a nossa alma, porque é espírito.
          </Text>
          <Text className="h5">52 - Morre a alma humana com o corpo?</Text>
          <Text className="text-base">
            A alma humana nunca morre; a fé e a mesma razão provam que la é
            imortal.
          </Text>
          ...
          <Text className="text-base">
            ...
            mesmo, que pode fazer uma ação e deixar de fazê-la, ou fazer antes
            uma que outra.
          </Text>
          ...
          <Text className="text-base">
            Se eu disser voluntariamente uma mentira, sinto que poderia deixar
            de dizê-la, e calar-me, e que poderia também falar de outro modo,
            dizendo a verdade.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Deus criou Adão e Eva no estado de inocência e de graça; mas
            depressa o perderam, pelo pecado.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            primeiros pais outros dons, que eles deviam transmitir, juntamente
            com a graça santificante, aos seus descendentes, e eram: a
            integridade, isto é, a perfeita sujeição dos sentidos à razão; a
            imortalidade; a imunidade de todas as dores e misérias; e a ciência
            proporcionada ao seu estado.
          </Text>
          <Text className="h5">58 - Qual foi o pecado de Adão?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            conferido ao gênero humano, em Adão, a graça santificante e os
            outros dons preternaturais, com a condição de que ele não
            desobedecesse, e tendo este desobedecido tia sua qualidade de cabeça
            e pai do gênero humano, tornou a natureza humana rebelde a Deus. Por
            isso a natureza humana é transmitida a todos os descendentes de Adão
            num estado de rebeldia contra Deus, privada da graça divina e dos
            outros dons.
          </Text>
          ...
          <Text className="text-base">
            Depois do pecado de Adão, os homens já não poderiam salvar-se, se
            Deus não tivesse usado para com eles de misericórdia.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            A misericórdia de que Deus usou para com o gênero humano, foi
            prometer logo a Adão um Redentor divino, ou Messias, enviá-Lo depois
            a seu tempo, para libertar os homens da escravidão do demônio e do
            pecado.
          </Text>
          <Text className="h5">67 - Quem é o Messias prometido?</Text>
          <Text className="text-base">
            O Messias prometido é Jesus Cristo, como nos ensina o segundo artigo
            do Credo.
          </Text>
          <Text className="h2">
          ...
          <Text className="text-base">
            Imediatamente Jesus obrigou os seus discípulos a subir para a barca
          ...
          <Text className="text-base">
            A segunda Pessoa chama-se Filho porque é gerada pelo Padre por via
            de inteligência, desde toda da ti eternidade; e por este motivo se
            chama também Verbo eterno do Padre.
          </Text>
          <Text className="h5">
            70 - Sendo também nós filhos de Deus, por que Jesus Cristo se chama
            Filho único de Deus Padre?
          </Text>
          <Text className="text-base">
            Jesus Cristo chama-se Filho único de Deus porque só Ele é por
            natureza seu Filho, e nós seus filhos por criação e por adoção.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            sacerdotes e os profetas e Jesus é Rei dos reis, Sumo Sacerdote e
            Sumo Profeta.
          </Text>
          ...
          <Text className="text-base">
            As principais figuras do Redentor no Antigo Testamento são o
            inocente Abel, o sumo sacerdote Melquisedec, o sacrifício de Isaac,
            José vendido pelos irmãos, o profeta Jonas, o cordeiro pascal e a
            serpente de bronze, levantada por Moisés tio deserto.
          </Text>
          ...
          <Text className="text-base">
            ...
            palavras, ela se perturbou e refletia no que poderia significar a
            saudação. Mas o anjo lhe falou: Não tenhas medo, Maria, porque
            encontraste graça diante de Deus. Eis que conceberás e darás à luz
            um filho e lhe porás o nome de Jesus. Ele será grande e será chamado
            Filho do Altíssimo. O Senhor Deus lhe dará o trono de Davi, seu pai.
            Ele reinará na casa de Jacó pelos séculos e seu reino não terá fim.
            Maria perguntou ao anjo: Como acontecerá isso, pois não conheço
            homem? Em resposta o anjo lhe disse: O Espírito Santo virá sobre ti
            e o poder do Altíssimo te cobrirá com sua sombra; e por isso mesmo
            Santo que vai nascer de ti será chamado Filho de Deus. Eis que
            também Isabel, tua parenta, concebeu um filho em sua velhice, e este
            é o sexto mês daquela que era considerada estéril, porque para Deus
            nada é impossível. Disse então Maria: Eis aqui a serva do Senhor.
            Aconteça comigo segundo tua palavra! E o anjo afastou-se dela. Luc
            1, 26-33
          </Text>
          ...
          <Text className="text-base">
            ...
            Encarnação do Filho de Deus é obra de bondade e de amor, e as obras
            de bondade e de amor atribuem-se ao Espírito Santo.
          </Text>
          ...
          <Text className="text-base">
            Sim, em Jesus Cristo, que é Deus e homem, há duas naturezas, a
            divina e a humana.
          </Text>
          ...
          <Text className="text-base">
            ...
            isto é, Jesus Cristo, verdadeiro Deus e verdadeiro homem.
          </Text>

          <Text className="h5">92 - E a Virgem Maria, será Mãe de Deus?</Text>
          <Text className="text-base">
            Sim, Maria Santíssima é Mãe de Deus, porque é Mãe de Jesus Cristo,
            que é verdadeiro Deus.
          </Text>
          ...
          <Text className="text-base">
            Levaram, pois, Jesus da casa de Caifás ao Pretório. Era de manhã.
            ...
            reino fosse deste inundo, certamente que os meus ministros se haviam
            de esforçar para que eu não fosse entregue aos judeus; mas o meu
            reino não é daqui. Disse-lhe então Pilatos: Logo tu és rei?
            Respondeu Jesus: Tu dizes, sou rei, Nasci, e vim ao mundo para dar
            testemunho da verdade; todo o que está pela verdade. ouve a minha
            voz. "Disse lhe Pilatos: O que é a verdade? Dito isto, tornou a
            sair, para ir ter com os judeus e disse-lhes: Não encontro nele
            crime algum. Ora é costume que eu pela Páscoa, vos solte um
            prisioneiro; quereis. pois, que vos solte o rei dos judeus? Então
            ...
            crucificai-o, porque eu não en centro nele crime algum
            Responderam-lhe os judeus: Nós temos uma lei e segundo a lei deve
            ...
            Pilatos soltá-lo. Porém os judeus gritavam, dizendo: Se soltas este,
            não é, amigo de César, Porque todo o que se faz rei, declara-se
            contra César. Pilatos, tendo ouvido estas palavras, conduziu Jesus
            para fora e sentou se no seu tribunal. no lugar chamado
            Lithostrotos, em hebraico Gabbatha. Era a Parásceve (ou dia de
            preparação) da Páscoa, cerca da hora sexta, e disse aos judeus: Eis
          ...
          <Text className="h5">96 - Que quer dizer a palavra padeceu?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            Jesus Cristo padeceu enquanto homem somente, porque enquanto Deus
            não podia padecer nem morrer.
          </Text>
          ...
          <Text className="text-base">
            O suplício da cruz era, naqueles tempos, o mais cruel e ignominioso
          ...
          <Text className="text-base">
            ...
            satisfazê-la requeria-se uma pessoa que tivesse merecimento
            infinito.
          </Text>

          <Text className="h5">
            104 - Para satisfazer à justiça divina era necessário que Jesus
            Cristo fosse Deus e homem ao mesmo tempo?
          </Text>
          <Text className="text-base">
            Sim, era necessário que Jesus Cristo fosse homem para poder padecer
            e morrer, e era necessário que fosse Deus, para que os seus
            sofrimentos fossem de valor infinito.
          </Text>
          ...
          <Text className="text-base">
            Jesus quis sofrer tanto, para satisfazer mais abundantemente à
            justiça divina, para nos mostrar mais claramente o seu amor, e para
            nos inspirar maior horror ao pecado.
          </Text>
          ...
          <Text className="text-base">
            Sim, na morte de Jesus obscureceu-se o sol, tremeu a terra,
            abriram-se algumas sepulturas, e muitos mortos ressuscitaram.
          </Text>
          ...
          <Text className="text-base">
            O quinto artigo do Credo ensina-nos que a alma de Jesus Cristo,
            assim que se separou do corpo, foi ao Limbo e que, no terceiro dia,
            se uniu de novo ao corpo, para nunca mais dele se separar.
          </Text>

          <Text className="h5">115 - Que se entende aqui por inferno?</Text>
          <Text className="text-base">
            Por inferno entende-se aqui o Limbo, isto é, aquele lugar onde
            estavam as almas dos justos, esperando ti redenção de Jesus Cristo.
          </Text>
          ...
          <Text className="text-base">
            ...
            de Jesus Cristo, porque pelo pecado de Adão o Paraíso estava
            fechado; e convinha que Jesus Cristo, cuja morte o reabriu, fosse o
            primeiro a entrar nele.
          </Text>
          ...
          <Text className="text-base">
            A ressurreição de Jesus Cristo não foi semelhante à dos outros
            homens ressuscitados, porque Jesus Cristo ressuscitou por virtude
          ...
          <Text className="text-base">
            Os que prenderam Jesus levaram-no a Caifás, o Sumo Sacerdote, onde
          ...
          <Text className="text-base">
            ...
            levada ao Céu, porque Jesus Cristo, sendo Homem-Deus, subiu ao Céu
            por virtude própria; mas sua Mãe, que era criatura, embora a mais
            digna de todas, foi levada ao Céu por virtude de Deus.
          </Text>
          ...
          <Text className="text-base">
            As palavras está sentado significam ti posse pacífica que Jesus
            Cristo tem da sua glória, o as palavras à direita de Deus Padre
            todo-poderoso exprimem que Ele, tem o lugar de honra sobre todas as
            criaturas.
          </Text>
          ...
          <Text className="text-base">
            ...
            separa as ovelhas dos cabritos. Colocará as ovelhas à sua direita e
            os cabritos, à esquerda. E o rei dirá aos que estiverem à sua
            direita: Vinde, abençoados por meu Pai! Tomai posse do Reino
            preparado para vós desde a criação do mundo. Porque tive fome e me
            destes de comer, tive sede e me destes de beber, fui peregrino e me
            acolhestes e, estive nu e me vestistes, enfermo e me visitastes,
            ...
            fome e não me destes de comer, tive sede e não me destes de beber,
            fui peregrino e não me destes abrigo; estive nu e não me vestistes,
          ...
          <Text className="text-base">
            ...
            cheio de glória e de majestade, há de vir do Céu para julgar todos
            os homens, bons e maus, e para dar a cada um o prêmio ou o castigo
            que tiver merecido.
          </Text>
          ...
          <Text className="text-base">
            No Juízo universal há de manifestar-se a de Deus, porque todos hão
            de reconhecer a justiça com que Deus governa o mundo, embora se
            vejam às vezes os bons a sofrer e o maus em prosperidade.
          </Text>
          ...
          <Text className="text-base">
            ...
            porque, tendo Ele sido injustamente condenado pelos homens,
            aparecerá então à face do mundo inteiro como Juiz supremo de todos.
          </Text>
          ...
          <Text className="text-base">
            ...
            verão manifestados, à vista de todo o mundo, os pecados que
            cometeram ainda os mais ocultos.
          </Text>
          ...
          <Text className="text-base">
            ...
            lugar. De repente veio do céu um ruído, como de um vento impetuoso,
            que encheu toda a casa em que estavam sentados. Viram aparecer,
            então, uma espécie de línguas de fogo, que se repartiram e foram
            ...
            concedia que falassem. Ora, em Jerusalém moravam judeus, homens
            piedosos, de todas as nações que há debaixo do céu. Ouvindo aquele
            ruído, acorreu muita gente e se maravilhava de que cada um os
            ouvisse falar em sua própria língua. Profundamente impressionados,
            ...
            nossas próprias línguas. Atônitos e fora de si, diziam uns para os
            outros: O que quer dizer isso? Outros, zombando, diziam: Eles estão
          ...
          <Text className="h5">131 - De quem procede o Espírito Santo?</Text>
          <Text className="text-base">
            O Espírito Santo procede do Padre e do Filho como de um só
            princípio, por via de vontade e de amor.
          </Text>
          ...
          <Text className="text-base">
            ...
            gerou o Filho desde toda a eternidade, e do Padre e do Filho procede
            o Espírito Santo, também desde toda a eternidade.
          </Text>
          ...
          <Text className="text-base">
            Os Apóstolos ficaram reunidos no Cenáculo em companhia da Virgem
            Maria e os outros discípulos, e perseveravam na oração esperando o
            Espírito Santo que Jesus lhes havia prometido.
          </Text>
          ...
          <Text className="text-base">
            O Espírito Santo confirmou na fé os Apóstolos, encheu-os de luzes,
            de forças, de caridade e da abundância de todos os seus dons.
          </Text>
          ...
          <Text className="text-base">
            O Espírito Santo foi enviado a toda a Igreja e a todas as almas
            fiéis.
          </Text>
          ...
          <Text className="text-base">
            ...
            resolveram escolher alguns homens e enviá-los a Antioquia com Paulo
            e Barnabé; escolheram Judas, chamado Barsabás, e Silas, homens
            ...
            palavras, confundindo vossas mentes, sem nenhuma autorização de
            nossa parte. Por isso resolvemos, de comum acordo, enviar-vos alguns
            homens escolhidos, em companhia de nossos amados Barnabé e Paulo,
            que expuseram suas vidas pelo nome de Nosso Senhor Jesus Cristo.
            Estamos enviando Judas e Silas para vos comunicar de viva voz as
            mesmas coisas. Pareceu bem ao Espírito Santo e a nós não vos impor
            ...
            prostituição. Procedereis bem evitando estas coisas. Passai bem.
            Atos 15, 22-29
          </Text>
          ...
          <Text className="text-base">
            ...
            todas as pessoas que fazem parte desta Igreja estão em comunhão
            entre si.
          </Text>
          ...
          <Text className="text-base">
            Depois do artigo que trata do Espírito Santo, fala-se imediatamente
            da Igreja Católica, para indicar que toda a santidade da mesma
            Igreja procede do Espírito Santo, que é o autor de toda a santidade.
          </Text>

          <Text className="h5">144 - Que quer dizer esta palavra Igreja?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            triunfante; parte no Purgatório, e formam a Igreja padecente; parte
            na terra, e formam a Igreja militante.
          </Text>
          ...
          <Text className="text-base">
            Sim, estas diversas partes da Igreja constituem uma só Igreja e um
            só corpo, porque têm a mesma cabeça que é Jesus Cristo, o mesmo
            espírito que as anima e as tine, e o mesmo fim que é a felicidade
            eterna, que uns já estão gozando e que outros esperam.
          </Text>
          ...
          <Text className="text-base">
            Este nono artigo do Credo refere-se principalmente à Igreja
            militante, que é a Igreja na qual estamos atualmente.
          </Text>

          <Text className="h4">2º - Da Igreja em particular</Text>
          <Text className="h5">149 - Que é a Igreja Católica?</Text>
          <Text className="text-base">
            A Igreja Católica é a sociedade ou reunião de todas as pessoas
            baptizadas que, vivendo na terra, professam a mesma fé e a mesma lei
            de Cristo, participam dos mesmos Sacramentos, e obedecem aos
          ...
          <Text className="text-base">
            Para alguém ser membro da Igreja, é necessário estar baptizado, crer
            e professar a doutrina de Jesus Cristo, participar dos mesmos
          ...
          <Text className="text-base">
            ...
            sociedades ou seitas fundadas pelos homens e que se dizem cristãs,
            por quatro notas características. Ela é Una, Santa, Católica e
            Apostólica.
          </Text>

          <Text className="h5">155 - Por que dizeis que a Igreja é Una?</Text>
          <Text className="text-base">
            Digo que a verdadeira Igreja é Una, porque os seus filhos, de
            qualquer tempo ou lugar, estão unidos entre si na mesma fé, no mesmo
            culto, na mesma lei e na participação dos mesmos Sacramentos, sob o
          ...
          <Text className="text-base">
            ...
            diocese, mas são sempre porções da Igreja universal, e formam com
            ela uma só Igreja.
          </Text>
          ...
          <Text className="text-base">
            ...
            encontram só na Igreja que tem por chefe o Bispo de Roma, sucessor
            de São Pedro.
          </Text>
          ...
          <Text className="h5">163 - Em que consiste a alma da Igreja?</Text>
          <Text className="text-base">
            A alma da Igreja consiste no que Ela tem de interior e de
            espiritual, isto é, a Fé, a Esperança, a Caridade, os dons da graça
            e do Espírito Santo, e todos os tesouros celestes que lhe provieram
            dos merecimentos de Cristo Redentor e dos Santos.
          </Text>
          ...
          <Text className="text-base">
            ...
            salvar-se, como ninguém pôde salvar-se do dilúvio fora da arca de
            Noé, que era figura desta Igreja.
          </Text>
          ...
          <Text className="text-base">
            Todos os justos do Antigo Testamento se salvaram em virtude da fé
            que tinham em Cristo que havia de vir, por meio da qual eles já
            pertenciam espiritualmente a esta Igreja.
          </Text>
          ...
          <Text className="text-base">
            ...
            Cristo disse aos Pastores da Igreja: Quem vos ouve, a Mim ouve, e
          ...
          <Text className="text-base">
            Não. A Igreja Católica pode ser perseguida, mas não pode ser
            destruída nem perecer. Ela há de durar até ao fim do mundo, porque
            até ao fim do mundo Jesus Cristo estará com Ela, como prometeu.
          </Text>
          ...
          <Text className="text-base">
            ...
            Ora, um etíope, camareiro e tesoureiro-mor a serviço da rainha
            Candace da Etiópia, tinha ido prestar culto em Jerusalém. Voltava,
            sentado no seu carro, lendo o profeta Isaías. O Espírito Santo disse
            a Filipe: Aproxima-te e acompanha aquele carro. Filipe acelerou o
            passo. Ouvindo que lia o profeta Isaías, perguntou: Será que estás
            entendendo o que lês? Ele respondeu: Como é que vou entender se
            ninguém me orienta? Então convidou Filipe para subir e sentar-se ao
            seu lado. A passagem da Escritura que ele lia era a seguinte: Como
            uma ovelha levada ao matadouro, e como um cordeiro diante de quem o
            tosquia, ele emudeceu e não abre a boca. Com humilhação foi
            consumado o seu julgamento; de seus descendentes, quem falará? pois
            a sua vida é tirada da terra. O camareiro perguntou a Filipe:
            Dize-me, de quem o profeta está falando? De si mesmo ou de outro?
            Filipe pôs-se a falar e, começando com esta passagem da escritura,
            anunciou-lhe a boa-nova de Jesus. Seguindo o caminho, encontraram
            água e o camareiro disse: Aqui existe água, o que impede que eu seja
            baptizado? Mandou parar o carro, e os dois desceram para a água,
            Filipe e o camareiro, e Filipe o baptizou. Quando subiram da água, o
          ...
          <Text className="text-base">
            ...
            porque há uns que mandam, outros que obedecem, uns que ensinam,
            outros que são ensinados.
          </Text>
          ...
          <Text className="text-base">
            A Igreja docente e a Igreja discente são duas partes distintas de
            uma só e mesma Igreja, como no corpo humano a cabeça é distinta dos
            outros membros, e, não obstante, forma com eles um corpo só.
          </Text>
          ...
          <Text className="text-base">
            Sim, além da autoridade de ensinar, a Igreja tem especialmente o
            poder de administrar as coisas santas, de fazer leis e de exigir a
            sua observância.
          </Text>
          ...
          <Text className="text-base">
            O poder que têm os membros da hierarquia eclesiástica não vem do
            Povo, e seria heresia o dizê-lo: vem unicamente de Deus.
          </Text>
          ...
          <Text className="text-base">
            ...
            Jonas, porque não foi a carne nem o sangue quem te revelou isso, mas
            o Pai que está nos céus. E eu te digo: Tu és Pedro e sobre esta
            pedra construirei a minha Igreja e as portas do inferno nunca
            levarão vantagem sobre ela. Eu te darei as chaves do reino dos céus,
            e tudo que ligares na terra será ligado nos céus, e tudo que
            desligares na terra será desligado nos céus. E deu ordens aos
            discípulos de não falarem para ninguém que ele era o Cristo. Mt 16,
            13-20.
          </Text>

          <Text className="h5">191 - Quem é o Papa?</Text>
          <Text className="text-base">
            O Papa, a quem chamamos também Sumo Pontífice ou Romano Pontífice, é
            o sucessor de São Pedro na Sede de Roma, o Vigário de Jesus Cristo
            na terra, e o chefe visível da Igreja.
          </Text>
          ...
          <Text className="text-base">
            O Romano Pontífice é o sucessor de São Pedro. porque São Pedro
            reuniu na sua pessoa a dignidade de Bispo de Roma e de chefe da
            Igreja e porque, por disposição divina, estabeleceu em Roma a sua
            sede, e aí morreu. Por isso quem é eleito Bispo de Roma, é também
            herdeiro de toda a sua autoridade.
          </Text>
          ...
          <Text className="text-base">
            O Romano Pontífice é o Vigário de Jesus Cristo porque ele O
            representa na terra, e faz as suas vezes no governo da Igreja.
          </Text>
          ...
          <Text className="h5">195 - Qual é, pois, a dignidade do Papa?</Text>
          <Text className="text-base">
            A dignidade do Papa é a maior entre todas as dignidades da terra e
            dá-lhe um poder supremo e imediato sobre todos e cada um dos
          ...
          <Text className="text-base">
            O Papa é infalível em razão da promessa de Jesus Cristo e da
            contínua assistência do Espírito Santo.
          </Text>

          <Text className="h5">198 - Quando o Papa é infalível?</Text>
          <Text className="text-base">
            ...
            define uma doutrina relativa à fé e aos costumes, que deve ser
            seguida por toda a Igreja.
          </Text>
          ...
          <Text className="text-base">
            Não. A Igreja, ao definir que o Papa é infalível, não estabeleceu
            uma nova verdade de fé, mas só definiu, para se opor a erros novos,
            que a infalibilidade do Papa, contida já na Sagrada Escritura e na
            Tradição, e uma verdade revelada por Deus, e que por conseguinte se
          ...
          <Text className="text-base">
            Depois do Papa, por instituição divina, as personagens mais
            venerandas da Igreja são os Bispos.
          </Text>
          ...
          <Text className="text-base">
            Chama-se o Bispo Pastor legítimo, porque a jurisdição, isto é, o
            poder que tem de governar os fiéis da própria diocese, foi-lhe
            conferido segundo as normas e leis da Igreja.
          </Text>
          ...
          <Text className="text-base">
            ...
            são sucessores dos Apóstolos, no que diz respeito ao governo
            ordinário da Igreja.
          </Text>
          ...
          <Text className="text-base">
            Sim, todo o fiel, eclesiástico ou leigo, deve estar unido de
            espírito e de coração ao próprio Bispo que está em graça e comunhão
            com a Se Apostólica.
          </Text>
          ...
          <Text className="text-base">
            ...
            próprio Bispo, e prestar-lhe obediência em tudo o que se refere ao
            bem das almas e ao governo espiritual da diocese.
          </Text>
          ...
          <Text className="h5">212 - Quem é o pároco?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            docilidade, professar-lhe respeito e submissão em tudo o que
            interessa ao bem da paróquia.
          </Text>

          <Text className="h4">5º - Da comunhão dos Santos</Text>
          <Text className="text-base">
            ...
            não há trevas. Se dizemos ter comunhão com ele mas andamos nas
            trevas, mentimos e não praticamos a verdade. Se, porém, andamos na
            luz, assim como ele está na luz, estamos em comunhão uns com os
          ...
          <Text className="text-base">
            ...
            ensina-nos que na Igreja, pela íntima união que existe entre todos
            os seus membros, são comuns os bens espirituais, assim internos como
          ...
          <Text className="text-base">
            Na comunhão dos bens internos entram somente os cristãos que estão
            em graça de Deus; os que estão em pecado mortal não participam de
            todos estes bens.
          </Text>
          ...
          <Text className="text-base">
            Porque é a graça de Deus. vida sobrenatural da alma, que une os
            fiéis a Deus e a Jesus Cristo como seus membros vivos e os torna
            capazes de fazer obras meritórias para a vida eterna; e porque
            aqueles que se encontram em estado de pecado mortal, não tendo a
            graça de Deus, estão excluídos da comunhão perfeita dos bens
            espirituais e não podem fazer obras meritórias rias para a vida
            eterna.
          </Text>
          ...
          <Text className="text-base">
            Os membros desta comunhão chamam-se Santos, porque todos são
            chamados à santidade, e foram santificados por meio do Batismo, e
            muitos deles já atingiram a santidade perfeita.
          </Text>
          ...
          <Text className="text-base">
            ...
            as almas do Purgatório, aplicando, em sufrágio delas, Missas,
            esmolas, indulgências e outras boas obras.
          </Text>
          ...
          <Text className="text-base">
            Aqueles que não participam da comunhão dos Santos são, na outra
            vida, os condenados, e nesta vida aqueles que não pertencem nem à
            alma nem ao corpo da Igreja, quer dizer, aqueles que estão em estado
            de pecado mortal e se encontram fora da verdadeira Igreja.
          </Text>
          ...
          <Text className="text-base">
            ...
            crêem em Cristo Messias, nem como vindo na pessoa de Jesus Cristo,
            nem como havendo de vir ainda: tais são os maometanos e outros
            semelhantes.
          </Text>
          ...
          <Text className="text-base">
            ...
            em alguma verdade revelada por Deus e ensinada conto de fé pela
            Igreja Católica: por exemplo, os arianos, os nestorianos e as várias
            seitas dos protestantes.
          </Text>
          ...
          <Text className="text-base">
            ...
            indignos, do corpo da Igreja, a qual espera e deseja a sua
            conversão.
          </Text>

          <Text className="h5">231 - Deve-se temer a excomunhão?</Text>
          <Text className="text-base">
            Deve-se temer grandemente a excomunhão, porque é o castigo mais
            grave e mais terrível que a Igreja pode infligir aos seus filhos
            rebeldes e obstinados.
          </Text>
          ...
          <Text className="text-base">
            Os excomungados ficam privados das orações publicas, dos
            Sacramentos, das indulgências e excluídos da sepultura eclesiástica.
          </Text>
          ...
          <Text className="text-base">
            ...
            outros que estão fora da verdadeira Igreja com advertências
            salutares, com orações e boas obras, suplicando a Deus que pela sua
            misericórdia lhes conceda a graça de se converterem à Fé e de
            entrarem na comunhão dos Santos.
          </Text>
          ...
          <Text className="text-base">
            ...
            que ele estava em casa. Reuniu-se tanta gente que nem mesmo em
            frente à porta havia lugar para todos. E Jesus lhes anunciava a
            palavra. Trouxeram-lhe um paralítico, carregado por quatro homens.
            Como não podiam levá-lo até Jesus, por causa da multidão,
          ...
          <Text className="h5">237 - Como perdoa a Igreja os pecados?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            Deus quer a ressurreição dos corpos para que a nossa alma, tendo
            feito o bem ou o final unida ao corpo, receba juntamente com ele o
            prêmio ou o castigo.
          </Text>
          ...
          <Text className="text-base">
            ...
            tinha enxugado os pés com os cabelos. Seu irmão Lázaro estava
            enfermo. As irmãs mandaram dizer a Jesus: Senhor, aquele a quem amas
            ...
            falta a luz. Depois destas palavras, acrescentou: Lázaro, nosso
            amigo, adormeceu mas eu vou despertá-lo. Senhor, se ele está
            dormindo é porque vai ficar bom disseram os discípulos. Jesus se
            referia à morte, mas eles pensavam que estivesse falando do repouso
            do sono. Então Jesus lhes falou claramente: Lázaro morreu. Eu me
            alegro de não ter estado lá, para que vós assim acrediteis. Mas
            vamos até ele. Tomé, chamado Dídimo, disse então aos companheiros:
            Vamos nós também para morrermos com ele. Quando Jesus chegou, já
            fazia quatro dias que Lázaro estava no túmulo. Betânia ficava perto
            de Jerusalém, a uns três quilômetros. Muitos judeus tinham vindo até
            Marta e Maria para as consolar da morte do irmão. Quando Marta ouviu
            que Jesus havia chegado, saiu-lhe ao encontro. Maria ficou sentada
            em casa. Marta disse a Jesus: Senhor, se tivesses estado aqui, meu
            irmão não teria morrido. Sei, porém, que tudo quanto pedires a Deus
            ele te concederá. Jesus respondeu: Teu irmão ressuscitará.\* Sei que
            ele ressuscitará na ressurreição do último dia disse Marta. Jesus
            ...
            Senhor, se tivesses estado aqui, o meu irmão não teria morrido.
            Quando viu que Maria e todos os judeus que vinham com ela estavam
            chorando, Jesus se comoveu profundamente. E emocionado, perguntou:
            Onde o pusestes? Senhor, vem ver disseram-lhe. Jesus começou a
            chorar. Os judeus comentavam: Vede como ele o amava. Al- guns,
            porém, disseram: Ele, que abriu os olhos do cego de nascença, não
            podia fazer com que Lázaro não morresse? Tomado novamente de
            profunda emoção, Jesus se dirigiu ao sepulcro. Era uma gruta com uma
            pedra colocada na entrada. Jesus ordenou: Tirai a pedra. Marta, irmã
            do morto, disse: Senhor, já está cheirando mal, pois já são quatro
            dias que está aí. Jesus respondeu: Eu não te disse que, se
            acreditasses, verias a glória de Deus? Tiraram então a pedra. Jesus
            levantou os olhos para o alto e disse: Pai, eu te dou graças porque
            me atendeste. Eu sei que sempre me atendes, mas digo isto por causa
            da multidão que me rodeia, para que creiam que tu me enviaste.
            Depois dessas palavras, gritou bem forte: Lázaro, vem para fora! O
            morto saiu com os pés e as mãos atados com faixas e o rosto envolto
            num sudário. Jesus ordenou: Desatai-o e deixai-o andar. João 11,
            1-44
          </Text>
          ...
          <Text className="text-base">
            ...
            outra, ou eternamente feliz para os eleitos no Paraíso, ou
            eternamente desgraçada para os condenados no Inferno.
          </Text>
          ...
          <Text className="text-base">
            A felicidade dos eleitos consiste em ver, amar e possuir para sempre
            a Deus, fonte de todo o bem.
          </Text>
          ...
          <Text className="text-base">
            ...
            almas porque por enquanto só as almas estão no Paraíso, ou no
            Inferno; mas depois da ressurreição da carne, os homens, na
            plenitude da sua natureza, isto é, em corpo e alma, serão ou felizes
          ...
          <Text className="text-base">
            ...
            medida, isto é, no grau, serão maiores ou menores, segundo os
            méritos ou deméritos de cada um.
          </Text>
          ...
          <Text className="h5">256 - Que é a oração particular?</Text>
          <Text className="text-base">
            A oração particular é a que faz cada um em particular, por si ou
            pelos outros.
          </Text>

          <Text className="h5">257 - Que é a oração pública?</Text>
          <Text className="text-base">
            A oração pública é a que fazem os ministros sagrados, em nome da
            Igreja, e pela salvação do povo fiel. Pode-se chamar pública também
            a oração feita em comum e publicamente pelos fiéis, como nas
            procissões, nas peregrinações e na Igreja.
          </Text>
          ...
          <Text className="text-base">
            ...
            fundamentada nas promessas de Deus onipotente, muito misericordioso
            e fidelíssimo, e nos merecimentos de Jesus Cristo.
          </Text>
          ...
          <Text className="text-base">
            ...
            condição de que sejam conformes à sua santíssima vontade, e não
            sejam obstáculo à nossa eterna salvação.
          </Text>
          ...
          <Text className="text-base">
            Para bem orar requerem-se especialmente o recolhimento, a humildade,
            a confiança, a perseverança e a resignação.
          </Text>
          ...
          <Text className="text-base">
            ...
            possível, as distrações, isto é, todo o pensamento estranho à
            oração.
          </Text>
          ...
          <Text className="text-base">
            ...
            diligência. Se porém fizermos quanto podemos para estarmos
            recolhidos em Deus, então as distrações não diminuem o merecimento
            da nossa oração, mas até o podem aumentar.
          </Text>
          ...
          <Text className="text-base">
            Quer dizer: reconhecer sinceramente a nossa indignidade,
            incapacidade e miséria, acompanhando a oração com a compostura do
            corpo.
          </Text>

          <Text className="h5">271 - Que quer dizer orar com confiança?</Text>
          <Text className="text-base">
            Quer dizer que devemos ter firme esperança de sermos atendidos, se
            daí provier a glória de Deus e o nosso verdadeiro bem.
          </Text>
          ...
          <Text className="text-base">
            Quer dizer que não nos devemos cansar de orar, se Deus não nos
            atender imediatamente, senão que devemos continuar a orar ainda com
            mais fervor.
          </Text>
          ...
          <Text className="text-base">
            Sim, Deus atende sempre as orações bem feitas; mas da maneira que
            Ele sabe ser mais útil para a nossa salvação eterna, e não sempre
            segundo a nossa vontade.
          </Text>

          <Text className="h5">275 - Que efeitos produz em nós a oração?</Text>
          <Text className="text-base">
            A oração faz-nos reconhecer a nossa dependência, em todas as coisas,
            de Deus, supremo Senhor, faz-nos progredir na virtude, alcança-nos
            de Deus misericórdia fortalece- nos contra as tentações,
            conforta-nos nas tribulações, auxilia-nos nas nossas necessidades e
          ...
          <Text className="text-base">
            Devemos orar por todos; isto é, por nós mesmos pelos nossos
            parentes, superiores, benfeitores, amigos e inimigos; pela conversão
          ...
          <Text className="text-base">
            ...
            ele responder lá de dentro: Não me incomodes, a porta já está
            fechada e eu e meus filhos já estamos deitados; não posso me
            levantar para te dar os pães. Eu vos digo: Se ele não se levantar e
            não lhe der os pães por ser seu amigo, ao menos se levantará por
            ...
            Espírito Santo aos que pedirem! Luc 11, 1-13
          </Text>
          ...
          <Text className="text-base">
            ...
            despertar a nossa confiança na sua infinita bondade, visto sermos
            seus filhos.
          </Text>
          ...
          <Text className="text-base">
            Deus está em toda a parte; mas dizemos: Padre Nosso que estais no
            Céu, para elevar os nossos corações ao Céu, onde Deus se manifesta
            na glória aos seus filhos.
          </Text>
          ...
          <Text className="text-base">
            ...
            cismáticos voltem à unidade da Igreja, que os pecadores se corrijam
            e que os justos sejam perseverantes no bem.
          </Text>
          ...
          <Text className="text-base">
            Em primeiro lugar pedimos que seja santificado o nome de Deus,
            porque devemos prezar mais a glória de Deus do que todos os nossos
            bens e vantagens.
          </Text>
          ...
          <Text className="text-base">
            ...
            no Céu. pedimos a graça de fazer em todas as coisas a vontade de
            Deus, obedecendo aos seus santos Mandamentos tão prontamente como os
            Anjos e os Santos Lhe obedecem no Céu. Pedimos, além disso, a graça
            de corresponder às inspirações divinas e de viver resignados à
            vontade de Deus, quando Ele nos manda tribulações.
          </Text>
          <Text className="h5">
            297 - É-nos necessário cumprir a vontade de Deus?
          </Text>
          <Text className="text-base">
            É-nos tão necessário cumprir a vontade de Deus, como nos é
            necessário conseguir a salvação eterna, porque Jesus Cristo disse
            que só entrará tio reino dos céus quem tiver feito a vontade de seu
            Pai.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            postos por Deus para guiar-nos no caminho da Salvação, nos orientam
            a fim de que conheçamos os desígnios particulares da Providência a
            nosso respeito, desígnios que se podem manifestar em divinas
            inspirações ou nas circunstâncias em que o Senhor nos tenha
            colocado.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Não. A revelação Divina encerrou-se com a morte do último Apóstolo,
            de maneira que não há mais Revelação pública necessária para a
            salvação. A afirmação de que devemos ver em todas as coisas a
            Vontade de Deus, diz apenas que todas as coisas estão sujeitas à
            Santíssima Vontade de Deus, de maneira que mesmo o mal não acontece
            sem uma permissão de Deus, que sabe tirar o bem do mal, e por isso o
            permite. E como Deus tem sobre os homens uma amorosa Providência,
            devemos ver em todos os acontecimentos, bons ou maus, um desígnio de
            Deus que visa nossa salvação eterna.
          </Text>
          ...
          <Text className="text-base">
            ...
            é, pedimos ao Senhor que nos dê a sua graça, da qual a todo o
            instante temos necessidade.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Para o nosso corpo pedimos o que é necessário para o sustento da
            vida temporal.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Dizemos: O pão nosso nos dai hoje, e não dizemos: dai-nos hoje o
            pão, para excluir todo o desejo tio, bens alheios. Por isso pedimos
            ao Senhor que nos ajude nos ganhos justos e lícitos, a fim de
            granjearmos o sustento com o nosso trabalho, sem furtos nem fraudes.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Nossos pecados são chamados de dívidas porque por causa deles
            devemos satisfazer a divina justiça, seja nesta vida, seja na outra.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            Deus lhes perdoe, tanto mais que se condenam por si mesmos, dizendo
            ti Deus que lhes perdoe, como eles perdoam ao próximo.
          </Text>
          ...
          <Text className="text-base">
            Não é pecado ter tentações, mas é pecado consentir nelas, ou
          ...
          <Text className="text-base">
            Na sétima petição: mas livrai-nos do mal, pedimos a Deus que nos
            livre dos males passados, presentes, futuros, e especialmente do
            sumo mal, que é o pecado, da condenação eterna, que é o seu castigo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            que são nocivos à nossa alma, e por isso pedimos a libertação do mal
            em geral, isto é, de tudo aquilo que Deus vê que para nós é mal.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            sempre entregando-nos à vontade de Deus, que pode no entanto,
            ordenar aquela tribulação para proveito da nossa alma.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Devemos rezar o Padre-Nosso todos os dias, por que todos os dias
            temos necessidade do auxílio de Deus.
          </Text>
          <Text className="h2">
          ...
          <Text className="text-base">
            ...
            Maria perguntou ao anjo: Como acontecerá isso, pois não conheço
            homem? Em resposta o anjo lhe disse: O Espírito Santo virá sobre ti
            e o poder do Altíssimo te cobrirá com sua sombra; é por isso que o
            menino santo que vai nascer será chamado Filho de Deus. Até Isabel,
          ...
          <Text className="text-base">
            As palavras do Arcanjo São Gabriel são: Ave, cheia de graça; o
          ...
          <Text className="text-base">
            ...
            privilégios com que Deus a favoreceu de preferência a todas as
            outras criaturas.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            As palavras de Santa Isabel são: Bendita sois vós entre as mulheres,
          ...
          <Text className="text-base">
            Todas as demais palavras da Ave-Maria foram acrescentadas pela
            Igreja.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Com as ultimas palavras da Ave-Maria pedimos o proteção da
            Santíssima Virgem no decurso desta vida e especialmente na hora da
            nossa morte, no qual nos será mais necessária.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            nos ensinou, pedimos à Santíssima Virgem que nos alcance as graças
            que imploramos.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            Moisés disse a Josué: Escolhe alguns homens e sai para combater
            contra os amalecitas. Amanhã estarei de pé no alto da colina com a
            vara de Deus na mão. Josué fez o que Moisés lhe tinha mandado, e
            atacou os amalecitas, enquanto Moisés, Aarão e Hur subiram ao topo
            ...
            desgraça que o Senhor lhe tinha enviado; cada um lhe ofereceu uma
            soma de dinheiro e um anel de ouro. O Senhor abençoou a Jó pelo fim
            de sua vida mais do que no princípio; possuía agora quatorze mil
            ovelhas, seis mil camelos, mil juntas de bois e mil jumentas. Teve
            sete filhos e três filhas: a primeira chamava-se Rola; a segunda,
            Cássia; a terceira, Azeviche. Não havia em todo o país mulheres mais
          ...
          <Text className="text-base">
            Os Mandamentos da Lei de Deus têm esse nome porque foi o próprio
            Deus que os gravou na alma de todo o homem, os promulgou no monte
            Sinai, na antiga Lei, esculpidos em duas tábuas de pedra, e Jesus
            Cristo os confirmou na Lei nova.
          </Text>
          <Text className="h5">
            345 - Quais são os Mandamentos da primeira tábua?
          </Text>
          <Text className="text-base">
            Os Mandamentos da primeira tábua são os três primeiros, que se
            referem diretamente a Deus, e aos deveres que temos para com Ele.
          </Text>
          <Text className="h5">
            346 - Quais são os Mandamentos da segunda tábua?
          </Text>
          <Text className="text-base">
            Os Mandamentos da segunda tábua são os últimos sete, que se referem
            ao próximo e aos deveres que temos para com ele.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            muitos se orgulham das coisas humanas, também eu vou orgulhar-me.
            Vós, que sois sensatos, suportais de boa vontade os insensatos. Sim,
            suportais quem vos escraviza, quem vos devora, quem vos explora,
            quem vos trata com orgulho, quem vos bate no rosto. Neste ponto,
            ...
            um. Três vezes fui flagelado com varas. Uma vez, apedrejado. Três
            vezes naufraguei, uma noite e um dia passei no alto-mar. Viagens sem
            conta, exposto a perigos nos rios, perigos de assaltantes, perigos
            da parte de concidadãos, perigos da parte dos pagãos, perigos na
            cidade, perigos nos lugares desabitados, perigos no mar, perigos
            entre falsos irmãos! Trabalhos e fadigas, muitas noites sem dormir,
            com fome e sede, frequentes jejuns, frio e nudez! Além de outras
            coisas, o que pesa sobre mim diariamente, a preocupação por todas as
            igrejas! Quem está fraco, sem que eu sinta com ele? Quem é seduzido
            ao pecado, sem que eu fique indignado? Se é preciso contar
            vantagens, contarei vantagens da minha fraqueza. O Deus e Pai de
            nosso Senhor Jesus Cristo, que é bendito pelos séculos, sabe que não
            minto. Em Damasco, o governador do rei Aretas pôs guarda na cidade
            dos damascenos, para me prender, mas através de uma janela, fui
            descido numa cesta pelo muro, e escapei das suas mãos. II Cor 11,
            16-3
          </Text>
          ...
          <Text className="text-base">
            ...
            teu Deus, para que saibamos que Deus, sendo o nosso Criador e
            Senhor, pode mandar o que quiser, e nós, criaturas suas, somos
            obrigados a obedecer-Lhe.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">353 - Que é o culto interno?</Text>
          <Text className="text-base">
            O culto interno é a honra que se presta a Deus só com as faculdades
            da alma isto é, com a inteligência e com a vontade.
          </Text>
          <Text className="h5">354 - Que é o culto externo?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            juntamente, porque Ele é Criador e Senhor absoluto de uma e de
            outro.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            estátua, a uma imagem, a um homem, o culto supremo de adoração,
            devido só a Deus.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            adorarás tais coisas, nem lhes darás culto.
          </Text>
          <Text className="h5">
            360 - Proíbem estas palavras toda a espécie de imagens?
          </Text>
          <Text className="text-base">
            Não, por certo. Mas só as das falsas divindades, feitas com intuito
            de adoração, como faziam os idólatras. E tanto isto é verdade, que o
            próprio Deus deu ordem a Moisés para fazer algumas, como as duas
            estátuas de querubins que estavam sobre a arca, e a serpente de
            bronze no deserto.
          </Text>
          <Text className="h5">361 - Que é a superstição?</Text>
          <Text className="text-base">
            Chama-se superstição toda e qualquer devoção contrária à doutrina e
            ao uso da Igreja, bem como o atribuir a urna ação ou alguma coisa
            uma virtude sobrenatural que ela não tem.
          </Text>
          <Text className="h5">362 - Que é o sacrilégio?</Text>
          <Text className="text-base">
            O sacrilégio é a profanação de um lugar, de uma pessoa ou de uma
            coisa consagrada a Deus ou destinada ao seu culto.
          </Text>
          <Text className="h5">363 - Que é a heresia?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            Quem recorresse ao demônio e o invocasse, cometeria um pecado
            enorme, porque o demônio é o mais perverso inimigo de Deus e do
            homem.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Sim, também as relíquias dos Santos podem e devem honrar-se porque
            os seus corpos foram membros vivos de Jesus Cristo e templos do
            Espírito Santo, e devem ressurgir gloriosos para a vida eterna.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            para enganar o Espírito Santo, retendo uma parte do preço do
            terreno? Por acaso não podias conservá-lo, sem o vender? E depois de
            vendido, não podias dispor livremente da quantia? Então, por que
            resolveste fazer isso? Não foi aos homens que mentiste, mas a Deus.
            Ao ouvir estas palavras, Ananias caiu morto. Grande medo tomou conta
            de todos os que souberam disso. Alguns jovens se levantaram,
            ...
            e morreu. Quando os jovens entraram, encontraram a mulher morta e a
            levaram para sepultar ao lado do marido. Grande medo se apoderou de
            toda a Igreja e de todos que ouviram tais coisas. Atos 5, 1-1
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">374 - Que é a blasfêmia?</Text>
          <Text className="text-base">
            A blasfêmia é um pecado horrível que consiste em palavras ou atos de
            desprezo ou maldição contra Deus, contra a Virgem, contra os Santos,
            ou contra as coisas santas.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Quando se afirma com juramento o que se sabe ou se julga ser falso,
            e quando com juramento se promete o que não se tem a intenção de
            cumprir.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Quando se jura sem prudência e sem madura ponderação, ou por coisas
          ...
          <Text className="text-base">
            Podia-se pedir a comutação ou a dispensa ao Bispo próprio, ou ao
            Sumo Pontífice, conforme a qualidade do voto.
          </Text>
          <Text className="h5">386 - É pecado transgredir os votos?</Text>
          <Text className="text-base">
            O transgredir os votos é pecado, e por isso não devemos fazer votos
            sem madura reflexão, e ordinariamente sem o conselho do confessor,
            ou de outra pessoa prudente, para não nos expormos ao perigo de
            pecar.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            ao túmulo trazer os perfumes que tinham preparado. Encontraram a
            pedra do túmulo removida e, entrando, não acharam o corpo do Senhor
            Jesus. Ficaram sem saber o que fazer. Nisso, dois homens vestidos de
            roupas brilhantes apareceram diante delas. Como ficassem
            ...
            viajar no dia seguinte, conversava com os discípulos e prolongou a
            conversa até meia-noite. Havia muitas lâmpadas na sala onde
            estávamos reunidos. Um jovem, chamado Êutico, que estava sentado no
            parapeito de uma janela, adormeceu profundamente enquanto Paulo
            continuava a falar. Vencido pelo sono, caiu do terceiro andar, e o
          ...
          <Text className="text-base">
            ...
            para o povo judeu; na Lei Nova, são os domingos e outras
            festividades estabelecidas pela Igreja.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            O terceiro Mandamento proíbe-nos os trabalhos servis, e qualquer
            obra que nos impeça o culto de Deus.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            chamados manuais, isto é, aqueles trabalhos materiais em que tem
            parte mais o corpo do que o espírito, como os que ordinariamente são
          ...
          <Text className="text-base">
            Trabalhando em dia santo, comete-se pecado mortal; não obstante não
            há culpa grave se o trabalho dura pouco tempo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Nos dias santos são permitidos aqueles trabalhos que são necessários
            à vida, ou ao serviço de Deus, e os que se fazem por uma causa
            grave, pedindo licença, se for possível, ao próprio pároco.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            vivas longos anos e sejas feliz na terra que o Senhor teu Deus te
            dá. Deut 5, 16 Meu filho, escuta a advertência de teu pai, e não
            rejeites o ensino de tua mãe, pois serão diadema para tua cabeça e
            um colar para teu pescoço. Prov 1, 8-9 Pois o Senhor glorifica o pai
            em seus filhos e consolida a autoridade da mãe sobre a prole. Quem
            honra o pai, expia os pecados; quem glorifica a mãe, é como se
            acumulasse tesouros. Quem honra o pai será alegrado pelos filhos e,
            no dia em que orar, será atendido. Quem glorifica o pai terá vida
            longa, e quem obedece ao Senhor proporcionará repouso à sua mãe.
            Quem teme o Senhor honrará seu pai e, como a senhores, servirá seus
            genitores. Com obras e palavras honra teu pai, para que venha sobre
            ti a sua bênção. A bênção do pai consolida a casa dos filhos; a
            maldição da mãe lhes destrói os alicerces. Não te glories da desonra
            de teu pai, pois a desonra do pai não é uma glória para ti. A glória
            do homem vem da honra de seu pai, e é uma desonra para os filhos a
            mãe desprezada. Filho, ampara teu pai na velhice, e não lhe causes
            desgosto enquanto vive. Ainda que perca a razão, sê tolerante e não
            o desprezes, tu, que estás em teu pleno vigor. Não será esquecida a
            ...
            pecados desaparecerão, como o gelo ao calor do dia. Quem abandona o
            pai é como blasfemador; e é maldito do Senhor quem irrita sua mãe.
            Eclo 3, 2-13. Quem amaldiçoa o pai e a mãe verá sua lâmpada
            apagar-se nas trevas. Prov 20, 20 Maldito, quem desprezar o pai ou a
            mãe! E todo o povo dirá: Amén! Deut 27, 16 Quando o viram, ficaram
            admirados e sua mãe lhe disse: Filho, por que agiste assim conosco?
            Olha, teu pai e eu, aflitos, te procurávamos. Ele respondeu-lhes :
          ...
          <Text className="text-base">
            O quarto Mandamento: honrar pai e mãe, ordena-nos respeitar o pai e
            a mãe, obedecer-lhes em tudo o que não é pecado, e auxiliá-los em
            suas necessidades espirituais e temporais.
          </Text>
          <Text className="h5">400 - Que nos proíbe o quarto Mandamento?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            todos os legítimos superiores tanto eclesiásticos como seculares,
            aos quais portanto devemos obedecer e respeitar.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            têm os filhos de obedecer, vêm-lhes de Deus que constituiu e ordenou
            a família, a fim de que nela o homem encontre os primeiros meios
          ...
          <Text className="text-base">
            Os pais têm o dever de amar, cuidar e alimentar seus filhos, de
            prover à sua educação religiosa e civil, de dar-lhes o bom exemplo,
            de afastá-los das ocasiões de pecado, de corrigi-los nas suas
            faltas, e de auxiliá-los a abraçar o estado para o qual são chamados
            por Deus.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            matou. O Senhor perguntou a Caim: Onde está teu irmão Abel? E ele
            respondeu: Não sei. Acaso sou o guarda de meu irmão? O que fizeste?
            perguntou ele Ouço da terra a voz do sangue de teu irmão, clamando
          ...
          <Text className="text-base">
            ...
            bater ou feri-lo, ou causar qualquer outro dano no seu corpo, por
            nós ou por meio de outrem. Proíbe também ofendê-lo com palavras
            injuriosas e querer-lhe o mal. Neste Mandamento Deus proíbe ainda ao
          ...
          <Text className="h5">415 - Que é o escândalo?</Text>
          <Text className="text-base">
            O escândalo é toda palavra, ação ou omissão, que é ocasião para os
            outros de cometerem pecados.
          </Text>
          <Text className="h5">416 - É pecado grave o escândalo?</Text>
          <Text className="text-base">
            O escândalo é um pecado grave, porque tende a destruir a maior obra
            de Deus, que é a redenção, com a perda das almas: pois que ele dá ao
          ...
          <Text className="text-base">
            ...
            pode reparar a honra com uma ação injusta, irracional e bárbara,
            qual é o duelo.
          </Text>
          <Text className="h5">421 - Que nos ordena o quinto Mandamento?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            reparar o mal que fez, compensando o próximo dos danos que lhe
            causou, retratando os erros que lhe ensinou, e dando-lhe bom
            exemplo.
          </Text>
          <Text className="h4">3º - Do 6º e do 9º</Text>
          <Text className="text-base">
            Mandamentos da Lei de Deus José foi levado para o Egito. Putifar, um
            egípcio, ministro do Faraó e chefe da guarda do palácio, o comprou
            ...
            recusou, dizendo à mulher de seu senhor: Em verdade meu senhor não
            me pede contas do que há na casa, confiando-me todos os bens. Ele
            próprio não é mais importante do que eu nesta casa. Nada se reservou
            senão a ti por seres sua mulher. Como poderia eu fazer tamanha
            maldade pecando contra Deus! E ainda que ela insistisse com José,
            todos os dias, para dormir com ela ou mesmo estar com ela, ele não
            ...
            alta. Quando viu que comecei a gritar por socorro, largou o manto
            junto a mim e fugiu correndo para fora. A mulher ficou com o manto
            de José até o marido voltar para casa. Então falou-lhe nos mesmos
            termos, dizendo: Esse escravo hebreu que nos trouxeste, veio ter
            comigo e quis abusar de mim. Quando me ouviu gritar por socorro,
            largou junto de mim o manto e fugiu para fora. Ao ouvir o marido o
            que dizia a mulher, assim é que me tratou teu escravo, ficou
            furioso. Mandou prender José e o meteu no cárcere, onde se guardavam
            os presos do rei. E José ficou no cárcere. Mas o Senhor estava com
            José e concedeu-lhe seu favor, atraindo-lhe a simpatia do chefe do
            cárcere. Este confiou a seus cuidados todos os que se achavam
            presos. Era ele que organizava tudo que lá se fazia. O chefe da
            prisão não se preocupava com coisa alguma que lhe fora confiada,
            porque o Senhor estava com José e fazia prosperar tudo o que ele
            fazia. Gênesis 39, 1-2
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            ação, palavra ou olhar contrários à santa pureza, e a infidelidade
            no matrimônio.
          </Text>
          <Text className="h5">424 - Que nos proíbe o nono Mandamento?</Text>
          <Text className="text-base">
            O nono Mandamento proíbe expressamente todo o desejo contrário à
            fidelidade que os cônjuges se juraram ao contrair matrimônio; e
            proíbe também todo o pensamento culpável e todo desejo de ação
            proibida pelo sexto Mandamento.
          </Text>
          <Text className="h5">425 - É um grande pecado a impureza?</Text>
          <Text className="text-base">
            É um pecado gravíssimo e abominável diante de Deus e dos homens;
            rebaixa o homem à condição dos irracionais, arrasta-o a muitos
            outros pecados e vícios, e provoca o, mais terríveis castigos de
            Deus nesta vida e na outra.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Os pensamentos que nos vêm ao espírito contra ti pureza, por si
            mesmos não são pecados, mas antes tentações e incentivos ao pecado.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            as coisas alheias, e causar dano ao próximo nos seus bens de
            qualquer outro modo.
          </Text>
          ...
          <Text className="text-base">
            Porque se peca contra a justiça, e se faz injúria ao próximo,
          ...
          <Text className="text-base">
            ...
            contanto, que tirasse só o que lhe é estritamente necessário para
          ...
          <Text className="text-base">
            Comete-se a usura exigindo sem titulo legítimo um juro ilícito por
            uma quantia emprestada, abusando da necessidade ou da ignorância do
            próximo.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">443 - É pecado grave roubar?</Text>
          <Text className="text-base">
            É um pecado grave contra a justiça quando se trata de matéria grave,
            porque é de suma importância que seja respeitado o direito que cada
            um tem sobre os próprios bens, e isto para bem dos indivíduos, das
            famílias e da sociedade.
          </Text>
          <Text className="h5">444 - Quando é grave a matéria do furto?</Text>
          <Text className="text-base">
          ...
          <Text className="h5">445 - Que nos ordena o sétimo Mandamento?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            mas é necessário que faça o que puder para restituir as coisas
            alheias e reparar os danos causados ao próximo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Deve-se empregar grande diligência para achar o dono, e
          ...
          <Text className="text-base">
            ...
            filha de acordo com a Lei de Moisés. Joaquim era muito rico e tinha
            ...
            encontrar a sós. Ora, enquanto os dois estavam à espreita duma
            ocasião favorável, certo dia Susana entrou no parque segundo seu
            ...
            velhos estavam lá escondidos. Apenas as duas mocinhas tinham saído,
            os dois velhos se levantaram e correram para Susana, dizendo: Olha,
            ...
            portas do parque e as abriu. Quando a gente da casa ouviu a gritaria
            no parque, precipitaram-se pela porta dos fundos para ver o que lhe
            estaria sucedendo. Mas quando os velhos apresentaram a sua versão
            dos fatos, os empregados ficaram muito constrangidos, porque jamais
            se tinha ouvido falar de qualquer deslize de Susana. Quando no dia
            seguinte o povo se reuniu em casa do seu marido Joaquim, os dois
            anciãos vieram animados pela intenção criminosa de conseguir sua
            condenação à morte; por isso se dirigiram ao povo reunido: Mandai
            comparecer a Susana filha de Helcias, mulher de Joaquim! Mandaram-na
            portanto chamar. Ela compareceu em companhia dos pais e filhos e de
            todos os parentes. Ora, Susana era mulher de aparência exuberante e
            de extraordinária beleza. Como ela se apresentasse com o rosto
            velado, os dois malvados mandaram tirar-lhe o véu, para se
            ...
            falsas testemunhas. Segundo a Lei de Moisés, aplicaram-lhes a pena
            que maldosamente tinham tramado contra o próximo, e os mandaram
            matar. Desta maneira, naquele dia foi salva uma vida inocente.
            Helcias e sua mulher louvaram a Deus por causa da sua filha e o
            mesmo fizeram Joaquim, esposo de Susana, e todos os seus familiares;
            eles louvaram a Deus, porque nela não foi achada qualquer coisa que
            merecesse reprovação. Dan 13, 1-6
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            O oitavo Mandamento: não levantar falso testemunho, proíbe-nos
            atestar falsidade em juízo; proíbe também a detração ou murmuração,
            a calúnia, a adulação, o juízo e a suspeita temerários, e toda
            espécie de mentiras.
          </Text>
          <Text className="h5">451 - Que é a detração ou murmuração?</Text>
          <Text className="text-base">
            A detração ou murmuração é um pecado que consiste em manifestar, sem
            justo motivo, os pecados ou defeitos alheios.
          </Text>
          <Text className="h5">452 - Que é a calúnia?</Text>
          <Text className="text-base">
            A calúnia é um pecado que consiste em atribuir maliciosamente ao
            próximo culpas e defeitos que não tem.
          </Text>
          <Text className="h5">453 - Que é a adulação?</Text>
          <Text className="text-base">
            A adulação é um pecado que consiste em enganar urna pessoa,
            dizendo-lhe falsamente bem dela mesma ou de outra, com o fim de
            tirar daí algum proveito.
          </Text>
          ...
          <Text className="h5">455 - Que é a mentira?</Text>
          <Text className="text-base">
            A mentira é um pecado que consiste em afirmar como verdadeiro ou
            como falso, por meio de palavras ou de ações, o que se julga não ser
            assim.
          </Text>
          <Text className="h5">456 - De quantas espécies é a mentira?</Text>
          <Text className="text-base">
            A mentira é de três espécies: jocosa, oficiosa e nociva.
          </Text>
          <Text className="h5">457 - Que é a mentira jocosa?</Text>
          <Text className="text-base">
            Mentira jocosa é aquela pela qual se mente por gracejo e sem
          ...
          <Text className="text-base">
            Mentira nociva é a afirmação de uma falsidade com prejuízo do
            próximo.
          </Text>
          ...
          <Text className="h5">461 - Que pecado é a mentira?</Text>
          <Text className="text-base">
          ...
          <Text className="h5">464 - Que nos ordena o oitavo Mandamento?</Text>
          <Text className="text-base">
            O oitavo Mandamento ordena-nos que digamos oportunamente a verdade,
            e que interpretemos em bom sentido, tanto quanto pudermos, as ações
            do nosso próximo.
          </Text>
          ...
          <Text className="text-base">
            O décimo Mandamento: não cobiçar as coisas alheias, proíbe o desejo
            de privar o próximo dos seus bens, e o desejo de adquirir bens por
            meios injustos.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">467 - Que nos ordena o décimo Mandamento?</Text>
          <Text className="text-base">
            O décimo Mandamento ordena-nos que nos contentemos com o estado em
            que Deus nos colocou, e que soframos com paciência a pobreza, quando
          ...
          <Text className="text-base">
            ...
            pessoas a fim de que toda a questão se resolva pela decisão de duas
            ou três testemunhas. Se não as ouvir, vai dizê-lo à igreja. E, se
          ...
          <Text className="text-base">
            ...
            Jesus Cristo no-lo ordena, e porque os preceitos da Igreja facilitam
          ...
          <Text className="text-base">
            A obrigação de observar os preceitos da Igreja começa geralmente com
            o uso da razão.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            De um preceito da Igreja só pode dispensar o Papa ou quem dele
            receber as competentes faculdades.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Domingo quer dizer dia do Senhor, isto é, dia especialmente
          ...
          <Text className="text-base">
            ...
            porque é ele o principal dia de festa entre os cristãos, como entre
            os judeus o principal dia de festa era o sábado, por instituição do
            próprio Deus.
          </Text>
          <Text className="h5">48O Que outras festas instituiu a Igreja?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            Sacramento para nossa santificação.
          </Text>
          ...
          <Text className="text-base">
            Com as palavras do terceiro preceito: comungar ao menos pela Páscoa
            da Ressurreição, a Igreja obriga todos os cristãos que chegarem à
            idade da discrição a receber todos os anos a Santíssima Eucaristia,
            durante o tempo pascal; e é bom que seja na própria paróquia.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            No Brasil, o tempo útil para satisfazer o preceito da Comunhão
            Pascal vai do dia 2 de fevereiro, festa da Purificação de Nossa
            Senhora e da Apresentação do Menino Jesus no Templo, até o dia 16 de
            julho, comemoração de Nossa Senhora do Carmo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            O quarto preceito da Igreja: jejuar e abster-se de carne quando
            manda a Santa Madre Igreja, manda-nos que jejuemos e nos abstenhamos
            de carne na Quarta-Feira de Cinzas e na Sexta-Feira Santa; e que nos
          ...
          <Text className="h5">494 - Em que consiste o jejum?</Text>
          <Text className="text-base">
            O jejum consiste em tomar uma só refeição, durante o dia, e em não
            comer coisas proibidas.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">496 - Para que serve o jejum?</Text>
          <Text className="text-base">
            O jejum serve para nos dispor melhor para a oração, para fazer
            penitência dos pecados cometidos, e para nos preservar de cometer
            outros novos.
          </Text>
          ...
          <Text className="text-base">
            ...
            escusados por legitimo impedimento. A abstinência começa a obrigar
            aos catorze anos.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Os que não estão obrigados a jejuar, nem por isso estão dispensados
            de toda a mortificação, porque todos temos obrigação de fazer
            penitência.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            rigoroso jejum de quarenta dias que Jesus Cristo observou no
            deserto, e a fim de nos prepararmos, por meio da penitência, para
            celebrar santamente a festa da Páscoa.
          </Text>
          <Text className="h5">500 - Qual o fim do jejum do Advento?</Text>
          <Text className="text-base">
            O jejum do Advento foi instituído para nos dispor a celebrar
            santamente a festa do Nata
          </Text>
          <Text className="h5">
            501 - Para que foi instituído o jejum das Quatro Têmporas?
          </Text>
          <Text className="text-base">
            O jejum das Quatro Têmporas foi instituído para consagrar cada uma
            das quatro estações do ano com a penitência de alguns dias; para
            pedir a Deus a conservação dos frutos da terra; para Lhe dar graças
            pelos frutos já concedidos, e para Lhe pedir que dê à sua Igreja
            santos ministros, que são ordenados nos sábados das Quatro Têmporas.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            outras pequenas, uma pela manhã e outra à tarde, que evite grave
            dano, como, por exemplo, uma forte dor de cabeça. Nos dias de
            abstinência, proíbe o uso da carne e do caldo de carne.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Observa-se o quinto preceito: pagar dízimos segundo o costume,
            pagando aquelas ofertas ou contribuições, que foram estabelecidas,
            para reconhecer o supremo domínio que Deus tem sobre todas as
            coisas, e para sustentar os ministros do altar.
          </Text>
          <Text className="h2">
            V -{" "}
            <Text className="em">
          ...
          <Text className="text-base">
            ...
            particulares que cada um tem por causa do seu estado, da sua
            condição e da situação em que se acha.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            visto como essas pessoas se obrigaram por esta forma à observância
            de todos ou de alguns conselhos evangélicos.
          </Text>
          ...
          <Text className="text-base">
            ...
            porque nos ajudam a desapegar o coração do amor dos bens terrenos,
            dos prazeres e das honras, e assim nos afastam do pecado.
          </Text>
          ...
          <Text className="text-base">
            ...
            todos os Sacramentos significam, por meio de coisas sensíveis, a
            graça divina que eles produzem na nossa alma.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Para fazer um Sacramento requerem-se a matéria, a forma, e o
            ministro, que tenha intenção de fazer o que faz a Igreja.
          </Text>
          ...
          <Text className="h5">522 - Que é a forma dos Sacramentos?</Text>
          <Text className="text-base">
            A forma dos Sacramentos são as palavras que se proferem para os
            fazer.
          </Text>
          <Text className="h5">523 - Quem é o ministro dos Sacramentos?</Text>
          <Text className="text-base">
            O ministro dos Sacramentos é a pessoa que faz ou confere os
            Sacramentos.
          </Text>
          <Text className="h4">
            2º - Do efeito principal dos Sacramentos, que é a graça
          </Text>
          <Text className="h5">524 - Que é a graça?</Text>
          <Text className="text-base">
          ...
          <Text className="h5">526 - Que é a graça santificante?</Text>
          <Text className="text-base">
            A graça santificante é um dom sobrenatural, inerente à nossa alma,
            que nos faz justos, filhos adotivos de Deus e herdeiros do Paraíso.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">530 - Que é a graça atual?</Text>
          <Text className="text-base">
            A graça atual é um dom sobrenatural que ilumina nossa inteligência,
            move e fortalece a nossa vontade, a fim de que pratiquemos o bem e
            evitemos o mal.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Os Sacramentos que conferem a primeira graça santificante, que nos
            faz amigos de Deus, são dois: Batismo e Penitência.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            cinco, isto é, a Confirmação, a Eucaristia, a Extrema-Unção, a Ordem
            e o Matrimônio, os quais conferem a graça segunda.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            Extrema-Unção, a Ordem e o Matrimônio, chamam-se Sacramentos de
            vivos, porque aqueles que os recebem, devem estar isentos de pecado
            mortal, quer dizer, já vivos pela graça santificante.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Quem recebe um Sacramento de vivos, sabendo que não está em estado
            de graça, comete um grave sacrilégio.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            O caráter que estes três Sacramentos imprimem na alma, serve para
            nos distinguir, no Batismo como membros de Jesus Cristo, na
            Confirmação como seus soldados, na Ordem como seus ministros.
          </Text>
          <Text className="h2">
            II - <Text className="em">Do Batismo</Text>
          </Text>
          <Text className="h4">1º - Natureza e efeitos do Batismo</Text>
          <Text className="h5">549 - Que é o Sacramento do Batismo?</Text>
          <Text className="text-base">
            O Batismo é o Sacramento pelo qual renascemos para a graça de Deus,
            e nos tornamos cristãos.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            apaga o pecado original e também o atual, se o há; perdoa toda a
            pena por eles devida; imprime o caráter de cristão; faz-nos filhos
            de Deus, membros da Igreja e herdeiros do Paraíso, e torna-nos
            capazes de receber os outros Sacramentos.
          </Text>
          <Text className="h5">551 - Qual é a matéria do Batismo?</Text>
          <Text className="text-base">
            A matéria do Batismo é a água natural, que se derrama sobre a cabeça
            do que é baptizado, de maneira que escorra.
          </Text>
          <Text className="h5">552 - Qual é a forma do Batismo?</Text>
          <Text className="text-base">
            A forma do Batismo é esta: Eu te baptizo em nome do Padre e do Filho
            e do Espírito Santo.
          </Text>
          ...
          <Text className="text-base">
            ...
            estiverem muitas pessoas presentes, deverá baptizá-lo o Sacerdote,
            se lá estiver; na sua falta, um eclesiástico de ordem inferior, e na
          ...
          <Text className="text-base">
            Quem baptiza deve ter a intenção de fazer o que faz a Santa Igreja
            ao baptizar.
          </Text>
          <Text className="h4">
          ...
          <Text className="text-base">
            Se alguém derramasse a água, e outro proferisse as palavras, a
            pessoa não ficaria baptizada; é necessário que seja a mesma pessoa
            que derrame a água e pronuncie as palavras.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            condição, dizendo: Se estás vivo, eu te baptizo em nome do Padre e
          ...
          <Text className="text-base">
            ...
            elas pela sua tenra idade estão expostas a muitos perigos de morrer,
            e não podem salvar-se sem o Batismo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            filhos sem Batismo, pecam gravemente, porque os privam da vida
            eterna; e pecam também gravemente, demorando muito tempo o Batismo,
            porque os expõem ao perigo de morrer sem o terem recebido.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Se um adulto se baptizasse em pecado mortal, sem esta dor, receberia
            o caráter do Batismo, mas não a remissão dos pecados, nem a graça
          ...
          <Text className="text-base">
            O Batismo é absolutamente necessário para a salvação, porque o
            Senhor disse expressamente: Quem não renascer na água e no Espírito
          ...
          <Text className="text-base">
            ...
            sangue, ou um ato de amor perfeito de Deus, ou de contrição, junto
            com o desejo, ao menos implícito, do Batismo, e este ato chama-se
            Batismo de desejo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Ao receber o santo Batismo renuncia-se para sempre ao demônio, às
            suas obras e às suas pompas.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            do mundo, contrárias às máximas do Santo Evangelho.
          </Text>
          ...
          <Text className="text-base">
            Os padrinhos e as madrinhas são obrigados a cuidar que os seus
            filhos espirituais sejam instruídos nas verdades da fé, e vivam como
            bons cristãos, edificando-os com o bom exemplo.
          </Text>
          <Text className="h5">
            574 - Que vínculo contraem os padrinhos do Batismo?
          </Text>
          <Text className="text-base">
            Os padrinhos contraem um parentesco espiritual com o baptizado, e
            este parentesco origina impedimento de matrimônio com o mesmo.
          </Text>
          <Text className="h2">
            III - <Text className="em">Da Confirmação ou Crisma</Text>
          </Text>
          <Text className="h5">575 - Que é o Sacramento da Confirmação?</Text>
          <Text className="text-base">
            A Confirmação, ou Crisma, é um Sacramento que nos dá o Espírito
            Santo, imprime na nossa alma o caráter de soldados de Cristo, e nos
            faz perfeitos cristãos.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">578 - Qual é a matéria deste Sacramento?</Text>
          <Text className="text-base">
          ...
          <Text className="h5">579 - Que é o santo Crisma?</Text>
          <Text className="text-base">
            O santo Crisma é óleo de oliveira misturado com bálsamo, e
            consagrado pelo Bispo na Quinta-Feira Santa.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            abundância da graça que se difunde na alma do cristão para o
            confirmar na fé; e o bálsamo, que é aromático e preserva da
            corrupção, significa que o cristão fortificado por esta graça é
            capaz de difundir o bom aroma das virtudes cristãs, e de
            preservar-se da corrupção dos vícios.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            sinal da Cruz, e te confirmo com o Crisma da salvação, em nome do
            Pai e do Filho e do Espírito Santo. Assim seja.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            vergonha, a fim de que o crismado entenda que não deve
            envergonhar-se do nome e da profissão de cristão, nem ter medo dos
            inimigos da fé.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Sim, todos devem procurar receber o Sacramento da Confirmação e
            fazer que os seus subordinados o recebam.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Para receber dignamente o Sacramento da Confirmação é necessário
            estar em estado de graça, saber os mistérios principais da nossa
            santa Fé, e aproximar-se deste Sacramento com reverência e devoção.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            instruído nas coisas mais necessárias da religião e de bons
            costumes; e deve ser do mesmo sexo que o crismado.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">594 - Que é o Sacramento da Eucaristia?</Text>
          <Text className="text-base">
            A Eucaristia é um Sacramento que, pela admirável conversão de toda a
            substância do pão no Corpo de Jesus Cristo, e de toda a substância
            do vinho no seu precioso Sangue, contém verdadeira, real e
            substancialmente o Corpo, Sangue, Alma e Divindade do mesmo Jesus
            Cristo Nosso Senhor, debaixo das espécies de pão e de vinho, para
            ser nosso alimento, espiritual.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Sim, na Eucaristia está verdadeiramente o mesmo Jesus Cristo que
            está no Céu e que nasceu, na terra, da Santíssima Virgem Maria.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            presente Jesus Cristo, porque Ele mesmo o disse, e assim no-lo
          ...
          <Text className="text-base">
            A matéria do Sacramento da Eucaristia é a que foi empregada por
            Jesus Cristo. a saber: o pão de trigo e o vinho de uva.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            No cálice, antes da consagração, está vinho com algumas gotas de
            água.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">604 - Que é a consagração?</Text>
          <Text className="text-base">
            A consagração é a renovação, por meio do sacerdote, do milagre
            operado por Jesus Cristo na última Ceia, quando mudou o pão e o
            vinho no seu Corpo e no seu Sangue adorável, por estas palavras:
          ...
          <Text className="text-base">
            Foi o mesmo Jesus Cristo Nosso Senhor, Deus onipotente, que deu
            tanta virtude às palavras da consagração.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Tanto na hóstia como no cálice está Jesus Cristo todo inteiro,
            porque Ele está na Eucaristia vivo e imortal como no céu; por isso
            onde está o seu Corpo, está também o seu Sangue, sua Alma e sua
            Divindade; e onde está seu Sangue está também seu Corpo, sua Alma e
            sua Divindade, pois tudo isto é inseparável em Jesus Cristo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            O Corpo de Jesus Cristo fica inteiro em todas e em cada uma das
            partes em que a hóstia foi dividida.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Tanto numa hóstia grande, como na partícula de uma hóstia, está
          ...
          <Text className="text-base">
            Conserva-se nas igrejas a Santíssima Eucaristia, a fim de ser
            adorada pelos fiéis, e levada aos enfermos, quando for necessário.
          </Text>
          <Text className="h5">619 - Deve-se adorar a Eucaristia?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            O Sacramento da Eucaristia produz em nós os seus maravilhosos
            efeitos, quando o recebemos com as devidas disposições.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Estar em estado de graça quer dizer: ter a consciência limpa de todo
            o pecado mortal.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            antes de comungar; porque para quem está em pecado mortal, não basta
            o ato de contrição perfeita, sem a confissão, para fazer uma
            comunhão bem feita,
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Quem comungasse em pecado mortal, receberia a Jesus Cristo, mas não
            a sua graça; pelo contrário, cometeria sacrilégio e incorreria na
          ...
          <Text className="text-base">
            Quem engoliu restos de comida presos aos dentes, pode comungar,
            porque já não são tomados como alimentos ou perderam tal condição.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            respeito a este Sacramento a Doutrina Cristã e acreditá-lo
            firmemente.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Comungar com devoção quer dizer: aproximar-se da sagrada Comunhão
            com humildade e modéstia, tanto na própria pessoa como no vestir, e
            fazer a preparação antes e a ação de graças depois da Comunhão.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            cabeça medianamente levantada, com os olhos modestos e voltados para
            a sagrada Hóstia, com a boca suficientemente aberta e com a língua
            um pouco estendida sobre o lábio inferior. Senhoras e meninas devem
          ...
          <Text className="text-base">
            Devemos procurar engolir a sagrada Hóstia o mais depressa possível,
            e convém abster-nos de cuspir algum tempo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Se a sagrada Hóstia se pegar ao céu da boca, é preciso despegá-la
            com a língua, nunca porém com os dedos.
          </Text>
          ...
          <Text className="text-base">
            Aqueles que, tendo a idade capaz para serem admitidos à Comunhão,
            não comungam, ou porque não querem, ou porque não estão instruídos
            por sua culpa, pecam sem dúvida. Pecam outrossim os seus pais, ou
            quem lhes faz as vezes, se o adiamento da Comunhão se dá por sua
          ...
          <Text className="h5">652 - Que é então a santa Missa?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            O Sacrifício da Missa é substancialmente o mesmo que o da Cruz,
            porque o mesmo Jesus Cristo, que se ofereceu sobre a Cruz, é que se
            oferece pelas mãos dos sacerdotes seus ministros, sobre os nossos
            altares, mas quanto ao modo por que é oferecido, o sacrifício da
            Missa difere do sacrifício da Cruz, conservando todavia a relação
            mais íntima e essencial com ele.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Entre o Sacrifício da Missa e o sacrifício da Cruz há esta diferença
            e esta relação: que Jesus Cristo sobre se ofereceu derramando o seu
          ...
          <Text className="text-base">
            Outra relação do Sacrifício da Missa com o da Cruz é que o
            ...
            consagração só o Corpo de nosso Salvador se torna presente debaixo
            das espécies de pão, e debaixo das espécies de vinho, só o seu
            Sangue; entretanto, pela concomitância natural e pela união
            hipostática, está presente, debaixo de cada uma das espécies, Jesus
          ...
          <Text className="text-base">
            ...
            Cristo, e o sacerdote é o ministro que em nome de Jesus Cristo
            oferece este sacrifício ao Eterno Padre.
          </Text>
          <Text className="h5">
            659 - Quem instituiu o Santo Sacrifício da Missa?
          </Text>
          <Text className="text-base">
            Foi o próprio Jesus Cristo que instituiu o Santo Sacrifício da
            Missa, quando instituiu o Sacramento da Eucaristia, e disse que
            fosse ele feito em memória da sua Paixão.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            A missa celebrada em honra da Santíssima Virgem e dos Santos é
            sempre um sacrifício oferecido só a Deus; diz-se, porém, celebrada
            em honra da Santíssima Virgem e dos Santos, para louvar a Deus neles
            pelos dons que lhes concedeu, e para alcançar, pela intercessão
          ...
          <Text className="text-base">
            Para ouvir bem e com fruto a santa Missa são necessárias duas
            coisas:
          </Text>
          <View className="list-styled">
          ...
          <Text className="text-base">
            O melhor modo de praticar a devoção interior ao ouvir a santa Missa
            é o seguinte:
          </Text>
          <View className="list-styled">
            <Text className="li text-justify">
          ...
          <Text className="h5">666 - Que é a Comunhão espiritual?</Text>
          <Text className="text-base">
            A Comunhão espiritual é um grande desejo de se unir sacramentalmente
            a Jesus Cristo, dizendo por exemplo: Meu Senhor Jesus Cristo, eu
            desejo de todo o meu coração unir-me a Vós agora e por toda a
            eternidade ; e fazendo os mesmos atos que se fazem antes e depois da
          ...
          <Text className="text-base">
            ...
            Missa; e até o tempo da santa Missa é o mais oportuno para rezar
          ...
          <Text className="h5">670 - Que é o Sacramento da Penitência?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            porque quem cometeu uma falta deve sujeitar-se à pena que o
            Sacerdote impõe.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            próxima. A remota é constituída pelos pecados cometidos pelo
            penitente depois do Batismo, e a matéria próxima são os atos do
            próprio penitente, isto é, a contrição, a acusação e a satisfação.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            poder da Ordem, mas é necessário também o poder de jurisdição, isto
            é, a faculdade de julgar, que deve ser dada pelo Bispo.
          </Text>
          <Text className="h5">
            679 - Quantas são as partes do Sacramento da Penitência?
          </Text>
          <Text className="text-base">
            As partes do Sacramento da Penitência são: a contrição, a confissão
            e a satisfação da parte do pecador, a absolvição da parte do
            sacerdote.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            A palavra contrição quer dizer fratura ou despedaçamento, como
            quando uma pedra é esmagada e reduzida a pó.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">685 - Que é a satisfação ou penitência?</Text>
          <Text className="text-base">
            A satisfação ou penitência é a oração ou outra boa obra, que o
            confessor impõe ao pecador em expiação dos seus pecados.
          </Text>
          <Text className="h5">686 - Que é a absolvição?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            contrição, porque sem ela nunca se pode obter o perdão dos pecados,
            e com ela só, quando é perfeita, pode obter-se o perdão, contanto
            que esteja unida com o desejo, ao menos implícito, de confessar-se.
          </Text>
          <Text className="h4">
          ...
          <Text className="text-base">
            ...
            temporal, da qual também é perdoada uma parte maior ou menor,
            conforme as disposições do penitente; faz reviver o mereci. mento
            das boas obras feitas antes de se cometer o pecado mortal; dá à alma
            auxílios oportunos para não recair no pecado e restitui a paz à
            consciência.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            pecados, por muitos e grandes que sejam, contanto que se receba com
          ...
          <Text className="text-base">
            ...
            coração ao Senhor que nos dê luz para conhecer todos os nossos
            pecados e força para os detestar.
          </Text>
          <Text className="h4">3º - Do exame de consciência</Text>
          <Text className="h5">694 - Que é o exame de consciência?</Text>
          <Text className="text-base">
            O exame de consciência é uma diligente investigação dos pecados que
            se cometeram, desde a última confissão bem feita.
          </Text>
          ...
          <Text className="text-base">
            Devemos examinar-nos também sobre os maus hábitos e sobre as
            ocasiões de pecado.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Há matéria grave, quando se trata de uma coisa notavelmente
          ...
          <Text className="text-base">
            Há plena advertência no pecado, quando se conhece perfeitamente que
            se faz um mal grave.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Deve empregar-se no exame de consciência mais ou menos tempo,
            conforme a necessidade, isto é, conforme o número e a qualidade dos
            pecados que sobrecarregam a consciência, e conforme o tempo
            decorrido desde a última confissão bem feita.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">706 - De quantas espécies é a dor?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            A dor perfeita não nos alcança o perdão dos pecados
            independentemente da confissão, porque sempre inclui a vontade de se
            confessar.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">714 - Por que a dor deve ser interna?</Text>
          <Text className="text-base">
            A dor deve ser interna, porque a vontade, que se afastou de Deus com
            o pecado, deve voltar para Deus, detestando o pecado cometido.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            dirige, isto é, o perdão de Deus, a aquisição da graça santificante
            e o direito à glória eterna.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            sobrenatural, porque estes são os motivos fornecidos pela fé. Quem,
            ao contrário, se arrependesse só pela desonra ou castigo que lhe vem
            dos homens, ou por algum prejuízo puramente temporal, teria dor
            natural, porque se arrependeria só por motivos humanos.
          </Text>
          <Text className="h5">718 - Por que a dor deve ser suma?</Text>
          <Text className="text-base">
            A dor deve ser suma, porque devemos considerar e odiar o pecado como
            o maior de todos os males, visto ser ofensa de Deus, sumo Bem.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Quem se confessa só de pecados veniais, para se confessar
            validamente, basta que se arrependa de algum deles; mas, para
            alcançar o perdão de todos, é necessário que se arrependa de todos
            os que reconhece ter cometido.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Para tornar mais segura a confissão só de pecados veniais, é
            prudente acusar, com verdadeira dor, também algum pecado mais grave
          ...
          <Text className="text-base">
            ...
            Deus a graça de fazer semelhante ato na ocasião de maior
            necessidade, isto é, em perigo de morte.
          </Text>
          <Text className="h4">5º - Do propósito</Text>
          <Text className="h5">729 - Em que consiste o propósito?</Text>
          <Text className="text-base">
            O propósito consiste em uma vontade determinada de nunca mais
            cometer o pecado, e de empregar todos os meios necessários para o
            evitar.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Para ser um bom propósito, esta resolução deve ter principalmente
            três condições: deve ser absoluta, universal e eficaz.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            circunstâncias de tempo, de lugar, de pessoas ou de coisas, que,
            pela sua própria natureza, ou pela nossa fragilidade, nos induzem a
            cometer o pecado.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            A acusação deve ser humilde, quer dizer que o penitente deve
            acusar-se diante do seu confessor sem altivez de ânimo ou de
            palavras, mas com sentimentos de um réu que reconhece a sua culpa, e
            comparece diante do juiz.
          </Text>
          <Text className="h5">
            744 - Que quer dizer: a acusação deve ser íntegra?
          </Text>
          <Text className="text-base">
            A acusação deve ser íntegra, quer dizer que se devem confessar, com
            as suas circunstâncias e no seu número, todos os pecados mortais
          ...
          <Text className="text-base">
            Quem, para se desculpar, dissesse uma mentira da qual resultasse
            dano grave para o próximo, deveria manifestar esta circunstância,
          ...
          <Text className="text-base">
            Quem não se lembra exatamente do número dos seus pecados, deve
            acusar o número aproximado.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            penoso, é necessário fazê-lo, porque é de preceito divino; e de
            outro modo não se pode obter o perdão dos pecados cometidos; além
            disso, a dificuldade de se confessar é compensada por muitas
            vantagens e grandes consolações.
          </Text>
          <Text className="h4">7º - Do modo de se confessar</Text>
          <Text className="h5">760 - Como vos apresentareis ao confessor?</Text>
          <Text className="text-base">
            Ponho-me de joelhos aos pés do confessor, e digo: Abençoai-me,
            Padre, porque pequei.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Inclino-me humildemente para receber a bênção, e faço o sinal da
            Cruz.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            absolvição, cumpri a penitência, e fui à Comunhão. Em seguida faz-se
            a acusação dos pecados.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            especialmente contra tal ou tal virtude, por exemplo, contra a
            pureza, contra o quarto Mandamento, etc.
          </Text>
          <Text className="h5">
            765 - Depois desta acusação, que direis ainda?
          </Text>
          <Text className="text-base">
            Direi: De todos estes pecados e de todos aqueles de que não me
            lembro, peço perdão a Deus de todo o meu coração; e a vós, Padre,
          ...
          <Text className="h5">774 - Que é a satisfação?</Text>
          <Text className="text-base">
            A satisfação, que também se chama penitência sacramental, é um dos
            atos do penitente, com o qual ele dá uma certa reparação à justiça
            divina pelos pecados cometidos pondo em prática aquelas obras que o
            confessor lhe impõe.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            antes, e deve fazer-se a diligência por cumpri-la em estado de
            graça.
          </Text>
          <Text className="h5">777 - Como se deve cumprir a penitência?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            Nosso Senhor quis perdoar no Sacramento do Batismo toda a pena
            devida aos pecados, e não no Sacramento da Penitência, porque os
            pecados depois do Batismo são muito mais graves, visto serem
            cometidos com maior conhecimento e ingratidão aos benefícios de
            Deus, e também para que a obrigação de satisfazer por eles sirva de
          ...
          <Text className="text-base">
            ...
            pagar a pena devida pelos pecados; por isso deve-se fazer a
            diligência por suprir com outras penitências voluntárias.
          </Text>
          <Text className="h5">782 - Quais são as obras de penitência?</Text>
          <Text className="text-base">
            As obras de penitência podem reduzir-se a três espécies: à oração,
            ao jejum, à esmola.
          </Text>
          ...
          <Text className="text-base">
            Por esmola entende-se toda e qualquer obra de misericórdia
          ...
          <Text className="text-base">
            ...
            dele, e edificando com as palavras e com o bom exemplo aqueles que
            se tenha escandalizado.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">793 - Que é a indulgência?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            O poder de conceder indulgências pertence ao Papa em toda a Igreja,
            e ao Bispo, na sua diocese, na medida em que lhe é concedido pelo
            Papa.
          </Text>
          ...
          <Text className="h5">798 - Que é a indulgência plenária?</Text>
          <Text className="text-base">
            A indulgência plenária é a que perdoa toda a pena temporal devida
            pelos nossos pecados. Por isso, se alguém morresse depois de ter
            recebido esta indulgência, iria logo para o céu, inteiramente isento
            das penas do Purgatório.
          </Text>
          <Text className="h5">799 - Que é a indulgência parcial?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            Devemos ter as indulgências em muito grande apreço, porque com elas
            se satisfaz a justiça de Deus e mais depressa e mais facilmente se
          ...
          <Text className="h5">804 - Que é o Jubileu?</Text>
          <Text className="text-base">
            O Jubileu, que ordinariamente se concede todos os vinte e cinco
            anos, é uma indulgência plenária, à qual estão anexos muitos
            privilégios e concessões particulares, como o poder de obter-se a
            absolvição de alguns pecados reservados e de censuras, e a comutação
            de alguns votos.
          </Text>
          <Text className="h2">
          ...
          <Text className="text-base">
            ...
            <View className="list-styled">
              ...
              <Text className="li text-justify">
                4º - dá força para suportar pacientemente o mal, para resistir
                às tentações, e para morrer santamente;
              </Text>
              <Text className="li text-justify">
            ...
            <Text className="text-base">
              ...
              a Extrema-Unção quando está em plena consciência e com alguma
              esperança de vida? É bom receber a Extrema-Unção quando o enfermo
              está ainda com plena consciência e com alguma esperança de vida,
              porque recebendo-a com melhores disposições poderá obter maior
              proveito; e além disso, como este Sacramento dá a saúde do corpo,
              se convém à alma auxiliando as forças da natureza, não se deve
              estar à espera de que se desespere da cura.
            </Text>
            <Text className="h5">
              809 - Com que disposições se deve receber a Extrema-Unção?
            </Text>
            <Text className="text-base">
              As principais disposições para receber a Extrema-Unção são: estar
              em estado de graça, confiar na eficácia do Sacramento e na
              misericórdia divina e resignar-se à vontade de Deus.
            </Text>
            <Text className="h5">
          ...
          <Text className="h5">811 - Que é o Sacramento da Ordem?</Text>
          <Text className="text-base">
            A Ordem é o Sacramento que dá o poder de exercitar os ministérios
            sagrados que se referem ao culto de Deus e à salvação das almas, e
            que imprime na alma de quem o recebe o caráter de ministro de Deus.
          </Text>
          ...
          <Text className="text-base">
            ...
            Sacerdócio; em seguida o Presbiterado ou Sacerdócio simples; depois
            o Diaconado e as Ordens que se chamam menores.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">815 - Quem é o ministro deste Sacramento?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            A dignidade do Sacerdócio cristão é muito grande, pelo duplo poder
            que lhe conferiu Jesus Cristo sobre o seu Corpo real e sobre o seu
            Corpo místico, que é a Igreja, e pela divina missão, confiada aos
          ...
          <Text className="text-base">
            O Sacerdócio católico é necessário na Igreja, porque sem ele os
            fiéis estariam privados do Santo Sacrifício da Missa e da maior
            ...
            existiria a Igreja como Cristo a instituiu.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            prometeu que as potências do Inferno não prevaleceriam jamais contra
            a sua Igreja.
          </Text>
          ...
          <Text className="text-base">
            Para conhecer se Deus o chama ao estado eclesiástico, o cristão
            deve:
          </Text>
          <View className="list-styled">
            <Text className="li text-justify">
          ...
          <Text className="h5">826 - Que é o Sacramento do Matrimônio?</Text>
          <Text className="text-base">
            O Matrimônio é um Sacramento instituído por Nosso Senhor Jesus
            Cristo, que estabelece uma união santa e indissolúvel entre o homem
            e a mulher, e lhes dá a graça de se amarem um ao outro santamente, e
            de educarem cristãmente seus filhos.
          </Text>
          <Text className="h5">
            827 - Por quem foi instituído o Matrimônio?
          </Text>
          <Text className="text-base">
            O Matrimônio foi instituído pelo próprio Deus no Paraíso terrestre;
            e no Novo Testamento foi elevado por Jesus Cristo à dignidade de
            Sacramento.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Diz-se que o vínculo do Matrimônio é indissolúvel, isto é, que não
            se pode quebrar senão pela morte de um dos cônjuges, porque assim o
            estabeleceu Deus desde o começo, e assim o proclamou solenemente
          ...
          <Text className="text-base">
            ...
            constituir o Sacramento, mas é dada para sancionar em nome da Igreja
            a sua união, e para atrair sempre mais sobre eles as bênçãos de
            Deus.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Os esposos, para receber com fruto o Sacramento do Matrimônio,
            devem:
          </Text>
          <View className="list-styled">
            <Text className="li text-justify">
            ...
            <Text className="li text-justify">
              2º - consultar os próprios pais, antes de chegar ao noivado, como
              o exige a obediência e o respeito devido aos mesmos;
            </Text>
            <Text className="li text-justify">
          ...
          <Text className="text-base">
            ...
            livre de qualquer impedimento matrimonial dirimente, e dar
            livremente o próprio consentimento ao contrato do Matrimônio na
            presença do próprio pároco ou de um Sacerdote devidamente
            autorizado, e de duas testemunhas.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            validade do Matrimônio e de dispensar dos impedimentos que Ela
            própria estabeleceu, porque não se podendo separar no matrimônio
            cristão o contrato do Sacramento, também o contrato cai sob alçada
            da Igreja, porque só a Ela conferiu Jesus Cristo o direito de
            promulgar leis e decisões acerca das coisas sagradas.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Um cristão não pode celebrar somente o contrato civil, porque este
            não é Sacramento, e portanto não é um verdadeiro matrimônio.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">852 - Que é a virtude sobrenatural?</Text>
          <Text className="text-base">
            A virtude sobrenatural é uma qualidade que Deus infunde na alma,
            pela qual se tem propensão, facilidade e prontidão para conhecer e
            praticar o bem, em ordem da vida eterna.
          </Text>
          <Text className="h5">
            853 - Quantas são as principais virtudes sobrenaturais?
          </Text>
          <Text className="text-base">
            As principais virtudes sobrenaturais são sete, a saber, três
          ...
          <Text className="h5">860 - Que é a Fé?</Text>
          <Text className="text-base">
            A Fé e uma virtude sobrenatural, infundida por Deus em nossa alma,
            pela qual nós, apoiados na autoridade do mesmo Deus, acreditamos que
            é verdade tudo o que Ele revelou e por meio da Santa Igreja nos
            propõe para crer.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Sim, temos a certeza absoluta de que são verdadeiras as doutrinas
            que a Santa Igreja nos ensina, porque Jesus Cristo empenhou a sua
            palavra, que a Igreja nunca se enganaria.
          </Text>
          <Text className="h5">863 - Com que pecado se perde a Fé?</Text>
          <Text className="text-base">
            A Fé perde-se negando ou duvidando voluntariamente, ainda que seja
            de um só artigo que nos é proposto para crer.
          </Text>
          <Text className="h5">864 - Como recuperamos a Fé?</Text>
          <Text className="text-base">
            Recuperamos a Fé perdida, arrependendo-nos do pecado cometido e
            crendo de novo tudo o que crê a Santa Igreja.
          </Text>
          ...
          <Text className="text-base">
            O Novo Testamento contém os livros inspirados escritos depois da
            vinda de Jesus Cristo.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">876 - Que quer dizer a palavra Bíblia?</Text>
          <Text className="text-base">
          ...
          <Text className="text-base">
            ...
            inspirada, o Autor de todas as suas partes é o próprio Deus. Isto
            não obsta a que nas cópias as e traduções da mesma se tenha dado
            algum engano ou dos copistas ou dos tradutores. Porém, nas edições
            revistas e aprovadas pela Igreja Católica não pode haver erro no que
            respeita à fé ou à moral.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            reconhecidas como fiéis pela Igreja Católica, e venham acompanhadas
            de explicações ou notas aprovadas pela mesma Igreja.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            O verdadeiro sentido das Sagradas Escrituras podemos conhecê-lo só
            por meio o da Igreja, porque só a Igreja é que não pode errar ao
            interpretá-las.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Um cristão a quem fosse oferecida a Bíblia por um protestante, ou
            por algum emissário dos protestantes, deveria rejeitá-la com horror,
            por ser proibida pela Igreja. E, se a tivesse aceitado sem reparar,
          ...
          <Text className="text-base">
            ...
            explicativas das passagens obscuras, podem causar dano à Fé. Por
            isso a Igreja proíbe também as traduções da Sagrada Escritura já
            aprovadas por Ela, mas reimpressas sem as explicações que a mesma
            Igreja aprovou.
          </Text>
          <Text className="h4">5º - Da Tradição</Text>
          <Text className="h5">885 - Dizei-me: o que é a Tradição?</Text>
          <Text className="text-base">
          ...
          <Text className="h5">888 - Que é a Esperança?</Text>
          <Text className="text-base">
            A Esperança é uma virtude sobrenatural, infundida por Deus na nossa
            alma, pela qual desejamos e esperamos a vida eterna que Deus
            prometeu aos seus servos, e os auxílios necessários para alcançá-la.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Perde-se a Esperança todas as vezes que se perde a Fé; perde-se
            também pelo pecado de desespero ou de presunção.
          </Text>
          ...
          <Text className="text-base">
            A Caridade é uma virtude sobrenatural, infundida por Deus em nossa
            alma, pela qual amamos a Deus por Si mesmo sobre todas as coisas, e
            amamos o próximo como a nós mesmos, por amor de Deus.
          </Text>
          ...
          <Text className="text-base">
            ...
            criaturas mais caras e mais perfeitas, e estar disposto a perder
            tudo antes que ofendê-Lo ou deixar de amá-Lo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Amar a Deus com toda a nossa mente quer dizer: dirigir para Ele
          ...
          <Text className="text-base">
            Sim, somos obrigados a amar também os inimigos, porque também eles
            são nossos próximos, e porque Jesus Cristo o mandou expressamente.
          </Text>
          <Text className="h5">
            903 - Que quer dizer: amar o próximo como a nos mesmos?
          </Text>
          <Text className="text-base">
            Amar o próximo como a nós mesmos quer dizer: desejar-lhe e
            fazer-lhe, tanto quanto pudermos, todo o bem que devemos desejar
            para nós mesmos, e não lhe desejar nem fazer mal algum.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">909 - Que é a Prudência?</Text>
          <Text className="text-base">
            A Prudência é a virtude que dirige toda ação ao devido fim, e por
            isso procura os meios convenientes para que a ação seja em tudo bem
            feita, e portanto aceita ao Senhor.
          </Text>
          <Text className="h5">910 - Que é a Justiça?</Text>
          <Text className="text-base">
            A Justiça é a virtude pela qual damos a cada um o que lhe pertence.
          </Text>
          <Text className="h5">911 - Que é a Fortaleza?</Text>
          <Text className="text-base">
            A Fortaleza é a virtude que nos dá coragem parti não temer perigo
            algum, nem a própria morte, no serviço de Deus.
          </Text>
          <Text className="h5">912 - Que é a Temperança?</Text>
          <Text className="text-base">
            A Temperança é a virtude pela qual refreamos os desejos desordenados
            de prazeres sensuais, e usamos com moderação dos bens temporais.
          </Text>
          <Text className="h2">
          ...
          <Text className="text-base">
            A Sabedoria é um dom pelo qual nós, elevando o espírito acima das
            coisas terrenas e frágeis, contemplamos as eternas, isto é, a
            Verdade, que é Deus, no qual pomos nossa complacência, amando-O como
            nosso Sumo bem.
          </Text>
          <Text className="h5">916 - Que é o Entendimento?</Text>
          <Text className="text-base">
            O Entendimento é um dom pelo qual nos é facilitada, quanto é
            possível a um homem mortal, a inteligência das verdades da Fé e dos
            divinos mistérios, os quais não podemos conhecer com as luzes
            naturais da nossa razão.
          </Text>
          <Text className="h5">917 - Que é o Conselho?</Text>
          <Text className="text-base">
            O Conselho é um dom pelo qual, nas dúvidas e incertezas da vida
            humana, conhecemos o que mais convém à glória de Deus, à nossa
            salvação e à do próximo.
          </Text>
          <Text className="h5">918 - Que é a Fortaleza?</Text>
          <Text className="text-base">
          ...
          <Text className="h5">919 - Que é a Ciência?</Text>
          <Text className="text-base">
            A Ciência é um dom pelo qual julgamos retamente das coisas criadas,
            e conhecemos o modo de bem usar delas e de as dirigir ao último fim,
            que é Deus.
          </Text>
          <Text className="h5">920 - Que é a Piedade?</Text>
          <Text className="text-base">
            Á Piedade é um dom pelo qual veneramos e amamos a Deus e aos Santos,
            e conservamos ânimo bondoso e benévolo para com o próximo, por amor
            de Deus.
          </Text>
          <Text className="h5">921 - Que é o Temor de Deus?</Text>
          <Text className="text-base">
            O Temor de Deus é um dom que nos faz reverenciar a Deus, e ter
            receio de ofender a sua Divina Majestade, e que nos afasta do mal,
            incitando-nos ao bem.
          </Text>
          <Text className="h2">
          ...
          <Text className="text-base">
            Jesus Cristo propôs-nos as Bem-aventuranças para os fazer detestar
            as máximas do mundo, e para nos convidar a amar e praticar as
            máximas do seu Evangelho.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            não as procuram com solicitude, se não as têm; e sofrem com
            resignação a perda delas se lhes são tiradas.
          </Text>
          <Text className="h5">926 - Quem são os mansos?</Text>
          <Text className="text-base">
            Os mansos são aqueles que tratam o próximo com brandura, e lhe
            sofrem com paciência os defeitos e as ofensas que dele recebem, sem
          ...
          <Text className="text-base">
            Os que choram, e todavia são chamados bem-aventurados, são aqueles
            que sofrem com resignação as tribulações, e que se afligem pelos
            pecados cometidos, pelos males e pelos escândalos que se vêem no
            mundo, pela ausência do céu, e pelo perigo de o perder.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            sempre se afastam dele, e evitam sobretudo toda a espécie de
            impureza.
          </Text>
          ...
          <Text className="text-base">
            Os que sofrem perseguição por amor da justiça são aqueles que
          ...
          <Text className="text-base">
            ...
            espirituais, conforme são corporais ou espirituais as necessidades
            que se socorrem.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">943 - Que é o pecado original?</Text>
          <Text className="text-base">
            O pecado original é aquele com o qual todos nascemos, exceto a
            Santíssima Virgem Maria, e que contraímos pela desobediência do
            nosso primeiro pai Adão.
          </Text>
          <Text className="h5">
          ...
          <Text className="h5">946 - Que é o pecado atual?</Text>
          <Text className="text-base">
            O pecado atual é aquele que o homem, chegado ao uso da razão, comete
          ...
          <Text className="h5">948 - Que é o pecado mortal?</Text>
          <Text className="text-base">
            O pecado mortal é uma transgressão da lei divina, pela qual se falta
            gravemente aos deveres para com Deus, para com o próximo, ou para
            com nós mesmos.
          </Text>
          ...
          <Text className="text-base">
            Além da gravidade da matéria, para haver um pecado mortal requer-se
            a plena advertência desta gravidade, e a vontade deliberada de
            cometer o pecado.
          </Text>
          <Text className="h5">952 - Que é o pecado venial?</Text>
          <Text className="text-base">
            O pecado venial é uma leve transgressão da lei divina, pela qual se
            falta levemente a algum dever para com Deus, para com o próximo, ou
            para com nós mesmos.
          </Text>
          ...
          <Text className="text-base">
            ...
            Santo, porque se cometem por pura malícia, o que é contrário à
            bondade que se atribui ao Espírito Santo.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Novíssimos são chamados nos Livros Santos as últimas coisas que hão
            de acontecer ao homem.
          </Text>
          ...
          <Text className="text-base">
            ...
            porque a Morte é a última coisa que nos acontece neste mundo; o
            Juízo de Deus é o último entre os juízos que temos a passar; o
            Inferno é último mal que hão de sofrer os maus; e o Paraíso é sumo
            bem que hão de receber os bons.
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Um bom cristão, pela manhã, apenas acorda, deve fazer o sinal da
          ...
          <Text className="text-base">
            ...
            <Text className="text-base">
              ...
              peço-Vos que neste dia me preserveis do pecado, e me livreis de
              todo o mal. Assim seja". Reza depois o Padre-Nosso, a Ave-Maria, o
              Credo, e os atos de Fé, de Esperança e de Caridade,
              acompanhando-os com um vivo afeto do coração.
            </Text>
            <Text className="h5">
              972 - Que práticas de piedade deveria fazer todos os dias o
              cristão?
            </Text>
            <Text className="text-base">
            ...
            <Text className="text-base">
              Depois da refeição, convém fazer o sinal da Cruz, e dizer:
              "Senhor, eu Vos dou graças pelo alimento que me destes; fazei-me
              digno de participar da mesa celeste".
            </Text>
            <Text className="h5">
            ...
            <Text className="h5">
              979 - Quando fora da Igreja se ouve o sinal de elevação da hóstia
              na Missa solene, ou da bênção do Santíssimo Sacramento, que se
              deve fazer?
            </Text>
            É bom fazer, ao menos com o coração, um ato de adoração, dizendo,
            por exemplo: "Graças e louvores se dêem a todo o momento ao
          ...
          <Text className="text-base">
            ...
            José eu Vos encomendo a minha alma".
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            ...
            sendo possível, acompanhá-Lo com modéstia e recolhimento; e, se não
            é possível acompanhá-Lo, fazer um ato de adoração em qualquer lugar
            que nos encontremos, e dizer: "Consolai, Senhor, este enfermo, e
            concedei-lhe a graça de se conformar com a vossa santíssima vontade.
            e de conseguir a sua salvação".
          </Text>
          <Text className="h5">
          ...
          <Text className="text-base">
            Ouvindo tocar o sino pela agonia de algum moribundo, irei, se puder,
            à igreja orar por ele; e, não podendo, encomendarei a Nosso Senhor a
            sua alma, pensando que dentro em breve tempo hei de encontrar-me
            também eu naquele estado.
          </Text>
          <Text className="h5">
            990 - Ao ouvir sinais pela morte de alguém, que haveis de fazer?
          </Text>
          <Text className="text-base">
            Ao ouvir sinais pela morte de alguém, procurarei rezar um De
            profundis ou um Réquiem, ou um Padre-Nosso e uma Ave-Maria, pela
            alma daquele defunto, e renovarei o pensamento da morte.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
