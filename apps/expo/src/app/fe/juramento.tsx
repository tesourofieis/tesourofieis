        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              Eu, <Text className="vernacular">N.</Text>, firmemente aceito e
              creio em todas e em cada uma das verdades definidas, afirmadas e
              declaradas pelo magistério infalível da Igreja, sobretudo aqueles
              princípios doutrinais que contradizem directamente os erros do
              tempo presente.
            </Text>
            <Text className="latin">
            ...
            <Text className="vernacular">
              ...
              vivia entre nós, e que foi edificada sobre Pedro, chefe da
            ...
            <Text className="latin">
              ...
              quem prius habuit Ecclesia; pariterque damno errorem omnem quo
              divino deposito, Christi sponsæ tradito ab eaque fideliter
              custodiendo, sufficitur philosophicum inventum, vel creatio humanæ
            ...
            <Text className="vernacular">
              ...
              heresia da evolução dos dogmas de um significado a outro,
              diferente daquele que a Igreja professava primeiro; condeno de
              igual modo todo o erro que pretenda substituir o depósito divino
              confiado por Cristo à Igreja, para que o guardasse fielmente, por
              uma hipótese filosófica ou uma criação da consciência que se
            ...
            <Text className="latin">
              ...
              informatæ, sed verum assensum intellectus veritati extrinsecus
              acceptæ ex auditu, quo nempe, quæ a Deo personali, creatore ac
            ...
            <Text className="vernacular">
              ...
              moralmente educada, mas um verdadeiro assentimento do intelecto a
              uma verdade recebida de fora pela pregação, pelo qual, confiantes
              na sua autoridade supremamente veraz, nós cremos tudo aquilo que,
            ...
            <Text className="latin">
              ...
              credentis fidei contradicant, aut præmissas adstruere, ex quibus
            ...
            <Text className="vernacular">
              ...
              que contradizem a fé o crente ou fixar premissas das quais se
            ...
            <Text className="latin">
              ...
              supernaturali origine catholicæ traditionis, sive de promissa
              divinitus ope ad perennem conservationem uniuscuiusque revelati
              veri; deinde scripta patrum singulorum interpretanda solis
              scientiæ principiis, sacra qualibet auctoritate seclusa eaque
            ...
            <Text className="vernacular">
              ...
              quanto à origem sobrenatural da tradição católica, seja quanto à
              ajuda prometida por Deus para a perene salvaguarda de cada uma das
              verdades reveladas, e então interpretar os textos patrísticos
              somente sobre as bases científicas, expulsando toda autoridade
            ...
            <Text className="latin">
              ...
              nihil iam restet nisi nudum factum et simplex, communibus
              historice factis æquandum: hominum nempe sua industria, solertia,
            ...
            <Text className="vernacular">
              ...
              reduzindo-o a um evento pura e simplesmente análogo àqueles
              ocorridos na história, pelos quais os homens com o próprio
            ...
            <Text className="latin">
              ...
              teneatur, quod melius et aptius videri possit secundum suam
              cuiusque ætatis culturam, sed ut numquam aliter credatur, numquam
            ...
            <Text className="vernacular">
              ...
              aquilo que pareça melhor e mais consoante à cultura própria e
              particular de cada época, mas para que a verdade absoluta e
