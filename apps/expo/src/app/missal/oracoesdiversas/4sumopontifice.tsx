    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          servo <Typography className="vernacular">N.</Typography>, que constituístes Pastor
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          <Typography className="vernacular">N.</Typography>, que constituístes Pastor da
      ...
      <Language>
        <Typography className="latin">
          ...
          fámulum tuum <Typography className="latin">N.</Typography>, quem pastórem Ecclésiæ
        ...
        <Typography className="vernacular">
          ...
          vosso servo <Typography className="vernacular">N.</Typography>, que constituístes
