    ...
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">N.</Typography>, quem pastórem Ecclésiæ
          tuæ præésse voluísti, propítius réspice: da ei, quǽsumus, verbo et
        ...
        <Typography className="vernacular">
          ...
          servo <Typography className="vernacular">N.</Typography>, que
          constituístes Pastor da vossa Igreja; concedei-lhe, Vos suplicamos, a
          graça de edificar os seus súbditos com suas palavras e exemplos, a fim
          de que com o rebanho, que lhe foi confiado, alcance a vida eterna. Por
          nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">N.</Typography>, quem pastórem Ecclésiæ
          tuæ præésse voluísti, assídua protectióne gubérna. Per Dóminum...
        </Typography>
        <Typography className="vernacular">
          Deixai-Vos aplacar, Senhor, Vos suplicamos, com a oferta destes dons;
          e governai com vossa contínua protecção o vosso servo{" "}
          <Typography className="vernacular">N.</Typography>, que constituístes
      ...
      <Language>
        <Typography className="latin">
          ...
          fámulum tuum <Typography className="latin">N.</Typography>, quem
          pastórem Ecclésiæ tuæ præésse voluísti; una cum commísso sibi grege,
          salvet semper et múniat. Per Dóminum...
        </Typography>
        <Typography className="vernacular">
          ...
          vosso servo <Typography className="vernacular">N.</Typography>, que
