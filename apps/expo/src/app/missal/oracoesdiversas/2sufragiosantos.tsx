    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">N.</Text> et ómnibus Sanctis, salutem nobis
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">N.</Text> (nome do Patrono da Igreja) e
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">N.</Text> et ómnibus Sanctis; a cunctis nos
        ...
        <Text className="vernacular">
          ...
          B. <Text className="vernacular">N.</Text> (nome do Patrono da Igreja)
