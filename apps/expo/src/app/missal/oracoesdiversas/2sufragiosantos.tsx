    ...
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">N.</Typography> et ómnibus Sanctis, salutem nobis
          tríbue benígnus et pacem; ut, destrúctis adversitátibus et erróribus
          univérsis, Ecclésia tua secúra tibi sérviat libertáte. Per eúndem
          Dóminum...
        </Typography>
        <Typography className="vernacular">
          ...
          <Typography className="vernacular">N.</Typography> (nome do Patrono da Igreja) e
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">N.</Typography> et ómnibus Sanctis; a cunctis nos
          reddat et perversitátibus expiátos, et adversitátibus expedítos. Per
          eúndem Dóminum...
        </Typography>
        <Typography className="vernacular">
          ...
          B. <Typography className="vernacular">N.</Typography> (nome do Patrono da Igreja)
          e de todos os Santos, nos sirva de expiação dos nossos pecados e nos
          livre de todas as adversidades. Pelo mesmo nosso Senhor...
        </Typography>
      </Language>
    </PageWrapper>
  );
