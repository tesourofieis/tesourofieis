...
export default function PagePortugaldominios() {
  return (
    <div className="docs">
      ...
      servos: o nosso Papa <span className="text-red-500">N.</span> o nosso
      Patriarca <span className="text-red-500">N.</span> (Arcebispo{" "}
      <span className="text-red-500">N.</span> ou Bispo{" "}
      <span className="text-red-500">N.</span>), o nosso Presidente e os nossos
      Governantes, assim como o povo que lhes foi confiado e o seu exército;
      concedei a paz e a prosperidade aos nossos tempos e afastai da nossa
      Igreja toda a maldade, destruindo a soberba dos pagãos e dos hereges com o
      poder da vossa dextra. (Por nosso Senhor... ou Pelo mesmo nosso Senhor
      segundo a conclusão da Oração, da Secreta ou do Postcomúnio a que fica
