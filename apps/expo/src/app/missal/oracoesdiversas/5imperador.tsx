    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          servo tuo imperatóri nostro <span className="text-red-500">N.</span>{" "}
        ...
        <p>
          ...
          <span className="text-red-500">N.</span> vosso servo, que governe
          sempre com sabedoria, para o triunfo do vosso poder, a fim de que,
          sendo príncipe em virtude da vossa instituição, seja sempre poderoso
          em virtude da vossa graça. Por nosso Senhor...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> arma cœléstia; ut pax
        ...
        <p>
          ...
          <span className="text-red-500">N.</span>, vosso servo, as armas
