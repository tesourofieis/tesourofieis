    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          avértas fáciem tuam a me, allelúja, allelúja. <em>Ps. ibidem, 1</em>{" "}
          Dóminus illuminátio mea et salus mea: quem timébo? ℣. Gloria Patri...
        </p>
        <p>
          ...
          <em>Sl. ibidem, 1</em> Ó Senhor é a minha luz e a minha salvação. A
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          murmuratióne: unusquísque, sicut accépit grátiam, in altérutrum illam
          administrántes, sicut boni dispensatóres multifórmis grátiæ Dei. Si
        ...
        <p>
          ...
          sem murmuração. Que cada um seja caritativo para com o próximo,
          segundo a abundância dos dons, que recebeu, como dispensadores da
          multiforme graça de Deus. Se alguém falar, que o faça com palavras de
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Joann. 14, 18</em> Non vos relínquam órphanos: vado, et vénio ad
          vos, et gaudébit cor vestrum. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 46, 9</em> O Senhor reina em todos Os
          povos: Deus está assentado sobre o seu trono Sagrado, aleluia. ℣.{" "}
          <em>Jo. 14, 18</em> Não vos deixarei órfãos: vou, e voltarei para vós
          e o vosso coração alegrar-se-á. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          testemunho de mim, porque estais comigo desde o princípio. Digo-vos
          estas coisas para que vos não escandalizeis. Expulsar-vos-ão das
          sinagogas, e até se aproxima a hora em que qualquer que vos matar
