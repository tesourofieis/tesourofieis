        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">Ps. ibidem, 1</Text> Dóminus illuminátio
            ...
            <Text className="vernacular">
              ...
              aleluia. <Text className="vernacular">Sl. ibidem, 1</Text> Ó
          ...
          <Language>
            <Text className="latin">
              ...
              omnes gentes: Deus sedet super sedem sanctam suam. Allelúja.
              <Text className="versicle"> ℣. </Text>
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. 46, 9</Text> O Senhor reina em
              todos Os povos: Deus está assentado sobre o seu trono Sagrado,
