...
export default function PagePasc00() {
  return (
    <SafeAreaView className="flex-1">
      <ScrollView>
        <View className="docs">
          <Text className="h1">Domingo da Ressurreição</Text>
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              allelúja. <Text className="latin">Ps. ibid., 1-2</Text> Dómine,
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              <Text className="latin">1 Cor. 5, 7</Text> Pascha nostrum
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              nobis, María, quid vidísti in via? Sepúlcrum Christi vivéntis et
              glóriam vidi resurgéntis. Angélicos testes, sudárium et vestes.
              Surréxit Christus, spes mea: præcédet vos in Galilǽam. Scimus
            ...
            <Text className="vernacular">
              ...
              morreu, mas Ele vive e reina. Diz-nos, ó Maria, o que viste no
              caminho? Vi o sepulcro de Cristo, que está vivo; vi a glória de
              Cristo ressuscitado. Vi presentes os Anjos, o sudário e as vestes.
              Ressuscitou Cristo, minha esperança, que precederá na Galileia os
              discípulos. Sabemos que Cristo ressuscitou dos mortos,
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              ínvicem: Quis revólvet nobis lápidem ab óstio monuménti? Et
              respiciéntes vidérunt revolútum lápidem. Erat quippe magnus valde.
              Et introëúntes in monuméntum vidérunt júvenem sedéntem in dextris,
              coopértum stola cándida, et obstupuérunt. Qui dicit illis: Nolíte
              expavéscere: Jesum quǽritis Nazarénum, crucifíxum: surréxit, non
              est hic, ecce locus, ubi posuérunt eum. Sed ite, dícite discípulis
            ...
            <Text className="vernacular">
              ...
              tendo já nascido o sol. E diziam umas às outras: «Quem nos tirará
              a pedra da entrada do sepulcro?». Olhando, então, viram que a
              pedra estava desviada para o lado: a qual, com efeito, era muito
              grande. Entrando no sepulcro, viram um jovem, assentado ao lado
              direito, vestido com uma túnica branca. Ficaram atónitas! Mas o
              jovem disse-lhes: «Não tenhais medo! Procurais a Jesus Nazareno,
              que foi crucificado? Ressuscitou, não está aqui: eis o lugar onde
