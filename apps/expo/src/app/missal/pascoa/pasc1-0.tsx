    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          concupíscite, allelúja, allelúja allelúja. <em>Ps. 80, 2</em>{" "}
          Exsultáte Deo, adjutóri nostro: jubiláte Deo Jacob. ℣. Gloria Patri...
        </p>
        <p>
          ...
          <em>Sl. 80, 2</em> Aclamai a Deus, que é o nosso Sustentáculo: cantai
          hinos de júbilo em honra de Deus de Jacob. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          venit per aquam et sánguinem, Jesus Christus: non in aqua solum, sed
          in aqua et sánguine. Et Spíritus est, qui testificátur, quóniam
          Christus est véritas. Quóniam tres sunt, qui testimónium dant in cœlo:
          Pater, Verbum, et Spíritus Sanctus: et hi tres unum sunt. Et tres
          sunt, qui testimónium dant in terra: Spíritus, et aqua, et sanguis: et
          hi tres unum sunt. Si testimónium hóminum accípimus, testimónium Dei
        ...
        <p>
          ...
          Cristo é que veio com a água e o sangue: não somente com a água, mas
          com a água e o sangue. E é o Espírito quem atesta que Jesus Cristo é a
          verdade. Porquanto são três os que dão testemunho do céu: o Pai, o
          Verbo, e o Espírito Santo: e estes três são um só. E três são os que
          dão testemunho na terra: o espírito, a água e o sangue: e estes três
          são um só. Se aceitamos o testemunho dos homens, muito maior é o
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Matth. 28, 7</em> In die resurrectiónis
          meæ, dicit Dóminus, præcédam vos in Galilǽam. Allelúja. ℣.{" "}
          <em>Joann. 20, 26</em> Post dies octo, jánuis clausis, stetit Jesus in
          médio discipulórum suórum, et dixit: Pax vobis. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Mt. 28, 7</em> No dia da minha ressurreição,
          diz o Senhor, irei adiante de vós para a Galileia, aleluia. ℣.{" "}
          <em>Jo. 20, 26</em> Oito dias depois, estando as portas fechadas,
          Jesus veio e, estando no meio dos seus discípulos, disse: «A paz seja
          convosco», aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          eis; et quorum retinuéritis, reténta sunt. Thomas autem unus ex
          duódecim, qui dícitur Dídymus, non erat cum eis, quando venit Jesus.
          Dixérunt ergo ei alii discípuli: Vídimus Dóminum. Ille autem dixit
          eis: Nisi vídero in mánibus ejus fixúram clavórum, et mittam dígitum
          meum in locum clavórum, et mittam manum meam in latus ejus, non
          credam. Et post dies octo, íterum erant discípuli ejus intus, et
          Thomas cum eis. Venit Jesus, jánuis clausis, et stetit in médio, et
          dixit: Pax vobis. Deinde dicit Thomæ: Infer dígitum tuum huc et vide
          ...
          Deus meus. Dixit ei Jesus: Quia vidísti me, Thoma, credidísti: beáti,
          qui non vidérunt, et credidérunt. Multa quidem et alia signa fecit
        ...
        <p>
          ...
          a quem os retiverdes, ser-lhes-ão retidos». Porém Tomé, um dos Doze,
          que era chamado Dídimo, não estava com eles. Disseram-lhe, então, os
          outros discípulos: «Vimos o Senhor!». Ele respondeu-lhes: «Se não vir
          nas suas mãos o sinal dos cravos, se não meter o meu dedo no lugar dos
          cravos e não meter a minha mão no seu lado, não acreditarei». Passados
          oito dias, encontravam-se os discípulos outra vez, no mesmo lugar,
          estando Tomé com eles. E veio Jesus, estando as portas fechadas; e,
          pondo-se no meio deles, disse: «A paz seja convosco». Em seguida disse
          ...
          Respondeu Tomé: «Meu Senhor e meu Deus!». Disse-lhe Jesus: «Porque me
          viste, ó Tomé, acreditaste: bem-aventurados aqueles que não viram e
          acreditaram». Jesus fez ainda na presença de seus discípulos muitos
