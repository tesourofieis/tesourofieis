        ...
        <View className="docs">
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              aleluia, aleluia. <Text className="vernacular">Sl. 80, 2</Text>{" "}
              Aclamai a Deus, que é o nosso Sustentáculo: cantai hinos de júbilo
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              qui venit per aquam et sánguinem, Jesus Christus: non in aqua
              solum, sed in aqua et sánguine. Et Spíritus est, qui testificátur,
              quóniam Christus est véritas. Quóniam tres sunt, qui testimónium
              dant in cœlo: Pater, Verbum, et Spíritus Sanctus: et hi tres unum
              sunt. Et tres sunt, qui testimónium dant in terra: Spíritus, et
              aqua, et sanguis: et hi tres unum sunt. Si testimónium hóminum
              accípimus, testimónium Dei majus est: quóniam hoc est testimónium
            ...
            <Text className="vernacular">
              ...
              mesmo Jesus Cristo é que veio com a água e o sangue: não somente
              com a água, mas com a água e o sangue. E é o Espírito quem atesta
              que Jesus Cristo é a verdade. Porquanto são três os que dão
              testemunho do céu: o Pai, o Verbo, e o Espírito Santo: e estes
              três são um só. E três são os que dão testemunho na terra: o
              espírito, a água e o sangue: e estes três são um só. Se aceitamos
              o testemunho dos homens, muito maior é o testemunho de Deus. Este
              testemunho de Deus, que é maior, foi por Ele dado a respeito do
          ...
          <Language>
            <Text className="latin">
              ...
              meæ, dicit Dóminus, præcédam vos in Galilǽam. Allelúja.
            ...
            <Text className="vernacular">
              ...
              <Text className="em">Jo. 20, 26</Text> Oito dias depois, estando
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              insufflávit, et dixit eis: Accípite Spíritum Sanctum: quorum
              remiseritis peccáta, remittúntur eis; et quorum retinuéritis,
              reténta sunt. Thomas autem unus ex duódecim, qui dícitur Dídymus,
              non erat cum eis, quando venit Jesus. Dixérunt ergo ei alii
              discípuli: Vídimus Dóminum. Ille autem dixit eis: Nisi vídero in
              mánibus ejus fixúram clavórum, et mittam dígitum meum in locum
              clavórum, et mittam manum meam in latus ejus, non credam. Et post
              dies octo, íterum erant discípuli ejus intus, et Thomas cum eis.
              Venit Jesus, jánuis clausis, et stetit in médio, et dixit: Pax
              vobis. Deinde dicit Thomæ: Infer dígitum tuum huc et vide manus
              meas, et affer manum tuam et mitte in latus meum: et noli esse
              incrédulus, sed fidélis. Respóndit Thomas et dixit ei: Dóminus
              meus et Deus meus. Dixit ei Jesus: Quia vidísti me, Thoma,
              credidísti: beáti, qui non vidérunt, et credidérunt. Multa quidem
              et alia signa fecit Jesus in conspéctu discipulórum suórum, quæ
              non sunt scripta in libro hoc. Hæc autem scripta sunt, ut
            ...
            <Text className="vernacular">
              ...
              veio Jesus, e, estando no meio deles, disse: «A paz seja
              convosco!». Depois de dizer isto, mostrou as suas mãos e o seu
              lado. E alegraram-se os discípulos, vendo o Senhor. E disse-lhes
              novamente: «A paz seja convosco! Assim como meu Pai me enviou,
              assim também vos envio». Ditas estas palavras, soprou sobre eles,
              dizendo: «Recebei o Espírito Santo. Àqueles a quem perdoardes os
              pecados, ser-lhes-ão perdoados, e àqueles a quem os retiverdes,
              ser-lhes-ão retidos». Porém Tomé, um dos Doze, que era chamado
              Dídimo, não estava com eles. Disseram-lhe, então, os outros
              discípulos: «Vimos o Senhor!». Ele respondeu-lhes: «Se não vir nas
              suas mãos o sinal dos cravos, se não meter o meu dedo no lugar dos
              cravos e não meter a minha mão no seu lado, não acreditarei».
              Passados oito dias, encontravam-se os discípulos outra vez, no
              mesmo lugar, estando Tomé com eles. E veio Jesus, estando as
              portas fechadas; e, pondo-se no meio deles, disse: «A paz seja
              convosco». Em seguida disse a Tomé: «Mete aqui o teu dedo e vê as
              minhas mãos; aproxima, também, a tua mão e mete-a no meu lado; e
              não sejas incrédulo, mas fiel». Respondeu Tomé: «Meu Senhor e meu
              Deus!». Disse-lhe Jesus: «Porque me viste, ó Tomé, acreditaste:
              bem-aventurados aqueles que não viram e acreditaram». Jesus fez
              ainda na presença de seus discípulos muitos outros milagres, que
              não foram escritos neste livro; mas estes foram, a fim de que
