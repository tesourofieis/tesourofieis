    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          sempre, aleluia, aleluia. <em>Sl. 104, 1</em> Louvai o Senhor e
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 106, 2</em> Dicant nunc, qui redémpti sunt a Dómino: quos
          rédemit de manu inimíci, et de regiónibus congregávit eos.
        </p>
        <p>
          Eis o dia que o Senhor fez: exultemos e alegremo-nos nele. ℣.{" "}
          <em>Sl. 106, 2</em> Assim devem cantar agora aqueles que o Senhor
          resgatou e tirou das mãos dos inimigos, e que, sendo de muitas
        ...
        <p>
          Aleluia, aleluia. ℣. Ressuscitou do sepulcro o Senhor, que havia sido
          pregado no madeiro por nossa causa.
        </p>
      </div>
