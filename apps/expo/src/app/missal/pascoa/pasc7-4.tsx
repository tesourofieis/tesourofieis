        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              faciébat. Multi enim eórum, qui habébant spíritus immúndos,
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              Et ait ad illos: Nihil tuléritis in via, neque virgam, neque
              peram, neque panem, neque pecúniam, neque duas túnicas habeátis.
              Et in quamcúmque domum intravéritis, ibi manéte et inde ne
              exeátis. Et quicúmque non recéperint vos: exeúntes de civitáte
              illa, etiam púlverem pedum vestrórum excútite in testimónium supra
            ...
            <Text className="vernacular">
              ...
              curar os enfermos, e disse-lhes: «Não leveis nada pelo caminho:
              nem bordão, nem saco, nem pão, nem dinheiro; não tenhais duas
              túnicas; em qualquer casa em que entrardes, permanecei aí e não
              queirais sair; quando encontrardes pessoas que não queiram
              receber-vos, saí dessa cidade e sacudi até o pó dos vossos pés, a
              fim de que isso sirva de testemunho contra elas». Então partiram;
