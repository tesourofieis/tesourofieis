    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          eos, allelúja, allelúja. <Text className="latin">Ps. ibid., 2</Text>{" "}
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">Sl. ibid., 2</Text> Louvai alegremente o
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">Act. 2, 4</Text> Loquebántur váriis linguis
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">Act. 2, 4</Text> Os Apóstolos publicavam
