    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 95, 1</em> Cantáte Dómino cánticum novum: cantáte Dómino,
          omnis terra. ℣. Gloria Patri...
        </p>
        <p>
          Vinde, benditos do meu Pai, recebei o reino, aleluia: que foi
          preparado para vós desde a criação do mundo, aleluia, aleluia,
          aleluia. <em>Sl. 95, 1</em> Cantai ao Senhor um cântico novo: que toda
          a terra cante hinos ao Senhor. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          tradidístis et negástis ante fáciem Piláti, judicánte illo dimítti.
          Vos autem sanctum et justum negástis, et petístis virum homicídam
          donári vobis: auctórem vero vitæ interfecistis, quem Deus suscitávit a
          mórtuis, cujus nos testes sumus. Et nunc, fratres, scio, quia per
          ignorántiam fecístis, sicut et príncipes vestri. Deus autem, quæ
        ...
        <p>
          ...
          entregastes e atraiçoastes perante Pilatos, quando este O julgava e
          queria livrá-l’O. Vós atraiçoastes o Santo e o Justo: pedistes que um
          homicida fosse livre e matastes o autor da vida, o qual Deus, porém,
          ressuscitou dos mortos! De tudo isto somos testemunhas. Contudo, meus
          irmãos, sei que assim procedestes por ignorância; e do mesmo modo os
          vossos príncipes. Mas foi assim que Deus cumpriu tudo o que havia sido
      ...
      <div className="side-by-side">
        <p>
          Hæc dies, quam fecit Dóminus: exsultémus et lætámur in ea. ℣. Déxtera
        ...
        <p>
          Allelúja, allelúja. ℣. <em>Luc. 24, 34</em> Surréxit Dóminus vere: et
          appáruit Petro.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Lc. 24, 34</em> O Senhor ressuscitou
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          fílii Zebedǽi et álii ex discípulis ejus duo. Dicit eis Simon Petrus:
          Vado piscári. Dicunt ei: Venímus et nos tecum. Et exiérunt et
          ascendérunt in navim: et illa nocte nihil prendidérunt. Mane autem
          facto, stetit Jesus in lítore: non tamen cognovérunt discípuli, quia
          Jesus est. Dixit ergo eis Jesus: Púeri, numquid pulmentárium habétis?
          Respondérunt ei: Non. Dicit eis: Míttite in déxteram navígii rete, et
          inveniétis. Misérunt ergo: et jam non valébant illud tráhere præ
          multitúdine píscium. Dixit ergo discípulus ille, quem diligébat Jesus,
          Petro: Dóminus est. Simon Petrus cum audísset, quia Dóminus est,
          túnica succínxit se (erat enim nudus), et misit se in mare. Alii autem
          discípuli navígio venérunt (non enim longe erant a terra, sed quasi
          cúbitis ducéntis), trahéntes rete píscium. Ut ergo descendérunt in
          terram, vidérunt prunas pósitas, et piscem superpósitum, et panem.
          Dicit eis Jesus: Afférte de píscibus, quos prendidístis nunc. Ascéndit
          Simon Petrus, et traxit rete in terram, plenum magnis píscibus centum
          quinquagínta tribus. Et cum tanti essent, non est scissum rete. Dicit
          eis Jesus: Veníte, prandéte. Et nemo audébat discumbéntium interrogáre
        ...
        <p>
          ...
          Zebedeu e dois outros discípulos. Então Simão-Pedro disse: «Eu vou
          pescar». Eles disseram: «Também iremos convosco». Saíram, então, e
          subiram para uma barca. Porém, durante toda a noite nada pescaram.
          Sendo já de manhã, Jesus apareceu na praia, mas os discípulos O não
          conheceram. Então Jesus disse-lhes: «Filhos, tendes alguma coisa para
          comer?». Responderam-Lhe: «Não». Ele disse-lhes: «Lançai a rede à
          direita da barca e achareis peixes». Lançaram-na eles, e já não podiam
          recolhê-la, tanta era a quantidade de peixes que continha. Então o
          discípulo, que Jesus preferia, disse a Pedro: «É o Senhor!».
          Simão-Pedro, ouvindo que era o Senhor, cingiu-se com a túnica (pois
          estava nu) e lançou-se ao mar. E os outros discípulos vieram com a
          barca (pois estavam um pouco afastados da terra, cerca de duzentos
          côvados), conduzindo a rede com os peixes. Logo que desceram para a
          terra, viram as brasas acesas, um peixe em cima delas e pão. E Jesus
          disse-lhes: «Dai-me desses peixes que pescastes agora». Subiu Pedro
          para a barca, puxou a rede para terra e tirou cento e cinquenta e três
          peixes grandes; e, sendo tantos, a rede se não rompeu! Disse-lhes,
          então, Jesus: «Vinde e comei». E nenhum dos discípulos presentes
          ousava perguntar-Lhe: «Quem sois?» (pois sabiam que era o Senhor). E
