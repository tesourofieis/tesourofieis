...
export default function PagePasc23() {
  return (
    <div className="docs">
      <h1>S. José, Padroeiro da Santa Igreja e dos Moribundos</h1>
      ...
      <aside>
        ...
        Jacob ao morrer profetiza que seu filho José «será o pastor e a força de
        Israel, e que o Omnipotente o cumulará de bênçãos». José foi
        estabelecido por Faraó sobre toda a terra do Egipto, de sorte que a
        salvação de todos dependia dele. O povo clamou ao rei, implorando
        viveres, e ele lhes respondeu: «Ide a José». «Deus me estabeleceu como
        pai do rei, e o senhor de toda a sua casa; elevou-me para salvar muitos
        povos». É o papel confiado por Deus a S. José, em sua Igreja. O
        Evangelho, a Oração e a Comunhão, estabelecendo as relações existentes
        entre a Trindade do céu e a da terra, fazem sobressair todo o poder de
        S. José. Maria, a esposa que o Espírito Santo tornou fecunda, é a Mãe de
        Jesus, e, como José é o esposo dessa mãe virgem, tem um direito sobre o
        bendito fruto do seu seio. O Prefácio diz que ele se porta para com o
        Menino Deus como um Pai para com seu Filho. O Intróito, as Orações, o
        Aleluia e o Ofertório nos mostram, em S. José, o protector estabelecido
        pela divina Providência como Seu delegado junto do corpo místico de
        Cristo, que é a Igreja, para velar sobre ela no meio de todas as suas
        tribulações. «Lembrai-vos de nós, ó S. José» diz S. Bernardino de Sena,
        «intercedei por nós pelo sufrágio de vossa oração, junto d'Aquele que
        passou por vosso filho: ao mesmo tempo, tornai-nos propícia vossa esposa
        a Virgem Santíssima». Comemoração S. Pedro de Verona, Mártir. Nascido em
        Verona, pelo ano 1205, de pais maniqueus, S. Pedro combateu, desde a
        infância, os hereges e entrou na Ordem dos Dominicanos. Conservou o
        corpo o corpo e a alma em tão grande pureza, que jamais cometeu pecado
        mortal. Lê-se na Bula de sua canonização: «Cacho de uvas escolhido na
        vinha da Igreja, encheu, com o seu suco generoso, o cálice real. O galho
        do qual foi desprendido pelo ferro, era um dos mais aderentes ao cepo
        divino». Era de tal modo inflamado pelo amor da sua fé, que desejava
        morrer por ela, e foi atendido: «Vivendo piedosamente no Cristo, era
        necessário que fosse perseguido». Um ímpio sicário, enviado pelos
      ...
      <div className="side-by-side">
        <p>
          ...
          regis Israël, inténde: qui dedúcis, velut ovem, Joseph. ℣. Gloria
          Patri...
        </p>
        <p>
          ...
          pastor guia a ovelha, ouvi. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          dissolúta sunt víncula brachiórum et mánuum illíus per manus poténtis
          Jacob: inde pastor egréssus est, lapis Israël. Deus patris tui erit
          adjútor tuus, et Omnípotens benedícet tibi benedictiónibus cœli
          désuper, benedictiónibus abýssi jacéntis deórsum, benedictiónibus
          úberum et vulvæ. Benedictiónes patris tui confortátæ sunt
        ...
        <p>
          ...
          sua inveja, até lhe arrojaram dardos; porém, o seu arco retesado
          permaneceu sempre forte, e as cadeias, que prendiam os seus braços e,
          as suas mãos, foram partidas pela mão do Deus poderoso de Jacob. De
          modo que Ele saiu desta situação para ser o pastor dum povo e o
          sustentáculo de Israel. Ó meu filho, o Deus de teu pai será o teu
          protector; o Omnipotente encher-te-á com suas excelsas bênçãos; a
          terra que habitas será regada pelas torrentes que procedem da
          profundeza do abysmo das águas, por virtude dessa bênção; e serás
          ainda abençoado com a fecundidade maternal. As bênçãos, que sobre ti
          lança teu pai, excedem as que ele recebeu de seus antepassados; e
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. De quacúmque tribulatióne clamáverint ad me,
          exáudiam eos, et ero protéctor eórum semper. Allelúja. ℣. Fac nos
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          corporal, como de uma pomba, ouvindo-se uma voz, vinda do céu, que
