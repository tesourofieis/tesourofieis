...
export default function PagePasc72() {
  return (
    <div className="docs">
      <h1>Terça-feira de Pentecostes</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          allelúja. <em>Ps. 77, 1</em> Atténdite, pópule meus, legem meam:
        ...
        <p>
          ...
          <em>Sl. 77, 1</em> Escutai a minha lei, ó meu povo: escutai as
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Joann. 14, 26</em> Spíritus Sanctus docébit
          vos, quæcúmque díxero vobis. Allelúja. <em>hic genuflectitur</em> ℣.
          Veni, Sancte Spíritus, reple tuórum corda fidélium: et tui amóris in
          eis ignem accénde.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Jo. 14, 26</em> O Espírito Santo vos
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          ostiárius áperit, et oves vocem ejus áudiunt, et próprias oves vocat
          nominátim et e ducit eas. Et cum próprias oves emíserit, ante eas
          vadit: et oves illum sequúntur, quia sciunt vocem ejus. Aliénum autem
          non sequúntur, sed fúgiunt ab eo; quia non novérunt vocem alienórum.
          Hoc provérbium dixit eis Jesus. Illi autem non cognovérunt, quid
          loquerétur eis. Dixit ergo eis íterum Jesus: Amen, amen, dico vobis,
          quia ego sum óstium óvium. Omnes, quotquot venérunt, fures sunt et
          latrónes, et non audiérunt eos oves. Ego sum. óstium. Per me si quis
        ...
        <p>
          ...
          entra pela porta. A este abre o porteiro a porta e as ovelhas ouvem a
          sua voz. Ele chama as ovelhas pelos seus próprios nomes e fá-las sair.
          E, quando sai com elas, vai adiante e elas seguem-no, pois conhecem a
          sua voz. Mas não acompanharão um estranho; antes fugirão dele, porque
          não conhecem a voz dos estranhos». Jesus disse-lhes esta parábola, mas
          eles não compreenderam o seu sentido. E Jesus disse-lhes novamente:
          «Em verdade, em verdade vos digo: Eu sou a porta das ovelhas. Todos
          quantos vieram são ladrões e salteadores, por isso as minhas ovelhas
          os não ouviram. Eu sou a porta. Se alguém entrar por mim, será salvo:
