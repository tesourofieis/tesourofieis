    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          allelúja, allelúja, allelúja. <em>Ps. ibid., 1</em> Attendite, pópule
        ...
        <p>
          ...
          <em>Sl. ibid., 1</em> Atende à minha lei, ó meu povo: escuta as
      ...
      <div className="side-by-side">
        ...
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 95, 10</em> Dizei aos povos: o Senhor
          reinou pelo madeiro.
        </p>
      </div>
