        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">Ps. ibid., 1</Text> Attendite, pópule
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. ibid., 1</Text> Atende à minha
              lei, ó meu povo: escuta as palavras da minha boca.
