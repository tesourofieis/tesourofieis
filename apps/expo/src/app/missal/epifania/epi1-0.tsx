        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              ætérnum. <Text className="latin">Ps. 99, 1</Text> Jubiláte Deo,
            ...
            <Text className="vernacular">
              ...
              império é eterno!» <Text className="vernacular">Sl. 99, 1</Text>{" "}
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              reformámini in novitáte sensus vestri: ut probétis, quæ sit
              volúntas Dei bona, et benéplacens, et perfécta. Dico enim per
              grátiam, quæ data est mihi, ómnibus qui sunt inter vos: Non plus
              sápere, quam opórtet sápere, sed sápere ad sobrietátem: et
              unicuique sicut Deus divísit mensúram fídei. Sicut enim in uno
              córpore multa membra habémus, ómnia autem membra non eúndem actum
            ...
            <Text className="vernacular">
              ...
              agradável e perfeito. Exorto-vos, pois, a todos vós, pela graça
              que me foi dada, que não formeis de vós um juízo muito elevado,
              mas que tenhais sentimentos modestos de vós, cada um conforme a
              medida que Deus lhe concedeu. Porquanto, assim como em um só corpo
              temos muitos membros (os quais, contudo, não têm a mesma função),
              assim também, ainda que sejamos vários, contudo formamos um só
          ...
          <Language>
            <Text className="latin">
              ...
              pacem pópulo tuo, et colles justítiam.
            </Text>
            <Text className="vernacular">
              Bendito seja o Senhor Deus de Israel, pois somente Ele opera
              prodígios em todos os séculos.
            ...
            <Text className="latin">
              ...
              terra: servíte Dómino in lætítia. Allelúja.
            </Text>
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
              <Text className="vernacular">Sl. 99, 1</Text> Aclamai
