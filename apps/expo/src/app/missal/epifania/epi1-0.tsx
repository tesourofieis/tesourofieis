    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 99, 1</em> Jubiláte Deo, omnis terra: servíte Dómino in
          lætítia. ℣. Gloria Patri...
        </p>
        <p>
          ...
          eterno!» <em>Sl. 99, 1</em> Aclamai jubilosamente o Senhor, ó
          habitantes da terra: obedecei ao Senhor com alegria. ℣. Glória ao
          Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          sǽculo. ℣. Suscípiant montes pacem pópulo tuo, et colles justítiam.
        </p>
        <p>
          Bendito seja o Senhor Deus de Israel, pois somente Ele opera prodígios
          em todos os séculos. ℣. Que os montes do vosso povo sejam bafejados
          pela paz: e as colinas pela justiça.
        </p>
        <p>
        ...
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 99, 1</em> Aclamai jubilosamente o
