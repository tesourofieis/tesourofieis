...
export default function PageEpi50() {
  return (
    <div className="docs">
      <h1>Quinto Domingo depois da Epifania</h1>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          perfectionis: et pax Christi exsúltet in córdibus vestris, in qua et
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          zizánia in médio trítici, et ábiit. Cum autem crevísset herba et
          fructum fecísset, tunc apparuérunt et zizánia. Accedéntes autem servi
          patrisfamílias, dixérunt ei: Dómine, nonne bonum semen seminásti in
          agro tuo? Unde ergo habet zizánia? Et ait illis: Inimícus homo hoc
          fecit. Servi autem dixérunt ei: Vis, imus, et collígimus ea? Et ait:
          Non: ne forte colligéntes zizánia eradicétis simul cum eis et
        ...
        <p>
          ...
          retirou. Havendo crescido a erva, deu fruto e apareceu também o joio.
          Então aproximaram-se os servos do pai de família, e disseram-lhe: «Por
          ventura não semeastes boa semente neste vosso campo? Donde lhe veio,
          pois, o joio?». Ele disse: «Foi o homem inimigo quem fez isto». Os
          servos retorquiram-lhe: «Quereis que vamos e colhamos o joio?». Ele
          disse: «Não, pois receio que, arrancando o joio, arranqueis também o
