...
export default function PageEpi20() {
  return (
    <div className="docs">
      <h1>Segundo Domingo depois da Epifania</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          tuo, Altíssime. <em>Ps. ibid., 1-2</em> Jubiláte Deo, omnis terra,
          psalmum dícite nómini ejus: date glóriam laudi ejus. ℣. Gloria
          Patri...
        </p>
        <p>
          ...
          <em>Sl. ibid., 1-2</em> Aclamai jubilosamente o Senhor, ó habitantes
          da terra: cantai hinos em honra do seu nome: glorificai-O com vossos
          louvores. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          exhortándo, qui tríbuit in simplicitáte, qui præest in sollicitúdine,
          qui miserétur in hilaritáte. Diléctio sine simulatióne. Odiéntes
          malum, adhæréntes bono: Caritáte fraternitátis ínvicem diligéntes:
          Honóore ínvicem præveniénte s: Sollicitúdine non pigri: Spíritu
          fervéntes: Dómino serviéntes: Spe gaudéntes: In tribulatióne
          patiéntes: Oratióni instántes: Necessitátibus sanctórum communicántes:
          Hospitalitátem sectántes. Benedícite persequéntibus vos: benedícite,
        ...
        <p>
          ...
          ensino, exerça-o; aquele que recebeu o dom de exortar, exorte; aquele
          que dá esmola, dê-a com simplicidade; aquele que governa, governe com
          solicitude; aquele que pratica as obras de misericórdia, pratique-as
          com alegria. Que a vossa caridade seja sem fingimento. Odiai o mal e
          amai o bem. Amai-vos reciprocamente com amor fraternal, sendo cada um
          solícito em honrar o outro. Com o zelo vencei a preguiça; conservai o
          fervor no espírito; servi o Senhor; alegrai-vos na esperança; sede
          pacientes nas tribulações; assíduos na oração; prontos em socorrer as
          necessidades dos fiéis; praticai a hospitalidade; abençoai aqueles que
          vos perseguem: abençoai-os e não os amaldiçoeis; alegrai-vos com os
      ...
      <div className="side-by-side">
        ...
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 148, 2</em> Laudáte Dóminum, omnes
          Angeli ejus: laudáte eum, omnes virtútes ejus. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 148, 2</em> Louvai o Senhor, vós todos,
          que sois os seus Anjos: louvai-O, vós todos, que sois os seus
          exércitos. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          ei Jesus: Quid mihi et tibi est, mulier? nondum venit hora mea. Dicit
          Mater ejus minístris: Quodcúmque díxerit vobis, fácite. Erant autem
          ibi lapídeæ hýdriæ sex pósitæ secúndum purificatiónem Judæórum,
          capiéntes síngulæ metrétas binas vel ternas. Dicit eis Jesus: Implete
          hýdrias aqua. Et implevérunt eas usque ad summum. Et dicit eis Jesus:
          Hauríte nunc, et ferte architriclíno. Et tulérunt. Ut autem gustávit
          architriclínus aquam vinum fáctam, et non sciébat unde esset, minístri
          autem sciébant, qui háuserant aquam: vocat sponsum architriclínus, et
          dicit ei: Omnis homo primum bonum vinum ponit: et cum inebriáti
        ...
        <p>
          ...
          Jesus disse-Lhe: «Não têm vinho». Jesus respondeu-lhe: «Mulher, que
          tenho Eu e vós com isso? Ainda não chegou a minha hora». Mas sua Mãe
          disse aos servos: «Fazei tudo quanto Ele vos disser». Ora, estavam ali
          seis talhas de pedra para servirem nas purificações dos judeus,
          contendo cada uma delas duas ou três medidas. Jesus disse-lhes então:
          «Enchei as talhas com água». Eles as encheram até acima. E Jesus
          continuou: «Tirai, agora, e levai ao que dirige o banquete». Eles
          assim fizeram. Logo que o que dirigia o banquete provou o vinho (ele
          não sabia donde viera este vinho, mas os servos, que haviam tirado a
          água, sabiam) chamou o esposo e disse-lhe: «Todo o homem serve
          primeiramente o bom vinho, e depois que se bebe dele abundantemente é
