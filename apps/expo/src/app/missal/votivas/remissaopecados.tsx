    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 56, 2</em> Miserére mei, Deus, miserére mei: quóniam in te
          confídit ánima mea. ℣. Gloria Patri...
        </p>
        <p>
          ...
          nosso Deus. (T. P. Aleluia, aleluia.) <em>Sl. 56, 2</em> Tende
          misericórdia de mim, ó Deus, tende misericórdia de mim, porque a minha
          alma em Vós confia. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          est Deus eórum? ℣. ibid., 9 Adjuva nos, Deus, salutáris noster: et
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Senhor. ℣. Estejam os vossos ouvidos atentos à oração do vosso servo.
          ℣. Se guardardes a lembrança dos nossos delitos, Senhor, quem poderá
          subsistir ante Vós, Senhor? ℣. Pois nas vossas mãos está o perdão: e
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 50, 10</em> Audítui meo dabis gáudium et lætítiam: et
          exsultábunt ossa humiliáta. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 7, 12</em> Deus é juiz justo, forte e
          paciente. Porventura irar-se-á todos os dias? Aleluia. ℣.{" "}
          <em>Sl. 50, 10</em> Dareis gozo e alegria aos meus ouvidos: e meus
          ossos humilhados exultarão de contentamento. Aleluia.
        </p>
      </div>
