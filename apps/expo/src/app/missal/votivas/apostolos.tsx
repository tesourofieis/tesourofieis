    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          operántium iniquitátem, allelúja, allelúja. <em>Ps. ib., 2</em>{" "}
          Exáudi, Dómine, orationem meam, cum déprecor: a timóre inimíci éripe
        ...
        <p>
          ...
          <em>Sl. ib., 2</em> Senhor, quando eu Vos invocar, ouvi a minha
      ...
      <div className="side-by-side">
        ...
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 88, 6</em> Senhor, os céus proclamam as
          vossas maravilhas e a vossa verdade na assembleia dos Santos. Aleluia.
          ℣. <em>Jo. 15, 16</em> Fui Eu quem vos escolheu no mundo, a fim de que
          possais ir (pelo mundo), alcanceis frutos e esses frutos permaneçam
          Aleluia.
        </p>
      </div>
