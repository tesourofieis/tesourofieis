        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              Allelúja, allelúja.) <Text className="latin">Ps. 121, 1</Text>{" "}
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. 121, 1</Text> Regozijei-me quando
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              locútus est ad Abraham et Isaac et Jacob, servórum suórum
              fidélium; et det vobis cor ómnibus, ut colátis eum et faciátis
              ejus voluntátem corde magno et ánimo volénti. Adapériat cor
              vestrum in lege sua et in præcéptis suis et fáciat pacem. Exáudiat
            ...
            <Text className="vernacular">
              ...
              fiéis servos Abraão, Isaque e Jacob; que vos dê disposições
              rectas, a fim de que O adoreis e cumprais a sua vontade com
              coração generoso e ânimo dócil; que ilumine o vosso coração com
              sua lei e com seus preceitos, para que gozeis a paz; que Ele o
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              na abundância dos bens aqueles que Vos amam, ó Sião.
              <Text className="versicle"> ℣. </Text>Que haja paz nas tuas
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              <Text className="versicle"> ℣. </Text>E contra os seus muros
          ...
          <Language>
            ...
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
              <Text className="vernacular">Sl. 147, 12</Text> Louvai o Senhor, ó
