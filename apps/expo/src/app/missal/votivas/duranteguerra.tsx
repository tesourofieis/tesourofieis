        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              allelúja.) <Text className="latin">Ps. ibid., 1-2</Text> Ad te,
              Dómine, levávi ánimam meam: Deus meus, in te confído, non
              erubéscam.<Text className="versicle"> ℣. </Text>Gloria Patri...
            </Text>
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              príncipes bellatórum, et univérsum pópulum a mínimo usque ad
              magnum. Et dixit ad eos: Hæc dicit Dóminus, Deus Israël, ad quem
              misístis me, ut prostérnerem preces vestras in conspéctu ejus: Si
              quiescéntes manséritis in terra hac, ædificábo vos, et non
              déstruam; plantábo, et non evéllam: jam enim placátus sum super
              malo, quod feci vobis. Nolíte timére a fácie regis Babylónis, quem
              vos pavídi formidátis; nolíte metúere eum, dicit Dóminus: quia
              vobíscum sum ego, ut salvos vos fáciam et éruam de manu ejus. Et
            ...
            <Text className="vernacular">
              ...
              e todo o povo, desde o mais alto ao mais baixo, aos quais disse:
              «Eis o que diz o Senhor, Deus de Israel, a quem me mandastes para
              que Lhe apresentasse as vossas preces: «Se permanecerdes em
              repouso nesta mansão, edificarei para vosso proveito, e não
              destruirei; plantarei para vós, e não arrancarei; pois já estou
              aplacado pelo mal que contra mim praticastes», Não receeis, pois,
              o rei da Babilónia, que vos faz tremer; o não receeis, diz o
              Senhor, pois estou convosco para vos salvar e arrancar de suas
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              vosso poder.<Text className="versicle"> ℣. </Text>Livrastes com a
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              pecados e iniquidades.<Text className="versicle"> ℣. </Text>
              <Text className="vernacular">Sl. 78, 8-9</Text> Esquecei-Vos das
              nossas antigas iniquidades, Senhor: apressai-Vos em revestir-nos
              com vossas misericórdias, pois grande é a nossa miséria.
          ...
          <Language>
            <Text className="latin">
              ...
              meis, Deus meus: et ab insurgéntibus in me líbera me. Allelúja.
              <Text className="versicle"> ℣. </Text>
              <Text className="em">ibid., 17</Text> Ego autem cantábo
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              quis vos sedúcat. Multi enim vénient in nómine meo, dicéntes: Ego
              sum Christus; et multos sedúcent. Auditúri enim estis prǿlia et
              opiniónes prœliórum. Vidéte, ne turbémini. Opórtet enim hæc fíeri,
              sed nondum est finis. Consúrget enim gens in gentem, et regnum in
            ...
            <Text className="vernacular">
              ...
              séculos?». Então, respondendo Jesus, disse-lhes: «Acautelai-vos,
              para que ninguém Vos seduza; pois virão muitos, dizendo: «Eu sou o
              Cristo», seduzindo também muitas pessoas. Ouvireis falar de
              guerras e de rumores de guerras. Tende cuidado em vos não
              perturbardes; pois convém que tais coisas aconteçam, mas isso não
              será ainda o fim. Levantar-se-á povo contra povo, e reino contra
