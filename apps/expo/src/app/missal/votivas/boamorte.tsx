    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 1</em> Usquequo, Dómine, oblivísceris me in finem?
          usquequo avertis fáciem tuam a me? ℣. Gloria Patri...
        </p>
        <p>
          ...
          contra ele. (T. P. Aleluia, aleluia.) <em>Sl. ibid., 1</em> Até
          quando, Senhor, me esquecereis? Esquecer-me-eis até ao fim? Até quando
          conservareis afastada de mim a vossa face? ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          et resurréxit: ut et mortuórum et vivórum dominétur. Tu autem quid
          júdicas fratrem tuum? aut tu quare spernis fratrem tuum? Omnes enim
          stábimus ante tribúnal Christi. Scriptum est enim: Vivo ego, dicit
        ...
        <p>
          ...
          por isto que Cristo morreu e ressuscitou: para que fosse Senhor tanto
          dos mortos, como dos vivos. Porque julgais, então, o vosso irmão?
          Certamente todos comparecemos ante o tribunal de Cristo; pois está
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          os males; pois Vós, Senhor, estais comigo. ℣. Vossa vara e o vosso
        ...
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 30, 2-3</em> Tenho esperança em Vós,
          Senhor: não ficarei confundido para sempre. Pela vossa justiça,
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          minha alma: meu Deus, confio em Vós: não ficarei envergonhado, pais os
      ...
      <div className="side-by-side">
        <p>
          ...
          domus Jacob de pópulo bárbaro. Allelúja. ℣. <em>Ps. 107, 2</em>{" "}
          Parátum cor meum, Deus, parátum cor meum: cantábo et psallam tibi,
          glória mea. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 113, 1</em> Quando Israel saiu do Egipto
          e a casa de Jacob no meio de um povo bárbaro. Aleluia. ℣.{" "}
          <em>Sl. 107, 2</em> Meu coração está preparado. Eu cantarei Salmos em
          vossa honra na minha glória. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          de que não caia sobre vós aquele dia repentino; porquanto ele virá, à
          semelhança de um laço, sobre todos aqueles que estão à face da terra.
