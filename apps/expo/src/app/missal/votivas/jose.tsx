    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          (T. P. Aleluia, aleluia.){" "}
          <Text className="vernacular">Sl. 79, 2</Text> Vós, que conduzis José,
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          Alcançai-nos, ó José, que a nossa vida decorra sem mancha e que, sob
          vosso Patrocínio, esteja sempre segurança. Aleluia.
        </Text>
      </Language>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>Na sua casa haverá abundância e
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          protector. Aleluia.<Text className="versicle"> ℣. </Text>Ó José, fazei
