    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 79, 2</em> Qui regis Israël, inténde: qui dedúcis, velut ovem,
          Joseph. ℣. Gloria Patri...
        </p>
        <p>
          ...
          (T. P. Aleluia, aleluia.) <em>Sl. 79, 2</em> Vós, que conduzis José,
          como um pastor guia a ovelha, ouvi. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          désuper, benedictiónibus abýssi jacéntiis deórsum, benedictiónibus
          úberum et vulvæ. Benedictiónes patris tui confortátæ sunt
          benedictiónibus patrum ejus, donec veníret Desidérium cóllium
          æternórum: fiant in ca-pite Joseph, et in vértice Nazarǽi inter
          fratres suos.
        </p>
        <p>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          uma coroa de pedras preciosas. ℣. Ele pediu-Vos a vida, e
        ...
        <p>
          ...
          sem mancha e que, sob vosso Patrocínio, esteja sempre segurança.
          Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          cumprimento dos seus mandamentos. ℣. Sua descendência será poderosa na
          terra, pois a posteridade dos justos será abençoada. ℣. Na sua casa
          haverá abundância e riqueza e a sua justiça subsistirá em todos os
          séculos dos séculos.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Sanctus corporáli specie sicut colúmba in ipsum: et vox de cœlo facta
      ...
      <div className="side-by-side">
        <p>
          ...
          despícere, ac te verum Deum perfécta caritáte dilígere: Qui vivis et
          regnas...
        </p>
        <p>
      ...
      <div className="side-by-side">
        <p>
          ...
          nos facis beáti Joseph protectióne gaudére; ita, ejus meritis et
          intercessióne, cæléstis glóriæ fácias esse participes. Per Dóminum...
        </p>
        <p>
