    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          (T. P. Allelúja, allelúja.) <Text className="latin">Ps. 77, 1</Text>{" "}
        ...
        <Text className="vernacular">
          ...
          (T. P. Aleluia, aleluia.){" "}
          <Text className="vernacular">Sl. 77, 1</Text> Ó meu povo, escutai a
      ...
      <Language>
        ...
        <Text className="latin">
          ...
          <Text className="latin">Ps. 78, 9-10</Text> Propítius esto, Dómine,
          peccátis nostris: ne quando dicant gentes: Ubi est Deus eórum?
          Allelúja.
        </Text>
        <Text className="vernacular">
          Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Sl. 78, 9-10</Text> Perdoai-nos, Senhor,
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">Sl. 78, 9-10</Text> Perdoai-nos, Senhor,
          Os nossos pecados: para que os povos não digam: «Onde está o seu
          Deus?». Aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="em">Sl. 30, 8</Text> Exultarei de alegria por causa
