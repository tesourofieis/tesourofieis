        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              allelúja.) <Text className="latin">Ps. ibid., 4</Text>{" "}
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. ibid., 4</Text> Que todos os
          ...
          <Language>
            <Text className="latin">
              ...
              clarificétur, et omnes gentes cognóscant te solum Deum verum, et
            ...
            <Text className="vernacular">
              ...
              fim de que a vossa doutrina se propague e seja manifestada, e
              todas as nações Vos conheçam como único e verdadeiro Deus, e
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              meménto finis, ut enárrent mirabília tua. Da testimónium his, qui
              ab inítio creatúræ tuæ sunt, et súscita prædicatiónes, quas locúti
              sunt in nómine tuo prophétæ prióres. Da mercédem sustinéntibus te,
              ut prophétæ tui fidéles inveniántur: et exáudi oratiónes servórum
              tuórum, secúndum benedictiónem Aaron de pópulo tuo, et dírige nos
            ...
            <Text className="vernacular">
              ...
              reconheçam que não há outro Deus senão Vós e proclamem vossas
              maravilhas. Erguei vossa mão contra as nações estrangeiras, Para
              que reconheçam vosso poder; porque, assim como diante dos seus
              olhos mostrastes a vossa santidade, assim também à nossa vista
              mostrai nelas a vossa grandeza, a fim de que reconheçam, como nós,
              que além de Vós, Senhor, não há outro Deus. Renovai vossos
              prodígios e operai novas maravilhas. Glorificai a vossa mão e o
              vosso braço direito. Excitai o vosso furor e manifestai a vossa
              ira. Destruí o adversário e afligi o inimigo. Apressai o tempo e
              ...
              primeiros Profetas. Concedei recompensa aos que esperam em Vós,
              para que os vossos profetas sejam considerados verdadeiros, e ouvi
              as súplicas dos vossos servos, segundo a bênção de Aarão ao vosso
              povo, e encaminhai-nos pela estrada da justiça, a fim de que todos
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              povos Vos glorifiquem.<Text className="versicle"> ℣. </Text>A
              terra deu o seu fruto. Que o nosso Deus nos abençoe, ó Deus! Que
              em todos os confins da terra O temam.
            </Text>
            <Text className="latin">
              Allelúja, allelúja.<Text className="versicle"> ℣. </Text>
              <Text className="latin">Ps. 99, 1</Text> Jubiláte Deo, omnis
              terra: servíte Dómino in lætítia: introíte in conspéctu ejus, in
          ...
          <Language>
            <Text className="latin">
              ...
              magnus Dóminus, et laudábilis nimis: terríbilis est super omnes
              deos.
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              rejubilai diante de Deus. Servi o Senhor com alegria. Comparecei
              diante d’Ele, exultando de contentamento. Aleluia. Sabei que o
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              misértus est eis: quia erant vexáti, et jacéntes sicut oves non
              habéntes pastórem. Tunc dicit discípulis suis: Messis quidem
            ...
            <Text className="vernacular">
              ...
              compadeceu-se delas, pois estavam desgarradas e abandonadas, como
              ovelhas sem pastor. Então, disse aos seus discípulos: «A messe, na
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              glorificado entre as nações o vosso nome, e que em todo o orbe se
