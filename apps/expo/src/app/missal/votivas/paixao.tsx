        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              allelúja.) <Text className="latin">Ps. 88, 2</Text> Misericórdias
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. 88, 2</Text> De geração em
              geração cantarei eternamente as misericórdias do Senhor.
          ...
          <Language>
            <Text className="latin">
              ...
              déxteram tuam, audíre mereámur: Veníte, benedícti: Qui cum eodem
            ...
            <Text className="vernacular">
              ...
              dia de Juízo, nos encontrarmos colocados à vossa dextra para que
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              dolébunt super eum, ut doléri solet in morte primogéniti. In die
              illa magnus erit planctus in Jerúsalem, et dicétur: Quid sunt
              plagæ istæ in médio mánuum tuárum? Et dicet: His plagátus sum in
              domo eórum, qui diligébant me. Frámea, suscitáre super pastórem
            ...
            <Text className="vernacular">
              ...
              lágrimas e suspiros, como quando se chora um filho único,
              penetrados de dor, como quando se pranteia a morte de um filho
              querido. Nesse dia haverá grande pranto em Jerusalém,
              perguntando-se: «Que chagas são estas no meio das vossas mãos?». E
              Ele responderá: «Com elas fui ferido em casa daqueles que me
              amavam!». Ó espada, que tu sejas desembainhada! Vem contra o meu
              pastor e contra aquele que é meu companheiro, diz o Senhor dos
          ...
          <Language>
            <Text className="latin">
              ...
              et non invéni.<Text className="versicle"> ℣. </Text>Dedérunt in
            ...
            <Text className="vernacular">
              ...
              <Text className="versicle"> ℣. </Text>Deram-me, fel para meu
              alimento: e, quando tinha sede, deram-me vinagre a beber.
            </Text>
            <Text className="latin">
              Allelúja, allelúja.<Text className="versicle"> ℣. </Text>Ave, Rex
              noster: tu solus nostros es miserátus erróres: Patri obǿdiens,
              ductus es ad crucifigéndum, ut agnus mansúetus ad occisiónem.
              Allelúja.
            </Text>
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>Ave, ó
              nosso Rei; só Vós tivestes compaixão de nossos erros. Sendo Vós
          ...
          <Language>
            <Text className="latin">
              ...
              eum quasi leprósum et percússum a Deo et humiliátum.
            ...
            <Text className="vernacular">
              ...
              nossas dores.<Text className="versicle"> ℣. </Text>Nós
              julgávamo-l’O como um leproso, como um homem ferido por Deus e
              humilhado pelos seus castigos.
              <Text className="versicle"> ℣. </Text>Porém Ele, foi ferido por
              causa das nossas iniquidades; foi cheio de dores por causa dos
              nossos crimes.<Text className="versicle"> ℣. </Text>Ele sofreu o
          ...
          <Language>
            <Text className="latin">
              ...
              noster: tu solus nostros es miserátus erróres: Patri obǿdiens,
              ductus es ad crucifigéndum, ut agnus mansúetus ad occisiónem.
              Allelúja.<Text className="versicle"> ℣. </Text>Tibi glória,
            ...
            <Text className="vernacular">
              ...
              nosso Rei; só Vós tivestes compaixão de nossos erros. Sendo Vós
              obediente ao Pai, fostes levado, como manso cordeiro, à
              crucifixão. Aleluia.<Text className="versicle"> ℣. </Text>A Vós
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              (quóniam Parascéve erat), ut non remanérent in cruce córpora
              sábbato (erat enim magnus dies ille sábbati), rogavérunt Pilátum,
              ut frangeréntur eórum crura et tolleréntur. Venérunt ergo mílites:
              et primi quidem fregérunt crura et alteríus, qui crucifíxus est
              cum eo. Ad Jesum autem cum veníssent, ut vidérunt eum jam mórtuum,
              non fregérunt ejus crura, sed unus mílitum láncea latus ejus
            ...
            <Text className="vernacular">
              ...
              esponja no vinagre e, atando-a a um hissope, chegaram-lho à boca.
              E Jesus, havendo tomado o vinagre, disse: «Tudo está consumado!».
              Depois, tendo inclinado a cabeça, expirou. Porém os judeus, para
              que os corpos não ficassem na cruz, no sábado (porque era o dia da
              Preparação, e aquele sábado era dia solene) pediram licença a
              Pilatos que lhes fosse permitido quebrarem-lhes as pernas, e
              tirarem-nos. Vieram então os soldados e quebraram as pernas ao
              primeiro. Depois as do outro que havia sido crucificado com Ele.
              E, tendo vindo ao pé de Jesus e encontrando-O já morto, Lhe não
              quebraram as pernas, mas um dos soldados abriu-Lhe o lado com uma
