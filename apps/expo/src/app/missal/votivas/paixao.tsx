    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          generatiónem et generatiónem. ℣. Gloria Patri...
        </p>
        <p>
          ...
          os nomes. (T. P. Aleluia, aleluia.) <em>Sl. 88, 2</em> De geração em
          geração cantarei eternamente as misericórdias do Senhor. ℣. Glória ao
          Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          invéni. ℣. Dedérunt in escam meam fel, et in siti mea potavérunt me
          acéto.
        </p>
        <p>
          ...
          Procurei quem me consolasse, mas encontrei ninguém. ℣. Deram-me, fel
          para meu alimento: e, quando tinha sede, deram-me vinagre a beber.
        </p>
        <p>
          Allelúja, allelúja. ℣. Ave, Rex noster: tu solus nostros es miserátus
          erróres: Patri obǿdiens, ductus es ad crucifigéndum, ut agnus
          mansúetus ad occisiónem. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. Ave, ó nosso Rei; só Vós tivestes compaixão de
          nossos erros. Sendo Vós obediente ao pai, fostes levado, como manso
          cordeiro, à crucifixão. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          ℣. Ipse autem vulnerátus est propter iníquitates nostras, attrítus est
          propter scélera nostra. ℣. Disciplína pacis nostræ super eum: et
          livóre ejus sanáti sumus.
        </p>
        <p>
          ...
          dos nossos crimes. ℣. Ele sofreu o castigo que nos alcançou a paz:
          fomos curados com seus vergões de sangue.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. Ave, Rex noster: tu solus nostros es miserátus
          erróres: Patri obǿdiens, ductus es ad crucifigéndum, ut agnus
          mansúetus ad occisiónem. Allelúja. ℣. Tibi glória, hosánna: tibi
          triúmphus et victória: tibi summæ laudis et honóris coróna. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. Ave, ó nosso Rei; só Vós tivestes compaixão de
          nossos erros. Sendo Vós obediente ao Pai, fostes levado, como manso
          cordeiro, à crucifixão. Aleluia. ℣. A Vós Senhor, o triunfo e a
