    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          peccatóris.<Text className="versicle"> ℣. </Text>
          Gloria Patri...
        </Text>
        <Text className="vernacular">
          ...
          pecadores.<Text className="versicle"> ℣. </Text>Glória ao Pai...
        </Text>
      </Language>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>Estou oprimido em todo meu
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>Quóniam defécit in dolóre vita
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>Pois a minha vida consome-se no
          meio da dor: e os meus anos em gemidos!
          <Text className="versicle"> ℣. </Text>Minhas forças debilitaram-se por
      ...
      <Language>
        ...
        <Text className="vernacular">
          Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Sl. 101, 2</Text> Senhor, ouvi a minha
          oração: e que meu clamor chegue até Vós. Aleluia.
          <Text className="versicle"> ℣. </Text>
          <Text className="em">Sl. 27, 7</Text> Meu coração teve esperança em
