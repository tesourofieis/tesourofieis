        ...
        <View className="docs">
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              Aleluia, aleluia.) <Text className="vernacular">Sl. 131, 1</Text>{" "}
          ...
          <Language>
            <Text className="latin">
              ...
              similári.<Text className="versicle"> ℣. </Text>
              <Text className="latin">Hebr. 2, 17</Text> Ut miséricors fíeret,
              et fidélis póntifex ad Deum: ut repropitiáret delícta pópuli.
            </Text>
            <Text className="vernacular">
              ...
              Pontífice misericordioso e fiel junto de Deus, para expiar os
              pecados do povo.
            </Text>
            <Text className="latin">
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              vossa santificação.<Text className="versicle"> ℣. </Text>Que os
