    ...
    <div>
      ...
      <div className="side-by-side">
        <p>
          ...
          P. Allelúja, allelúja.) <em>Ps. ibid., 2</em> Deus, áuribus nostris
          audívimus: patres nostri annuntiavérunt nobis. ℣. Gloria Patri...
        </p>
        <p>
          ...
          aleluia.) <em>Sl. ibid., 2</em> Ó Deus, com os nossos ouvidos o
          ouvimos; os nossos pais contaram-nos tudo. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Altíssimo sobre toda a terra. ℣. Tornai-os a todos, ó meu Deus, como
          pó, como uma palha que o torvelinho arrasta pelo caminho.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 79, 3</em> Excita, Dómine, poténtiam
          tuam, et veni: ut salvos fácias nos. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 79, 3</em> Despertai o vosso poder,
      ...
      <div className="side-by-side">
        <p>
          ...
          tuum. ℣. Ne quando dicant gentes: Ubi est Deus eórum? et innotéscat
          in, natiónibus coram óculis nostris. ℣. Víndica sánguinem servórum
          tuórum, qui effúsus est: intret in conspéctu tuo gémitus compeditórum.
        </p>
        <p>
          ...
          Não digam algum dia os povos: onde está o seu Deus? Seja notório aos
          povos e aos nossos olhos. ℣. Vingai o sangue que os vossos servos
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 79, 3</em> Excita, Dómine, poténtiam
          tuam, et veni: ut salvos fácias nos. Allelúja. ℣.{" "}
          <em>ibid., 15-16</em> Deus virtútum, convértere, réspice de cœlo, et
          vide, et vísita víneam istam: et pérfice eam, quam plantávit déxtera
          tua. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 79, 3</em> Despertai o vosso poder,
          Senhor, e vinde para que sejamos salvos. Aleluia. ℣.{" "}
          <em>ibid., 15-16</em> Deus poderoso, volvei-Vos para nós, olhai para
          nós lá do céu, contemplai e visitai esta vinha: defendei esta vinha
          que a vossa mão dextra plantou. Aleluia.
        </p>
      </div>
