  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Eu irei até ao altar de Deus.
        </Text>
        <Text className="latin">
        ...
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Até Deus, que é a alegria da
          minha juventude.
        </Text>
      </Language>
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Julgai-me, ó Deus, e defendei a
        ...
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Pois que Vós, ó Deus, sois a
        ...
        <Text className="latin">
          <Text className="response"> ℟. </Text> Et introíbo ad altáre Dei: ad
          Deum, qui lætíficat juventútem meam.
        </Text>
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> E irei até ao Altar de Deus;
        ...
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Confia em Deus, pois ainda O
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Assim como era no princípio, e
      ...
      <Language>
        ...
        <Text className="latin">
          <Text className="response"> ℟. </Text> Misereátur vestri omnípotens
          Deus, et, dimíssis peccátis vestris, perdúcat vos ad vitam ætérnam.
        </Text>
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Compadeça-se de vós o Senhor
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="cross"> ✠ </Text> omnipotente e misericordioso nos
        ...
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Deus, tu convérsus vivificábis
          nos.
        </Text>
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Ó Deus, volvei-Vos para nós, e
          alcançaremos a vida.
        </Text>
        <Text className="latin">
          <Text className="response"> ℟. </Text> Et plebs tua lætábitur in te.
        </Text>
        <Text className="vernacular">
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Senhor, atendei à minha oração.
        </Text>
        <Text className="latin">
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Senhor, tende piedade de nós.
        </Text>
        <Text className="latin">
          <Text className="versicle"> ℣. </Text> Kýrie eléison.
        </Text>
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Cristo, tende piedade de nós.
        </Text>
        <Text className="latin">
          <Text className="response"> ℟. </Text> Christe eléison.
        </Text>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          Espírito Santo <Text className="cross"> ✠ </Text> na glória de Deus
          Pai.
        </Text>
        <Text className="latin">
          <Text className="response"> ℟. </Text> Amen.
      ...
      <Language>
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>...per ómnia sǽculua sæculórum.
        </Text>
        <Text className="vernacular">
      ...
      <Language>
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Per evangélica dicta deleántur
          nostra delícta.
        </Text>
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Que pelas palavras do Evangelho
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          céus. <Text className="em">(todos se ajoelham).</Text>
        </Text>
        <Text className="latin">
        ...
        <Text className="latin">
          ...
          resurrectiónem mortuórum. Et <Text className="cross"> ✠ </Text> vitam
          ventúri sǽculi.
        </Text>
        <Text className="vernacular">
          ...
          espero a ressurreição dos mortos, e <Text className="cross"> ✠ </Text>{" "}
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="cross"> ✠ </Text> este sacrifício, preparado para a
      ...
      <Language>
        <Text className="latin">
          ...
          Dóminus bene <Text className="cross"> ✠ </Text> dícere, et in odórem
        ...
        <Text className="vernacular">
          ...
          eleitos, abençoar <Text className="cross"> ✠ </Text> este incenso e
          aceitá-lo como odor de suavidade. Por Cristo, Senhor nosso. Amen.
        </Text>
      </Language>

      <Text className="aside">O Sacerdote incensa primeiro as oblatas:</Text>
      ...
      <Language>
        <Text className="latin">
          <Text className="response"> ℟. </Text> Accéndat in nobis Dóminus ignem
          sui amóris, et flammam ætérnæ caritátis. Amen.
        </Text>
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Que o Senhor acenda em nós o
      ...
      <Language>
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Súscipe, sancta Trinitas, hanc
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Recebei, ó Santíssima Trindade,
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Orai, meus irmãos, a fim de que
          meu sacrifício, que é também vosso, seja recebido por Deus Pai
          omnipotente.
        </Text>
        <Text className="latin">
          <Text className="response"> ℟. </Text> Suscípiat Dóminus sacrifícium
          de mánibus tuis ad laudem et glóriam nominis sui, ad utilitátem quoque
          nostram, totiúsque Ecclésiæ suæ sanctæ.
        </Text>
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Que o Senhor receba por vossas
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Demos graças ao Senhor, Nosso
          Deus.
        </Text>
        <Text className="latin">
      ...
      <Language>
        <Text className="latin">
          ...
          benedícas, hæc <Text className="cross"> ✠ </Text> dona, hæc{" "}
        ...
        <Text className="vernacular">
          ...
          <Text className="cross"> ✠ </Text> sacrifícios santos e imaculados Vos
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> tam, rationábilem, acceptabilémque
          fácere dignéris: ut nobis Cor <Text className="cross"> ✠ </Text> pus,
          et San <Text className="cross"> ✠ </Text> guis fiat dilectíssimi Fílii
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> dixit, fregit, dedítque discípulis
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> dixit, dedítque discípulis suis,
        ...
        <Text className="vernacular">
          ...
          <Text className="cross"> ✠ </Text> e deu-o aos seus discípulos
          dizendo:
        </Text>
        <Text className="latin">
          <Text className="latin">
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> puram, hóstiam{" "}
      ...
      <Text className="aside">Profundamente inclinado, o Sacerdote diz:</Text>
      ...
      <Language>
        <Text className="latin">
          ...
          sacrosánctum Fílii tui Cor <Text className="cross"> ✠ </Text> pus, et
          Sán <Text className="cross"> ✠ </Text> guinem sumpsérimus, omni
        ...
        <Text className="vernacular">
          ...
          <Text className="cross"> ✠ </Text> e Sangue{" "}
          <Text className="cross"> ✠ </Text> de vosso Filho sejam repletos de
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> omnipotenti, in unitáte Spíritus{" "}
          <Text className="cross"> ✠ </Text> Sancti, omnis honor, et glória.
        </Text>
        <Text className="vernacular">
          Por Ele <Text className="cross"> ✠ </Text>, com Ele{" "}
          <Text className="cross"> ✠ </Text> e n’Ele{" "}
          <Text className="cross"> ✠ </Text>, a Vós, ó Deus Pai todo-o-poderoso{" "}
          <Text className="cross"> ✠ </Text>, na unidade do Espírito{" "}
          <Text className="cross"> ✠ </Text> Santo, pertence, e Vos é dada, toda
          a honra e glória.
        </Text>
      </Language>
      ...
      <Language>
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Pláceat tibi, sancta Trínitas,
        ...
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Santíssima Trindade, seja-Vos
      ...
      <Language>
        <Text className="latin">
          <Text className="versicle"> ℣. </Text>Benedícat vos omnípotens Deus,
          Pater, et Fílius, <Text className="cross"> ✠ </Text> et Spíritus
          Sanctus.
        </Text>
        <Text className="vernacular">
          <Text className="versicle"> ℣. </Text>Que desça sobre vós a bênção do
          omnipotente Deus: Pai, e Filho, <Text className="cross"> ✠ </Text> e
          Espírito Santo.
        </Text>
        <Text className="latin">
          <Text className="response"> ℟. </Text> Amen.
