...
export default function PageAdv10() {
  return (
    <SafeAreaView className="flex-1">
      <ScrollView>
        <View className="docs">
          <Text className="h1">Primeiro Domingo do Advento</Text>
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">Ps. ibid., 4</Text> Vias tuas, Dómine,
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. ibid., 4</Text> Mostrai-me,
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              induámur arma lucis. Sicut in die honéste ambulémus: non in
              comessatiónibus et ebrietátibus, non in cubílibus et impudicítiis,
            ...
            <Text className="vernacular">
              ...
              Despojemo-nos, pois, das obras das trevas, e revistamo-nos das
              armas da luz. Andemos honestamente, como de dia: nem em excessos
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              exspectatióne, quæ supervénient univérso orbi: nam virtútes
              coelórum movebúntur. Et tunc vidébunt Fílium hóminis veniéntem in
              nube cum potestáte magna et maiestáte. His autem fíeri
              incipiéntibus, respícite et leváte cápita vestra: quóniam
              appropínquat redémptio vestra. Et dixit illis similitúdinem:
              Vidéte ficúlneam et omnes árbores: cum prodúcunt iam ex se
              fructum, scitis, quóniam prope est æstas. Ita et vos, cum
              vidéritis hæc fíeri, scitóte, quóniam prope est regnum Dei. Amen,
            ...
            <Text className="vernacular">
              ...
              susto, na expectativa daquelas coisas que irão acontecer em todo o
              mundo; pois os poderes do céu estremecerão. Então aparecerá o
              Filho do homem, que virá em uma nuvem, revestido de grande poder e
              majestade. Quando estas coisas começarem a acontecer, olhai para o
              alto e erguei as vossas cabeças, porque se avizinha a vossa
              redenção». Depois deu-lhes esta comparação: «Vede a figueira e as
              demais árvores. Quando elas começam a frutificar, por aí conheceis
              que está próximo o estio. Do mesmo modo, quando estas coisas
              acontecerem, sabereis que está próximo o reino de Deus. Em verdade
              vos digo: não acabará esta geração sem que isto aconteça. O céu e
