        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              <Text className="latin">Ps. ibid., 2</Text> Exáudi, Deus,
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              Mártyris tui atque Pontíficis intercéssio gloriósa nos prótegat.
              Per Dóminum...
            </Text>
            <Text className="vernacular">
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              ut, cujus natalítia cólímus, de ejúsdem étiam protectióne
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              ...
              do vosso B. Mártir <Text className="vernacular">N.</Text>, os
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              fructum plus áfferat. Jam vos mundi estis propter sermónem, quem
              locútus sum vobis. Mane te in me: et ego in vobis. Sicut palmes
              non potest ferre fructum a semetípso, nisi mánserit in vite: sic
              nec vos, nisi in me manséritis. Ego sum vitis, vos pálmites: qui
              manet in me, et ego in eo, hic fert fructum multum: quia sine me
              nihil potéstis fácere. Si quis in me non mánserit, mittétur foras
              sicut palmes, et aréscet, et cólligent eum, et in ignem mittent,
            ...
            <Text className="vernacular">
              ...
              limpos em razão da doutrina que vos tenho pregado. Permanecei em
              mim, pois eu permaneço em vós. Assim como a videira não pode dar
              fruto só por si, sem permanecer unida à cepa, assim também não
              podereis vós dar fruto se não permanecerdes unidos a mim. Eu sou a
              cepa da vinha, e vós sois as vides. Aquele que permanece em mim,
              eu permaneço nele, e dará abundante fruto; pois nada podereis
              fazer sem mim. Se alguém não permanecer em mim, será arrancado e
              lançado fora, como uma vide seca. Então secará e levá-la-ão para a
              lançarem no fogo, em que arderá. Se permanecerdes em mim e as
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              ad perpétuum nobis tríbue proveníre subsídium. Per Dóminum...
            </Text>
            <Text className="vernacular">
              Aceitai benigno, Senhor, as hóstias que Vos oferecemos pelos
              méritos do B. <Text className="vernacular">N.</Text>, vosso Mártir
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              ...
              que pela intercessão do B. <Text className="vernacular">N.</Text>,
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              ...
              por intercessão do B. <Text className="vernacular">N.</Text>,
          ...
          <View className="side-by-side">
            <Text className="latin">
              Refécti participatióne múneris sacri, quǽsumus, Dómine, Deus
              noster: ut, cujus exséquimur cultum; intercedénte beáto{" "}
              <Text className="latin">N.</Text> Martyre tuo, sentiámus efféctum.
              Per Dóminum nostrum...
            </Text>
            <Text className="vernacular">
