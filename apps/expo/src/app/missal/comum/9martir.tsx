    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          <Typography className="vernacular">Sl. ibid., 2</Typography> Ouvi, ó
      ...
      <Language>
        <Typography className="latin">
          ...
          propítius; ut, cujus natalítia cólímus, de ejúsdem étiam protectióne
          gaudeámus. Per Dóminum...
        </Typography>
        <Typography className="vernacular">
          Ó Deus, que nos alegrais com a solenidade anual do B.{" "}
          <Typography className="vernacular">N.</Typography> vosso Mártir e
          Pontífice, concedei-nos propício que nos congratulemos com a protecção
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">N.</Typography> Mártyris tui natalítia
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          vosso B. Mártir <Typography className="vernacular">N.</Typography>, os
          nossos corpos sejam livres de todas as adversidades e as nossas almas
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="em">Ps. 20, 4</Typography> Posuísti, Dómine,
        ...
        <Typography className="vernacular">
          ...
          <Typography className="versicle"> ℣. </Typography>
          <Typography className="em">Sl. 20, 4</Typography> Impusestes na sua
          cabeça, Senhor, uma coroa de pedras preciosas. Aleluia.
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          e Pontífice; e dignai-Vos permitir que em virtude delas alcancemos o
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">N.</Typography> Martyre tuo atque
        ...
        <Typography className="vernacular">
          ...
          <Typography className="vernacular">N.</Typography>, vosso Mártir e
          Pontífice, o efeito do mystério, que celebrámos. Por nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          intercessão do B. <Typography className="vernacular">N.</Typography>,
      ...
      <Language>
        <Typography className="latin">
          Refécti participatióne múneris sacri, quǽsumus, Dómine, Deus noster:
          ut, cujus exséquimur cultum; intercedénte beáto{" "}
          <Typography className="latin">N.</Typography> Martyre tuo, sentiámus
        ...
        <Typography className="vernacular">
          ...
          <Typography className="vernacular">N.</Typography>, vosso Mártir, o
