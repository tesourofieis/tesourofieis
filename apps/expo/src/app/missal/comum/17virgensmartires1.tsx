    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          allelúja.) <Text className="latin">Ps. ibid., 1</Text> Beáti
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">N.</Text> Vírginis et Mártyris tuæ natalítia
      ...
      <Language>
        ...
        <Text className="latin">
          ...
          <Text className="latin">ibid., 15 & 16</Text> Adducántur Regi Vírgines
          post eam: próximæ ejus afferéntur tibi in lætítia. Allelúja.
        </Text>
        <Text className="vernacular">
          Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="vernacular">ibid., 15 & 16</Text> Serão apresentadas
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>
          <Text className="em">ibid., 5</Text> Spécie tua et pulchritúdine tua
          inténde, próspere procéde et regna. Allelúja.
        </Text>
        <Text className="vernacular">
          Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Sl. 44, 15 & 16</Text> Após ela, serão
          apresentadas virgens ao Rei: as suas companheiras serão introduzidas
          no meio da alegria. Aleluia.
          <Text className="versicle"> ℣. </Text>
          <Text className="em">ibid., 5</Text> Caminhai, pois, com beleza e com
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          solenidade da B. Virgem <Text className="vernacular">N.</Text>, vossa
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">N.</Text> Vírgine et Mártyre tua, sempitérna
