        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              et in sǽculum sǽculi.<Text className="versicle"> ℣. </Text>Gloria
              Patri...
            </Text>
            <Text className="vernacular">
              ...
              glória, ó Deus, o meu Rei: e abençoarei o vosso Nome agora, sempre
          ...
          <Language>
            <Text className="latin">
              ...
              ante te. Allelúja.<Text className="versicle"> ℣. </Text>
              <Text className="latin">Ps. 115, 15</Text> Pretiósa in conspéctu
              Dómini mors Sanctórum ejus. Allelúja.
            </Text>
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>Vossos
              santos, Senhor, florescerão, como o lírio, e serão, ante Vós, como
              o odor do bálsamo. Aleluia.<Text className="versicle"> ℣. </Text>
