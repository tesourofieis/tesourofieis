        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">Ps. 83, 2-3</Text> Quam dilécta
            ...
            <Text className="vernacular">
              ...
              aleluia.) <Text className="vernacular">Sl. 83, 2-3</Text> Quão
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              do vosso povo e concedei a todos aqueles que entrarem neste
          ...
          <Language>
            <Text className="latin">
              ...
              qui huc deprecatúri convéniunt, ex quacúmque tribulatióne ad te
            ...
            <Text className="vernacular">
              ...
              Templo, vindo habitar nele com vosso poder, e dignai-Vos conceder
              a todos aqueles que nele se reunirem para Vos dirigirem suas
              orações que, em qualquer tribulação em que elevem até Vós os seus
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              Dei cum homínibus, et habitábit cum eis. Et ipsi pópulus ejus
              erunt, et ipse Deus cum eis erit eórum Deus: et abstérget Deus
              omnem lácrimam ab óculis eórum: et mors ultra non erit, neque
            ...
            <Text className="vernacular">
              ...
              dizia: «Eis aqui o tabernáculo de Deus no meio dos homens. O
              Senhor habitará com eles, que serão o seu povo; e o próprio Deus
              permanecerá com eles e será o seu Deus, enxugando-lhes todas as
              lágrimas dos seus olhos. Então já não existirão nem a morte, nem
              as lágrimas, nem os clamores, nem as dores, porque o primeiro
          ...
          <Language>
            <Text className="latin">
              ...
              cui astat Angelórum chorus, exáudi preces servórum tuórum.
            </Text>
            <Text className="vernacular">
              Este lugar foi feito por Deus: ele é um mystério inapreciável e
              isento de qualquer defeito.<Text className="versicle"> ℣. </Text>Ó
              Deus, diante de Quem se prostram os caros dos Anjos, ouvi as
              preces dos vossos servos.
            </Text>
            <Text className="latin">
              Allelúja, allelúja.<Text className="versicle"> ℣. </Text>
              <Text className="latin">Ps. 137, 2</Text> Adorábo ad templum
              sanctum tuum: et confitébor nómini tuo. Allelúja.
            </Text>
            <Text className="vernacular">
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              habita em Jerusalém nunca será abalado.
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">Ps. 137, 2</Text> Adorábo ad templum
              sanctum tuum: et confitébor nómini tuo. Allelúja.
              <Text className="versicle"> ℣. </Text>Bene fundáta est domus
              Dómini supra firmam petram. Allelúja.
            </Text>
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
              <Text className="vernacular">Sl. 137, 2</Text> Adorar-Vos-ei no
              vosso santo Templo: e louvarei o vosso santo Nome.
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              turba, quia statúra pusíllus erat. Et præcúrrens ascéndit in
              arborem sycómorum, ut vidéret eum; quia inde erat transitúrus. Et
              cum venísset ad locum, suspíciens Jesus vidit illum, et dixit ad
              eum: Zachǽe, féstinans descénde; quia hódie in domo tua opórtet me
              manére. Et féstinans descéndit, et excépit illum gaudens. Et cum
              vidérent omnes, murmurábant, dicéntes, quod ad hóminem peccatórem
            ...
            <Text className="vernacular">
              ...
              mas o não conseguia por causa das turbas do povo, pois ele era de
              baixa estatura. Correu, pois, adiante e subiu para um sicómoro,
              para ver Jesus, que devia passar por aquele lugar. Chegando Jesus
              ali, ergueu os olhos e, vendo-o, disse-lhe: «Zaqueu, descei
              depressa, porque me convém hospedar-me hoje em vossa casa».
              Imediatamente Zaqueu desceu e recebeu Jesus com alegria. Vendo as
              pessoas isto, começaram a murmurar, dizendo que Jesus ia
              hospedar-se em casa de um pecador. Entretanto Zaqueu estava
              perante o Senhor e dizia-Lhe: «Senhor, eis que vou dar metade dos
              meus bens aos pobres; e, se defraudei alguém, restituirei o
              quádruplo». Jesus disse então: «Esta casa recebeu hoje a salvação,
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              perfeita, que Vos fazemos, do nosso corpo e da nossa alma; e
