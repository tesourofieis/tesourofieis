        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              nostris méritis non valémus, ejus patrocínio assequámur. Per
              Dóminum nostrum...
            </Text>
            <Text className="vernacular">
              Que a intercessão do B. Abade{" "}
              <Text className="vernacular">N.</Text> nos favoreça junto de Vós,
              Senhor, Vos suplicamos, a fim de que aquilo que não podemos
          ...
          <Language>
            ...
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
              <Text className="vernacular">Sl. 91, 13</Text> O justo florescerá,
              como a palmeira, e multiplicar-se-á, como o cedro do Líbano.
          ...
          <Language>
            <Text className="latin">
              ...
              nobis proveníre depóscat. Per Dóminum...
            </Text>
            <Text className="vernacular">
              Vos imploramos, Senhor, que o vosso santo Abade{" "}
              <Text className="vernacular">N.</Text> nos alcance que a hóstia,
          ...
          <Language>
            <Text className="latin">
              ...
              ut et conversatiónis ejus experiámur insígnia, et intercessiónis
              percipiámus suffrágia. Per Dóminum nostrum...
            </Text>
            <Text className="vernacular">
              Que a recepção do vosso sacramento, Senhor, unida às preces do B.{" "}
              <Text className="vernacular">N.</Text> Abade, nos sirva de
