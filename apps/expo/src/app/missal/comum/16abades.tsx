    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">N.</Text> Abbátis comméndet: ut, quod nostris
          méritis non valémus, ejus patrocínio assequámur. Per Dóminum
          nostrum...
        </Text>
        <Text className="vernacular">
          Que a intercessão do B. Abade <Text className="vernacular">N.</Text>{" "}
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">N.</Text> Abbas, quǽsumus, in salútem nobis
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">N.</Text> Abbas, pro nobis intercedéndo: ut et
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">N.</Text> Abade, nos sirva de protecção,
