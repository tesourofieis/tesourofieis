    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          allelúja.) <em>Ps. 91, 2</em> Bonum est confitéri Dómino: et psállere
          nómini tuo, Altíssime. ℣. Gloria Patri...
        </p>
        <p>
          ...
          (T. P. Aleluia, aleluia.) <em>Sl. 91, 2</em> É bom louvar o Senhor: e
          cantar hinos em honra do vosso nome, ó Altíssimo! ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> minístrum tribuísti: præsta,
        ...
        <p>
          ...
          <span className="text-red-500">N.</span> para ministro da eterna
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          justiça. ℣. A lei do seu Deus está sempre no seu coração e os seus pés
          não tropeçarão.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Eccli. 45, 9</em> Amávit eum Dóminus, et
          ornávit eum: stolam glóriæ índuit eum. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Ecl. 45, 9</em> Amou-o o Senhor e revestiu-o
      ...
      <div className="side-by-side">
        ...
        <p>
          Aleluia, aleluia. ℣. <em>Ecl. 45, 9</em> Amou-o o Senhor, ornou-o e
          revestiu-o com a túnica da glória. Aleluia. ℣. <em>Os. 14, 6</em> O
      ...
      <div className="side-by-side">
        <p>
          Sancti <span className="text-red-500">N.</span> Pontíficis tui at que
        ...
        <p>
          ...
          <span className="text-red-500">N.</span> vosso Pontífice e Doutor, nos
