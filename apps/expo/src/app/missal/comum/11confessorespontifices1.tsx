    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 131, 1</em> Meménto, Dómine, David: et omnis mansuetúdinis
          ejus. ℣. Gloria Patri...
        </p>
        <p>
          ...
          aleluia.) <em>Sl. 131, 1</em> Lembrai-vos de David, ó Senhor, e da sua
          grande mansidão. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          vosso Confessor e Pontífice <span className="text-red-500">N.</span>{" "}
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>ibid., 20</em> Non st invéntus símilis illi, qui conserváret legem
          Excélsi.
        </p>
        <p>
          Eis o grande sacerdote que nos dias da sua vida agradou a Deus. ℣.{" "}
          <em>ibid., 20</em> Não foi encontrado outrem semelhante a ele na
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 109, 4</em> Tu es sacérdos in ætérnum,
          secúndum órdinem Melchísedech. Allelúja. ℣. Hic est sacérdos, quem
          coronávit Dóminus. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 109, 4</em> Tu és sacerdote para sempre
          segundo a ordem de Melquisedeque. Aleluia. ℣. Este é o sacerdote que o
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> Confessóre tuo atque
        ...
        <p>
          ...
          <span className="text-red-500">N.</span>, vosso Confessor e Pontífice,
