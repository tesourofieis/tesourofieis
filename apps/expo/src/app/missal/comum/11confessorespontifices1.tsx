    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          aleluia.) <Text className="vernacular">Sl. 131, 1</Text> Lembrai-vos
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          vosso Confessor e Pontífice <Text className="vernacular">N.</Text>{" "}
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>
          <Text className="latin">ibid., 20</Text> Non st invéntus símilis illi,
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">Ps. 109, 4</Text> Tu es sacérdos in ætérnum,
          secúndum órdinem Melchísedech. Allelúja.
          <Text className="versicle"> ℣. </Text>Hic est sacérdos, quem coronávit
          Dóminus. Allelúja.
        </Text>
        <Text className="vernacular">
          Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Sl. 109, 4</Text> Tu és sacerdote para
          sempre segundo a ordem de Melquisedeque. Aleluia.
          <Text className="versicle"> ℣. </Text>Este é o sacerdote que o Senhor
          coroou. Aleluia.
        </Text>
      </Language>
      ...
      <Language>
        <Text className="latin">
          ...
          exhibéntes, intercedénte beáto <Text className="latin">N.</Text>{" "}
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">N.</Text>, vosso Confessor e Pontífice,
