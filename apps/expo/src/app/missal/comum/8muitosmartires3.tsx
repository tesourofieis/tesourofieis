    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          tribulatiónis. <em>Ps. ibid., 1</em> Noli æmulári in malignántibus:
          neque zeláveris faciéntes iniquitátem. ℣. Gloria Patri...
        </p>
        <p>
          A salvação dos justos, porém, está no Senhor; Ele é o seu refúgio na
          ocasião da tribulação. <em>Sl. ibid., 1</em> Não invejeis os maus, nem
          tenhais emulação daqueles que cometem iniquidades. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> sollemnitáte lætíficas:
        ...
        <p>
          ...
          <span className="text-red-500">N.</span>, concedei-nos benigno que
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          meliórem et manéntem substántiam. Nolíte itaque amíttere! confidéntiam
          vestram, quæ magnam habet remuneratiónem. Patiéntia enim vobis
        ...
        <p>
          ...
          aos maus tratos, e, por outro lado, associados aos que sofreram iguais
          tormentos. Com efeito, vós compartilhastes as agruras dos prisioneiros
          e suportastes com alegria o despojo dos vossos bens, conhecendo que
          uma riqueza maior, que nunca seria arrebatada, vos estava reservada.
          Não percais a confiança que tendes, a qual deve alcançar uma
          recompensa de elevado valor. Com efeito, tendes necessidade de
          perseverança para que, depois de haverdes cumprido a vontade de Deus,
      ...
      <div className="side-by-side">
        ...
        <p>
          Aleluia, aleluia. ℣. O exército cândido dos mártires, ó Senhor, canta
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          ténebris dixístis, in lúmine dicéntur: et quod in aurem locuti estis
          in cubículis, prædicábitur in tectis. Dico autem vobis amícis meis: Ne
          terreámini ab his, qui occídunt corpus, et post hæc non habent ámplius
          quid fáciant. Osténdam autem vobis, quem timeátis: timéte eum, qui,
          postquam occídent, habet potestátem míttere in gehénnam. Ita dico
          vobis: hunc timéte. Nonne quinque pásseres véneunt dipóndio, et unus
          ex illis non est in oblivióne coram Deo? Sed et capílli cápitis vestri
          omnes numerári sunt. Nolíte ergo timére: multis passéribus pluris
        ...
        <p>
          ...
          que dissestes ao ouvido, no recôndito dos vossos cubículos, será
          apregoado sobre os telhados. Digo-vos, porém, a vós, que sois meus
          amigos: não tenhais receio daqueles que matam o corpo e depois não
          podem fazer mais nada. Sabeis a quem deveis temer? Temei aquele que,
          depois de haver dado a morte, tem ainda o poder de lançar no inferno.
          Sim; eu vo-lo digo: temei este. Porventura se não vendem cinco
          pássaros por dois ceitis? Contudo, nem um só deles fica em
          esquecimento diante de Deus! Até os cabelos da vossa cabeça estão
          contados! Não tenhais, pois, receio. Vós valeis mais do que muitos
      ...
      <div className="side-by-side">
        <p>
          ...
          sanctis Martýribus tuis <span className="text-red-500">N.</span> et{" "}
          <span className="text-red-500">N.</span>, a cunctis nos defénde
        ...
        <p>
          ...
          <span className="text-red-500">N.</span>, preservai-nos de todos os
      ...
      <div className="side-by-side">
        <p>
          ...
          sanctis Martýribus tuis <span className="text-red-500">N.</span> et{" "}
          <span className="text-red-500">N.</span>, cœléstis remédii fáciat esse
        ...
        <p>
          ...
          intercessão dos vossos santos Mártires{" "}
          <span className="text-red-500">N.</span>e{" "}
          <span className="text-red-500">N.</span> nos faça participantes do
          remédio celestial. Por nosso Senhor...
        </p>
      </div>

      <aside>Outro Evangelho (para certos dias):</aside>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          dixit eis: Vidéte, ne quis vos sedúcat. Multi enim vénient in nómine
          meo, dicéntes: Ego sum Christus: et multos sedúcent. Auditúri enim
          estis prǿlia et opiniónes prœliórum. Vidéte, ne turbémini. Opórtet
          enim hæc fíeri, sed nondum est finis. Consúrget enim gens in gentem,
          et regnum in regnum, et erunt pestiléntiæ et fames et terræmótus per
          loca. Hæc autem ómnia inítia sunt dolórum. Tunc tradent vos in
          tribulatiónem et occídent vos: et éritis ódio ómnibus géntibus propter
          nomen meum. Et tunc scandalizabúntur multi, et ínvicem tradent, et
        ...
        <p>
          ...
          haverá da vossa vinda e da consumação dos séculos?». Então,
          respondendo, Jesus disse-lhes: «Acautelai-vos, para que ninguém vos
          seduza; pois virão muitos, dizendo: sou Cristo, seduzindo também
          muitas pessoas; ouvireis falar de guerras e de rumores de guerras.
          Tende cuidado em vos não perturbardes, pois convém que tais coisas
          aconteçam; mas isso não será ainda o fim. Levantar-se-á povo contra
          povo e reino contra reino; haverá peste, fome e tremores de terra em
          diversos lugares; mas todas estas coisas serão apenas o começo das
          aflições. Entregar-vos-ão, para sofrerdes tormentos até à morte;
          sereis odiados por todos os povos por causa do meu nome; pelo que
          muitos se deixarão seduzir, se denunciarão e se atraiçoarão uns aos
