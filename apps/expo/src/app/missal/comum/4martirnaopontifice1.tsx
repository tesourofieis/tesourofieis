        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              <Text className="latin">Ps. ibid., 4</Text> Quóniam prævenísti eum
              in benedictiónibus dulcédinis: posuísti in cápite ejus corónam de
              lápide pretióso.<Text className="versicle"> ℣. </Text>Gloria
              Patri...
            </Text>
            <Text className="vernacular">
              ...
              desejava. <Text className="vernacular">Sl. ibid., 4</Text> Com
