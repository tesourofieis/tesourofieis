    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          nomina autem eórum vivent in sǽculum sǽculi. <em>Ps. 32, 1</em>{" "}
        ...
        <p>
          ...
          <em>Sl. 32, 1</em> Ó justos, rejubilai no Senhor: é àqueles que
          possuem o coração recto que pertence louvar o Senhor. ℣. Glória ao
          Pai...
        </p>
      </div>
      <h3>Oração</h3>
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> natalítia cólere: da nobis in
        ...
        <p>
          ...
          dos vossos Santos Mártires <span className="text-red-500">N.</span> e{" "}
          <span className="text-red-500">N.</span>, concedei-nos ainda a graça
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          laço quebrou-se, e ficámos livres. O nosso auxílio está no nome do
          Senhor, que criou o céu e a terra.
        </p>
        <p>
          Allelúja, alielúja. ℣. <em>Ps.67, 4</em> Justi epuléntur, et exsúltent
          in conspéctu Dei: et delecténtur in lætítia. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 67, 4</em> Que os justos se regozijem e
          exultem de alegria na presença de Deus, como em um banquete. Que eles
          se deliciem em transportes de alegria. Aleluia.
        </p>
      </div>
      <aside>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          <span className="text-red-500">N.</span>, dignai-Vos conceder-nos a
