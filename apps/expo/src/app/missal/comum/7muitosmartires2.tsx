        ...
        <View className="docs">
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              séculos! <Text className="vernacular">Sl. 32, 1</Text> Ó justos,
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              <Text className="versicle"> ℣. </Text>O laço quebrou-se, e ficámos
              livres. O nosso auxílio está no nome do Senhor, que criou o céu e
              a terra.
            </Text>
            <Text className="latin">
              Allelúja, alielúja.<Text className="versicle"> ℣. </Text>
              <Text className="latin">Ps.67, 4</Text> Justi epuléntur, et
              exsúltent in conspéctu Dei: et delecténtur in lætítia. Allelúja.
            </Text>
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
              <Text className="vernacular">Sl. 67, 4</Text> Que os justos se
