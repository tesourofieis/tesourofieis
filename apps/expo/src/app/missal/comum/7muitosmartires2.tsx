    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">Sl. 32, 1</Text> Ó justos, rejubilai no
          Senhor: é àqueles que possuem o coração recto que pertence louvar o
          Senhor.<Text className="versicle"> ℣. </Text>
          Glória ao Pai...
        </Text>
      </Language>
      ...
      <Language>
        ...
        <Text className="latin">
          ...
          <Text className="latin">Ps.67, 4</Text> Justi epuléntur, et exsúltent
