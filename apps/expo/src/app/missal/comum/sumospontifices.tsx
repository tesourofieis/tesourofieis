    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          minhas ovelhas. (T. P. Aleluia, aleluia.) <em>Sl. 29, 2</em>{" "}
          Louvar-Vos-ei, Senhor, pois me acolhestes e não permitistes que meus
          inimigos se rissem de mim. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> (Mártyrem tuum atque) Summum
        ...
        <p>
          ...
          <span className="text-red-500">N.</span> (Vosso Mártir e) Sumo
      ...
      <div className="side-by-side">
        <p>
          ...
          beáto <span className="text-red-500">N.</span> (Mártyre tuo atque)
          Summo Pontífice, in tua veritáte persístens, contínua securitáte
          muniátur. Per Dominum...
        </p>
        <p>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          dos anciãos. ℣. Glorifiquem o Senhor pelas suas misericórdias: e pelas
          suas maravilhas em favor dos filhos dos homens.
        </p>
        <p>
      ...
      <div className="side-by-side">
        <p>
          ...
          prohibébo: Dómine, tu scisti. ℣. Justítiam tuam non abscóndi in corde
          meo: veritátem tuam et salutáre tuum dixi. ℣. Non abscóndi
          misericórdiam tuam, et veritátem tuam a concílio multo.
        </p>
        <p>
          Anunciei a vossa justiça numa grande assembleia: eis, pois, que não
          cerrareis os meus lábios, Senhor, bem o sabeis. ℣. Não encerrei a
          vossa justiça no meu coração; mas publiquei a vossa verdade e
          salvação. ℣. Não ocultei a vossa misericórdia e fidelidade diante da
          grande assembleia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Matth. 16, 18</em> Tu es Petrus, et super
          hanc petram ædificábo Ecclésiam meam. Allelúja. ℣.{" "}
          <em>Ps. 44, 17, 18</em> Constítues eos príncipes super omnem terram:
          mémores erunt nóminis tui, Dómine. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Mt. 16, 18</em> Tu és Pedro, e sobre esta
          pedra edificarei a minha Igreja. Aleluia. ℣. <em>Sl. 44, 17, 18</em>{" "}
          Vós os constituístes príncipes em toda a terra: e eles perpetuarão,
          Senhor, o vosso nome. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span>, Ecclésia tua et fídei
        ...
        <p>
          ...
          <span className="text-red-500">N.</span>, a vossa. Igreja se alegre
          com a integridade da sua fé e sempre exulte com a tranquilidade dos
      ...
      <div className="side-by-side">
        <p>
          ...
          dedísti: ut beáti <span className="text-red-500">N.</span> (Martyris
          tui atque) Summi Pontíficis deprecatióne nec pastóri obœdiéntia gregis
          nec gregi desit cura pastóris. Per Dóminum...
        </p>
        <p>
          Senhor, Vos suplicamos, multiplicai na vossa Igreja o espírito da
          graça, que lhe concedestes, a fim de que, pela oração do
          bem-aventurado <span className="text-red-500">N.</span> (Vosso Mártir
          e) Sumo Pontífice, não falte ao pastor a obediência do rebanho, nem ao
