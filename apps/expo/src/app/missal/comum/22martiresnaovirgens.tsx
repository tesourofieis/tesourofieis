    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          caminhos e que cumprem a Lei do Senhor. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> Martyris tuæ natalítia
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          adjútor. Et liberásti me secúndum multitúdinem misericórdiæ nóminis
          ...
          altitúdine ventris ínferi, et a lingua coinquináta, et a verbo
        ...
        <p>
          ...
          da língua iníqua e dos lábios daqueles que tramam a mentira; e na
          ...
          prestes a devorar-me; das mãos dos que procuravam tirar-me a vida; e
          das aflições, que me cercavam. Livrastes-me da violência das chamas,
          que me cercavam, no meio das quais não senti o calor do fogo.
          Livrastes-me do abysmo profundo do inferno; da língua impura; das
          palavras mentirosas; do rei iníquo e da língua injusta. Minha alma
      ...
      <div className="side-by-side">
        <p>
          ...
          proptérea unxit te Deus, Deus tuus, óleo lætítiae præ consórtibus
          tuis. ℣. Spécie tua et pulchritúdine tua inténde, próspere procéde et
          regna.
        </p>
        <p>
          Vinde, ó esposa de Cristo; vinde e recebei a coroa que o Senhor
          preparou para vós, para a eternidade. Foi por amor dele que
          derramastes o vosso sangue. ℣. <em>Sl. 44, 8 et 5</em> Amastes a
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          com majestade; ide gozar a vitória e reinai. Aleluia. ℣. Por causa da
          vossa verdade, mansidão e justiça, a vossa dextra operará admiráveis
          prodígios. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> Martyris tuæ sollemnitáte
        ...
        <p>
          ...
          solenidade da vossa B. Mártir <span className="text-red-500">N.</span>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="text-red-500">N.</span> Mártyre tua, sempitérna
