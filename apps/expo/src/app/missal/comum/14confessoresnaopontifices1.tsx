...
export default function Page14Confessoresnaopontifices1() {
  return (
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          Deus, qui nos beáti <Text className="latin">N.</Text> Confessóris tui
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>Glória et divitiæ in domo ejus:
      ...
      <Text className="aside">No T. Pascal o Gradual e o Trato e diz-se:</Text>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="em">Eccli. 45, 9</Text> Amávit eum Dóminus et ornávit
