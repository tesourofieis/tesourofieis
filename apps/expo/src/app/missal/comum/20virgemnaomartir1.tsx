        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              gaudémus; ita piæ devotiónis erudiámur afféctu. Per Dóminum
              nostrum...
            </Text>
            <Text className="vernacular">
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">ibid., 15 & 16</Text> Após ela, serão
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">ibid., 13 et 10</Text> Vultum tuum
              ...
              <Text className="versicle"> ℣. </Text>Afferéntur in lætítia et
            ...
            <Text className="vernacular">
              ...
              <Text className="versicle"> ℣. </Text>
              <Text className="vernacular">ibid., 13 et 10</Text> Todos os
              poderosos da terra implorarão os vossos olhares: e as filhas dos
          ...
          <Language>
            ...
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
              <Text className="vernacular">Sl. 44, 15 et 16</Text> Após ela,
