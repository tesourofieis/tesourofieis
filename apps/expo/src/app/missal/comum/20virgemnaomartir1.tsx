    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          allelúja.) <Text className="latin">Ps. ibid., 2</Text> Eructávit cor
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>Propter veritátem et
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="em">ibid., 15-16</Text> Adducéntur Regi Vírgines post
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>
          <Text className="vernacular">ibid., 13 et 10</Text> Todos os poderosos
          da terra implorarão os vossos olhares: e as filhas dos reis formam a
          vossa corte de glória.
          <Text className="versicle"> ℣. </Text>
          <Text className="em">ibid., 15-16</Text> Depois de vós, virão coros de
      ...
      <Language>
        ...
        <Text className="vernacular">
          Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Sl. 44, 15 et 16</Text> Após ela, serão
          apresentadas virgens ao Rei: as suas companheiras serão introduzidas
          no meio da alegria. Aleluia.
          <Text className="versicle"> ℣. </Text>
