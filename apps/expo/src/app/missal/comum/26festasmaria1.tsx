        ...
        <View className="docs">
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              céu e a terra em todos os séculos dos séculos. (T. P. Aleluia,
              aleluia) <Text className="vernacular">Sl. 44, 2</Text> Meu coração
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              ministério; e deste modo tenho habitação fixa em Sião. Ele
              deixa-me descansar na cidade santa e tenho poder em Jerusalém.
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              que nem todo o universo é capaz de conter, esteve encerrado,
              quando se fez homem, no vosso seio.
            </Text>
            <Text className="latin">
              Allelúja, allelúja.<Text className="versicle"> ℣. </Text>Post
              partum, Virgo, invioláta perí mansisti: Dei Génetrix, intercéde
              pro nobis. Allelúja.
            </Text>
            <Text className="vernacular">
          ...
          <Language>
            <Text className="latin">
              ...
              dictis credidísti.<Text className="versicle"> ℣. </Text>Dum Virgo
              Deum et hóminem genuísti: et post partum, Virgo, invioláta
              permansísti.<Text className="versicle"> ℣. </Text>
              Dei Génetrix, intercéde pro nobis.
            </Text>
            <Text className="vernacular">
              Regozijai-vos, ó Virgem Maria, pois só vós fostes capaz de
              destruir todas as heresias.<Text className="versicle"> ℣. </Text>
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              floresceu: a Virgem deu à luz do mundo o Homem-Deus: restabeleceu
              Deus a paz, reconciliando na sua pessoa a nossa baixeza com a
              suprema grandeza. Aleluia. <Text className="em">Lc. 1, 28</Text>{" "}
