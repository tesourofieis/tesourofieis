    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          actiónis gravat, beáti <Text className="latin">N.</Text> Martyris tui
        ...
        <Text className="vernacular">
          ...
          gloriosa intercessão do B. <Text className="vernacular">N.</Text>,
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>O inimigo nada poderá contra ele
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          merecimentos do B. <Text className="vernacular">N.</Text>, vosso
