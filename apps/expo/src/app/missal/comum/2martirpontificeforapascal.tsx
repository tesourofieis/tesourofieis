        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              Martyris tui atque Pontíficis intercéssio gloriósa nos prótegat.
              Per Dóminum...
            </Text>
            <Text className="vernacular">
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              ...
              mão o auxiliará e o meu braço o fortificará.
              <Text className="versicle"> ℣. </Text>O inimigo nada poderá contra
