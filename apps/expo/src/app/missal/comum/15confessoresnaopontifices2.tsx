    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          allelúja.) <Text className="latin">Ps. ibid., 2</Text> Bonum est
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          do vosso B. Confessor <Text className="vernacular">N.</Text>, a fim de
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>A lei do seu Deus está no seu
      ...
      <Language>
        <Text className="latin">
          ...
          intercedénte beáto <Text className="latin">N.</Text> Confessóre tuo,
