        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              peccátis nostris. (T. P. Allelúja.)
            </Text>
            <Text className="vernacular">
              <Text className="vernacular">Ant.</Text> Não Vos recordeis,
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              nós. Cristo, tende piedade de nós. Senhor, tende piedade de nós.
            </Text>
            <Text className="latin">
              Pater noster... (secreto usque ad)
              <Text className="versicle"> ℣. </Text>Et ne nos indúcas in
              tentatiónem. <Text className="response"> ℟. </Text> Sed líbera nos
              a malo.
            </Text>
            <Text className="vernacular">
              Pai-nosso... (em silêncio).<Text className="versicle"> ℣. </Text>E
              não nos deixeis cair em tentação.{" "}
              <Text className="response"> ℟. </Text> Mas livrai-nos do mal.
            </Text>
            <Text className="latin">
              <Text className="versicle"> ℣. </Text>Ego dixit: Dómine, miserére
              mei. <Text className="response"> ℟. </Text> Sana ánimam meam, quia
              peccávi tibi.
            </Text>
            <Text className="vernacular">
              <Text className="versicle"> ℣. </Text>Eu disse: Senhor, tende
              piedade de mim. <Text className="response"> ℟. </Text> Curai a
              minha alma, pois pequei contra Vós.
            </Text>
            <Text className="latin">
            ...
            <Text className="vernacular">
              <Text className="versicle"> ℣. </Text>Senhor, volvei-Vos um pouco
              para nós. <Text className="response"> ℟. </Text> Enchei-Vos de
              piedade para com vossos servos.
            </Text>
            <Text className="latin">
              <Text className="versicle"> ℣. </Text>Fiat misericórdia tua,
              Dómine, super nos. <Text className="response"> ℟. </Text>{" "}
              Quemádmodum sperávimus in te.
            </Text>
            <Text className="vernacular">
              <Text className="versicle"> ℣. </Text>Senhor, venha a nós a vossa
              misericórdia. <Text className="response"> ℟. </Text> Pois
              esperamos em Vós.
            </Text>
            <Text className="latin">
            ...
            <Text className="vernacular">
              ...
              faltas ocultas. <Text className="response"> ℟. </Text> E perdoai
              ao vosso servo as faltas alheias.
            </Text>
            <Text className="latin">
