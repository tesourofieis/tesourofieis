  ...
  return (
    <PageWrapper>
      ...
      <Text className="text-base">
        ...
        que mais Vos agrada: isto é, amar-Vos, servir-Vos e obedecer sempre à
        vossa lei e vontade. Ó Deus, que sois o meu amor, tomai posse de mim e
        enchei o meu coração com um amor fiel, generoso e heróico para convosco.
        Eu me ofereço todo a Vós: o corpo, para que seja casto; a alma, para que
        seja pura; o coração, para que Vos ame sempre. Senhor, deste-Vos todo
        inteiro a mim! Pois eu me dou, também, todo a Vós. Assim é justo. Deste
        modo, eu me sujeito completamente a Vós, amando-Vos e obedecendo-Vos. E,
        agora, Senhor, quero recordar-me destas palavras que um dia dissestes:
        «Pedi e recebereis». Senhor, neste momento em que estais em mim,
        dignai-Vos espalhar no meu íntimo a abundância dos vossos dons, para
