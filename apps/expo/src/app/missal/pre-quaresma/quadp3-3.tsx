      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="aside">
            ...
            essa igreja, outrora o Papa se dirigia descalço para inaugurar a
            milícia cristã dos santos jejuns da Quaresma, em que lutamos contra
            os espíritos maus com a arma da abstinência. Era uma das 25
            paróquias romanas do século V. A exemplo dos Ninivitas, que fizeram
            penitência na cinza e no cilício, a Igreja, a fim de humilhar o
            nosso orgulho e lembrar-nos a sentença de morte que devemos sofrer
            em consequência do pecado, coloca hoje sobre nossas cabeças um pouco
            de cinzas, dizendo-nos: 'Lembra-te, ó homem, que és pó e que em pó
            te hás de tornar.' Viemos do pó e a ele voltaremos, eis com que
            abateremos o nosso orgulho. Isto são vestígios da antiga cerimónia
            de que nos fala o Pontifical Romano. Os cristãos culpados de faltas
            graves deviam submeter-se à penitência pública. Na Quarta-feira de
            Cinzas o Pontífice benzia os cilício que eles deviam trazer durante
            a santa Quarentena e impunha-lhes as cinzas feitas das palmas que
            haviam servido na procissão do Domingo de Ramos do ano anterios. Em
            seguida cantando os fiéis os sete salmos penitênciais expulsava-se
            do lugar santo os penitentes por causa dos seus pecados, assim como
            Adão, o primeiro homem, havia sido expulso do paraíso, devido à sua
            desobediência. Somente na Quinta-feira Santa depunham eles as vestes
            de penitência e entravam de novo na igreja; depois de ter obtido a
            sua reconciliação pelo labor da penitência quaresmal, a confissão e
            a absolvição sacramental. O Papa Urbano VI no Concílio de Benevento
            prescreveu que as cinzas fossem impostas nos simples fiéis.
            Recebamos, pois, as Cinzas e recebamo-las em espírito de humildade e
            penitênciam, a fim de que este poderoso sacramental nos obtenha de
            Deus as graças imploradas pela Igreja ao benze-las. Deus perdoa, com
            efeito, os pecados dos homens em atenção ao seu arrependimento. É
            rico em bondade para com os que se convertem a Ele de todo o
            coraçao, no jejum, nas lágrimas e nos gemidos. Não devemos, na
            verdade rasgar as nossas vestes, em sinal de dor, como faziam os
            Fariseus, e sim os nossos corações, pois, não é aos homens que
            devemos tomar por testemunhas de nossos jejuns, e sim nosso Pai que
            vê no segredo de nossas almas e no-lo restriibuirá, diz Jesus no
          ...
          <Language>
            <Text className="latin">
              ...
              qui bene <Text className="cross"> ✠ </Text> dícat et sanctí{" "}
              <Text className="cross"> ✠ </Text> ficet hos cíneres, ut sint
              remédium salúbre ómnibus nomen sanctum tuum humilíter
              ...
              deplorántibus, vel sereníssimam pietátem tuam supplíciter
              obnixéque flagitántibus: et præsta per invocatiónem sanctíssimi
            ...
            <Text className="vernacular">
              ...
              para abençoar <Text className="cross"> ✠ </Text> e santificar{" "}
              <Text className="cross"> ✠ </Text> estas Cinzas, a fim de que
              sejam remédio salutar para todos os que imploram humildemente o
              vosso santo nome, e, reconhecendo os seus delitos, a si mesmos se
              acusam, deplorando esses crimes, diante da vossa divina clemência,
              e suplicando instante e humildemente a vossa compassiva
              misericórdia. Dignai-Vos permitir que pela invocação do vosso
              santíssimo nome todos os que com estas Cinzas forem aspergidos
              alcancem, além da remissão dos pecados, saúde para o corpo e
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="cross"> ✠ </Text> dícere pro tua pietáte dignáre:
              ut, qui nos cínerem esse, et ob pravitátis nostræ deméritum in
              púlverem reversúros cognóscimus; peccatórum ómnium véniam, et
              prǽmia pæniténtibus repromíssa, misericórditer cónsequi mereámur.
            ...
            <Text className="vernacular">
              ...
              <Text className="cross"> ✠ </Text> estas Cinzas, que desejamos
              sejam impostas nas nossas cabeças em sinal de humildade e para
              merecermos o perdão, a fim de que, reconhecendo que não somos
              senão cinza e que nos tornaremos em pó em punição da nossa
              malícia, mereçamos da vossa bondade alcançar o perdão dos nossos
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              Cinzas, a graça da vossa bênção; e, enchendo-os com o espírito de
          ...
          <Language>
            <Text className="latin">
              ...
              tui, Dómine, líbera nos. Atténde, Dómine.
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. 56, 2</Text> Tende piedade de
              mim, pois em Vós procura refúgio a minha alma.
              <Text className="versicle"> ℣. </Text>
              Glória ao Pai...
            </Text>
          </Language>
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              quia benígnus et miséricors est, pátiens, et multæ misericórdiæ,
              et præstábilis super malítia. Quis scit, si convertátur, et
              ignóscat, et relínquat post se benedictiónem, sacrifícium et
              libámen Dómino, Deo vestro? Cánite tuba in Sion, sanctificáte
              jejúnium, vocáte cœtum, congregáte pópulum, sanctificáte
              ecclésiam, coadunáte senes, congregáte parvulos et sugéntes úbera:
              egrediátur sponsus de cubíli suo, et sponsa de thálamo suo. Inter
              vestíbulum et altare plorábunt sacerdótes minístri Dómini, et
              dicent: Parce, Dómine, parce pópulo tuo: et ne des hereditátem
              tuam in oppróbrium, ut dominéntur eis natiónes. Quare dicunt in
              pópulis: Ubi est Deus eórum? Zelátus est Dóminus terram suam, et
              pepércit pópulo suo. Et respóndit Dóminus, et dixit populo suo:
              Ecce, ego mittam vobis fruméntum et vinum et óleum, et replebímini
            ...
            <Text className="vernacular">
              ...
              benigno, clemente, paciente, compassivo, cheio de misericórdia e
              cuja bondade excede a malícia humana. Quem sabe se Ele não
              retrocederá e não se arrependerá, não deixando após si uma bênção
              para apresentardes como oferta de sacrifício ao Senhor, nosso
              Deus?! Tocai a trombeta em Sião; ordenai que jejuem; convocai uma
              assembleia; chamai o povo; publicai uma reunião santa; reuni os
              velhos; congregai os meninos, ainda mesmo os que bebem o leite
              maternal; o marido saia do seu quarto e a esposa do seu leito
              nupcial. Que os sacerdotes, ministros do Senhor, chorem entre o
              vestíbulo e o altar e digam: «Perdoai, Senhor, perdoai ao vosso
              povo; não deixeis a vossa herança cair no opróbrio para servir de
              troça às nações estrangeiras»! Pois dir-se-á entre os povos: «Onde
              está o Deus deste povo? O Senhor compadeceu-se da sua terra e
              perdoou ao povo». Respondeu, então, o Senhor e disse ao seu povo:
              «Eis que vos mandarei trigo, vinho e azeite, e ficareis saciados;
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              a minha alma confia em Vós.<Text className="versicle"> ℣. </Text>
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              recepérunt mercédem suam. Tu autem, cum jejúnas, unge caput tuum,
              et fáciem tuam lava, ne videáris homínibus jejúnans, sed Patri
              tuo, qui est in abscóndito: et Pater tuus, qui videt in
              abscóndito, reddet tibi. Nolíte thesaurizáre vobis thesáuros in
              terra: ubi ærúgo et tínea demólitur: et ubi fures effódiunt et
              furántur. Thesaurizáte autem vobis thesáuros in cœlo: ubi neque
            ...
            <Text className="vernacular">
              ...
              Na verdade vos digo: já receberam a sua recompensa. Porém, quando
              jejuardes, perfumai a cabeça e lavai o rosto, para que não pareça
              aos homens que jejuais, mas sim a vosso Pai, que conhece todas as
              coisas ocultas; e, conhecendo esse segredo, vos dará a recompensa.
              Não guardeis tesouros na terra, onde a traça e a ferrugem os
              gastam e os ladrões esburacam a parede e os roubam. Guardai antes
              vossos tesouros no céu, onde nem a ferrugem nem a traça os
