...
export default function PageQuadp34() {
  return (
    <PageWrapper>
      <Text className="h1">Quinta-feira depois das Cinzas</Text>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">Ps. ibid., 2-3</Text> Exáudi, Deus, oratiónem
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">Sl. ibid., 2-3</Text> Ouvi, ó Deus, a
