...
export default function PageQuadp34() {
  return (
    <div className="docs">
      <h1>Quinta-feira depois das Cinzas</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 2-3</em> Exáudi, Deus, oratiónem meam, et ne despéxeris
          deprecatiónem meam: inténde mihi et exáudi me. ℣. Gloria Patri...
        </p>
        <p>
          Quando invoquei o Senhor, ouviu Ele a minha voz e livrou-me daqueles
          ...
          cuidados, pois Ele providenciará. <em>Sl. ibid., 2-3</em> Ouvi, ó
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          ouvi propício as preces do vosso povo suplicante e afastai os flagelos
          da vossa ira, que merecemos pelos nossos pecados. Por nosso Senhor...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          In diébus illis: Ægrotávit Ezechías usque ad mortem: et introívit ad
          eum Isaías fílius Amos Prophéta, et dixit ei: Hæc dicit Dóminus:
          Dispóne dómui tuæ, quia moriéris tu, et non vives. Et convértit
          Ezechías fáciem suam ad paríetem, et orávit ad Dóminum, et dixit:
          Obsecro, Dómine, meménto, quæso, quómodo ambuláverim coram te in
          veritáte et in corde perfécto, et, quod bonum est in óculis tuis,
          fécerim. Et flevit Ezechías fletu magno. Et factum est verbum Dómini
          ad Isaíam, dicens: Vade, et dic Ezechíæ: Hæc dicit Dóminus, Deus David
          patris tui: Audívi oratiónem tuam, et vidi lácrimas tuas: ecce, ego
          adjíciam super dies tuos quíndecim annos: et de manu regis Assyriórum
          éruam te et civitátem istam, et prótegam eam, ait Dóminus omnípotens.
        </p>
        <p>
          Naqueles dias, Ezequias foi atacado de doença mortal. Então, o Profeta
          Isaías, filho de Amós, veio ter com ele e disse-lhe: «Isto diz o
          Senhor: «Dispõe os negócios da tua casa, porque morrerás e não
          viverás». Ezequias voltou o rosto para a parede e dirigiu esta oração
          ao Senhor: «Lembrai-Vos, Senhor, Vos suplico, de que tenho caminhado
          na vossa presença com a verdade e com o coração íntegro e tenho
          praticado o que é agradável a vossos olhos». Depois, Ezequias chorou
          amargamente. Então o Senhor falou a Isaías nestes termos: «Ide e dizei
          a Ezequias: Isto diz o Senhor, Deus de David, vosso Pai: Ouvi a vossa
          oração e vi as vossas lágrimas; eis que acrescentarei ainda a vossa
          vida com quinze anos e vos livrarei, e a esta terra, do jugo do rei da
          Assíria e a protegerei»: diz o Senhor omnipotente.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Fac hoc, et facit. Audiens autem Jesus, mirátus est, et sequéntibus se
          dixit: Amen, dico vobis, non invéni tantam fidem in Israël. Dico autem
          vobis, quod multi ab Oriénte et Occidénte vénient, et recúmbent cum
          Abraham et Isaac et Jacob in regno cœlórum: fílii autem regni
        ...
        <p>
          ...
          assim como acreditaste, assim acontecerá». E naquela hora o servo foi
          curado.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          Elevei a minha alma até Vós, Senhor, meu Deus: tenho confiança em Vós:
          não serei confundido; não permitireis que meus inimigos zombem de mim,
          porque todos aqueles que esperam em Vós, não serão confundidos.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          Senhor, Vos suplicamos, olhai benigno para o presente sacrifício, a
          fim de que sirva para aumento da nossa devoção e para a nossa
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          suplicamos, Deus omnipotente, que este mesmo dom seja para nós motivo
          de satisfação e de salvação. Por nosso Senhor...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          merecidamente com os flagelos, possa, enfim, respirar, bafejado pela
