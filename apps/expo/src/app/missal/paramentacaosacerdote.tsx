...
export default function PageParamentacaosacerdote() {
  return (
    <PageWrapper>
      <H1 text="Paramentação do Sacerdote" />
      <H1 text="Ao lavar as mãos" />
      ...
      <H1 text="Ao manípulo" />
      <Typography className="vernacular">
        Permiti, Senhor, que possa envergar a insígnia das lágrimas e das dores,
        a fim de que receba com alegria a recompensa do meu trabalho.
      </Typography>
      <H1 text="À estola" />
      <Typography className="vernacular">
