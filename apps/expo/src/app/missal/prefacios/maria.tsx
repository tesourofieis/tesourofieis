    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          - na Apresentação; Visitatióne - na Visitação; Anuntiatióne - na
          Anunciação; Nativitáte - na Natividade; Festa das Dores diz-se:
          Transfixióne - na transfixão; Festa de N. S. do Monte Carmelo:
          Solemnitáte - na Solenidade; Missas Votivas diz-se: Veneratióne - em
          Veneração.) beátæ Maríæ semper Vírginis collaudáre, benedícere et
          ...
          effúdit, Jesum Christum, Dóminum nostrum. Per quem majestátem tuam
        ...
        <p>
          ...
          Maria, sempre Virgem. Foi ela quem concebeu o vosso Filho Unigénito
          por obra do Espírito Santo, e, sem a mais leve perda de glória da
          virgindade, deu ao mundo a Luz eterna, Jesus Cristo, nosso Senhor, por
          quem os Anjos louvam a vossa majestade, as Dominações a adoram, as
          Potestades a reverenciam, os Céus, as Virtudes dos céus e os
