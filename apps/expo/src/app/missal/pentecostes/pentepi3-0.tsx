    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          vós próprios, caríssimos, mas deixai a justiça de Deus, pois está
          escrito: «A vingança pertence-me; Eu é que a exercerei, diz o Senhor».
          Se o vosso inimigo tem fome, dai-lhe de comer; se tem sede, dai-lhe de
          beber; pois, se assim procederdes, reunireis brasas de fogo sobre a
          sua cabeça. Não vos deixeis vencer pelo mal; mas triunfai do mal,
          praticando o bem.
        </Text>
      </Language>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          nos odiavam. Glorificar-nos-emos constantemente em Deus e louvaremos
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          «Senhor, se quiserdes, podeis curar-me». Então Jesus, estendendo a
          mão, tocou-o e disse: «Quero; sê curado». E no mesmo instante ficou
          limpo da lepra. E Jesus disse-lhe: «Ouve: não digas nada a ninguém;
          mas vai, mostra-te aos sacerdotes e oferece-lhes a dádiva que Moisés
          prescreveu, a fim de que ela seja testemunha da tua cura». E entrando
          Jesus em Cafarnaum, aproximou-se d’Ele um centurião, pedindo e
          dizendo: «Senhor, o meu servo está na cama paralítico e sofre
          cruelmente». E Jesus disse-lhe: «Eu irei e o curarei». Mas o centurião
          ...
          faz». Ouvindo Jesus isto, mostrou-se admirado, e disse: «Em verdade
          vos digo, que não encontrei, ainda, uma fé tão grande em Israel! Assim
          vos digo: que muitos virão do Oriente e do Ocidente e terão lugar no
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          augustos mystérios, tornai-nos dignos, Vos suplicamos, de receberdes
