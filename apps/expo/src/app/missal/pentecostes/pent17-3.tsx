    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">Ps 80:6</Text> Testimónium in Joseph pósuit
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">Sl 80:6</Text> O Senhor impôs este
          preceito a José, quando saía do Egipto, onde ouvia uma língua que não
          compreendia.<Text className="versicle"> ℣. </Text>
          Glória ao Pai...
        </Text>
      </Language>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>Ele livra o indigente da lama e
