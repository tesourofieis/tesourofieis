    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          tuo: cantábo Dómino, qui bona tríbuit mihi. <em>Ps. ib., 1</em>{" "}
          Usquequo, Dómine, oblivísceris me in finem? usquequo avértis fáciem
          tuam a me? ℣. Gloria Patri...
        </p>
        <p>
          ...
          benefícios. <em>Ps. ib., 1</em> Até quando, Senhor, Vos esquecereis de
          mim? Esquecer-me-eis para sempre? Até quando afastareis de mim a vossa
          face? ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          pequei contra Vós. ℣. Bem-aventurado aquele que pensa no pobre e no
          miserável, pois o Senhor o livrará no dia mau.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 5, 2</em> Verba mea áuribus pércipe,
          Dómine: intéllege clamórem meum. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 5, 2</em> Atendei às minhas palavras,
