        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              invocántibus te. <Text className="latin">Ps. ibid., 1</Text>{" "}
              Inclína, Dómine, aurem tuam mihi, et exáudi me: quóniam inops, et
              pauper sum ego.<Text className="versicle"> ℣. </Text>Gloria
              Patri...
            </Text>
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              cœlis et in terra nominátur, ut det vobis secúndum divítias glóriæ
              suæ, virtúte corroborári per Spíritum ejus in interiórem hóminem,
              Christum habitáre per fidem in córdibus vestris: in caritáte
              radicáti et fundáti, ut póssitis comprehéndere cum ómnibus
              sanctis, quæ sit latitúdo et longitúdo et sublímitas et profúndum:
              scire etiam supereminéntem sciéntiæ caritátem Christi, ut
              impleámini in omnem plenitúdinem Dei. Ei autem, qui potens est
              ómnia fácere superabundánter, quam pétimus aut intellégimus,
            ...
            <Text className="vernacular">
              ...
              princípio desta grande família no céu e na terra, para que segundo
              as riquezas da sua glória sejais fortificados pelo seu Espírito e
              revestidos com a graça de homens interiores, para que Jesus Cristo
              habite pela fé nos vossos corações, e que, enraizados e imbuídos
              na caridade, possais compreender com todos seus santos a largura,
              o comprimento, a altura e a profundidade deste mystério, e
              conhecer o amor de Cristo, o qual ultrapassa toda a ciência, a fim
              de que sejais repletos da plenitude dos dons de Deus. Que Aquele
              que é poderoso, e que, por isso, pode fazer infinitamente mais do
              que Lhe pedimos, ou mesmo pensamos, segundo a virtude que opera em
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              ...
              Pois o Senhor edificou Sião, onde fará resplandecer a sua
              majestade.
            </Text>
            <Text className="latin">
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              dixit ad legisperítos et pharisǽos, dicens: Si licet sábbato
              curáre? At illi tacuérunt. Ipse vero apprehénsum sanávit eum ac
              dimísit. Et respóndens ad illos, dixit: Cujus vestrum ásinus aut
              bos in púteum cadet, et non contínuo éxtrahet illum die sábbati?
              Et non póterant ad hæc respóndere illi. Dicebat autem et ad
              invitátos parábolam, inténdens, quómodo primos accúbitus
              elígerent, dicens ad illos: Cum invitátus fúeris ad núptias, non
              discúmbas in primo loco, ne forte honorátior te sit invitátus ab
              illo, et véniens is, qui te et illum vocávit, dicat tibi: Da huic
              locum: et tunc incípias cum rubóre novíssimum locum tenére. Sed
              cum vocátus fúeris, vade, recúmbe in novíssimo loco: ut, cum
              vénerit, qui te invitávit, dicat tibi: Amíce, ascénde supérius.
            ...
            <Text className="vernacular">
              ...
              hidrópico, Então Jesus tomou a palavra e perguntou aos doutores da
              Lei e aos fariseus: «É permitido curar os enfermos ao sábado?».
              Eles se calaram. E Jesus tocou neste homem, curou-o e mandou-o
              embora. Depois, dirigindo-se aos outros, continuou: «Qual é de vós
              aquele que, se o seu boi ou o seu jumento cai em um poço no dia de
              sábado, o não retira logo, mesmo nesse dia?». Eles não puderam
              responder-Lhe. Ainda Jesus, notando que os convivas escolhiam os
              principais lugares à mesa, disse: «Quando vos convidarem para
              assistirdes às bodas, não procureis o primeiro lugar, pois pode
              acontecer que, tendo sido convidada outra pessoa de maior
              dignidade do que vós, aquele que vos convidou diga: «Cedei o vosso
              lugar a este convidado». E, então, tereis de ir, cheios de
              vergonha, ocupar o último lugar. Pelo contrário, ide ocupar o
              último lugar, de modo que aquele que vos houver convidado diga:
              «Amigo, vinde para lugar mais digno», o que será motivo de glória
