        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              Magnus Dóminus, et laudábilis nimis: in civitate Dei nostri, in
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. ibid., 2</Text> O Senhor é grande
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              ...
              salvar.<Text className="versicle"> ℣. </Text>
