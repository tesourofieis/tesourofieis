...
export default function PagePent240() {
  return (
    <PageWrapper>
      <Text className="h1">Vigésimo Quarto Domingo depois de Pentecostes</Text>
      ...
      <Language>
        ...
        <Text className="latin">
          ...
          fructificántes, et crescéntes in scientia Dei: in omni virtúte
          confortáti secúndum poténtiam claritátis ejus in omni patiéntia, et
          longanimitáte cum gáudio, grátias agentes Deo Patri, qui dignos nos
          fecit in partem sortis sanctórum in lúmine: qui erí puit nos de
        ...
        <Text className="vernacular">
          ...
          uma conduta digna de Deus, agradando-Lhe em todas as coisas, dando
          frutos em todas as espécies de boas obras e progredindo no
          conhecimento de Deus. Que sejais fortificados com o poder da glória de
          Deus para suportardes tudo com paciência, longanimidade e alegria,
          dando graças a Deus Pai, que nos tornou dignos de tomar parte na
      ...
      <Language>
        ...
        <Text className="latin">
          ...
          ad montes: et qui in tecto, non descéndat tóllere áliquid de domo sua:
          et qui in agro, non revertátur tóllere túnicam suam. Væ autem
          prægnántibus et nutriéntibus in illis diébus. Oráte autem, ut non fiat
          fuga vestra in híeme vel sábbato. Erit enim tunc tribulátio magna,
          qualis non fuit ab inítio mundi usque modo, neque fiet. Et nisi
          breviáti fuíssent dies illi, non fíeret salva omnis caro: sed propter
          eléctos breviabúntur dies illi. Tunc si quis vobis díxerit: Ecce, hic
          est Christus, aut illic: nolíte crédere. Surgent enim pseudochrísti et
          pseudoprophétæ, et dabunt signa magna et prodígia, ita ut in errórem
          inducántur (si fíeri potest) étiam elécti. Ecce, prædíxi vobis. Si
          ergo díxerint vobis: Ecce, in desérto est, nolíte exíre: ecce, in
          penetrálibus, nolíte crédere. Sicut enim fulgur exit ab Oriénte et
          paret usque in Occidéntem: ita erit et advéntus Fílii hóminis.
          Ubicúmque fúerit corpus, illic congregabúntur et áquilæ. Statim autem
          post tribulatiónem diérum illórum sol obscurábitur, et luna non dabit
          lumen suum, et stellæ cadent de cælo, et virtútes cœlórum
          commovebúntur: et tunc parébit signum Fílii hóminis in cœlo: et tunc
          plangent omnes tribus terræ: et vidébunt Fílium hominis veniéntem in
          núbibus cæli cum virtúte multa et majestáte. Et mittet Angelos suos
          cum tuba et voce magna: et congregábunt electos ejus a quátuor ventis,
          a summis cœlórum usque ad términos eórum. Ab arbóre autem fici díscite
          parábolam: Dum jam ramus ejus tener túerit et fólia nata, scitis, quia
          prope est æstas: ita et vos tum vidéritis hæc ómnia, scitóte, quia
        ...
        <Text className="vernacular">
          ...
          Judeia fujam para as montanhas; aquele que se achar em cima do telhado
          não desça para ir buscar qualquer coisa a casa; e aquele que estiver
          nos campos não volte a casa para procurar algum vestido. Ai das
          mulheres que estiverem prestes a ser mães: ou a amamentar seus filhos
          nesses dias! Rogai ao Senhor que a vossa fuga não seja nem no Inverno,
          nem ao sábado; pois a aflição será tão grande que não houve coisa
          semelhante desde o princípio do mundo até ao presente, como não haverá
          nunca mais; e, se esses dias não fossem abreviados (e sê-lo-ão em
          atenção aos escolhidos), ninguém seria salvo. Então, se alguém vos
          disser: «O Cristo está aqui, ou está acolá», não acrediteis; pois
          aparecerão falsos cristos e falsos profetas, que praticarão grandes
          maravilhas e prodígios até mesmo seduzirem (se tal fora possível) os
          próprios escolhidos. Eu vo-lo anuncio, desde já. Se, pois, vos
          disserem: «Ei-l’O está no deserto», não saiais; ou se vos disserem:
          «Ei-l’O aqui, no lugar mais retirado de casa», não acrediteis também;
          ...
          lugar em que estiver o cadáver aí se reunirão as águias. Imediatamente
          após a tribulação destes dias o sol se obscurecerá, a lua não
          projectará luz, as estrelas cairão do céu e os poderes dos céus serão
          abalados. E aparecerá no céu o sinal do Filho do homem, e todas as
          tribos da terra se lamentarão: e verão o Filho do homem sobre as
          nuvens do céu, revestido de grande poder e majestade! Ele enviará os
          seus Anjos, que farão retinir a trombeta em som estridente, e logo
          convocarão os escolhidos dos quatro ventos, desde uma extremidade dos
          céus até à outra! Compreendei isto por esta parábola, tirada da
          figueira: «Quando os seus ramos estão tenros e as folhas começam a
          despontar, conheceis que está próximo o estio; assim também, quando
          virdes todas estas coisas, sabereis que o Filho do homem está próximo,
