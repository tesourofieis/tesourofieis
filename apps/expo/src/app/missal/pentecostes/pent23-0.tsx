    ...
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">
          ...
          néxibus, quae pro nostra fraglitáte contráximus, tua benignitáte
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          qui terréna sápiunt. Nostra autem conversátio in cœlis est: unde etiam
        ...
        <Typography className="vernacular">
          ...
          Salvador, N. S. Jesus Cristo, que renovará o nosso corpo vil,
          tornando-o semelhante aoseu corpo glorioso, por meio daquela virtude,
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          que nos odiavam.<Typography className="versicle"> ℣. </Typography>
          Glorificar-nos-emos constantemente em Deus e louvaremos eternamente o
          vosso nome.
        </Typography>
        <Typography className="latin">
      ...
      <Language>
        ...
        <Typography className="latin">
          In illo témpore: Loquénte Jesu ad turbas, ecce, princeps unus accéssit
          et adorábat eum, dicens: Dómine, fília mea modo defúncta est: sed
          veni, impóne manum tuam super eam, et vivet. Et surgens Jesus
          sequebátur eum et discípuli ejus. Et ecce múlier, quæ sánguinis fluxum
          patiebátur duódecim annis, accéssit retro et tétigit fímbriam
          vestiménti ejus. Dicébat enim intra se: Si tetígero tantum vestiméntum
          ejus, salva ero. At Jesus convérsus et videns eam, dixit: Confíde,
          fília, fides tua te salvam fecit. Et salva facta est múlier ex illa
          hora. Et cum venísset Jesus in domum príncipis, et vidísset tibícines
          et turbam tumultuántem, dicebat: Recédite: non est enim mórtua puélla,
          sed dormit. Et deridébant eum. Et cum ejécta esset turba, intrávit et
          ténuit manum ejus. Et surréxit puella. Et éxiit fama hæc in univérsam
          terram illam.
        </Typography>
        <Typography className="vernacular">
          Naquele tempo, falando Jesus ao povo, um dos príncipes da sinagoga
          aproximou-se d’Ele e, adorando-O, disse-Lhe: «Senhor, a minha filha
          acaba de morrer, mas vinde, colocai vossas mãos sobre ela e recobrará
          a vida». Levantando-se então, Jesus segui-o com os discípulos. Logo,
          uma mulher que padecia dum fluxo de sangue havia doze anos
          aproximou-se d’Ele por detrás e tocou-Lhe na franja do vestido, pois
          (dizia de si para si), se eu tocar, somente que seja, no seu vestido,
          serei curada. Então Jesus, voltando-se e vendo-a, disse-lhe: «Tende
          confiança, minha filha, a vossa fé salvou-vos». E naquela hora foi
          curada esta mulher! Quando Jesus chegou a casa do príncipe da
          sinagoga, vendo os tocadores de flauta e a turba do povo, carpindo
          muito, disse: «Retirai-vos, porque a menina não está morta, mas
          adormecida». Eles riam-se de Jesus! Havendo, porém, saído a turba,
          entrou Jesus e pegou na mão da menina, que logo ressuscitou! E correu
          a fama deste acontecimento em todo o país.
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          sacrifício de louvor, a fim de que pela vossa bondade alcancemos o
          efeito dos dons que nos concedestes sem nenhuns merecimentos da nossa
          parte. Por nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          concedestes a alegria de participarem dos vossos sagrados mystérios
          fiquem expostos aos perigos humanos. Por nosso Senhor...
        </Typography>
      </Language>
    </PageWrapper>
  );
