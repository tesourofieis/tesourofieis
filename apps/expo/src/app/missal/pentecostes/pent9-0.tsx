...
export default function PagePent90() {
  return (
    <div className="docs">
      <h1>Nono Domingo depois de Pentecostes</h1>
      ...
      <div className="side-by-side not-content">
        <p>
          ...
          Dómine. <em>Ps. ibid., 3</em> Deus, in nómine tuo salvum me fac: et in
          virtúte tua libera me. ℣. Gloria Patri...
        </p>
        <p>
          ...
          verdadeira, exterminai-os. <em>Sl. ibid., 3</em> Ó Deus, pelo vosso
          nome, salvai-me; e, pelo vosso poder, livrai-me. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side not-content">
        ...
        <p>
          ...
          lúdere. Neque fornicémur, sicut quidam ex ipsis fornicáti sunt, et
          cecidérunt una die vigínti tria mília. Neque tentémus Christum, sicut
          quidam eórum tentavérunt, et a serpéntibus periérunt. Neque
          murmuravéritis, sicut quidam eórum murmuravérunt, et periérunt ab
          exterminatóre. Hæc autem ómnia in figúra contingébant illis: scripta
          sunt autem ad correptiónem nostram, in quos fines sæculórum
          devenérunt. Itaque qui se exístimat stare, vídeat ne cadat. Tentátio
        ...
        <p>
          ...
          levantou-se para se divertir». Não cometamos, pois, acções impuras,
          como alguns deles o fizeram, pelo que pereceram em um só dia vinte e
          três mil. Não tentemos a Cristo, como alguns deles tentaram, pelo que
          pereceram de mordeduras de serpentes. Não murmureis, como alguns deles
          murmuraram, pelo que foram feridos mortalmente pelo Anjo exterminador.
          Todas estas coisas eram como que figuras, e foram escritas para
          advertência de nós, que viemos no fim dos tempos. Aquele, pois, que
          crê estar seguro, tenha cuidado, não caia. Nenhuma tentação nos
      ...
      <div className="side-by-side not-content">
        ...
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 58, 2</em> Livrai-me das mãos dos meus
          inimigos, ó meu Deus; livrai-me daqueles que se insurgem contra mim.
          Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side not-content">
        ...
        <p>
          ...
          tuis. Quia vénient dies in te: et circúmdabunt te inimíci tui vallo,
          et circúmdabunt te: et coangustábunt te úndique: et ad terram
          prostérnent te, et fílios tuos, qui in te sunt, et non relínquent in
          te lápidem super lápidem: eo quod non cognóveris tempus visitatiónis
          tuæ. Et ingréssus in templum, cœpit ejícere vendéntes in illo et
        ...
        <p>
          ...
          tudo está oculto a teus olhos! Pois virão dias infelizes para ti, em
          que os teus inimigos te cercarão de trincheiras, te sitiarão e te
          fecharão por todos os lados. Então, te destruirão completamente, assim
          como aos teus filhos, que estão dentro de ti, não deixando pedra sobre
          pedra. Porquanto não quiseste conhecer o tempo em que foste visitada».
          Depois Jesus entrou no templo, expulsando aqueles que lá vendiam ou
