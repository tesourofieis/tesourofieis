    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          quia fecit nobíscum misericórdiam suam. <em>Ps. 8, 2</em> Dómine,
        ...
        <p>
          ...
          louvamos; pois foi misericordiosa para connosco. <em>Sl. 8, 2</em>{" "}
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          assentado sobre os Querubins! ℣. Sim, Senhor, sois bendito no
        ...
        <p>
          Aleluia, aleluia. ℣. <em>ibid., 52</em> Bendito sois, Senhor, Deus de
          nossos pais, e digno de louvor em todos os séculos. Aleluia.
        </p>
      </div>
