...
export default function PagePent10() {
  return (
    <SafeAreaView className="flex-1">
      <ScrollView>
        <View className="docs">
          <Text className="h1">Domingo da Santíssima Trindade</Text>
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              majestade, permiti, Vos imploramos, que, guardando nós firmemente
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              foi seu conselheiro? Quem foi o primeiro a dar-Lhe alguma coisa,
              para depois receber recompensa? Pois tudo quanto existe é d’Ele,
