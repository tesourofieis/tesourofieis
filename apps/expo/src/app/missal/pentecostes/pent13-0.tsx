...
export default function PagePent130() {
  return (
    <PageWrapper>
      <Text className="h1">Décimo Terceiro Domingo depois de Pentecostes</Text>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">Ps. ibid., 1</Text> Ut quid, Deus, reppulísti
      ...
      <Language>
        ...
        <Text className="latin">
          ...
          <Text className="latin">Ps. 89, 1</Text> Dómine, refúgium factus es
          nobis a generatióne et progénie. Allelúja.
        </Text>
        <Text className="vernacular">
          Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Sl. 89, 1</Text> De geração em geração,
