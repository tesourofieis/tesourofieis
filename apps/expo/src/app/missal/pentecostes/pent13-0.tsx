...
export default function PagePent130() {
  return (
    <PageWrapper>
      <H1 text="Décimo Terceiro Domingo depois de Pentecostes" />

      <H3 text="Intróito" />

      <Typography className="em">Sl. 73, 20,19 & 23</Typography>
      ...
      <Typography className="em">Sl. 73, 20, 19 et 22</Typography>
      ...
      <Typography className="em">Lc. 17, 11-19</Typography>
      ...
      <Typography className="em">Sb. 16, 20</Typography>
