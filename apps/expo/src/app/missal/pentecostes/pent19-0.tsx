    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 77, 1</em> Attendite, pópule meus, legem meam: inclináte aurem
        ...
        <p>
          ...
          <em>Sl. 77, 1</em> Sede atentos à minha Lei, ó meu povo; escutai as
          palavras que saem da minha boca. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          próximo suo: quóniam sumus ínvicem membra. Irascímini, et nolíte
          peccáre: sol non occídat super iracúndiam vestram. Nolíte locum dare
        ...
        <p>
          ...
          a cada um, nas relações com o próximo, segundo a verdade, pois somos
          todos membros uns dos outros. Se vos irardes, que seja sem pecar; e
          que o sol se não esconda sem que a vossa ira desapareça. Não deis
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          ℣. E que minhas mãos erguidas Vos sejam agradáveis, como o sacrifício
          vespertino.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 104, 1</em> Confitémini Dómino, et
          invocáte nomen ejus: annuntiáte inter gentes ópera ejus. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 104, 1</em> Louvai o Senhor e invocai o
          seu nome: publicai as suas obras em todos os povos. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          nuptias, et nolébant veníre. Iterum misit álios servos, dicens: Dícite
          invitátis: Ecce, prándium meum parávi, tauri mei et altília occísa
          sunt, et ómnia paráta: veníte ad núptias. Illi autem neglexérunt: et
          abiérunt, álius in villam suam, álius vero ad negotiatiónem suam:
          réliqui vero tenuérunt servos ejus, et contuméliis afféctos
          occidérunt. Rex autem cum audísset, iratus est: et, missis exercítibus
          suis, pérdidit homicídas illos et civitátem illórum succéndit. Tunc
          ait servis suis: Núptiæ quidem parátæ sunt, sed, qui invitáti erant,
          non fuérunt digni. Ite ergo ad exitus viárum et, quoscúmque
        ...
        <p>
          ...
          os servos chamar aqueles que haviam sido convidados para assistir.
          Eles, porém, não quiseram vir. Novamente mandou outros servos com esta
          participação: «Preparei o banquete; estão já mortos os bois e os
          animais gordos; tudo está preparado; vinde, pois, às bodas». Mas
          nenhuma atenção lhes dispensaram; e um foi para a sua casa de campo,
          outro para os seus negócios, e ainda outros detiveram os servos,
          ultrajando-os e matando-os. Então o rei, tendo conhecimento do que se
          passara, ficou cheio de ira e mandou os seus exércitos matar os
          assassinos e queimar a sua cidade. Depois disse aos servos: «As bodas
          estão preparadas, mas aqueles que haviam sido convidados não eram
          dignos. Ide vós, pois, pelas encruzilhadas dos caminhos e chamai para
          as bodas todos quantos encontrardes». Saíram os servos pelos caminhos
          e reuniram todos quantos encontraram, quer bons, quer maus, ficando
          cheia de convivas a sala das bodas. Entretanto o rei entrou para ver
          os que estavam. E tendo visto um dos convivas sem as vestes das bodas,
          disse-lhe: «Amigo, como te atreveste a entrar sem a veste das bodas?».
          O conviva guardou silêncio. Então o rei disse aos servos: «Amarrai-o
