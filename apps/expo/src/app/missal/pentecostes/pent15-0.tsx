...
export default function PagePent150() {
  return (
    <div className="docs">
      <h1>Décimo Quinto Domingo depois de Pentecostes</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          clamávi tota die. <em>Ps. ibid., 4</em> Lætífica ánimam servi tui:
          quia ad te, Dómine, ánimam meam levávi. ℣. Gloria Patri...
        </p>
        <p>
          ...
          Senhor, pois clamei por Vós todo o dia! <em>Sl. ibid., 4</em> Alegrai
          a alma do vosso servo, porque a Vós, Senhor, se elevou a minha alma.
          ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          spirituáles estis, hujúsmodi instrúite in spíritu lenitátis,
          consíderans teípsum, ne et tu tentéris. Alter alteríus ónera portáte,
          et sic adimplébitis legem Christi. Nam si quis exístimat se áliquid
          esse, cum nihil sit, ipse se sedúcit. Opus autem suum probet
          unusquísque, et sic in semetípso tantum glóriam habébit, et non in
          áltero. Unusquísque enim onus suum portábit. Commúnicet autem is, qui
          catechizátur verbo, ei, qui se catechízat, in ómnibus bonis. Nolíte
          erráre: Deus non irridétur. Quæ enim semináverit homo, hæc et metet.
          Quóniam qui séminat in carne sua, de carne et metet corruptiónem: qui
          autem séminat in spíritu, de spíritu metet vitam ætérnam. Bonum autem
        ...
        <p>
          ...
          inadvertência, vós, que sois espirituais, admoestai-o com espírito de
          mansidão, e acautelai-vos, também, para não cairdes na tentação. Que
          se auxiliem uns aos outros a levar os seus fardos, pois deste modo
          cumprireis a lei de Cristo. Se algum se julga alguma coisa, engana-se;
          porque não é nada. Que cada um examine as suas acções, e então
          conhecerá se poderá gloriar-se de si próprio, e não comparando-se com
          os outros, visto que cada um levará o seu próprio fardo. Aquele que
          foi catequizado nas verdades da fé comunique todos seus bens com
          aquele que o catequizou. Não vos iludais; pois de Deus se não zomba.
          Cada ente humano colherá aquilo que tiver semeado. Aquele, pois, que
          semeia na carne não colherá da carne senão a corrupção; e aquele que
          semeia no espírito colherá do espírito a vida eterna. Não nos
          fatiguemos de praticar boas acções, porque colheremos o fruto, se não
      ...
      <div className="side-by-side">
        ...
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 94, 3</em> Quóniam Deus magnus Dóminus,
          et Rex magnus super omnem terram. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 94, 3</em> Pois o Senhor é o excelso Deus
          e o excelso Rei, superior a todo o universo. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          accéssit et tétigit lóculum. (Hi autem, qui portábant, stetérunt.) Et
        ...
        <p>
          ...
          de sua mãe, que era viúva e ia acompanhada por muitas pessoas da
          cidade. Vendo, então, o Senhor tudo isto, encheu-se de Compaixão da
          mãe e disse-lhe: «Não chores». Depois, aproximando-se do defunto,
          tocou no esquife (pois aqueles que o levavam haviam parado) e disse:
          «Jovem, ordeno-te eu, levanta-te!». E no mesmo instante se ergueu e
          sentou o que estava morto, começando a falar! Então Jesus entregou-o a
