...
export default function PagePent100() {
  return (
    <SafeAreaView className="flex-1">
      <ScrollView>
        <View className="docs">
          <Text className="h1">Décimo Domingo depois de Pentecostes</Text>
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              enútriet. <Text className="latin">Ps. ibid., 2</Text> Exáudi,
              Deus, oratiónem meam, et ne despéxeris deprecatiónem meam: inténde
              mihi et exáudi me.<Text className="versicle"> ℣. </Text>Gloria
              Patri...
            </Text>
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. ibid., 2</Text> Ouvi, Senhor, a
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              Dóminus Jesus, nisi in Spíritu Sancto. Divisiónes vero gratiárum
              sunt, idem autem Spíritus. Et divisiónes ministratiónum sunt, idem
              autem Dóminus. Et divisiónes operatiónum sunt, idem vero Deus, qui
              operátur ómnia in ómnibus. Unicuíque autem datur manifestátio
              Spíritus ad utilitátem. Alii quidem per Spíritum datur sermo
              sapiéntiæ álii autem sermo sciéntiæ secúndum eúndem Spíritum:
              álteri fides in eódem Spíritu: álii grátia sanitátum in uno
              Spíritu: álii operátio virtútum, álii prophétia, álii discrétio
              spirítuum, álii génera linguárum, álii interpretátio sermónum. Hæc
            ...
            <Text className="vernacular">
              ...
              Jesus; nem ninguém, também, poderá dizer que Jesus é Senhor, senão
              inspirado pelo Espírito Santo. Na verdade, há diversas graças;
              porém o Espírito é o mesmo. Há diversos ministérios; porém o mesmo
              Senhor. Há diversidade de operações; porém não há senão um só
              Deus, que opera todas as coisas em nós. Os dons do Espírito Santo,
              que se manifestam em cada um, são para utilidade comum. A um é
              dado pelo Espírito o dom de falar com sabedoria; a outro é dado
              pelo mesmo Espírito o dom de falar com ciência; a um outro é dada
              a fé pelo mesmo Espírito; este recebe do mesmo Espírito a graça de
              curar os enfermos; aquele alcança o dom dos milagres; um outro o
              dom das profecias, aqueloutro o discernimento dos espíritos; este
              o dom de falar diversas línguas; e ainda aqueloutro o dom de as
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              ...
              vossas o Senhor.<Text className="versicle"> ℣. </Text>Que os
              vossos lábios pronunciem o meu juízo: e que os vossos olhos vejam
              a minha justiça.
            </Text>
            <Text className="latin">
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Ps 64, 2</Text> Diante de Vós,
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              alter publicánus. Pharisǽus stans, hæc apud se orábat: Deus,
              grátias ago tibi, quia non sum sicut céteri hóminum: raptóres,
              injústi, adúlteri: velut étiam hic publicánus. Jejúno bis in
              sábbato: décimas do ómnium, quæ possídeo. Et publicánus a longe
              stans nolébat nec óculos ad cœlum leváre: sed percutiébat pectus
              suum, dicens: Deus, propítius esto mihi peccatóri. Dico vobis:
            ...
            <Text className="vernacular">
              ...
              e o outro publicano. O fariseu, estando de pé, orava assim no seu
              íntimo: «Ő Deus, dou-Vos graças, porque não sou como os outros
              homens, que são ladrões, injustos e adúlteros, nem mesmo como este
              publicano; pois jejuo duas vezes na semana e pago o dízimo dos
              meus rendimentos». O publicano, ao contrário, conservando-se
              afastado, não ousava, sequer, levantar os olhos para o céu, e
              batia no peito, dizendo: «Meu Deus, tende piedade de mim, que sou
              um pobre pecador». Eu vos declaro, disse Jesus, que este voltou
