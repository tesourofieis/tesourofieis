...
export default function PagePent100() {
  return (
    <div className="docs">
      <h1>Décimo Domingo depois de Pentecostes</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 2</em> Exáudi, Deus, oratiónem meam, et ne despéxeris
        ...
        <p>
          ...
          preocupações, pois Ele vos sustentará. <em>Sl. ibid., 2</em> Ouvi,
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          nisi in Spíritu Sancto. Divisiónes vero gratiárum sunt, idem autem
          Spíritus. Et divisiónes ministratiónum sunt, idem autem Dóminus. Et
          divisiónes operatiónum sunt, idem vero Deus, qui operátur ómnia in
          ómnibus. Unicuíque autem datur manifestátio Spíritus ad utilitátem.
          Alii quidem per Spíritum datur sermo sapiéntiæ álii autem sermo
          sciéntiæ secúndum eúndem Spíritum: álteri fides in eódem Spíritu: álii
          grátia sanitátum in uno Spíritu: álii operátio virtútum, álii
        ...
        <p>
          ...
          ninguém, também, poderá dizer que Jesus é Senhor, senão inspirado pelo
          Espírito Santo. Na verdade, há diversas graças; porém o Espírito é o
          mesmo. Há diversos ministérios; porém o mesmo Senhor. Há diversidade
          de operações; porém não há senão um só Deus, que opera todas as coisas
          em nós. Os dons do Espírito Santo, que se manifestam em cada um, são
          para utilidade comum. A um é dado pelo Espírito o dom de falar com
          sabedoria; a outro é dado pelo mesmo Espírito o dom de falar com
          ciência; a um outro é dada a fé pelo mesmo Espírito; este recebe do
          mesmo Espírito a graça de curar os enfermos; aquele alcança o dom dos
          milagres; um outro o dom das profecias, aqueloutro o discernimento dos
          espíritos; este o dom de falar diversas línguas; e ainda aqueloutro o
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          vossas o Senhor. ℣. Que os vossos lábios pronunciem o meu juízo: e que
          os vossos olhos vejam a minha justiça.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps 64, 2</em> Te decet hymnus, De us, in
          Sion: et tibi redde tu votum in Jerúsalem. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Ps 64, 2</em> Diante de Vós, Senhor, é
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          publicánus. Pharisǽus stans, hæc apud se orábat: Deus, grátias ago
          tibi, quia non sum sicut céteri hóminum: raptóres, injústi, adúlteri:
          velut étiam hic publicánus. Jejúno bis in sábbato: décimas do ómnium,
          quæ possídeo. Et publicánus a longe stans nolébat nec óculos ad cœlum
          leváre: sed percutiébat pectus suum, dicens: Deus, propítius esto mihi
        ...
        <p>
          ...
          publicano. O fariseu, estando de pé, orava assim no seu íntimo: «Ő
          Deus, dou-Vos graças, porque não sou como os outros homens, que são
          ladrões, injustos e adúlteros, nem mesmo como este publicano; pois
          jejuo duas vezes na semana e pago o dízimo dos meus rendimentos». O
          publicano, ao contrário, conservando-se afastado, não ousava, sequer,
          levantar os olhos para o céu, e batia no peito, dizendo: «Meu Deus,
