...
export default function PagePent176() {
  return (
    <div className="docs">
      <h1>Sábado das Têmporas de Setembro</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          qui fecit nos: quia ipse est Dóminus, Deus noster. <em>Ps 94:1</em>{" "}
          Veníte, exsultémus Dómino: jubilémus Deo, salutári nostro. ℣. Gloria
          Patri...
        </p>
        <p>
          Vinde, adoremos Deus; prostemo-nos e choremos perante o Senhor, que
          nos criou: pois Ele é o Senhor, nosso Deus. <em>Sl 94:1</em> Vinde,
          cantemos com alegria ao Senhor: manifestemos o nosso júbilo a Deus,
          que é a nossa salvação. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Dómino. Omne opus servíle non faciétis in témpore diéi hujus: quia
          dies propitiatiónis est, ut propitiétur vobis Dóminus, Deus vester.
          Omnis ánima, quæ afflicta non fúerit die hac, períbit de pópulis suis:
          et quæ óperis quídpiam fécerit, delébo eam de pópulo suo. Nihil ergo
          óperis faciétis in eo: legítimum sempitérnum erit vobis in cunctis
        ...
        <p>
          ...
          Senhor e vos não empregareis em trabalho servil, «pois é o dia da
          expiação», para que alcanceis que o Senhor, vosso Deus, seja propício.
          Todo aquele que nesse dia não se castigar, será expulso do seu povo,
          assim como todo aquele que se empregar em trabalho servil. Nenhum
          trabalho, pois, farei naquele dia. Isto ficará sendo um preceito
          eterno para os vossos descendentes, em qualquer parte em que se
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          está o seu Deus? ℣. Vinde em nosso socorro, ó Deus, nosso Salvador:
          Livrai-nos, Senhor, para a glória do vosso nome.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          sábbatum, id est réquies. Sumetísque vobis die primo fructus arbóris
          pulchérrimæ, spatulásque palmárum, et ramos ligni densárum fróndium,
          et sálices de torrénte, et lætabímini coram Dómino, Deo vestro.
          Celebrabitísque sollemnitátem ejus septem diébus per annum: legítimum
          sempitérnum erit in generatiónibus vestris. Mense séptimo festa
          celebrábitis, et habitábitis in umbráculis septem diébus. Omnis, qui
        ...
        <p>
          ...
          oitavo serão dias de «sábado», isto é, de descanso. No primeiro dia
          procurareis frutos da melhor árvore, ramos de palmeira e doutras
          árvores frondosas e espessas e de salgueiros das ribeiras,
          rejubilando-vos na presença do Senhor, vosso Deus. Todos os anos
          celebrareis esta festa durante sete dias. É um preceito perpétuo para
          os vossos descendentes. Celebrareis esta festa no sétimo mês:
          permanecereis durante sete dias nas vossas tendas. Todo aquele que
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          símilis tui, qui aufers iniquitátem, et transis peccátum reliquiárum
          hereditátis tuæ ? Non immíttet ultra furórem suum, quóniam volens
          misericórdiam est. Revertétur, et miserébitur nostri: depónet
        ...
        <p>
          ...
          Quem é Deus, como Vós, que apagais a iniquidade e esqueceis os pecados
          da vossa herança?». O Senhor não mais manifestará a sua indignação
          contra os seus, porque quer mostrar misericórdia. Ele regressará a nós
          e mostrará a sua piedade: aliviar-nos-á do peso das nossas iniquidades
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          misértus: sic convérsus cogitávi in diébus istis, ut benefáciam domui
          Juda et Jerúsalem: nolíte timére. Hæc sunt ergo verba, quæ faciétis:
          Loquímini veritátem, unusquísque cum próximo suo: veritátem et
          judícium pacis judicáte in portis vestris. Et unusquísque malum contra
          amícum suum ne cogitétis in córdibus vestris: et juraméntum mendax ne
          diligátis: ómnia enim hæc sunt, quæ odi, dicit Dóminus. Et factum est
          verbum Dómini exercítuum ad me, dicens: Hæc dicit Dóminus exercítuum:
          Jejúnium quarti et jejúnium quinti et jejúnium séptimi et jejúnium
        ...
        <p>
          ...
          o desígnio de conceder benefícios à casa de Judá e de Jerusalém. Não
          tenhais receio, pois. Eis o que deveis fazer: Que cada um diga a
          verdade ao próximo e às suas portas fale e proceda com justiça,
          segundo a verdade e em ordem à paz; que ninguém pense mal no seu
          coração contra o próximo, nem ame os falsos testemunhos, porque
          detesto todas essas coisas», diz o Senhor. A palavra do Senhor dos
          exércitos foi-me dirigida nestes termos: «Assim fala o Senhor dos
          exércitos: Os jejuns do quarto, do quinto, do sétimo e do décimo mês
      ...
      <div className="side-by-side">
        ...
        <p>
          Eleve-se, como o incenso, a minha oração até Vós, Senhor. ℣. Que as
          minhas mãos erguidas Vos sejam gratas, como o sacrifício da tarde.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          thuríbulum, et arcam testaménti circumtéctam ex omni parte auro, in
          qua urna áuea habens manna, et virga Aaron, quæ frondúerat, et tábulæ
          testaménti, supérque eam erant Chérubim glóriæ obumbrántia
          propitiatórium: de quibus non est modo dicéndum per síngula. His vero
          ita compósitis; in prióri quidem tabernáculo semper introíbant
          sacerdótes, sacrificiórum offícia consummántes: in secúndo autem semel
          in anno solus póntifex, non sine sánguine, quem offert pro sua et
          pópuli ignorántia: hoc significánte Spíritu Sancto, nondum propalátam
          esse sanctórum viam, adhuc prióre tabernaculo habénte statum. Quæ
          parábola est témporis instántis: juxta quam múnera et hóstiæ
          offerúntur, quæ non possunt juxta consciéntiam perféctum fácere
          serviéntem, solummodo in cibis, et in pótibus, et váriis
          baptismátibus, et justítiis carnis usque ad tempus correctiónis
          impósitis. Christus autem assístens póntifex futurórum bonórum, per
          ámplius et perféctius tabernáculum non manufáctum, id est, non hujus
        ...
        <p>
          ...
          chamado o «Santo dos Santos», que continha um turíbulo de ouro, a arca
          da aliança toda coberta de ouro (na qual se achava uma urna de ouro,
          onde estava o maná), a vara de Aarão, que florescera, e as tábuas da
          aliança. Sobre a arca estavam os Querubins da glória, resguardando com
          a sua sombra o propiciatório. Mas não é agora ocasião propícia para
          falar com detalhe deste assunto... Ora, estando estas coisas assim
          dispostas, os Sacerdotes entravam, quando queriam, na primeira parte
          do tabernáculo, para o exercício do culto; mas na segunda parte não
          entrava senão o Sumo Sacerdote, e uma só vez em cada ano; não, porém,
          sem levar o sangue que oferecia pelas suas faltas de ignorância e
          pelas do povo, querendo com isto o Espírito Santo significar que o
          caminho do «Santo dos Santos» não se abria, enquanto o primeiro
          tabernáculo subsistia. Isto é uma figura que tem relação com os tempos
          presentes, em que se oferecem dons e vítimas, que não podem conduzir à
          perfeiçãi, sob o ponto de vista da consciência, aquele que presta o
          culto, pois que o culto não consite nas diversas abluções e dons
          carnais impostos somente até ao tempo da reforma; mas Cristo veio como
          Pontífice dos bens futuros (passando por um tabernáculo, mais
          excelente e perfeito, que não foi construído por mão humana, isto é,
      ...
      <div className="side-by-side">
        ...
        <p>
          Ó povos, louvai todos o Senhor, glorificai-O todos, ó povos. ℣. A sua
          misericórdia é grande: e a sua verdade subsistirá sempre.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          sunt, ex quo vénio quærens fructum in ficúlnea hac, et non invénio:
          succíde ergo illam: ut quid étiam terram óccupat? At ille respóndens,
          dicit illi: Dómine, dimítte illam et hoc anno, usque dum fódiam circa
          illam et mittam stércora: et si quidem fécerit fructum: sin autem, in
          futúrum succídes eam. Erat autem docens in synagóga eórum sábbatis. Et
          ecce múlier, quæ habébat spíritum infirmitátis annis decem et octo: et
          erat inclináta, nec omníno póterat sursum respícere. Quam cum vidéret
          ...
          glorificábat Deum. Respóndens autem archisynagógus, indígnans quia
          sábbato curásset Jesus, dicébat turbæ: Sex dies sunt, in quibus
          opórtet operári: in his ergo veníte, et curámini, et non in die
          sábbati. Respóndens autem ad illum Dóminus, dixit: Hypócritæ,
          unusquísque vestrum sábbato non solvit bovem suum aut ásinum a
          præsépio, et ducit adaquáre? Hanc autem fíliam Abrahæ, quam alligávit
        ...
        <p>
          ...
          buscar os frutos a esta figueira, e os não encontro. Corta-a, pois.
          Para que ocupa ela este chão?». O vinhateiro respondeu: «senhor,
          deixai-a ficar ainda este ano, porque a cavarei em redor e lhe
          deitarei adubos. Talvez dê frutos; senão cortá-la-eis mais tarde». Ora
          Jesus ensinava numa sinagoga a um sábado, e eis que veio ter com Ele
          uma mulher, que havia dezoito anos estava possessa de um espírito que
          a retinha enferma: andava curvada, não podendo de mode algum olhar
          para o alto. Então, vendo-a Jesus, chamou-a e disse-lhe: «Mulher,
          ficas livre da tua enfermidade!». E, impondo sobre ela as suas mãos,
          imediatamente esta se endireitou. E a mulher louvava a Deus! Porém o
          príncipe da sinagoga, indignado de que Jesus tivesse feito esta cura
          ao sábado, tomou a palavra e disse: «Há seis dias para trabalhar;
          vinde, pois, para serdes curados em um desses dias, e não ao sábado».
          O Senhor respondeu, dizendo: «Hipócritas, porventura cada um de vós ao
          sábado não desprende do estábulo o boi ou o jumento, e o não leva a
          beber? Então esta filha de Abraão, que Satanás conservava presa há
