    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">Ps. 131, 1</Text> Meménto, Dómine, David: et
          omnis mansuetúdinis ejus.<Text className="versicle"> ℣. </Text>
          Gloria Patri...
        </Text>
        <Text className="vernacular">
          ...
          <Text className="vernacular">Sl. 131, 1</Text> Lembrai-Vos de David, ó
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>Glorificai o Senhor pela sua
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>Et portæ ínferi non prævalébunt
          advérsus eam: et tibi dabo claves regni cœlórum.
          <Text className="versicle"> ℣. </Text>Quodcúmque ligáveris super
          terram, erit ligátum et in cœlis.
          <Text className="versicle"> ℣. </Text>Et quodcúmque sólveris super
          terram, erit solútum et in cœlis.
        </Text>
        <Text className="vernacular">
          Tu és Pedro, e sobre esta pedra edificarei a minha Igreja.
          <Text className="versicle"> ℣. </Text>E as portas do inferno não
          prevalecerão contra ela: E dar-te-ei as chaves do reino dos céus.
          <Text className="versicle"> ℣. </Text>Tudo o que ligares sobre a terra
          será ligado nos céus.<Text className="versicle"> ℣. </Text>E tudo o
