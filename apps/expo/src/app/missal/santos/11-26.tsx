        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              præcláris vitæ méritis decoráre dignátus es: te súpplices
              exorámus; ut, ejus exémplo terréna despiciéntes, tui consórtio
              perfruámur ætérno. Per Dóminum...
            </Text>
            <Text className="text-base vernacular">
              Ó clementíssimo Deus, que Vos dignastes chamar à solidão o Santo
              Abade Silvestre quando meditava piedosamente em um túmulo aberto
              sobre a vaidade deste mundo, assim como o ornastes com os méritos
              de uma vida preclara, humildemente Vos suplicamos que, imitando o
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              beáti Silvéstri Abbátis imitatóres effécti, Corpus et Sánguinem
              Fílii tui sancte percípere mereámur: Qui tecum vivit et regnat...
            </Text>
            <Text className="text-base vernacular">
              Senhor, Vos suplicamos, permiti que, oferecendo reverentemente à
              vossa divina majestade estes dons, nos tornemos imitadores do B.
              Abade Silvestre pela piedosa disposição da alma e pela pureza de
          ...
          <View className="side-by-side">
            <Text className="text-base latin">
              ...
              glóriæ tuæ cum Sanctis habeámus. Per Dóminum...
            </Text>
            <Text className="text-base vernacular">
              Havendo comparticipado do divino banquete, concedei-nos, Senhor,
              Vos suplicamos, que sigamos de tal sorte os passos do Santo Abade
