...
export default function Page1009() {
  return (
    <div className="docs">
      <h1>S. João Leonardo, Conf., a 9 de Outubro</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          glória Dómini plenum est opus ejus. <em>Ps. 95, 1</em> Cantáte Dómino
        ...
        <p>
          ...
          cheias da glória do Senhor. <em>Sl. 95, 1</em> Cantai ao Senhor um
      ...
      <div className="side-by-side">
        <p>
          ...
          comédit me. ℣. <em>Isai. 49, 2</em> Pósuit os meum quasi gládium
          acutum: in umbra manus suæ protéxit me, et pósuit me sicut sagíttam
          eléctam.
        </p>
        <p>
          Inflamou-se o meu coração e comoveram-se as minhas entranhas: o zelo
          da tua casa devorou-me. ℣. <em>Is. 49, 2</em> O Senhor tornou a minha
          boca como uma espada aguda: protegeu-me com a sombra da sua mão: e fez
          de mim como que uma seta escolhida.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 70, 7</em> Tamquam prodígium factus sum
          multis: et tu adjútor fortis, Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 70, 7</em> Fui considerado por muitos
          corno um prodígio: tu és um poderoso auxiliar. Aleluia.
        </p>
      </div>
