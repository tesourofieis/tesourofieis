      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="comment">
            ...
            vivacidade de espírito. Em Paris, estudou a teologia, na Sorbona,
            foi cónego da Metrópole, com 17 anos. Ordenado sacerdote, celebrou o
            Santo Sacrifício com fé mui viva e grande amor, conservando estes
            sentimentos sempre que subia ao altar. Deus o suscitou «para dar aos
            pobres o ensino cristão e firmar a mocidade no caminho da verdade».
            Fundou, com esse desígnio, uma nova congregação religiosa por ele
            intitulada «Os Irmãos das Escolas Cristãs», espalhada, em breve, por
            todo o mundo. Por humildade e pelo amor à pobreza renunciou ao
            canonicato distribuindo aos pobres todos os seus bens. «Inflamado de
            zelo pela salvação das almas», diz o Breviário, «consumiu a
            existência em trabalhar para seu maior bem. Castigava-se
            ...
            1719 com a idade de 68 anos». Aplicava-se em ocultar a sua vida nas
            mais humildes funções, servindo a Jesus nos pequeninos. Foi exaltado
            pelo Divino Ressuscitado, cuja glória compartilha, continuando a
            abençoar a sua obra, no universo inteiro. À imitação do Santo,
            «tenhamos grande zelo em procurar a glória de Deus salvando-lhes
            almas, a fim de merecermos igual recompensa no céu».
          </Text>
          ...
          <Language>
            <Text className="latin">
              ...
              concéde propítius; ut ejus intercessióne et exémplo, stúdio glóriæ
            ...
            <Text className="vernacular">
              ...
              concedei-nos propício que, pela sua intercessão e seguindo o seu
              exemplo, sejamos devorados pelo zelo da glória de Deus para a
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              regnum cœlórum. Quicumque ergo humiliáverit se sicut párvulus
            ...
            <Text className="vernacular">
              ...
              disse: «Em verdade vos digo: se vos não converteis e vos não
              tornais como os pequenos, não entrareis no reino dos céus. Todo
              aquele, pois, que se fizer pequeno, como este menino, esse é o
