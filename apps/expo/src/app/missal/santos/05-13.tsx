  ...
  return (
    <div className="docs">
      ...
      <aside>
        ...
        Sucessivamente professor de teologia e pregador em Lovaina (1559-1576)
        encarregado do curso de controvérsias em Roma, onde teve por penitente
        S. Luís de Gonzaga, provincial dos Jesuítas em Nápoles, enviado em
        França por Sixto V em missão diplomática, Belarmino foi, apesar de
        repugnância da sua humildade, agraciado com as honras do cardinalato em
        1599. Clemente VIII motivou a sua escolha declarando que a Igreja não
        possuía outro igual em sabedoria. Sem contar os três anos que Belarmino
        passou como arcebispo em Cápua, o cardeal continuou a residir na Cidade
        Eterna, onde prestou relevantes serviçoes a Clemente VIII, Paulo V e
        Grgório XV. Com seus livros de controvérsias causou enormes prejuízos à
        ...
        doutrina cristã. Alma de angélica inocência, religioso de humildade e
        obediência sem par, foi no episcopado um pastor modelar por sua
