  ...
  return (
    <PageWrapper>
      ...
      <Text className="comment">
        ...
        Nolasco, movido pelo exemplo da caridade divina e por inspiração celeste
        (Or.) da qual S. Raimundo de Penhafort foi o instrumento, empregou toda
        a sua fortuna (Ev.) em libertar os cristãos do cativeiro dos infiéis
        onde se consumiam os seus corpos e onde as suas almas corriam grandes
        perigos. A Ordem de Nossa Senhora das Mercês, fundada para esse fim,
        mostra como a realeza de Jesus se extende no mundo natural e no mundo
        sobrenatural. Por voto especial, os Religiosos prometiam eles próprios
        prisioneiros pagãos, se necessário fosse, para libertar os seus irmãos
        no Cristo (Ep.). Morreu em 1256 e foi enterrado com a sua couraça e
        espada.
      </Text>
      ...
      <Language>
        <Text className="latin">
          Deus, qui in tuæ caritátis exémplum ad fidélium redemptiónem sanctum
          Petrum Ecclésiam tuam nova prole fœcundáre divínitus docuísti: ipsíus
          nobis intercessióne concéde; a peccáti servitúte solútis, in cœlésti
          pátria perpétua libertáte gaudére: Qui vivis et regnas...
        </Text>
        <Text className="vernacular">
          Ó Deus, que em prova da vossa caridade quisestes inspirar
          sobrenaturalmente S. Pedro a fundar na vossa Igreja uma nova família,
          destinada à redenção dos fiéis cativos, concedei-nos por sua
          intercessão que, livres nós do cativeiro do pecado, gozemos perpétua
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          para que por meio deles nos livremos dos males presentes e futuros.
          Por nosso Senhor...
        </Text>
      </Language>
