...
export default function Page0119Portugal() {
  return (
    <div className="docs">
      <h1>S. Gonçalo de Amarante, Confesso, a 19 de Janeiro</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          cápite ejus corónam de lápide pretióso. ℣. <em>ibid., 5</em> Vitam
          pétiit a te: et tribuísti ei longitúdinem diérum in sæculum sæculi.
        </p>
        <p>
          Concedestes-lhe, Senhor, bênçãos escolhidas, as mais suaves, e
          impusestes na sua cabeça uma coroa de pedras preciosas. ℣.{" "}
          <em>ibid., 5</em> Concedestes-lhe a vida que Vos suplicou e
          prolongastes-lhe a duração dos seus dias pelos séculos dos séculos.
        </p>
        <p>
