      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="comment">
            ...
            bem-aventurado Pedro e dos Pontífices» e «conduziram a Pedro, em
            numerosas levas, os Búlgaros, Moravios, Boémios». Irmãos pelo
            sangue, nasceram no século IX em Tessalónica e distinguiram-se pelos
            progressos nas ciências, em Constantinopla. Sagrados Bispos, pelo
            Papa Adriano II (Intr., Ep., Ale.), converteram os povos eslavos
            (Or.). Inventores dos caracteres dessa língua, traduziram os livros
            santos e realizaram os ritos sagrados nesse idioma de que são
