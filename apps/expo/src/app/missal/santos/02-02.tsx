      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="comment">
            ...
            É celebrada a 2 de Fevereiro porque, desejando submeter-se à lei
            mosaica, Maria devia ir a Jerusalém 40 dias depois do nascimento do
            Menino Jesus para ali oferecer o sacrifício prescrito. As mães davam
            um cordeiro ou, se os meios não lhe permitiam, duas rolinhas ou duas
            pombinhas. A Santíssima Virgem levou consigo a Jerusalém o Menino
            Jesus e a procissão das Candeias recorda a viagem de Maria e José
            subindo ao Templo para apresentar o Anjo da Aliança segundo a
            predicção da Malaquias. As Missas da Anunciação, Assunção,
            Natividade de Maria, Exaltação da Santa Cruz e Candeias tinham
            outrora procissão própria que se conservou só para a última dessas
            festas. A cera das velas significa a carne virginal do divino
            Menino, diz S. Anselmo, a mecha figura a sua alma e a chama a sua
            divindade. A Purificação, à qual a Mãe do Salvador não estava
            obrigada, pois dera à luz fora das leis ordinárias, passa ao segundo
            plano na liturgia, sendo a Apresentação de Jesus o principal objecto
            desta festa. Relacionando-se a festa ao Tempo de Natal, vê-se Jesus
            manifestado por Simeão como o Deus que iluminará com a sua luz os
            gentios e será a glória do povo de Israel; considerando-a como
            pertencente ao Tempo depois da Epifania, adora-se a Jesus no
            cumprimento da profecia, seja nas Nupcias de Caná, quando Ele começa
            a manifestar a sua glória, ou no meio da multidões ao espalhar a luz
            de sua doutrina. Tornemos a ler a 4ª Oração de bênção das velas a
            fim de compreender o simbolismo da lâmpada do santuário e das velas
            bentas nesse dia, e conhecer a significação de seu uso no leito dos
            moribundos, nas tempestades e perigos que podem correr nosso corpo e
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              Simeónis implésti: te humíliter deprecámur; ut has candélas ad
              usus hóminum et sanitátem córporum et animárum, sive in terra sive
              ...
              <Text className="cross"> ✠ </Text> ficáre dignéris: et hujus
              plebis tuæ, quæ illas honorífice in mánibus desíderat portare
              teque cantando laudare, exáudias voces de cœlo sancto tuo et de
              sede majestátis tuæ: et propítius sis ómnibus clamántibus ad te,
            ...
            <Text className="vernacular">
              ...
              do justo Simeão: humildemente Vos rogamos, pela invocação do vosso
              ...
              <Text className="cross"> ✠ </Text> e santificar{" "}
              <Text className="cross"> ✠ </Text> estas velas para uso dos homens
              e para a saúde dos corpos e das almas, quer na terra, quer no mar.
              Ouvi, lá do vosso celestial santuário e do trono da vossa
              majestade, os votos do vosso povo, aqui presente, que deseja levar
              reverentemente em suas mãos estas velas e louvar-Vos com seus
              cânticos; enfim, sede propício para com todos que por Vós clamam,
              os quais resgatastes pelo precioso Sangue do vosso Filho: Que,
              sendo Deus, convosco vive e...
            </Text>
            <Text className="latin">
            ...
            <Text className="latin">
              ...
              cúpimus luce accénsas, bene <Text className="cross"> ✠ </Text>{" "}
              dícere et sancti <Text className="cross"> ✠ </Text> ficáre atque
            ...
            <Text className="vernacular">
              ...
              benzer <Text className="cross"> ✠ </Text>, santificar{" "}
              <Text className="cross"> ✠ </Text> e acender com a luz da vossa
              bênção estas velas que nós, vossos servos, desejamos levar acesas,
              depois de as havermos recebido para honra do vosso santo Nome, a
              fim de que, oferecendo-as a Vós, que sois nosso Deus e Senhor, nos
            ...
            <Text className="latin">
              ...
              <Text className="cross"> ✠ </Text> dictiónem tuam super hos
              céreos, et sancti <Text className="cross"> ✠ </Text> fica eos
              lúmine grátiæ tuæ, et concéde propítius; ut, sicut hæc luminária
              igne visíbili accénsa noctúrnas depéllunt ténebras; ita corda
              nostra invisíbili igne, id est, Sancti Spíritus splendóre
              ...
              sǽcula sæculórum. Senhor Jesus Cristo, luz verdadeira que ilumina
              todo o homem que vem a este mundo, lançai a vossa bênção{" "}
              <Text className="cross"> ✠ </Text>
            </Text>
            <Text className="vernacular">
              sobre estas velas e santificai-as{" "}
              <Text className="cross"> ✠ </Text> com a luz da vossa graça;
              permiti benigno que, assim como estes círios, brilhando com luz
              visível, afastam as trevas da noite, assim também os nossos
              corações, iluminados com o fogo invisível, isto é, ilustrados com
              o esplendor do Espírito Santo sejam livres da cegueira de todos os
              vícios, a fim de que, purificados os olhos da nossa alma, possamos
              conhecer o que Vos é agradável e útil à nossa salvação; e, assim,
              após as perigosas trevas deste mundo, mereçamos alcançar a posse
              da luz eterna. Por Vós, ó Jesus Cristo, Salvador do mundo, que,
            ...
            <Text className="latin">
              ...
              <Text className="cross"> ✠ </Text> dictiónis tuæ grátiam super hos
              céreos benígnus infúnde; quaténus sic adminístrent lumen extérius,
              ut, te donánte, lumen Spíritus tui nostris non desit méntibus
              intérius. Per Dóminum...
            </Text>
            <Text className="vernacular">
              ...
              bênção <Text className="cross"> ✠ </Text> nestas velas, de sorte
              que, dando-nos elas a luz exterior, não falte interiormente às
              nossas almas pela vossa graça a luz do vosso Espírito Santo. Por
              nosso Senhor...
            </Text>
            <Text className="latin">
              <Text className="response"> ℟. </Text> Amen.
            ...
            <Text className="latin">
              ...
              agnóvit, suscépit et benedíxit: præsta propítius; ut, ejúsdem
              Spíritus Sancti grátia illumináti atque edócti, te veráciter
              agnoscámus et fidéliter diligámus: Qui cum Deo Patre in unitáte
            ...
            <Text className="vernacular">
              ...
              Espírito, aceitou em suas mãos, reconheceu e abençoou,
              concedei-nos propício que, iluminados e ilustrados pela graça do
          ...
          <Language>
            <Text className="latin">
              ...
              annuntiavérunt nobis.<Text className="versicle"> ℣. </Text>Glória
              Patri...
            </Text>
            <Text className="vernacular">
          ...
          <Language>
            <Text className="latin">
              ...
              est déxtera tua. <Text className="latin">Ps. ibid., 2</Text>{" "}
              Magnus Dóminus, et laudábilis nimis: in civitáte Dei nostri, in
              monte sancto ejus.<Text className="versicle"> ℣. </Text>Gloria
              Patri...
            </Text>
            <Text className="vernacular">
              ...
              justiça. <Text className="vernacular">Sl. ibid., 2</Text> O Senhor
              é grande e digno de todos os louvores, na cidade do nosso Deus, na
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              vultis. Ecce, venit, dicit Dóminus exercítuum: et quis póterit
              cogitáre diem advéntus ejus, et quis stabit ad vidéndum eum? Ipse
              enim quasi ignis conflans et quasi herba fullónum: et sedébit
              conflans et emúndans argéntum, et purgábit fílios Levi et colábit
              eos quasi aurum et quasi argéntum: et erunt Dómino offeréntes
              sacrifícia in justítia. Et placébit Dómino sacrifícium Juda et
            ...
            <Text className="vernacular">
              ...
              que Ele vem, diz o Senhor dos Exércitos. Mas quem poderá adivinhar
              o dia da sua vinda? Quem estará lá para O ver? Pois Ele será como
              o fogo, que funde os metais, ou como a erva, de que se servem os
              lavandeiros. Assentar-se-á como um homem que funde e limpa a
              prata; purificará os filhos de Levi e os tornará limpos, como o
              ouro ou a prata, e oferecerão ao Senhor sacrifícios de justiça. E
              o sacrifício de Judá e de Jerusalém será agradável ao Senhor, como
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="versicle"> ℣. </Text>Sicut audívimus, ita et
              vídimus m civitáte Dei nostri, in monte sancto ejus.
            </Text>
            <Text className="vernacular">
              Recebemos, ó Deus, a vossa misericórdia no meio do vosso templo.
            ...
            <Text className="latin">
              Allelúja, allelúja.<Text className="versicle"> ℣. </Text>Senex
              Púerum portábat: Puer autem senem regébat. Allelúja.
            </Text>
            <Text className="vernacular">
          ...
          <Language>
            <Text className="latin">
              ...
              salutáre tuum.<Text className="versicle"> ℣. </Text>Quod parásti
            ...
            <Text className="vernacular">
              ...
              <Text className="versicle"> ℣. </Text>Pois os meus olhos já viram
              a vossa salvação:<Text className="versicle"> ℣. </Text>Que
              preparastes diante dos olhos de todos os povos.
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              masculínum adapériens vulvam sanctum Dómino vocábitur. Et ut
              darent hóstiam, secúndum quod dictum est in lege Dómini, par
              túrturum aut duos pullos columbárum. Et ecce, homo erat in
              Jerúsalem, cui nomen Símeon, et homo iste justus et timorátus,
              exspéctans consolatiónem Israël, et Spíritus Sanctus erat in eo.
              Et respónsum accéperat a Spíritu Sancto, non visúrum se mortem,
              nisi prius vidéret Christum Dómini. Et venit in spíritu in
              templum. Et cum indúcerent púerum Jesum parentes ejus, ut fácerent
              secúndum consuetúdinem legis pro eo: et ipse accépit eum in ulnas
              suas, et benedíxit Deum, et dixit: Nunc dimíttis servum tuum,
              Dómine, secúndum verbum tuum in pace: Quia vidérunt óculi mei
            ...
            <Text className="vernacular">
              ...
              masculino, quando nascer, será consagrado ao Senhor», e para darem
              a oferta, segundo o que está escrito na lei do Senhor: «Um par de
              rolas ou dois pombinhos». Ora havia em Jerusalém um homem, chamado
              Simeão, que era justo, temente a Deus e esperava a consolação de
              Israel; e no qual habitava o Espírito Santo, que lhe inspirara que
              não haveria de morrer sem que visse o Ungido do Senhor. Veio,
              então, ao templo, conduzido pelo Espírito; e, como os Pais
              conduzissem o Menino Jesus para que n’Ele se cumprisse o que a lei
              ordenava, tomou Simeão o Menino nos braços e louvou a Deus,
              dizendo: «Agora, Senhor, deixai ir em paz o vosso servo, segundo a
              vossa palavra, pois os meus olhos já viram o vosso Salvador, que
