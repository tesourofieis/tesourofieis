...
export default function Page0206() {
  return (
    <SafeAreaView className="flex-1">
      <ScrollView>
        <View className="docs">
          <Text className="h1">S. Tito, B. e Conf., a 6 de Fevereiro</Text>
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              operárii autem pauci. Rogáte ergo Dóminum messis, ut mittat
              operários in messem suam. Ite: ecce, ego mitto vos sicut agnos
              inter lupos. Nolíte portáre sǽculum neque peram neque calceaménta;
              et néminem per viam salutavéritis. In quamcúmque domum
              ...
              revertátur. In eádem autem domo manéte, edéntes et bibéntes quæ
              apud illos sunt: dignus est enim operárius mercéde sua. Nolíte
              transíre de domo in domum. Et in quamcúmque civitátem
              intravéritis, et suscéperint vos, manducáte quæ apponúntur vobis:
            ...
            <Text className="vernacular">
              ...
              operários são poucos; pedi, pois ao Senhor da messe que mande mais
              operários para a messe. Ide; eis que vos envio como cordeiros para
              o meio dos lobos; não leveis bolsa, nem saco, nem saudeis ninguém
              pelo caminho. Em qualquer casa em que entrardes, dizei em primeiro
              lugar: «A paz esteja nesta casa»! Se aí houver um filho da paz, a
              vossa paz repousará nele; e, se não um houver, voltará para vós.
              Permanecei na mesma casa e comei e bebei do que houver nessa casa,
              pois o operário merece salário. Não transiteis de casa para casa.
              Em qualquer casa em que entrardes e vos receberem comei do que vos
