        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              <Text className="latin">Ib., 20</Text> Non est invéntus símilis
              illi, qui conserváret legem Excélsi.
            </Text>
            <Text className="vernacular">
              Eis o sumo sacerdote, que nos dias da sua vida agradou a Deus.
              <Text className="versicle"> ℣. </Text>
              <Text className="vernacular">Ib., 20</Text> Não foi encontrado
              outrem que o igualasse na observância da lei do Altíssimo.
            </Text>
            <Text className="latin">
              Allelúja, allelúja.<Text className="versicle"> ℣. </Text>
              <Text className="latin">Joann. 10, 14</Text> Ego sum pastor bonus:
              et cognósco oves meas, et cognóscunt me meæ. Allelúja.
            </Text>
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
              <Text className="vernacular">Jo. 10, 14</Text> Eu sou o bom
