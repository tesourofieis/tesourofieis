    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          per quem mihi mundus crucifíxus est, et ego mundo. <em>Ps. 141, 2</em>{" "}
        ...
        <p>
          ...
          estou para o mundo! <em>Sl. 141, 2</em> Elevei a minha voz ao Senhor:
          dirigi ao Senhor a minha voz suplicante! ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          Aleluia, aleluia. ℣. Francisco, pobre e humilde, entra rico no céu: em
          sua honra ressoam hinos celestiais. Aleluia.
        </p>
      </div>
