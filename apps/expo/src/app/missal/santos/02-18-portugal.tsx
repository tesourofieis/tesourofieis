    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          Jerusalém. <Text className="vernacular">Sl. 121, 1</Text> Senti muita
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>
          <Text className="latin">Ps. 19, 10</Text> Dómine, salvum fac regem et
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">Sl. 19, 10</Text> Senhor, salvai o rei e
          ouvi-nos no dia em que Vos invocarmos.
        </Text>
        <Text className="latin">
          Allelúja, allelúja.<Text className="versicle"> ℣. </Text>
          <Text className="latin">Ps. 115, 18-19</Text> Vota mea Dómino redam in
      ...
      <Language>
        <Text className="latin">
          <Text className="latin">Sl. 115, 16</Text>Dirupísti víncula mea: tibi
        ...
        <Text className="vernacular">
          <Text className="vernacular">Sl. 115, 16</Text>Cumprirei os votos que
