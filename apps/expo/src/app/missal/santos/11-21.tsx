  ...
  return (
    <PageWrapper>
      ...
      <Text className="comment">
        ...
        Apresentação no Templo da abençoada menina. Essas três primeiras festas
        do Ciclo Mariano fazem eco ao Ciclo Cristológico que celebra a festa do
        Natal de Jesus a 25 de Dezembro, a imposição do Santo Nome a 2 de
        Janeiro e a sua Apresentação no Templo a 2 de Fevereiro. A festa da
        Apresentação de Maria repousa sobre uma piedosa tradição, oriunda de
        dois Evangelhos apócrifos nos quais se conta ter sido a Santíssima
        Virgem apresentada no templo de Jerusalém, com a idade de três anos, e
        ter ali vivido com outras donzelas, dirigidas pelas santas mulheres. No
        século VI, comemorava-se esse facto no Oriente, e o imperador bizantino
        Miguel Commeno o menciona numa constituição em 1166. Um cavalheiro
        francês, de nome Philippe de Maizières, adido à corte do rei de Chipre,
        na qualidade de chanceler, tendo sido enviado em 1372, como embaixador
        junto ao Papa Gregorio XI, em Avignon, narrou-lhe com que magnificência
        era celebrada essa festa na Grécia, no dia de Novembro, Sua Santidade
