  ...
  return (
    <div className="docs">
      ...
      <aside>
        ...
        das armas o seduziu. No cerco de Pampelona foi gravemente ferido na
        perna. Durante a longa convalescença. por falta de livros de cavalaria
        que o apaixonavam, deram-lhe para ler a vida de Jesus Cristo e a dos
        Santos. Tal leitura foi para ele uma revelação. Compreendeu que a Igreja
        também possui a sua milícia, a qual, sob as ordens do representante de
        Cristo, luta para defender na terra os interesses sagrados do Deus dos
        exércitos. Na célebre Abadia dos Beneditinos de Montserrat, Inácio depõe
        a espada aos pés da SS Virgem e sua alma generosa, outrora seduzida pela
        glória mundana, não mais aspira senão pela maior glória do grande Rei
        que de ora em diante servirá (Or.). Na noite de 25 de Março, festa do
        mistério da Encarnação do Verbo, depois da confissão de suas faltas, faz
        a vigília de armas e, pela Mãe de Deus, é criado cavaleiro de Cristo e
        ...
        conservar em seus filhos a intensa vida interior que supõe a actividade
        militante à qual os destina, Santo Inácio lhes dá uma forte hierarquia,
        e lhes ensina, em tratado magistral altamente aprovado pela Igreja, seu
        Exercícios Espirituais que têm santificado a milhares de almas.
        Afirmou-se ter sido a prática do Exercitatorium do Abade Beneditino
        Gisneros, de Montserrat (ano 1500) que lhe inspirou essa ideia. Guiado
        pela graça, realizou-o, entretanto, de maneira diferente e muito pessoal
        em Manrese. Santo Inácio arma seus filhos dando-lhes por escudo o nome
        de Jesus (Intr.), como couraça o amor de Deus, que o Salvador veio
        acender na terra (Com.), cujo símbolo o Sagrado Coração, eles trazem
        gloriosamente nas dobras de sua bandeira, tendo por espada a palavra e a
        pena,o ensino e o apostolado sob todas as formas. Num mosteiro
        beneditino, na Espanha, no dia da Anunciação, Santo Inácio organiza suas
        primeiras armas; na capela da Abadia beneditina de Montmartre, na festa
        da Anunciação do ano 1534, e mais tarde no altar da SS Virgem da
        Basílica de São Paulo fora dos muros, servida pelos filhos de São Bento,
        nasce a Companhia de Jesus, nobre cavalaria de Cristo. Foi, finalmente o
        ...
        ocuparem mais livremente dos interesses de Deus e para lhe darem essa
        totalidade de glória acidental, cujo uso, pelos homens, de coisas
      ...
      <div className="side-by-side">
        <p>
          ...
          in glória est Dei Patris. <em>Ps. 5, 12-13</em> Gloriabúntur in te
          omnes, qui díligunt nomen tuum: quóniam tu benedíces justo. ℣. Gloria
          Patri...
        </p>
        <p>
          ...
          <em>Sl. 5, 12-13</em> Em Vós serão glorificados todos aqueles que amam
          o vosso nome, pois abençoais o justo. ℣. Glória ao Pai...
        </p>
      </div>
