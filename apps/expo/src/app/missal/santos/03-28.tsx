    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          eum.<Text className="versicle"> ℣. </Text>Timeat eum omne semen
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>Tema-O toda a geração de Israel:
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">Judith 16, 3</Text> Dóminus cónterens bella:
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>O Senhor mostrou-se um guerreiro
          invencível: o seu nome é omnipotente.
          <Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Jdt. 16, 3</Text> O Senhor é o vencedor
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>Quia factus es suscéptor meus,
          et refúgium meum in die tribulatiónis meæ. Allelúja.
        </Text>
        <Text className="vernacular">
          Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Sl. 58, 17</Text> Eu, porém, cantarei a
          vossa fortaleza e regozijar-me-ei desde manhã com vossa misericórdia.
          Aleluia.<Text className="versicle"> ℣. </Text>Pois fostes o meu
