...
export default function Page0727() {
  return (
    <div className="docs">
      ...
      <h3>Oração</h3>
      <aside>Na Diocese do Porto</aside>Ó Deus, que permitistes que o B.
      Pantaleão, vosso Mártir, sofresse vários tormentos e orasse pelos seus
      perseguidores, concedei-nos propício que, implorando o seu auxílio,
