        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">Ps. ibid., 1-2</Text> Jubiláte Deo, omnis
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. ibid., 1-2</Text> Povos de toda a
            ...
            <Language>
              <Text className="latin">
                ...
                laudis, et nomem Dómini invocábo. Allelúja.
                <Text className="versicle"> ℣. </Text>Confitébor tibi, quóniam
                exaudísti me: et factus es mihi in salútem. Allelúja.
              </Text>
              <Text className="vernacular">
                Aleluia, aleluia.<Text className="versicle"> ℣. </Text>Rompestes
                os meus laços, ó meu Deus, a vós oferecerei o sacrifício de
                louvor, e invocarei o nome do Senhor. Aleluia.
