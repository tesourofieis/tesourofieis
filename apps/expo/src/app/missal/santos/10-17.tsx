...
export default function Page1017() {
  return (
    <PageWrapper>
      <Text className="h1">Santa Margarida Maria, Virgem, a 17 de Outubro</Text>
      ...
      <Language>
        <Text className="latin">
          ...
          gútturi meo. <Text className="latin">Ps. 83, 2-3</Text> Quam dilécta
          tabernácula tua, Dómine virtútum! concupíscit, et déficit ánima mea in
          átria Dómini.<Text className="versicle"> ℣. </Text>
          Gloria Patri...
        </Text>
        <Text className="vernacular">
          Assentei-me à sombra daquele que eu desejara: e o seu fruto é doce ao
          meu paladar. <Text className="vernacular">Sl. 83, 2-3</Text> Como são
      ...
      <Language>
        <Text className="latin">
          ...
          illam.<Text className="versicle"> ℣. </Text>
        ...
        <Text className="vernacular">
          ...
          submergiram.<Text className="versicle"> ℣. </Text>
        ...
        <Text className="latin">
          ...
          <Text className="latin">Cant. 7, 10</Text> Ego dilécto meo, et ad me
          conversio ejus. Allelúja.
        </Text>
        <Text className="vernacular">
          Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Ct. 7, 10</Text> Eu sou para o meu muito
