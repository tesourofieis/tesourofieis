    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          operou maravilhas. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Senhor, ó povos de toda a terra! ℣. O Senhor manifestou o Salvador que
          havia prometido: e manifestou a sua justiça aos olhos dos povos.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Hebr. 1, 1-2</em> Multifárie olim Deus
        ...
        <p>
          ...
          diversas maneiras pelos Profetas, dignou-se falar-nos nos últimos
          tempos pelo seu Filho. Aleluia.
        </p>
      </div>
