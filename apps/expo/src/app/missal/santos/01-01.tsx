...
export default function Page0101() {
  return (
    <SafeAreaView className="flex-1">
      <ScrollView>
        <View className="docs">
          <Text className="h1">Circuncisão do Senhor e Oitava do Natal</Text>
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              se ofereceu espontaneamente por nós, para nos resgatar de toda a
              iniquidade e tornar-nos numa raça purificada, escolhida e zelosa
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              pois, o Senhor, ó povos de toda a terra!
              <Text className="versicle"> ℣. </Text>O Senhor manifestou o
