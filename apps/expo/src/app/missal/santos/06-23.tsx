    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          et multi in nativitáte ejus gaudébunt. <em>Ps. 20, 2</em> Dómine, in
        ...
        <p>
          ...
          Muitos se regozijarão com seu nascimento. <em>Sl. 20, 2</em> Senhor,
      ...
      <div className="side-by-side">
        ...
        <p>
          Foi enviado por Deus um homem que se chamava João. ℣. Ele veio para
          dar testemunho da luz e preparar um povo perfeito para o Senhor.
        </p>
      </div>
