        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">Ps. 72, 1</Text> Quam bonus Israël Deus
            ...
            <Text className="vernacular">
              ...
              Deus. <Text className="vernacular">Sl. 72, 1</Text> Como Deus é
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              cáritas Patris in eo: quóniam omne, quod est in mundo,
              concupiscéntia carnis est, et concupiscéntia oculórum, et supérbia
              vitæ: quæ non est ex Patre, sed ex mundo est. Et mundus transit et
            ...
            <Text className="vernacular">
              ...
              possui o amor de Deus, pois tudo quanto há no mundo é
              concupiscência da carne, dos olhos e soberba da vida. Ora isto não
              vem do Pai, mas do mundo. O mundo passa, assim como a sua
          ...
          <Language>
            <Text className="latin">
              ...
              eis, qui sperant in te, in conspéctu filiórum hóminum.
            </Text>
            <Text className="vernacular">
              Como é grande, Senhor, a vossa bondade, que reservais para aqueles
              que Vos temem!<Text className="versicle"> ℣. </Text>Encheis de
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="versicle"> ℣. </Text>Elegi abjéctus esse in domo
              Dei mei: magis quam habitáre in tabernáculis peccatórum.
              <Text className="versicle"> ℣. </Text>Non privábit bonis eos, qui
              ámbulant in innocéntia: Dómine virtútum, beátus homo, qui sperat
              in te.
            </Text>
            <Text className="vernacular">
              Bem-aventurado o homem de quem sois o auxílio: dispôs o seu
              coração para ascender incessantemente para Vós neste vale de
              lágrimas, onde Deus o colocou.
              <Text className="versicle"> ℣. </Text>
              Antes quis ser desprezível na Casa do Senhor do que habitar nas
              tendas dos pecadores.<Text className="versicle"> ℣. </Text>Não
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              et ne prohibuéritis eos: tálium enim est regnum Dei. Amen, dico
              vobis: Quisquis non recéperit regnum Dei velut párvulus, non
              intrábit in illud. Et cotnpléxans eos et impónens manus super
              illos, benedicébat eos. Et cum egréssus esset in viam, procúrrens
              quidam genu flexo ante eum, rogábat eum: Magíster bone, quid
              fáciam, ut vitam ætérnam percípiam? Jesus autem dixit ei: Quid me
              dicis bonum? Nemo bonus, nisi unus Deus. Præcépta nosti: Ne
              adúlteres, Ne occídas, Ne furóris, Ne falsum testimónium díxeris,
              Ne fraudem féceris, Hónora patrem tuum et matrem. At ille
              respóndens, ait illi: Magíster, hæc ómnia observávi a juventúte
              mea. Jesus autem intúitus eum, diléxit eum et dixit ei: Unum tibi
            ...
            <Text className="vernacular">
              ...
              mim estes pequenos e os não proibais disso, porque de tais é o
              reino de Deus. Em verdade vos digo: Todo aquele que não receber o
              reino de Deus, como um menino, não entrará nele». E, abraçando-os
              e pondo as mãos sobre eles, abençoava-os. Então, havendo saído,
              para começar sua jornada, correu um certo jovem ao seu encontro e,
              ajoelhando diante d’Ele, perguntou-lhe: «Bom Mestre, que deverei
              fazer para alcançar a vida eterna?». Jesus disse-lhe: «Porque me
              chamais bom? Ninguém é bom senão só Deus. Tu conheces os
              mandamentos: não cometas adultério; não mates; não furtes; não
              digas falso testemunho; não cometas fraudes; honra teu pai e tua
              mãe». Então, respondendo o jovem, disse-Lhe: «Tudo isso tenho
              observado desde a minha juventude». E Jesus fitou-o, mostrou-lhe
              amizade e disse-lhe: «Uma coisa te falta; vai, vende tudo quanto
