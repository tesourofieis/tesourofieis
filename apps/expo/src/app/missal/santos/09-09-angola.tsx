  ...
  return (
    <PageWrapper>
      ...
      <Text className="vernacular">
        ...
        têm fome; hospedai em vossa casa os pobres e os peregrinos; quando
      ...
      <Text className="vernacular">
        ...
        seus nomes serão respeitados diante dele. Aleluia, aleluia. Erguei-Vos,
      ...
      <Text className="vernacular">
        ...
        de Jerusalém para Jericó, caiu em poder dos ladrões, que o despojaram e
        feriram; depois, abandonaram-no Semimorto. Passou por aquele caminho um
        sacerdote, que viu o ferido e continuou a sua jornada. Passando também
        por ali um levita, viu igualmente o ferido, aproximou-se um pouco e
        seguiu a sua viagem. Por fim, viajando por ali um samaritano, passou
        perto do ferido, viu-o e encheu-se de Compaixão. Logo, aproximou-se
        dele, deitou óleo e vinho nas feridas, cingiu-as, montou-o no seu
        próprio jumento, conduziu-o a uma hospedaria e cuidou dele. No outro
        dia, tirou dois dinheiros da sua bolsa, deu-os ao hospedeiro e
        disse-lhe: «Cuida deste homem; e tudo o mais que gastares eu te pagarei
        quando aqui voltar». «Ora», perguntou Jesus ao doutor, «qual destes três
        te parece ser o próximo do homem que caiu em poder dos ladrões?». O
