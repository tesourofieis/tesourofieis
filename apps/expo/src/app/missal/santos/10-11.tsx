    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          Emmánuel. <em>Ps. 97, 1</em> Cantáte Dómino cánticum novum: quia
          mirabília fecit. ℣. Gloria Patri...
        </p>
        <p>
          Eis que a virgem conceberá e dará à luz um Filho, cujo nome será
          Emanuel. <em>Sl. 97, 1</em> Cantai ao Senhor um cântico novo, porque
          Ele praticou maravilhas. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          Sairá uma vara do tronco de Jessé e uma flor brotará da sua raiz. ℣. E
          o espírito do Senhor repousará sobre ela.
        </p>
        <p>
          Allelúja, allelúja. ℣. Virgo Dei Génitrix, quem totus non capit orbis,
          in tua se clausit víscera factus homo. Allelúja.
        </p>
        <p>
