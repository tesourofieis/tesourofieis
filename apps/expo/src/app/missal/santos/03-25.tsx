    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          exsultatióne. (T. P. Allelúja, allelúja.) <em>Ps. ib., 2</em>{" "}
        ...
        <p>
          ...
          aleluia). <em>Sl. ib., 2</em> Meu coração exprimiu uma palavra
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          homínibus, quia molésti estis et Deo meo? Propter hoc dabit Dóminus
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          para a eternidade. ℣. Reinareis pela verdade, mansidão e justiça; e a
          vossa dextra conduzir-vos-á admiravelmente.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          speciem tuam. ℣. <em>ibid., 13 & 10</em> Vultum tuum deprecabúntur
          omnes dívites plebis: fíliæ regum in honóre tuo. ℣.{" "}
          <em>ibid., 15-16</em> Adducántur Regi Vírgines post eam: próximæ ejus
          afferéntur tibi. ℣. Adducántur in lætítia et exsultatióne: adducántur
          in templum Regis.
        </p>
        <p>
          Ouvi, minha filha, vede e abri os vossos ouvidos; pois o Rei está
          extasiado com vossa formosura. ℣. <em>ibid., 13 & 10</em> Todos os
          poderosos da terra implorarão os vossos olhares; as filhas dos reis
          formarão a vossa corte de honra. ℣. <em>ibid., 15-16</em> As virgens
          serão apresentados ao Rei após ela: as suas companheiras ser-vos-ão
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Luc. 1, 28</em> Ave, María, grátia plena;
          Dóminus tecum: benedicta tu in muliéribus. Allelúja. ℣.{" "}
          <em>Num. 17, 8</em> Virga Jesse flóruit: Virgo Deum et hóminem génuit:
          pacem Deus réddidit, in se reconcílians ima summis. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Lc. 1, 28</em> Ave, Maria: o Senhor é
          convosco. Bendita sois Vós entre as mulheres. Aleluia. ℣.{" "}
          <em>Nm. 17, 8</em> A vara de Jessé floresceu e a Virgem deu à luz o
          Homem-Deus: restabeleceu Deus a paz, reconciliando na sua pessoa a
          nossa baixeza com a suprema grandeza. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          tua parente, concebeu um filho na sua velhice: este é o sexto mês
