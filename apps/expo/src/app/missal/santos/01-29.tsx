  ...
  return (
    <PageWrapper>
      ...
      <Text className="comment">
        ...
        Encarnado (Grad.) e operou como Ele, por sua doce caridade, (Or.)
        prodígios de conversão. Enviado a «pregar a palavra de Deus (Ep.) aos
        Calvinistas do Chablais, restituiu à fé católica sessenta mil desses
        hereges» (Breviário). Consagrado Bispo de Genebra e fundador da Ordem da
        Visitação, irradiou, sobre essa dupla familia (Com.), a influência de
        seu zelo apostólico e doce santidade. «Brilhe a vossa luz diante dos
        homens, céus» (Ev.). O Santo revelou especialmente a bondade de Deus.
        «Se houver algum excesso, dizia S. Francisco de Sales, antes seja do
        lado da doçura». «Quero amá-lo tanto, esse querido próximo, que amá-lo
        tanto! aprouve a Deus assim fazer o meu coração! Ah! quando estaremos
        todos embebidos na doçura e caridade para com o próximo?» S. Francisco
