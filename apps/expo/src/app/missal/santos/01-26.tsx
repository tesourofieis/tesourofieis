  ...
  return (
    <PageWrapper>
      ...
      <Typography className="comment">
        ...
        liturgia nos faz ler hoje a passagem. «Aquele que, declara ele após S.
        João, não confessa ter vindo o Cristo na carne, é um anticristo». Ele,
        pois, reivindica para Jesus a realidade de seu título de Filho de Deus,
        contra os hereges de seu tempo que afirmavam ser a Encarnação do Verbo
        apenas aparente. Um dia, perguntando o herege Marcião se o conhecia, o
        santo Bispo respondeu: «que o conhecia como sendo o primogénito de
        Satanás». A Epístola de hoje estabelece o meio de distinguir «os filhos
        de Deus daqueles que são filhos do diabo». Aqueles que, à semelhança de
        Cristo, amam os irmãos e, como Ele dão, a vida por eles, são de Deus.
        Assim fará S. Policarpo. Vítima da perseguição sob o imperador na idade
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          et occídit fratrem suum. Et propter quid occídit eum? Quóniam ópera
          ejus malígna erant: fratris autem ejus justa. Nolíte mirári fratres,
          si odit vos mundus. Nos scimus quóniam transláti sumus de morte ad
          vitam, quóniam dilígimus fratres. Qui non díligit, manet in morte:
          omnis qui odit fratrem suum, homicída est. Et scitis, quóniam omnis
        ...
        <Typography className="vernacular">
          ...
          qual matou o seu irmão. E porque o matou ele? Porque as suas obras
          eram más, enquanto que as do seu irmão eram justas. Não vos admireis,
          irmãos, se o mundo vos odeia; porquanto sabemos que passamos da morte
          à vida, porque amamos os nossos irmãos. Aquele que não ama permanece
          na morte. Aquele que odeia o seu irmão é um homicida. E vós sabeis que
