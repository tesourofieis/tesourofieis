...
export default function Page1221() {
  return (
    <PageWrapper>
      <Text className="h1">Vigília S. Tomé, Apóstolo, a 20 de Dezembro</Text>
      ...
      <Text className="comment">
        ...
        continuamente a palavra de Cristo e gozar de sua intimidade. «Eu vos
        chamei amigos porque tudo o que tenho ouvido de meu Pai, vos fiz
        conhecer». «Deus, acrescenta a Epístola, o escolheu entre todos os
        homens; deu-lhe os seus mandamentos, a lei de vida e ciência, e o
        elevou». O Ofertório declara-o escolhido por Jesus para ser um dos doze
        Príncipes, a governar a sua Igreja. «O Senhor, diz ainda a Epístola,
