      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="comment">
            ...
            por este divino nome» (Oração). Descendente de nobre familia de
            Sena, Bernardino renunciou a todos os seus bens, guardando intacta a
            castidade, apesar dos perigos provenientes da rara beleza de seus
            traços. A Igreja aplica-lhe estas palavras dos nossos Santos Livros:
            «podia violar o Mandamento de Deus e não o violou» (Epístola). «Não
            colocando sua esperança no dinheiro, nem nos tesouros» (idem),
            deixou tudo, a fim de seguir o Cristo (Evangelho) e entrou para a
            Ordem de S. Francisco, sendo uma das suas glórias. Percorrendo as
            cidades e aldeias, a todos pregava o nome de Jesus (Oração),
            operando inúmeros milagres. S. Pedro Celestino lhe apareceu,
            avisando-o da sua próxima morte, ocorrida na vigília da Ascensão, do
