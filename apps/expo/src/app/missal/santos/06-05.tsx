        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              audívimus: patres nostri narravérunt opus, quod operátus es in
              diébus eórum.<Text className="versicle"> ℣. </Text>Gloria Patri...
            </Text>
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. 43, 2</Text> Ó Deus, ouvimos com
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              ...
              de alegria.<Text className="versicle"> ℣. </Text>Se sois
              ultrajados por causa do nome de Cristo, sereis bem-aventurados;
              pois a honra, a glória e a virtude de Deus e o seu Espírito
              repousarão sobre vós.
            </Text>
            <Text className="latin">
              Allelúja, allelúja.<Text className="versicle"> ℣. </Text>
              <Text className="latin">Is. 66, 12</Text> Declinábo super eum
              quasi flúvium pacis, et quasi torréntem inundántem glóriam.
              Allelúja.
            </Text>
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
              <Text className="vernacular">Is. 66, 12</Text> Farei correr sobre
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              Jerúsalem, et exsultáte in ea, omnes, qui dilígitis Dóminum.
              Allelúja.<Text className="versicle"> ℣. </Text>Vidébitis, et
              gaudébit cor vestrum: cognoscétur manus Dómini servis ejus.
              Allelúja.
            </Text>
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
              ...
              <Text className="versicle"> ℣. </Text>Vereis e alegrar-se-á o
