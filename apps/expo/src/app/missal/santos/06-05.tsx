    ...
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">Ps. 43, 2</Typography> Deus, áuribus
          nostris audívimus: patres nostri narravérunt opus, quod operátus es in
          diébus eórum.<Typography className="versicle"> ℣. </Typography>Gloria
          Patri...
        </Typography>
        <Typography className="vernacular">
          ...
          (T. P. Aleluia, aleluia.){" "}
          <Typography className="vernacular">Sl. 43, 2</Typography> Ó Deus,
          ouvimos com os nossos ouvidos; os nossos pais contaram-nos o que
          fizestes nos seus dias.
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="versicle"> ℣. </Typography>Si exprobrámini in
          nómine Christi, beáti éritis: quóniam, quod est honóris, glóriæ et
        ...
        <Typography className="vernacular">
          ...
          alegria.<Typography className="versicle"> ℣. </Typography>Se sois
          ultrajados por causa do nome de Cristo, sereis bem-aventurados; pois a
          honra, a glória e a virtude de Deus e o seu Espírito repousarão sobre
          vós.
        </Typography>
        <Typography className="latin">
          Allelúja, allelúja.<Typography className="versicle"> ℣. </Typography>
          <Typography className="latin">Is. 66, 12</Typography> Declinábo super
          eum quasi flúvium pacis, et quasi torréntem inundántem glóriam.
          Allelúja.
        </Typography>
        <Typography className="vernacular">
          Aleluia, aleluia.<Typography className="versicle"> ℣. </Typography>
          <Typography className="vernacular">Is. 66, 12</Typography> Farei
      ...
      <Language>
        <Typography className="latin">
          Allelúja, allelúja.<Typography className="versicle"> ℣. </Typography>
          <Typography className="latin">Is. 66, 10 & 14</Typography> Lætámini
          cum Jerúsalem, et exsultáte in ea, omnes, qui dilígitis Dóminum.
          Allelúja.
          <Typography className="versicle"> ℣. </Typography>Vidébitis, et
          gaudébit cor vestrum: cognoscétur manus Dómini servis ejus. Allelúja.
        </Typography>
        <Typography className="vernacular">
          Aleluia, aleluia.<Typography className="versicle"> ℣. </Typography>
          <Typography className="vernacular">Is. 66, 10 & 14</Typography>{" "}
          Alegrai-vos e exultai com Jerusalém, ó vós, que amais o Senhor.
          Aleluia.
          <Typography className="versicle"> ℣. </Typography>Vereis e
          alegrar-se-á o vosso coração. A mão do Senhor manifestar-se-á nos seus
          servos. Aleluia.
        </Typography>
      </Language>
