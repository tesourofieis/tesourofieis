    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">ibid., 26-27</Text> Múlier, ecce fílius tuus:
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">ibid., 26-27</Text> «Mulher disse Jesus
          eis o vosso Filho»; e, dirigindo-se ao discípulo, disse: «Eis a tua
          Mãe».<Text className="versicle"> ℣. </Text>Glória ao Pai...
        </Text>
      </Language>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>Virgo Dei Génetrix, quem totus
        ...
        <Text className="latin">
          Allelúja, allelúja.<Text className="versicle"> ℣. </Text>Stabat sancta
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>
          <Text className="latin">Thren. 1, 12</Text> O vos omnes, qui tránsitis
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Lm. 1, 12</Text> Ó vós todos, que passais
