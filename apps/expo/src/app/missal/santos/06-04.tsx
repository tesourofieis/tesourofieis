        ...
        <View className="docs">
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. 72, 1</Text> Como Deus é bom para
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">Ps. ibid., 3</Text> Sitívit ánima mea ad
              Deum fortem vivum.
            </Text>
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. ibid., 3</Text> Minha alma tem
              sede de Deus forte e vivo.
            </Text>
            <Text className="latin">
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              aquele que escolhestes e elevastes, para que habitasse nos vossos
              átrios. Aleluia.<Text className="versicle"> ℣. </Text>
