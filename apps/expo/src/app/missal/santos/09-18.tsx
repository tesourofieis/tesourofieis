...
export default function Page0918() {
  return (
    <PageWrapper>
      ...
      <Typography className="em">Ecl. 1, 14-15</Typography>
      ...
      <Typography className="em">1 Cor. 13, 1-8</Typography>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          <Typography className="vernacular">Ecl. 11, 13</Typography> Deus olhou
      ...
      <Typography className="em">Sl. 34, 13</Typography>
      ...
      <Typography className="em">Sl. 68, 30-31</Typography>
