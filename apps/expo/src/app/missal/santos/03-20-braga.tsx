  ...
  return (
    <PageWrapper>
      ...
      <Text className="text-base">
        ...
        assim, resolvi tomá-la para minha luz, pois o seu brilho não tem ocaso.
        Todos os bens me vieram dela e recebi das suas mãos inumeráveis
        riquezas. Regozijei-me em todas as coisas, pois a sabedoria guiava-me, e
        eu ignorava que ela era a mãe de todos os bens. Conheci a sabedoria sem
