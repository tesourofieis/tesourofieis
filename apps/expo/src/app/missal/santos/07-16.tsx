      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="comment">
            ...
            vinda de Jesus por João Baptista, abraçaram a fé cristã e foram os
            primeiros a erigir à Santíssima Virgem um Santuário sobre o Monte
            Carmelo, no mesmo lugar onde Elias tinha outrora visto levantar-se
            uma nuvem, figura da fecundidade da Mãe de Deus. Foram chamados:
            Irmãos da Bem-aventurada Maria do Monte Carmelo (Or.). Esses
            religiosos vieram à Europa, no século XIII e, em 1245, Inocêncio IV
            aprovou-lhes a regra sob o generalato se S. Simão Stock. A 16 de
            Julho de 1251, Maria apareceu a seu ferveroso servo, entregando-lhe
            o hábito que devia ser o sinal distintivo da Ordem. Inocêncio IV,
            abençoou essa veste, concedendo-lhe numerosos privilégios, não só
            para os membros da Ordem, mas também para todos os que entrassem
            para a Confraria de Nossa Senhora do Monte Carmelo. Trazendo o
            escapulário, redução do grande escapulário dos Padres Carmelitas,
            participam eles de todos os seus méritos, e podem esperar da
            Santíssima Virgem pronta libertação do purgatório, se forem fiéis em
            observar a abstinência, a castidade conforme o seu estado de vida e
            as orações prescritas por João XXII na bula dita Sabatina, publicada
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              veritátis: in me omnis spes vitæ et virtútis. Transíte ad me,
              omnes qui concupíscitis me, et a generatiónibus meis implémini.
              Spíritus enim meus super mel dulcis, et heréditas mea super mel et
              favum. Memória mea in generatiónes sæculórum. Qui edunt me, adhuc
              esúrient: et qui bibunt me, adhuc sítient. Qui audit me, non
            ...
            <Text className="vernacular">
              ...
              graça do caminho e da verdade; em mim existe toda a esperança da
              vida e da virtude. Vinde a mim, ó vós, que me desejais com ardor,
              e saciai-vos com meus frutos; pois o meu espírito é mais doce do
              que o mel e a minha herança excede em doçura o próprio favo de
              mel! Minha memória permanecerá nas gerações de todos os séculos.
              Aqueles que me comerem terão ainda fome; e aqueles que me beberem
              terão ainda sede. Aqueles que me escutam não serão confundidos;
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              mancha de impureza, fostes a Mãe do Salvador.
              <Text className="versicle"> ℣. </Text>Ó Virgem, Mãe de Deus,
              Aquele que nem todo o universo é capaz de conter, esteve encerrado
              no vosso seio, fazendo-se homem.
            </Text>
            <Text className="latin">
              Allelúja, allelúja.<Text className="versicle"> ℣. </Text>Per te,
              Dei Génetrix, nobis est vita pérdita data: quæ de cœlo suscepísti
              prolem, et mundo genuísti Salvatórem. Allelúja.
            </Text>
            <Text className="vernacular">
              Aleluia, aleluia.<Text className="versicle"> ℣. </Text>Por vós, ó
              Mãe de Deus, nos foi restituída a vida que havíamos perdido! Vós
