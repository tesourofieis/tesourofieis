    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          lex Dei ejus in corde ipsíus. <em>Ps. ibid., 1</em> Noli æmulári in
        ...
        <p>
          ...
          justiça. A lei do seu Deus está no seu coração. <em>Sl. ibid., 1</em>{" "}
          Não vos irriteis contra os maus, nem tenhais inveja daqueles que
          cometem iniquidades. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          pénnæ eórum exténtæ désuper: duæ pennæ singulórum jungebántur et duæ
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          peccatóribus mánducat Magíster vester? At Jesus áudiens, ait: Non est
        ...
        <p>
          ...
          puseram-se a comer com Ele e com seus discípulos muitos publicanos e
          pecadores. Vendo isto, os fariseus disseram aos discípulos: «Porque
          come o vosso Mestre com os publicanos e pecadores?». Jesus,
          ouvindo-os, disse: «Não são os sãos que necessitam de médico, mas os
