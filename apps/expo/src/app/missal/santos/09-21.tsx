...
export default function Page0921() {
  return (
    <SafeAreaView className="flex-1">
      <ScrollView>
        <View className="docs">
          <Text className="h1">S. Mateus, a 21 de Setembro</Text>
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              eórum et pénnæ eórum exténtæ désuper: duæ pennæ singulórum
              ...
              aspéctus lampadárum. Hæc erat vísio discúrrens in médio animálium,
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              gloriosus Apostolórum chorus laudat, Dómine. Allelúja.
            </Text>
            <Text className="vernacular">
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              peccatóres veniéntes discumbébant cum Jesu et discípulis ejus. Et
              vidéntes pharisǽi, dicébant discípulis ejus: Quare cum publicánis
              et peccatóribus mánducat Magíster vester? At Jesus áudiens, ait:
              Non est opus valéntibus médicus, sed male habéntibus. Eúntes autem
            ...
            <Text className="vernacular">
              ...
              aproximaram-se e puseram-se a comer com Ele e com seus discípulos
              muitos publicanos e pecadores. Vendo isto, os fariseus disseram
              aos discípulos: «Porque come o vosso Mestre com os publicanos e
              pecadores?». Jesus, ouvindo-os, disse: «Não são os sãos que
              necessitam de médico, mas os que estão enfermos. Ide, pois, e
