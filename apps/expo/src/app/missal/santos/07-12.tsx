  ...
  return (
    <div className="docs">
      ...
      <aside>
        ...
        lançando-se a seus pés, implorou-lhe o perdão pelo amor de Jesus
        crucificado. João lembrou-se da palavra de amor do Evangelho e o abraçou
        como a um irmão. Movido por graça ainda mais viva, revestiu o hábito
        monástico e, em breve, legislador como Moisés (Ep.) fundou em Val
        Umbrosa (Toscana) uma nova Ordem, à qual deu a regra de S. Bento (Com.)
        e que ainda hoje floresce, após mais de oito séculos de existência. A
        simonia reinava em toda a parte na Itália. Sua firmeza e eloquência
        baniram essa desordem da Etruria e levaram novamente sua pátria à
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          vos, et oráte pro persequéntibus et calumniántibus vos, ut sitis fílii
        ...
        <p>
          ...
          odeiam; rezai pelos que vos perseguem e caluniam, a fim de que sejais
          filhos do vosso Pai, que está nos céus, o qual faz nascer o sol para
          os maus e bons e chover para os justos e injustos. Se amais os que vos
          amam, que recompensa mereceis? Não procedem do mesmo modo os
