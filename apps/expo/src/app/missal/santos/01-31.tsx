        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              in Dómino, et dabit tibi petitiónes cordis tui; revéla Dómino viam
              tuam et spera in eo, et ipse fáciet.
            </Text>
            <Text className="vernacular">
              Espera no Senhor e pratica obras boas: então habitarás na terra e
              te sustentarás com suas riquezas.
          ...
          <Language>
            <Text className="latin">
              ...
              tuo in sǽcula: prótegar in velaménto alárum tuárum.
            ...
            <Text className="vernacular">
              ...
              <Text className="versicle"> ℣. </Text>Habitarei eternamente no
              vosso tabernáculo: abrigar-me-ei à sombra das vossas asas.
