  ...
  return (
    <PageWrapper>
      ...
      <Typography className="comment">
        ...
        de suas viagens. São Timóteo, imediatamente, tudo abandonado, tornou-se
        o discípulo de S. Paulo (Ev.), o qual lhe conferiu a plenitude do
        sacerdócio (Intr.) e confiou-lhe o governo da Igreja de Éfeso. Na
        Epístola lemos a passagem de uma das duas admiráveis cartas que lhe
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          téstibus. Præcípio tibi coram Deo, qui vivíficat ómnia, et Christo
          Jesu, qui testimónium réddidit sub Póntio Piláto, bonam confessiónem:
          ut serves mandátum sine mácula, irreprehensíbile usque in advéntum
          Dómini nostri Jesu Christi, quem suis tempóribus osténdet beátus et
        ...
        <Typography className="vernacular">
          ...
          fizestes esta boa profissão de fé diante de muitos testemunhos. Eu vos
          ordeno diante de Deus, que dá a vida a todas as coisas, e perante
          Jesus Cristo, que deu testemunho por uma boa profissão de fé, sob
          Pôncio Pilatos, que oportunamente mostrará o Bem-aventurado e o único
