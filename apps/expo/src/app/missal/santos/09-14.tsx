...
export default function Page0914() {
  return (
    <div className="docs">
      <h1>Exaltação da Santa Cruz, a 14 de Setembro</h1>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          <em>Sl. 66, 2</em> Que o Senhor tenha misericórdia de nós e nos
          abençoe; que o Senhor nos ilumine com o brilho que resplandece da sua
          face, e se compadeça de nós. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          Cristo fez-se obediente por nós até à morte, e morte na Cruz. ℣. Eis
          porque Deus O exaltou e Lhe deu um nome que é superior a todo o nome.
        </p>
        <p>
        ...
        <p>
          ...
          peso mais doce ainda! Só tu fostes digno de segurar o Rei e o Senhor
          dos céus. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          morte esset moritúrus.) Respóndit ei turba. Nos audívimus ex lege,
          quia Christus manet in ætérnum: et quómodo tu dicis: Opórtet exaltári
          Fílium hóminis? Quis est iste Fílius hóminis? Dixit ergo eis Jesus:
        ...
        <p>
          ...
          dizia Ele para indicar o género de morte de que morreria). As turbas
          responderam-Lhe: «Aprendemos na Lei que Cristo permanecerá para
          sempre. Como, pois, dizeis: é necessário que seja elevado o Filho do
          homem? Quem é este Filho do homem?». E Jesus retorquiu-lhes: «A luz
          estará no meio de vós, ainda por algum tempo. Caminhai, pois, enquanto
