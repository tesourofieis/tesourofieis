      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="comment">
            Santo Ambrósio, nascido em Tréveris, pelo ano de 335, é um dos
            quatro grandes Doutores da Igreja Latina. Quando ainda no berço, um
            enxame de abelhas entrou na boca do Santo, para aí trabalhar o seu
            mel: presságio de sua grande eloquência. Governador de Milão,
            Ambrósio foi providencialmente designado como bispo, pela voz de uma
            criança e tornou-se pregador incansável de que falam a Epístola e o
            Evangelho. Combateu os hereges, conseguiu que o imperador Teodósio
            se humilhasse e deu à Igreja S. Agostinho, cuja conversão vale a de
            reinos inteiros. Enriqueceu o Ofício Divino com hinos sagrados,
            mandou cantar os salmos por todo o povo dividido em coros. Esse
            grande bispo morreu em 397, na noite do Sábado Santo, depois de ter
            recebido o adorável Corpo de Jesus, que o levou para a sua
            bem-aventurada eternidade. À semelhança de Ambrósio, saibamos sempre
            manter com doce firmeza os direitos de Deus.
          </Text>
