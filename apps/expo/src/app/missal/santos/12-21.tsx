  ...
  return (
    <PageWrapper>
      ...
      <Typography className="comment">
        ...
        narra a tão célebre cena do Cenáculo depois da Ressurreição do Salvador.
        Duvidava S. Tomé e, só depois de lhe ter Jesus mandado por o dedo nas
        suas chagas, passou subitamente da incredulidade à fé ardente
        exclamando: «Meu Senhor e meu Deus». Esse dedo, diz um Padre da Igreja,
        tornou-se o mestre do mundo, pois, ensinou-lhe a verdade da carne de
        Jesus Cristo. Acreditemos nós também, no grande mistério de um Verbo
        encarnado, o qual muito breve se manifestará ao mundo. O nome de S. Tomé
        figura no Canon da Missa. A elevação tendo sido estabelecida para
        combater a heresia de Béranger o qual negava a presença real, ao serem
        elevadas as santas espécies, olhemo-las com espírito de fé, digamos com
        São Tomé: «Meu Senhor e meu Deus». Prática enriquecida por Pio X com uma
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          fixúram clavórum, et mittam dígitum meum in locum clavórum, et mittam
          manum meam in latus ejus, non credam. Et post dies octo, íterum erant
          discípuli ejus intus, et Thomas cum eis. Venit Jesus jánuis clausis,
          et stetit in médio, et dixit: Pax vobis. Deinde dicit Thomæ: Inter
          dígitum tuum huc, et vide manus meas, et affer manum tuam, et mitte in
        ...
        <Typography className="vernacular">
          ...
          cravos, se não meter o meu dedo no lugar dos cravos e se não meter a
          minha mão no seu lado, não acreditarei». Passados oito dias,
          encontravam-se outra vez no mesmo lugar, estando Tomé com eles. Veio
          então Jesus, estando as portas fechadas; e, pondo-se no meio deles,
          disse: «A paz seja convosco». Em seguida disse a Tomé: «Mete aqui o
          teu dedo e vê as minhas mãos; aproxima, também, a tua mão e mete-a no
