  ...
  return (
    <PageWrapper>
      ...
      <Text className="text-base">
        ...
        que veio e não entrará nesta cidade: assim diz o Senhor. Protegerei esta
      ...
      <Text className="text-base">
        ...
        porque o Senhor guarda as vidas dos seus servos e salva-os das mãos dos
        pecadores.
      </Text>
      ...
      <Text className="text-base">
        ...
        te avise, porque Herodes procura o Menino para lhe tirar a vida». E
        José, então, levantando-se de noite, tomou o Menino e sua Mãe e partiu
        para o Egipto, onde permaneceu até à morte de Herodes, a fim de se
