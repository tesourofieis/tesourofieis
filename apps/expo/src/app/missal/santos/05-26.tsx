    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">Ps. 102, 1</Text> Benedic, ánima mea, Dómino:
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">Sl. 102, 1</Text> Bendizei, ó minha alma,
      ...
      <Language>
        ...
        <Text className="latin">
          ...
          <Text className="latin">Thren. 1, 13</Text> De excélso misit ignem in
          óssibus meis, et erudívit me. Allelúja.
        </Text>
        <Text className="vernacular">
          Aleluia, aleluia.<Text className="versicle"> ℣. </Text>
          <Text className="vernacular">Lm. 1, 13</Text> Do alto dos céus enviou
      ...
      <Language>
        <Text className="latin">
          ...
          óssibus meis, et erudívit me. Allelúja.
          <Text className="versicle"> ℣. </Text>
          <Text className="em">Ps. 38, 4</Text> Concáluit cor meum intra me: et
        ...
        <Text className="vernacular">
          ...
          e fogo sobre os meus ossos e instruiu-me. Aleluia.
          <Text className="versicle"> ℣. </Text>
          <Text className="em">Sl. 38, 4</Text> Meu coração inflamou-se no meu
