...
export default function Page1028() {
  return (
    <div className="docs">
      <h1>S. Simão e S. Judas, a 28 de Outubro</h1>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          conhecendo quando me deito e me levanto. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 138, 17</em> Nimis honoráti sunt amíci
          tui, Deus: nimis confortátus est principátus eórum. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 138, 17</em> Honrais largamente os vossos
          filhos, ó Deus; o seu poder tem-se fortalecido extraordinariamente.
          Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          quia vero de mundo non estis, sed ego elegi vos de mundo, proptérea
          odit vos mundus. Mementóte sermónis mei, quem ego dixi vobis: Non est
          servus major dómino suo. Si me persecúti sunt, et vos persequántur: si
          sermónem meum servavérunt, et vestrum servábunt. Sed hæc ómnia fácient
          vobis propter nomen meum: quia nésciunt eum, qui misit me. Si non
          veníssent et locútus fuíssem eis, peccátum non háberent: nunc autem
          excusatiónem non habent de peccáto suo. Qui me odit: et Patrem meum
          odit. Si ópera non fecíssem in eis, quæ nemo álius fecit, peccátum non
        ...
        <p>
          ...
          pertenceria; mas, como não sois do mundo e Eu vos escolhi do mundo,
          por isso ele vos odiará. Lembrai-vos de que vos disse: «O servo mais
          não é do que o senhor». Se, pois, me perseguiram, perseguir-vos-ão,
          também; se guardaram as minhas palavras, guardarão também as vossas.
          Farão todas estas coisas por causa do meu nome, porque não conhecem
          Aquele que me mandou. Se não tivesse vindo e lhes não houvesse falado,
          não seriam culpados; mas agora não têm desculpa do seu pecado. Quem me
          odeia, odeia também meu Pai. Se Eu no meio de vós não houvesse
