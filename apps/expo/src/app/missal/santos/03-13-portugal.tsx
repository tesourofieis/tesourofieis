    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          serão conduzidas ao templo do Pai: do Senhor. <em>Sl. ibid., 2</em>{" "}
          Meu coração exprimiu uma palavra sublime: «Consagro ao Rei as minhas
          obras». ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          ℣. <em>Ps. 23, 6</em> Hæc est generátio quæréntium Dóminum, quærémtium
          fáciem Dei Jacbob.
        </p>
        <p>
          Que as virgens louvem o nome do Senhor: pois só o seu nome foi
          exaltado. ℣. Esta pertence à gereção das que procuram a face de Deus
          de Jacob.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 13 & 10</em> Vultum tuum deprecabúntur omnes divites
          plebis: filiæ regum in honóre tuo. ℣. <em>Ps. ibid., 16</em>{" "}
          Afferéntur in lætítia et exsultatióne: adducéntur in templum Regi
          Dómino.
        </p>
        <p>
          Ó Deus, vosso trono é eterno: o ceptro da rectidão é o ceptro do vosso
          reino. <em>Ps. ibid., 13 & 10</em> Todos os ricos da terra implorarão
          o vosso olhar: as filhas dos reis formarão a vossa corte. ℣.{" "}
          <em>Ps. ibid., 16</em> Virão em transportes de alegria e de júbilo: e
          serão conduzidas ao templo do Rei e Senhor.
        </p>
      </div>
