...
export default function Page0115() {
  return (
    <div className="docs">
      <h1>S. Paulo, 1.º Eremita, Conf., a 15 de Janeiro</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 2</em> Bonum est confitéri Dómino: et psállere nómini
          tuo, Altíssime. ℣. Gloria Patri...
        </p>
        <p>
          ...
          Deus. <em>Sl. ibid., 2</em> É bom louvar o Senhor: e cantar hinos em
