...
export default function Page0115() {
  return (
    <PageWrapper>
      <Text className="h1">S. Paulo, 1.º Eremita, Conf., a 15 de Janeiro</Text>
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">Ps. ibid., 2</Text> Bonum est confitéri
        ...
        <Text className="vernacular">
          ...
          Deus. <Text className="vernacular">Sl. ibid., 2</Text> É bom louvar o
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">ibid., 3</Text> Annuntiándum mane
