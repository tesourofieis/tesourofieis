...
export default function Page0115() {
  return (
    <PageWrapper>
      <H1 text="S. Paulo, 1.º Eremita, Conf., a 15 de Janeiro" />

      <Typography className="comment">
        S. Paulo, pai dos Eremitas, cuja vida foi escrita por S. Jerónimo, órfão
        aos quinze anos de idade, abandonou os seus bens e retirou-se para o
        deserto onde uma verdejante palmeira, símbolo de suas virtudes, (Intr.)
        forneceu-lhe alimento e vestuário. Na solidão meditava sobre a ciência
        das ciências, o conhecimento de Jesus Cristo (Ep.) e do Pai que o Cristo
        revela aos humildes (Ev.). Assim viveu até à idade de 112 anos,
        experimentando, no exercício heróico da oração e penitência, a suavidade
        do jugo do Senhor (id.). O grande S. Antão do deserto visitou-o pouco
        antes de sua morte e S. Paulo pediu-lhe, como derradeiro favor, que o
        revestisse depois de morto com o manto de S. Atanásio, o invencível
        defensor da divindade de Cristo. Atestando assim, morrer unido a esse
        santo e haver consistido toda a sua existência de penitência, em
        auxiliar aqueles que lutavam contra a heresia ariana. Morreu cerca do
        ano de 342. Neste Tempo depois da Epifania, consagrado à manifestação da
        divindade de Jesus, penetremo-nos, como S. Paulo eremita, da convicção
        que a vida cristã consiste em reconhecer a Cristo como Filho de Deus e
        em santificar-nos tornando nossa a sua santidade divina.
      </Typography>
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">Ps. ibid., 2</Typography> Bonum est confitéri
        ...
        <Typography className="vernacular">
          ...
          Deus. <Typography className="vernacular">Sl. ibid., 2</Typography> É bom louvar o
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          defriménta. Verúmtamen exístimo ómnia detriméntum esse propter
          eminéntem sciéntiam Jesu Christi, Dómini mei: propter quem ómnia
          detriméntum feci et árbitror ut stércora, ut Christum lucrifáciam et
          ...
          perféctus sim: sequor autem, si quo modo comprehéndam, in quo et
        ...
        <Typography className="vernacular">
          ...
          a fim de que ganhe a Cristo e me encontre com Ele, não com a minha
          ...
          sofrimentos, havendo-me confortado com sua morte, a fim de que possa
          de algum modo conseguir a ressurreição dos mortos. Não que eu a tenha
          alcançado, isto é, me haja tornado já perfeito; mas prossigo o caminho
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">ibid., 3</Typography> Annuntiándum mane
        ...
        <Typography className="vernacular">
          ...
          o lírio, e florescerá eternamente na presença do Senhor. Aleluia.
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          Dómine cœli et terræ, quia abscondísti hæc a sapiéntibus ei
          prudéntibus, et revelásti ea párvulis. Ita, Pater: quóniam sic fuit
          plácitum ante te. Omnia mihi trádita sunt a Patre meo. Et nemo novit
          Fílium nisi Pater: neque Patrem quis novit nisi Fílius, et cui
          volúerit Fílius reveláre. Veníte ad me, omnes, qui laborátis et
        ...
        <Typography className="vernacular">
          ...
          Senhor do céu e da terra, pois ocultastes estas coisas aos sábios e
          aos prudentes e as revelastes aos pequenos. Sim, ó Pai, dou-Vos
          graças, porque assim o quisestes. Todas as coisas me foram dadas pelo
          meu Pai; e ninguém conhece o Filho senão o Pai, nem ninguém conhece o
          Pai senão o Filho, e aquele a quem o Filho o revelar. Vinde a mim,
          vós, todos, que trabalhais e estais sobrecarregados, o vos
