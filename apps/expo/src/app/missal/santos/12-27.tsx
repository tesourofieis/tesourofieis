    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          sapiéntiæ et intelléctus: stolam glóriæ índuit eum. <em>Ps. 91, 2</em>{" "}
        ...
        <p>
          ...
          <em>Sl. 91, 2</em> É bom louvar o Senhor: e cantar hinos em honra do
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          morreria. Ora Jesus não disse: «Não morrerá». ℣. Mas disse: «Quero que
        ...
        <p>
          Aleluia, aleluia. ℣. <em>ibid., 24</em> Este é o próprio discípulo que
          dá testemunho destas coisas; e sabemos que seu testemunho é
          verdadeiro. Aleluia.
        </p>
      </div>
