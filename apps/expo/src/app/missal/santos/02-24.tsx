...
export default function Page0224() {
  return (
    <div className="docs">
      <h1>S. Matias, Apóstolo, a 24 de Fevereiro</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          principátus eórum. <em>Ps. ibid., 1-2</em> Dómine, probásti me et
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Juda, qui fuit dux eórum, qui comprehendérunt Jesum: qui connumerátus
          erat in nobis, et sortítus est sortem ministérii hujus. Et hic quidem
          possédit agrum de mercéde iniquitátis, et suspénsus crépuit médius: et
          diffúsa sunt ómnia víscera ejus. Et notum factum est ómnibus
          habitántibus Jerúsalem, ita ut appellarétur ager ille, lingua eórum,
          Hacéldama, hoc est ager sánguinis. Scriptum est enim in libro
          Psalmórum: Fiat commorátio eórum desérta, et non sit, qui inhábitet in
          ea: et episcopátum ejus accípiat alter. Opórtet ergo ex his viris, qui
          nobíscum sunt congregáti in omni témpore, quo intrávit et exívit inter
          nos Dóminus Jesus, incípiens a baptísmate Joánnis usque in diem, qua
          assúmptus est a nobis, testem resurrectiónis ejus nobíscum fíeri unum
          ex istis. Et statuérunt duos, Joseph qui vocabátur Bársabas, qui
          cognominátus est Justus, et Matthíam. Et orántes dixérunt: Tu, Dómine,
          qui corda nosti ómnium, osténde, quem elégeris ex his duóbus unum,
        ...
        <p>
          ...
          de David a respeito de Judas, que foi o guia daqueles que prenderam
          Jesus, o qual era um dos nossos e havia recebido participação no nosso
          mystério. Este homem, depois de haver comprado um campo com o preço do
          seu crime, suspendeu-se pelo pescoço e rebentou no meio do corpo,
          espalhando-se pelo chão. Este acontecimento foi conhecido de todos os
          habitantes de Jerusalém, de modo que aquele campo ficou sendo chamado
          em sua própria língua «Hacéldama», isto é, «campo de sangue». Ora está
          escrito no livro dos Salmos: «Que sua morada fique deserta e não haja
          quem resida nela, e que outro receba o seu episcopado». É, pois,
          necessário que entre os homens, que estiveram reunidos connosco
          durante o tempo em que o Senhor Jesus viveu entre nós desde o baptismo
          de João até ao dia em que subiu aos céus, um deles seja escolhido como
          testemunho da sua Ressurreição». E apresentaram-se dois: José, chamado
          Barsabás, cognominado o justo, e Matias. Então, orando, disseram:
          «Vós, Senhor, que conheceis o coração de todos, mostrai-nos qual
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          fortalecido extraordinariamente. ℣. Hei-de contá-los, e ultrapassarão
          os grãos de areia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          meu Pai; e ninguém conhece o Filho senão o Pai, assim como ninguém
          conhece o Pai senão o Filho, e aquele a quem o Filho o quer revelar.
          Vinde a mim, vós todos, que trabalhais e estais sobrecarregados, e vos
