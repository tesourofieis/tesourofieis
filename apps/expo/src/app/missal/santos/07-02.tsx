...
export default function Page0702() {
  return (
    <div className="docs">
      <h1>Visitação da B. Virgem Maria, a 2 de Julho</h1>
      ...
      <aside>
        ...
        São João Baptista. Hoje, como no tempo do Advento, a Igreja aproxima de
        Jesus e de Maria a lembrança do Precursor. Lembramos naquela época que a
        Sexta-feira das Têmporas do verão recorda o mistério da Visitação. Esta
        solenidade foi instituída para todo o universo em 1389, por Urbano VI, a
        fim de obter a terminação do grande cisma do Ocidente, e, depois,
        elevada ao rito de duplo de segunda classe por Pio IX, pois, nesta festa
        conseguiu-se, em Roma, no ano 1849, a vitória da Igreja sobre a
        Revolução. Maria visita a Isabel e Jesus a João, santificando-o. Este
        exulta de alegria e Isabel, inspirada, pelo Espírito Santo, exclama:
        «Sois bendita entre as mulheres, e bendito é o fruto de vosso ventre»
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          o céu e a terra, em todos os séculos dos séculos. <em>Sl. 44, 2</em>{" "}
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          diléctus meus lóquitur mihi: Surge, própera, amíca mea, colúmba mea,
          formósa mea, et veni. Jam enim hiems tránsiit, imber ábiit et
        ...
        <p>
          ...
          o meu amado fala-me e diz: «Ergue-te, apressa-te e vem, ó minha amiga,
          ó minha pomba, ó minha única beleza! Pois já o Inverno acabou; já as
          chuvas cessaram e se retiraram. As flores brotaram nos nossos jardins;
          chegou o tempo da poda; ouve-se a voz da rola nos nossos campos; a
          figueira começa a mostrar os primeiros frutos e as vinhas em flor
          exalam aromas! Ergue-te e vem, minha amiga, minha única beleza! Ó
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          sem a vossa pureza sofrer a mais leve mancha. ℣. Ó Virgem, Mãe de
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          seio e Isabel ficou cheia do Espírito Santo, exclamando em voz alta:
          «Bendita sois vós entre todas as mulheres; e bendito é o fruto do
          vosso ventre. Donde me vem a mim que a Mãe do meu Senhor venha até
          mim? Pois, desde que a voz da vossa saudação chegou a meus ouvidos, o
