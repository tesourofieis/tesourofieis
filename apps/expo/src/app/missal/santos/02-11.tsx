...
export default function Page0211() {
  return (
    <PageWrapper>
      <H1 text="Aparição da B. Virgem Maria Imaculada, a 11 de Fevereiro" />
      ...
      <Language>
        ...
        <Text className="vernacular">
          ...
          <Text className="vernacular">Cant. 4, 7</Text> Toda sois formosa, ó
