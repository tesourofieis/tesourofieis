    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          parátam sicut sponsam ornátam viro suo. <em>Ps. 44,2</em> Eructávit
        ...
        <p>
          ...
          <em>Sl. 44,2</em> Meu coração exprimiu uma palavra excelente:
          «Consagro as minhas obras ao Rei». ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          túrturis audíta est in terra nostra. ℣. <em>ibid., 10 & l4</em> Surge,
          amíca mea, speciósa mea, et veni: colúmba mea in foramínibus petræ, in
          cavérna macériæ.
        </p>
        <p>
          As flores apareceram na terra! Veio o tempo em que podemos cantar. Os
          arrulhos da rola ouvem-se já pelos campos! ℣. <em>ibid., 10 & l4</em>{" "}
        ...
        <p>
          Aleluia, aleluia. ℣. Mostrai-me o vosso rosto: fazei que a vossa voz
          ressoe aos meus ouvidos; pois a vossa voz é doce e o vosso rosto é
          cheio de beleza. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          nostri. ℣. <em>Cant. 4, 7</em> Tota pulchra es, María: et mácula
          originális non est in te. ℣. Felix es, sacra Virgo María, et omni
          laude digníssima, quæ serpéntis caput virgíneo pede contrivísti.
        </p>
        <p>
          Sois a glória de Jerusalém, a alegria de Israel, a honra do nosso
          povo. ℣. <em>Cant. 4, 7</em> Toda sois formosa, ó Maria; e a mancha
          original não existe em Vós. ℣. Sois bem-aventurada, Santa Virgem
          Maria, e digníssima de todo o louvor, pois com vosso pé virginal
          esmagastes a cabeça da serpente.
        </p>
      </div>
