...
export default function Page0211() {
  return (
    <PageWrapper>
      ...
      <Typography className="em">Ap. 21, 2</Typography>
      ...
      <Typography className="em">Ct. 2, 12</Typography>
      ...
      <Typography className="em">Jdt 15, 10</Typography>
      ...
      <Typography className="em">Lc. 1, 26-31</Typography>
      ...
      <Typography className="em">Sl. 64, 10</Typography>
