        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              méritis et exémplo discámus peritúras mundi calcáre delícias, et
            ...
            <Text className="vernacular">
              ...
              humildade, concedei-nos que pelos seus méritos e exemplos
              desprezemos as glórias e delícias deste mundo e, abraçados à vossa
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              própera, amíca mea, colúmba mea, formósa mea, et veni. Jam enim
              hiems tránsiit, imber ábiit et recéssit. Flores apparuérunt in
              terra nostra, tempus putatiónis advénit: vox túrturis audíta est
              in terra nostra: ficus prótulit grossos suos: víneæ floréntes
              dedérunt odórem suum. Surge, amíca mea, speciósa mea, et veni:
              colúmba mea in foramínibus petra, in cavérna macériæ, osténde mihi
            ...
            <Text className="vernacular">
              ...
              retiraram. As flores brotaram nos nossos jardins; chegou o tempo
              da poda; ouve-se a voz da rola nos nossos campos; a figueira
              começa a mostrar os primeiros frutos e as vinhas em flor exalam
              aromas! Ergue-te e vem, minha amiga, minha única beleza! Ó minha
              pomba escondida nas fendas das rochas e nas cavernas dos muros em
          ...
          <View className="side-by-side">
            <Text className="latin">
              ...
              <Text className="latin">Ps. ibid., 18-19</Text> Vota mea Dómino
              reddam in conspéctu omnis pópuli ejus, in átriis domus Dómini.
            </Text>
            <Text className="vernacular">
              ...
              meus votos ao Senhor na presença de todo seu povo e nos átrios da
              casa do Senhor.
            </Text>
            <Text className="latin">
