    ...
    <PageWrapper>
      ...
      <Language>
        <Text className="latin">
          ...
          Fílium Dei. <Text className="latin">Ps. 118, 1</Text> Beáti immaculáti
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="latin">ibid., 15</Text> In vita sua fecit magnália,
        ...
        <Text className="latin">
          Allelúja, allelúja.<Text className="versicle"> ℣. </Text>Áspice, quæ
