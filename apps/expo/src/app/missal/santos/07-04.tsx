...
export default function Page0704() {
  return (
    <div className="docs">
      <h1>Santa Isabel, Rainha de Portugal, a 4 de Julho</h1>
      ...
      <aside>
        ...
        virtudes de sua tia-avó [Santa Isabel da
        Hungria](/missal/santosa/11-19). O pai, vendo-lhe a santidade, dizia que
        ela excederia a todas as mulheres nascidas também da raça real (Ep.,
        Com.). Isabel casou-se com Dinis I, rei de Portugal, recebera a
        prerogativa de restabelecer a paz onde houvesse divisões, e de acalmar
        os furores da guerra (Or.). Viúva, tomou o hábito da Ordem Terceira,
        distribuiu suas riquezas, adquirindo, por esse meio, a pérola preciosa e
        tesouro oculto da vida eterna (Ev.). Morreu em 1336, em Coimbra. Seu
        corpo conservou-se intacto.
      </aside>
      ...
      <div className="side-by-side">
        <p>
          ...
          Fílium Dei. <em>Ps. 118, 1</em> Beáti immaculáti in via: qui ámbulant
        ...
        <p>
          ...
          louvam em harmonias o Filho de Deus. <em>Sl. 118, 1</em>{" "}
      ...
      <div className="side-by-side">
        <p>
          ...
          conciliávit cor Patris ad fílium. ℣. <em>ibid., 15</em> In vita sua
          fecit magnália, et in morte mirabília operáta est.
        </p>
        <p>
          Com a palavra do Senhor conteve o céu, afastou a ira do Senhor e
          conciliou o coração do pai com o do filho. ℣. <em>ibid., 15</em>{" "}
          Durante a sua vida praticou maravilhas e na morte operou milagres.
        </p>
        <p>
        ...
        <p>
          Aleluia, aleluia. ℣. Ó Rainha Isabel, que residis em excelso trono,
          olhai benignamente para nós, que outrora fomos na terra vossos
          súbditos. Aleluia.
        </p>
      </div>
