...
export default function Page0806() {
  return (
    <div className="docs">
      <h1>Transfiguração de N. S. J. Cristo, a 6 de Agosto</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          terra. <em>Ps. 83, 2-3</em> Quam dilécta tabernácula tua, Dómine
        ...
        <p>
          ...
          tremeu. <em>Sl. 83, 2-3</em> Como são amáveis os vossos tabernáculos,
          ó Senhor dos exércitos! Minha alma suspira ardentemente pelos átrios
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          perfeita adopção que de nós fizestes como vossos filhos, concedei-nos
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          delapsa ad eum hujuscemodi a magnifica glória: Hic est Fílius meus
          diléctus, in quo mihi complacui, ipsum audíte. Et hanc vocem nos
          audivimus de cœlo allatam, cum essemus cum ipso in monte sancto. Et
        ...
        <p>
          ...
          de Deus Pai honra e glória, quando da glória magnífica desceu sobre
          Ele esta voz: «Este é o meu Filho muito amado, em quem pus as minhas
          complacências; ouvi-O». Nós também ouvimos esta voz, vinda do céu,
          quando estávamos com Ele, na montanha sagrada. E consideramos a
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          lábios. ℣. Meu coração exprimiu uma palavra excelente: Consagro ao Rei
          as minhas obras.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Sap. 7, 26</em> Candor est lucis ætérnæ,
          spéculum sine mácula, et imágo bonitátis illíus. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sb. 7, 26</em> Este é o esplendor da luz
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          illis Moyses et Elías cum eo loquéntes. Respóndens autem Petrus, dixit
          ...
          accéssit Jesus, et tétigit eos, dixítque eú Surgite, et nolíte timére.
        ...
        <p>
          ...
          saindo do seio dela uma voz, que dina: «Este é o meu Filho muito
