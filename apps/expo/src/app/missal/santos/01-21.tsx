        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              tuum nimis. <Text className="latin">Ps. ibid., 1</Text> Beáti
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">ibid., 5</Text> Por amor da verdade,
              da mansidão e da justiça a vossa mão direita vos levará a praticar
              maravilhas.
            </Text>
            <Text className="latin">
