  ...
  return (
    <div className="docs">
      ...
      <aside>
        ...
        (Ev., Com.) (Ver [Comemoração de Santa
        Felicidade](/missal/santos/11-23#comemoração-de-santa-felicidade)). Eles
        morreram no ano de 150, sob o imperador Antonino. Um século depois,
        Rufina e Segunda, irmãs pela natureza tornaram-se duplamente irmãs,
        misturando o seu sangue no mesmo suplício, para não perderem a
      ...
      <div className="side-by-side">
        <p>
          ...
          stérilem in domo, matrem filiórum lætántem. <em>Ps. ibid., 2</em> Sit
          nomen Dómini benedíctum: ex hoc nunc, ei usque in sǽculum. ℣. Gloria
          Patri...
        </p>
        <p>
          ...
          aquela que antes era estéril. <em>Sl. ibid., 2</em> Bendito seja o
          nome do Senhor, agora e em todos os séculos. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          laço quebrou-se e ficamos livres: o nosso auxílio está no nome do
