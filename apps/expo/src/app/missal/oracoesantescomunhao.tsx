  ...
  return (
    <PageWrapper>
      ...
      <Text className="text-base">
        ...
        a própria verdade, o dissestes. Creio, também, meu amável Jesus, que,
        nesse sacramento, Vós, sendo verdadeiro Deus e verdadeiro Homem, Vos
      ...
      <Text className="text-base">
        ...
        pois, ao compreender e examinar o abysmo que nos separa, aproximar-me de
        Vós?... Ah! Tende compaixão de mim! Esquecei-Vos das minhas iniquidades,
      ...
      <Text className="text-base">
        ...
        tão bom que dissestes: «Minhas delícias são viver e habitar com os
        homens». Vinde, pois, descei ao meu pobre coração e tomai conta dele.
        Enchei-o com vossa graça; e que daqui para o futuro não viva senão para
