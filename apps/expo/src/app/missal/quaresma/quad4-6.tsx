        ...
        <View className="docs">
          ...
          <View className="side-by-side">
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. 77, 1</Text> Inclinai os vossos
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              dissipátas: ut díceres his, qui vincti sunt: Exíte: et his, qui in
              ténebris: Revelámini. Super vias pascéntur, et in ómnibus planis
              páscua eórum. Non esúrient neque sítient, et non percútiet eos
              æstus et sol: quia miserátor eórum reget eos, et ad fontes aquárum
              potábit eos. Et ponam omnes montes meos in viam, et sémitæ meæ
              exaltabúntur. Ecce, isti de longe vénient, ei ecce illi ab
              aquilóne et mari, et isti de terra austráli. Laudáte, cœli, et
              exsúlta, terra, jubiláte, montes, laudem: quia consolátus est
              Dóminus pópulum suum, et páuperum suórum miserébitur. Et dixit
              Sion: Derelíquit me Dóminus, et Dóminus oblítus est mei. Numquid
              oblivísci potest múlier infántem suum, ut non misereátur fílio
            ...
            <Text className="vernacular">
              ...
              dissipadas, dizeres aos cativos, que estão a ferros: «Sois
              livres», e aos que estão nas trevas: «Vinde à luz».
              Apascentar-se-ão livremente em todos os caminhos e todas as
              planícies lhes servirão de pastagens. Não terão fome, nem sede; os
              não incomodará o calor, nem os queimará o sol; pois Aquele, que é
              misericordioso, os guiará e conduzirá às águas frescas para
              beberem. Então aplanarei os montes e torná-los-ei em caminhos e as
              veredas serão alteadas. Eis que chegam de longe: uns virão do
              norte e do mar e outros das terras do meio-dia. Ó céus, rejubilai!
              Ó terra, exultai! Ó montanhas, cantai hinos de alegria, pois o
              Senhor consolou o seu povo e teve compaixão dos seus pobres.
              Entretanto disse Sião: O Senhor abandonou-me; o Senhor esqueceu-se
              de mim! Porventura pode uma mãe esquecer o seu filho, de modo que
          ...
          <View className="side-by-side">
            ...
            <Text className="latin">
              ...
              testimónium pérhibes: testimónium tuum non est verum. Respóndit
              Jesus et dixit eis: Et si ego testimónium perhíbeo de meípso,
              verum est testimónium meum: quia scio, unde veni et quo vado: vos
              autem nescítis, unde vénio aut quo vado. Vos secúndum carnem
              judicátis: ego non júdico quemquam: et si júdico ego, judícium
              meum verum est, quia solus non sum: sed ego et, qui misit me,
              Pater. Et in lege vestra scriptum est, quia duórum hóminum
              testimónium verum est. Ego sum, qui testimónium perhíbeo de
              meípso: et testimónium pérhibet de me, qui misit me, Pater.
              Dicébant ergo ei: Ubi est Pater tuus? Respóndit Jesus: Neque me
              scitis neque Patrem meum: si me sciretis, fórsitan et Patrem meum
            ...
            <Text className="vernacular">
              ...
              de ti mesmo; o teu testemunho não é verdadeiro». Jesus
              respondeu-lhes: «Ainda que dê testemunho de mim mesmo, o meu
              testemunho é verdadeiro, porque sei donde venho e para onde vou;
              porém, vós ignorais donde venho e para onde vou. Vós julgais
              segundo a carne, enquanto que Eu não julgo ninguém. E, se julgo, o
              meu juízo é verdadeiro; pois não sou só, mas estou com o Pai, que
              me mandou. Na vossa Lei está escrito: «Que o testemunho de dois
              homens é verdadeiro». Ora, Eu dou testemunho de mim; e o Pai, que
              me mandou, dá também testemunho de mim». Perguntaram-Lhe então:
              «Onde está o vosso Pai?». Jesus respondeu: «Vós me não conheceis a
              mim, nem ao meu Pai. Se me conhecêsseis, conheceríeis também o meu
