    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          <Typography className="em">Joann. 11, 47-49, 50 & 53</Typography> Collegérunt
          pontífices et pharisǽi concílium, et dixérunt: Quid fácimus, quia hic
          homo multa signa facit? Si dimíttimus eum sic, omnes credent in eum:
          Et vénient Románi, et tollent nostrum locum et gentem.
        ...
        <Typography className="vernacular">
          <Typography className="response"> ℟. </Typography>{" "}
          <Typography className="em">Jo. 11, 47-49, 50 & 53</Typography> Os pontífices e os
          fariseus reuniram-se em conselho e disseram: «Que faremos? Este homem
          faz muitos prodígios. Se o deixamos andar livremente, todos
          acreditarão n’Ele. E virão os romanos, e destruirão a nossa terra e o
          nosso povo».<Typography className="versicle"> ℣. </Typography>Mas um deles,
        ...
        <Typography className="latin">
          <Typography className="response"> ℟. </Typography>{" "}
          <Typography className="em">Mt. 28, 39 & 41</Typography> In monte Olivéti orávit ad
          Patrem: Pater, si fíeri potest, tránseat a me calix iste. Spíritus
          quidem promptus est, caro autem infírma: fiat volúntas tua.
          <Typography className="versicle"> ℣. </Typography>Vigiláte et oráte, ut non
          intrétis in tentatiónem. Spíritus quidem...
        </Typography>
        <Typography className="vernacular">
          <Typography className="response"> ℟. </Typography>{" "}
          <Typography className="em">Mt. 28, 39 & 41</Typography> No monte das Oliveiras
          orou a seu Pai: Meu pai, se é possível, afastai de mim este cálice! Na
          verdade, o espírito está pronto: mas a carne é fraca; contudo, faça-se
          a vossa vontade.
          <Typography className="versicle"> ℣. </Typography>Vigiai e orai, para não cairdes
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="cross"> ✠ </Typography> dicántur et hi pálmites palmárum
          seu olivárum: et sicut in figúra Ecclésiæ multiplicásti Noë
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="cross"> ✠ </Typography> ficáre dignéris: ut, quicúmque ex
          ea recéperint, accípiant sibi protectiónem ánimæ et córporis: fiátque,
        ...
        <Typography className="vernacular">
          ...
          <Typography className="cross"> ✠ </Typography> santificar estes Ramos de oliveira,
          vossa Criatura, que fizestes nascer na árvore, semelhantes ao que a
          pomba levava no bico quando regressou à arca. Permiti que aqueles que
          receberam estes Ramos obtenham a vossa protecção na alma e no corpo; e
          que estes Ramos, Senhor, que são um sinal da vossa graça, se convertam
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="cross"> ✠ </Typography> dic étiam hos ramos palmæ et olívæ,
          quos tui fámuli ad honórem nóminis tui fidéliter suscípiunt; ut, in
          quemcúmque locum introdúcti fúerint, tuam benedictiónem habitatóres
          loci illíus consequántur: et, omni adversitáte effugáta, déxtera tua
          prótegat, quos rédemit Jesus Christus, Fílius tuus, Dóminus noster:
          Qui tecum...
        </Typography>
        <Typography className="vernacular">
          ...
          de Jesus, abençoai <Typography className="cross"> ✠ </Typography>, também, estes
          Ramos de palmeira e de oliveira, que os vossos fiéis servos vão
          receber em honra do vosso nome, a fim de que, em qualquer lugar em que
          sejam colocados, aqueles que habitarem nesse lugar consigam a vossa
          bênção, e, afastada toda a adversidade, a vossa dextra proteja os que
          foram remidos por Jesus Cristo, vosso Filho, nosso Senhor: O qual,
          sendo Deus...
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="cross"> ✠ </Typography> dictióne sanctífices: ut cuncto
        ...
        <Typography className="vernacular">
          ...
          <Typography className="cross"> ✠ </Typography> celestial, Vos pedimos, estes Ramos
          de oliveira e doutras árvores, a fim de que sirva de proveito a todo
      ...
      <Language>
        <Typography className="latin">
          Bene <Typography className="cross"> ✠ </Typography> dic, quǽsumus, Dómine, hos
          ...
          devotióne perfíciat, de hoste victóriam reportándo et opus
          misericórdiæ summópere diligéndo. Per Dóminum...
        </Typography>
        <Typography className="vernacular">
          Abençoai <Typography className="cross"> ✠ </Typography>, Senhor, Vos imploramos,
          estes Ramos de palmeira e de oliveira, e concedei ao vosso povo a
          graça de realizar espiritualmente com ardente devoção a cerimónia
          exterior que hoje pratica em vossa honra; e que, triunfando do inimigo
          por meio dela, corresponda com amor à misericordiosa obra por Vós
          realizada para sua salvação. Por nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          <Typography className="response"> ℟. </Typography> Glória, louvor & Plebs Hebrǽa
          tibi cum palmis óbvia venit:
        </Typography>
        <Typography className="latin">
      ...
      <Language>
        <Typography className="latin">
          ...
          civitátem, Hebræórum púeri resurrectiónem vitæ pronuntiántes. Cum
          ramis palmárum: Hosánna, clamábant, in excélsis.
          <Typography className="versicle"> ℣. </Typography>Cum audísset pópulus, quod Jesus
          veníret Jerosólymam, exiérunt óbviam ei. Cum ramis palmárum: Hosánna,
          clamábant, in excélsis.
        </Typography>
        <Typography className="vernacular">
          <Typography className="response"> ℟. </Typography> Quando o Senhor entrava na
          cidade santa, os meninos hebreus anunciavam antecipadamente a
          ressurreição d’Aquele que é a vida. * Empunhando ramos de palmeira,
          clamavam: «Hosana no alto dos céus!».
          <Typography className="versicle"> ℣. </Typography>E, tendo o povo notícia de que
          Jesus vinha a Jerusalém, saiu ao seu encontro. Empunhando ramos de
          palmeira, clamava: «Hosana no alto dos céus!».
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          ...
          meam. <Typography className="latin">Ps. ibid., 2</Typography> Deus, Deus meus,
          réspice in me: quare me dereliquísti? longe a salúte mea verba
          delictórum meórum.
        </Typography>
        <Typography className="vernacular">
          ...
          pois sou fraco. <Typography className="vernacular">Sl. ibid., 2</Typography> Meu
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          nomen: <Typography className="em">(hic genuflectitur)</Typography> ut in nómine
          Jesu omne genu flectátur cœléstium, terréstrium et inférno rum: et
      ...
      <Language>
        <Typography className="latin">
          ...
          glória assumpsísti me.<Typography className="versicle"> ℣. </Typography>
        ...
        <Typography className="vernacular">
          ...
          <Typography className="versicle"> ℣. </Typography>Como o Deus de Israel é bom para
          os que possuem coração recto! Meus pés estiveram vacilantes; estive
          quase a cair, pois eu olhava com indignação para os ímpios, vendo a
          paz que gozavam os pecadores.
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="versicle"> ℣. </Typography>Longe a salúte mea verba
          delictórum meórum.<Typography className="versicle"> ℣. </Typography>Deus meus,
          clamábo per diem, nec exáudies: in nocte, et non ad insipiéntiam mihi.
          <Typography className="versicle"> ℣. </Typography>Tu autem in sancto hábitas, laus
          Israël.<Typography className="versicle"> ℣. </Typography>In te speravérunt patres
          nostri: speravérunt, et liberásti eos.
          <Typography className="versicle"> ℣. </Typography>Ad te clamavérunt, et salvi
          facti sunt: in te speravérunt, et non sunt confusi.
          <Typography className="versicle"> ℣. </Typography>Ego autem sum vermis, et non
          homo: oppróbrium hóminum et abjéctio plebis.
          <Typography className="versicle"> ℣. </Typography>Omnes, qui vidébant me,
          aspernabántur me: locúti sunt lábiis et movérunt caput.
          <Typography className="versicle"> ℣. </Typography>Sperávit in Dómino, erípiat eum:
          salvum fáciat eum, quóniam vult eum.
          <Typography className="versicle"> ℣. </Typography>Ipsi vero consideravérunt et
          conspexérunt me: divisérunt sibi vestiménta mea, et super vestem meam
          misérunt mortem.<Typography className="versicle"> ℣. </Typography>Líbera me de ore
          leónis: et a córnibus unicórnium humilitátem meam.
          <Typography className="versicle"> ℣. </Typography>Qui timétis Dóminum, laudáte
          eum: univérsum semen Jacob, magnificáte eum.
          <Typography className="versicle"> ℣. </Typography>
          Annuntiábitur Dómino generátio ventúra: et annuntiábunt cœli justítiam
          ejus.<Typography className="versicle"> ℣. </Typography>Pópulo, qui nascétur, quem
          fecit Dóminus.
        </Typography>
        <Typography className="vernacular">
          Meu Deus, meu Deus, olhai para mim: Porque me abandonastes?
          <Typography className="versicle"> ℣. </Typography>O clamor dos meus pecados
          afastou de mim a salvação.<Typography className="versicle"> ℣. </Typography>
          Meu rei durante o dia e não me ouvi Deus, clama reis; clamarei durante
          a noite e não acharei consolação.
          <Typography className="versicle"> ℣. </Typography>Contudo, sois a glória de Israel
          e habitais no santuário.
          <Typography className="versicle"> ℣. </Typography>Os nossos pais esperaram em Vós:
          esperaram e fostes o seu libertador!
          <Typography className="versicle"> ℣. </Typography>Clamaram por Vós, e foram
          salvos; confiaram em Vós e não foram iludidos.
          <Typography className="versicle"> ℣. </Typography>Porém sou um verme e não um
          homem; sou o opróbrio dos homens, a irrisão do povo!
          <Typography className="versicle"> ℣. </Typography>Todos quantos me vêem, enchem-me
          de injúrias, murmuram de mim, abanando a cabeça e dizendo:
          <Typography className="versicle"> ℣. </Typography>«Esperou no Senhor; pois que
          venha salvá-l’O, já que O ama».
          ...
          sobre a minha túnica.<Typography className="versicle"> ℣. </Typography>
          Livrai-me, Senhor, da boca do leão e das pontas dos unicórnios, pois
          sou fraco.<Typography className="versicle"> ℣. </Typography>Louvai o Senhor, ó
          Vós, que O temeis! Cantai louvores em sua honra, ó filhos de Jacob.
          <Typography className="versicle"> ℣. </Typography>À geração futura será anunciado
          o Senhor; os céus proclamarão a sua justiça.
          <Typography className="versicle"> ℣. </Typography>Ao povo, que há-de nascer,
      ...
      <Language>
        <Typography className="latin">
          <Typography className="cross"> ✠ </Typography> Passio Dómini nostri Jesu Christi
          secúndum Matthǽum.
        </Typography>
        <Typography className="vernacular">
          <Typography className="cross"> ✠ </Typography> Paixão de Nosso Senhor Jesus
          Cristo, segundo S. Mateus.
        </Typography>
        <Typography className="latin">
          In illo témpore: Dixit Jesus discípulis suis:{" "}
          <Typography className="cross"> ✠ </Typography> Scitis, quid post bíduum Pascha
          fiet, et Fílius hóminis tradétur, ut crucifigátur.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Tunc congregáti
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Non in die festo,
          ne forte tumúltus fíeret in pópulo.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Cum autem Jesus
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Sciens autem Jesus,
          ait illis: <Typography className="cross"> ✠ </Typography> Quid molésti estis huic
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Tunc ábiit unus de
          duódecim, qui dicebátur Judas Iscariótes, ad príncipes sacerdótum, et
          ait illis: <Typography className="font-bold text-red-500">S.</Typography> Quid
        ...
        <Typography className="vernacular">
          ...
          <Typography className="cross"> ✠ </Typography> «Sabeis que, passados dois dias, se
          celebrará a Páscoa e que o Filho do homem será entregue, para O
          crucificarem». <Typography className="font-bold text-red-500">C.</Typography>{" "}
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Que isso, porém,
          não seja no dia da festa, para que o povo não faça tumulto».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Então, estando
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Para que serve tal
          desperdício? Pois poderia ter-se vendido por elevada quantia este
          perfume e dar aos pobres o seu preço».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Conhecendo Jesus
          isto, disse-lhes: <Typography className="cross"> ✠ </Typography> «Para que causais
          ...
          que praticou». <Typography className="font-bold text-red-500">C.</Typography>{" "}
          Então um dos Doze, chamado Judas Iscariotes, foi ter com o príncipe
          dos sacerdotes e disse-lhe:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Quanto quereis
          dar-me para que eu vo-l’O entregue?».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> E combinaram
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> At Jesus dixit:{" "}
          <Typography className="cross"> ✠ </Typography> Ite in civitátem ad quendam, et
          dícite ei: Magíster dicit: Tempus meum prope est, apud te fácio pascha
          cum discípulis meis.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et fecérunt
          ...
          illis, dixit: <Typography className="cross"> ✠ </Typography> Amen, dico vobis,
          quia unus vestrum me traditúrus est.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et contristáti
          valde, cœpérunt sínguli dícere:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Numquid ego sum,
          Dómine? <Typography className="font-bold text-red-500">C.</Typography> At ipse
          respóndens, ait: <Typography className="cross"> ✠ </Typography> Qui intíngit mecum
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Numquid ego sum,
          Rabbi? <Typography className="font-bold text-red-500">C.</Typography> Ait illi:{" "}
          <Typography className="cross"> ✠ </Typography> Tu dixísti.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Cenántibus autem
          eis, accépit Jesus panem, et benedíxit, ac fregit, dedítque discípulis
          suis, et ait: <Typography className="cross"> ✠ </Typography> Accípite et comédite:
          hoc est corpus meum.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et accípiens
          cálicem, grátias egit: et dedit illis, dicens:{" "}
          <Typography className="cross"> ✠ </Typography> Bíbite ex hoc omnes. Hic est enim
          ...
          mei. <Typography className="font-bold text-red-500">C.</Typography> Et hymno
          dicto, exiérunt in montem Olivéti. Tunc dicit illis Jesus:{" "}
          <Typography className="cross"> ✠ </Typography> Omnes vos scándalum patiémini in me
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Respóndens autem
          Petrus, ait illi: <Typography className="font-bold text-red-500">S.</Typography>{" "}
          Et si omnes scandalizáti fúerint in te, ego numquam scandalizábor.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Ait illi Jesus:{" "}
          <Typography className="cross"> ✠ </Typography> Amen, dico tibi, quia in hac nocte,
          antequam gallus cantet, ter me negábis.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Ait illi Petrus:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Etiam si oportúerit
          me mori tecum, non te negábo.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Simíliter et omnes
          discípuli dixérunt.
        </Typography>
        <Typography className="vernacular">
          No primeiro dia dos ázimos, vieram os discípulos ter com Jesus,
          dizendo-Lhe: <Typography className="font-bold text-red-500">S.</Typography> «Onde
          quereis que preparemos o que é necessário para comer a Páscoa?»{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Jesus disse-lhes:{" "}
          <Typography className="cross"> ✠ </Typography> «Ide à cidade, a casa dum tal, e
          dizei-lhe: «O Mestre diz: «Meu tempo está próximo; quero celebrar a
          Páscoa com meus discípulos em tua casa».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Os discípulos
          ...
          estando eles a comer, disse-lhes: <Typography className="cross"> ✠ </Typography>{" "}
          «Em verdade vos digo que um de vós me trairá».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Então, cheios de
          profunda tristeza, começaram, individualmente, a dizer:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Serei eu, Senhor?»{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Ele disse:{" "}
          <Typography className="cross"> ✠ </Typography> «O que me há-de trair é aquele que
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Ora Judas, o
          discípulo que O traiu, disse:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Serei eu,
          porventura, Senhor?»{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Jesus disse-lhe:{" "}
          <Typography className="cross"> ✠ </Typography> «Tu o disseste!».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Enquanto ceavam,
          tomou Jesus o pão, benzeu-o, partiu-o e deu-o aos discípulos, dizendo:{" "}
          <Typography className="cross"> ✠ </Typography> «Tomai e comei: Isto é o meu
          corpo». <Typography className="font-bold text-red-500">C.</Typography> E, pegando
          no cálice, deu graças e entregou-lho, dizendo-lhes:{" "}
          <Typography className="cross"> ✠ </Typography> «Bebei dele vós todos. Pois este é
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Havendo dito o hino
          de graças, saíram para o monte das Oliveiras, Então, disse-lhes Jesus:{" "}
          <Typography className="cross"> ✠ </Typography> «Esta noite serei para vós todos
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Porém, respondendo
          Pedro, disse-Lhe: <Typography className="font-bold text-red-500">S.</Typography>{" "}
          ...
          retorquiu-lhe: <Typography className="cross"> ✠ </Typography> «Em verdade te digo:
          esta noite, antes de o galo cantar, negar-me-ás três vezes».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> edro disse-Lhe:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Ainda que tenha de
          morrer convosco, não Vos negarei!».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> O mesmo afirmaram
          todos os discípulos.
        </Typography>
        <Typography className="latin">
          Tunc venit Jesus cum illis in villam, quæ dícitur Gethsémani, et dixit
          discípulis suis: <Typography className="cross"> ✠ </Typography> Sedéte hic, donec
          vadam illuc et orem.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et assúmpto Petro
          et duóbus fíliis Zebedǽi, cœpit contristári et mæstus esse. Tunc ait
          illis: <Typography className="cross"> ✠ </Typography> Tristis est ánima mea usque
          ad mortem: sustinéte hic, et vigilate mecum.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et progréssus
          pusíllum, prócidit in fáciem suam, orans et dicens:{" "}
          <Typography className="cross"> ✠ </Typography> Pater mi, si possíbile est,
          tránseat a me calix iste: Verúmtamen non sicut ego volo, sed sicut tu.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et venit ad
          discípulos suos, et invénit eos dormiéntes: et dicit Petro:{" "}
          <Typography className="cross"> ✠ </Typography> Sic non potuístis una hora vigiláre
          mecum? Vigiláte et oráte, ut non intrétis in tentatiónem. Spíritus
          quidem promptus est, caro autem infírma.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Iterum secúndo
          ábiit et orávit, dicens: <Typography className="cross"> ✠ </Typography> Pater mi,
          si non potest hic calix transíre, nisi bibam illum, fiat volúntas tua.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et venit íterum, et
        ...
        <Typography className="vernacular">
          ...
          discípulos: <Typography className="cross"> ✠ </Typography> «Assentai-vos aqui,
          ...
          angustiar-se. E disse-lhes: <Typography className="cross"> ✠ </Typography> «Minha
          alma está triste até à morte! Ficai aqui e vigiai comigo».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Depois, avançou um
          pouco e prostrou-se com o rosto no chão, orando e dizendo:{" "}
          <Typography className="cross"> ✠ </Typography> «Meu Pai, se é possível, fazei que
          este cálice se afaste de mim; contudo faça-se a vossa vontade e não a
          minha». <Typography className="font-bold text-red-500">C.</Typography> Em seguida,
          veio ter com os discípulos, encontrando-os a dormir. Disse, então, a
          Pedro: <Typography className="cross"> ✠ </Typography> «Pois não pudestes vigiar
          uma hora comigo?! Vigiai e orai para não entrardes em tentação. Na
          verdade, o espírito está pronto, porém a carne é fraca».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> De novo se retirou
          Jesus e, pela segunda vez orou, dizendo:{" "}
          <Typography className="cross"> ✠ </Typography> «Meu Pai, se este cálice não pode
          passar sem que Eu o beba, faça-se a vossa vontade».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Depois veio outra
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Et conféstim
          ...
          eum. Dixítque illi Jesus: <Typography className="cross"> ✠ </Typography> Amíce, ad
          quid venísti?
        </Typography>
        <Typography className="vernacular">
          ...
          turba: <Typography className="font-bold text-red-500">S.</Typography> «Aquele que
          eu beijar, é Esse; prendei-O».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Logo que Judas
          chegou, aproximou-se do Mestre e disse-Lhe:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Salve, ó Mestre».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> E osculou-O. Jesus
          disse-lhe: <Typography className="cross"> ✠ </Typography> «Amigo, a que vieste?».
        </Typography>
        <Typography className="latin">
          <Typography className="font-bold text-red-500">C.</Typography> Tunc accessérunt,
          ...
          ait illi Jesus: <Typography className="cross"> ✠ </Typography> Convérte gládium
          ...
          <Typography className="font-bold text-red-500">C.</Typography> In illa hora dixit
          Jesus turbis: <Typography className="cross"> ✠ </Typography> Tamquam ad latrónem
          exístis cum gládiis et fústibus comprehéndere me: cotídie apud vos
          sedébam docens in templo, et non me tenuístis.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Hoc autem totum
          factum est, ut adimpleréntur Scripturae Prophetárum. Tunc discípuli
          omnes, relícto eo, fugérunt.
        </Typography>
        <Typography className="vernacular">
          <Typography className="font-bold text-red-500">C.</Typography> Chegaram-se, então,
          ...
          Entretanto Jesus disse-lhe: <Typography className="cross"> ✠ </Typography> «Mete a
          espada no seu lugar; pois todos quantos se servem da espada morrerão
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Ao mesmo tempo,
          Jesus disse às turbas: <Typography className="cross"> ✠ </Typography> «Viestes com
          ...
          prendestes?! <Typography className="font-bold text-red-500">C.</Typography> Tudo
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Hic dixit: Possum
          destrúere templum Dei, et post tríduum reædificáre illud.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et surgens princeps
          sacerdótum, ait illi:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Nihil respóndes ad
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Adjúro te per Deum
          vivum, ut dicas nobis, si tu es Christus, Fílius Dei.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Dicit illi Jesus:{" "}
          <Typography className="cross"> ✠ </Typography> Tu dixísti. Verúmtamen dico vobis,
          ámodo vidébitis Fílium hóminis sedéntem a dextris virtútis Dei, et
          veniéntem in núbibus cœli.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Tunc princeps
          sacerdótum scidit vestiménta sua, dicens:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Blasphemávit: quid
          adhuc egémus téstibus? Ecce, nunc audístis blasphémiam: quid vobis
          vidétur? <Typography className="font-bold text-red-500">C.</Typography> At illi
          respondéntes dixérunt:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Reus est mortis.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Tunc exspuérunt in
          fáciem ejus, et cólaphis eum cecidérunt, álii autem palmas in fáciem
          ejus dedérunt, dicéntes:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Prophetíza nobis,
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Ele disse: «Posso
          destruir o templo de Deus e reedificá-lo em três dias».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Logo se levantou o
          príncipe dos sacerdotes e disse:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Nada respondeis ao
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Conjuro-Vos, por
          Deus vivo, que nos digais se sois Cristo, Filho de Deus!».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Jesus respondeu:{" "}
          <Typography className="cross"> ✠ </Typography> «Tu o disseste; contudo digo-vos
          que haveis de ver daqui a pouco o Filho do homem assentar-se à direita
          do poder de Deus, caminhando sobre as nuvens do céu».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Então o príncipe
          dos sacerdotes rasgou os seus vestidos, dizendo:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Blasfemou! Para
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «É réu de morte».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Então, cuspiram-Lhe
          no rosto e deram-Lhe bofetadas, dizendo:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Adivinhai, ó
          Cristo, quem Vos bateu?».
        </Typography>
        <Typography className="latin">
          <Typography className="font-bold text-red-500">C.</Typography> Petrus vero sedébat
          foris in átrio: et accéssit ad eum una ancílla, dicens:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Et tu cum Jesu
          Galilǽo eras. <Typography className="font-bold text-red-500">C.</Typography> At
          ille negávit coram ómnibus, dicens:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Néscio, quid dicis.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Exeúnte autem illo
          jánuam, vidit eum ália ancílla, et ait his, qui erant ibi:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Et hic erat cum
          Jesu Nazaréno. <Typography className="font-bold text-red-500">C.</Typography> Et
          íterum negávit cum juraménto: Quia non novi hóminem. Et post pusíllum
          accessérunt, qui stabant, et dixérunt Petro:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Vere et tu ex illis
          es: nam et loquéla tua maniféstum te facit.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Tunc cœpit
        ...
        <Typography className="vernacular">
          <Typography className="font-bold text-red-500">C.</Typography> Durante este tempo,
          ...
          com Jesus, o Galileu».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Pedro negou logo,
          diante de todos, dizendo:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Não sei o que
          dizes». <Typography className="font-bold text-red-500">C.</Typography> Saindo,
          então, ele a porta, viu-o outra criada, que logo disse para os que
          estavam ali: <Typography className="font-bold text-red-500">S.</Typography> «Este
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Verdadeiramente tu
          também és deles, pois, o teu modo de falar, manifestamente, o dá a
          conhecer». <Typography className="font-bold text-red-500">C.</Typography> Então,
        ...
        <Typography className="latin">
          ...
          dicens: <Typography className="font-bold text-red-500">S.</Typography> Peccávi,
          tradens sánguinem justum.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> At illi dixérunt:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Quid ad nos? Tu
          vidéris. <Typography className="font-bold text-red-500">C.</Typography> Et
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Non licet eos
          míttere in córbonam: quia prétium sánguinis est.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Consílio autem
          ...
          appretiáti, quem appretiavérunt a fíliis Israël: et dedérunt eos in
          agrum fíguli, sicut constítuit mihi Dóminus.
        </Typography>
        <Typography className="vernacular">
          ...
          dizendo: <Typography className="font-bold text-red-500">S.</Typography> «Pequei,
          entregando-vos o sangue inocente!».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Mas eles disseram:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Que nos importa
          isso? Tu poderias pensar no que fazias!».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Ele, então, arrojou
          as moedas para o templo, afastou-se e foi enforcar-se! Os príncipes
          dos sacerdotes recolheram o dinheiro e disseram:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Não é lícito
          deitá-lo no cofre sagrado, pois é o preço do sangue».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> E, havendo reunido
          ...
          cumpriu o que fora anunciado pelo Profeta Jeremias, quando dissera:
          «Recolheram as trinta moedas de prata, preço d’Aquele que foi posto a
          preço por alguns filhos de Israel, comprando com elas o campo dum
          oleiro, como o Senhor me ordenou».
        </Typography>
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Et cum accusarétur
          a princípibus sacerdótum et senióribus, nihil respóndit. Tunc dicit
          illi Pilátus: <Typography className="font-bold text-red-500">S.</Typography> Non
          audis, quanta advérsum te dicunt testimónia?{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et non respóndit ei
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Quem vultis
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Nihil tibi et justo
          illi: multa enim passa sum hódie per visum propter eum.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Príncipes autem
          sacerdótum et senióres persuasérunt populis, ut péterent Barábbam,
          Jesum vero pérderent. Respóndens autem præses, ait illis:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Quem vultis vobis
          de duóbus dimítti? <Typography className="font-bold text-red-500">C.</Typography>{" "}
          At illi dixérunt: <Typography className="font-bold text-red-500">S.</Typography>{" "}
          Barábbam. <Typography className="font-bold text-red-500">C.</Typography> Dicit
          illis Pilátus: <Typography className="font-bold text-red-500">S.</Typography> Quid
          ígitur fáciam de Jesu, qui dícitur Christus?{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Dicunt omnes:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Crucifigátur.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Ait illis præses:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Quid enim mali
          íecit? <Typography className="font-bold text-red-500">C.</Typography> At illi
          magis clamábant, dicéntes:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Crucifigátur.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Videns autem
          Pilátus, quia nihil profíceret, sed magis tumúltus fíeret: accépta
          aqua, lavit manus coram pópulo, dicens:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Innocens ego sum a
          sánguine justi hujus: vos vidéritis.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et respóndens
          univérsus pópulus, dixit:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Sanguis ejus super
          nos et super fílios nostros.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Tunc dimísit illis
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Ave, Rex Judæórum.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et exspuéntes in
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Sois o Rei dos
          Judeus?». <Typography className="font-bold text-red-500">C.</Typography>{" "}
          Respondeu-lhe Jesus: «Tu o dizes».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> E, sendo acusado
          pelos príncipes dos sacerdotes e pelos anciãos, nada respondeu.
          Disse-Lhe, então, Pilatos:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Não ouvis as
          coisas de que Vos acusam?».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Mas Ele não
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Qual quereis que
          solte? Barrabás ou Jesus, por apelido Cristo?».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Pois sabia que por
          inveja é que lh’O haviam entregado. Quando Pilatos estava assentado no
          seu tribunal, mandou-lhe dizer sua mulher:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Não te ocupes
          desse justo, pois tive, hoje, sonhos, nos quais padeci muito por sua
          causa». <Typography className="font-bold text-red-500">C.</Typography>, Mas os
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Qual dos dois
          quereis que solte?».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Responderam:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Barrabás».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Pilatos observou:{" "}
          <Typography className="font-bold text-red-500">S.</Typography>, «Que hei-de fazer,
          então, de Jesus, que se chama Cristo?»{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Responderam todos:{" "}
          <Typography className="font-bold text-red-500">S.</Typography>, «Seja
          crucificado!». <Typography className="font-bold text-red-500">C.</Typography> O
          Governador disse-lhes:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Pois que mal fez
          Ele?». <Typography className="font-bold text-red-500">C.</Typography> Porém, cada
          vez mais alto, bradavam:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Seja
          crucificado!». <Typography className="font-bold text-red-500">C.</Typography>{" "}
          Vendo Pilatos que nada conseguia, mas que o tumulto crescia, mandou
          vir água e lavou as mãos diante do povo, dizendo:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Estou inocente do
          sangue deste justo; isso é lá convosco».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Todo o povo
          respondeu: <Typography className="font-bold text-red-500">S.</Typography> «Que o
          sangue caia sobre nós e nossos filhos!».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Então Pilatos
          ...
          vestidos e cobriram-n’O com um manto de púrpura. Depois, teceram uma
          ...
          judeus!». <Typography className="font-bold text-red-500">C.</Typography> E,
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Idípsum autem et
          ...
          <Typography className="cross"> ✠ </Typography> Eli, Eli, lamma sabactháni?{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Hoc est:{" "}
          <Typography className="cross"> ✠ </Typography> Deus meus, Deus meus, ut quid
          dereliquísti me? <Typography className="font-bold text-red-500">C.</Typography>{" "}
          Quidam autem illic stantes et audiéntes dicébant:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Elíam vocat iste.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et contínuo currens
          unus ex eis, accéptam spóngiam implévit acéto et impósuit arúndini, et
          dabat ei bíbere. Céteri vero dicébant:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Sine, videámus, an
          véniat Elías líberans eum.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Jesus autem íterum
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Ah! dissestes que
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Ao mesmo tempo os
          sacerdotes com os escribas e anciãos, escarneciam d’Ele, dizendo:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Salvou os outros e
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Os ladrões, que
          ...
          <Typography className="cross"> ✠ </Typography> «Elí, Elí, lamma sabatáni?».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Isto é:{" "}
          ...
          <Typography className="font-bold text-red-500">S. </Typography> «Chama por Elias».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Logo, correndo um
          deles, foi buscar uma esponja, ensopou-a em vinagre, pô-la sobre uma
          cana e apresentou-Lha para beber. Os outros diziam:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Deixa; vejamos se
          Elias vem livrá-l’O».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Porém Jesus,
        ...
        <Typography className="latin">
          ...
          valde, dicéntes: <Typography className="font-bold text-red-500">S.</Typography>{" "}
          Vere Fílius Dei erat iste.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Erant autem ibi
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Realmente, Este
          era o Filho de Deus!».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Achavam-se também,
