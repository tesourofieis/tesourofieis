  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="response"> ℟. </Text>{" "}
          <Text className="em">Jo. 11, 47-49, 50 & 53</Text> Os pontífices e os
          ...
          nosso povo».<Text className="versicle"> ℣. </Text>Mas um deles,
        ...
        <Text className="vernacular">
          ...
          a vossa vontade.
          <Text className="versicle"> ℣. </Text>Vigiai e orai, para não cairdes
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> dicántur et hi pálmites palmárum
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> ficáre dignéris: ut, quicúmque ex
        ...
        <Text className="vernacular">
          ...
          digneis <Text className="cross"> ✠ </Text> abençoar e
          <Text className="cross"> ✠ </Text> santificar estes Ramos de oliveira,
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> dic étiam hos ramos palmæ et olívæ,
        ...
        <Text className="vernacular">
          ...
          de Jesus, abençoai <Text className="cross"> ✠ </Text>, também, estes
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> dictióne sanctífices: ut cuncto
        ...
        <Text className="vernacular">
          ...
          <Text className="cross"> ✠ </Text> celestial, Vos pedimos, estes Ramos
      ...
      <Language>
        ...
        <Text className="vernacular">
          Abençoai <Text className="cross"> ✠ </Text>, Senhor, Vos imploramos,
      ...
      <Language>
        ...
        <Text className="vernacular">
          <Text className="response"> ℟. </Text> Glória, louvor & Plebs Hebrǽa
      ...
      <Language>
        <Text className="latin">
          <Text className="response"> ℟. </Text> Ingrediénte Dómino in sanctam
          civitátem, Hebræórum púeri resurrectiónem vitæ pronuntiántes. Cum
          ramis palmárum: Hosánna, clamábant, in excélsis.
          <Text className="versicle"> ℣. </Text>Cum audísset pópulus, quod Jesus
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>E, tendo o povo notícia de que
      ...
      <Language>
        <Text className="latin">
          ...
          meam. <Text className="latin">Ps. ibid., 2</Text> Deus, Deus meus,
        ...
        <Text className="vernacular">
          ...
          pois sou fraco. <Text className="vernacular">Sl. ibid., 2</Text> Meu
      ...
      <Language>
        ...
        <Text className="latin">
          ...
          nomen: <Text className="em">(hic genuflectitur)</Text> ut in nómine
      ...
      <Language>
        <Text className="latin">
          ...
          glória assumpsísti me.<Text className="versicle"> ℣. </Text>
        ...
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>Como o Deus de Israel é bom para
      ...
      <Language>
        <Text className="latin">
          ...
          <Text className="versicle"> ℣. </Text>Tu autem in sancto hábitas, laus
          Israël.<Text className="versicle"> ℣. </Text>In te speravérunt patres
          ...
          <Text className="versicle"> ℣. </Text>Sperávit in Dómino, erípiat eum:
          ...
          misérunt mortem.<Text className="versicle"> ℣. </Text>Líbera me de ore
          ...
          ejus.<Text className="versicle"> ℣. </Text>Pópulo, qui nascétur, quem
          fecit Dóminus.
        </Text>
        <Text className="vernacular">
          ...
          <Text className="versicle"> ℣. </Text>Contudo, sois a glória de Israel
          e habitais no santuário.
          <Text className="versicle"> ℣. </Text>Os nossos pais esperaram em Vós:
          ...
          <Text className="versicle"> ℣. </Text>Todos quantos me vêem, enchem-me
          de injúrias, murmuram de mim, abanando a cabeça e dizendo:
          <Text className="versicle"> ℣. </Text>«Esperou no Senhor; pois que
          ...
          sobre a minha túnica.<Text className="versicle"> ℣. </Text>
          Livrai-me, Senhor, da boca do leão e das pontas dos unicórnios, pois
          sou fraco.<Text className="versicle"> ℣. </Text>Louvai o Senhor, ó
          Vós, que O temeis! Cantai louvores em sua honra, ó filhos de Jacob.
          <Text className="versicle"> ℣. </Text>À geração futura será anunciado
      ...
      <Language>
        <Text className="latin">
          <Text className="cross"> ✠ </Text> Passio Dómini nostri Jesu Christi
          secúndum Matthǽum.
        </Text>
        <Text className="vernacular">
        ...
        <Text className="latin">
          ...
          <Text className="cross"> ✠ </Text> Dormíte jam et requiéscite: ecce,
        ...
        <Text className="latin">
          ...
          ait illi Jesus: <Text className="cross"> ✠ </Text> Convérte gládium
        ...
        <Text className="vernacular">
          ...
          Entretanto Jesus disse-lhe: <Text className="cross"> ✠ </Text> «Mete a
