      ...
      <ScrollView>
        <View className="docs">
          ...
          <Text className="aside">
            ...
            transbordar de santa alegria que nos permite, após vinte séculos,
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              Israël in desértum Sin, quod est inter Elim et Sínai: quintodécimo
              die mensis secúndi, postquam egréssi sunt de terra Ægýpti. Et
              murmurávit omnis congregátio filiórum Israël contra Móysen et
              Aaron in solitúdine. Dixerúntque fílii Israël ad eos: Utinam
              mórtui essëmus per manum Dómini in terra Ægýpti, quando sedebámus
              super oílas cárnium, et comedebámus panem in saturitáte: cur
              eduxístis nos in desértum istud, ut occiderétis omnem multitúdinem
              fame? Dixit autem Dóminus ad Móysen: Ecce, ego pluam vobis panes
              de cœlo: egrediátur pópulus, et cólligat quæ suffíciunt per
              síngulos dies: ut tentem eum, utrum ámbulet in lege mea an non.
              Die autem sexto parent quod ínferant: et sit duplum, quam
              collígere sciébant per síngulos dies. Dixerúntque Móyses et Aaron
            ...
            <Text className="vernacular">
              ...
              Egipto nos assentávamos em frente das caçarolas, cheias de carne,
              e tínhamos pão em abundância! Porque nos conduzistes a este
              deserto? Para aqui morrer de fome esta multidão?». Então o Senhor
              disse a Moisés: «Vou mandar chover pães do céu. Que o povo, pois,
              saia e recolha a quantidade necessária para cada dia, a fim de que
              verifique se procede ou não segundo a minha lei; porém, no sexto
              dia, prepararão o que tiverem recolhido, que será o duplo do que
              costumam recolher em cada um dos outros dias». Disseram, pois,
              Moisés e Aarão a todos os filhos de Israel: «Esta tarde
            ...
            <Text className="latin">
              ...
              in eum: Et vénient Románi, et tollent nostrum locum et gentem.
              <Text className="versicle"> ℣. </Text>
              Unus autem ex illis, Cáiphas nómine, cum esset póntifex anni
              illíus, prophetávit dicens: Expedit vobis, ut unus moriátur homo
            ...
            <Text className="vernacular">
              ...
              acreditarão n’Ele. E virão os romanos, e destruirão a nossa terra
              e o nosso povo».<Text className="versicle"> ℣. </Text>Mas um
              deles, chamado Caifás, que era o Pontífice naquele ano, disse
              profeticamente: «É melhor que morra um só homem pelo povo, do que
              pereça toda a nação». Desde aquele dia, pois, resolveram matá-l’O,
            ...
            <Text className="latin">
              ...
              volúntas tua.<Text className="versicle"> ℣. </Text>Vigiláte et
              oráte, ut non intrétis in tentatiónem. Spíritus quidem...
            </Text>
            <Text className="vernacular">
              <Text className="response"> ℟. </Text>{" "}
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              inveniétis ásinam alligátam et pullum cum ea: sólvite et addúcite
              mihi: et si quis vobis áliquid dixerit, dícite, quia Dóminus his
              opus habet, et conféstim dimíttet eos. Hoc autem totum factum est,
              ut adimplerétur, quod dictum est per Prophétam, dicéntem: Dícite
              fíliae Sion: Ecce, Rex tuus venit tibi mansuétus, sedens super
              ásinam et pullum, fílium subjugális. Eúntes autem discípuli,
              fecérunt, sicut præcépit illis Jesus. Et adduxérunt ásinam et
              pullum: et imposuérunt super eos vestiménta sua, et eum désuper
              sedére tecérunt. Plúrima autem turba stravérunt vestiménta sua in
              via: álii autem cædébant ramos de arbóribus, et sternébant in via:
              turbæ autem, quæ præcedébant et quæ sequebántur, clamábant,
            ...
            <Text className="vernacular">
              ...
              encontrareis uma jumenta presa e com ela um jumentinho.
              Desprendei-a e trazei-os. Se alguém vos disser alguma coisa,
              respondei: «O Senhor precisa deles». E logo os deixarão trazer».
              Tudo isto aconteceu para se cumprir o que fora anunciado pelo
              Profeta: «Dizei à filha de Sião: «Eis o teu Rei, que vem a ti com
              doçura, montado em uma jumenta e sobre um jumentinho, filho da que
              está sob o jugo». Foram os discípulos e fizeram tudo como Jesus
              lhes ordenara, trazendo a jumenta e o jumentinho. Então puseram em
              cima deles as suas capas e fizeram-n’O montar. Ora a multidão, que
              era numerosa, estendia as suas capas na estrada e cortava ramos
              das árvores, com que atapetava o caminho. E os da multidão, tanto
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="cross"> ✠ </Text> dicántur et hi pálmites
            ...
            <Text className="vernacular">
              ...
              assim como, querendo figurar a Igreja, multiplicastes as vossas
              graças sobre Noé, saindo da arca, e sobre Moisés, saindo do Egipto
              com os filhos de Israel, assim também permiti que, levando nós
              estas palmas e Ramos de oliveira, caminhemos ao encontro de Cristo
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="cross"> ✠ </Text> dícere et sancti{" "}
              <Text className="cross"> ✠ </Text> ficáre dignéris: ut, quicúmque
              ex ea recéperint, accípiant sibi protectiónem ánimæ et córporis:
              fiátque, Dómine, nostræ salútis remédium tuæ grátiæ sacraméntum.
              Per Dóminum nostrum...
            </Text>
            <Text className="vernacular">
              Vos imploramos, Senhor santo, Pai omnipotente, eterno Deus, que
              Vos digneis <Text className="cross"> ✠ </Text> abençoar e
              <Text className="cross"> ✠ </Text> santificar estes Ramos de
              oliveira, vossa Criatura, que fizestes nascer na árvore,
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="cross"> ✠ </Text> dic étiam hos ramos palmæ et
              olívæ, quos tui fámuli ad honórem nóminis tui fidéliter
            ...
            <Text className="vernacular">
              ...
              encontro de Jesus, abençoai <Text className="cross"> ✠ </Text>,
              também, estes Ramos de palmeira e de oliveira, que os vossos fiéis
              servos vão receber em honra do vosso nome, a fim de que, em
              qualquer lugar em que sejam colocados, aqueles que habitarem nesse
              lugar consigam a vossa bênção, e, afastada toda a adversidade, a
          ...
          <Language>
            <Text className="latin">
              ...
              intéllegant, quid mýstice desígnet in facto, quod hódie, cœlésti
              lúmine affláta, Redemptóri óbviam procédens, palmárum atque
              olivárum ramos vestígiis ejus turba substrávit. Palmárum igitur
              rami de mortis príncipe triúmphos exspéctant; súrculi vero
              olivárum spirituálem unctiónem advenísse Quodámmodo clamant.
              Intelléxit enim jam tunc illa hóminum beáta multitúdo præfigurári:
              quia Redémptor noster, humánis cóndolens misériis, pro totíus
              mundi vita cum mortis príncipe esset pugnatúrus ac moriéndo
              triumphatúrus. Et ídeo tália óbsequens administrávit, quæ in illo
              ei triúmphos victóriæ et misericórdiæ pinguédinem declarárent.
              Quod nos quoque plena fide, et factum et significátum retinéntes,
              te, Dómine sancte, Pater omnípotens, ætérne Deus, per eúndem
              Dóminum nostrum Jesum Christum supplíciter exorámus: ut in ipso
              atque per ipsum, cujus nos membra fíeri voluísti, de mortis
            ...
            <Text className="vernacular">
              ...
              corações dos vossos fiéis servos, para que compreendam
              salutarmente o mystério apresentado na acção daquele povo que,
              levado por inspiração celestial, caminhou neste dia ao encontro do
              Redentor e atapetou com ramos de palmeira e de oliveira o caminho
              por onde Ele devia passar. Com efeito, os ramos de palmeira
              significavam a vitória que ia alcançar sobre o príncipe da morte e
              os de oliveira publicavam, de certo modo, a união espiritual que
              ia ser espalhada. Esta feliz multidão de homens pressentiu, então,
              que o nosso Redentor, comovido com as misérias da humanidade, ia
              travar combate com o príncipe da morte, para dar a vida ao mundo
              inteiro, e que Ele triunfaria pela sua própria morte. Por isso, o
              povo ofereceu ao Senhor a homenagem destes Ramos, dos quais uns
              significavam a vitória e o triunfo e os outros a efusão da sua
              misericórdia. Nós, pois, que possuímos a plenitude da fé, vendo
              neste acontecimento não só o facto mas ainda a significação, Vos
              pedimos, Senhor santo, Pai omnipotente, Deus eterno, pelo mesmo N.
              S. Jesus Cristo, de quem houvestes por graça fazer-nos membros,
          ...
          <Language>
            <Text className="latin">
              ...
              ramos cœlésti bene <Text className="cross"> ✠ </Text> dictióne
              sanctífices: ut cuncto pópulo tuo profíciant ad salútem. Per
            ...
            <Text className="vernacular">
              ...
              <Text className="cross"> ✠ </Text> celestial, Vos pedimos, estes
              Ramos de oliveira e doutras árvores, a fim de que sirva de
          ...
          <Language>
            <Text className="latin">
              ...
              tui veneratiónem hodiérna die corporáliter agit, hoc spirituáliter
              summa devotióne perfíciat, de hoste victóriam reportándo et opus
              misericórdiæ summópere diligéndo. Per Dóminum...
            </Text>
            <Text className="vernacular">
              Abençoai <Text className="cross"> ✠ </Text>, Senhor, Vos
              imploramos, estes Ramos de palmeira e de oliveira, e concedei ao
              vosso povo a graça de realizar espiritualmente com ardente devoção
              a cerimónia exterior que hoje pratica em vossa honra; e que,
              triunfando do inimigo por meio dela, corresponda com amor à
          ...
          <Language>
            <Text className="latin">
              ...
              vestimenta sua cum ramis palmarum in via sternébant: præsta,
              quǽsumus; ut illi fídei viam præparémus, de qua, remoto lápide
            ...
            <Text className="vernacular">
              ...
              Escrituras, que, ao entrar Ele em Jerusalém, uma turba de povo
              fiel, cheia de sincera piedade, estendesse os seus vestidos e
              ramos de palmeira à sua passagem, concedei-nos a graça, Vos
              imploramos, de Lhe prepararmos pela fé um caminho onde não haja
              pedra, nem de tropeço, nem de escândalo, a fim de que das nossas
          ...
          <Language>
            ...
            <Text className="vernacular">
              <Text className="versicle"> ℣. </Text> Caminhemos em paz.
            </Text>
            <Text className="latin">
              <Text className="response"> ℟. </Text> In nómine Christi. Amen.
            </Text>
            <Text className="vernacular">
          ...
          <Language>
            <Text className="latin">
              ...
              et addúcite mihi. Si quis vos interrogáverit, dícite: Opus Dómino
              est. Solvéntes adduxérunt ad Jesum: et imposuérunt illi vestiménta
              sua, et sedit super eum: alii expandébant vestiménta sua in via:
              alii ramos de arbóribus sternébant: et qui sequebántur, clamábant:
              Hosánna, benedíctus, qui venit in nómine Dómini: benedíctum regnum
            ...
            <Text className="vernacular">
              ...
              Desprendei-o e trazei-mo. Se alguém vos disser alguma coisa,
              respondei: «O Senhor precisa dele». Havendo-o desprendido,
              trouxeram-no a Jesus. Então, puseram as suas capas em cima do
              jumentinho e fizeram Jesus montá-lo. E alguns da multidão
              estendiam os vestidos no caminho, outros espalhavam ramos de
              árvores e todos que O acompanhavam clamavam: «Bendito seja o que
          ...
          <Language>
            <Text className="latin">
              ...
              salus nostra et redémptio Israël. Quantus est iste, cui Throni et
              Dominatiónes occúrrunt! Noli timére, fília Sion: ecce, Rex tuus
            ...
            <Text className="vernacular">
              ...
              redenção de Israel! Como é grande Aquele diante de quem os Tronos
              e as Dominações se curvam para O receberem! Nada temas, ó filha de
              Sião, eis o teu Rei, que chega montado num jumentinho, como está
          ...
          <Language>
            ...
            <Text className="latin">
              <Text className="response"> ℟. </Text> Glória, laus &
            </Text>
            <Text className="vernacular">
            ...
            <Text className="vernacular">
              <Text className="response"> ℟. </Text> Glória, louvor & Plebs
          ...
          <Language>
            <Text className="latin">
              ...
              excélsis.
              <Text className="versicle"> ℣. </Text>Cum audísset pópulus, quod
              Jesus veníret Jerosólymam, exiérunt óbviam ei. Cum ramis palmárum:
              Hosánna, clamábant, in excélsis.
            </Text>
            <Text className="vernacular">
              <Text className="response"> ℟. </Text> Quando o Senhor entrava na
              cidade santa, os meninos hebreus anunciavam antecipadamente a
              ressurreição d’Aquele que é a vida. * Empunhando ramos de
              palmeira, clamavam: «Hosana no alto dos céus!».
              <Text className="versicle"> ℣. </Text>E, tendo o povo notícia de
          ...
          <Language>
            <Text className="latin">
              ...
              humilitátem meam. <Text className="latin">Ps. ibid., 2</Text>{" "}
            ...
            <Text className="vernacular">
              ...
              <Text className="vernacular">Sl. ibid., 2</Text> Meu Deus, meu
          ...
          <Language>
            ...
            <Text className="latin">
              ...
              similitúdinem hóminum factus, et hábitu invéntus ut homo.
            ...
            <Text className="vernacular">
              ...
              próprio, reduzindo-se à condição de servo, tornando-se semelhante
          ...
          <Language>
            <Text className="latin">
              ...
              Quam bonus Israël Deus rectis corde! mei autem pæne moti sunt
              pedes: pæne effúsi sunt gressus mei: quia zelávi in peccatóribus,
              pacem peccatórum videns.
            </Text>
            <Text className="vernacular">
              Apoiastes-me com vossa dextra; conduzistes-me segundo a vossa
              vontade; e elevastes-me com glória.
              <Text className="versicle"> ℣. </Text>Como o Deus de Israel é bom
          ...
          <Language>
            <Text className="latin">
              ...
              delictórum meórum.<Text className="versicle"> ℣. </Text>Deus meus,
              clamábo per diem, nec exáudies: in nocte, et non ad insipiéntiam
              mihi.<Text className="versicle"> ℣. </Text>Tu autem in sancto
              hábitas, laus Israël.<Text className="versicle"> ℣. </Text>In te
              speravérunt patres nostri: speravérunt, et liberásti eos.
              <Text className="versicle"> ℣. </Text>Ad te clamavérunt, et salvi
              facti sunt: in te speravérunt, et non sunt confusi.
              <Text className="versicle"> ℣. </Text>Ego autem sum vermis, et non
              homo: oppróbrium hóminum et abjéctio plebis.
              <Text className="versicle"> ℣. </Text>Omnes, qui vidébant me,
              aspernabántur me: locúti sunt lábiis et movérunt caput.
              <Text className="versicle"> ℣. </Text>Sperávit in Dómino, erípiat
              eum: salvum fáciat eum, quóniam vult eum.
              <Text className="versicle"> ℣. </Text>Ipsi vero consideravérunt et
              conspexérunt me: divisérunt sibi vestiménta mea, et super vestem
              meam misérunt mortem.<Text className="versicle"> ℣. </Text>Líbera
              me de ore leónis: et a córnibus unicórnium humilitátem meam.
              <Text className="versicle"> ℣. </Text>Qui timétis Dóminum, laudáte
              eum: univérsum semen Jacob, magnificáte eum.
              <Text className="versicle"> ℣. </Text>
              Annuntiábitur Dómino generátio ventúra: et annuntiábunt cœli
              justítiam ejus.<Text className="versicle"> ℣. </Text>Pópulo, qui
              nascétur, quem fecit Dóminus.
            </Text>
            <Text className="vernacular">
              Meu Deus, meu Deus, olhai para mim: Porque me abandonastes?
              <Text className="versicle"> ℣. </Text>O clamor dos meus pecados
              afastou de mim a salvação.<Text className="versicle"> ℣. </Text>
              Meu rei durante o dia e não me ouvi Deus, clama reis; clamarei
              durante a noite e não acharei consolação.
              <Text className="versicle"> ℣. </Text>Contudo, sois a glória de
              Israel e habitais no santuário.
              <Text className="versicle"> ℣. </Text>Os nossos pais esperaram em
              Vós: esperaram e fostes o seu libertador!
              <Text className="versicle"> ℣. </Text>Clamaram por Vós, e foram
              salvos; confiaram em Vós e não foram iludidos.
              <Text className="versicle"> ℣. </Text>Porém sou um verme e não um
              homem; sou o opróbrio dos homens, a irrisão do povo!
              <Text className="versicle"> ℣. </Text>Todos quantos me vêem,
              enchem-me de injúrias, murmuram de mim, abanando a cabeça e
              dizendo:<Text className="versicle"> ℣. </Text>«Esperou no Senhor;
              pois que venha salvá-l’O, já que O ama».
              <Text className="versicle"> ℣. </Text>Olharam para mim e
              desprezaram-me; repartiram entre si os meus vestidos e lançaram
              sortes sobre a minha túnica.<Text className="versicle"> ℣. </Text>
              Livrai-me, Senhor, da boca do leão e das pontas dos unicórnios,
              pois sou fraco.<Text className="versicle"> ℣. </Text>Louvai o
              Senhor, ó Vós, que O temeis! Cantai louvores em sua honra, ó
              filhos de Jacob.<Text className="versicle"> ℣. </Text>À geração
              futura será anunciado o Senhor; os céus proclamarão a sua justiça.
          ...
          <Language>
            ...
            <Text className="vernacular">
              <Text className="cross"> ✠ </Text> Paixão de Nosso Senhor Jesus
            ...
            <Text className="latin">
              ...
              <Text className="font-bold text-red-500">S.</Text> Quid vultis
            ...
            <Text className="vernacular">
              ...
              <Text className="cross"> ✠ </Text> «Sabeis que, passados dois
              dias, se celebrará a Páscoa e que o Filho do homem será entregue,
              para O crucificarem».{" "}
              <Text className="font-bold text-red-500">C.</Text> Então,
              reuniram-se os príncipes dos sacerdotes e os anciãos na sala do
              sumo Pontífice, que era chamado Caifás, e deliberaram prender
              Jesus, insidiosamente, e matarem-n’O. Mas diziam:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Que isso,
              porém, não seja no dia da festa, para que o povo não faça
              tumulto». <Text className="font-bold text-red-500">C.</Text>{" "}
              Então, estando Jesus em Betânia, em casa de Simão, o leproso,
              aproximou-se d’Ele uma mulher, trazendo um vaso de alabastro,
              cheio de perfumes preciosos, derramando-os sobre a cabeça de
              Jesus, que estava assentado à mesa. Vendo isto, indignaram-se os
              discípulos, dizendo:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Para que serve
              tal desperdício? Pois poderia ter-se vendido por elevada quantia
              este perfume e dar aos pobres o seu preço».{" "}
              <Text className="font-bold text-red-500">C.</Text> Conhecendo
              Jesus isto, disse-lhes: <Text className="cross"> ✠ </Text> «Para
              que causais pena a esta mulher? Foi uma boa obra para comigo, que
              ela praticou; pois pobres sempre os tereis convosco; porém a mim
              nem sempre me tereis. Espalhando este perfume sobre o meu corpo,
              ungiu-me para Eu ser sepultado. Em verdade vos digo: onde quer que
              seja pregado este Evangelho (no mundo inteiro) contar-se-á também
              em sua memória a acção que praticou».{" "}
              <Text className="font-bold text-red-500">C.</Text> Então um dos
              Doze, chamado Judas Iscariotes, foi ter com o príncipe dos
            ...
            <Text className="latin">
              ...
              edéntibus illis, dixit: <Text className="cross"> ✠ </Text> Amen,
              dico vobis, quia unus vestrum me traditúrus est.{" "}
              ...
              sum, Dómine? <Text className="font-bold text-red-500">C.</Text> At
              ipse respóndens, ait: <Text className="cross"> ✠ </Text> Qui
              intíngit mecum manum in parópside, hic me tradet. Fílius quidem
              hóminis vadit, sicut scriptum est de illo: væ autem hómini illi,
              per quem Fílius hóminis tradétur: bonum erat ei, si natus non
              fuísset homo ille.{" "}
              <Text className="font-bold text-red-500">C.</Text> Respóndens
              autem Judas, qui trádidit eum, dixit:{" "}
              <Text className="font-bold text-red-500">S.</Text> Numquid ego
              sum, Rabbi? <Text className="font-bold text-red-500">C.</Text> Ait
              illi: <Text className="cross"> ✠ </Text> Tu dixísti.{" "}
              <Text className="font-bold text-red-500">C.</Text> Cenántibus
              autem eis, accépit Jesus panem, et benedíxit, ac fregit, dedítque
              discípulis suis, et ait: <Text className="cross"> ✠ </Text>{" "}
              ...
              <Text className="cross"> ✠ </Text> Bíbite ex hoc omnes. Hic est
              enim sanguis meus novi Testaménti, qui pro multis effundétur in
              remissiónem peccatórum. Dico autem vobis: non bibam ámodo de hoc
              genímine vitis usque in diem illum, cum illud bibam vobíscum novum
              in regno Patris mei.{" "}
              <Text className="font-bold text-red-500">C.</Text> Et hymno dicto,
              exiérunt in montem Olivéti. Tunc dicit illis Jesus:{" "}
              <Text className="cross"> ✠ </Text> Omnes vos scándalum patiémini
              in me in ista nocte. Scriptum est enim: Percútiam pastórem, et
              dispergéntur oves gregis. Postquam autem resurréxero, præcédam vos
              in Galilǽam. <Text className="font-bold text-red-500">C.</Text>{" "}
              Respóndens autem Petrus, ait illi:{" "}
              <Text className="font-bold text-red-500">S.</Text> Et si omnes
              scandalizáti fúerint in te, ego numquam scandalizábor.{" "}
              <Text className="font-bold text-red-500">C.</Text> Ait illi Jesus:{" "}
              <Text className="cross"> ✠ </Text> Amen, dico tibi, quia in hac
              nocte, antequam gallus cantet, ter me negábis.{" "}
              <Text className="font-bold text-red-500">C.</Text> Ait illi
              Petrus: <Text className="font-bold text-red-500">S.</Text> Etiam
            ...
            <Text className="vernacular">
              ...
              estando eles a comer, disse-lhes:{" "}
              <Text className="cross"> ✠ </Text> «Em verdade vos digo que um de
              vós me trairá». <Text className="font-bold text-red-500">C.</Text>{" "}
              Então, cheios de profunda tristeza, começaram, individualmente, a
              dizer: <Text className="font-bold text-red-500">S.</Text> «Serei
              eu, Senhor?» <Text className="font-bold text-red-500">C.</Text>{" "}
              Ele disse: <Text className="cross"> ✠ </Text> «O que me há-de
              trair é aquele que mete comigo a mão no prato! Com efeito, o Filho
              do homem vai ser traído, segundo o que está escrito a seu
              respeito, mas infeliz daquele que O tiver traído! Melhor lhe fora
              não haver nascido!».{" "}
              ...
              disse-lhe: <Text className="cross"> ✠ </Text> «Tu o disseste!».{" "}
              <Text className="font-bold text-red-500">C.</Text> Enquanto
              ceavam, tomou Jesus o pão, benzeu-o, partiu-o e deu-o aos
              discípulos, dizendo: <Text className="cross"> ✠ </Text> «Tomai e
              comei: Isto é o meu corpo».{" "}
              <Text className="font-bold text-red-500">C.</Text> E, pegando no
              cálice, deu graças e entregou-lho, dizendo-lhes:{" "}
              <Text className="cross"> ✠ </Text> «Bebei dele vós todos. Pois
              este é o meu sangue do Novo Testamento, que será derramado por
              muitos para remissão dos pecados. Digo-vos, porém, que não mais
              tornarei a beber deste fruto da videira, até ao dia em que o
              hei-de beber, novamente, convosco no reino de meu Pai».{" "}
              <Text className="font-bold text-red-500">C.</Text> Havendo dito o
              hino de graças, saíram para o monte das Oliveiras, Então,
              disse-lhes Jesus: <Text className="cross"> ✠ </Text> «Esta noite
              serei para vós todos motivo de escândalo; porque está escrito:
              «Ferirei o pastor e as ovelhas do rebanho serão dispersas». Mas,
              depois de ressuscitar, irei adiante de vós para a Galileia»{" "}
              <Text className="font-bold text-red-500">C.</Text> Porém,
              respondendo Pedro, disse-Lhe:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Ainda que
              todos se escandalizem, eu nunca me escandalizarei».{" "}
              <Text className="font-bold text-red-500">C.</Text> E Jesus
              retorquiu-lhe: <Text className="cross"> ✠ </Text> «Em verdade te
              digo: esta noite, antes de o galo cantar, negar-me-ás três vezes».{" "}
              <Text className="font-bold text-red-500">C.</Text> edro disse-Lhe:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Ainda que
              tenha de morrer convosco, não Vos negarei!».{" "}
            ...
            <Text className="latin">
              ...
              dixit discípulis suis: <Text className="cross"> ✠ </Text> Sedéte
              ...
              Tunc ait illis: <Text className="cross"> ✠ </Text> Tristis est
              ánima mea usque ad mortem: sustinéte hic, et vigilate mecum.{" "}
              ...
              tránseat a me calix iste: Verúmtamen non sicut ego volo, sed sicut
              tu. <Text className="font-bold text-red-500">C.</Text> Et venit ad
              discípulos suos, et invénit eos dormiéntes: et dicit Petro:{" "}
              <Text className="cross"> ✠ </Text> Sic non potuístis una hora
              vigiláre mecum? Vigiláte et oráte, ut non intrétis in tentatiónem.
              Spíritus quidem promptus est, caro autem infírma.{" "}
              <Text className="font-bold text-red-500">C.</Text> Iterum secúndo
              ábiit et orávit, dicens: <Text className="cross"> ✠ </Text> Pater
              mi, si non potest hic calix transíre, nisi bibam illum, fiat
              volúntas tua. <Text className="font-bold text-red-500">C.</Text>{" "}
              Et venit íterum, et invenit eos dormiéntes: erant enim óculi eórum
              ...
              ecce, appropinquávit hora, et Fílius hóminis tradétur in manus
            ...
            <Text className="vernacular">
              ...
              aos discípulos: <Text className="cross"> ✠ </Text> «Assentai-vos
              ...
              angustiar-se. E disse-lhes: <Text className="cross"> ✠ </Text>{" "}
              «Minha alma está triste até à morte! Ficai aqui e vigiai comigo».{" "}
              <Text className="font-bold text-red-500">C.</Text> Depois, avançou
              um pouco e prostrou-se com o rosto no chão, orando e dizendo:{" "}
              <Text className="cross"> ✠ </Text> «Meu Pai, se é possível, fazei
              que este cálice se afaste de mim; contudo faça-se a vossa vontade
              e não a minha». <Text className="font-bold text-red-500">C.</Text>{" "}
              Em seguida, veio ter com os discípulos, encontrando-os a dormir.
              Disse, então, a Pedro: <Text className="cross"> ✠ </Text> «Pois
              não pudestes vigiar uma hora comigo?! Vigiai e orai para não
              entrardes em tentação. Na verdade, o espírito está pronto, porém a
              carne é fraca». <Text className="font-bold text-red-500">C.</Text>{" "}
              De novo se retirou Jesus e, pela segunda vez orou, dizendo:{" "}
              <Text className="cross"> ✠ </Text> «Meu Pai, se este cálice não
              pode passar sem que Eu o beba, faça-se a vossa vontade».{" "}
              <Text className="font-bold text-red-500">C.</Text> Depois veio
              outra vez ter com os discípulos, que achou dormindo (até tinham os
              olhos colados de sono!), e, deixando-os, foi pela terceira vez
              orar, repetindo as mesmas palavras. Depois, veio ter com os
              discípulos e disse-lhes: <Text className="cross"> ✠ </Text> «Dormi
              agora e repousai: eis que se aproxima a hora em que o Filho do
              homem será entregue às mãos dos pecadores. Erguei-vos; vamos! Eis
            ...
            <Text className="latin">
              ...
              est eum. Dixítque illi Jesus: <Text className="cross"> ✠ </Text>{" "}
            ...
            <Text className="vernacular">
              ...
              osculou-O. Jesus disse-lhe: <Text className="cross"> ✠ </Text>{" "}
              «Amigo, a que vieste?».
            </Text>
            <Text className="latin">
              ...
              apud vos sedébam docens in templo, et non me tenuístis.{" "}
            ...
            <Text className="vernacular">
              ...
              mais de doze legiões de Anjos? Mas, como se cumpririam as
              Escrituras que anunciam que assim deveria suceder?».{" "}
              <Text className="font-bold text-red-500">C.</Text> Ao mesmo tempo,
              Jesus disse às turbas: <Text className="cross"> ✠ </Text> «Viestes
              com espadas e paus para me prender, como se Eu fora um ladrão?!
              Todos os dias estava assentado convosco, ensinando no templo, e
              não me prendestes?!{" "}
              <Text className="font-bold text-red-500">C.</Text> Tudo isto
              aconteceu assim, para que se cumprissem as Escrituras dos
              Profetas. E, naquela hora, todos os discípulos, havendo-O
              abandonado, fugiram.
            </Text>
            <Text className="latin">
              ...
              sedébat cum minístris, ut vidéret finem. Príncipes autem
              ...
              <Text className="font-bold text-red-500">S.</Text> Adjúro te per
              Deum vivum, ut dicas nobis, si tu es Christus, Fílius Dei.{" "}
              <Text className="font-bold text-red-500">C.</Text> Dicit illi
              Jesus: <Text className="cross"> ✠ </Text> Tu dixísti. Verúmtamen
              dico vobis, ámodo vidébitis Fílium hóminis sedéntem a dextris
              virtútis Dei, et veniéntem in núbibus cœli.{" "}
              <Text className="font-bold text-red-500">C.</Text> Tunc princeps
              sacerdótum scidit vestiménta sua, dicens:{" "}
              <Text className="font-bold text-red-500">S.</Text> Blasphemávit:
              quid adhuc egémus téstibus? Ecce, nunc audístis blasphémiam: quid
              vobis vidétur? <Text className="font-bold text-red-500">C.</Text>{" "}
              At illi respondéntes dixérunt:{" "}
              <Text className="font-bold text-red-500">S.</Text> Reus est
              mortis. <Text className="font-bold text-red-500">C.</Text> Tunc
            ...
            <Text className="vernacular">
              ...
              sacerdotes, havendo entrado e tomado lugar, junto com os criados,
              para ver o resultado. Entretanto, os príncipes dos sacerdotes e
              todos os do conselho buscavam algum falso testemunho contra Jesus
              ...
              nada dizia; pelo que o príncipe dos sacerdotes O instou:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Conjuro-Vos,
              por Deus vivo, que nos digais se sois Cristo, Filho de Deus!».{" "}
              <Text className="font-bold text-red-500">C.</Text> Jesus
              respondeu: <Text className="cross"> ✠ </Text> «Tu o disseste;
              contudo digo-vos que haveis de ver daqui a pouco o Filho do homem
              assentar-se à direita do poder de Deus, caminhando sobre as nuvens
              do céu». <Text className="font-bold text-red-500">C.</Text> Então
              o príncipe dos sacerdotes rasgou os seus vestidos, dizendo:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Blasfemou!
              Para que são precisas ainda testemunhas? Eis que acabais de ouvir
              uma blasfémia! Que vos parece?»{" "}
              <Text className="font-bold text-red-500">C.</Text> Eles
              responderam: <Text className="font-bold text-red-500">S.</Text> «É
              réu de morte». <Text className="font-bold text-red-500">C.</Text>{" "}
              Então, cuspiram-Lhe no rosto e deram-Lhe bofetadas, dizendo:{" "}
            ...
            <Text className="latin">
              ...
              <Text className="font-bold text-red-500">S.</Text> Néscio, quid
              dicis. <Text className="font-bold text-red-500">C.</Text> Exeúnte
              autem illo jánuam, vidit eum ália ancílla, et ait his, qui erant
              ibi: <Text className="font-bold text-red-500">S.</Text> Et hic
              erat cum Jesu Nazaréno.{" "}
              <Text className="font-bold text-red-500">C.</Text> Et íterum
              negávit cum juraménto: Quia non novi hóminem. Et post pusíllum
              accessérunt, qui stabant, et dixérunt Petro:{" "}
              <Text className="font-bold text-red-500">S.</Text> Vere et tu ex
              illis es: nam et loquéla tua maniféstum te facit.{" "}
              <Text className="font-bold text-red-500">C.</Text> Tunc cœpit
              detestári et juráre, quia non novísset hóminem. Et contínuo gallus
              cantávit. Et recordátus est Petrus verbi Jesu, quod díxerat:
            ...
            <Text className="vernacular">
              ...
              estavam ali: <Text className="font-bold text-red-500">S.</Text>{" "}
              «Este também estava com Jesus Nazareno».{" "}
              <Text className="font-bold text-red-500">C.</Text> , Pedro negou
              segunda vez com juramento, afirmando: «Não conheço tal homem».
              ...
              <Text className="font-bold text-red-500">C.</Text> Então, começou
              a proferir imprecações e a jurar que não conhecia tal homem.
              Subitamente, cantou o galo. E logo Pedro se recordou de que Jesus
            ...
            <Text className="latin">
              ...
              ad nos? Tu vidéris.{" "}
              <Text className="font-bold text-red-500">C.</Text> Et projéctis
              argénteis in templo, recéssit: et ábiens, láqueo se suspéndit.
              Príncipes autem sacerdótum, accéptis argénteis, dixérunt:{" "}
              ...
              Propter hoc vocátus est ager ille Hacéldama, hoc est, ager
              sánguinis, usque in hodiérnum diem. Tunc implétum est, quod dictum
              est per Jeremíam Prophétam, dicéntem: Et accepérunt trigínta
            ...
            <Text className="vernacular">
              ...
              <Text className="font-bold text-red-500">C.</Text> Ele, então,
              arrojou as moedas para o templo, afastou-se e foi enforcar-se! Os
              príncipes dos sacerdotes recolheram o dinheiro e disseram:{" "}
              ...
              reunido o conselho a respeito disto, compraram com esse dinheiro o
              campo dum oleiro, para servir de cemitério dos peregrinos; por
              isso aquele campo é ainda hoje chamado «Hacéldama», isto é, campo
              do sangue. Com isto se cumpriu o que fora anunciado pelo Profeta
              Jeremias, quando dissera: «Recolheram as trinta moedas de prata,
            ...
            <Text className="latin">
              ...
              <Text className="font-bold text-red-500">S.</Text> Non audis,
              quanta advérsum te dicunt testimónia?{" "}
              <Text className="font-bold text-red-500">C.</Text> Et non
              respóndit ei ad ullum verbum, ita ut mirarétur præses veheménter.
              Per diem autem sollémnem consuéverat præses pópulo dimíttere unum
              vinctum, quem voluíssent. Habébat autem tunc vinctum insígnem, qui
              dicebátur Barábbas. Congregátis ergo illis, dixit Pilátus:{" "}
              ...
              quod per invídiam tradidíssent eum. Sedénte autem illo pro
              tribunáli, misit ad eum uxor ejus, dicens:{" "}
              <Text className="font-bold text-red-500">S.</Text> Nihil tibi et
              justo illi: multa enim passa sum hódie per visum propter eum.{" "}
              ...
              <Text className="font-bold text-red-500">S.</Text> Quem vultis
              vobis de duóbus dimítti?{" "}
              <Text className="font-bold text-red-500">C.</Text> At illi
              dixérunt: <Text className="font-bold text-red-500">S.</Text>{" "}
              Barábbam. <Text className="font-bold text-red-500">C.</Text> Dicit
              illis Pilátus: <Text className="font-bold text-red-500">S.</Text>{" "}
              Quid ígitur fáciam de Jesu, qui dícitur Christus?{" "}
              <Text className="font-bold text-red-500">C.</Text> Dicunt omnes:{" "}
              <Text className="font-bold text-red-500">S.</Text> Crucifigátur.{" "}
              <Text className="font-bold text-red-500">C.</Text> Ait illis
              præses: <Text className="font-bold text-red-500">S.</Text> Quid
              enim mali íecit?{" "}
              <Text className="font-bold text-red-500">C.</Text> At illi magis
              clamábant, dicéntes:{" "}
              <Text className="font-bold text-red-500">S.</Text> Crucifigátur.{" "}
              ...
              <Text className="font-bold text-red-500">S.</Text> Innocens ego
              sum a sánguine justi hujus: vos vidéritis.{" "}
              <Text className="font-bold text-red-500">C.</Text> Et respóndens
              univérsus pópulus, dixit:{" "}
              <Text className="font-bold text-red-500">S.</Text> Sanguis ejus
              super nos et super fílios nostros.{" "}
              <Text className="font-bold text-red-500">C.</Text> Tunc dimísit
              illis Barábbam: Jesum autem flagellátum trádidit eis, ut
              crucifigerétur. Tunc mílites prǽsidis suscipiéntes Jesum in
              prætórium, congregavérunt ad eum univérsam cohórtem: et exuéntes
              eum, chlámydem coccíneam circumdedérunt ei: et plecténtes corónam
              de spinis, posuérunt super caput ejus, et arúndinem in déxtera
              ejus. Et genu flexo ante eum, illudébant ei, dicéntes:{" "}
              <Text className="font-bold text-red-500">S.</Text> Ave, Rex
              Judæórum. <Text className="font-bold text-red-500">C.</Text> Et
              exspuéntes in eum, accepérunt arúndinem, et percutiébant caput
            ...
            <Text className="vernacular">
              ...
              quisesse. Havia, então, um preso notável, chamado Barrabás.
              Estando todos juntos, disse Pilatos:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Qual quereis
              que solte? Barrabás ou Jesus, por apelido Cristo?».{" "}
              <Text className="font-bold text-red-500">C.</Text> Pois sabia que
              por inveja é que lh’O haviam entregado. Quando Pilatos estava
              assentado no seu tribunal, mandou-lhe dizer sua mulher:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Não te ocupes
              desse justo, pois tive, hoje, sonhos, nos quais padeci muito por
              sua causa». <Text className="font-bold text-red-500">C.</Text>,
              Mas os príncipes dos sacerdotes e os anciãos persuadiram o povo
              que pedisse que Barrabás fosse solto e mandasse matar Jesus.
              Falando, pois, o Governador, disse-lhes:{" "}
              ...
              observou: <Text className="font-bold text-red-500">S.</Text>, «Que
              hei-de fazer, então, de Jesus, que se chama Cristo?»{" "}
              <Text className="font-bold text-red-500">C.</Text> Responderam
              todos: <Text className="font-bold text-red-500">S.</Text>, «Seja
              crucificado!». <Text className="font-bold text-red-500">C.</Text>{" "}
              O Governador disse-lhes:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Pois que mal
              fez Ele?». <Text className="font-bold text-red-500">C.</Text>{" "}
              Porém, cada vez mais alto, bradavam:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Seja
              crucificado!». <Text className="font-bold text-red-500">C.</Text>{" "}
              Vendo Pilatos que nada conseguia, mas que o tumulto crescia,
              mandou vir água e lavou as mãos diante do povo, dizendo:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Estou inocente
              do sangue deste justo; isso é lá convosco».{" "}
              <Text className="font-bold text-red-500">C.</Text> Todo o povo
              respondeu: <Text className="font-bold text-red-500">S.</Text> «Que
              o sangue caia sobre nós e nossos filhos!».{" "}
              <Text className="font-bold text-red-500">C.</Text> Então Pilatos
              soltou Barrabás, e, havendo mandado açoitar Jesus, entregou-lh’O
              para ser crucificado. Os soldados do governador conduziram Jesus
              ao Pretório, formaram em torno d’Ele toda a corte, despojaram-n’O
              dos vestidos e cobriram-n’O com um manto de púrpura. Depois,
              teceram uma coroa de espinhos, puseram-Lha na cabeça, meteram-Lhe
              na mão direita uma cana, como se fora um ceptro, e ajoelharam
              diante d’Ele, escarnecendo-O e dizendo:{" "}
              <Text className="font-bold text-red-500">S.</Text> «Salve, ó Rei
              dos judeus!». <Text className="font-bold text-red-500">C.</Text>{" "}
              E, cuspindo-Lhe nas faces, tiraram-Lhe a cana e bateram-Lhe com
              ela na cabeça. Depois, ainda O escarneceram, tiraram-Lhe o manto,
            ...
            <Text className="latin">
              ...
              bíbere cum felle mixtum. Et cum gustásset, nóluit bibere. Postquam
              autem crucifixérunt eum, divisérunt vestiménta ejus, sortem
              mitténtes: ut implerétur, quod dictum est per Prophétam dicentem:
              Divisérunt sibi vestiménta mea, et super vestem meam misérunt
              sortem. Et sedéntes, servábant eum. Et imposuérunt super caput
              ...
              dicébant: <Text className="font-bold text-red-500">S.</Text> Alios
              ...
              <Text className="font-bold text-red-500">C.</Text> Idípsum autem
              et latrónes, qui crucifíxi erant cum eo, improperábant ei. A sexta
              autem hora ténebræ factæ sunt super univérsam terram usque ad
              horam nonam. Et circa horam nonam clamávit Jesus voce magna,
              dicens: <Text className="cross"> ✠ </Text> Eli, Eli, lamma
              sabactháni? <Text className="font-bold text-red-500">C.</Text> Hoc
              est: <Text className="cross"> ✠ </Text> Deus meus, Deus meus, ut
              quid dereliquísti me?{" "}
              <Text className="font-bold text-red-500">C.</Text> Quidam autem
              illic stantes et audiéntes dicébant:{" "}
              <Text className="font-bold text-red-500">S.</Text> Elíam vocat
              iste. <Text className="font-bold text-red-500">C.</Text> Et
              ...
              <Text className="font-bold text-red-500">S.</Text> Sine, videámus,
              an véniat Elías líberans eum.{" "}
              <Text className="font-bold text-red-500">C.</Text> Jesus autem
            ...
            <Text className="vernacular">
              ...
              vinho misturado com fel. Porém Ele, havendo-o provado, o não quis
              beber. Depois de O crucificarem, lançaram sortes sobre os seus
              vestidos (para se cumprir o que fora anunciado pelo Profeta):
              «Repartiram entre si os meus vestidos e lançaram sortes à minha
              túnica». Depois assentaram-se e assim O guardaram. Puseram,
              também, por cima da sua cabeça uma inscrição, indicando a causa da
              ...
              «Salvou os outros e não pode salvar-se a si próprio? Se Ele é o
              Rei de Israel, que desça da cruz, e acreditaremos n’Ele. Confiou
              em Deus?! Pois, se Deus O ama, que O livre, porquanto Ele disse:
              «Sou o Filho de Deus».{" "}
              <Text className="font-bold text-red-500">C.</Text> Os ladrões, que
              estavam crucificados com Ele, insultavam-n’O do mesmo modo. Desde
              a hora sexta até à nona, as trevas estenderam-se por toda a terra.
              ...
              <Text className="font-bold text-red-500">S. </Text> «Chama por
              Elias». <Text className="font-bold text-red-500">C.</Text> Logo,
              correndo um deles, foi buscar uma esponja, ensopou-a em vinagre,
              pô-la sobre uma cana e apresentou-Lha para beber. Os outros
              diziam: <Text className="font-bold text-red-500">S.</Text> «Deixa;
            ...
            <Text className="latin">
              ...
              surrexérunt. Et exeúntes de monuméntis post resurrectiónem ejus,
            ...
            <Text className="vernacular">
              ...
              que haviam morrido, ressuscitaram; e, saindo dos seus sepulcros,
            ...
            <Text className="latin">
              ...
              pósuit illud in monuménto suo novo, quod excíderat in petra. Et
            ...
            <Text className="vernacular">
              ...
              entregue o cadáver; e, levando-O José, amortalhou-O em um lençol
              limpo e depositou-O em um sepulcro novo, que havia mandado abrir
              na rocha. Depois, colocou uma pedra pesada à entrada do sepulcro e
          ...
          <Language>
            <Text className="latin">
              ...
              resúrgam. Jube ergo custodíri sepúlcrum usque in diem tértium: ne
              forte véniant discípuli ejus, et furéntur eum, et dicant plebi:
              Surréxit a mórtuis; et erit novíssimus error pejor prióre. Ait
              illis Pilátus: Habétis custódiam, ite, custodíte, sicut scitis.
            ...
            <Text className="vernacular">
              ...
              disse: «Depois de três dias, ressuscitarei». Ordenai, pois, que
              seu sepulcro seja guardado, até ao terceiro dia, pois não seja o
              caso que os discípulos roubem o cadáver e digam depois à plebe:
              «Ressuscitou dos mortos!». Então, seria o último embuste pior do
              que o primeiro». Pilatos respondeu-lhes: «Tendes aí guardas; ide e
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              doçura, montado em uma jumenta e sobre um jumentinho, filho da que
              está sob o jugo». Foram os discípulos e fizeram tudo como Jesus
              lhes ordenara, trazendo a jumenta e o jumentinho. Então, puseram
              em cima deles as suas capas e fizeram-n’O montar. Ora a multidão,
              que era numerosa estendia as suas capas na estrada e cortava ramos
              das árvores com que atapetavam o caminho. E os da multidão, tanto
              os que O precediam, como os que O seguiam, clamavam: «Hosana ao
              Filho de David. Bendito seja O que vem em nome do Senhor!».
            </Text>
          </Language>
