    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Sciens
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Quanto
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> At
          ...
          ego sum, Dómine?{" "}
          <Typography className="font-bold text-red-500">C.</Typography> At ipse
          ...
          ille. <Typography className="font-bold text-red-500">C.</Typography>{" "}
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Ait
          illi Petrus:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Etiam
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Serei
          eu, Senhor?»{" "}
          ...
          nascido!».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Ora
          ...
          vezes». <Typography className="font-bold text-red-500">C.</Typography>{" "}
          edro disse-Lhe:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «Ainda
          que tenha de morrer convosco, não Vos negarei!».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> O mesmo
        ...
        <Typography className="latin">
          ...
          mecum. <Typography className="font-bold text-red-500">C.</Typography>{" "}
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Em
          ...
          fraca». <Typography className="font-bold text-red-500">C.</Typography>{" "}
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> In illa
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Hoc
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Ao
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Tudo
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Hic
          dixit: Possum destrúere templum Dei, et post tríduum reædificáre
          illud. <Typography className="font-bold text-red-500">C.</Typography>{" "}
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Adjúro
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Reus
          est mortis.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Tunc
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Ele
          disse: «Posso destruir o templo de Deus e reedificá-lo em três dias».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Logo se
          ...
          Deus!». <Typography className="font-bold text-red-500">C.</Typography>{" "}
          ...
          nuvens do céu».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Então o
          ...
          responderam:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> «É réu
          de morte».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Então,
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Néscio,
          quid dicis.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Exeúnte
        ...
        <Typography className="vernacular">
          <Typography className="font-bold text-red-500">C.</Typography> Durante
          ...
          sei o que dizes».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Saindo,
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> At illi
          dixérunt:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Quid ad
          nos? Tu vidéris.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Não é
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Quem
          ...
          illis: <Typography className="font-bold text-red-500">S.</Typography>{" "}
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Dicunt
          omnes: <Typography className="font-bold text-red-500">S.</Typography>{" "}
          Crucifigátur.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Ait
          illis præses:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Quid
          ...
          <Typography className="font-bold text-red-500">S.</Typography>{" "}
          Crucifigátur.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Videns
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Sanguis
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Mas Ele
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Qual
          quereis que solte? Barrabás ou Jesus, por apelido Cristo?».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Pois
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Não te
          ocupes desse justo, pois tive, hoje, sonhos, nos quais padeci muito
          por sua causa».{" "}
          <Typography className="font-bold text-red-500">C.</Typography>, Mas os
          ...
          crucificado!».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> O
          Governador disse-lhes:{" "}
        ...
        <Typography className="latin">
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Idípsum
          ...
          <Typography className="font-bold text-red-500">C.</Typography> Quidam
          autem illic stantes et audiéntes dicébant:{" "}
          <Typography className="font-bold text-red-500">S.</Typography> Elíam
          vocat iste.{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Et
          ...
          <Typography className="font-bold text-red-500">S.</Typography> Sine,
        ...
        <Typography className="vernacular">
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Ah!
          ...
          cruz». <Typography className="font-bold text-red-500">C.</Typography>{" "}
          ...
          <Typography className="font-bold text-red-500">S. </Typography> «Chama
          por Elias».{" "}
          <Typography className="font-bold text-red-500">C.</Typography> Logo,
          ...
          <Typography className="font-bold text-red-500">S.</Typography> «Deixa;
