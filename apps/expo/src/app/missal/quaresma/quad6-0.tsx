    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          15 do segundo mês, depois que safram da terra do Egipto. Apenas
        ...
        <p>
          ...
          concílium, et dixérunt: Quid fácimus, quia hic homo multa signa facit?
          Si dimíttimus eum sic, omnes credent in eum: Et vénient Románi, et
          tollent nostrum locum et gentem. ℣. Unus autem ex illis, Cáiphas
          nómine, cum esset póntifex anni illíus, prophetávit dicens: Expedit
          vobis, ut unus moriátur homo pro pópulo, et non tota gens péreat. Ab
          illo ergo die cogitavérunt interfícere eum, dicéntes. Et vénient...
        </p>
        <p>
          <span className="text-red-500">℟.</span>{" "}
          <em>Jo. 11, 47-49, 50 & 53</em> Os pontífices e os fariseus
          reuniram-se em conselho e disseram: «Que faremos? Este homem faz
          muitos prodígios. Se o deixamos andar livremente, todos acreditarão
          n’Ele. E virão os romanos, e destruirão a nossa terra e o nosso povo».
          ℣. Mas um deles, chamado Caifás, que era o Pontífice naquele ano,
          disse profeticamente: «É melhor que morra um só homem pelo povo, do
          que pereça toda a nação». Desde aquele dia, pois, resolveram matá-l’O,
          dizendo: «E virão os romanos…»
        </p>
        <p>
          <span className="text-red-500">℟.</span> <em>Mt. 28, 39 & 41</em> In
          monte Olivéti orávit ad Patrem: Pater, si fíeri potest, tránseat a me
          calix iste. Spíritus quidem promptus est, caro autem infírma: fiat
          volúntas tua. ℣. Vigiláte et oráte, ut non intrétis in tentatiónem.
          Spíritus quidem...
        </p>
        <p>
          <span className="text-red-500">℟.</span> <em>Mt. 28, 39 & 41</em> No
          monte das Oliveiras orou a seu Pai: Meu pai, se é possível, afastai de
          mim este cálice! Na verdade, o espírito está pronto: mas a carne é
          fraca; contudo, faça-se a vossa vontade. ℣. Vigiai e orai, para não
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> dicántur et hi pálmites
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> dícere et sancti{" "}
          <span className="cross text-red-500">✠</span> ficáre dignéris: ut,
        ...
        <p>
          ...
          digneis <span className="cross text-red-500">✠</span> abençoar e
          <span className="text-red-500"> ✠ </span> santificar estes Ramos de
          oliveira, vossa Criatura, que fizestes nascer na árvore, semelhantes
          ao que a pomba levava no bico quando regressou à arca. Permiti que
          aqueles que receberam estes Ramos obtenham a vossa protecção na alma e
          no corpo; e que estes Ramos, Senhor, que são um sinal da vossa graça,
          se convertam em remédio eficaz para as nossas enfermidades. Por nosso
          Senhor...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> dic étiam hos ramos
        ...
        <p>
          ...
          de Jesus, abençoai <span className="cross text-red-500">✠</span>,
      ...
      <div className="side-by-side">
        <p>
          ...
          <span className="cross text-red-500">✠</span> dictióne sanctífices: ut
        ...
        <p>
          ...
          <span className="cross text-red-500">✠</span> celestial, Vos pedimos,
          ...
          Senhor. <span className="text-red-500">℟.</span> Amen.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Bene <span className="cross text-red-500">✠</span> dic, quǽsumus,
        ...
        <p>
          Abençoai <span className="cross text-red-500">✠</span>, Senhor, Vos
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> In nómine Christi. Amen.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Em nome de Cristo. Amen.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟.</span> Glória, laus &
        </p>
        <p>
          <span className="text-red-500">℟. </span> Glória, louvor &
        </p>
        <p>
        ...
        <p>
          <span className="text-red-500">℟. </span> Glória, louvor & Plebs
          Hebrǽa tibi cum palmis óbvia venit:
        </p>
        <p>Cum prece, voto, hymnis, ádsumus ecce tibi.</p>
        <p>
      ...
      <div className="side-by-side">
        <p>
          <span className="text-red-500">℟.</span> Ingrediénte Dómino in sanctam
          civitátem, Hebræórum púeri resurrectiónem vitæ pronuntiántes. Cum
          ramis palmárum: Hosánna, clamábant, in excélsis. ℣. Cum audísset
          pópulus, quod Jesus veníret Jerosólymam, exiérunt óbviam ei. Cum ramis
          palmárum: Hosánna, clamábant, in excélsis.
        </p>
        <p>
          <span className="text-red-500">℟.</span> Quando o Senhor entrava na
          ...
          clamavam: «Hosana no alto dos céus!». ℣. E, tendo o povo notícia de
          que Jesus vinha a Jerusalém, saiu ao seu encontro. Empunhando ramos de
          palmeira, clamava: «Hosana no alto dos céus!».
        </p>
      </div>

      <h2>Missa de Domingo de Ramos</h2>
      ...
      <div className="side-by-side">
        <p>
          ...
          meam. <em>Ps. ibid., 2</em> Deus, Deus meus, réspice in me: quare me
        ...
        <p>
          ...
          pois sou fraco. <em>Sl. ibid., 2</em> Meu Deus, meu Deus, lançai para
          mim vossos olhares. Porque me abandonastes? O clamor dos meus pecados
          afastou de mim a salvação.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          nomen: <em>hic genuflectitur</em> ut in nómine Jesu omne genu
          flectátur cœléstium, terréstrium et inférno rum: et omnis lingua
        ...
        <p>
          ...
          que é superior a todo o nome <em>devemos genuflectir</em> para que ao
          ser proferido o nome de Jesus todos os joelhos se dobrem nos céus, na
      ...
      <div className="side-by-side">
        <p>
          ...
          glória assumpsísti me. ℣. Quam bonus Israël Deus rectis corde! mei
          autem pæne moti sunt pedes: pæne effúsi sunt gressus mei: quia zelávi
          in peccatóribus, pacem peccatórum videns.
        </p>
        <p>
          Apoiastes-me com vossa dextra; conduzistes-me segundo a vossa vontade;
          e elevastes-me com glória. ℣. Como o Deus de Israel é bom para os que
          possuem coração recto! Meus pés estiveram vacilantes; estive quase a
          cair, pois eu olhava com indignação para os ímpios, vendo a paz que
          gozavam os pecadores.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          salúte mea verba delictórum meórum. ℣. Deus meus, clamábo per diem,
          nec exáudies: in nocte, et non ad insipiéntiam mihi. ℣. Tu autem in
          sancto hábitas, laus Israël. ℣. In te speravérunt patres nostri:
          speravérunt, et liberásti eos. ℣. Ad te clamavérunt, et salvi facti
          sunt: in te speravérunt, et non sunt confusi. ℣. Ego autem sum vermis,
          et non homo: oppróbrium hóminum et abjéctio plebis. ℣. Omnes, qui
          ...
          eum. ℣. Ipsi vero consideravérunt et conspexérunt me: divisérunt sibi
          vestiménta mea, et super vestem meam misérunt mortem. ℣. Líbera me de
          ore leónis: et a córnibus unicórnium humilitátem meam. ℣. Qui timétis
          Dóminum, laudáte eum: univérsum semen Jacob, magnificáte eum. ℣.
        ...
        <p>
          ...
          clamor dos meus pecados afastou de mim a salvação. ℣. Meu rei durante
          o dia e não me ouvi Deus, clama reis; clamarei durante a noite e não
          acharei consolação. ℣. Contudo, sois a glória de Israel e habitais no
          santuário. ℣. Os nossos pais esperaram em Vós: esperaram e fostes o
          seu libertador! ℣. Clamaram por Vós, e foram salvos; confiaram em Vós
          e não foram iludidos. ℣. Porém sou um verme e não um homem; sou o
          opróbrio dos homens, a irrisão do povo! ℣. Todos quantos me vêem,
          enchem-me de injúrias, murmuram de mim, abanando a cabeça e dizendo:
          ℣. «Esperou no Senhor; pois que venha salvá-l’O, já que O ama». ℣.
          Olharam para mim e desprezaram-me; repartiram entre si os meus
          vestidos e lançaram sortes sobre a minha túnica. ℣. Livrai-me, Senhor,
          da boca do leão e das pontas dos unicórnios, pois sou fraco. ℣. Louvai
          o Senhor, ó Vós, que O temeis! Cantai louvores em sua honra, ó filhos
          de Jacob. ℣. À geração futura será anunciado o Senhor; os céus
          proclamarão a sua justiça. ℣. Ao povo, que há-de nascer, ensinarão que
      ...
      <div className="side-by-side">
        <p>
          <span className="cross text-red-500">✠</span> Passio Dómini nostri
          Jesu Christi secúndum Matthǽum.
        </p>
        <p>
          <span className="cross text-red-500">✠</span> Paixão de Nosso Senhor
          Jesus Cristo, segundo S. Mateus.
        </p>
        <p>
          In illo témpore: Dixit Jesus discípulis suis:{" "}
          <span className="cross text-red-500">✠</span> Scitis, quid post bíduum
          Pascha fiet, et Fílius hóminis tradétur, ut crucifigátur.{" "}
          <span className="font-bold text-red-500">C.</span> Tunc congregáti
          ...
          <span className="font-bold text-red-500">S.</span> Non in die festo,
          ne forte tumúltus fíeret in pópulo.{" "}
          <span className="font-bold text-red-500">C.</span> Cum autem Jesus
          ...
          <em>S.</em> Ut quid perdítio hæc? pótuit enim istud venúmdari multo,
          et dari paupéribus. <span className="font-bold text-red-500">C.</span>{" "}
          Sciens autem Jesus, ait illis:{" "}
          <span className="cross text-red-500">✠</span> Quid molésti estis huic
          ...
          <span className="font-bold text-red-500">C.</span> Tunc ábiit unus de
          duódecim, qui dicebátur Judas Iscariótes, ad príncipes sacerdótum, et
          ait illis: <span className="font-bold text-red-500">S.</span> Quid
          vultis mihi dare, et ego vobis eum tradam?{" "}
          <span className="font-bold text-red-500">C.</span> At illi
        ...
        <p>
          ...
          <span className="cross text-red-500">✠</span> «Sabeis que, passados
          dois dias, se celebrará a Páscoa e que o Filho do homem será entregue,
          para O crucificarem».{" "}
          <span className="font-bold text-red-500">C.</span> Então, reuniram-se
          os príncipes dos sacerdotes e os anciãos na sala do sumo Pontífice,
          que era chamado Caifás, e deliberaram prender Jesus, insidiosamente, e
          matarem-n’O. Mas diziam:{" "}
          <span className="font-bold text-red-500">S.</span> «Que isso, porém,
          não seja no dia da festa, para que o povo não faça tumulto».{" "}
          <span className="font-bold text-red-500">C.</span> Então, estando
          ...
          <span className="font-bold text-red-500">S.</span> «Para que serve tal
          desperdício? Pois poderia ter-se vendido por elevada quantia este
          perfume e dar aos pobres o seu preço».{" "}
          <span className="font-bold text-red-500">C.</span> Conhecendo Jesus
          isto, disse-lhes: <span className="cross text-red-500">✠</span> «Para
          que causais pena a esta mulher? Foi uma boa obra para comigo, que ela
          praticou; pois pobres sempre os tereis convosco; porém a mim nem
          sempre me tereis. Espalhando este perfume sobre o meu corpo, ungiu-me
          para Eu ser sepultado. Em verdade vos digo: onde quer que seja pregado
          este Evangelho (no mundo inteiro) contar-se-á também em sua memória a
          acção que praticou».{" "}
          <span className="font-bold text-red-500">C.</span> Então um dos Doze,
          chamado Judas Iscariotes, foi ter com o príncipe dos sacerdotes e
          disse-lhe: <span className="font-bold text-red-500">S.</span> «Quanto
          quereis dar-me para que eu vo-l’O entregue?».{" "}
          <span className="font-bold text-red-500">C.</span> E combinaram
        ...
        <p>
          ...
          <span className="font-bold text-red-500">C.</span> At Jesus dixit:{" "}
          <span className="cross text-red-500">✠</span> Ite in civitátem ad
          quendam, et dícite ei: Magíster dicit: Tempus meum prope est, apud te
          fácio pascha cum discípulis meis.{" "}
          <span className="font-bold text-red-500">C.</span> Et fecérunt
          ...
          illis, dixit: <span className="cross text-red-500">✠</span> Amen, dico
          vobis, quia unus vestrum me traditúrus est.{" "}
          <span className="font-bold text-red-500">C.</span> Et contristáti
          valde, cœpérunt sínguli dícere:{" "}
          <span className="font-bold text-red-500">S.</span> Numquid ego sum,
          Dómine? <span className="font-bold text-red-500">C.</span> At ipse
          respóndens, ait: <span className="cross text-red-500">✠</span> Qui
          ...
          ille. <span className="font-bold text-red-500">C.</span> Respóndens
          autem Judas, qui trádidit eum, dixit:{" "}
          <span className="font-bold text-red-500">S.</span> Numquid ego sum,
          Rabbi? <span className="font-bold text-red-500">C.</span> Ait illi:{" "}
          <span className="cross text-red-500">✠</span> Tu dixísti.{" "}
          <span className="font-bold text-red-500">C.</span> Cenántibus autem
          eis, accépit Jesus panem, et benedíxit, ac fregit, dedítque discípulis
          suis, et ait: <span className="cross text-red-500">✠</span> Accípite
          et comédite: hoc est corpus meum.{" "}
          <span className="font-bold text-red-500">C.</span> Et accípiens
          cálicem, grátias egit: et dedit illis, dicens:{" "}
          <span className="cross text-red-500">✠</span> Bíbite ex hoc omnes. Hic
          est enim sanguis meus novi Testaménti, qui pro multis effundétur in
          ...
          regno Patris mei. <span className="font-bold text-red-500">C.</span>{" "}
          Et hymno dicto, exiérunt in montem Olivéti. Tunc dicit illis Jesus:{" "}
          <span className="cross text-red-500">✠</span> Omnes vos scándalum
          ...
          in Galilǽam. <span className="font-bold text-red-500">C.</span>{" "}
          Respóndens autem Petrus, ait illi:{" "}
          <span className="font-bold text-red-500">S.</span> Et si omnes
          scandalizáti fúerint in te, ego numquam scandalizábor.{" "}
          <span className="font-bold text-red-500">C.</span> Ait illi Jesus:{" "}
          <span className="cross text-red-500">✠</span> Amen, dico tibi, quia in
          hac nocte, antequam gallus cantet, ter me negábis.{" "}
          <span className="font-bold text-red-500">C.</span> Ait illi Petrus:{" "}
          <span className="font-bold text-red-500">S.</span> Etiam si oportúerit
          me mori tecum, non te negábo.{" "}
          <span className="font-bold text-red-500">C.</span> Simíliter et omnes
          discípuli dixérunt.
        </p>
        <p>
          No primeiro dia dos ázimos, vieram os discípulos ter com Jesus,
          dizendo-Lhe: <span className="font-bold text-red-500">S.</span> «Onde
          quereis que preparemos o que é necessário para comer a Páscoa?»{" "}
          <span className="font-bold text-red-500">C.</span> Jesus disse-lhes:{" "}
          <span className="cross text-red-500">✠</span> «Ide à cidade, a casa
          dum tal, e dizei-lhe: «O Mestre diz: «Meu tempo está próximo; quero
          celebrar a Páscoa com meus discípulos em tua casa».{" "}
          <span className="font-bold text-red-500">C.</span> Os discípulos
          ...
          <span className="cross text-red-500">✠</span> «Em verdade vos digo que
          um de vós me trairá».{" "}
          <span className="font-bold text-red-500">C.</span> Então, cheios de
          profunda tristeza, começaram, individualmente, a dizer:{" "}
          <span className="font-bold text-red-500">S.</span> «Serei eu, Senhor?»{" "}
          <span className="font-bold text-red-500">C.</span> Ele disse:{" "}
          <span className="cross text-red-500">✠</span> «O que me há-de trair é
          aquele que mete comigo a mão no prato! Com efeito, o Filho do homem
          vai ser traído, segundo o que está escrito a seu respeito, mas infeliz
          daquele que O tiver traído! Melhor lhe fora não haver nascido!».{" "}
          <span className="font-bold text-red-500">C.</span> Ora Judas, o
          discípulo que O traiu, disse:{" "}
          <span className="font-bold text-red-500">S.</span> «Serei eu,
          porventura, Senhor?»{" "}
          <span className="font-bold text-red-500">C.</span> Jesus disse-lhe:{" "}
          <span className="cross text-red-500">✠</span> «Tu o disseste!».{" "}
          <span className="font-bold text-red-500">C.</span> Enquanto ceavam,
          tomou Jesus o pão, benzeu-o, partiu-o e deu-o aos discípulos, dizendo:{" "}
          <span className="cross text-red-500">✠</span> «Tomai e comei: Isto é o
          meu corpo». <span className="font-bold text-red-500">C.</span> E,
          pegando no cálice, deu graças e entregou-lho, dizendo-lhes:{" "}
          <span className="cross text-red-500">✠</span> «Bebei dele vós todos.
          ...
          <span className="font-bold text-red-500">C.</span> Havendo dito o hino
          de graças, saíram para o monte das Oliveiras, Então, disse-lhes Jesus:{" "}
          <span className="cross text-red-500">✠</span> «Esta noite serei para
          vós todos motivo de escândalo; porque está escrito: «Ferirei o pastor
          e as ovelhas do rebanho serão dispersas». Mas, depois de ressuscitar,
          irei adiante de vós para a Galileia»{" "}
          <span className="font-bold text-red-500">C.</span> Porém, respondendo
          Pedro, disse-Lhe: <span className="font-bold text-red-500">S.</span>{" "}
          «Ainda que todos se escandalizem, eu nunca me escandalizarei».{" "}
          <span className="font-bold text-red-500">C.</span> E Jesus
          retorquiu-lhe: <span className="cross text-red-500">✠</span> «Em
          verdade te digo: esta noite, antes de o galo cantar, negar-me-ás três
          vezes». <span className="font-bold text-red-500">C.</span> edro
          disse-Lhe: <span className="font-bold text-red-500">S.</span> «Ainda
          que tenha de morrer convosco, não Vos negarei!».{" "}
          <span className="font-bold text-red-500">C.</span> O mesmo afirmaram
          todos os discípulos.
        </p>
        <p>
          Tunc venit Jesus cum illis in villam, quæ dícitur Gethsémani, et dixit
          discípulis suis: <span className="cross text-red-500">✠</span> Sedéte
          hic, donec vadam illuc et orem.{" "}
          <span className="font-bold text-red-500">C.</span> Et assúmpto Petro
          et duóbus fíliis Zebedǽi, cœpit contristári et mæstus esse. Tunc ait
          illis: <span className="cross text-red-500">✠</span> Tristis est ánima
          mea usque ad mortem: sustinéte hic, et vigilate mecum.{" "}
          <span className="font-bold text-red-500">C.</span> Et progréssus
          pusíllum, prócidit in fáciem suam, orans et dicens:{" "}
          <span className="cross text-red-500">✠</span> Pater mi, si possíbile
          est, tránseat a me calix iste: Verúmtamen non sicut ego volo, sed
          sicut tu. <span className="font-bold text-red-500">C.</span> Et venit
          ad discípulos suos, et invénit eos dormiéntes: et dicit Petro:{" "}
          <span className="cross text-red-500">✠</span> Sic non potuístis una
          hora vigiláre mecum? Vigiláte et oráte, ut non intrétis in
          tentatiónem. Spíritus quidem promptus est, caro autem infírma.{" "}
          <span className="font-bold text-red-500">C.</span> Iterum secúndo
          ábiit et orávit, dicens: <span className="cross text-red-500">✠</span>{" "}
          Pater mi, si non potest hic calix transíre, nisi bibam illum, fiat
          volúntas tua. <span className="font-bold text-red-500">C.</span> Et
        ...
        <p>
          ...
          discípulos: <span className="cross text-red-500">✠</span>{" "}
          ...
          <span className="font-bold text-red-500">C.</span> Depois, avançou um
          pouco e prostrou-se com o rosto no chão, orando e dizendo:{" "}
          <span className="cross text-red-500">✠</span> «Meu Pai, se é possível,
          fazei que este cálice se afaste de mim; contudo faça-se a vossa
          vontade e não a minha».{" "}
          <span className="font-bold text-red-500">C.</span> Em seguida, veio
          ter com os discípulos, encontrando-os a dormir. Disse, então, a Pedro:{" "}
          <span className="cross text-red-500">✠</span> «Pois não pudestes
          vigiar uma hora comigo?! Vigiai e orai para não entrardes em tentação.
          Na verdade, o espírito está pronto, porém a carne é fraca».{" "}
          <span className="font-bold text-red-500">C.</span> De novo se retirou
          Jesus e, pela segunda vez orou, dizendo:{" "}
          <span className="cross text-red-500">✠</span> «Meu Pai, se este cálice
          não pode passar sem que Eu o beba, faça-se a vossa vontade».{" "}
          <span className="font-bold text-red-500">C.</span> Depois veio outra
          ...
          disse-lhes: <span className="cross text-red-500">✠</span> «Dormi agora
          e repousai: eis que se aproxima a hora em que o Filho do homem será
        ...
        <p>
          ...
          <span className="font-bold text-red-500">C.</span> Et conféstim
          ...
          eum. Dixítque illi Jesus:{" "}
          <span className="cross text-red-500">✠</span> Amíce, ad quid venísti?
        </p>
        <p>
          ...
          turba: <span className="font-bold text-red-500">S.</span> «Aquele que
          eu beijar, é Esse; prendei-O».{" "}
          <span className="font-bold text-red-500">C.</span> Logo que Judas
          chegou, aproximou-se do Mestre e disse-Lhe:{" "}
          <span className="font-bold text-red-500">S.</span> «Salve, ó Mestre».{" "}
          <span className="font-bold text-red-500">C.</span> E osculou-O. Jesus
          disse-lhe: <span className="cross text-red-500">✠</span> «Amigo, a que
          vieste?».
        </p>
        <p>
          <span className="font-bold text-red-500">C.</span> Tunc accessérunt,
          ...
          ait illi Jesus: <span className="cross text-red-500">✠</span> Convérte
          gládium tuum in locum suum. Omnes enim, qui accéperint gládium, gládio
          ...
          <span className="font-bold text-red-500">C.</span> In illa hora dixit
          Jesus turbis: <span className="cross text-red-500">✠</span> Tamquam ad
          latrónem exístis cum gládiis et fústibus comprehéndere me: cotídie
          apud vos sedébam docens in templo, et non me tenuístis.{" "}
          <span className="font-bold text-red-500">C.</span> Hoc autem totum
          factum est, ut adimpleréntur Scripturae Prophetárum. Tunc discípuli
          omnes, relícto eo, fugérunt.
        </p>
        <p>
          <span className="font-bold text-red-500">C.</span> Chegaram-se, então,
          ...
          Entretanto Jesus disse-lhe:{" "}
          <span className="cross text-red-500">✠</span> «Mete a espada no seu
          ...
          <span className="font-bold text-red-500">C.</span> Ao mesmo tempo,
          Jesus disse às turbas: <span className="cross text-red-500">✠</span>{" "}
          «Viestes com espadas e paus para me prender, como se Eu fora um
          ladrão?! Todos os dias estava assentado convosco, ensinando no templo,
          e não me prendestes?!{" "}
          <span className="font-bold text-red-500">C.</span> Tudo isto aconteceu
          assim, para que se cumprissem as Escrituras dos Profetas. E, naquela
        ...
        <p>
          ...
          <span className="font-bold text-red-500">S.</span> Hic dixit: Possum
          destrúere templum Dei, et post tríduum reædificáre illud.{" "}
          <span className="font-bold text-red-500">C.</span> Et surgens princeps
          sacerdótum, ait illi:{" "}
          <span className="font-bold text-red-500">S.</span> Nihil respóndes ad
          ...
          <span className="font-bold text-red-500">S.</span> Adjúro te per Deum
          vivum, ut dicas nobis, si tu es Christus, Fílius Dei.{" "}
          <span className="font-bold text-red-500">C.</span> Dicit illi Jesus:{" "}
          <span className="cross text-red-500">✠</span> Tu dixísti. Verúmtamen
          dico vobis, ámodo vidébitis Fílium hóminis sedéntem a dextris virtútis
          Dei, et veniéntem in núbibus cœli.{" "}
          <span className="font-bold text-red-500">C.</span> Tunc princeps
          sacerdótum scidit vestiménta sua, dicens:{" "}
          <span className="font-bold text-red-500">S.</span> Blasphemávit: quid
          adhuc egémus téstibus? Ecce, nunc audístis blasphémiam: quid vobis
          vidétur? <span className="font-bold text-red-500">C.</span> At illi
          respondéntes dixérunt:{" "}
          <span className="font-bold text-red-500">S.</span> Reus est mortis.{" "}
          <span className="font-bold text-red-500">C.</span> Tunc exspuérunt in
          fáciem ejus, et cólaphis eum cecidérunt, álii autem palmas in fáciem
          ejus dedérunt, dicéntes:{" "}
          <span className="font-bold text-red-500">S.</span> Prophetíza nobis,
        ...
        <p>
          ...
          <span className="font-bold text-red-500">S.</span> «Ele disse: «Posso
          destruir o templo de Deus e reedificá-lo em três dias».{" "}
          <span className="font-bold text-red-500">C.</span> Logo se levantou o
          príncipe dos sacerdotes e disse:{" "}
          <span className="font-bold text-red-500">S.</span> «Nada respondeis ao
          ...
          <span className="font-bold text-red-500">S.</span> «Conjuro-Vos, por
          Deus vivo, que nos digais se sois Cristo, Filho de Deus!».{" "}
          <span className="font-bold text-red-500">C.</span> Jesus respondeu:{" "}
          <span className="cross text-red-500">✠</span> «Tu o disseste; contudo
          digo-vos que haveis de ver daqui a pouco o Filho do homem assentar-se
          à direita do poder de Deus, caminhando sobre as nuvens do céu».{" "}
          <span className="font-bold text-red-500">C.</span> Então o príncipe
          dos sacerdotes rasgou os seus vestidos, dizendo:{" "}
          <span className="font-bold text-red-500">S.</span> «Blasfemou! Para
          que são precisas ainda testemunhas? Eis que acabais de ouvir uma
          blasfémia! Que vos parece?»{" "}
          <span className="font-bold text-red-500">C.</span> Eles responderam:{" "}
          <span className="font-bold text-red-500">S.</span> «É réu de morte».{" "}
          <span className="font-bold text-red-500">C.</span> Então, cuspiram-Lhe
          no rosto e deram-Lhe bofetadas, dizendo:{" "}
          <span className="font-bold text-red-500">S.</span> «Adivinhai, ó
          Cristo, quem Vos bateu?».
        </p>
        <p>
          <span className="font-bold text-red-500">C.</span> Petrus vero sedébat
          foris in átrio: et accéssit ad eum una ancílla, dicens:{" "}
          <span className="font-bold text-red-500">S.</span> Et tu cum Jesu
          Galilǽo eras. <span className="font-bold text-red-500">C.</span> At
          ille negávit coram ómnibus, dicens:{" "}
          <span className="font-bold text-red-500">S.</span> Néscio, quid dicis.{" "}
          <span className="font-bold text-red-500">C.</span> Exeúnte autem illo
          jánuam, vidit eum ália ancílla, et ait his, qui erant ibi:{" "}
          <span className="font-bold text-red-500">S.</span> Et hic erat cum
          Jesu Nazaréno. <span className="font-bold text-red-500">C.</span> Et
          íterum negávit cum juraménto: Quia non novi hóminem. Et post pusíllum
          accessérunt, qui stabant, et dixérunt Petro:{" "}
          <span className="font-bold text-red-500">S.</span> Vere et tu ex illis
          es: nam et loquéla tua maniféstum te facit.{" "}
          <span className="font-bold text-red-500">C.</span> Tunc cœpit
        ...
        <p>
          <span className="font-bold text-red-500">C.</span> Durante este tempo,
          ...
          com Jesus, o Galileu».{" "}
          <span className="font-bold text-red-500">C.</span> Pedro negou logo,
          diante de todos, dizendo:{" "}
          <span className="font-bold text-red-500">S.</span> «Não sei o que
          dizes». <span className="font-bold text-red-500">C.</span> Saindo,
          então, ele a porta, viu-o outra criada, que logo disse para os que
          estavam ali: <span className="font-bold text-red-500">S.</span> «Este
          ...
          <span className="font-bold text-red-500">S.</span> «Verdadeiramente tu
          também és deles, pois, o teu modo de falar, manifestamente, o dá a
          conhecer». <span className="font-bold text-red-500">C.</span> Então,
        ...
        <p>
          ...
          dicens: <span className="font-bold text-red-500">S.</span> Peccávi,
          tradens sánguinem justum.{" "}
          <span className="font-bold text-red-500">C.</span> At illi dixérunt:{" "}
          <span className="font-bold text-red-500">S.</span> Quid ad nos? Tu
          vidéris. <span className="font-bold text-red-500">C.</span> Et
          ...
          <span className="font-bold text-red-500">S.</span> Non licet eos
          míttere in córbonam: quia prétium sánguinis est.{" "}
          <span className="font-bold text-red-500">C.</span> Consílio autem
        ...
        <p>
          ...
          dizendo: <span className="font-bold text-red-500">S.</span> «Pequei,
          entregando-vos o sangue inocente!».{" "}
          <span className="font-bold text-red-500">C.</span> Mas eles disseram:{" "}
          <span className="font-bold text-red-500">S.</span> «Que nos importa
          isso? Tu poderias pensar no que fazias!».{" "}
          <span className="font-bold text-red-500">C.</span> Ele, então, arrojou
          as moedas para o templo, afastou-se e foi enforcar-se! Os príncipes
          dos sacerdotes recolheram o dinheiro e disseram:{" "}
          <span className="font-bold text-red-500">S.</span> «Não é lícito
          deitá-lo no cofre sagrado, pois é o preço do sangue».{" "}
          <span className="font-bold text-red-500">C.</span> E, havendo reunido
        ...
        <p>
          ...
          <span className="font-bold text-red-500">C.</span> Dicit illi Jesus:{" "}
          <span className="cross text-red-500">✠</span> Tu dicis.{" "}
          <span className="font-bold text-red-500">C.</span> Et cum accusarétur
          a princípibus sacerdótum et senióribus, nihil respóndit. Tunc dicit
          illi Pilátus: <span className="font-bold text-red-500">S.</span> Non
          audis, quanta advérsum te dicunt testimónia?{" "}
          <span className="font-bold text-red-500">C.</span> Et non respóndit ei
          ...
          <span className="font-bold text-red-500">S.</span> Quem vultis
          ...
          <span className="font-bold text-red-500">S.</span> Nihil tibi et justo
          illi: multa enim passa sum hódie per visum propter eum.{" "}
          <span className="font-bold text-red-500">C.</span> Príncipes autem
          sacerdótum et senióres persuasérunt populis, ut péterent Barábbam,
          Jesum vero pérderent. Respóndens autem præses, ait illis:{" "}
          <span className="font-bold text-red-500">S.</span> Quem vultis vobis
          de duóbus dimítti? <span className="font-bold text-red-500">C.</span>{" "}
          At illi dixérunt: <span className="font-bold text-red-500">S.</span>{" "}
          Barábbam. <span className="font-bold text-red-500">C.</span> Dicit
          illis Pilátus: <span className="font-bold text-red-500">S.</span> Quid
          ígitur fáciam de Jesu, qui dícitur Christus?{" "}
          <span className="font-bold text-red-500">C.</span> Dicunt omnes:{" "}
          <span className="font-bold text-red-500">S.</span> Crucifigátur.{" "}
          <span className="font-bold text-red-500">C.</span> Ait illis præses:{" "}
          <span className="font-bold text-red-500">S.</span> Quid enim mali
          íecit? <span className="font-bold text-red-500">C.</span> At illi
          magis clamábant, dicéntes:{" "}
          <span className="font-bold text-red-500">S.</span> Crucifigátur.{" "}
          <span className="font-bold text-red-500">C.</span> Videns autem
          Pilátus, quia nihil profíceret, sed magis tumúltus fíeret: accépta
          aqua, lavit manus coram pópulo, dicens:{" "}
          <span className="font-bold text-red-500">S.</span> Innocens ego sum a
          sánguine justi hujus: vos vidéritis.{" "}
          <span className="font-bold text-red-500">C.</span> Et respóndens
          univérsus pópulus, dixit:{" "}
          <span className="font-bold text-red-500">S.</span> Sanguis ejus super
          nos et super fílios nostros.{" "}
          <span className="font-bold text-red-500">C.</span> Tunc dimísit illis
          ...
          <span className="font-bold text-red-500">S.</span> Ave, Rex Judæórum.{" "}
          <span className="font-bold text-red-500">C.</span> Et exspuéntes in
        ...
        <p>
          ...
          <span className="font-bold text-red-500">S.</span> «Sois o Rei dos
          Judeus?». <span className="font-bold text-red-500">C.</span>{" "}
          Respondeu-lhe Jesus: «Tu o dizes».{" "}
          <span className="font-bold text-red-500">C.</span> E, sendo acusado
          pelos príncipes dos sacerdotes e pelos anciãos, nada respondeu.
          Disse-Lhe, então, Pilatos:{" "}
          <span className="font-bold text-red-500">S.</span> «Não ouvis as
          coisas de que Vos acusam?».{" "}
          <span className="font-bold text-red-500">C.</span> Mas Ele não
          ...
          <span className="font-bold text-red-500">S.</span> «Qual quereis que
          solte? Barrabás ou Jesus, por apelido Cristo?».{" "}
          <span className="font-bold text-red-500">C.</span> Pois sabia que por
          inveja é que lh’O haviam entregado. Quando Pilatos estava assentado no
          seu tribunal, mandou-lhe dizer sua mulher:{" "}
          <span className="font-bold text-red-500">S.</span> «Não te ocupes
          desse justo, pois tive, hoje, sonhos, nos quais padeci muito por sua
          causa». <span className="font-bold text-red-500">C.</span>, Mas os
          ...
          <span className="font-bold text-red-500">S.</span> «Qual dos dois
          quereis que solte?».{" "}
          <span className="font-bold text-red-500">C.</span> Responderam:{" "}
          <span className="font-bold text-red-500">S.</span> «Barrabás».{" "}
          <span className="font-bold text-red-500">C.</span> Pilatos observou:{" "}
          <span className="font-bold text-red-500">S.</span>, «Que hei-de fazer,
          então, de Jesus, que se chama Cristo?»{" "}
          <span className="font-bold text-red-500">C.</span> Responderam todos:{" "}
          <span className="font-bold text-red-500">S.</span>, «Seja
          crucificado!». <span className="font-bold text-red-500">C.</span> O
          Governador disse-lhes:{" "}
          <span className="font-bold text-red-500">S.</span> «Pois que mal fez
          Ele?». <span className="font-bold text-red-500">C.</span> Porém, cada
          vez mais alto, bradavam:{" "}
          <span className="font-bold text-red-500">S.</span> «Seja
          crucificado!». <span className="font-bold text-red-500">C.</span>{" "}
          Vendo Pilatos que nada conseguia, mas que o tumulto crescia, mandou
          vir água e lavou as mãos diante do povo, dizendo:{" "}
          <span className="font-bold text-red-500">S.</span> «Estou inocente do
          sangue deste justo; isso é lá convosco».{" "}
          <span className="font-bold text-red-500">C.</span> Todo o povo
          respondeu: <span className="font-bold text-red-500">S.</span> «Que o
          sangue caia sobre nós e nossos filhos!».{" "}
          <span className="font-bold text-red-500">C.</span> Então Pilatos
          ...
          judeus!». <span className="font-bold text-red-500">C.</span> E,
        ...
        <p>
          ...
          <span className="font-bold text-red-500">C.</span> Idípsum autem et
          ...
          <span className="cross text-red-500">✠</span> Eli, Eli, lamma
          sabactháni? <span className="font-bold text-red-500">C.</span> Hoc
          est: <span className="cross text-red-500">✠</span> Deus meus, Deus
          meus, ut quid dereliquísti me?{" "}
          <span className="font-bold text-red-500">C.</span> Quidam autem illic
          stantes et audiéntes dicébant:{" "}
          <span className="font-bold text-red-500">S.</span> Elíam vocat iste.{" "}
          <span className="font-bold text-red-500">C.</span> Et contínuo currens
          unus ex eis, accéptam spóngiam implévit acéto et impósuit arúndini, et
          dabat ei bíbere. Céteri vero dicébant:{" "}
          <span className="font-bold text-red-500">S.</span> Sine, videámus, an
          véniat Elías líberans eum.{" "}
          <span className="font-bold text-red-500">C.</span> Jesus autem íterum
        ...
        <p>
          ...
          <span className="font-bold text-red-500">S.</span> «Ah! dissestes que
          ...
          <span className="font-bold text-red-500">C.</span> Ao mesmo tempo os
          sacerdotes com os escribas e anciãos, escarneciam d’Ele, dizendo:{" "}
          <span className="font-bold text-red-500">S.</span> «Salvou os outros e
          ...
          <span className="font-bold text-red-500">C.</span> Os ladrões, que
          ...
          <span className="cross text-red-500">✠</span> «Elí, Elí, lamma
          sabatáni?». <span className="font-bold text-red-500">C.</span> Isto é:{" "}
          <span className="cross text-red-500">✠</span> «Meu Deus, meu Deus,
          porque me abandonastes?».{" "}
          <span className="font-bold text-red-500">C.</span> Alguns, porém, dos
          que ali estavam, ouvindo isto, diziam:{" "}
          <span className="font-bold text-red-500">S. </span> «Chama por Elias».{" "}
          <span className="font-bold text-red-500">C.</span> Logo, correndo um
          deles, foi buscar uma esponja, ensopou-a em vinagre, pô-la sobre uma
          cana e apresentou-Lha para beber. Os outros diziam:{" "}
          <span className="font-bold text-red-500">S.</span> «Deixa; vejamos se
          Elias vem livrá-l’O».{" "}
          <span className="font-bold text-red-500">C.</span> Porém Jesus,
        ...
        <p>
          ...
          valde, dicéntes: <span className="font-bold text-red-500">S.</span>{" "}
          Vere Fílius Dei erat iste.{" "}
          <span className="font-bold text-red-500">C.</span> Erant autem ibi
        ...
        <p>
          ...
          <span className="font-bold text-red-500">S.</span> «Realmente, Este
          era o Filho de Deus!».{" "}
          <span className="font-bold text-red-500">C.</span> Achavam-se também,
