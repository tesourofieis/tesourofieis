        ...
        <View className="docs">
          ...
          <Language>
            <Text className="latin">
              ...
              Deus exaltávit illum: et dedit illi nomen, quod est super omne
              nomen.
            </Text>
            <Text className="vernacular">
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">Ps. 47, 2</Text> Magnus Dóminus, et
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="latin">Ps. 84, 2</Text> Benedixísti, Dómine,
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="versicle"> ℣. </Text>Venit ergo ad Simónem
            ...
            <Text className="vernacular">
              ...
              <Text className="versicle"> ℣. </Text>Porém, quando Jesus chegou
              junto de Simão-Pedro, este disse-Lhe:
            </Text>
            <Text className="latin">
              Dómine, tu mihi lavas pedes? Respóndit Jesus et dixit ei: Si non
              lávero tibi pedes, non habébis partem mecum.
              <Text className="versicle"> ℣. </Text>Quod ego fácio, tu nescis
              modo: scies autem póstea.
            </Text>
            <Text className="vernacular">
              Senhor, quereis lavar-me os pés? Jesus respondeu-lhe e disse: «Se
              te não lavar os pés, não terás parte comigo».
              <Text className="versicle"> ℣. </Text>«O que faço presentemente tu
              o ignoras; mas sabê-lo-ás depois».
            </Text>
            <Text className="latin">
              Dómine, tu mihi lavas pedes? Respóndit Jesus et dixit ei: Si non
              lávero tibi pedes, non habébis partem mecum.
          ...
          <Language>
            ...
            <Text className="vernacular">
              ...
              caridade é a maior destas três virtudes.
          ...
          <Language>
            <Text className="latin">
              ...
              <Text className="versicle"> ℣. </Text>Benedicámus Patrem, et
              Fílium, cum Sancto Spíritu.{" "}
              <Text className="latin">Ps. 83, 23</Text> Quam dilécta tabernácula
            ...
            <Text className="vernacular">
              ...
              misericórdia.<Text className="versicle"> ℣. </Text>Bendigamos o
              Pai, e o Filho, e o Espírito Santo.{" "}
              <Text className="vernacular">Sl. 83, 23</Text> Como são amáveis os
          ...
          <Language>
            <Text className="latin">
              ...
              Christi amor.<Text className="versicle"> ℣. </Text>Exsultémus et
              in ipso jucundémur.<Text className="versicle"> ℣. </Text>Timeámus
              et amémus Deum vivum.<Text className="versicle"> ℣. </Text>Et ex
              corde diligámus nos sincéro.
            </Text>
            <Text className="vernacular">
              Deus está onde estiverem a caridade e o amor.
              <Text className="versicle"> ℣. </Text>Foi o amor ele Cristo que
              nos reuniu.<Text className="versicle"> ℣. </Text>Alegremo-nos e
            ...
            <Text className="vernacular">
              ...
              <Text className="versicle"> ℣. </Text>Estamos reunidos em uma
              única assembleia.<Text className="versicle"> ℣. </Text>Evitemos
              tudo o que possa dividir os nossos corações.
            ...
            <Text className="latin">
              Ubi cáritas et amor, Deus ibi est.
              <Text className="versicle"> ℣. </Text>Simul quoque cum Beátis
              videámus<Text className="versicle"> ℣. </Text>Gloriánter vultum
              tuum, Christe Deus:<Text className="versicle"> ℣. </Text>Gáudium,
              quod est imménsum atque probum.
              <Text className="versicle"> ℣. </Text>Sǽcula per infiníta
              sæculórum. <Text className="response"> ℟. </Text> Amen.
            </Text>
            <Text className="vernacular">
              Deus está onde estiverem a caridade e o amor.
              <Text className="versicle"> ℣. </Text>Fazei-nos ver com os
              Bem-aventurados.<Text className="versicle"> ℣. </Text>Vosso rosto
              está na glória, Cristo nosso Deus:
          ...
          <Language>
            ...
            <Text className="latin">
              <Text className="versicle"> ℣. </Text>Tu mandásti mandáta tua,
              Dómine.
            </Text>
            <Text className="vernacular">
            ...
            <Text className="latin">
              <Text className="versicle"> ℣. </Text>Tu lavásti pedes
              discipulórum tuórum.
            </Text>
            <Text className="vernacular">
