...
<div className="side-by-side not-content">
      <p>Sancti tui, Dómine, benedícent te: glóriam regni tui dicent, allelúja, allelúja. <em>Ps. ibid., 1</em> Exaltábo te, Deus meus, Rex: et benedícam nómini tuo in sǽculum, et in sǽculum sǽculi. ℣. Gloria Patri...</p>
      <p>Que os vossos Santos Vos bendigam, Senhor: e publiquem a glória do vosso reino. Aleluia, aleluia. <em>Sl. ibid., 1</em> Exaltarei a vossa glória, ó Deus, o meu Rei: e abençoarei o vosso Nome agora, sempre e em todos os séculos! ℣. Glória ao Pai...</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Lætámini in Dómino et exsultáte, justi: et gloriámini, omnes recti corde, allelúja, allelúja.</p>
      <p>Alegrai-vos no Senhor, ó justos! Exultai de júbilo! Todos aqueles que possuem o coração recto serão glorificados. Aleluia, aleluia.</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Gaudéte, justi, in Dómino, allelúja: rectos decet collaudátio, allelúja.</p>
      <p>Alegrai-vos no Senhor, ó justos. Aleluia. É aos que são rectos que pertence cantar os vossos louvores. Aleluia.</p>
      </div>
