    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          allelúja. <em>Ps. ibid., 1</em> Exaltábo te, Deus meus, Rex: et
          benedícam nómini tuo in sǽculum, et in sǽculum sǽculi. ℣. Gloria
          Patri...
        </p>
        <p>
          Que os vossos Santos Vos bendigam, Senhor: e publiquem a glória do
          vosso reino. Aleluia, aleluia. <em>Sl. ibid., 1</em> Exaltarei a vossa
          glória, ó Deus, o meu Rei: e abençoarei o vosso Nome agora, sempre e
          em todos os séculos! ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. Sancti tui, Dómine, florébunt sicut lílium: et
          sicut odor bálsami erunt ante te. Allelúja. ℣. <em>Ps. 115, 15</em>{" "}
          Pretiósa in conspéctu Dómini mors Sanctórum ejus. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. Vossos santos, Senhor, florescerão, como o lírio,
          e serão, ante Vós, como o odor do bálsamo. Aleluia. ℣.{" "}
          <em>Sl. 115, 15</em> É preciosa diante do Senhor a morte dos seus
          Santos. Aleluia.
        </p>
      </div>
