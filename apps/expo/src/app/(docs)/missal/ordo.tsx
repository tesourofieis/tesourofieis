...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> Até Deus, que é a alegria da minha juventude.</p>
      </div>
...
et quare tristis incédo, dum afflígit me inimícus?</p>
      <p><span className="text-red-500">℟.</span> Pois que Vós, ó Deus, sois a minha fortaleza,
porque me repelistes? E porque ando triste enquanto o meu inimigo me aflige?</p>
      <p>℣. Emítte lucem tuam et veritátem tuam: ipsa me deduxérunt, et adduxérunt in montem sanctum tuum et in tabernácula tua.</p>
      <p>℣. Enviai a vossa luz e a vossa verdade; elas me guiarão e conduzirão até ao vosso santo monte, até aos vossos tabernáculos.</p>
      <p><span className="text-red-500">℟.</span> Et introíbo ad altáre Dei: ad Deum, qui lætíficat
juventútem meam.</p>
      <p><span className="text-red-500">℟.</span> E irei até ao Altar de Deus; até Deus, que é
a alegria da minha juventude.</p>
      <p>℣. Confitébor tibi in cíthara, Deus, Deus meus: quare tristis es, ánima mea, et quare contúrbas me?</p>
      <p>℣. Ó Deus, ó meu Deus, louvar-Vos-ei com a cítara. Porque estás triste, ó minha alma? Porque te perturbas?</p>
      <p><span className="text-red-500">℟.</span> Spera in Deo, quóniam adhuc confitébor illi:
salutáre vultus mei, et Deus meus.</p>
      <p><span className="text-red-500">℟.</span> Confia em Deus, pois ainda O louvarei. Ele é
a minha salvação e o meu Deus.</p>
      </div>
...
et in sǽcula sæculórum. Amen.</p>
      <p><span className="text-red-500">℟.</span> Assim como era no princípio, e agora, e sempre,
por todos os séculos dos séculos. Amen.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> Ad Deum, qui lætíficat juventútem meam.</p>
      <p><span className="text-red-500">℟.</span> Até Deus, que é a alegria da minha juventude.</p>
      <p>℣. Adjutórium nostrum <span className="cross text-red-500">✠</span> in nómine Dómini.</p>
      <p>℣. O nosso auxílio está <span className="cross text-red-500">✠</span> no nome do Senhor.</p>
      <p><span className="text-red-500">℟.</span> Qui fecit cœlum et terram.</p>
      <p><span className="text-red-500">℟.</span> Que criou o céu e a terra.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>℣. Confíteor Deo...</p>
      <p>℣. Eu me confesso a Deus...</p>
      <p><span className="text-red-500">℟.</span> Misereátur vestri omnípotens Deus, et, dimíssis
peccátis vestris, perdúcat vos ad vitam ætérnam.</p>
      <p><span className="text-red-500">℟.</span> Compadeça-se de vós o Senhor omnipotente; vos
perdoe os pecados e guie até à vida eterna.</p>
      <p>℣. Amen.</p>
      <p>℣. Amen.</p>
      </div>
...
et ópere:
<em>Percutit sibi pectus ter, dicens:</em></p>
      <p><span className="text-red-500">℟.</span> Eu me confesso a Deus, todo poderoso, à bem-aventurada
sempre Virgem Maria, ao bem-aventurado S. Miguel Arcanjo, ao bem-aventurado S. João
Baptista, aos Santos Apóstolos S. Pedro e S. Paulo, a todos os santos, e a vós, Padre:
que pequei muitas vezes por pensamentos, palavras e obras:
<em>Baterá no peito três vezes, dizendo:</em></p>
      ...
      <p>Portanto rogo à bem-aventurada sempre Virgem Maria, ao bem-aventurado S. Miguel Arcanjo, ao bem-aventurado S. João Baptista, aos Santos Apóstolos S. Pedro e S. Paulo, a todos os Santos e a vós, Padre, que rogueis a Deus, nosso Senhor, por mim.</p>
      ...
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p>℣. Deus, tu convérsus vivificábis nos.</p>
      <p>℣. Ó Deus, volvei-Vos para nós, e alcançaremos a vida.</p>
      <p><span className="text-red-500">℟.</span> Et plebs tua lætábitur in te.</p>
      <p><span className="text-red-500">℟.</span> E o vosso povo se alegrará convosco.</p>
      <p>℣. Osténde nobis, Dómine, misericórdiam tuam.</p>
      <p>℣. Senhor, mostrai-nos a vossa misericórdia.</p>
      <p><span className="text-red-500">℟.</span> Et salutáre tuum da nobis.</p>
      <p><span className="text-red-500">℟.</span> E concedei-nos a vossa salvação.</p>
      <p>℣. Dómine, exáudi oratiónem meam.</p>
      <p>℣. Senhor, atendei à minha oração.</p>
...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> Senhor, tende piedade de nós.</p>
      <p>℣. Kýrie eléison.</p>
      <p>℣. Senhor, tende piedade de nós.</p>
      <p><span className="text-red-500">℟.</span> Christe eléison.</p>
      <p><span className="text-red-500">℟.</span> Cristo, tende piedade de nós.</p>
      <p>℣. Christe eléison.</p>
...
<div className="side-by-side not-content">
      ...
      <p>E encarnou pelo Espírito Santo, no seio da Virgem Maria: <strong>E foi feito homem.</strong></p>
      <p>Crucifíxus étiam pro nobis: sub Póntio Piláto passus, et sepúltus est. Et resurréxit tértia die, secúndum Scriptúras. Et ascéndit in cœlum: sedet ad déxteram Patris. Et íterum ventúrus est cum glória judicáre vivos et mórtuos: cujus regni non erit finis. Et in Spíritum Sanctum, Dóminum et vivificántem: qui ex Patre Filióque procédit. Qui cum Patre et Fílio simul adorátur et conglorificátur: qui locútus est per Prophétas. Et unam sanctam cathólicam et apostolicam Ecclésiam. Confíteor unum baptísma in remissiónem peccatórum. Et exspécto resurrectiónem mortuórum. Et <span className="cross text-red-500">✠</span> vitam ventúri sǽculi.</p>
      <p>Também por nós foi crucificado sob Pôncio Pilatos, padeceu e foi sepultado. Ressuscitou ao terceiro dia, conforme as Escrituras, e subiu aos céus, onde está sentado à direita do Pai. De novo há-de vir em sua glória, para julgar os vivos e os mortos; e o seu reino não terá fim. Creio no Espírito Santo, Senhor que dá a vida, e procede do Pai e do Filho; e com o Pai e o Filho é adorado e glorificado: Ele que falou pelos Profetas. Creio na Igreja una, santa, católica e apostólica. Confesso um só baptismo para a remissão dos pecados. E espero a ressurreição dos mortos, e <span className="cross text-red-500">✠</span> a vida do mundo que há-de vir.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      </div>

      <h2>Missa dos Fiéis</h2>

      <h3>Sacrifício Ofertório</h3>
...
<div className="side-by-side not-content">
      ...
      <h3>Ofertório do dia</h3>

<Ordo client:visible section="ofertório" />

      <h4>Oferecimento do pão:</h4>
...
e a chama da eterna caridade. Amen.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Não deixeis, ó meu Deus, a minha alma perder-se com os ímpios, nem a minha vida com os homens sanguinários:</p>
      <p>In quorum mánibus iniquitátes sunt: déxtera eórum repléta est munéribus. Ego autem in innocéntia mea ingréssus sum: rédime me et miserére mei. Pes meus stetit in dirécto: in ecclésiis benedícam te, Dómine.</p>
      <p>Que têm as mãos manchadas de iniquidades e a mão direita cheia de dádivas. Pois que tenho vivido na inocência, salvai-me e tende misericórdia de mim. Meus pés continuam firmes no caminho direito: e hei-de bendizer-Vos, Senhor, em todas as assembleias.</p>
      <p>Glória Patri, et Fílio, et Spirítui Sancto. Sicut erat in princípio, et nunc, et semper: et in sǽcula sæculórum. Amen.</p>
      <p>Glória ao Pai, e ao Filho, e ao Espírito Santo. Assim como era no princípio, e agora, e sempre, por todos os séculos dos séculos. Amen.</p>
      </div>
...
<aside>
  Nas Missas de defuntos e do Tempo da Paixão omite-se o Glória Patri.
      ...
      <h4>Oração à Santíssima Trindade</h4>
...
ad laudem et glóriam nominis sui, ad utilitátem quoque nostram, totiúsque Ecclésiæ
suæ sanctæ.</p>
      <p><span className="text-red-500">℟.</span> Que o Senhor receba por vossas mãos este sacrifício
para a honra e glória de seu Nome, e também para a nossa utilidade e de toda sua
santa Igreja.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>℣. Demos graças ao Senhor, Nosso Deus.</p>
      <p><span className="text-red-500">℟.</span> Dignum et justum est.</p>
      <p><span className="text-red-500">℟.</span> Assim é digno e justo.</p>
      </div>

      <h3>Prefácio do dia</h3>
...
<div className="side-by-side not-content">
      ...
      <p>Bendito <span className="cross text-red-500">✠</span> o que vem em nome do Senhor. Hosana nas alturas.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <h4>Consagração e Elevação da Hóstia</h4>
...
<div className="side-by-side not-content">
  ...
  qui pro vobis et pro multis effundétur in remissiónem peccatórum.{" "}
      ...
      <p><strong>
  {" "}
  Pois isto é o Cálice do meu Sangue do novo e eterno testamento, mystério da fé,
  que será derramado por vós e por muitos, para a remissão dos pecados.{" "}
</strong></p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <h4>Oblação da Vítima a Deus</h4>
...
<div className="side-by-side not-content">
      ...
      <h3>Orações depois da Consagração</h3>
...
<div className="side-by-side not-content">
      ...
      <p>Vos suplicamos, Senhor, dignai-Vos conceder a estes, assim como a todos os que descansam em Cristo, um lugar de consolação, de luz e de paz. Pelo mesmo Cristo, nosso Senhor. Amen.</p>
      </div>

      <h4>Invocação dos Santos</h4>
...
<div className="side-by-side not-content">
      ...
      <p>Por quem, Senhor, sempre criais estes bens e os santificais <span className="cross text-red-500">✠</span>, vivificais <span className="cross text-red-500">✠</span>, abençoais <span className="cross text-red-500">✠</span> e no-los concedeis.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Instruídos com os salutares preceitos do Salvador e dirigidos pelos seus divinos ensinamentos, ousamos dizer:</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> Et cum spíritu tuo.</p>
      <p><span className="text-red-500">℟.</span> E com vosso espírito.</p>
      <p>Hæc commíxtio, et consecrátio Córporis et Sánguinis Dómini nostri Jesu Christi, fiat accipiéntibus nobis in vitam ætérnam. Amen.</p>
      <p>Que esta mistura e esta consagração do Corpo e do Sangue de nosso Senhor Jesus Cristo sejam penhor de vida eterna para nós que a receberemos. Amen.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Cordeiro de Deus, que tirais o pecado do mundo, dai-nos a paz.</p>
      </div>

      <h3>Orações para a Comunhão</h3>
...
<div className="side-by-side not-content">
      ...
      <p>Senhor Jesus Cristo, Filho de Deus vivo, que, por vontade do Pai, cooperando o Espírito Santo, pela vossa morte, destes a vida ao mundo: livrai-nos de todos os males por este vosso sacrossanto Corpo e Sangue. Permiti que cumpra sempre os vossos preceitos e nunca me afaste de Vós: que sendo Deus, viveis e reinais com o mesmo Deus Pai e Espírito Santo em todos os séculos dos séculos. Amen.</p>
      <p>Percéptio Córporis tui, Dómine Jesu Christe, quod ego indígnus súmere præsúmo, non mihi provéniat in judícium et condemnatiónem: sed pro tua pietáte prosit mihi ad tutaméntum mentis et córporis, et ad medélam percipiéndam: Qui vivis et regnas cum Deo Patre in unitáte Spíritus Sancti Deus, per ómnia sǽcula sæculórum. Amen.</p>
      <p>Senhor Jesus Cristo, que este vosso Corpo, que, eu, ainda que indigno, vou receber, não seja para meu juízo e condenação, mas que, pela vossa misericórdia, sirva à minha alma e ao meu corpo de defesa e de remédio salutar: Vós, que, sendo Deus, viveis e reinais com Deus Pai em unidade de Deus Espírito Santo em todos os séculos dos séculos. Amen.</p>
      </div>

      <h3>Comunhão do celebrante</h3>
...
sempre Virgem Maria, ao bem-aventurado S. Miguel Arcanjo, ao bem-aventurado S. João
Baptista, aos Santos Apóstolos S. Pedro e S. Paulo, a todos os santos, e a vós, Padre:
que pequei muitas vezes por pensamentos, palavras e obras:</p>
      </div>
...
morada, mas dizei uma só palavra e a minha alma será salva.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Senhor, que o vosso Corpo, que recebi, e o vosso sangue, que bebi, se unam intimamente ás minhas entranhas; dignai-Vos permitir, Senhor, que não fique em mim mancha alguma de pecado, agora que estou confortado com sacramentos tão puros e santos: Vós, que viveis e reinais em todos os séculos. Amen.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <h3>Postcomúnio do dia</h3>

<Ordo client:visible section="postcomúnio" />

      <h3>Despedida e Bênção</h3>
