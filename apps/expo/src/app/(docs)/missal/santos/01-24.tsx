...
export default function Page0124() {
  return (
    <div className="docs">
      <h1>S. Timóteo, B. e Márt., a 24 de Janeiro</h1>


<aside>
  Como na [Missa Státuit ei Dóminus](/missal/comum/2martirpontificeforapascal),
  excepto:
</aside>
