...
export default function Page0728() {
  return (
    <div className="docs">
      <h1>S. Nazário e Outros, Mártires, a 28 de Julho</h1>


<aside>
  A Igreja venera hoje Santos que viveram em épocas e países diferentes.
  Nazário, baptizado pelo Papa S. Lino, em Roma, baptizou por sua vez o jovem
  Celso, nascido em Cimiez, próximo de Nice. Foram, em seguida para Milão, onde
  os pagãos os prenderam e os fizeram degolar, cerca do ano 68. Em 395 seus
  corpos foram descobertos, encontrando-se no túmulo de S. Nazário uma
  garrafinha de sangue tão vermelho como se tivesse sido derramado naquele mesmo
...
<div className="side-by-side">
      ...
      <p>Deus concedeu aos justos a recompensa dos seus trabalhos, conduzindo-os por um caminho admirável. Foi para eles sombra durante o dia e luz das estrelas durante a noite. Fê-los atravessar o mar Vermelho e guiou-os através das águas caudalosas. E submergiu no mar os seus inimigos, arrojando à praia os cadáveres. Eis porque os justos arrebataram os despojos dos ímpios, cantaram hinos em honra do vosso santo nome, ó Senhor, e louvaram em harmonia a vossa mão vitoriosa, ó Senhor, nosso Deus.</p>
      </div>
