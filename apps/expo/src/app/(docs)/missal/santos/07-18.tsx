...
<aside>
  O Espírito Santo, que se manifestou de todos os modos na alma dos Santos cujos
  nomes apareceram no Ciclo desde a festa de Pentecostes, faz-nos admirar hoje a
  S. Camilo, cuja caridade teve especialmente por objecto a Jesus no próximo
  (Com.). Nascido em 1550, no reino de Nápoles, da nobre família dos Lélis, S.
  Camilo entrou para os Capuchinhos mas uma chaga na perna obrigou-o a sair por
  duas vezes. Deus o destinava a fundar uma Congregação de Clérigos regulares,
  consagrados ao serviço dos doentes. Obteve da Sé Apostólica a aprovação de sua
  Ordem. Inspirando-se no exemplo de Jesus, que morreu por nós (Ep.) e declarou
  não haver maior prova de amor do que dar a vida pelos outros (Intr., Ev.), os
  religiosos se obrigam a assistir os doentes, mesmo os pestíferos. S. Camilo,
  bem como o seu Instituto, recebeu de Deus a graça todo especial de ajudar
  vitoriosamente as almas na suprema luta da agonia (Or., Secre.), pelo que o
  nome do Santo foi inserido pela Igreja nas Ladainhas dos agonizantes. S.
  Camilo morreu em Roma a 14 de Julho de 1624.
</aside>
