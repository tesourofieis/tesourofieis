    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          tribulatiónibus eórum liberávit eos. <em>Ps. ibid., 2</em> Benedícam
        ...
        <p>
          ...
          todas as tribulações. <em>Sl. ibid., 2</em> Bendirei o Senhor em todo
          o tempo; o seu louvor estará sempre na minha boca. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Ecce, quam bonum et quam jucundum, habitáre fratres in unum! ℣. Sicut
          unguéntum in cápite, quod descéndit in barbam, barbam Aaron.
        </p>
        <p>
          Oh! como é bom e suave que os irmãos habitem juntos! ℣. É como o
          perfume suave espalhado na cabeça de Aarão, e que corre pela barba:
          pela barba de Aarão.
        </p>
      </div>
