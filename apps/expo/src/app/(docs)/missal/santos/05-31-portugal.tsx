    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 120, 1</em> Levávi óculos meos in montes: unde vénie ℣. Glória
          ao Pai...
        </p>
        <p>
          ...
          Aleluia, aleluia. (T. P. Aleluia, aleluia.) <em>Sl. 120, 1</em> Elevei
          os meus olhos para os montes donde me veio o auxílio. ℣. Glória ao
          Pai...
        </p>
      </div>
      <h3>Oração</h3>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          aurem vestram, et veníte ad me; audíte, et vivet ánima vestra. Ecce
        ...
        <p>
          ...
          não é pão e porque empregais o vosso trabalho naquilo que não sacia?
          Escutai-me, então, com atenção: comei aquilo que é bom, e a vossa alma
          se deleitará com alimentos substanciosos. Inclinai os vossos ouvidos,
          e vinde a mim. Escutai-me; e a vossa alma viverá. Eis que chamareis um
      ...
      <div className="side-by-side">
        <p>
          ...
          isti congregáti sunt, venérunt tibi. Allelúja. ℣. Fílii tui de longe
          vénient, et filiæ tuæ de látere surgent. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. Volvei os olhos em torno de vós e vede: todos
          estes se reuniram e vieram até vós, aleluia. ℣. Os teus filhos virão
