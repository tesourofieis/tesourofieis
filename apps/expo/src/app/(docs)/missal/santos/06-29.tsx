...
<aside>
  A Igreja inteira está em festa, pois «Deus consagrou este dia pelo martírio
  dos Apóstolos Pedro e Paulo» (Or.). Nas duas grandiosas basílicas construídas,
  em Roma, sobre os túmulos «destes dois Príncipes que, pela cruz e pela espada
  conquistaram um lugar no senado eterno», outrora celebrava-se um duplo
  sacrifício. Mais tarde, devido à grande distância entre as duas igrejas,
  dividiu-se a festa, honrando-se mais especialmente São Pedro a 29 de Junho e
  São Paulo a 30. S. Pedro, bispo de Roma, é o vigário, isto é, o representante
  visível de Cristo. Como indicam o Prefácio, a Aleluia, o Evangelho, o
  Ofertório e o Comúnio, os Judeus rejeitaram a Jesus, fazendo o mesmo com o seu
  sucessor (Ep.). Transferindo, então, o centro religioso do mundo, Pedro deixou
  Jerusalém pela cidade de Roma, que se tornou a cidade eterna e a sede de todos
  os Papas. S. Pedro, primeiro Papa, fala em nome de Cristo que lhe comunicou
  sua infabilidade doutrinal; não são, pois, a carne e o sangue seus guias, e
  sim o Pai celeste, que não permite prevalecerem as portas do inferno contra a
  Igreja, de que é fundamento (Ev.). S. Pedro, recebendo as chaves é preposto
  «ao reino dos céus» sobrea terra, isto é, à Igreja; nela reina em nome de
  Cristo, que o investiu de seu poder e autoridade suprema (Ev.). Os nomes de S.
  Pedro e S. Paulo abrem a lista dos Apóstolos no Canon da Missa. Em união com a
  Igreja, que não cessava de dirigir orações a Deus, por Pedro (Ep.), oremos
  pelo seu sucessor «o servo de Deus nosso Santo Padre o Papa» (Canon da Missa).
</aside>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. <em>Mt. 18,18</em> Tu és Pedro e sobre esta pedra edificarei a minha Igreja. Aleluia.</p>
      </div>
