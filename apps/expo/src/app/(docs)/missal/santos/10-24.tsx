    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          thesáuros auri recóndere: quóniam eleemósyna a morte liberat, et ipsa
          est, quæ purgat peccáta et facit invenire misericórdiam et vitam
          ætérnam. Qui autem faciunt peccátum et iniquitátem, hostes sunt ánimæ
          suæ. Manifésto ergo vobis veritátem, et non abscóndam a vobis occúltum
          sermónem. Quando orábas cum lácrimis, et sepeliébas mórtuos, et
          derelinquébas prándium tuum, et mórtuos abscondébas per diem in domo
          tua, et nocte sepeliébas eos, ego óbtuli oratiónem tuam Dómino. Et
          quia accéptus eras Deo, necésse fuit, ut tentátio probáret te. Et nunc
        ...
        <p>
          ...
          tesouros que se podem juntar; pois a esmola livra da morte, apaga os
          pecados e faz alcançar a misericórdia e a vida eterna. Aqueles, porém,
          que cometem o pecado e a iniquidade são inimigos de suas almas. Quero,
          pois, descobrir-vos a verdade e não vos ocultar uma só coisa secreta:
          Quando oráveis com lágrimas; sepultáveis os mortos; deixáveis o vosso
          descanso; guardáveis os mortos em vossa casa de dia e os sepultáveis
          de noite: então ofereci ao Senhor as vossas orações. E porque éreis
          agradável a Deus, foi necessário que a tentação vos experimentasse.
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 146, 5</em> Magnus Dóminus noster, et magna virtus ejus.
        </p>
        <p>
          Rafael, o Anjo do Senhor, dominou o demónio e amarrou-o. ℣.{" "}
          <em>Sl. 146, 5</em> Grande é o Senhor, nosso Deus; grande é o seu
          poder.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 137, 1-2</em> In conspéctu Angelórum
          psallam tibi: adorábo ad templum sanctum tuum, et confitébor nómini
          tuo, Dómine. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 137, 1-2</em> Cantarei Salmos na presença
          dos Anjos; adorar-Vos-ei no vosso santo templo e glorificarei o vosso
          santo nome, ó Senhor. Aleluia.
        </p>
      </div>
