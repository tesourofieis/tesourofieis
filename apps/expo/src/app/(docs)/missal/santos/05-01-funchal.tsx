  ...
  return (
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          Deus, qui nos ánnua beáti Jacóbi Apóstoli tui sollemnitáte lætíficas:
          præsta, quǽsumus; ut cujus gaudémus méritis, instruámur exémplis. Per
          Dóminum nostrum...
        </p>
        <p>
          Ó Deus, que nos alegrais com a solenidade anual dos Vosso B. Apóstolo
          Tiago, concedei-nos, Vos suplicamos, que, alegrando-nos com os seus
          méritos, sejamos instruídos com os seus exemplos. Por nosso Senhor...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          Vos amici mei estis, si fecéritis quæ præcípio vobis. Allelúja.
        </p>
        <p>
          ...
          dos santos. Aleluia. ℣. Sereis meus amigos, se fizerdes o que vos
          mando. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Múnera, Dómine, quæ pro Apóstoli tui Jacóbi sollemnitáte deférimus,
        ...
        <p>
          ...
          do vosso Apóstolo Tiago e afastai de nós todos os males que merecemos.
          Por nosso Senhor...
        </p>
      </div>
