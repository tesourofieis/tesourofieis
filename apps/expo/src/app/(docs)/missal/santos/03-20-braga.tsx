...
export default function Page0320Braga() {
  return (
    <div className="docs">
      <h1>S. Martinho de Dume, B. e Conf., a 20 de Março, Na Arquidiocese de Braga</h1>
...
Ó Deus, que ao vosso povo concedestes o B. Martinho como ministro da salvação eterna, permiti, Vos rogamos, que mereçamos sempre ter como intercessor nos céus aquele que na terra possuímos como Patrono e Mestre de vida. Por nosso Senhor...
...
Deus omnipotente e sempiterno, fazei que estes dons, que oferecemos à vossa majestade por intercessão do B. Martinho, vosso Confessor e Pontífice, nos sirvam de proveito para a salvação eterna. Por nosso Senhor...
...
Havendo recebido os sacramentos da nossa salvação, concedei-nos, ó misericordioso Deus, Vos suplicamos, que nos sirvam sempre de auxílio as preces do B. Martinho, em cuja veneração os oferecemos à vossa majestade. Por nosso...
