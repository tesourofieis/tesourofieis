...
export default function Page0626Portugal() {
  return (
    <div className="docs">
      ...
      <h3>Oração</h3>Ó Deus, que pela magnitude da vossa inefável piedade
      permitistes que o B. Pelágio, sendo de pouca idade, se mostrasse grande na
      fé e virtude, Concedei-nos, Vos suplicamos, que, assim como Veneramos a
      sua glória, assim também imitemos a sua inocência. Por nosso Senhor...
      <h3>Epístola</h3>
      <LinkCard
      ...
      fortalecestes-me para sempre na vossa presença. Aleluia, aleluia. Sou, fui
