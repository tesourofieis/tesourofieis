...
<div className="side-by-side">
      <p>Deus, qui beátum Matthíam Apostolórum tuórum collégio sociásti: tríbue, quǽsumus; ut, ejus interventióne, tuæ circa nos pietátis semper víscera sentiámus. Per Dóminum nostrum...</p>
      <p>Ó Deus, que agregastes o B. Matias ao colégio apostólico, concedei-nos, Vos imploramos, que por sua intercessão sintamos sempre os efeitos dos abysmos da vossa misericórdia para connosco. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side">
      <p>Nimis honoráti sunt amíci tui, Deus: nimis confortátus est principatus eórum. ℣. Dinumerábo eos, et super arénam multiplicabúntur.</p>
      <p>Honrais largamente os vossos amigos, ó Deus: e o seu poder tem-se fortalecido extraordinariamente. ℣. Hei-de contá-los, e ultrapassarão os grãos de areia.</p>
      </div>
...
<div className="side-by-side">
      <p>Desidérim ánimæ ejus tribuísti ei: et voluntáte labiórum ejus non fraudásti eum. ℣. Quóniam prævenísti eum in benedictiónibus dulcédinis. ℣. Posuísti in cápite ejus corónam de lápide pretióso.</p>
      <p>Concedestes-lhe o desejo da sua alma: lhe não negastes o que seus lábios Vos pediram. ℣. Premunistes-lo com bênção de doçura. ℣. Impusestes na sua cabeça uma coroa de pedras preciosas.</p>
      </div>
...
<div className="side-by-side">
      ...
      <p>Vós os instituístes príncipes em toda a terra. Ó Senhor, eles perpetuarão de geração em geração a glória do vosso nome.</p>
      </div>

      <h3>Secreta</h3>

<div className="side-by-side">
      <p>Hóstias tibi, Dómine, quas nómini tuo sacrándas offérimus, sancti Matthíæ Apóstoli tui prosequátur orátio: per quam nos expiári fácias et deféndi. Per Dóminum nostrum...</p>
      <p>Senhor, que as hóstias, que Vos oferecemos para serem consagradas em honra do vosso Santo Nome, sejam acompanhadas pela oração do vosso santo Apóstolo Matias, em virtude da qual sejamos purificados e livres do mal. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side">
      ...
      <p>Vós, que me seguistes, assentar-vos-eis em tronos e julgareis as doze tribos de Israel.</p>
      </div>

      <h3>Postcomúnio</h3>

<div className="side-by-side">
      <p>Præsta, quǽsumus, omnípotens Deus: ut per hæc sancta, quæ súmpsimus, interveniénte beáto Matthía Apóstolo tuo, véniam consequámur et pacem. Per Dóminum nostrum...</p>
      <p>Concedei-nos, Vos imploramos, ó Deus omnipotente, que os sacrossantos mystérios, de que participámos, nos alcancem por intercessão do B. Matias, vosso Apóstolo, o perdão e a paz. Por nosso Senhor...</p>
      </div>
