...
<aside>
  Apolinário veio da Antióquia para Roma com o príncipe dos Apóstolos que o
  sagrou bispo (Intr., Grad., Al.) e o enviou a Ravena, a pregar o Evangelho de
  Jesus Cristo. A Epístola é a de S. Pedro, descrevendo os deveres dos que devem
  dirigir a Igreja, não como dominadores, porém, como modelos do rebanho. O
  Evangelho diz também «o que é maior deve ser como o último, e o que governa,
  como o que serve». Preso pelos falsos padres dos ídolos, foi cruelmente
  espancado e lançado na prisão, depois enviado para o exílio nas margens do
  Danúbio, na Trácia. Voltando a Ravena, foi novamente perseguido sendo
  martirizado no ano de 79, fazendo valer os talentos que Deus lhe confiara
  (Com.). Nas nossas provações permaneçamos unidos a Jesus e Ele nos preparará
  como a esse Santo, um lugar no seu reino (Ev.).
</aside>
...
<div className="side-by-side not-content">
      ...
      <p>Aleluia, aleluia. ℣. <em>Ps. 109, 4</em> Jurou o Senhor e não se arrependerá: tu és sacerdote para sempre segundo a ordem de Melquisedeque. Aleluia.</p>
      </div>
