...
export default function Page0822() {
  return (
    <div className="docs">
      <h1>Imaculado Coração da B. Virgem Maria, a 22 de Agosto</h1>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. <em>Lc. 1, 46, 47</em> Minha alma glorifica o Senhor e o meu espírito se alegra em Deus, meu Salvador. Aleluia.</p>
      </div>
...
S. João.</p>
      ...
      <p>Naquele tempo, estavam, junto à Cruz de Jesus, sua Mãe, a irmã de sua Mãe, Maria, mulher de Cléofas, e Maria Madalena. Então, vendo Jesus sua Mãe, e de pé, perto dela, o discípulo que Ele preferia, disse a sua Mãe: «Mulher, eis o vosso filho». Em seguida disse ao discípulo: «Eis a tua Mãe!». E desde aquela hora o discípulo a levou consigo.</p>
      </div>
