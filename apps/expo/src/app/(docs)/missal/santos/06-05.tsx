    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 43, 2</em> Deus, áuribus nostris audívimus: patres nostri
          narravérunt opus, quod operátus es in diébus eórum. ℣. Gloria Patri...
        </p>
        <p>
          ...
          (T. P. Aleluia, aleluia.) <em>Sl. 43, 2</em> Ó Deus, ouvimos com os
      ...
      <div className="side-by-side">
        <p>
          ...
          ejus gaudeátis exsultántes. ℣. Si exprobrámini in nómine Christi,
          beáti éritis: quóniam, quod est honóris, glóriæ et virtútis Dei, et
          qui est ejus Spíritus, super vos requiéscet.
        </p>
        <p>
          ...
          alegria. ℣. Se sois ultrajados por causa do nome de Cristo, sereis
          bem-aventurados; pois a honra, a glória e a virtude de Deus e o seu
          Espírito repousarão sobre vós.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Is. 66, 12</em> Declinábo super eum quasi
          flúvium pacis, et quasi torréntem inundántem glóriam. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Is. 66, 12</em> Farei correr sobre ele como
          que um rio de paz, e como que uma torrente a trasbordar de glória.
          Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Is. 66, 10 & 14</em> Lætámini cum
          Jerúsalem, et exsultáte in ea, omnes, qui dilígitis Dóminum. Allelúja.
          ℣. Vidébitis, et gaudébit cor vestrum: cognoscétur manus Dómini servis
          ejus. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Is. 66, 10 & 14</em> Alegrai-vos e exultai
          com Jerusalém, ó vós, que amais o Senhor. Aleluia. ℣. Vereis e
