...
<aside>
  Comemoração de S. Sixto, Felicíssimo e Agapito como na [Missa Missa Sapiéntiam
...
<div className="side-by-side">
      ...
      <p>Caríssimos: Não foi servindo-nos de fábulas engenhosas que vos fizemos conhecer o poder e a vinda de nosso Senhor Jesus Cristo, mas depois de havermos sido espectadores da sua majestade. Com efeito, Ele recebeu de Deus Pai honra e glória, quando da glória magnífica desceu sobre Ele esta voz: «Este é o meu Filho muito amado, em quem pus as minhas complacências; ouvi-O». Nós também ouvimos esta voz, vinda do céu, quando estávamos com Ele, na montanha sagrada. E consideramos a palavra profética como firmíssima, à qual fazeis bem em atender, como se fora uma lâmpada em um lugar escuro, até que o dia brilhe e que a estrela da manhã nasça nos nossos corações!</p>
      </div>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. <em>Sb. 7, 26</em> Este é o esplendor da luz eterna, o espelho sem mancha de Deus e a imagem da sua bondade!</p>
      </div>
