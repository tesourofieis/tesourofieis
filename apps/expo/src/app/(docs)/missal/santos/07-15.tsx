  ...
  return (
    <div className="docs">
      ...
      <aside>
        ...
        aos seus sucessores, a fidelidade em todas as coisas». Aplicou-se
        cuidadosamente em estender a religião, reedificado as igrejas destruídas
        e fundando mosteiros que enriqueceu com donativos (Ep.). Retido no Monte
        Cassino por grave moléstia, foi curado milagrosamente, graças à
        intercessão de S. Bento. Desejoso de preparar-se para a vinda do divino
        Mestre (Ev., Com.), voltou da Itália pela França, fez-se agregar à de S.
        Vanno de Verdun. O Abade recebeu-o, ordenando-lhe imediatamente, em nome
        da obediência religiosa, voltar ao trono imperial. Amou tanto a lei de
        Deus (Intr.) que guardou absoluta virgindade no matrimónio e resolveu,
