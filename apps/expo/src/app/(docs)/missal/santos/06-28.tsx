...
<aside>
  A Igreja celebra amanhã a festa dos dois Apóstolos, os fundamentos sobre os
  quais ela está solidamente edificada (Or.). «O rigor que sabe impor-se um
  povo, em certos dias de preparação é um sinal da fé por ele conservada,
  escreve D. Guéranger, e mostra compreender ele a grandeza do objecto
  apresentado pela Santa Liturgia a seu culto». Pedro crucificado (Intr., Ev.)
  domina, como Cristo, o mundo; sela, com o seu sangue, a confissão de fé (Ev.
  de amanhã) e o amor (Ev.) a Jesus; rei das almas. Paulo, associando-se aos
  seus trabalhos e ao seu martírio, compartilha de seu reino e de seu triunfo.
</aside>
