...
export default function Page12252() {
  return (
    <div className="docs">
      <h1>Terceira Missa Natal de N. S. Jesus Cristo</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 97, 1</em> Cantáte Dómino cánticum novum, quia mirabília
          fecit. ℣. Gloria Patri...
        </p>
        <p>
          ...
          praticou maravilhas. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          glóriæ, et figúra substántia? ejus, portánsque ómnia verbo virtútis
          suæ, purgatiónem peccatórum fáciens, sedet ad déxteram majestátis in
          excélsis: tanto mélior Angelis efféctus, quanto differéntius præ illis
          nomen hereditávit. Cui enim dixit aliquándo Angelórum: Fílius meus es
          tu, ego hódie génui te? Et rursum: Ego ero illi in patrem, et ipse
          erit mihi in fílium? Et cum íterum introdúcit Primogénitum in orbem
          terræ, dicit: Et adórent eum omnes Angeli Dei. Et ad Angelos quidem
          dicit: Qui facit Angelos suos spíritus, et minístros suos flammam
          ignis. Ad Fílium autem: Thronus tuus, Deus, in sǽculum sǽculi: virga
          æquitátis, virga regni tui. Dilexísti justítiam et odísti iniquitátem:
          proptérea unxit te Deus, Deus tuus, óleo exsultatiónis præ
          particípibus tuis. Et: Tu in princípio, Dómine, terram fundásti: et
        ...
        <p>
          ...
          qual, sendo a irradiação esplendorosa da sua glória e a figura da sua
          substância e sustentando todas as coisas com sua palavra omnipotente
          depois de nos haver purificado dos nossos pecados, assentou-se à
          dextra da majestade divina, no mais alto dos céus, tanto mais superior
          aos Anjos quanto mais excelente e maior é o nome que herdou. Com
          efeito, a qual dos Anjos disse Deus estas palavras: «Tu és o meu
          Filho, gerei-te hoje?». E ainda estoutras: «Eu serei sen Pai e Ele
          será para mim Filho?». E também, quando mandou o seu primogénito ao
          mundo, disse: «Que todos os Anjos de Deus O adorem!». E, pelo que
          respeita aos Anjos, a Escritura diz: «Ele, que aos Anjos faz ventos e
          aos seus ministros chamas de fogo». Mas a respeito do Filho exprime-se
          assim: «Vosso trono, ó Deus, será eterno; o ceptro da vossa realeza
          será um ceptro de justiça e de rectidão. Vós amastes a justiça e
          odiastes a iniquidade. Por isso, ó Deus, o vosso Deus (o Pai) Vos
          ungiu com o bálsamo da alegria, mais ainda do que àqueles que convosco
          participam da glória». E também disse: «Vós, Senhor, no princípio
          criastes a terra; os céus são obra das vossas mãos. Eles perecerão,
      ...
      <div className="side-by-side">
        <p>
          ...
          terra. ℣. Notum fecit Dominus salutare suum: ante conspéctum géntium
          revelávit justitiam suam.
        </p>
        <p>
        ...
        <p>
          Aleluia, aleluia. ℣. Um dia de santidade resplandeceu para nós: vinde,
          ó povos, e adorai o Senhor: pois hoje desceu a grande luz à terra.
          Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          thesáuris suis, obtulérunt ei múnera, aurum, thus et myrrham. Et
          responso accépto in somnis, ne redírent ad Heródem, per aliam viam
        ...
        <p>
          ...
          ofereceram-Lhe presentes de ouro, incenso e mirra. Depois, havendo
          tido aviso em sonhos de que não deveriam voltar a encontrar Herodes,
