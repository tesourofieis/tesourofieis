...
export default function Page0212() {
  return (
    <div className="docs">
      <h1>Os Fundadores da Ordem dos Servitas, a 12 de Fevereiro</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          linguas infántium fecit disértas. <em>Ps. 8, 2</em> Dómine, Dóminus
          noster, quam admirábile est nomen tuum in univérsa terra! ℣. Gloria
          Patri...
        </p>
        <p>
          ...
          tornou eloquente a língua das criancinhas. <em>Sl. 8, 2</em> Ó Senhor,
          nosso Deus, como o vosso nome é glorioso em toda a terra! ℣. Glória ao
          Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          nuntiántes in prophétis dignitátem prophetárum, et imperántes in
          præsénti pópulo, et virtúte prudéntiæ pópulis sanctíssima verba. In
          perítia sua requiréntes modos músicos, et narrántes cármina
          scripturárum. Hómines dívites in virtúte, pulchritúdinis stúdium
          habéntes: pacificántes in dómibus suis. Omnes isti in generatiónibus
          gentis suæ glóriam adépti sunt, et in diébus suis habéntur in
          láudibus. Qui de illis nati sunt, reliquérunt nomen narrándi laudes
          eórum. Et sunt, quorum non est memória: periérunt, quasi qui non
          fúerint: et nati sunt, quasi non nati, et fílii ipsórum cum ipsis. Sed
          illi viri misericórdiæ sunt, quorum pietátes non defuérunt: cum sémine
        ...
        <p>
          ...
          notáveis em poder e dotados de prudência; foram conselheiros, cheios
          de sabedoria, anunciando a vontade divina nas suas profecias; mandaram
          no povo do seu tempo; deram aos povos, pela solidez da sua
          inteligência, as máximas mais santas; inventaram com perícia a arte
          das melodias; escreveram discursos poéticos; foram ricos em virtudes;
          ardentes no que era belo; e governaram em paz as suas casas. Todos
          estes homens foram honrados pelos seus contemporâneos; todos eles
          foram ilustres no seu tempo. Seus descendentes deixaram nome que
          recorda os seus louvores. Ao contrário, houve outros cuja recordação
          se perdeu; pereceram, como se nunca houvessem nascido, compartilhando
          da sua sorte seus filhos. É que aqueles foram homens misericordiosos,
          cujas virtudes não foram olvidadas. A felicidade transmitiu-se à sua
          descendência e a sua herança foi assegurada aos netos, mantendo-se sua
          descendência fiel à aliança com Deus, assim como também os seus
          filhos. Assim, a sua geração permanecerá eternamente e a sua glória
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Eccli. 44, 14</em> Córpora ipsorum in pace sepúlta sunt, et nomen
          eórum vivit in generatiónem et generatiónem.
        </p>
        <p>
          ...
          raça abençoada pelo Senhor. ℣. <em>Ecl. 44, 14</em> Seus corpos foram
          sepultados em paz e o seu nome vive de geração em geração.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>ibid., 15</em> Sapiéntiam ipsorum narrent
          pópuli, et laudem eórum núntiet Ecclésia. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>ibid., 15</em> Publiquem os povos a sua
