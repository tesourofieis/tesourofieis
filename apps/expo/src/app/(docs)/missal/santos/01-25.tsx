...
export default function Page0125() {
  return (
    <div className="docs">
      <h1>Conversão de S. Paulo, a 25 de Janeiro</h1>
...
<div className="side-by-side">
      ...
      <h3>Oração Comemoração de S. Pedro</h3>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. O grande S. Paulo, este vaso de eleição, é verdadeiramente digno de glória, pois mereceu ocupar o duodécimo trono. Aleluia.</p>
      </div>
...
<div className="side-by-side">
      ...
      <h3>Secreta Comemoração de S. Pedro</h3>
...
<div className="side-by-side">
      ...
      <h3>Postcomúnio Comemoração de S. Pedro</h3>
