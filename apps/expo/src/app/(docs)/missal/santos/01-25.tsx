    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          serváre in illum diem, justus judex. <em>Ps. 138, 1-2</em> Dómine,
        ...
        <p>
          ...
          <em>Sl. 138, 1-2</em> Senhor, Vós me perscrutastes e me conhecestes:
          conhecestes quando me deito e quando me levanto. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          gentes: et cognovérunt grátiam Dei, quæ data est mihi. ℣. Grátia Dei
        ...
        <p>
          ...
          Deus, que me foi dada. ℣. A graça de Deus em mim não foi estéril, mas
          permanece sempre em mim.
        </p>
        <p>
          Allelúja, allelúja. ℣. Magnus sanctus Paulus, vas electiónis, vere
          digne est glorificándus, qui et méruit thronum duodécimum possídere.
          Allelúja.
        </p>
        <p>
      ...
      <div className="side-by-side">
        <p>
          ...
          glorificándus. ℣. Prædicátor veritátis et doctor géntium in fide et
          veritáte. ℣. Per te omnes gentes cognovérunt grátiam Dei. ℣. Intercéde
          pro nobis ad Deum, qui te elégit.
        </p>
        <p>
          Sois um vaso de eleição, ó Apóstolo S. Paulo; e é com justa razão que
          vos glorificamos. ℣. Sois o pregador da verdade e o Doutor das nações,
          ensinando-lhes a fé e a verdade. ℣. Pelo vosso apostolado todas as
          nações conheceram a graça de Deus. ℣. Intercedei, pois, por nós junto
