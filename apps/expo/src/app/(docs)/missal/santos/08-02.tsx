...
export default function Page0802() {
  return (
    <div className="docs">
      <h1>S. Afonso Ligório, B. C. e Doutor, a 2 de Agosto</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          paupéribus misit me, sanáre contrítos corde. <em>Ps. 77, 1</em>{" "}
        ...
        <p>
          ...
          <em>Sl. 77, 1</em> Atendei à minha lei, ó meu povo; escutai as
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 39, 11</em> Justítiam tuam non abscóndi in corde meo:
        ...
        <p>
          ...
          pecadores, que se afastaram da vossa lei. ℣. <em>Sl. 39, 11</em> Não
          ocultei a vossa justiça no meu coração, publiquei a vossa verdade e a
          vossa salvação.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Eccli. 49, 3-4</em> Ipse est diréctus
        ...
        <p>
          Aleluia, aleluia. ℣. <em>Ecl. 49, 3-4</em> Foi predestinado pelo alto
          para levar o povo à penitência; e fez desaparecer as abominações da
          impiedade. Volveu o seu coração para o Senhor: e nos dias dos
