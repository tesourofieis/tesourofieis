...
<aside>
  O Anjo Gabriel anunciára a Maria que Deus daria, em breve, um filho a Isabel.
  Imediatamente a Virger foi a Hebron, onde morava sua prima; é este o mistério
  da Visitação, celebrado após a Oitava da Natividade de São João Baptista.
  Hoje, como no tempo do Advento, a Igreja aproxima de Jesus e de Maria a
  lembrança do Precursor. Lembramos naquela época que a Sexta-feira das Têmporas
  do verão recorda o mistério da Visitação. Esta solenidade foi instituída para
  todo o universo em 1389, por Urbano VI, a fim de obter a terminação do grande
  cisma do Ocidente, e, depois, elevada ao rito de duplo de segunda classe por
  Pio IX, pois, nesta festa conseguiu-se, em Roma, no ano 1849, a vitória da
  Igreja sobre a Revolução. Maria visita a Isabel e Jesus a João,
  santificando-o. Este exulta de alegria e Isabel, inspirada, pelo Espírito
  Santo, exclama: «Sois bendita entre as mulheres, e bendito é o fruto de vosso
  ventre» (Ev.). A Virgem, Mãe de Deus, que consigo traz e dá à luz, o autor de
...
<div className="side-by-side not-content">
      ...
      <p>Aleluia, aleluia. ℣. Bem-aventurada sois, ó santa Virgem Maria: e digna de todos os louvores, pois de vós nasceu o sol da justiça, Cristo, nosso Deus. Aleluia.</p>
      </div>
