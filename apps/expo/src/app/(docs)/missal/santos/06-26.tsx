...
export default function Page0626() {
  return (
    <div className="docs">
      <h1>S. S. João e Paulo, Mártires, a 26 de Junho</h1>


<aside>
  Os dois irmãos João e Paulo eram Romanos e serviam à Constância, filha de
  Constantino. Juliano o Apóstata, convidou-os a tomar parte entre os seus
  familiares, eles, porém, recusaram a fim de guardar a Jesus a sua fidelidade.
  Concederam-lhes dez dias para se resolverem, do que aproveitaram para
  distribuir seus bens aos pobres. Foram presos e, «sem temer os que não podem
  senão matar o corpo e nada mais fazer» (Ev.), tornaram-se, no ano 362, mais
  que nunca irmãos pela mesma fé e pelo mesmo martírio (Or.. Grad., Ale.). A
  Igreja os compara «às duas oliveiras e aos dois candelabros, brilhando diante
  da face do Senhor, e de que fala o Apocalipse». «Estes justos, acrescenta ele,
  comparecem juntos na presença do Senhor e não se separam». Seus nomes figuram
  no [Canon da Missa](/missal/ordo#canon-missæ) passando de geração em geração,
  enquanto os seus corpos descançam em paz (Ep.) no antigo santuário a eles
  consagrado no Monte Coelius, em Roma e onde é feita a Estação de Sexta-Feira
  depois das Cinzas. Alegremo-nos com a Igreja pelo trinfo de São João e de São
  Paulo (Or.) e, imitando-os, confessemos a fé em Jesus, diante dos homens, e
  Ele nos reconhecerá como seus, em presença de seus Anjos (Ev.).
</aside>
...
<div className="side-by-side not-content">
      ...
      <p>São homens de misericórdia e as obras da sua piedade não faltaram. Os bens, que deixaram à posteridade, permanecerão sempre. Seus descendentes constituirão uma herança sagrada; a sua raça manterá a aliança com Deus; e em virtude dela os seus filhos subsistirão eternamente, nunca mas acabando a sua geração, assim como a sua glória. Seus corpos foram sepultados em paz e o seu nome vive em todas as gerações. Que os povos, pois, publiquem a sua sabedoria e que a Igreja cante os seus louvores.</p>
      </div>
      <h3>Gradual</h3>
...
<div className="side-by-side not-content">
      ...
      <p>Aleluia, aleluia. ℣. Esta é a verdadeira fraternidade que venceu os crimes do mundo: ela seguiu Cristo e por isso possuirá gloriosamente o reino do céu. Aleluia.</p>
      </div>
