    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          como o perfume espalhado na cabeça, que desceu sobre a barba de Aarão.
        </p>
        <p>
        ...
        <p>
          ...
          crimes do mundo: ela seguiu Cristo e por isso possuirá gloriosamente o
          reino do céu. Aleluia.
        </p>
      </div>
