...
export default function Page0720() {
  return (
    <div className="docs">
      <h1>S. Jerónimo Emiliano, Conf., a 20 de Julho</h1>
      ...
      <aside>
        ...
        do Espírito de adopção que nos torna filhos do Pai, foi escolhido pelo
        Céu para tornar-se o pai dos orfãos e dos pobres (Or.). Como Jesus
        pedira ao jovem do Evangelho, deixou tudo e, a exemplo do Mestre, chamou
        a si os pequeninos (Ev.). Fundou em Somascha, entre Milão e Bergamo, uma
        Congregação com o fim de educar a juventude nos orfanatos e colégios. O
        Intróito, aplicando-lhe as palavras de Jeremias, mostra-o cheio de
        compaixão pelas crenças, que, graças a ele, aprenderam a louvar o
        Senhor. Partindo seu pão com os famintos e cobrindo os nús, acolheu nos
        asilos os indigentes e, com o auxílio dos nobres de Pavia e de Milão,
        espalhou entre os pobres profusas esmolas (Ep., Grad., Ale.). Morreu de
        peste no ano 1537, quando carregava aos ombros os cadáveres dos
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 112, 1</em> Laudáte, pueri, Dóminum: laudáte nomen Dómini. ℣.
          Gloria Patri...
        </p>
        <p>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          oriétur, et anteíbit fáciem tuam justítia tua, et glória Dómini
          cólliget te. Tunc invocábis, et Dóminus exáudiet: clamabis, et dicet:
          Ecce, adsum; si abstúleris de médio tui caténam, et desíeris exténdere
          dígitum, et loqui quod non prodest. Cum effúderis esuriénti ánimam
          tuam, et ánimam afflíctam repléveris. Oriétur in tenebris lux tua, et
          ténebræ tuæ erunt sicut merídies. Et réquiem tibi dabit Dóminus
        ...
        <p>
          ...
          carne. Então a vossa luz brilhará, como a aurora; reconquistareis
          depressa a vossa saúde; a vossa justiça caminhará diante de vós; e a
          glória do Senhor vos protegerá. Então invocareis o Senhor, que vos
          ouvirá; chamá-l’O-eis e responderá: «Eis-me aqui». Se tirardes do meio
          de vós a cadeia com que carregais os vossos irmãos; se deixardes de
          estender o dedo para eles e de lhes dirigirdes palavras injuriosas; se
          assistirdes com caridade aos pobres e consolardes as almas aflitas;
          então a vossa luz despontará nas trevas e as vossas trevas brilharão,
          como o sol ao meio-dia. E o Senhor vos dará um repouso que não mais
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. 111, 5-6</em> Jucúndus homo, qui miserétur et cómmodat:
          dispónet sermónes suos in judício, quia in ætérnum non commovébitur.
        </p>
        <p>
          Que as fontes trasbordem e que as águas se espalhem pelas praças
          públicas. <em>Sl. 111, 5-6</em> ℣. Bem-aventurado o homem que usou de
          misericórdia; que emprestou ao pobre; e que proferiu as suas palavras
          com justiça, pois ninguém poderá lançá-lo por terra.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>ibid., 9</em> Dispérsit, dedit paupéribus:
          justítia ejus manet in sǽculum sǽculi. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>ibid., 9</em> Com liberalidade distribuiu
          esmolas pelos pobres, pelo que sua justiça permanecerá em todos os
          séculos dos séculos. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          cœlórum. Et cum imposuísset eis manus, ábiit inde. Et ecce, unus
          accedens, ait illi: Magíster bone, quid boni fáciam, ut hábeam vitam
          ætérnam? Qui dixit ei: Quid me intérrogas de bono? Unus est bonus,
          Deus. Si autem vis ad vitam íngredi, serva mandáta. Dicit illi: Quæ?
          Jesus autem dixit: Non homicídium fácies: Non adulterábis: Non fácies
          furtum: Non falsum testimónium dices: Hónora patrem tuum et matrem
        ...
        <p>
          ...
          proibais de vir a mim, pois o reino dos céus é daqueles que se lhes
          assemelham». E, impondo sobre elas as mãos, se afastou. Mas eis que
          alguém, aproximando-se d’Ele, disse-Lhe: «Bom Mestre, que tenho a
          fazer de bom para alcançar a vida eterna?». Jesus respondeu-lhe:
          «Porque me chamais bom? Só um é bom: Deus! Se, pois, queres entrar na
          vida eterna, guarda os mandamentos». Disse-Lhe ele: «Quais
          mandamentos?». Jesus continuou: «Não cometerás homicídio, nem
          adultério; não furtarás; não levantarás falso testemunho; respeitarás
          teu pai e tua mãe; e amarás o teu próximo, como a ti próprio». O jovem
          disse-Lhe: «Tenho observado tudo isso desde a minha juventude; que me
