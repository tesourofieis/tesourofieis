...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. O Senhor amou André, como um perfume suave. Aleluia.</p>
      </div>
...
<div className="side-by-side">
      ...
      <p>Naquele tempo, caminhando Jesus junto ao mar da Galileia, viu dois irmãos: Simão, que se chama Pedro, e André, irmão deste, os quais lançavam as redes no mar, pois eram pescadores. Disse-lhes Jesus: «Vinde comigo e far-vos-ei pescadores de homens». Imediatamente eles, deixando as redes, O seguiram. Continuando Jesus a andar, encontrou mais adiante em uma barca, consertando as redes, outros dois irmãos: Tiago, filho de Zebedeu, e João, seu irmão, com seu pai Zebedeu. Então chamou-os. Logo, no mesmo instante, eles, deixando as redes e o pai, seguiram-n’O.</p>
      </div>
