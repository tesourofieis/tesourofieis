    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          solum fácere, sed et velle coepistis ab anno prióre: nunc vero et
          facto perfícite: ut, quemádmodum promptus est ánimus voluntátis, ita
          sit et perficiéndi ex eo quod habétis. Si enim volúntas prompta est,
          secúndum id quod habet, accépta est, non secúndum id quod non habet.
          Non enim ut áliis sit remíssio, vobis autem tribulátio, sed ex
          æqualitáte. In præsénti témpore vestra abundántia illórum inópiam
        ...
        <p>
          ...
          útil quanto começastes, não somente agora a praticar esta virtude, mas
          já o fazeis desde o último ano. Agora, pois, completai a vossa obra, a
          fim de que, tal como tem estado pronta a vossa vontade para querer,
          tal esteja também para cumprir o que quereis, segundo os meios que
          possuís; pois, quando a vontade está pronta, segundo o que possui, ela
          é agradável a Deus, mas não segundo o que se não possui. Não digo isto
          para que eles sintam alívio, e fiqueis atribulados; mas para que haja
          igualdade. Nas circunstâncias presentes a vossa abundância supra as
