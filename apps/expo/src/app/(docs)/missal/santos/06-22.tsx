...
export default function Page0622() {
  return (
    <div className="docs">
      <h1>S. Paulino, B. e Conf., a 22 de Junho</h1>
...
<div className="side-by-side">
      ...
      <p>Meus irmãos: Conheceis a bondade de nosso Senhor Jesus Cristo, que, sendo rico, se fez pobre, por causa de vos tornar ricos pela sua pobreza. A este respeito dou-vos um conselho, que vos é tanto mais útil quanto começastes, não somente agora a praticar esta virtude, mas já o fazeis desde o último ano. Agora, pois, completai a vossa obra, a fim de que, tal como tem estado pronta a vossa vontade para querer, tal esteja também para cumprir o que quereis, segundo os meios que possuís; pois, quando a vontade está pronta, segundo o que possui, ela é agradável a Deus, mas não segundo o que se não possui. Não digo isto para que eles sintam alívio, e fiqueis atribulados; mas para que haja igualdade. Nas circunstâncias presentes a vossa abundância supra as necessidades dos outros, de sorte que haja igualdade, assim como está escrito: «Àquele que recolheu muito lhe não sobejou; e àquele que recolheu pouco lhe não faltou».</p>
      </div>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. <em>Sl. 109, 4</em> Tu és sacerdote para sempre, segundo a ordem de Melquisedeque.</p>
      </div>
