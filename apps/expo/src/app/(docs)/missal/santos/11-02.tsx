...
<div className="side-by-side not-content">
      ...
      <p>Irmãos: Eis um mystério que vos revelo: Ressuscitaremos todos certamente; mas não seremos todos mudados. Num instante, num abrir e fechar de olhos, ao som da última trombeta, porque, então a trombeta soará e os mortos ressuscitarão incorruptíveis, e nós seremos transmudados. Pois é preciso que este corpo corruptível se revista da incorruptibilidade, e que este corpo mortal se revista da imortalidade. Quando este corpo corruptível se revestir da incorruptibilidade e este corpo mortal se revestir da imortalidade, então se cumprirá a palavra que está escrita: «A morte foi absorvida pela vitória. Onde está, ó morte, a tua vitória? Onde está, ó morte, o teu aguilhão?». Ora, o aguilhão da morte é o pecado; e a força do pecado é a lei. Graças, pois, sejam rendidas a Deus, que nos concedeu a vitória por Jesus Cristo, Senhor nosso.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Qual não será o terror dos homens quando o soberano Juiz vier examinar todas as acções com rigor!</p>
      <p>Tuba, mirum spargens sonum, Per sepúlcra regiónum, Coget omnes ante thronum.</p>
      <p>O som estridente da trombeta acordará os mortos, nas profundezas das sepulturas, reunindo-os todos diante do trono do Senhor.</p>
      <p>Mors stupébit et natúra, Cum resúrget creatúra, Judicánti responsúra.</p>
      <p>A morte e a natureza ficarão estupefactas quando a criatura comparecer para ser julgada pelo Juiz.</p>
      <p>Liber scriptus proferétur, In quo totum continétur, Unde mundus judicétur.</p>
      <p>Um livro aparecerá, onde está escrito tudo sobre o que há-de consistir o julgamento do mundo.</p>
      <p>Judex ergo cum sedébit, Quidquid latet, apparébit: Nil multum remanébit.</p>
      <p>Quando o Juiz se assentar no tribunal, tudo o que estiver oculto ficará descoberto, e nenhum crime ficará impune.</p>
      <p>Quid sum miser tunc dictúrus? Quem patrónum rogatúrus, Cum vix justus sit secúrus?</p>
      <p>Infeliz de mim! Que poderei dizer então? Que protector procurarei, quando somente o justo está tranquilo?!</p>
      <p>Rex treméndæ majestátis, Qui salvándos salvas gratis, Salva me, fons pietátis.</p>
      <p>Ó Rei, cuja majestade é tremenda, mas que salvais, gratuitamente, os escolhidos, salvai-me, ó fonte de piedade!</p>
      <p>Recordáre, Jesu pie, Quod sum causa tuæ viæ: Ne me perdas illa die.</p>
      <p>Recordai-Vos, ó piíssimo Jesus, de que vieste ao mundo por minha causa: não me condeneis nesse dia.</p>
      <p>Quærens me, sedísti lassus: Redemísti Crucem passus: Tantus labor non sit cassus.</p>
      <p>Ó Vós, que Vos fatigastes em minha procura e que para me resgatardes morrestes na Cruz: não queirais que fiquem infrutíferos tantos esforços.</p>
      <p>Juste judex ultiónis, Donum fac remissiónis Ante diem ratiónis.</p>
      <p>Ó justo Juiz, que castigais com justiça, concedei-me o perdão das minhas faltas antes do dia do julgamento.</p>
      <p>Ingemísco, tamquam reus: Culpa rubet vultus meus: Supplicánti parce, Deus.</p>
      <p>Eu choro, como réu; as minhas culpas envergonham-me. Ó Deus, que minhas súplicas me alcancem perdão.</p>
      <p>Qui Maríam absolvísti, Et latrónem exaudísti, Mihi quoque spem dedísti.</p>
      <p>Ó Vós, que absolvestes Maria e ouvistes o ladrão, e me concedestes também a esperança!</p>
      <p>Preces meæ non sunt dignæ: Sed tu bonus fac benígne, Ne perénni cremer igne.</p>
      <p>Bem sei que minhas preces não são dignas; mas Vós, que sois bom, não consintais que eu arda no fogo eterno.</p>
      <p>Inter oves locum præsta, Et ab hœdis me sequéstra, Státuens in parte dextra.</p>
      <p>Colocai-me entre os cordeiros, à vossa direita, e separai-me dos pecadores.</p>
      <p>Confutátis maledíctis, Flammis áctibus addíctis: Voca me cum benedíctis.</p>
      <p>Livrai-me da confusão e do suplicio dos malditos condenados e introduzi-me junto dos benditos de vosso Pai.</p>
      <p>Oro supplex et acclínis, Cor contrítum quasi cinis: Gere curam mei finis.</p>
      <p>Prostrado ante Vós, suplicante, com o coração esmagado, como reduzido a cinzas, Vos imploro, ó da morte.</p>
      <p>Lacrimósa dies illa, Qua resúrget ex favílla Judicándus homo reus.</p>
      <p>Dia de lágrimas aquele em que o homem renasça da sua cinza para ser julgado!</p>
      <p>Huic ergo parce, Deus: Pie Jesu Dómine, Dona eis réquiem.</p>
      <p>Tende, pois, piedade dele, ó meu Deus! Ó piíssimo Jesus, ó Senhor, concedei-lhe o repouso eterno.</p>
...
3.ª Missa, como a [Missa Quotidiana](/ritual/requiem#quotidiana), omitindo-se a 1.ª e 3.ª Oração, Secreta e Postcomúnio.
