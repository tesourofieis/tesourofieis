...
export default function Page1111() {
  return (
    <div className="docs">
      <h1>S. Martinho, a 11 de Novembro</h1>
...
<div className="side-by-side not-content">
      ...
      <p>Aleluia, aleluia. ℣. O bem-aventurado varão Martinho, Bispo de Tours, dormiu no Senhor: e os Anjos, os Arcanjos, os Tronos, as Dominações e as Virtudes o acolheram. Aleluia.</p>
      </div>
