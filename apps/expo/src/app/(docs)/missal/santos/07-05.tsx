...
export default function Page0705() {
  return (
    <div className="docs">
      <h1>S. António Maria Zacarias, Conf., a 5 de Julho</h1>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. <em>ibid., 11</em> Que sejais cheios dos frutos da justiça por Jesus Cristo, para glória e louvor de Deus. Aleluia.</p>
      </div>
