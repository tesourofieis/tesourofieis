...
export default function Page0318() {
  return (
    <div className="docs">
      <h1>S. Cirilo de Jerusalém, B. Conf. e Doutor, a 18 de Março</h1>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          se o soberano Senhor quiser, enchê-lo-á com o espírito de
          inteligência. Então ele espalhará, como chuva, as palavras da
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          super magístrum nec servus super dóminum suum. Súfficit discípulo, ut
          sit sicut magíster ejus: et servo, sicut dóminus ejus. Si
          patremfamílias Beélzebub vocavérunt; quanto magis domésticos ejus? Ne
          ergo timuéritis eos. Nihil enim est opértum, quod non revelábitur: et
          occúltum, quod non sciétur. Quod dico vobis in ténebris, dícite in
          lúmine: et quod in aure audítis, prædicáte super tecta. Et nolíte
        ...
        <p>
          ...
          homem. O discípulo não é superior ao mestre, nem o servo ao senhor.
          Basta ao discípulo ser como o mestre e ao servo como o senhor. Se
          chamaram Belzebute ao pai de família, o que não chamarão aos seus
          domésticos? Portanto, os não receeis; pois não há nada secreto que não
          seja revelado, nem oculto que não seja conhecido. Aquilo que vos digo
          nas trevas, dizei-o à luz; e o que vos digo ao ouvido, pregai-o sobre
