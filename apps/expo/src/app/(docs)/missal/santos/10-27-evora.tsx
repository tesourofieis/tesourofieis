...
export default function Page1027Evora() {
  return (
    <div className="docs">
      <h1>S. S. Vicente, Sabina e Cristeta, Márts, a 27 de Outubro, Na Arquidiocese de Évora</h1>
