    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          Fílium Dei. <em>Ps. 32, 1</em> Exsultáte, justi, in Dómino: rectos
          decet collaudátio. ℣. Gloria Patri...
        </p>
        <p>
          ...
          louvando unissonamente o Filho de Deus. <em>Sl. 32, 1</em> Aclamai o
      ...
      <div className="side-by-side">
        ...
        <p>
          Allelúja, allelúja. ℣. <em>Matth. 11, 28</em> Veníte ad me, omnes, qui
          laborátis et oneráti estis: et ego refíciam vos. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Mt. 11, 28</em> Vinde a mim, vós, todos, que
