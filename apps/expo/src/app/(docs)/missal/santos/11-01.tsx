...
export default function Page1101() {
  return (
    <div className="docs">
      <h1>Todos os Santos, a 1 de Novembro</h1>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. <em>Mt. 11, 28</em> Vinde a mim, vós, todos, que estais aflitos: e Eu vos aliviarei. Aleluia.</p>
      </div>
