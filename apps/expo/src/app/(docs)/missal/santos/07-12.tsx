...
export default function Page0712() {
  return (
    <div className="docs">
      <h1>S. João Gualberto, Abade, a 12 de Julho</h1>


<aside>
  João Gualberto nasceu em Florença, cerca do ano 999. Numa Sexta-Feira Santa,
  escoltado pelos seus homens armados, encontrou, só e sem defesa, o assassino
  de seu irmão. Ia atravessa-lo com a lança, quando este, lançando-se a seus
  pés, implorou-lhe o perdão pelo amor de Jesus crucificado. João lembrou-se da
  palavra de amor do Evangelho e o abraçou como a um irmão. Movido por graça
  ainda mais viva, revestiu o hábito monástico e, em breve, legislador como
  Moisés (Ep.) fundou em Val Umbrosa (Toscana) uma nova Ordem, à qual deu a
  regra de S. Bento (Com.) e que ainda hoje floresce, após mais de oito séculos
  de existência. A simonia reinava em toda a parte na Itália. Sua firmeza e
  eloquência baniram essa desordem da Etruria e levaram novamente sua pátria à
  integridade da fé e dos costumes. Quando morreu, em 1073, escreveram sobre o
  seu túmulo: A João Gualberto, cidadão de Florença, libertador da Itália.
</aside>
