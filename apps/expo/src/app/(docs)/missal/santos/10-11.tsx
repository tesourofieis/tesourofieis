...
export default function Page1011() {
  return (
    <div className="docs">
      <h1>Maternidade da B. Virgem Maria, a 11 de Outubro</h1>
...
<div className="side-by-side not-content">
      ...
      <p>Aleluia, aleluia. ℣. Ó Virgem, Aquele que todo o mundo não é capaz de conter, quando se fez homem, esteve encerrado no vosso seio. Aleluia.</p>
      </div>
