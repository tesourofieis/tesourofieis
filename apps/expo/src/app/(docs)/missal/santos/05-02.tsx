    ...
    <div className="docs">
      ...
      <div className="side-by-side not-content">
        ...
        <p>
          ...
          aleluia, aleluia. <em>Sl. 91, 2</em> É bom louvar o Senhor e cantar o
      ...
      <div className="side-by-side not-content">
        <p>
          ...
          secúndum órdinem Melchísedech. Allelúja. ℣. <em>Jac. 1, 12</em> Beátus
        ...
        <p>
          ...
          segundo a ordem de Melquisedeque! Aleluia. ℣. <em>Tg. 1, 12</em>{" "}
          Bem-aventurado o varão que sofre tentação; pois, quando acabar a
