...
export default function Page0504() {
  return (
    <div className="docs">
      <h1>Santa Mónica, Viúva, a 4 de Maio</h1>
      ...
      <aside>
        ...
        coração pelos maus costumes de Roma. «Dia e noite ela orava», «com maior
        abundância de lágrimas do que muitas mães derramam diante de um
        féretro». Era, antes de tudo, profundamente penetrada do temor de Deus,
        e sabia que a alma deve sacrificar-se para não ser rejeitada na última
        separação dos bons e dos maus; expiava as faltas de Agostinho.
        «Podereis, Senhor,» escreve o Santo, «desprezar o coração contrito e
        humilhado de uma viúva casta e sóbria? Rejeitareis as lágrimas daquela
        que não Vos pedia nem ouro, nem outro bem temporal e sim a salvação da
        alma de seu filho?» «Deus aceitou, na sua misericórdia, as lágrimas de
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          vere vidua est et desoláta, speret in Deum, et instet obsecratiónibus
          ...
          detérior. Vidua eligátur non minus sexagínta annórum, quæ fúerit unius
        ...
        <p>
          ...
          porque tal é a vontade de Deus. Aquela viúva, que é verdadeiramente
          viúva e vive só, espere em Deus e persevere noite e dia em suas
          súplicas e preces; porém aquela viúva, que vive nas delícias, não está
          viva, mas sim morta. Fazei-lhes, pois, saber isto, a fim de que sejam
          irrepreensíveis. Se alguém se não interessa pelos seus, e
          principalmente pelos de sua casa, nega a fé e é pior do que um infiel.
          Que a viúva que for escolhida não tenha menos de sessenta anos, nem
          haja tido mais do que um marido; e que tenha reputação de ter
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          hæc vídua erat, et turba civitátis multa cum illa. Quam cum vidísset
        ...
        <p>
          ...
          assentou o que estava morto, começando a falar! Então Jesus entregou-o
