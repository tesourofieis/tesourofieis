...
export default function PageEpi10() {
  return (
    <div className="docs">
      <h1>Domingo dentro do Oitavário da Epifania</h1>
...
<div className="side-by-side not-content">
      ...
      <p>Meus irmãos: Peço-vos pela misericórdia de Deus que ofereçais os vossos corpos como hóstia viva, santa e agradável a Deus, para que o culto que Lhe prestais seja racional. Não vos conformeis com os costumes; mas reformai-vos com a graça do espírito novo, que agora possuís, para que conheçais qual é a vontade de Deus, o que é bom, agradável e perfeito. Exorto-vos, pois, a todos vós, pela graça que me foi dada, que não formeis de vós um juízo muito elevado, mas que tenhais sentimentos modestos de vós, cada um conforme a medida que Deus lhe concedeu. Porquanto, assim como em um só corpo temos muitos membros (os quais, contudo, não têm a mesma função), assim também, ainda que sejamos vários, contudo formamos um só corpo em Jesus Cristo, sendo cada um de nós em particular membros uns dos outros, em Jesus Cristo, nosso Senhor.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Aleluia, aleluia. ℣. <em>Sl. 99, 1</em> Aclamai jubilosamente o Senhor, ó habitantes da terra: obedecei ao Senhor com alegria. Aleluia.</p>
      </div>
