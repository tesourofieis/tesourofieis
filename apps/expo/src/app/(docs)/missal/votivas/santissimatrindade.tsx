...
<div className="side-by-side">
      ...
      <p>Meus irmãos: Regozijai-vos, sede perfeitos» confortai-vos reciprocamente, sede unidos em vossos sentimentos, vivei em paz; e Deus da paz e do amor permanecerá convosco. Que a graça de nosso Senhor Jesus Cristo, o amor de Deus e a comunicação do Espírito Santo estejam sempre convosco. Amen.</p>
      </div>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. <em>ibid., 52</em> Sois bendito, Senhor, Deus dos nossos pais: e sois digno de louvor em todos os séculos.</p>
      </div>
...
S. João.</p>
      ...
      <p>Naquele tempo, disse Jesus aos seus discípulos: Quando vier o Paráclito, o Espírito da verdade que procede do Pai, que Eu vos enviarei do Pai. Ele dará testemunho de mim, e vós, que estais comigo desde o princípio, Lhe dareis também testemunho de mim. Digo-vos estas coisas para que vos não escandalizeis: expulsar-vos-ão das sinagogas; e vem a hora em que qualquer que vos mate, julgará que presta um serviço a Deus. Tratar-vos-ão deste modo, porque não conhecem nem o Pai, nem me conhecem a mim. Digo-vos estas coisas para que, quando chegar a hora, vos lembreis de que vo-las disse.</p>
      </div>
