...
export default function PagePeregrinosviajantes() {
  return (
    <div className="docs">
      <h1>Pelos Peregrinos e Viajantes</h1>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. <em>Sl. 118, 133</em> Encaminhei os meus passos segundo a vossa doutrina, para que nenhuma injustiça me possa dominar. Aleluia.</p>
      </div>

<aside>A pós a Septuagésima, omite-se o Aleluia e o seguinte, e diz-se:</aside>
