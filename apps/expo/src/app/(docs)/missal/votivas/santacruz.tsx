    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          illi nomen, quod est super omne nomen: <em>hic genuflectitur</em> ut
        ...
        <p>
          ...
          que é superior a todos os outros. <em>Genuflecte-se</em> De sorte que
      ...
      <div className="side-by-side">
        <p>
          ...
          recólimus passiónem: miserére nostri, qui passus es pro nobis. ℣. O
          Crux benedícta, quæ sola fuisti digna portáre Regem cœlórum et
          Dóminum.
        </p>
        <p>
          Vos adoramos e bendizemos, ó Cristo, porque salvastes o mundo pela
          vossa santa Cruz. ℣. Adoramos a vossa Cruz, Senhor, e honramos a vossa
          gloriosa paixão. O Vós, que sofrestes por nós, compadecei-Vos de nós.
          ℣. Ó Cruz bendita, só tu foste digna de sustentar o Senhor, que é o
          Rei dos céus.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 95, 10</em> Anunciai aos povos que Deus
          reinou pela Cruz. Aleluia. ℣. Ó lenho querido, que, preso aos benditos
          cravos, suportaste o doce fardo! Só tu foste digno de sustentar o
          Senhor, que é o Rei dos céus. Aleluia.
        </p>
      </div>
