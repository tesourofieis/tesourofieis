    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 1</em> Dixit Dóminus Dómino meo: Sede a dextris meis.
          ℣. Gloria Patri...
        </p>
        <p>
          ...
          Senhor ao meu Senhor: Assenta-te à minha direita. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          ℣. Vide quóniam tu labórem et dolórem consíderas: ℣. Tibi derelíctus
          est pauper: órphano tu eris adjútor.
        </p>
        <p>
          Erguei-Vos, ó Senhor Deus: elevai a vossa mão: não olvideis os pobres.
          ℣. Pois Vós apreciais e considerais o trabalho e a dor. ℣. A Vós se
          abandona o infeliz: sois amparo do órfão.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Hebr. 7, 24</em> Jesus autem eo quod máneat
          in ætérnum, sempitérnum habet sacerdótium. Allelúja. ℣.{" "}
          <em>Luc. 4, 18</em> Spíritus Dómini super me: propter quod unxit me,
          evangelizáre paupéribus misit me, sanáre contrítos corde. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Heb. 7, 24</em> Jesus, porque permanece para
          sempre, tem um sacerdócio sempiterno. Aleluia. ℣. <em>Lc. 4, 18</em> O
          Espírito do Senhor repousou sobre mim: e ungiu-me, mandando-me
          evangelizar os pobres e sarar os contritos de coração. Aleluia.
        </p>
      </div>
