    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Psalm</em> Deus, áuribus nostris audívimus, patres nostri
          annuntiavérunt nobis. ℣. Glória Patri...
        </p>
        <p>
          Levantai-Vos, ó Senhor, ajudai-nos, e resgatai-nos por causa do vosso
          nome. <em>Salmo</em> Nós ouvimos, ó Deus, com os nossos próprios
          ouvidos, anunciaram-nos nossos pais a obra que fizestes nos seus dias
          e nos dias antigos. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 2-3</em> Díligam te, Dómine, virtus mea: Dóminus
        ...
        <p>
          ...
          <em>Sl. ibid., 2-3</em> Eu vos amo, Senhor, que sois a minha força;
          sois, ó Senhor, o meu sustentáculo, o meu refúgio e a minha salvação.
          ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          orávit: et cœlum dedit plúviam et terra dedit fructum suum. Fratres
        ...
        <p>
          ...
          Pois ele pediu instantemente que não chovesse, e durante três anos e
          seis meses não choveu. E tornou a orar, pedindo chuva, e esta caiu do
          céu e a terra produziu frutos. Meus irmãos: se algum de vós se afastou
      ...
      <div className="side-by-side">
        <p>
          Allelúja. ℣. <em>Ps. 117, 1</em> Confitémini Dómino, quóniam bonus:
          quóniam in sǽculum misericórdia ejus.
        </p>
        <p>
          Aleluia. ℣. <em>Sl. 117, 1</em> Louvai o Senhor, pois Ele é bom: a sua
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          quod ponam ante illum: et ille deíntus respóndens, dicat: Noli mihi
          moléstus esse, jam óstium clausum est, et púeri mei mecum sunt in
          cubíli, non possum súrgere et dare tibi. Et si ille perseveráverit
          pulsans: dico vobis, etsi non dabit illi surgens, eo quod amícus ejus
          sit, propter improbitátem tamen ejus surget et dabit illi, quotquot
          habet necessários. Et ego dico vobis: Pétite, et dábitur vobis:
          quǽrite, et inveniétis: pulsáte, et aperiétur vobis. Omnis enim, qui
          petit, áccipit: et qui quærit, invénit: et pulsánti aperietur, Quis
          autem ex vobis patrem pétii panem, numquid lápidem dabit illi? Aut
        ...
        <p>
          ...
          casa e não tenho que dar-lhe» ; e esse amigo responder de dentro de
          casa: «Não me importunes, pois a porta já está fechada; eu e os meus
          filhos estamos deitados e não posso levantar-me», digo-vos que, se o
          primeiro continuar a bater à porta, ainda que o outro se não levante
          para lhe dar o pão por ser seu amigo, levantar-se-á para não ser
          importunado; e dar-lhe-á tanto quanto carecer. Assim vos digo eu: pedi
          e recebereis; buscai e encontrareis; batei e abrir-se-vos-á. Porquanto
          todo aquele que pedir receberá; todo aquele, que procurar achará; todo
          aquele que bater abrir-se-lhe-á. Se algum de vós pedir um pão a seu
          pai, porventura este lhe dará uma pedra? Ou, se lhe pedir um peixe,
