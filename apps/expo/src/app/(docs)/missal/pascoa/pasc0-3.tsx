...
<div className="side-by-side not-content">
      <p>Veníte, benedícti Patris mei, percípite regnum, allelúja: quod vobis parátum est ab orígine mundi, allelúja, allelúja, allelúja. <em>Ps. 95, 1</em> Cantáte Dómino cánticum novum: cantáte Dómino, omnis terra. ℣. Gloria Patri...</p>
      <p>Vinde, benditos do meu Pai, recebei o reino, aleluia: que foi preparado para vós desde a criação do mundo, aleluia, aleluia, aleluia. <em>Sl. 95, 1</em> Cantai ao Senhor um cântico novo: que toda a terra cante hinos ao Senhor. ℣. Glória ao Pai...</p>
      </div>

      <h3>Oração</h3>

<div className="side-by-side not-content">
      <p>Deus, qui nos Resurrectiónis Domínicæ ánnua solemnitáte lætíficas: concéde propítius; ut per temporália festa, quæ ágimus, perveníre ad gáudia ætérna mereámur. Per eúndem Dóminum...</p>
      <p>Ó Deus, que nos alegrais anualmente com a celebração da solenidade da Ressurreição do Senhor, permiti benigno que, celebrando nós estas festas neste tempo, mereçamos alcançar os gozos eternos. Pelo mesmo nosso Senhor...</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Hæc dies, quam fecit Dóminus: exsultémus et lætámur in ea. ℣. Déxtera Dómini fecit virtútem, déxtera Dómini exaltávit me.</p>
      <p>Eis o dia que o Senhor fez: exultemos e alegremo-nos nele. A dextra do Senhor manifestou o seu poder: a dextra do Senhor exaltou-me!</p>
      <p>Allelúja, allelúja. ℣. <em>Luc. 24, 34</em> Surréxit Dóminus vere: et appáruit Petro.</p>
      <p>Aleluia, aleluia. ℣. <em>Lc. 24, 34</em> O Senhor ressuscitou verdadeiramente e apareceu a Pedro.</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Portas cœli apéruit Dóminus: et pluit illis manna, ut éderent: panem cœli dedit eis: panem Angelórum manducávit homo, allelúja.</p>
      <p>O Senhor abriu as portas do céu e fez chover maná para alimentar o seu povo: deu-lhes o pão do céu: o homem comeu o pão dos Anjos, aleluia.</p>
      </div>

      <h3>Secreta</h3>

<div className="side-by-side not-content">
      <p>Sacrifícia, Dómine, paschálibus gáudiis immolámus: quibus Ecclésia tua mirabíliter et páscitur et nutrítur. Per Dóminum...</p>
      <p>No meio das alegrias pascais imolamos, Senhor, este sacrifício, que é para a vossa Igreja o alimento admirável de que se nutre e sustenta. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Christus resúrgens ex mórtuis jam non móritur, allelúja: mors illi ultra non dominábitur, allelúja, allelúja.</p>
      <p>Cristo, ressuscitado, já não torna a morrer, aleluia: a morte nunca mais terá poder sobre Ele, aleluia, aleluia.</p>
      </div>

      <h3>Postcomúnio</h3>

<div className="side-by-side not-content">
      <p>Ab omni nos, quǽsumus, Dómine, vetustáte purgátos: sacraménti tui veneránda percéptio in novam tránsferat creatúram: Qui vivis et regnas...</p>
      <p>Senhor, dignai-Vos purificar-nos de todos os restos do «homem velho», e permiti que a sagrada recepção deste sacramento nos torne criaturas novas. Vós, que, sendo Deus, viveis e reinais...</p>
      </div>
