...
export default function PagePasc71() {
  return (
    <div className="docs">
      <h1>Segunda-feira de Pentecostes</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          eos, allelúja, allelúja. <em>Ps. ibid., 2</em> Exsultáte Deo, adjutóri
          nostro: jubiláte Deo Jacob. ℣. Gloria Patri...
        </p>
        <p>
          Alimentou-os Deus com o pão mais puro, aleluia: e saciou-os com o mel
          que fez brotar de uma rocha, aleluia, aleluia. <em>Sl. ibid., 2</em>{" "}
          Louvai alegremente o Senhor, que é o nosso sustentáculo; aclamai com
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Act. 2, 4</em> Loquebántur váriis linguis
          Apóstoli magnália Dei. Allelúja. <em>hic genuflectitur</em> ℣. Veni,
          Sancte Spiritus, reple tuorum corda fidélium: et tui amóris in eis
          ignem accénde.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Act. 2, 4</em> Os Apóstolos publicavam em
          diversas línguas as maravilhas de Deus. Aleluia.{" "}
          <em>Genuflecte-se</em> Vinde, ó Espírito Santo; enchei os corações dos
