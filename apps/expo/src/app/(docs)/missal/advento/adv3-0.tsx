    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          <em>Sl. 84, 2</em> Abençoastes, Senhor, a vossa terra: e livrastes
          Jacob do cativeiro. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          Aleluia, aleluia. ℣. Mostrai, Senhor, o vosso poder, e vinde, para que
          sejamos salvos. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          respónsum demus his, qui misérunt nos? Quid dicis de te ipso? Ait: Ego
          vox clamántis in desérto: Dirígite viam Dómini, sicut dixit Isaías
          Prophéta. Et qui missi fúerant, erant ex pharisǽis. Et interrogavérunt
          eum, et dixérunt ei: Quid ergo baptízas, si tu non es Christus, neque
          Elías, neque Prophéta? Respóndit eis Joánnes, dicens: Ego baptízo in
          aqua: médius autem vestrum stetit, quem vos nescítis. Ipse est, qui
        ...
        <p>
          ...
          «Então quem és? És Elias?» João respondeu: «Não sou». «És algum
          Profeta?». Ele respondeu: «Não sou». «Diz, pois, quem és, a fim de que
          respondamos àqueles que nos enviaram. Que dizes de ti?» E João
          respondeu: «Eu sou a voz daquele que clama no deserto: «Endireitai o
          caminho de Senhor», como disse o Profeta Isaías». Ora, como alguns
          daqueles que lhe haviam sido enviados eram fariseus, interrogaram-no e
          disseram-lhe: «Então, se não és nem Cristo, nem Elias, nem algum
          Profeta, porque baptizas?» João respondeu-lhes: a «Eu baptizo na água;
          porém, entre vós está Alguém, a quem não conheceis, que é Aquele que
