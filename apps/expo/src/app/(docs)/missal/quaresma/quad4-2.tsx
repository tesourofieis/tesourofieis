...
export default function PageQuad42() {
  return (
    <div className="docs">
      <h1>Terça-feira da 4.ª Semana da Quaresma</h1>
...
<div className="side-by-side">
      ...
      <p>Miserére, Dómine, pópulo tuo: et contínuis tribulatiónibus laborántem, propítius respiráre concéde. Per Dóminum...</p>
      <p>Tende piedade, Senhor, do vosso povo e aliviai-o propiciamente das contínuas tribulações que o afligem. Por nosso Senhor...</p>
      </div>
