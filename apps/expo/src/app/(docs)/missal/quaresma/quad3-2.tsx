...
export default function PageQuad32() {
  return (
    <div className="docs">
      <h1>Terça-feira da 3.ª Semana da Quaresma</h1>
...
<div className="side-by-side">
      ...
      <p>Defendei-nos, Senhor, com vossa protecção e livrai-nos perpetuamente de todas as iniquidades. Por nosso Senhor...</p>
      </div>
