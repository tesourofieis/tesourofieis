...
<aside>
A Estação fazia-se outrora na igreja de S. João de Latrão, primitivamente chamada Basílica de São Salvador. A liturgia da Quinta-feira Santa é, realmente, toda impregnada da lembrança da Redenção. Comportava antigamente a celebração de três Missas; na primeira, eram reconciliados os Penitentes públicos; na segunda, consagravam-se os Santos Óleos e na terceira, comemorava-se especialmente a Instituição da Eucaristia na última Ceia. Somente esta última resta hoje; o Bispo cercado de 12 Padres, 7 Diáconos e 7 Subdiáconos, benze então os Santos Óleos na Catedral.
</aside>
...
<div className="side-by-side">
      ...
      <p>Senhor, quereis lavar-me os pés? Jesus respondeu-lhe e disse: «Se te não lavar os pés, não terás parte comigo». ℣. «O que faço presentemente tu o ignoras; mas sabê-lo-ás depois».</p>
      <p>Dómine, tu mihi lavas pedes? Respóndit Jesus et dixit ei: Si non lávero tibi pedes, non habébis partem mecum.</p>
      <p>Senhor, quereis lavar-me os pés? Jesus respondeu-lhe e disse: «Se te não lavar os pés, não terás parte comigo».</p>
      </div>
...
<div className="side-by-side">
      ...
      <p>Deus esta onde estiverem a caridade e o amor. ℣. Estamos reunidos em uma única assembleia. ℣. Evitemos tudo o que possa dividir os nossos corações. ℣. Longe de nós as rixas e as dissensões. ℣. Que Cristo, nosso Deus, esteja no meio de nós.</p>
      <p>Ubi cáritas et amor, Deus ibi est. ℣. Simul quoque cum Beátis videámus ℣. Gloriánter vultum tuum, Christe Deus: ℣. Gáudium, quod est imménsum atque probum. ℣. Sǽcula per infiníta sæculórum. <span className="text-red-500">℟.</span> Amen.</p>
...
<div className="side-by-side">
      ...
      <p><span className="text-red-500">℟.</span> Custodíri nimis.</p>
      <p><span className="text-red-500">℟.</span> Fossem bem observados.</p>
      <p>℣. Tu lavásti pedes discipulórum tuórum.</p>
      <p>℣. Lavastes os pés aos vossos discípulos.</p>
      <p><span className="text-red-500">℟.</span> Opera mánuum tuárum ne despícias.</p>
      <p><span className="text-red-500">℟.</span> Não desprezeis as obras das vossas mãos.</p>
