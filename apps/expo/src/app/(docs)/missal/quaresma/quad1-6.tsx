...
<div className="side-by-side not-content">
      <p>De necessitátibus meis éripe me, Dómine: vide humilitátem meam et labórem meum, et dimítte ómnia peccáta mea. <em>Ps. ibid., 1-2</em> Ad te, Dómine, levávi ánimam meam: Deus meus, in te confído, non erubéscam. ℣. Gloria Patri...</p>
      <p>Livrai-me, Senhor, das minhas tribulações; vede a minha humilhação e as minhas penas e perdoai-me todos meus pecados. <em>Sl. ibid., 1-2</em> A Vós, Senhor, elevo a minha alma: meu Deus, em Vós confio: não esperarei em vão. ℣. Glória ao Pai...</p>
      </div>

      <h3>Oração</h3>

<div className="side-by-side not-content">
      <p>Esto, Dómine, propítius plebi tuæ: et, quam tibi facis esse devótam, benígno réfove miserátus auxílio. Per Dóminum...</p>
      <p>Sede propício ao vosso povo, Senhor; e, visto que lhe concedestes a graça da devoção para convosco, auxiliai-o agora benignamente com vossa misericórdia. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Salvum fac servum tuum. Deus meus, sperántem in te. ℣. Auribus pércipe, Dómine, oratiónem meam.</p>
      <p>Salvai, ó meu Deus, o vosso servo, pois em Vós pôs a sua esperança. Escutai a minha oração, Senhor!</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Bénedic, anima mea, Dómino, et noli oblivísci omnes retributiónes ejus: et renovábitur, sicut áquilæ, juvéntus tua.</p>
      <p>Bendizei o Senhor, ó minha alma, e não esqueçais nunca os seus benefícios; e a vossa juventude se renovará, como a da águia.</p>
      </div>

      <h3>Secreta</h3>

<div className="side-by-side not-content">
      <p>Súscipe, quǽsumus, Dómine, múnera nostris obláta servítiis: et tua propítius dona sanctífica. Per Dóminum...</p>
      <p>Aceitai, Senhor, Vos suplicamos, as oblatas que a nossa escravidão Vos apresenta, e, propício, dignai-Vos santificar estes dons que de Vós recebemos. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Erubéscant et conturbéntur omnes inimíci mei: avertántur retrórsum, et erubéscant valde velóciter.</p>
      <p>Envergonhem-se e perturbem-se todos meus inimigos; apressem-se em fugir, cheios de vergonha.</p>
      </div>

      <h3>Postcomúnio</h3>

<div className="side-by-side not-content">
      <p>Per hujus, Dómine, operatiónem mystérii, et vítia nostra purgéntur, et justa desidéria compleántur. Per Dóminum nostrum...</p>
      <p>Que por efeito deste mystério, Senhor, os nossos vícios desapareçam e sejam realizados os nossos justos desejos. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Exáudi nos, miséricors Deus: et méntibus nostris grátiæ tuæ lumen osténde. Per Dóminum...</p>
      <p>Ó Deus de misericórdia, ouvi-nos; e mostrai às nossas almas a luz da vossa graça. Por nosso Senhor...</p>
      </div>
