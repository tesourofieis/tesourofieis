...
export default function PageQuad10() {
  return (
    <div className="docs">
      <h1>Primeiro Domingo da Quaresma</h1>
...
<div className="side-by-side not-content">
      <p>Invocábit me, et ego exáudiam eum: erípiam eum, et glorificábo eum: longitúdine diérum adimplébo eum. <em>Ps. ibid., 1</em> Qui hábitat in adjutório Altíssimi, in protectióne Dei cœli commorábitur. ℣. Gloria Patri...</p>
      <p>Invocar-me-á, e ouvi-lo-ei: livrá-lo-ei, e glorificá-lo-ei: conceder-lhe-ei longa vida. <em>Sl. ibid., 1</em> Aquele que habita à sombra do Altíssimo descansará sob a protecção de Deus do céu. ℣. Glória ao Pai...</p>
      </div>

      <h3>Oração</h3>

<div className="side-by-side not-content">
      <p>Deus, qui Ecclésiam tuam ánnua quadragesimáli observatióne puríficas: præsta famíliæ tuæ; ut, quod a te obtinére abstinéndo nítitur, hoc bonis opéribus exsequátur. Per Dóminum...</p>
      <p>Ó Deus, que purificais a vossa Igreja com a observância anual da quaresma, concedei à vossa família que o que ela deseja alcançar pela abstinência o pratique com suas boas obras. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Angelis suis Deus mandávit de te, ut custódiant te in ómnibus viis tuis. ℣. In mánibus portábunt te, ne umquam offéndas ad lápidem pedem tuum.</p>
      <p>Deus ordenou aos seus Anjos que te guardassem em todos teus caminhos. ℣. Levar-te-ão nas suas mãos, para que não tropeces nas pedras.</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Scápulis suis obumbrábit tibi Dóminus, et sub pennis ejus sperábis: scuto circúmdabit te véritas ejus.</p>
      <p>O Senhor vos acolherá à sua sombra: e sob as suas asas vos esperará: a sua fidelidade proteger-vos-á, como um escudo.</p>
      </div>

      <h3>Secreta</h3>

<div className="side-by-side not-content">
      <p>Sacrifícium quadragesimális inítii sollémniter immolámus, te, Dómine, deprecántes: ut, cum epulárum restrictióne carnálium, a noxiis quoque voluptátibus lemperémus. Per Dóminum...</p>
      <p>Senhor, imolamos solenemente este sacrifício no princípio da Quaresma, suplicando-Vos que, fazendo-nos restringir o uso das carnes, nos abstenhamos também dos prazeres funestos. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side not-content">
      <p>Scápulis suis obumbrábit tibi Dóminus, et sub pennis ejus sperábis: scuto circúmdabit te véritas ejus.</p>
      <p>O Senhor vos acolherá à sua sombra: e sob as suas asas vos esperará: a sua verdade proteger-vos-á, como um escudo.</p>
      </div>

      <h3>Postcomúnio</h3>

<div className="side-by-side not-content">
      <p>Qui nos, Dómine, sacraménti libátio sancta restáuret: et a vetustáte purgátos, in mystérii salutáris fáciat transíre consórtium. Per Dóminum...</p>
      <p>Que a participação, que tomámos, no vosso sacramento, Senhor, nos restaure; e que, despojando-nos do «homem velho», nos faça alcançar o mystério da salvação. Por nosso Senhor...</p>
      </div>
