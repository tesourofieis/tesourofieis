...
export default function PageQuad21() {
  return (
    <div className="docs">
      <h1>Segunda-feira da 2.ª Semana da Quaresma</h1>
...
<div className="side-by-side">
      ...
      <p>Adésto supplicatiónibus nostris, omnípotens Deus: et, quibus fidúciam sperándæ pietátis indúlges; consuétæ misericórdiæ tríbue benígnus efféctum. Per Dóminum...</p>
      <p>Sede atento às nossas súplicas, ó Deus omnipotente; e permiti benignamente que aqueles que de Vós mereceram a doce confiança de lhes revelardes que podiam ter esperança na vossa bondade alcancem os efeitos da vossa habitual misericórdia. Por nosso Senhor...</p>
      </div>
