...
export default function PageQuad41() {
  return (
    <div className="docs">
      <h1>Segunda-feira da 4.ª Semana da Quaresma</h1>
...
<div className="side-by-side not-content">
      ...
      <p>Deprecatiónem nostram, quǽsumus. Dómine, benígnus exáudi: et, quibus supplicándi præstas afféctum, tríbue defensiónis auxílium. Per Dóminum...</p>
      <p>Senhor, Vos suplicamos, ouvi benigno a nossa prece e socorrei com vossa protecção aqueles a quem inspirais o desejo da oração. Por nosso Senhor...</p>
      </div>
