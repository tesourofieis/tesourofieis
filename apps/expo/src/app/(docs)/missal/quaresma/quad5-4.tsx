...
<div className="side-by-side">
      <p>Omnia, quæ fecísti nobis, Dómine, in vero judício fecísti: quia peccávimus tibi, et mandátis tuis non obœdívimus: sed da glóriam nómini tuo, et fac nobíscum secúndum multitúdinem misericórdiæ tuæ. <em>Ps. 118, 1</em> Beáti immaculáti in via: qui ámbulant in lege Dómini.</p>
      <p>Quantos males caíram sobre nós, Senhor, foi com verdadeira justiça que o fizestes, pois pecamos e não obedecemos aos vossos mandamentos; mas agora glorificai o vosso nome e usai para connosco de misericórdia. <em>Ps. 118, 1</em> Bem-aventurados aqueles cuja vida é perfeita e que praticam a Lei do Senhor.</p>
      </div>

      <h3>Oração</h3>

<div className="side-by-side">
      <p>Præsta, quǽsumus, omnípotens Deus: ut dígnitas condiciónis humánæ, per immoderántiam sauciáta, medicinális parsimóniæ stúdio reformétur. Per Dóminum...</p>
      <p>Permiti, Vos suplicamos, ó Deus omnipotente, que a dignidade da natureza humana, corrompida pela intemperança, seja restabelecida pela prática da salutar abstinência. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side">
      <p>Tóllite hóstias, et introíte in átria ejus: adoráte Dóminum in aula sancta ejus. ℣. <em>Ps. 28, 9</em> Revelávit Dóminus condénsa: et in templo ejus omnes dicent glóriam.</p>
      <p>Levai convosco as vossas ofertas e entrai nos átrios: adorai o Senhor no seu templo santo. ℣. <em>Sl. 28, 9</em> O Senhor descobrirá o que está oculto, e todos O glorificarão no seu templo.</p>
      </div>
...
<div className="side-by-side">
      <p>Super flúmina Babylónis illic sédimus et flévimus: dum recordarémur tui, Sion.</p>
      <p>Ao pé das margens dos rios da Babilónia nos sentámos e chorámos, recordando-nos com saudade de Sião!</p>
      </div>

      <h3>Secreta</h3>

<div className="side-by-side">
      <p>Dómine, Deus noster, qui in his pótius creatúris, quas ad fragilitátis nostræ subsídium condidísti, tuo quoque nómini múnera jussísti dicánda constítui: tríbue, quǽsumus; ut et vitæ nobis præséntis auxílium et æternitátis effíciant sacraméntum. Per Dóminum...</p>
      <p>Senhor, nosso Deus, que quisestes que as criaturas destinadas por Vós para alimento da nossa fraqueza fossem também imoladas em honra do vosso nome, dignai-Vos permitir, Vos suplicamos, que elas nos sirvam de auxílio na vida presente e ao mesmo tempo de sacramento de salvação eterna. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side">
      <p>Meménto verbi tui servo tuo, Dómine, in quo mihi spem dedísti: hæc me consoláta est in humilitáte mea.</p>
      <p>Lembrai-Vos, Senhor, da promessa que fizestes ao vosso servo e com a qual me enchestes de esperança: ela me tem consolado na humilhação.</p>
      </div>

      <h3>Postcomúnio</h3>

<div className="side-by-side">
      <p>Quod ore súmpsimus, Dómine, pura mente capiámus: et de munere temporáli, fiat nobis remédium sempitérnum. Per Dóminum...</p>
      <p>Fazei, Senhor, que guardemos com o coração puro aquilo que a nossa boca recebeu; e que este dom temporal se torne para nós em remédio eterno. Por nosso Senhor...</p>
      </div>
...
<div className="side-by-side">
      ...
      <p>Esto, quǽsumus, Dómine, propítius plebi tuæ: ut, quæ tibi non placent, respuéntes; tuórum pótius repleántur delectatiónibus mandatórum. Per Dóminum...</p>
      <p>Senhor, Vos imploramos, sede favorável ao vosso povo, a fim de que, repelindo tudo o que Vos desagrada, lhe advenham as delícias que resultam da prática dos vossos mandamentos. Por nosso Senhor...</p>
      </div>
