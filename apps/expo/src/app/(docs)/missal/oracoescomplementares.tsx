...
export default function PageOracoescomplementares() {
  return (
    <div className="docs">
      <h1>Orações Complementares</h1>


      <h2>Acção de Graças da Missa</h2>

<div className="side-by-side">
      <p>Ant. Trium puerórum cantémus hymnum, quem cantábant Sancti in camíno ignis, benedicéntes Dóminum. (T. P. Allelúja.)</p>
      <p>Ant. Cantemos o hino dos três jovens que cantavam os Santos na fornalha do fogo, glorificando o Senhor. (T. P. Aleluia.)</p>
      </div>
...
<div className="side-by-side">
      <p>Ant. Trium puerórum cantémus hymnum, quem cantábant Sancti in camíno ignis, benedicéntes Dóminum. (T. P. Allelúja.)</p>
      <p>Ant. Cantemos o hino dos três jovens que cantavam os Santos na fornalha do fogo, glorificando o Senhor. (T. P. Aleluia.)</p>
      <p>Kýrie, eléison. Christe, eléison. Kýrie, eléison.</p>
      <p>Senhor, tende piedade de nós. Cristo, tende... Senhor, tende...</p>
      <p>Pater noster. ℣. Et ne nos indúcas in tentatiónem. <span className="text-red-500">℟. </span>Sed líbera nos a malo.</p>
      <p>Pai-nosso. ℣. E não nos deixeis cair em tentação. <span className="text-red-500">℟. </span>Mas livrai-nos do mal.</p>
      <p>℣. Confiteántur tibi, Dómine, omnia opera tua. ℞. Et Sancti tui benedícant tibi.</p>
      <p>℣. Que todas vossas obras Vos louvem, Senhor. <span className="text-red-500">℟. </span>E os vossos Santos Vos bendigam.</p>
      <p>℣. Exsultábunt Sancti in glória. <span className="text-red-500">℟. </span> Lætabúntur in cubílibus suis.</p>
      <p>℣. Os Santos exultam de alegria. <span className="text-red-500">℟. </span> Alegrar-se-ão no lugar do seu repouso.</p>
      <p>℣. Non nobis, Dómine, non nobis. <span className="text-red-500">℟. </span>Sed nómini tuo da glóriam.</p>
      <p>℣. Não a nós, Senhor, não a nós. <span className="text-red-500">℟. </span>Mas ao vosso nome dêmos glória.</p>
      <p>℣. Dómine, exáudi oratiónem meam. <span className="text-red-500">℟. </span>Et clamor meus ad te véniat.</p>
      <p>℣. Senhor, ouvi a minha oração. <span className="text-red-500">℟. </span>E o meu clamor chegue até Vós.</p>
