...
export default function PagePent30() {
  return (
    <div className="docs">
      <h1>Terceiro Domingo depois de Pentecostes</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          mea, Deus meus. <em>Ps. ibid., 1-2</em> Ad te, Dómine, levávi ánimam
          meam: Deus meus, in te confído, non erubéscam. ℣. Gloria Patri...
        </p>
        <p>
          ...
          Deus, e perdoai-me todos os pecados. <em>Sl. ibid., 1-2</em> A Vós,
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          adversárius vester diábolus tamquam leo rúgiens circuit, quærens, quem
          dévoret: cui resístite fortes in fide: sciéntes eándem passiónem ei,
          quæ in mundo est, vestræ fraternitáti fíeri. Deus autem omnis grátiæ,
        ...
        <p>
          ...
          adversário, que é o demónio, andará em torno de vós, como um leão,
          procurando a quem devorar. Resisti-lhe, sendo sempre firmes na fé e
          sabendo que os vossos irmãos, que estão dispersos pelo mundo, sofrem
          as mesmas aflições. Deus de toda a graça (que nos chamou à sua glória
      ...
      <div className="side-by-side">
        ...
        <p>
          Confiai ao Senhor vossas inquietações: Ele vos sustentará. ℣. Logo que
        ...
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 7, 12</em> Deus é juiz justo, forte e
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          illos parábolam istam, dicens: Quis ex vobis homo, qui habet centum
          oves: et si perdíderit unam ex illis, nonne dimíttit nonagínta novem
          in desérto, et vadit ad illam, quæ períerat, donec invéniat eam? Et
          cum invénerit eam, impónit in húmeros suos gaudens: et véniens domum,
          cónvocat amícos et vicínos, dicens illis: Congratulámini mihi, quia
          invéni ovem meam, quæ períerat? Dico vobis, quod ita gáudium erit in
          cœlo super uno peccatóre pœniténtiam agénte, quam super nonagínta
          novem justis, qui non índigent pœniténtia. Aut quæ múlier habens
          drachmas decem, si perdíderit drachmam unam, nonne accéndit lucérnam,
          et evérrit domum, et quærit diligénter, donec invéniat? Et cum
        ...
        <p>
          ...
          parábola e disse-lhes: «Qual é de vós o que, possuindo cem ovelhas, e,
          perdendo uma, não deixa as noventa e nove no deserto e não vai em
          procura da que se perdera até achá-la? E, achando-a, a não põe aos
          ombros com alegria, e, vindo para a sua casa, não reúne os amigos e
          vizinhos, dizendo-lhes: «congratulai-vos comigo, pois achei a minha
          ovelha, que se perdera»? Digo-vos que do mesmo modo haverá mais
          alegria no céu por um pecador que faça penitência do que por noventa e
          nove justos que não necessitem de fazer penitência. Ou, ainda, que
          mulher haverá que, possuindo dez dracmas, e, perdendo uma, não acende
          a candeia, varre a casa e procura a dracma com cuidado até achá-la? E,
          encontrando-a, não reúne as amigas e vizinhas, dizendo-lhes:
