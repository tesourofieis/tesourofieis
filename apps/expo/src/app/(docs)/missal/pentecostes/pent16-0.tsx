...
export default function PagePent160() {
  return (
    <div className="docs">
      <h1>Décimo Sexto Domingo depois de Pentecostes</h1>
      ...
      <div className="side-by-side">
        <p>
          ...
          invocántibus te. <em>Ps. ibid., 1</em> Inclína, Dómine, aurem tuam
          mihi, et exáudi me: quóniam inops, et pauper sum ego. ℣. Gloria
          Patri...
        </p>
        <p>
          ...
          invocam. <em>Sl. ibid., 1</em> Inclinai vossos ouvidos para mim,
          Senhor, e ouvi-me: pois sou necessitado, infeliz e pobre. ℣. Glória ao
          Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          corroborári per Spíritum ejus in interiórem hóminem, Christum habitáre
          ...
          longitúdo et sublímitas et profúndum: scire etiam supereminéntem
          sciéntiæ caritátem Christi, ut impleámini in omnem plenitúdinem Dei.
          Ei autem, qui potens est ómnia fácere superabundánter, quam pétimus
        ...
        <p>
          ...
          da sua glória sejais fortificados pelo seu Espírito e revestidos com a
          graça de homens interiores, para que Jesus Cristo habite pela fé nos
          vossos corações, e que, enraizados e imbuídos na caridade, possais
          compreender com todos seus santos a largura, o comprimento, a altura e
          a profundidade deste mystério, e conhecer o amor de Cristo, o qual
          ultrapassa toda a ciência, a fim de que sejais repletos da plenitude
          dos dons de Deus. Que Aquele que é poderoso, e que, por isso, pode
          fazer infinitamente mais do que Lhe pedimos, ou mesmo pensamos,
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          publicarão a vossa glória. ℣. Pois o Senhor edificou Sião, onde fará
          resplandecer a sua majestade.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 97, 1</em> Cantáte Dómino cánticum
          novum: quia mirabília fecit Dóminus. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 97, 1</em> Cantai em honra do Senhor um
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          ad illos, dixit: Cujus vestrum ásinus aut bos in púteum cadet, et non
          contínuo éxtrahet illum die sábbati? Et non póterant ad hæc respóndere
          illi. Dicebat autem et ad invitátos parábolam, inténdens, quómodo
          primos accúbitus elígerent, dicens ad illos: Cum invitátus fúeris ad
          núptias, non discúmbas in primo loco, ne forte honorátior te sit
          invitátus ab illo, et véniens is, qui te et illum vocávit, dicat tibi:
          Da huic locum: et tunc incípias cum rubóre novíssimum locum tenére.
          Sed cum vocátus fúeris, vade, recúmbe in novíssimo loco: ut, cum
        ...
        <p>
          ...
          tomou a palavra e perguntou aos doutores da Lei e aos fariseus: «É
          permitido curar os enfermos ao sábado?». Eles se calaram. E Jesus
          tocou neste homem, curou-o e mandou-o embora. Depois, dirigindo-se aos
          outros, continuou: «Qual é de vós aquele que, se o seu boi ou o seu
          jumento cai em um poço no dia de sábado, o não retira logo, mesmo
          nesse dia?». Eles não puderam responder-Lhe. Ainda Jesus, notando que
          os convivas escolhiam os principais lugares à mesa, disse: «Quando vos
          convidarem para assistirdes às bodas, não procureis o primeiro lugar,
          pois pode acontecer que, tendo sido convidada outra pessoa de maior
          dignidade do que vós, aquele que vos convidou diga: «Cedei o vosso
          lugar a este convidado». E, então, tereis de ir, cheios de vergonha,
          ocupar o último lugar. Pelo contrário, ide ocupar o último lugar, de
          modo que aquele que vos houver convidado diga: «Amigo, vinde para
