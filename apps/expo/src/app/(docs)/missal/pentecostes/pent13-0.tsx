...
export default function PagePent130() {
  return (
    <div className="docs">
      <h1>Décimo Terceiro Domingo depois de Pentecostes</h1>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. <em>Sl. 89, 1</em> De geração em geração, Senhor tendes sido o nosso refúgio. Aleluia.</p>
      </div>
...
S. Lucas.</p>
      <p>In illo témpore: Dum iret Jesus in Jerúsalem, transíbat per médiam Samaríam et Galilǽam. Et cum ingrederétur quoddam castéllum, occurrérunt ei decem viri leprósi, qui stetérunt a longe; et levavérunt vocem dicéntes: Jesu præcéptor, miserére nostri. Quos ut vidit, dixit: Ite, osténdite vos sacerdótibus. Et factum est, dum irent, mundáti sunt. Unus autem ex illis, ut vidit quia mundátus est, regréssus est, cum magna voce magníficans Deum, et cecidit in fáciem ante pedes ejus, grátias agens: et hic erat Samaritánus. Respóndens autem Jesus, dixit: Nonne decem mundáti sunt? et novem ubi sunt? Non est invéntus, qui redíret et daret glóriam Deo, nisi hic alienígena. Et ait illi: Surge, vade; quia fides tua te salvum fecit.</p>
      <p>Naquele tempo, indo Jesus para Jerusalém, atravessou a Samaria e a Galileia. Entrando, então, numa aldeia, foram ao seu encontro (ficando, contudo, a certa distância) dez leprosos, que clamavam: «Jesus, Mestre, tende misericórdia de nós!». Quando Jesus os viu, disse-lhes: «Ide e mostrai-vos aos sacerdotes». Enquanto eles iam, foram curados, Então um deles, vendo-se curado, voltou para trás, glorificando Deus em voz alta; e, prostrando-se com o rosto no chão, aos pés de Jesus, deu-Lhe graças! Este era samaritano. Jesus disse: «Porventura não foram os dez curados? Onde estão, pois, os outros nove? Não houve senão este estrangeiro que viesse e rendesse glória a Deus?». E, dirigindo-se a ele, acrescentou: «Levanta-te e vai: a tua fé te salvo.</p>
      </div>
