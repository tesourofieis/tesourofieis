    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Porque, ó Deus, nos repelistes para sempre? <em>Sl. ibid., 1</em>{" "}
          Porque, ó Deus, cresceu a vossa ira contra as ovelhas dos vossos
          pastos? ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          Lembrai-Vos, Senhor, da vossa aliança connosco e não esqueçais para
          sempre as almas dos vossos servos. ℣. Erguei-Vos, Senhor, julgai a
          vossa causa e lembrai-Vos dos opróbrios que sofreram os vossos servos.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 89, 1</em> Dómine, refúgium factus es
          nobis a generatióne et progénie. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 89, 1</em> De geração em geração, Senhor
