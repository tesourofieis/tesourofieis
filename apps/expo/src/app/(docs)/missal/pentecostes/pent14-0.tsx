...
export default function PagePent140() {
  return (
    <div className="docs">
      <h1>Décimo Quarto Domingo depois de Pentecostes</h1>
...
<div className="side-by-side">
      ...
      <p>Aleluia, aleluia. ℣. <em>Sl. 94, 1</em> Vinde, cantemos com alegria ao Senhor, exultemos jubilosamente em Deus, nosso Salvador. Aleluia.</p>
      </div>
