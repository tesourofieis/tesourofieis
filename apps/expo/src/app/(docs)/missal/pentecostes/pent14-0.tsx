    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 2-3</em> Quam dilécta tabernácula tua, Dómine virtútum!
        ...
        <p>
          ...
          outros lugares. <em>Sl. ibid., 2-3</em> Como são amáveis os vossos
          tabernáculos, Senhor dos exércitos! Minha alma suspira pelos átrios do
          Senhor e desfalece de saudade ao pensar neles. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          Bonum est confidére in Dómino, quam confidére in hómine. ℣. Bonum est
          speráre in Dómino, quam speráre in princípibus.
        </p>
        <p>
          É melhor confiar no Senhor do que nos homens. ℣. É melhor esperar em
          Deus do que nos príncipes.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 94, 1</em> Veníte, exsultémus Dómino,
          jubilémus Deo, salutári nostro. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 94, 1</em> Vinde, cantemos com alegria ao
