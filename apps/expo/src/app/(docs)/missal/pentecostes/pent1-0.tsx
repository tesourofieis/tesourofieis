...
export default function PagePent10() {
  return (
    <div className="docs">
      <h1>Domingo da Santíssima Trindade</h1>
...
<div className="side-by-side not-content">
      ...
      <p>Aleluia, aleluia. ℣. <em>ibid., 52</em> Bendito sois, Senhor, Deus de nossos pais, e digno de louvor em todos os séculos. Aleluia.</p>
      </div>
...
S. Mateus.</p>
      ...
      <p>Naquele tempo, disse Jesus aos discípulos: «Todo o poder me foi dado no céu e na terra. Ide, pois; ensinai todos os povos, baptizando-os em nome do Pai, e do Filho, e do Espírito Santo. Ensinai-os a observar tudo o que vos mandei. E sabei que estou convosco todos os dias até à consumação dos séculos».</p>
      </div>
