    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          nolíte inebriári vino, in quo est luxúria: sed implémini Spíritu
          Sancto, loquéntes vobismetípsis in psalmis et hymnis et cánticis
        ...
        <p>
          ...
          é a vontade de Deus. Não bebais vinho com excesso, o que é luxúria.
          Enchei-vos do Espírito Santo, entretendo-vos uns aos outros com
          Salmos, Hinos, cânticos espirituais e outros cânticos e louvores,
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          alimento em tempo conveniente. ℣. Abris as mãos e encheis de bênçãos
          tudo o que tem vida.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Ps. 107, 2</em> Parátum cor meum, Deus,
          parátum cor meum: cantábo, et psallam tibi, glória mea. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Sl. 107, 2</em> Meu coração está preparado, ó
          Deus; o meu coração está preparado: cantarei vossos louvores, ó Vós,
          que sois a minha glória. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          fílium ejus: incipiébat enim mori. Dixit ergo Jesus ad eum: Nisi signa
          et prodígia vidéritis, non créditis. Dicit ad eum régulus: Dómine,
          descénde, priúsquam moriátur fílius meus. Dicit ei Jesus: Vade, fílius
          tuus vivit. Crédidit homo sermóni, quem dixit ei Jesus, et ibat. Jam
          autem eo descendénte, servi occurrérunt ei et nuntiavérunt, dicéntes,
          quia fílius ejus víveret. Interrogábat ergo horam ab eis, in qua
        ...
        <p>
          ...
          principiava a agonizar. Disse-lhe Jesus: «Se não vedes prodígios e
          milagres não acreditais!». Respondeu-Lhe o oficial: «Senhor, vinde,
          antes que meu filho morra». Jesus disse-lhe: «Vai; o teu filho vive!».
          Acreditou este homem na palavra de Jesus e partiu. Ia já no caminho, e
          eis que seus servos foram ao seu encontro, anunciando-lhe que o filho
          vivia! Então perguntou-lhes qual a hora em que se achara melhor o
          filho. Os servos responderam: «Ontem, à hora sétima, deixou-o a
