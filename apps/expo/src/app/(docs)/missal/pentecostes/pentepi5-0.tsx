    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          obras, fazei-o em nome do Senhor Jesus Cristo, dando graças por Ele a
          Deus Pai.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          ...
          Então aproximaram-se os servos do pai de família e disseram-lhe:
          «Porventura não semeastes boa semente neste vosso campo? Donde lhe
          veio, pois, o joio?». Ele disse: «Foi o homem inimigo quem fez isto».
          E os servos retorquiram-lhe: «Quereis que vamos e colhamos o joio?».
          Ele disse: «Não, pois receio que, arrancando o joio, arranqueis também
          o trigo. Deixai crescer ambos até ao tempo da ceifa; e, então, direi
          aos ceifeiros: colhei primeiramente o joio e atai-o em molhos para
