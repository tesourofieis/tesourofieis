...
export default function PagePent10A() {
  return (
    <div className="docs">
      <h1>Primeiro Domingo depois de Pentecostes</h1>
...
<div className="side-by-side not-content">
      ...
      <p>Aleluia, aleluia. ℣. <em>Sl. 5, 2</em> Atendei às minhas palavras, Senhor! Ouvi o meu clamor. Aleluia.</p>
      </div>
