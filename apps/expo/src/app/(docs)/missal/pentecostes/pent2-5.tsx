    ...
    <div className="docs">
      ...
      <div className="side-by-side">
        <p>
          ...
          <em>Ps. ibid., 1</em> Exsultáte, justi, in Dómino: rectos decet
        ...
        <p>
          ...
          <em>Sl. ibid., 1</em> Exultai no Senhor, ó justos: Cantem seus
          louvores aqueles que possuem o coração recto. ℣. Glória ao Pai...
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          via. ℣. Díriget mansúetos in judício, docébit mites vias suas.
        </p>
        <p>
          O Senhor é bom e recto: eis porque dá uma lei aos delinquentes. ℣. Ele
          guia os pacíficos pela justiça e manifesta os seus caminhos aos
          humildes.
        </p>
        <p>
          Allelúja, allelúja. ℣. <em>Matth. 11, 29</em> Tóllite jugum meum super
        ...
        <p>
          ...
          aprendei de mim, que sou manso e humilde de Coração, e achareis paz
          para as vossas almas. Aleluia.
        </p>
      </div>
      ...
      <div className="side-by-side">
        <p>
          ...
          Non in perpétuum irascétur, neque in ætérnum comminábitur. ℣. Non
          secúndum peccáta nostra fecit nobis, neque secúndum iniquitátes
          nostras retríbuit nobis.
        </p>
        <p>
          O Senhor é terno e compassivo, compadecente e misericordiosíssimo: ℣.
          Não se irará perpetuamente, nem ameaçará eternamente. ℣. Não nos
      ...
      <div className="side-by-side">
        <p>
          Allelúja, allelúja. ℣. <em>Matth. 11, 29 et 28</em> Tóllite jugum meum
          super vos, et díscite a me, quia mitis sum et húmilis Corde: et
          inveniétis réquiem animábus vestris. Allelúja. ℣. Veníte ad me, omnes
          qui laborátis, et oneráti estis, et ego refíciam vos. Allelúja.
        </p>
        <p>
          Aleluia, aleluia. ℣. <em>Mt. 11, 29 et 28</em> Tomai o meu jugo sobre
          vós e aprendei de mim, que sou manso e humilde de Coração, e achareis
          paz para as vossas almas. Aleluia. ℣. Vinde a mim, vós todos, que
