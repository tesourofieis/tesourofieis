...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> E em todos seus habitantes.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Senhor Jesus Cristo, fazei entrar nesta casa, conduzido pelos passos do vosso humilde ministro, a felicidade eterna, a prosperidade divina, a alegria pura, a caridade fecunda e a saúde inalterável; fazei que os demónios fujam desta casa, não ousando mais entrar nela; fazei que os Anjos da paz aqui acorram e que toda a maligna discórdia seja expulsa. Fazei brilhar, Senhor, a grandeza do vosso Sacratíssimo Nome e abençoai <span className="cross text-red-500">✠</span> o nosso ministério. Santificai a nossa humilde entrada neste lugar santo, ó Vós, que sois a própria santidade e misericórdia e que permaneceis imutável com o Pai e com o Espírito Santo em todos os séculos dos séculos.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p>Orémus, et deprecémur Dóminum nostrum Jesum Christum, ut benedicéndo bene <span className="cross text-red-500">✠</span> dicat hoc tabernáculum, et omnes habitántes in eo, et det eis Angelum bonum custódem, et fáciat eos sibi servíre ad considerándum mirabília de lege sua: avértat ab eis omnes contrárias potestátes: erípiat eos ab omni formídine, et ab omni perturbatióne, ac sanos in hoc tabernáculo custodíre dignétur: Qui cum Patre et Spíritu Sancto vivit et regnat Deus in sæcula sæculórum.</p>
      <p>Pedimos e imploramos de nosso Senhor Jesus Cristo, que encha com suas bênçãos <span className="cross text-red-500">✠</span> esta casa e todos aqueles que nela habitam; que lhes envie o seu Anjo para os guardar cuidadosamente; que os una ao seu serviço e os faça considerar nas maravilhas da sua Lei; que afaste deles todas as forças inimigas; que os livre de qualquer perturbação ou terror e que se digne conservá-los sãos e salvos nesta morada: Ele, que, sendo Deus, vive e...</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Ouvi-nos, Senhor santo, Pai omnipotente, Deus eterno, e dignai-Vos mandar do céu o vosso Santo Anjo, para que guarde, sustente, proteja, visite e defenda todos aqueles que se encontram nesta morada. Por Cristo Senhor nosso.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> Cristo, tende piedade.</p>
      <p>℣. Kýrie eléson.</p>
      <p>℣. Senhor, tende piedade.</p>
      <p>Pater noster <em>secreto usque ad</em> Pai Nosso <em>Em silêncio até</em></p>
      ...
      <p><span className="text-red-500">℟.</span> Deus meus, sperántem in te.</p>
      <p><span className="text-red-500">℟.</span> Que em Vós espera.</p>
      <p>℣. Mitte ei, Dómine, auxílium de sancto.</p>
      <p>℣. Enviai-lhe, Senhor, do vosso santuário o vosso auxílio.</p>
      <p><span className="text-red-500">℟.</span> Et de Sion tuére eum (eam).</p>
      <p><span className="text-red-500">℟.</span> E protejei-o lá de Sião.</p>
      ...
      <p><span className="text-red-500">℟.</span> Et fílius iniquitátis non appónat nocére ei.</p>
      <p><span className="text-red-500">℟.</span> E que o Filho da iniquidade não possa prejudicá-lo.</p>
      <p>℣. Dómine, exáudi oratiónem meam.</p>
      <p>℣. Senhor, ouvi a minha oração.</p>
      <p><span className="text-red-500">℟.</span> Et clamor meus ad te véniat.</p>
      <p><span className="text-red-500">℟.</span> E que meu clamor chegue até Vós.</p>
...
<div className="side-by-side not-content">
      ...
      <p>Vos suplicamos, Senhor, olhai benigno para o vosso servo <span className="text-red-500">N.</span>, que sucumbe sob a enfermidade do seu corpo, e reanimai esta alma que criastes, a fim de que, curado dos castigos que sofreu, reconheça que não deve a salvação senão aos remédios da vossa graça. Por nosso Senhor...</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Senhor santo, Pai omnipotente, Deus eterno, que infundis nos corpos dos enfermos a graça das vossas bênçãos e que rodeais as criaturas com os incessantes cuidados da vossa bondade, atendei benigno à invocação que fazemos do vosso santo Nome; e, depois de haverdes curado da doença e restituído a saúde ao vosso servo, erguei-o com vossa dextra, fortalecei-o com vossa robustez, protegei-o com vosso poder e restituí-o à Santa Igreja, havendo atendido a todos seus desejos.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      </div>
