...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> Senhor, eu não sou digno de que entreis na minha morada, mas dizei uma só palavra e a minha alma será salva.</p>
      <p>Accípe frater (soror), Viaticum Córporis Dómini nostri Jesu Christi, qui te custódiat ab hoste malígno, et perdúcate in vitam ætérnam.</p>
      <p>Recebei, meu irmão (ou minha irmã), o Viático do Corpo de Nosso Senhor Jesus Cristo, a fim de que vos guie até à vida eterna.</p>
...
<div className="side-by-side not-content">
      ...
      <p>Senhor santo, Pai omnipotente, Deus eterno, Vos rogamos com confiança que o Corpo Santíssimo de nosso Senhor, que o nosso irmão (ou irmã) acaba de receber, lhe seja remédio eficaz, tanto para a sua alma como para o seu corpo, a fim de que lhe sirva para a eternidade: Ele, que, sendo Deus, convosco vive e reina por todos os séculos dos séculos.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      </div>
