...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> A Fé.</p>
      <p><em>Sac.</em> Fides, quid tibi præstat?</p>
      <p><em>Sac.</em> Para que te serve a Fé?</p>
      <p><span className="text-red-500">℟.</span> Vitam ætérnam.</p>
      <p><span className="text-red-500">℟.</span> Para alcançar a vida eterna.</p>
      <p><em>Sac.</em> Si ígitur vis ad vitam íngredi, serva mandáta. Díliges Dóminum Deum tuum ex toto corde tuo, et ex tota ánima tua, et ex tota mente tua, et próximum tuum sicut teípsum.</p>
      <p><em>Sac.</em> Se, portanto, queres alcançar a vida eterna, observa os Mandamentos.  Amarás o Senhor, teu Deus, com todo teu coração, com toda tua alma e com toda tua inteligência, e amarás o próximo como a ti próprio.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Pela vossa clemência, Vos suplicamos, Senhor, dignai-Vos ouvir as nossas preces; e com vosso poder guardai sempre este vosso escolhido <span className="text-red-500">N.</span> (ou esta vossa escolhida <span className="text-red-500">N.</span>) que acaba de ser assinalado (a) com a Cruz do Senhor, a fim de que, conservando as primeiras instruções da vossa infinita glória, possa alcançar a glória da regeneração pela prática dos vossos Mandamentos. Por Cristo, nosso Senhor.</p>
...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><em>Sac.</em> Pax tecum.</p>
      <p><em>Sac.</em> A paz seja contigo.</p>
...
<div className="side-by-side not-content">
      ...
      <p>Deus de nossos pais, ó Deus, Autor de toda a verdade, Vos pedimos e suplicamos que Vos digneis olhar benignamente para o vosso servo <span className="text-red-500">N.</span> (para a vossa serva <span className="text-red-500">N.</span>) que, que havendo provado pela primeira vez este sal, não sofra por mais tempo fome, antes permiti que seja sustentado (a) com o alimento celestial, conservando-se sempre ao serviço do vosso Nome, animado (a) com constante fervor espiritual e alegre esperança. Conduzi-o (a), Senhor, Vos suplicamos, à fonte da regeneração, para que consiga alcançar com os demais fiéis as recompensas eternas por Vós prometidas. Por Cristo, nosso Senhor.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Senhor santo, Pai omnipotente, Deus eterno, autor da luz e da verdade, imploro a vossa eterna e justíssima bondade em favor deste vosso servo (ou serva) <span className="text-red-500">N.</span>, a fim de que Vos digneis ilustrá-lo (ou ilustrá-la) com a luz da vossa inteligência, purificá-lo (ou purificá-la) e santificá-lo (ou santificá-la). Concedei-lhe, Senhor, a verdadeira ciência, para que, tornando-se digno (ou digna) da graça do Baptismo, conserve sempre uma esperança bem firme, um conselho bem recto e doutrina santa.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> Renuncio!</p>
      <p><em>Sac.</em> Et ómnibus opéribus ejus?</p>
      <p><em>Sac.</em> E a todas suas obras?</p>
      <p><span className="text-red-500">℟.</span> Abrenúntio.</p>
      <p><span className="text-red-500">℟.</span> Renuncio!</p>
      <p><em>Sac.</em> Et ómnibus pompis ejus?</p>
      <p><em>Sac.</em> E a todas suas seduções?</p>
      <p><span className="text-red-500">℟.</span> Abrenúntio.</p>
      <p><span className="text-red-500">℟.</span> Renuncio!</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> Creio.</p>
      <p><em>Sac.</em> Credis in Jesum Christum, Fílium ejus únicum, Dóminum nostrum, natum, et passum?</p>
      <p><em>Sac.</em> Crês em Jesus Cristo, seu Filho único, nosso Senhor, que nasceu e padeceu?</p>
      <p><span className="text-red-500">℟.</span> Credo.</p>
      <p><span className="text-red-500">℟.</span> Creio.</p>
      <p><em>Sac.</em> Credis et in Spíritum Sanctum, sanctam Ecclésiam cathólicam, Sanctórum communiónem, remissiónem peccatórum, carnis resurrectiónem, et vitam ætérnam?</p>
      <p><em>Sac.</em> Crês no Espírito Santo, na Santa Igreja Católica, na comunicação dos Santos, na remissão dos pecados, na ressurreição da carne e na vida eterna?</p>
      <p><span className="text-red-500">℟.</span> Credo.</p>
      <p><span className="text-red-500">℟.</span> Creio.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟.</span> Quero.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p>Que o Deus omnipotente, Pai de nosso Senhor Jesus Cristo, que te regenerou pela água e pelo Espírito Santo e te concedeu a graça da remissão de todos os pecados, te unja Ele próprio com o Crisma da salvação <span className="cross text-red-500">✠</span> para a vida eterna, em o mesmo nosso Senhor Jesus Cristo.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><span className="text-red-500">℟.</span> Amen.</p>
      <p><em>Sac.</em> Pax tibi.</p>
      <p><em>Sac.</em> A paz seja contigo.</p>
      <p><span className="text-red-500">℟.</span> Et cum spíritu tuo.</p>
      <p><span className="text-red-500">℟.</span> E com vosso espírito.</p>
      </div>
