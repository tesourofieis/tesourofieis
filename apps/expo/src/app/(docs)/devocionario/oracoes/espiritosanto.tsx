...
<div className="side-by-side">
      ...
      <p><span className="text-red-500">℟.</span> Et renovábis faciem terræ.</p>
      <p><span className="text-red-500">℟.</span> E renovareis a face da terra.</p>
      <p><span className="text-red-500 text-center">Orémus.</span></p>
      <p><span className="text-red-500 text-center">Oremos.</span></p>
      <p>Deus, qui corda fidélium Sancti Spíritus illustratióne docuísti, da nobis in eódem Spíritu recta sápere; et de ejus semper consola Tione gaudére. Per Christum Dóminum nostrum. <span className="text-red-500">℟.</span> Amen.</p>
      <p>Ó Deus, que haveis instruído os corações dos vossos fiéis com a luz do Espírito Santo, concedei-nos, segundo o mesmo Espírito, conhecer as coisas rectas e gozar sempre das suas divinas consolações. Por Cristo, Senhor Nosso. <span className="text-red-500">℟.</span> Amen.</p>
      </div>
...
<div className="side-by-side">
      ...
      <p>Vinde, ó pai dos pobres; vinde, doador dos dons, vinde, luz dos corações.</p>
      ...
      <p>Lava quod est sórdidum, riga quod est áridum, sana quod est sáucium.</p>
      <p>Lavai, pois, o que está sujo, regai o que está seco, curai o que está doente.</p>
      <p>Flecte quod est rígidum, fove quod est frígidum, rege quod est dévium.</p>
      <p>Dobrai o que é rígido, aquecei o que está frio, guiai o que está errante.</p>
