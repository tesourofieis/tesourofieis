...
export default function PageViasacra() {
  return (
    <div className="docs">
      ...
      coração, contrito, porque sois inocente e vais sofrer por nós, que somos
      ...
      <em>in libertatem gloriæ filiorum Dei</em> (na liberdade e glória dos
      filhos de Deus.).
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟. </span>Quia per Crucem tuam
          redemísti mundum.
        </p>
        <p>
          <span className="text-red-500">℟. </span>Porque pela vossa Santa Cruz
          redimistes o mundo.
        </p>
      </div>
      ...
      <div className="side-by-side">
        ...
        <p>
          <span className="text-red-500">℟. </span>Miserére nostri.
        </p>
        <p>
          <span className="text-red-500">℟. </span>Tende piedade de nós.
        </p>
      </div>
      <aside>
      ...
      Pilatos, que por instigação dos judeus O condena à morte. E Jesus, que
      quere padecer e morrer para nos provar o seu amor e livrar-nos do Inferno,
      ...
      açoites, a pesadíssima Cruz em que vai ser crucificado para nos salvar! Ó
      ...
      dor corre pare Ele através da multidão, que cruelmente O escarnece e se
      ...
      se mexe; já não pode caminhar; e os algozes, temendo que morra antes de
      ser crucificado, intimam Simão Cireneu a que O ajude!... Ó
      ...
      rosto do suor e sangue que Lhe toldavam a vista!... Ó misericordiosíssimo
      ...
      que O insulta e Lhe escarra no rosto. Os algozes, impacientes por chegarem
      ao Calvário, violentamente O levantam, descarregando-lhe murros e
      ...
      Filhas de Jerusalém, não choreis sobre Mim; chorai sobre vós mesmas e
      sobre vosso filhos!... Ó misericordiosíssimo Jesus, dai-nos lágrimas de
      ...
      empurrões e pancadas que Lhe dão os algozes, cai desamparado e chegar a
      tocar a terra com sua santíssima boca!... Ó misericordiosíssimo Jesus,
      ...
      fazendo-o tremer com dores!... Ó misericordiosíssimo Jesus, despojai-nos
      ...
      último suspiro!... Ó clementíssimo Jesus, que Vos abrasais em ardente amor
      pelas almas, eu Vos suplico pela agonia do vosso Santíssimo coração e
      pelas dores de vossa Mãe Imaculada, que purifiqueis no vosso Sangue todos
      ...
      que, banhada em lágrimas, beija e abraça o corpo deseu Filho, denegrido
      com pancadas e coberto de feridas, e algumas tão profundas que deixam ver
      os seus ossos!... Ó Santa Mãe das dores, rogai a Jesus que nos perdoe os
      pecados, nos ajude a imitar as vossas virtudes, nos conceda a graça da
      perseverança final e nos purifique com seu precioso Sangue, para podermos
      ...
      amor, fazei que eu sinta as vossas fortes dores e convosco chore. Pai
      eterno, misericórdia, pelo precioso sangue de Jesus.
      <h2>Oração final</h2>
      <aside>
