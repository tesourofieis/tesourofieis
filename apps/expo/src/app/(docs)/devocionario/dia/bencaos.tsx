...
<div className="side-by-side not-content">
      ...
      <p>℣. Louvado seja Jesus Cristo.</p>
      <p><span className="text-red-500">℟. </span>In æternum.</p>
      <p><span className="text-red-500">℟. </span>Sempre seja louvado.</p>
...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟. </span>Amen.</p>
      <p><span className="text-red-500">℟. </span>Amen.</p>
      <p>℣. Bénedic, Dómine, nos et hæc tua dona quæ de tua largitáte sumus sumptúri. Per Christum Dóminum nostrum.</p>
      <p>℣. Abençoai-nos, Senhor, e a estes alimentos que da vossa generosidade recebemos. Por Cristo Senhor Nosso.</p>
      <p><span className="text-red-500">℟. </span>Amen.</p>
      <p><span className="text-red-500">℟. </span>Amen.</p>
      </div>
...
<div className="side-by-side not-content">
      ...
      <p><span className="text-red-500">℟. </span>Amen.</p>
      <p><span className="text-red-500">℟. </span>Amen.</p>
      <p>℣. Ágimus tibi grátias, omnipotens Deus, pro universis beneficiis tuis, qui vivis et regnas in sǽcula sæculórum.</p>
      <p>℣. Senhor, nós Vos damos graças pelo alimento que nos destes; fazei-nos dignos de participar da vossa mesa celeste.</p>
      <p><span className="text-red-500">℟. </span>Amen.</p>
      <p><span className="text-red-500">℟. </span>Amen.</p>
      </div>
