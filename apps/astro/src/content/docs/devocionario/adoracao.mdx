...
<span class="text-red-600">℟.</span> Miserere nobis.

<span class="text-red-600">℟.</span> Tende misericórdia de nós.
...
<span class="text-red-600">℟.</span> Omne delectaméntum in se habéntem. (T. P. Aleluia)

<span class="text-red-600">℟.</span> O qual encerra em si toda a doçura. (T. P. Aleluia)
