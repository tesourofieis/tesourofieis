...
<span class="text-accent-600">℟.</span> Senhor, socorrei-nos e salvai-nos.

℣. Glória Patri, et Fílio, et Spirítui Sancto.

℣. Glória ao Pai, e ao Filho e ao Espírito Santo.

<span class="text-accent-600">℟.</span> Sicut erat in princípio, et nunc, et
semper, et in sǽcula sæculórum. Amen.

<span class="text-accent-600">℟.</span> Assim como era no princípio, agora e
...
<span class="text-accent-600">℟.</span> Ut digni efficiamur promissionibus Eius.

<span class="text-accent-600">℟.</span> Para que sejamos dignos das Suas promessas.
