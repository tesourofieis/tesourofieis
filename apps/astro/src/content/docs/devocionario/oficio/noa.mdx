...
import Salmo125 from "./../salterio/125.mdx";
...
<span class="text-accent-600">℟.</span> Dei Génetrix, intercéde pro nobis.

<span class="text-accent-600">℟.</span> Intercedei por nós, ó Mãe de Deus.
