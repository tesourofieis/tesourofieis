...
<span class="cross text-accent-600">✠</span> In nómine Patris, et Fílii, et Spíritus Sancti.

<span class="cross text-accent-600">✠</span> Em nome do Pai e do Filho e do Espírito Santo.
...
<span class="text-accent-600">℟.</span> Ora pro nobis, qui confugimus ad te.

<span class="text-accent-600">℟.</span> Rogai por nós que recorremos a vós.
...
<span class="text-accent-600">℟.</span> Conduc in cælum omnes animas, præsértim illas quæ máxime indigent misericórdia tua.

<span class="text-accent-600">℟.</span> Levai as alminhas todas para o Céu e socorrei principalmente as que mais precisarem.
...
<span class="text-accent-600">℟.</span> Ut digni efficiámur promissiónibus Christi.
