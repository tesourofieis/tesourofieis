...
<span class="text-accent-600">℟.</span> Sicut erat in princípio, et nunc, et semper, et in sǽcula sæculórum. Amen.
...
<span class="text-accent-600">℟.</span> Et renovábis faciem terræ.

<span class="text-accent-600">℟.</span> E renovareis a face da terra.
