...
<div>
  ...
  <div className="flex items-center justify-center gap-5">
    <LinkButton
      ...
      variant="primary"
    >
      <svg class="fill-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height="20px" width="20px">
    ...
    <LinkButton
      ...
      variant="primary"
    >
      <svg class="text-sepia-500 fill-sepia-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="20px" width="20px">
