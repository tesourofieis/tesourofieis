...
<aside>
  ...
  festa da Assunção, como a consequência lógica do privilégio da
  Imaculada Conceição e do Mistério da Encarnação. O pecado jamais tendo
  atingido a alma de Maria, convinha ao seu corpo, isento de toda mancha
  e no qual o Verbo se encarnara, não passar pela corrupção do túmulo.
</aside>
