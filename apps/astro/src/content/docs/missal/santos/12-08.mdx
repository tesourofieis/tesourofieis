...
<aside>
  ...
  das almas. Introdutora de seu Filho, Ela é a primeira a apresentar-se no Cyclo
  Litúrgico. Peçamos a Deus «a cura e libertação de todas as faltas» (Secr.,
  Postcomúnio), para que, recebendo a virtude própria da festa da Imaculada,
  sejamos mais dignos de receber a Jesus quando Ele vier em nossos corações, a
  25 de Dezembro.
</aside>
