  ...
  expect(proper).toMatchObject([
    {
      ...
      sections: [
        ...
        },
        {
          ...
          id: "Prelude(rubrica 1570 aut rubrica divino)",
        },
        {
          body: {
            latin: [
              "Finita Tertia, Sacerdos indutus Pluviali violaceo, vel sine Casula, cum Ministris similiter indutis, procedit ad benedicendum Candelas, in medio ante Altare vel ad cornu Epistolæ positas, et ipse, ibidem stans versus ad Altare, dicit manibus junctis in tono Orationis Missæ ferialis:",
              "℣. Dóminus vobíscum.",
              "℟. Et cum spíritu tuo.",
              ...
              "Finita Processione, Celebrans et Ministri, depositis violaceis, accipiunt paramenta alba pro Missa. Et Candelæ tenentur in manibus accensæ, dum legitur Evangelium, et iterum ab incepto Canone usque ad expletam Communionem.",
              "Hodie prohibetur quælibet Missa votiva, etiam sollemnis, de Christo Domino.",
              "",
            ],
            vernacular: [
              "Se a bênção das velas e a procissão não poderem ser feitas na sua forma solene, devido à ausência de ministros sagrados, é aceitável fazer-se da forma simples, até sem canto, desde que pelo menos três acólitos assistam o celebrante. O celebrante paramenta-se com capa branca ou sem casula, e segue com os ministros que se vestem similarmente para abençoar as velas, que são colocadas no centro do altar ou no lado da epístola. Em pé, de frente para o altar, o padre canta sem entoação, com as mão unidas:",
              ...
              'Repete-se a Ant. "A luz que iluminará..."',
              "Ant. A luz que iluminará as nações e a glória de Israel, vosso povo.",
              ...
              "",
              "",
              "Se existir procissão, primeiro, o celebrante coloca incenso turíbulo, depois o diácono vira-se para o povo e diz:",
              "℣. Caminhemos em paz.",
