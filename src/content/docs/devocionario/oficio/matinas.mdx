...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="col-6 text-justify">
    <span class="text-danger">R.</span> E a minha boca anunciará o vosso louvor.
  </span>
  <span class="col-6 text-justify">
...
<div class="grid grid-cols-2 gap-5">
  <span class="col-6 text-justify">Laus tibi, Domine, Rex æternæ gloriæ.</span>
  <span class="col-6 text-justify">
...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="col-6 text-justify">Dominus tecum.</span>
  <span class="col-6 text-justify">O Senhor é convosco.</span>
  <span class="col-6 text-justify">
...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="col-6 text-justify">Pater Noster (secreto usque ad).</span>
  <span class="col-6 text-justify">Pai Nosso (em silêncio).</span>
  <span class="col-6 text-justify">V. Et ne nos inducas in tentationem.</span>
  <span class="col-6 text-justify">V. E nos não deixeis cair em tentação.</span>
  <span class="col-6 text-justify">
...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="col-6 text-justify">V. Jube, Domine, benedicere.</span>
  <span class="col-6 text-justify">V. Dai-me, Senhor, a vossa bênção.</span>
</div>
...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="col-6 text-justify">V. Tu autem, Dómine, miserére nobis.</span>
  <span class="col-6 text-justify">
  ...
  <span class="col-6 text-justify">
    <span class="text-danger">R.</span> Sancta et immaculáta virginitas, quibus
  ...
  <span class="col-6 text-justify">
    <span class="text-danger">R.</span> Quia quem cæli cápere non póterant, tuo
    gremio contulisti.
  </span>
  <span class="col-6 text-justify">
    <span class="text-danger">R.</span> Porque encerrastes no vosso seio Aquele
    a quem os céus não podiam abranger.
  </span>
  <span class="col-6 text-justify">V. Iube domne benedicere.</span>
  <span class="col-6 text-justify">V. Dai-me, Senhor, a vossa bênção.</span>
  <span class="col-6 text-justify">
...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="col-6 text-justify">
    <span class="text-danger">R.</span> Bem-aventurada sois, ó Virgem Maria, que
  ...
  <span class="col-6 text-justify">
    <span class="text-danger">R.</span> Gerastes O que vos deu o ser, e ficastes
    para sempre Virgem.
  </span>
</div>
...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="text-justify">
    <span class="text-danger">R.</span> Ave, María, grátia plena; Dóminus tecum:
...
<div class="grid grid-cols-2 gap-5">
  <span class="text-justify">
    <span class="text-danger">R.</span> Súscipe verbum, Virgo María, quod tibi a
