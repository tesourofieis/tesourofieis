...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="text-justify">V. Jube, Domine, benedicere.</div>
...
<div class="grid grid-cols-2 gap-5">
  <span class="text-justify">Nos cum prole pia benedicat Virgo Maria.</div>
  <span class="text-justify">
...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="text-justify">V. Tu autem, Dómine, miserére nobis.</div>
  <span class="text-justify">
    V. E vós, Senhor, tende misericórdia de nós.
  </div>
  <span class="text-justify">
  ...
  <span class="text-justify">V. Iube domne benedicere.</div>
  <span class="text-justify">V. Dai-me, ó Senhor, a vossa bênção.</div>
  <span class="text-justify">
    Ipsa Virgo Vírginum intercédat pro nobis ad Dóminum.
  </div>
  <span class="text-justify">
