...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="text-justify">V. Ora pro nobis, beate Antoni.</span>
  <span class="text-justify">V. Rogai por nós, bem-aventurado António.</span>
  <span class="text-justify">
    <span class="text-red-500">R.</span> Ut digni efficiamur promissionibus
    Christi.
  </span>
  <span class="text-justify">
