...
<div class="grid grid-cols-2 gap-5">
  ...
  <span class="text-justify">
    <span class="text-red-500">R. </span>Quia per Crucem tuam redemísti mundum.
  </span>
  <span class="text-justify">
    <span class="text-red-500">R. </span>Porque pela vossa Santa Cruz redimistes
    o mundo.
  </span>
</div>
...
<div class="grid grid-cols-2 gap-5">
  <span class="text-justify">V. Miserére nostri, Dómine.</span>
  <span class="text-justify">V. Senhor tende piedade de nós.</span>
  <span class="text-justify">
    <span class="text-red-500">R. </span>Miserére nostri.
  </span>
  <span class="text-justify">
    <span class="text-red-500">R. </span>Tende piedade de nós.
  </span>
</div>
