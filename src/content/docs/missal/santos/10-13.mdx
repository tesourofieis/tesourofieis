...
<div class="container-fluid">
  <div class="row">
    <div class="col-6 dropcaps text-justify">
      ...
      regnáre póssimus in cœlis. Per Dóminum <em>&c.</em>
    </div>
    <div class="col-6 dropcaps text-justify">
      Ó Deus, que coroastes com a glória eterna o B. Rei Eduardo, vosso
      Confessor, fazei, Vos suplicamos, que o veneremos de tal modo na terra que
      com ele possamos reinar no céu. Por nosso Senhor <em>&c.</em>
    </div>
  </div>
</div>
