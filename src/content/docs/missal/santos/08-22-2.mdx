...
<div class="container-fluid">
  <div class="row">
    <div class="col-6 dropcaps text-justify">
      ...
      intercedéntibus beátis Martýribus tuis Timótheo, Hippolýto et Symphoriáno,
      déxteram super nos tuæ propitiatiónis exténde. Per Dóminum <em>&c.</em>
    </div>
    <div class="col-6 dropcaps text-justify">
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-6 dropcaps text-justify">
      ...
      Hipólito e Sinforiano, que participemos sempre dele durante toda nossa
      vida. Por nosso <em>&c.</em>
    </div>
  </div>
</div>
