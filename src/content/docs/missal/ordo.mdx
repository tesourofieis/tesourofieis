...
export const calendar = getCalendarDay(yyyyMMDD(new Date()));
...
<span class="text-red-500">℟.</span> Quia tu es, Deus, fortitudo mea: quare me reppulísti,
et quare tristis incédo, dum afflígit me inimícus?

<span class="text-red-500">℟.</span> Pois que Vós, ó Deus, sois a minha fortaleza,
...
<span class="text-red-500">℟.</span> E irei até ao Altar de Deus; até Deus, que é
...
<span class="text-red-500">℟.</span> Spera in Deo, quóniam adhuc confitébor illi:
salutáre vultus mei, et Deus meus.

<span class="text-red-500">℟.</span> Confia em Deus, pois ainda O louvarei. Ele é
...
<span class="text-red-500">℟.</span> Sicut erat in princípio, et nunc, et semper:
et in sǽcula sæculórum. Amen.

<span class="text-red-500">℟.</span> Assim como era no princípio, e agora, e sempre,
...
<span class="text-red-500">℟.</span> Misereátur vestri omnípotens Deus, et, dimíssis
peccátis vestris, perdúcat vos ad vitam ætérnam.

<span class="text-red-500">℟.</span> Compadeça-se de vós o Senhor omnipotente; vos
...
<span class="text-red-500">℟.</span> Confíteor Deo omnipoténti, beátæ Maríæ semper
...
<LinkCard
  link={`/${calendar.celebration[0]?.link}#oração`}
  title={calendar.celebration[0]?.title}
  caption={calendar.commemoration[0]?.title}
  description={calendar.tempora[0].title}
/>
...
<LinkCard
  link={`/${calendar.celebration[0]?.link}#epístola`}
  title={calendar.celebration[0]?.title}
  caption={calendar.commemoration[0]?.title}
  description={calendar.tempora[0].title}
/>
...
<LinkCard
  link={`/${calendar.celebration[0]?.link}#gradual`}
  title={calendar.celebration[0]?.title}
  caption={calendar.commemoration[0]?.title}
  description={calendar.tempora[0].title}
/>
...
<LinkCard
  link={`/${calendar.celebration[0]?.link}#evangelho`}
  title={calendar.celebration[0]?.title}
  caption={calendar.commemoration[0]?.title}
  description={calendar.tempora[0].title}
/>
...
<LinkCard
  link={`/${calendar.celebration[0]?.link}#ofertório`}
  title={calendar.celebration[0]?.title}
  caption={calendar.commemoration[0]?.title}
  description={calendar.tempora[0].title}
/>
...
<span class="text-red-500">℟.</span> Que o Senhor acenda em nós o fogo do seu amor
...
<span class="text-red-500">℟.</span> Suscípiat Dóminus sacrifícium de mánibus tuis
ad laudem et glóriam nominis sui, ad utilitátem quoque nostram, totiúsque Ecclésiæ
suæ sanctæ.

<span class="text-red-500">℟.</span> Que o Senhor receba por vossas mãos este sacrifício
...
<LinkCard
  link={`/${calendar.celebration[0]?.link}#secreta`}
  title={calendar.celebration[0]?.title}
  caption={calendar.commemoration[0]?.title}
  description={calendar.tempora[0].title}
/>
...
import { LinkCard as Link } from "@astrojs/starlight/components";

<Link href="/missal/prefacios" description="Prefácios" />
...
<span class="text-red-500">℟.</span> Dómine, non sum dignus, ut intres sub tectum
meum: sed tantum dic verbo, et sanábitur ánima mea.

<span class="text-red-500">℟.</span> Senhor, eu não sou digno de que entreis na minha
...
<LinkCard
  link={`/${calendar.celebration[0]?.link}#comúnio`}
  title={calendar.celebration[0]?.title}
  caption={calendar.commemoration[0]?.title}
  description={calendar.tempora[0].title}
/>
...
<LinkCard
  link={`/${calendar.celebration[0]?.link}#postcomúnio`}
  title={calendar.celebration[0]?.title}
  caption={calendar.commemoration[0]?.title}
  description={calendar.tempora[0].title}
/>
...
<span class="cross text-red-500">✠</span> Princípio do santo Evangelho segundo S.
João.
