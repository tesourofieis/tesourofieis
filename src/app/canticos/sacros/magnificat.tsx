  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Quia respéxit humilitátem ancíllæ suæ: * ecce enim ex hoc beátam me dicent omnes
          generatiónes.
        </Typography>
        <Typography className="vernacular">
          Visto que Ele olhou para a humildade da sua serva: * desde agora todas as gerações me
        ...
        <Typography className="vernacular">
          Manifestou-se o poder doseu braço: * dispersou os soberbos, cujo coração é cheio de
          orgulho.
        </Typography>
        <Typography className="latin">
