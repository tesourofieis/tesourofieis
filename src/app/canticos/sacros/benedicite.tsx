  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Benedícite, aquæ omnes, quæ super cœlos sunt, Dómino: benedícite, omnes virtútes Dómini,
          Dómino.
        </Typography>
        <Typography className="vernacular">
          Águas todas, que estai nos espaços celestiais, bendizei o Senhor; bendizei o Senhor, todos
        ...
        <Typography className="vernacular">
          Ó montes e colinas, bendizei o Senhor; ó todos os seres, que germinais na terra, bendizei
          o Senhor.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Benedícite, cete, et ómnia, quæ movéntur in aquis, Dómino: benedícite, omnes vólucres
          cœli, Dómino.
        </Typography>
        <Typography className="vernacular">
          Peixes e todos os entes, que vos moveis nas águas, bendizei o Senhor; aves do céu,
        ...
        <Typography className="latin">
          Benedícite, spíritus, et ánimæ justórum, Dómino: benedÌcite, sancti, et húmiles corde,
          Dómino.
        </Typography>
        <Typography className="vernacular">
          Bendizei o Senhor, ó espíritos e almas dos justos; bendizei o Senhor, ó santos e humildes
          de coração.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Bendigamos o Pai, e o Filho, assim como o Espírito Santo: louvemo-l’O e aclamemo-l’O em
          todos os séculos.
        </Typography>
        <Typography className="latin">
          Benedíctus es, Dómine, in firmaménto cœli: et laudábilis, et gloriósus, et superexaltátus
          in sǽcula.
        </Typography>
        <Typography className="vernacular">
          Bendito sois, Senhor, no firmamento do céu, e digno de ser louvado e aclamado em todos os
          séculos.
        </Typography>
      </Language>
    </PageWrapper>
