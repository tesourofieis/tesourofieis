  ...
  return (
    <PageWrapper>
      ...
      <View className="not-content">
        ...
        <Typography className="vernacular">
          Achou logo a Pátria Remédio ao seu mal; E a Virgem bendita Salvou Portugal.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          À Virgem bendita, Cante seu louvor, Toda a nossa terra, Um hino de amor.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Avé, Virgem Santa, Estrela que nos guia, Avé, Mãe da Pátria. Oh! Virgem Maria!
        </Typography>
      </View>
    </PageWrapper>
  );
