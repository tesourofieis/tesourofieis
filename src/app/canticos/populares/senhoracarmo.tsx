  ...
  return (
    <PageWrapper>
      ...
      <View className="not-content">
        ...
        <Typography className="vernacular">
          Senhora do Carmo Mandou-me um recado Que reze três vêzes Bendito e louvado.
        </Typography>
        <Typography className="vernacular">
          Bendito e louvado Eu hei-de rezar Senhora do Carmo Me há-de ajudar.
        </Typography>
        <Typography className="vernacular">
          No Céu três mesuras Ao peso da Cruz; reza-se três vêzes Salvai-me Jesus!... Salvai-me
          Jesus!... Salvai-me Jesus!...
        </Typography>
      </View>
    </PageWrapper>
  );
