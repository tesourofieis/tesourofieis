  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Non est sánitas in carne mea a fácie iræ tuæ: * non est pax óssibus meis a fácie
          peccatórum meórum.
        </Typography>
        <Typography className="vernacular">
          Não há parte sã na minha carne devido à vossa ira: * não há paz nos meus ossos, à face dos
          meus pecados.
        </Typography>
        <Typography className="latin">
          Quóniam iniquitátes meæ supergréssæ sunt caput meum: * et sicut onus grave gravátæ sunt
          super me.
        </Typography>
        <Typography className="vernacular">
          Porque as minhas iniquidades se elevaram acima da minha cabeça: * e me esmagam como uma
          pesada carga.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Porque as minhas entranhas estão cheias de ilusões: * e não há parte alguma sã na minha
          carne.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Cor meum conturbátum est, derelíquit me virtus mea: * et lumen oculórum meórum, et ipsum
          non est mecum.
        </Typography>
        <Typography className="vernacular">
          Meu coração está abalado, a minha força desamparou-me: * e a própria luz dos meus olhos
          comigo já não está.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Quia dixi: nequándo supergáudeant mihi inimíci mei: * et dum commovéntur pedes mei, super
          me magna locúti sunt.
        </Typography>
        <Typography className="vernacular">
          Pois disse: nunca triunfem sobre mim os meus inimigos: * eles que, tendo visto os meus pés
          vacilantes, falaram de mim insolentemente.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Inimíci autem mei vivunt, et confirmáti sunt super me: * et multiplicáti sunt qui odérunt
          me iníque.
        </Typography>
        <Typography className="vernacular">
          Meus inimigos vivem e têm-se tornado mais fortes do que eu: * e os que injustamente me
          odeiam têm-se multiplicado.
        </Typography>
        <Typography className="latin">
