    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Assim como o veado suspira pelas fontes das águas: * assim por Vós suspira a minha alma, ó
          Deus.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Fuérunt mihi lácrimæ meæ panes die ac nocte: * dum dícitur mihi quotídie: ubi est Deus
          tuus?
        </Typography>
        <Typography className="vernacular">
          Noite e dia as minhas lágrimas foram o meu pão: * enquanto todos os dias me dizem: onde
          está o teu Deus?
        </Typography>
        <Typography className="latin">
          Hæc recordátus sum, et effúdi in me ánimam meam: * quóniam transíbo in locum tabernáculi
          admirábilis, usque ad domum Dei.
        </Typography>
        <Typography className="vernacular">
          Lembrei-me destas coisas e dentro de mim mesmo derramei a minha alma: * porque irei ao
          lugar do admirável tabernáculo, até à casa de Deus.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Espera em Deus, porque ainda O hei-de louvar: * a Ele que é a salvação da minha face e meu
          Deus.
        </Typography>
        <Typography className="latin">
          Ad meípsum ánima mea conturbáta est: * proptérea memor ero tui de terra Jordánis, et
          Hermóniim a monte módico.
        </Typography>
        <Typography className="vernacular">
          Minha alma está abalada dentro de mim mesmo: * portanto lembrei-me de Vós, na terra do
          Jordão e de Hermon e desde o pequeno monte.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Porque de mim Vos esquecestes? * E porque hei-de andar triste, enquanto o inimigo me
          aflige?
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Dum dicunt mihi per síngulos dies: ubi est Deus tuus? * Quare tristis es, ánima mea? et
          quare contúrbas me?
        </Typography>
        <Typography className="vernacular">
          Dizendo-me todos os dias: o teu Deus onde está? * Porque estás triste, alma minha? E
          porque me conturbas?
        </Typography>
        <Typography className="latin">
          Spera in Deo, quóniam adhuc confitébor illi: * salutáre vultus mei, et Deus meus.
        ...
        <Typography className="vernacular">
          Espera em Deus, porque O ainda hei-de louvar: * a Ele que é a salvação do meu rosto e o
          meu Deus.
        </Typography>
      </Language>
    </PageWrapper>
