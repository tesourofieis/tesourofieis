  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Impleat Dóminus omnes petitiónes tuas: * nunc cognóvi quóniam salvum fecit Dóminus
          Christum suum.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Uns confiam nos carros, outros nos cavalos: * nós, porém, invocaremos o nome do Senhor
          nosso Deus.
        </Typography>
        <Typography className="latin">
