  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Æstimátus sum cum descendéntibus in lacum: * factus sum sicut homo sine adjutório, inter
          mórtuos liber.
        </Typography>
        <Typography className="vernacular">
          Sou contado entre os que descem à cova: * tornei-me como um homem sem socorro, abandonado
          entre os mortos.
        </Typography>
        <Typography className="latin">
          Sicut vulneráti dormiéntes in sepúlcris, quorum non es memor ámplius: * et ipsi de manu
          tua repúlsi sunt.
        </Typography>
        <Typography className="vernacular">
          Como os feridos que dormem nos sepulcros, de quem já Vos não lembrais: * e que foram
          repelidos de vossa mão.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Porventura fareis milagres em mercê dos mortos: * porventura os médicos os ressuscitarão,
          para que Vos louvem?
        </Typography>
        <Typography className="latin">
          Numquid narrábit áliquis in sepúlcro misericórdiam tuam, * et veritátem tuam in
          perditióne?
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Porventura vossas maravilhas serão conhecidas nas trevas, * e a vossa justiça na terra do
          esquecimento?
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Pauper sum ego, et in labóribus a juventúte mea: * exaltátus autem, humiliátus sum et
          conturbátus.
        </Typography>
        <Typography className="vernacular">
          Sou um pobre e vivo em trabalhos desde a minha mocidade: * e, depois de exaltado, fui
          humilhado e conturbado.
        </Typography>
        <Typography className="latin">
