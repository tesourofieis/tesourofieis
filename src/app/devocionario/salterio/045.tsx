    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          O nosso Deus é o nosso refúgio e a nossa força: * o nosso auxílio nas muitas tribulações
        ...
        <Typography className="vernacular">
          Por isso não temeremos, ainda que a terra seja perturbada: * e sejam precipitados os
          montes para o meio do mar.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          As gentes se conturbaram e os reinos se humilharam: * Ele fez ouvir a sua voz e a terra
          estremeceu.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Veníte, et vidéte ópera Dómini, quæ pósuit prodígia super terram: * áuferens bella usque
          ad finem terræ.
        </Typography>
        <Typography className="vernacular">
          Vinde e vede as obras do Senhor, as maravilhas que operou sobre a terra: * fazendo cessar
          as guerras até aos confins do mundo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Parai e reconhecei que eu sou Deus: * hei-de ser exaltado entre as gentes e exaltado sobre
          terra.
        </Typography>
        <Typography className="latin">
          Dóminus virtútum nobíscum: * suscéptor noster Deus Jacob.
