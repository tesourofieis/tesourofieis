  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Nesciérunt, neque intellexérunt, in ténebris ámbulant: * movebúntur ómnia fundaménta
          terræ.
        </Typography>
        <Typography className="vernacular">
          Não souberam nem entenderam, andam nas trevas: * serão abalados todos os fundamentos da
          terra.
        </Typography>
        <Typography className="latin">Ego dixi: Dii estis, * et fílii Excélsi omnes.</Typography>
        <Typography className="vernacular">
