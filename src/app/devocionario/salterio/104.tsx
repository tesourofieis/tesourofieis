  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Humiliavérunt in compédibus pedes ejus, ferrum pertránsiit ánimam ejus * donec veníret
          verbum ejus.
        </Typography>
        <Typography className="vernacular">
          Humilharam-no com grilhões nos pés, o ferro traspassou a sua alma * até que se cumpriu o
          seu vaticínio.
        </Typography>
        <Typography className="latin">
          Elóquium Dómini inflammávit eum: * misit rex, et solvit eum; princeps populórum, et
          dimísit eum.
        </Typography>
        <Typography className="vernacular">
          A palavra do Senhor o tinha inflamado: * o rei mandou que o soltassem, o príncipe dos
          povos deu-lhe a liberdade.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Para que instruísse os seus príncipes como a si: * e ensinasse a prudência aos seus
          anciãos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Converteu-lhes o coração para que odiassem o seu povo: * e usassem de dolos com seus
          servos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Feriu as suas vinhas e os seus figueirais: * e quebrou as árvores que havia nos seus
          limites.
        </Typography>
        <Typography className="latin">
