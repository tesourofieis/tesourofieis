  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">Dóminus protéctor vitæ meæ, * a quo trepidábo?</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Uma coisa só pedi ao Senhor, esta solicitarei, * é que habite na casa do Senhor todos os
          dias da minha vida:
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Quóniam abscóndit me in tabernáculo suo: * in die malórum protéxit me in abscóndito
          tabernáculi sui.
        </Typography>
        <Typography className="vernacular">
          Porque me escondeu no seu tabernáculo: * no dia do tormento me protegeu no recôndito do
          seu tabernáculo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Circuívi, et immolávi in tabernáculo ejus hóstiam vociferatiónis: * cantábo, et psalmum
          dicam Dómino.
        </Typography>
        <Typography className="vernacular">
          Circundei e no seu tabernáculo ofereci uma hóstia de júbilo: * cantarei e entoarei um
          salmo ao Senhor.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Legem pone mihi, Dómine, in via tua: * et dírige me in sémitam rectam propter inimícos
          meos.
        </Typography>
        <Typography className="vernacular">
          Prescreve-me, ó Senhor, uma lei no vosso caminho: * e conduzi-me pela vereda direita, por
          causa dos meus inimigos.
        </Typography>
        <Typography className="latin">
          Ne tradíderis me in ánimas tribulántium me: * quóniam insurrexérunt in me testes iníqui,
          et mentíta est iníquitas sibi.
        </Typography>
        <Typography className="vernacular">
          Não me entregueis à mercê das almas que me atribulam: * pois contra mim se levantaram
          falsas testemunhas, mas a iniquidade mentiu contra si própria.
        </Typography>
        <Typography className="latin">Credo vidére bona Dómini * in terra vivéntium.</Typography>
        <Typography className="vernacular">
