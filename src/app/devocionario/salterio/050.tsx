  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Tibi soli peccávi, et malum coram Te feci: * ut justificéris in sermónibus tuis, et vincas
          cum judicáris.
        </Typography>
        <Typography className="vernacular">
          Só contra Vós pequei e ante Vós fiz o mal: * para serdes justificado nas vossas palavras e
          vençais quando fores julgado.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Aspergir-me-eis com o hissope e ficarei limpo: * lavar-me-eis e ficarei mais alvo do que a
          neve.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Líbera me de sanguínibus, Deus, Deus salútis meæ: * et exsultábit lingua mea justítiam
          tuam.
        </Typography>
        <Typography className="vernacular">
          Livrai-me das penas de sangue, ó Deus, Deus da minha salvação: * e a minha língua
        ...
        <Typography className="vernacular">
          Porque se quisésseis um sacrifício, o teria oferecido: * mas Vos não deleitais com
          holocaustos.
        </Typography>
        <Typography className="latin">
          Sacrifícium Deo spíritus contribulátus: * cor contrítum, et humiliátum, Deus, non
          despícies.
        </Typography>
        <Typography className="vernacular">
          O sacrifício para Deus é um espírito contrito: * não desprezareis, ó Deus, um coração
        ...
        <Typography className="vernacular">
          Pela vossa bondade, ó Senhor, sede benigno para com Sião: * para se edificarem as muralhas
          de Jerusalém.
        </Typography>
        <Typography className="latin">
          Tunc acceptábis sacrifícium justítiæ, oblatiónes, et holocáusta: * tunc impónent super
          altáre tuum vítulos.
        </Typography>
        <Typography className="vernacular">
          Aceitareis então os sacrifícios de justiça, oferendas e holocaustos: * então serão
          colocados vitelos sobre o vosso altar.
        </Typography>
      </Language>
    </PageWrapper>
  );
