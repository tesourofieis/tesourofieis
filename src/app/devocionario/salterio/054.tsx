  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Estou triste na minha provação: * abalado estou pela voz do inimigo e pela tribulação do
          pecador.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">Ecce, elongávi fúgiens: * et mansi in solitúdine.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">
          Præcípita, Dómine, dívide linguas eórum: * quóniam vidi iniquitátem, et contradictiónem in
          civitáte.
        </Typography>
        <Typography className="vernacular">
          Precipitai-os, ó Senhor, spanidi as suas línguas: * pois vejo a injustiça e a contradição
          na cidade.
        </Typography>
        <Typography className="latin">
          Die ac nocte circúmdabit eam super muros ejus iníquitas: * et labor in médio ejus, et
          injustítia.
        </Typography>
        <Typography className="vernacular">
          Dia e noite cercará sobre seus muros a iniquidade: * está no meio dela a labuta e a
          injustiça.
        </Typography>
        <Typography className="latin">Et non defécit de platéis ejus * usúra, et dolus.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          E, se o que me odiava tivesse falado de mim com insolência, * talvez me teria escondido
          dele.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Que juntamente comigo tomavas doces manjares: * ambulávamos com consenso na casa do
          Senhor.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Rédimet in pace ánimam meam ab his, qui appropínquant mihi: * quóniam inter multos erant
          mecum.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">
          Non enim est illis commutátio, et non timuérunt Deum: * exténdit manum suam in
          retribuéndo.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">
          Contaminavérunt testaméntum ejus, spanísi sunt ab ira vultus ejus: * et appropinquávit cor
          illíus.
        </Typography>
        <Typography className="vernacular">
          Profanaram a sua aliança, foram spanididos pela ira do seu rosto: * e o seu coração se
          aproximou.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Jacta super Dóminum curam tuam, et ipse te enútriet: * non dabit in ætérnum fluctuatiónem
          justo.
        </Typography>
        <Typography className="vernacular">
          Descarrega sobre o Senhor os teus cuidados e Ele te sustentará: * não deixará o justo em
          perpétua agitação.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Homens sanguinários e enganadores não chegarão à metade dos seus dias: * eu, porém,
          esperei em Vós, ó Senhor.
        </Typography>
      </Language>
    </PageWrapper>
  );
