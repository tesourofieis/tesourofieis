    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Aclamai a Deus, habitantes todos da terra, cantai salmos ao seu nome: * tributai-Lhe
          gloriosos louvores.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Dizei a Deus: quão terríveis são as vossas obras, ó Senhor! * No vosso imenso poder vossos
          inimigos Vos dirigem mentiras.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Qui dominátur in virtúte sua in ætérnum, óculi ejus super gentes respíciunt: * qui
          exásperant non exalténtur in semetípsis.
        </Typography>
        <Typography className="vernacular">
          Ele domina pelo seu poder para sempre, os seus olhos contemplam as gentes: * os que o
          irritam se não exaltem a si mesmos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Induxísti nos in láqueum, posuísti tribulatiónes in dorso nostro: * imposuísti hómines
          super cápita nostra.
        </Typography>
        <Typography className="vernacular">
          Deixastes-nos cair no laço, carregastes de tribulações as nossas costas: * pusestes homens
        ...
        <Typography className="vernacular">
          Entrarei na vossa casa com holocaustos: * pagar-Vos-ei os meus votos, que meus lábios
          pronunciaram.
        </Typography>
        <Typography className="latin">Et locútum est os meum, * in tribulatióne mea.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Oferecer-Vos-ei holocaustos gordos com o fumo dos carneiros: * oferecer-Vos-ei bois com
          cabritos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Bendito seja Deus, * que não rejeitou a minha oração, nem retirou de mim a sua
          misericórdia.
        </Typography>
      </Language>
    </PageWrapper>
