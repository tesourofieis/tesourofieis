    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Pronto está o meu coração, ó Deus, pronto está o meu coração: * cantarei e salmodiarei na
          minha glória.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Exaltai-Vos sobre os céus, ó Deus, sobre toda a terra a vossa glória: * para que sejam
          livres os vossos eleitos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Porventura não sois Vós, Deus, que nos desamparastes, * não vireis Vós, Deus, com os
          nossos exércitos?
        </Typography>
        <Typography className="latin">
