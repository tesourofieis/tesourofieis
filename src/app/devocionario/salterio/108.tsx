    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Deus, Vos não caleis ao meu louvor: * porque abriram-se contra mim a boca do pecador e do
          traidor.
        </Typography>
        <Typography className="latin">
          Locúti sunt advérsum me lingua dolósa, et sermónibus ódii circumdedérunt me: * et
          expugnavérunt me gratis.
        </Typography>
        <Typography className="vernacular">
          Falaram contra mim com língua dolosa, me cercaram com palavras de ódio: * e gratuitamente
          me expugnaram.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">Fiant fílii ejus órphani: * et uxor ejus vídua.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Andem vagabundos dum lugar para outro os seus filhos e mendiguem: * e sejam expulsos das
          suas habitações.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          In memóriam rédeat iníquitas patrum ejus in conspéctu Dómini: * et peccátum matris ejus
          non deleátur.
        </Typography>
        <Typography className="vernacular">
          Reviva a lembrança da iniquidade de seus pais na presença do Senhor: * e o pecado de sua
          mãe não seja apagado.
        </Typography>
        <Typography className="latin">
          Fiant contra Dóminum semper, et dispéreat de terra memória eórum: * pro eo quod non est
          recordátus fácere misericórdiam.
        </Typography>
        <Typography className="vernacular">
          Estejam sempre diante do Senhor e desapareça da terra a sua memória: * porque se não
          lembrou de usar de misericórdia.
        </Typography>
        <Typography className="latin">
          Et persecútus est hóminem ínopem, et mendícum, * et compúnctum corde mortificáre.
        </Typography>
        <Typography className="vernacular">
          Perseguiu o homem desamparado e mendigo, * o homem aflito do coração, para lhe dar a
          morte.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Et índuit maledictiónem sicut vestiméntum, * et intrávit sicut aqua in interióra ejus, et
          sicut óleum in óssibus ejus.
        </Typography>
        <Typography className="vernacular">
          Vestiu-se de maldição como um traje, * e penetrou como água nas suas entranhas e como
        ...
        <Typography className="vernacular">
          Que ela seja para ele como a vestimenta com que se cobre: * e como a cinta com que sempre
          se cinge.
        </Typography>
        <Typography className="latin">
          Hoc opus eórum, qui détrahunt mihi apud Dóminum: * et qui loquúntur mala advérsus ánimam
          meam.
        </Typography>
        <Typography className="vernacular">
          Tal é diante do Senhor a obra daqueles que me caluniam: * e que dizem males contra a minha
          alma.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Maledícent illi, et Tu benedíces: * qui insúrgunt in me, confundántur: servus autem tuus
          lætábitur.
        </Typography>
        <Typography className="vernacular">
          Amaldiçoaram-me e Vós me abençoareis: * confundidos sejam os que se levantam contra mim,
          entretanto o vosso servo alegrar-se-á.
        </Typography>
        <Typography className="latin">
          Induántur qui détrahunt mihi, pudóre: * et operiántur sicut diplóide confusióne sua.
        </Typography>
        <Typography className="vernacular">
          Sejam cobertos de afronta os que me caluniam: * e fiquem envolvidos na sua confusão como
          numa capa dupla.
        </Typography>
        <Typography className="latin">
