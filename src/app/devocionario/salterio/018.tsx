  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Dá saltos como gigante para percorrer o caminho, * a sua saída é de uma extremidade do
          céu:
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Lex Dómini immaculáta, convértens ánimas: * testimónium Dómini fidéle, sapiéntiam præstans
          párvulis.
        </Typography>
        <Typography className="vernacular">
          A lei do Senhor é imaculada, convertendo a alma: * o testemunho do Senhor é fiel, dando
        ...
        <Typography className="vernacular">
          As justiças do Senhor são rectas, alegram os corações: * os mandamentos do Senhor são
          claros, iluminam os olhos.
        </Typography>
        <Typography className="latin">
          Timor Dómini sanctus, pérmanens in sǽculum sǽculi: * judícia Dómini vera, justificáta in
          semetípsa.
        </Typography>
        <Typography className="vernacular">
          O temor do Senhor é santo, permanece pelos séculos dos séculos: * os juízos do Senhor são
        ...
        <Typography className="vernacular">
          Mais preciosos que o ouro e as muitas pedras preciosas: * e mais doces do que o mel e o
          favo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Quem os seus delitos conhece? Dos que me são ocultos purificai-me: * e as alheias, perdoai
          ao vosso servo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Et erunt ut compláceant elóquia oris mei: * et meditátio cordis mei in conspéctu tuo
          semper.
        </Typography>
        <Typography className="vernacular">
          Então as palavras da minha boca ser-Vos-ão agradáveis: * e a meditação do meu coração
          esteja sempre na vossa presença.
        </Typography>
        <Typography className="latin">Dómine, adjútor meus, * et redémptor meus.</Typography>
        <Typography className="vernacular">Ó Senhor, meu amparo * e meu redentor.</Typography>
      </Language>
    </PageWrapper>
  );
}
