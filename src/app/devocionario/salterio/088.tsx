...
export default function Page088() {
  return (
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">Misericórdias Dómini * in ætérnum cantábo.</Typography>
        ...
        <Typography className="latin">
          Quóniam dixísti: in ætérnum misericórdia ædificábitur in cælis: * præparábitur véritas tua
          in eis.
        </Typography>
        <Typography className="vernacular">
          Porquanto dissestes: a misericórdia edificar-se-á eternamente nos céus: * a vossa verdade
          será preparada neles.
        </Typography>
        <Typography className="latin">
          Dispósui testaméntum eléctis meis, jurávi David, servo meo: * Usque in ætérnum præparábo
          semen tuum.
        </Typography>
        <Typography className="vernacular">
          Fiz aliança com meus escolhidos, jurei a David meu servo: * conservarei eternamente a
          vossa descendência.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Os céus declararão as vossas maravilhas, ó Senhor: * e também na igreja dos santos a vossa
          verdade.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Porque quem, nas nuvens, será igual ao Senhor: * e quem dos filhos de Deus, será
          semelhante a Deus?
        </Typography>
        <Typography className="latin">
          Deus, qui glorificátur in consílio sanctórum: * magnus et terríbilis super omnes qui in
          circúitu ejus sunt.
        </Typography>
        <Typography className="vernacular">
          A Deus, que é glorificado no conselho dos santos: * grande e terrível sobre todos os que
          estão à volta d’Ele.
        </Typography>
        <Typography className="latin">
          Dómine, Deus virtútum, quis símilis tibi? * Potens es, Dómine, et véritas tua in circúitu
          tuo.
        </Typography>
        <Typography className="vernacular">
          Ó Senhor Deus dos exércitos, quem é semelhante a Vós? * Sois poderoso, ó Senhor, e a vossa
          verdade Vos rodeia.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Tu humiliásti sicut vulnerátum, supérbum: * in brácchio virtútis tuæ dispersísti inimícos
          tuos.
        </Typography>
        <Typography className="vernacular">
          Vós humilhastes o soberbo, como a um ferido: * com a força de vosso braço desprezastes os
          vossos inimigos.
        </Typography>
        <Typography className="latin">
          Tui sunt cæli, et tua est terra, orbem terræ et plenitúdinem ejus Tu fundásti: *
          aquilónem, et mare Tu creásti.
        </Typography>
        <Typography className="vernacular">
          Vossos são os céus e vossa é a terra, Vós fundastes o mundo e tudo o que ele contém: * Vós
          criastes o aquilão e o mar.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Firmada seja a vossa mão e erga-se a vossa dextra: * justiça e julgamento são a base de
          vosso trono.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Dómine, in lúmine vultus tui ambulábunt, et in nómine tuo exsultábunt tota die: * et in
          justítia tua exaltabúntur.
        </Typography>
        <Typography className="vernacular">
          Ó Senhor, eles caminharão à luz de vosso rosto e em vosso nome se regozijarão todo o dia:
          * e pela vossa justiça serão exaltados.
        </Typography>
        <Typography className="latin">
          Quóniam glória virtútis eórum Tu es: * et in beneplácito tuo exaltábitur cornu nostrum.
        </Typography>
        <Typography className="vernacular">
          Porque Vós sois a glória da sua força: * e por vossa boa-vontade será exaltado o nosso
          poder.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Tunc locútus es in visióne sanctis tuis, et dixísti: * Pósui adjutórium in poténte: et
          exaltávi eléctum de plebe mea.
        </Typography>
        <Typography className="vernacular">
          Então falastes numa visão aos vossos santos e dissestes: * prestei o meu socorro ao
          poderoso e exaltei aquele que escolhi do meu povo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Minha verdade e minha misericórdia serão com ele: * e no meu nome será exaltado o seu
          poder.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Jurei uma vez pela minha santidade, não mentirei a David: * sua descendência permanecerá
          eternamente.
        </Typography>
        <Typography className="latin">
          Et thronus ejus sicut sol in conspéctu meo, * et sicut luna perfécta in ætérnum: et testis
          in cælo fidélis.
        </Typography>
        <Typography className="vernacular">
          Seu trono será como o sol ante mim, * como a lua cheia para sempre e como testemunho fiel
          do céu.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Saquearam-no todos os que passavam pelo caminho: * chegou a ser a desonra dos seus
          vizinhos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Lembrai-Vos do que é a minha natureza: * porventura criastes em vão todos os filhos dos
          homens?
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Que homem há, que viva sem jamais ver a morte: * que possa arrancar a sua alma do poder do
          inferno?
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Onde estão as vossas antigas misericórdias, ó Senhor, * as quais na vossa verdade jurastes
          a David?
        </Typography>
        <Typography className="latin">
          Memor esto, Dómine, oppróbrii servórum tuórum * quod contínui in sinu meo multárum
          géntium.
        </Typography>
        <Typography className="vernacular">
          Lembrai-Vos, ó Senhor, a desonra de vossos servos * que guardo no meu peito de gentes
          numerosas.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Com que têm insultado os vossos inimigos, ó Senhor, * com que têm insultado a mudança de
          vosso Cristo.
        </Typography>
        <Typography className="latin">Benedíctus Dóminus in ætérnum: * fiat, fiat.</Typography>
        <Typography className="vernacular">
