  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Dirigátur orátio mea sicut incénsum in conspéctu tuo: * elevátio mánuum meárum sacrifícium
          vespertínum.
        </Typography>
        <Typography className="vernacular">
          Suba direita como incenso a minha oração na vossa presença: * seja a elevação das minhas
        ...
        <Typography className="vernacular">
          Não deixais que meu coração se incline para palavras de malícia, * para buscar desculpas
          nos pecados.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Corrípiet me justus in misericórdia, et increpábit me: * óleum autem peccatóris non
          impínguet caput meum.
        </Typography>
        <Typography className="vernacular">
          Corrija-me o justo e advirta-me com misericórdia: * mas o azeite do pecador não chegue a
          ungir a minha cabeça.
        </Typography>
        <Typography className="latin">
          Quóniam adhuc et orátio mea in beneplácitis eórum: * absórpti sunt juncti petræ júdices
          eórum.
        </Typography>
        <Typography className="vernacular">
          Porque até a minha oração é contra o que lhe agrada: * os seus juízes serão precipitados
          ao longo dos rochedos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Dissipáta sunt ossa nostra secus inférnum: * quia ad Te, Dómine, Dómine, óculi mei: in Te
          sperávi, non áuferas ánimam meam.
        </Typography>
        <Typography className="vernacular">
          Foram dissipados os nossos ossos junto do inferno: * mas para Vós, Senhor, ó Senhor, estão
          os meus olhos: em Vós tenho esperado, me não tireis a vida.
        </Typography>
        <Typography className="latin">
