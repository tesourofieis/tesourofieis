  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Ecce, Dómine, Tu cognovísti ómnia novíssima, et antíqua: * Tu formásti me, et posuísti
          super me manum tuam.
        </Typography>
        <Typography className="vernacular">
          Eis, ó Senhor, que conhecestes todas as coisas, as novíssimas e as antigas: * Vós me
          formastes e pusestes sobre mim a vossa mão.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Quia ténebræ non obscurabúntur a Te, et nox sicut dies illuminábitur: * sicut ténebræ
          ejus, ita et lumen ejus.
        </Typography>
        <Typography className="vernacular">
          Pois as trevas não são escuras para Vós, a noite brilha como o dia: * como são as trevas
          para Vós, assim é a luz.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Confitébor tibi quia terribíliter magnificátus es: * mirabília ópera tua, et ánima mea
          cognóscit nimis.
        </Typography>
        <Typography className="vernacular">
          Vos glorificarei, pois sois terrivelmente magnífico: * maravilhosas são as vossas obras e
          a minha alma o bem sabe.
        </Typography>
        <Typography className="latin">
          Non est occultátum os meum a Te, quod fecísti in occúlto: * et substántia mea in
          inferióribus terræ.
        </Typography>
        <Typography className="vernacular">
          Meus ossos, que formastes em segredo, Vos não são ocultos: * nem a minha substância nas
          entranhas da terra.
        </Typography>
        <Typography className="latin">
          Imperféctum meum vidérunt óculi tui, et in libro tuo omnes scribéntur: * dies formabúntur,
          et nemo in eis.
        </Typography>
        <Typography className="vernacular">
          Vossos olhos me viram em bruto e no vosso livro todos estão escritos: * num dia serão
          criados, mas deles nem um.
        </Typography>
        <Typography className="latin">
          Mihi autem nimis honorificáti sunt amíci tui, Deus: * nimis confortátus est principátus
          eórum.
        </Typography>
        <Typography className="vernacular">
          Vejo, contudo, ó Deus, que singularmente honrastes os vossos amigos: * muito se fortaleceu
          o seu principado.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Não odiei eu, ó Senhor, os que Vos odiavam? * Me não desgastava eu devido aos vossos
          inimigos?
        </Typography>
        <Typography className="latin">
