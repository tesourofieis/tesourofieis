  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Disseram: vinde e exterminemo-los entre as gentes: * e não haja mais memória do nome de
          Israel.
        </Typography>
        <Typography className="latin">
          Quóniam cogitavérunt unanímiter: * simul advérsum Te testaméntum disposuérunt, tabernácula
          Idumæórum et Ismahelítæ:
        </Typography>
        <Typography className="vernacular">
          Pensaram de acordo: * e todos juntos fizeram aliança contra Vós, as tendas dos Idumeus e
          os Ismælitas:
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Conheçam que Vos é próprio o nome de Senhor: * e que só Vós sois o Altíssimo em toda a
          terra.
        </Typography>
      </Language>
    </PageWrapper>
