  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Dóminus justus concídit cervíces peccatórum: * confundántur et convertántur retrórsum
          omnes, qui odérunt Sion.
        </Typography>
        <Typography className="vernacular">
          O Senhor que é justo cortou os pescoços dos pecadores: * fiquem confundidos e retrocedam
        ...
        <Typography className="latin">
          Et non dixérunt qui præteríbant: benedíctio Dómini super vos: * benedíximus vobis in
          nómine Dómini.
        </Typography>
        <Typography className="vernacular">
          Não disseram os que passavam: a bênção do Senhor seja sobre vós: * nós vos abençoamos no
          nome do Senhor.
        </Typography>
      </Language>
    </PageWrapper>
