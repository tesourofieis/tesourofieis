  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          De facto, obrais iniquidade no vosso coração: * e as vossas mãos tramam injustiças na
          terra.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Furor illis secúndum similitúdinem serpéntis: * sicut áspidis surdæ, et obturántis aures
          suas,
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Como a cera que se derrete serão destruídos: * caiu fogo em cima deles e não viram mais o
          sol.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Antes que os vossos espinhos se convertam num arbusto: * Ele devorá-los-á na sua ira ainda
          vivos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          O homem dirá: se de certo há fruto para o justo: * de certo há um Deus que os julga sobre
          a terra.
        </Typography>
      </Language>
    </PageWrapper>
