  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Quia neque ab Oriénte, neque ab Occidénte, neque a desértis móntibus: * quóniam Deus judex
          est.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Humilha a este e exalta àquele: * pois na mão do Senhor há um cálice de vinho puro, cheio
          de mistura.
        </Typography>
        <Typography className="latin">
          Et inclinávit ex hoc in hoc: verúmtamen fæx ejus non est exinaníta: * bibent omnes
          peccatóres terræ.
        </Typography>
        <Typography className="vernacular">
          Inclina dum lado para o outro, e, todavia, suas fezes se não esgotaram: * delas beberão
