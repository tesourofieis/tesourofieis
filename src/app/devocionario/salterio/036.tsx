  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Et edúcet quasi lumen justítiam tuam: et judícium tuum tamquam merídiem: * súbditus esto
          Dómino, et ora eum.
        </Typography>
        <Typography className="vernacular">
          Fará brilhar como luz a tua justiça e o teu juízo como o meio-dia: * sê obediente ao
          Senhor e roga-Lhe.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Quóniam qui malignántur, exterminabúntur: * sustinéntes autem Dóminum, ipsi hereditábunt
          terram.
        </Typography>
        <Typography className="vernacular">
          Porque os que cometem maldades serão exterminados: * mas os que esperam no Senhor herdarão
          a terra.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Non confundéntur in témpore malo, et in diébus famis saturabúntur: * quia peccatóres
          períbunt.
        </Typography>
        <Typography className="vernacular">
          Não serão confundidos no tempo mau e nos dias de fome estarão saciados: * pois os
          pecadores perecerão.
        </Typography>
        <Typography className="latin">
          Inimíci vero Dómini mox ut honorificáti fúerint et exaltáti: * deficiéntes, quemádmodum
          fumus defícient.
        </Typography>
        <Typography className="vernacular">
          Os inimigos do Senhor, tanto que tiverem sido honrados e exaltados: * cairão e se
          desvanecerão como o fumo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Jovem fui e já sou velho: * e nunca vi o justo desamparado, nem sua descendência
          mendigando pão.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Passa o dia sempre misericordioso e dando emprestado: * e a sua descendência será
          abençoada.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Pois o Senhor ama a justiça e não desampara os seus santos: * eles serão conservados
          eternamente.
        </Typography>
        <Typography className="latin">Injústi puniéntur: * et semen impiórum períbit.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">
          Dóminus autem non derelínquet eum in mánibus ejus: * nec damnábit eum, cum judicábitur
          illi.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">
          Exspécta Dóminum, et custódi viam ejus: et exaltábit te ut hereditáte cápias terram: * cum
          períerint peccatóres vidébis.
        </Typography>
        <Typography className="vernacular">
          Espera no Senhor, guarda o seu caminho e Ele exaltar-te-á para que a terra possuas em
          herança: * o verás quando perecerem os pecadores.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Et adjuvábit eos Dóminus et liberábit eos: * et éruet eos a peccatóribus, et salvábit eos:
          quia speravérunt in eo.
        </Typography>
        <Typography className="vernacular">
          O Senhor ajudá-los-á e livrá-los-á: * tirá-los-á da mão dos pecadores e salvá-los-á, pois
          n’Ele esperam.
        </Typography>
      </Language>
    </PageWrapper>
