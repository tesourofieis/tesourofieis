  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Não me escarneçam os meus inimigos: * de facto, nem um dos que esperam em Vós será
          confundido.
        </Typography>
        <Typography className="latin">Confundántur omnes iníqua agéntes * supervácue.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">
          Dírige me in veritáte tua, et doce me: * quia Tu es, Deus, salvátor meus, et Te sustínui
          tota die.
        </Typography>
        <Typography className="vernacular">
          Dirigi-me na vossa verdade e ensinai-me: * pois Vós sois Deus, meu Salvador, e esperei em
          Vós todo o dia.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Lembrai-Vos, ó Senhor, de vossas bondades, * e de vossas misericórdias, que datam dos
          séculos passados.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Univérsæ viæ Dómini, misericórdia et véritas, * requiréntibus testaméntum ejus et
          testimónia ejus.
        </Typography>
        <Typography className="vernacular">
          Todos os caminhos do Senhor são misericórdia e verdade, * para os que buscam a sua aliança
        ...
        <Typography className="vernacular">
          Por causa de vosso nome, ó Senhor, me haveis de perdoar o meu pecado, * é veramente
          grande.
        </Typography>
        <Typography className="latin">
