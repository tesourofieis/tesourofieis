  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Nem o maligno habitará junto de Vós: * nem os injustos poderão permanecer ante vossos
          olhos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Virum sánguinum et dolósum abominábitur Dóminus: * ego autem in multitúdine misericórdiæ
          tuæ.
        </Typography>
        <Typography className="vernacular">
          O Senhor abominará o homem sanguinário e doloso: * eu, porém, confiado na abundância de
          vossa misericórdia.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Dómine, deduc me in justítia tua: * propter inimícos meos dírige in conspéctu tuo viam
          meam.
        </Typography>
        <Typography className="vernacular">
          Senhor, na vossa justiça guiai-me: * por causa dos meus inimigos dirigis ante vossos olhos
          o meu caminho.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Décidant a cogitatiónibus suis, secúndum multitúdinem impietátum eórum expélle eos, *
          quóniam irritavérunt Te, Dómine.
        </Typography>
        <Typography className="vernacular">
          Frustrem-se os seus desígnios, expulsai-os segundo a multidão das suas impiedades, *
          porque Vos irritaram, Senhor.
        </Typography>
        <Typography className="latin">
