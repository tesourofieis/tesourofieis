    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Bem-aventurado o que tem em consideração o necessitado e o pobre: * no mau dia livrá-lo-á
          o Senhor.
        </Typography>
        <Typography className="latin">
          Dóminus consérvet eum, et vivíficet eum, et beátum fáciat eum in terra: * et non tradat
          eum in ánimam inimicórum ejus.
        </Typography>
        <Typography className="vernacular">
          O guarde o Senhor e lhe dê vida e o faça feliz na terra: * e o não entregue ao poder dos
          seus inimigos.
        </Typography>
        <Typography className="latin">
          Dóminus opem ferat illi super lectum dolóris ejus: * univérsum stratum ejus versásti in
          infirmitáte ejus.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">Egrediebátur foras, * et loquebátur in idípsum.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Decretaram contra mim uma injusta palavra: * o que dorme não poderá porventura volver a
          erguer-se?
        </Typography>
        <Typography className="latin">
          Étenim homo pacis meæ, in quo sperávi: * qui edébat panes meos, magnificávit super me
          supplantatiónem.
        </Typography>
        <Typography className="vernacular">
          De facto, o homem da minha paz, em quem esperei: * que comia o meu pão, engrandeceu contra
          mim a sua traição.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Porque Vós me suportastes por causa da minha inocência: * e me fortificastes ante Vós para
          sempre.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Seja bendito o Senhor Deus de Israel por todos os séculos dos séculos: * assim seja, assim
          seja.
        </Typography>
      </Language>
    </PageWrapper>
