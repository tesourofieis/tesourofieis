  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          A Vós clamei, ó Senhor, * e disse: Vós sois a minha esperança, a minha porção na terra dos
          viventes.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Educ de custódia ánimam meam ad confiténdum nómini tuo: * me exspéctant justi, donec
          retríbuas mihi.
        </Typography>
        <Typography className="vernacular">
          Tirai a minha alma desta prisão para dar glória ao vosso nome: * estão-me esperando os
          justos, até que me recompenses.
        </Typography>
      </Language>
    </PageWrapper>
  );
