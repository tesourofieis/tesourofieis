  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Astitérunt reges terræ, et príncipes convenérunt in unum * advérsus Dóminum, et advérsus
          Christum ejus.
        </Typography>
        <Typography className="vernacular">
          Os reis da terra levantaram-se e os príncipes reuniram-se * contra o Senhor e contra o seu
          Cristo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Ego autem constitútus sum Rex ab eo super Sion montem sanctum ejus, * prǽdicans præcéptum
          ejus.
        </Typography>
        <Typography className="vernacular">
          Eu, porém, fui por Ele constituído Rei sobre Sião, seu santo monte, * para pregar a sua
          doutrina.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Pede-me e dar-te-ei as gentes como tua herança, * e estenderei o teu domínio aos confins
          da terra.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Abraçai a disciplina, para que o Senhor se não irrite, * e não pereçais fora do caminho da
          justiça.
        </Typography>
        <Typography className="latin">
