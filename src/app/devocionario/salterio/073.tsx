    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Porquê, ó Deus, nos desamparastes até ao fim: * e se acendeu a vossa cólera contra as
          ovelhas de vosso pasto?
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Levantai as vossas mãos contra a sua soberba sem limites: * quantas maldades cometeu o
          inimigo no santuário!
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Hastearam os seus estandartes como troféus: * e os não conheceram no cimo da porta de
          saída.
        </Typography>
        <Typography className="latin">
          Quasi in silva lignórum secúribus excidérunt jánuas ejus in idípsum: * in secúri et áscia
          dejecérunt eam.
        </Typography>
        <Typography className="vernacular">
          Como com machados num bosque de árvores, despedaçaram com afinco os seus portões: * com
          machado e martelo tudo derrubaram.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Dixérunt in corde suo cognátio eórum simul: * Quiéscere faciámus omnes dies festos Dei a
          terra.
        </Typography>
        <Typography className="vernacular">
          Com seus semelhantes disseram no seu coração: * façamos cessar na terra todos os dias de
          festa consagrados a Deus.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Memor esto hujus, inimícus improperávit Dómino: * et pópulus insípiens incitávit nomen
          tuum.
        </Typography>
        <Typography className="vernacular">
          Lembrai-Vos disto, o inimigo ultrajou o Senhor: * e um povo insensato blasfemou de vosso
          nome.
        </Typography>
        <Typography className="latin">
          Ne tradas béstiis ánimas confiténtes tibi, * et ánimas páuperum tuórum ne obliviscáris in
          finem.
        </Typography>
        <Typography className="vernacular">
          Não entregueis às feras as almas que Vos louvam, * e não esqueçais para sempre as almas de
          vossos pobres.
        </Typography>
        <Typography className="latin">
          Réspice in testaméntum tuum: * quia repléti sunt, qui obscuráti sunt terræ dómibus
          iniquitátum.
        </Typography>
        <Typography className="vernacular">
          Olhai para a vossa aliança: * pois todos os lugares obscuros do país estão cheios de
        ...
        <Typography className="latin">
          Exsúrge, Deus, júdica causam tuam: * memor esto improperiórum tuórum, eórum quæ ab
          insipiénte sunt tota die.
        </Typography>
        <Typography className="vernacular">
          Levantai-Vos, ó Deus, julgai a vossa causa: * lembrai-Vos dos ultrajes, com que um povo
          ignorante Vos injúria todo o dia.
        </Typography>
        <Typography className="latin">
          Ne obliviscáris voces inimicórum tuórum: * supérbia eórum, qui Te odérunt, ascéndit
          semper.
        </Typography>
        <Typography className="vernacular">
          Dos clamores de vossos inimigos Vos não esqueçais: * a soberba dos que Vos aborrecem
          ascende sempre.
        </Typography>
      </Language>
    </PageWrapper>
