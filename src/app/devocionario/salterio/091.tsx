  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Quão magníficas são, ó Senhor, as vossas obras! * Profundíssimos são os vossos
          pensamentos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Cum exórti fúerint peccatóres sicut fænum: * et apparúerint omnes, qui operántur
          iniquitátem:
        </Typography>
        <Typography className="vernacular">
          Quando os pecadores crescerem como a erva: * e aparecerem todos os que cometem a
          iniquidade:
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Quóniam ecce inimíci tui, Dómine, quóniam ecce inimíci tui períbunt: * et dispergéntur
          omnes, qui operántur iniquitátem.
        </Typography>
        <Typography className="vernacular">
          Porque eis que vossos inimigos, Senhor, eis que vossos inimigos perecerão: * e dispersados
        ...
        <Typography className="vernacular">
          Será exaltada a minha força como a do unicórnio: * e minha velhice na abundante
          misericórdia.
        </Typography>
        <Typography className="latin">
          Et despéxit óculus meus inimícos meos: * et in insurgéntibus in me malignántibus áudiet
          auris mea.
        </Typography>
        <Typography className="vernacular">
          Meus olhos olharão com desprezo para meus inimigos: * e meus ouvidos ouvirão falar dos
