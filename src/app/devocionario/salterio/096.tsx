  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Sejam confundidos todos os que adoram ídolos: * e os que nos seus simulacros se
          vangloriam.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Porque Vós sois o altíssimo Senhor sobre toda a terra: * exaltadíssimo sois sobre todos os
          deuses.
        </Typography>
        <Typography className="latin">
          Qui dilígitis Dóminum, odíte malum: * custódit Dóminus ánimas sanctórum suórum, de manu
          peccatóris liberábit eos.
        </Typography>
        <Typography className="vernacular">
          Vós que amais o Senhor, odiai o mal: * o Senhor guarda as almas dos seus santos,
          livrá-los-á da mão do pecador.
        </Typography>
        <Typography className="latin">Lux orta est justo, * et rectis corde lætítia.</Typography>
        <Typography className="vernacular">
