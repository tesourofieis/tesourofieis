  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Conféssio, et pulchritúdo in conspéctu ejus: * sanctimónia et magnificéntia in
        ...
        <Typography className="latin">
          Afférte Dómino, pátriæ géntium, afférte Dómino glóriam et honórem: * afférte Dómino
          glóriam nómini ejus.
        </Typography>
        <Typography className="vernacular">
          Dai ao Senhor, ó famílias das gentes, dai ao Senhor glória e honra: * dai ao Senhor a
          glória devida a seu nome.
        </Typography>
        <Typography className="latin">
          Tóllite hóstias, et introíte in átria ejus: * adoráte Dóminum in átrio sancto ejus.
        </Typography>
        <Typography className="vernacular">
          Elevai-Lhe sacrifícios e entrai nos seus átrios: * adorai o Senhor no átrio do seu
          santuário.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Læténtur cæli, et exsúltet terra: commoveátur mare, et plenitúdo ejus: * gaudébunt campi,
        ...
        <Typography className="latin">
          Tunc exsultábunt ómnia ligna silvárum a fácie Dómini, quia venit: * quóniam venit judicáre
          terram.
        </Typography>
        <Typography className="vernacular">
          Então exultar-se-ão todas as árvores dos bosques ante o Senhor, porque vem: * porque vem
          julgar a terra.
        </Typography>
        <Typography className="latin">
