...
export default function Page134() {
  return (
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">Laudáte nomen Dómini, * laudáte, servi, Dóminum.</Typography>
        ...
        <Typography className="latin">
          Omnia quæcúmque vóluit, Dóminus fecit in cælo, et in terra, * in mari, et in ómnibus
          abýssis.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">
          Qui prodúcit ventos de thesáuris suis: * qui percússit primogénita Ægýpti ab hómine usque
          ad pecus.
        </Typography>
        <Typography className="vernacular">
          Ele faz sair os ventos dos seus tesouros: * que feriu os primogénitos do Egipto, desde o
          homem até ao animal.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Enviou sinais e prodígios no meio de ti, ó Egipto: * contra Faraó e contra todos seus
          servos.
        </Typography>
        <Typography className="latin">
