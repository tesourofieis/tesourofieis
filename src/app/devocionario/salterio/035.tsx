  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Porque procedeu ele enganosamente na sua presença: * e a sua iniquidade mais odiosa se
          tornou.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Iniquitátem meditátus est in cubíli suo: * ástitit omni viæ non bonæ, malítiam autem non
          odívit.
        </Typography>
        <Typography className="vernacular">
          Meditou a iniquidade no seu leito: * deteve-se em todos os maus caminhos, a malícia ele
          não odiou.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Ó Senhor, salvareis homens e animais: * quanto multiplicastes a vossa misericórdia, ó
          Deus!
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Inebriar-se-ão com a abundância de vossa casa: * e os fareis beber na torrente de vossas
          delícias.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Estendei a vossa misericórdia sobre os que Vos conhecem, * e a vossa justiça sobre aqueles
          que têm o coração recto.
        </Typography>
        <Typography className="latin">
