  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          In die tribulatiónis meæ Deum exquisívi, mánibus meis nocte contra eum: * et non sum
          decéptus.
        </Typography>
        <Typography className="vernacular">
          No dia da minha tribulação busquei a Deus, estendi-Lhe de noite as minhas mãos: * e não
          fiquei defraudado.
        </Typography>
        <Typography className="latin">
          Rénuit consolári ánima mea, * memor fui Dei, et delectátus sum, et exercitátus sum: et
          defécit spíritus meus.
        </Typography>
        <Typography className="vernacular">
          Recusou consolar-se a minha alma, * lembrei-me de Deus e deleitei-me, ponderei e o meu
          espírito desfaleceu.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Deus, in sancto via tua: quis Deus magnus sicut Deus noster? * Tu es Deus qui facis
          mirabília.
        </Typography>
        <Typography className="vernacular">
          Vosso caminho, ó Deus, é santo: que Deus há grande como nosso Deus? * Vós sois o Deus que
          operais maravilhas.
        </Typography>
        <Typography className="latin">
          Notam fecísti in pópulis virtútem tuam: * redemísti in brácchio tuo pópulum tuum, fílios
          Jacob et Joseph.
        </Typography>
        <Typography className="vernacular">
          Fizestes conhecer entre os povos o vosso poder: * redimistes com vosso braço o vosso povo,
        ...
        <Typography className="vernacular">
          No mar o vosso caminho e os vossos atalhos em muitas águas: * e não serão conhecidos os
          vossos vestígios.
        </Typography>
        <Typography className="latin">
