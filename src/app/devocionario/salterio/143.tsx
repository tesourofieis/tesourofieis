    ...
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">
          Benedíctus Dóminus, Deus meus, qui docet manus meas ad prǽlium, * et dígitos meos ad
          bellum.
        </Typography>
        <Typography className="vernacular">
          Bendito seja o Senhor meu Deus, que adestra minhas mãos para a batalha, * e meus dedos
          para a guerra.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Que é o homem, ó Senhor, para que a ele Vos tenhais manifestado? * Ou o filho do homem,
          para assim o estimardes?
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Emítte manum tuam de alto, éripe me, et líbera me de aquis multis: * de manu filiórum
          alienórum.
        </Typography>
        <Typography className="vernacular">
          Enviai a vossa mão lá do alto, tirai-me e livrai-me das muitas águas: * da mão dos filhos
          estranhos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Vós que dais saúde aos reis: * que livrastes vosso servo David da espada maligna:
          livrai-me.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          E tirai-me da mão dos filhos estranhos, cuja boca falou vaidade: * e cuja direita é uma
          direita de iniquidade.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Bem-aventurado chamarão ao povo que tem estes bens: * bem-aventurado o povo que tem o
          Senhor por seu Deus.
        </Typography>
      </Language>
    </PageWrapper>
