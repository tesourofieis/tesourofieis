  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">Tu mandásti * mandáta tua custodíri nimis.</Typography>
        <Typography className="vernacular">
      ...
      <Language>
        ...
        <Typography className="latin">
          Étenim sedérunt príncipes, et advérsum me loquebántur: * servus autem tuus exercebátur in
          justificatiónibus tuis.
        </Typography>
        <Typography className="vernacular">
          Porque os príncipes se sentaram e falavam contra mim: * o vosso servo, todavia, meditava
          nas vossas justificações.
        </Typography>
        <Typography className="latin">
          Nam et testimónia tua meditátio mea est: * et consílium meum justificatiónes tuæ.
        </Typography>
        <Typography className="vernacular">
          Pois os vossos testemunhos são a minha meditação: * e as vossas justificações o meu
          conselho.
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="latin">Státue servo tuo elóquium tuum, * in timóre tuo.</Typography>
        <Typography className="vernacular">
      ...
      <Language>
        ...
        <Typography className="vernacular">
          E venha sobre mim a vossa misericórdia, ó Senhor: * e a vossa salvação, segundo a vossa
          palavra.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Et ne áuferas de ore meo verbum veritátis usquequáque: * quia in judíciis tuis
          supersperávi.
        </Typography>
        <Typography className="vernacular">
          Não tireis jamais da minha boca a palavra da verdade: * pois muito confiei nas vossas
          juízos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">Et meditábar in mandátis tuis, * quæ diléxi.</Typography>
        <Typography className="vernacular">Meditarei nos vossos mandamentos, * que amo.</Typography>
        <Typography className="latin">
          Et levávi manus meas ad mandáta tua, quæ diléxi: * et exercébar in justificatiónibus tuis.
        </Typography>
        <Typography className="vernacular">
          Levantarei as minhas mãos para os vossos mandamentos, que amo: * e exercitar-me-ei nas
      ...
      <Language>
        <Typography className="latin">Pórtio mea, Dómine, * dixi custodíre legem tuam.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Supliquei na vossa presença de todo meu coração: * compadecei-Vos de mim, segundo a vossa
          palavra.
        </Typography>
        <Typography className="latin">
      ...
      <Language>
        ...
        <Typography className="latin">
          Multiplicáta est super me iníquitas superbórum: * ego autem in toto corde meo scrutábor
          mandáta tua.
        </Typography>
        <Typography className="vernacular">
          A iniquidade dos soberbos multiplicou-se sobre mim: * porém eu, guardarei de todo meu
          coração os vossos mandamentos.
        </Typography>
        <Typography className="latin">
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Vossas mãos fizeram-me e formaram-me: * dai-me inteligência e aprenderei os vossos
          mandamentos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Os que Vos temem ver-me-ão e alegrar-se-ão: * pois nas vossas palavras pus grande
          esperança.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Conheci, ó Senhor, que os vossos juízos são de equidade: * e que me humilhastes segundo a
          vossa justiça.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Confundántur supérbi, quia injúste iniquitátem fecérunt in me: * ego autem exercébor in
          mandátis tuis.
        </Typography>
        <Typography className="vernacular">
          Sejam confundidos os soberbos, pois injustamente maquinaram males contra mim: * eu, porém,
          reflectirei os vossos mandamentos.
        </Typography>
        <Typography className="latin">
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Por pouco não deram cabo de mim na terra: * eu, porém, não abandonei os vossos
          mandamentos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Vivificai-me segundo a vossa misericórdia: * e guardarei os testemunhos saídos da vossa
          boca.
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Se a vossa lei não tivesse sido a minha meditação: * por certo teria perecido na minha
          humilhação.
        </Typography>
        <Typography className="latin">
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Com vossos mandamentos me tornastes mais prudente que meus inimigos: * pois os tenho
          sempre comigo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Compreendi mais que todos meus mestres: * pois os vossos testemunhos são a minha
          meditação.
        </Typography>
        <Typography className="latin">
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Fazei, ó Senhor, que Vos seja agradável as ofertas da minha boca: * e ensinai-me os vossos
          juízos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Adquiri os vossos testemunhos para que sejam eternamente o meu património: * pois são a
      ...
      <Language>
        <Typography className="latin">Iníquos ódio hábui: * et legem tuam diléxi.</Typography>
        <Typography className="vernacular">Odiei os iníquos: * e amei a vossa lei.</Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Amparai-me segundo a vossa promessa e viverei: * e não permitais que seja confundido no
          que espero.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Avaliei como prevaricadores todos os pecadores da terra: * por isso amei os vossos
          testemunhos.
        </Typography>
        <Typography className="latin">
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Olhai para mim e compadecei-Vos de mim, * segundo o juízo que usais com os que amam o
          vosso nome.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Fazei que a luz do vosso rosto reluza sobre o vosso servo: * e ensinai-me as vossas
          justificações.
        </Typography>
        <Typography className="latin">
      ...
      <Language>
        <Typography className="latin">Justus es, Dómine: * et rectum judícium tuum.</Typography>
        <Typography className="vernacular">
      ...
      <Language>
        ...
        <Typography className="latin">
          Vocem meam audi secúndum misericórdiam tuam, Dómine: * et secúndum judícium tuum vivífica
          me.
        </Typography>
        <Typography className="vernacular">
          Ouvi a minha voz, ó Senhor, segundo a vossa misericórdia: * e dai-me vida segundo o vosso
          juízo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">Prope es tu, Dómine: * et omnes viæ tuæ véritas.</Typography>
        <Typography className="vernacular">
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Muitos são os que me perseguem e me atribulam: * porém, me não desviei dos vossos
          mandamentos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Vede, ó Senhor, quanto tenho amado os vossos mandamentos: * vivificai-me na vossa
          misericórdia.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          O princípio das vossas palavras é a verdade: * todos os juízos da vossa justiça são
          eternos.
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Guardei os vossos mandamentos e os vossos testemunhos: * pois todos meus caminhos estão
          diante de Vós.
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          Appropínquet deprecátio mea in conspéctu tuo, Dómine: * juxta elóquium tuum da mihi
          intelléctum.
        </Typography>
        <Typography className="vernacular">
          Chegue a minha súplica à vossa presença, ó Senhor: * dai-me entendimento segundo a vossa
          palavra.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Errante, como ovelha que se extraviou: * buscai o vosso servo, pois me não esqueci dos
          vossos mandamentos.
        </Typography>
      </Language>
    </PageWrapper>
