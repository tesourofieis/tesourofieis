  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">Verúmtamen univérsa vánitas, * omnis homo vivens.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">Thesaurízat: * et ignórat cui congregábit ea.</Typography>
        ...
        <Typography className="vernacular">
          Livrai-me de todas minhas iniquidades: * um objecto de escárnio para o insensato me
          fizestes.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Calei-me e não abri a minha boca, porque Vós o fizestes: * afastai de mim os vossos
          flagelos.
        </Typography>
        <Typography className="latin">
          A fortitúdine manus tuæ ego deféci in increpatiónibus: * propter iniquitátem corripuísti
          hóminem.
        </Typography>
        <Typography className="vernacular">
          Repreendestes-me e debaixo da força de vossa mão desfaleci: * por causa da iniquidade
          castigastes o homem.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Fizestes que sua vida se consumisse como uma aranha: * é contudo em vão que todo o homem
          se inquieta.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Não Vos caleis, porque ante Vós eu sou um peregrino, * e um estranho como foram todos meus
          pais.
        </Typography>
        <Typography className="latin">
