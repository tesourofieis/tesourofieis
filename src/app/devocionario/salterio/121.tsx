  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Illuc enim ascendérunt tribus, tribus Dómini: * testimónium Israël ad confiténdum nómini
          Dómini.
        </Typography>
        <Typography className="vernacular">
          De facto, lá subiram as tribos, as tribos do Senhor: * como testemunho a Israel, para
