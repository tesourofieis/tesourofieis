  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Dicant qui redémpti sunt a Dómino, quos redémit de manu inimíci: * et de regiónibus
          congregávit eos:
        </Typography>
        <Typography className="vernacular">
          Digam-no os que foram resgatados pelo Senhor, os que Ele resgatou da mão do inimigo: * e
          os que congregou de entre as regiões:
        </Typography>
        <Typography className="latin">A solis ortu, et occásu: * ab aquilóne, et mari.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Estavam sentados nas trevas e na sombra da morte: * aprisionados, na mendiguez e em
          ferros.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Retirou-os do caminho da sua iniquidade: * pois tinham sido humilhados devido às suas
          injustiças.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Ascéndunt usque ad cælos, et descéndunt usque ad abýssos: * ánima eórum in malis
          tabescébat.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Caiu o desprezo sobre os príncipes: * e Ele fê-los andar em erro por onde caminho não
          existia.
        </Typography>
        <Typography className="latin">
