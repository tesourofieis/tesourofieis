  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Sois o mais belo dos filhos dos homens, a graça derramou-se nos vossos lábios: * por isso
          Vos abençoou Deus para sempre.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Propter veritátem, et mansuetúdinem, et justítiam: * et dedúcet Te mirabíliter déxtera
          tua.
        </Typography>
        <Typography className="vernacular">
          Por meio da verdade, da mansidão e da justiça: * e a vossa dextra conduzir-Vos-á
          maravilhosamente.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Agudas são as vossas setas: os povos cairão debaixo de Vós: * traspassarão o coração dos
          inimigos do Rei.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Amastes a justiça e odiastes a iniquidade: * por isso Deus, vosso Deus, Vos ungiu com óleo
          de alegria, sobre vossos companheiros.
        </Typography>
        <Typography className="latin">
          Myrrha, et gutta, et cásia a vestiméntis tuis, a dómibus ebúrneis: * ex quibus
          delectavérunt Te fíliæ regum in honóre tuo.
        </Typography>
        <Typography className="vernacular">
          De vossas vestes se exala Mirra, aloés e cássia, vêm das casas de marfim: * nas quais Vos
          alegraram as filhas dos reis na vossa glória.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Audi fília, et vide, et inclína aurem tuam: * et oblivíscere pópulum tuum et domum patris
          tui.
        </Typography>
        <Typography className="vernacular">
          Escutai, ó filha, vede e inclinai o vosso ouvido: * e esquecei-vos de vosso povo e da casa
          de vosso pai.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          As filhas de Tiro com dáspanas * apresentar-vos-ão suas súplicas: e todos os ricos do
          povo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Toda a glória da filha do Rei está no interior, * em franjas de ouro, ornada com
          variedade.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Após ela as virgens serão apresentadas ao Rei: * as suas companheiras ser-Vos-ão
          conduzidas.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Em lugar de vossos pais, filhos vos nascerão: * estabelecê-los-eis príncipes sobre toda a
          terra.
        </Typography>
        <Typography className="latin">
