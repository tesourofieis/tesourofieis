  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Quanta mandávit pátribus nostris nota fácere ea fíliis suis: * ut cognóscat generátio
          áltera.
        </Typography>
        <Typography className="vernacular">
          Que ordenou a nossos pais para que dessem a conhecer a seus filhos: * para que a geração
          seguinte a conhecesse.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Para que ponham em Deus a sua esperança e se não esqueçam das obras de Deus: * e busquem
          os seus mandamentos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Uma geração, que não encaminhou rectamente o seu coração: * nem seu espírito foi fiel a
          Deus.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Ideo audívit Dóminus, et dístulit: * et ignis accénsus est in Jacob, et ira ascéndit in
          Israël.
        </Typography>
        <Typography className="vernacular">
          Ouviu isto o Senhor e irritou-se: * e um fogo acendeu-se contra Jacob e cresceu a ira
          contra Israel.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Et manducavérunt, et saturáti sunt nimis, et desidérium eórum áttulit eis: * non sunt
          fraudáti a desidério suo.
        </Typography>
        <Typography className="vernacular">
          Comeram, muito se fartaram e foi satisfeito o seu desejo: * não ficaram defraudados no que
          desejavam.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          De como fez resplandecer no Egipto os seus milagres, * e os sues prodígios no campo de
          Tanis.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Misit in eos iram indignatiónis suæ: * indignatiónem, et iram, et tribulatiónem:
          immissiónes per ángelos malos.
        </Typography>
        <Typography className="vernacular">
          Descarregou sobre eles a violência da sua cólera: * a indignação, a ira e a tribulação,
          que enviou por anjos maus.
        </Typography>
        <Typography className="latin">
          Viam fecit sémitæ iræ suæ, non pepércit a morte animábus eórum: * et juménta eórum in
          morte conclúsit.
        </Typography>
        <Typography className="vernacular">
          Abriu um largo caminho à sua ira, não perdoou as suas vidas: * e envolveu na mortandade os
          seus animais.
        </Typography>
        <Typography className="latin">
          Et percússit omne primogénitum in terra Ægýpti: * primítias omnis labóris eórum in
          tabernáculis Cham.
        </Typography>
        <Typography className="vernacular">
          Feriu todo o primogénito na terra do Egipto: * e as primícias de todo seu trabalho nas
          tendas de Cam.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Os introduziu depois no monte da sua santificação: * monte que Ele adquiriu com sua
          dextra.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Ante eles expulsou as gentes: * e por sorte lhes spanidiu a terra e destribuiu-as por
          linhas de medição.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Eles, porém, tentaram e exacerbaram de novo o excelso Deus: * e não guardaram os seus
          preceitos.
        </Typography>
        <Typography className="latin">
          Et avertérunt se, et non servavérunt pactum: * quemádmodum patres eórum convérsi sunt in
          arcum pravum.
        </Typography>
        <Typography className="vernacular">
          Volveram-Lhe as costas e não observaram a aliança: * semelhantes a seus pais, falsearam
          como um arco torto.
        </Typography>
        <Typography className="latin">
          In iram concitavérunt eum in cóllibus suis: * et in sculptílibus suis ad æmulatiónem eum
          provocavérunt.
        </Typography>
        <Typography className="vernacular">
          Excitaram-n’O à ira nas suas colinas: * e com os ídolos que esculpiram inflamaram-Lhe o
          zelo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Rejeitou o tabernáculo de Silo: * o seu próprio tabernáculo, onde tinha habitado entre os
          homens.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Edificou o seu santuário como os do unicórnio na terra, * que tinha assegurado para
          sempre.
        </Typography>
        <Typography className="latin">
          Et elégit David, servum suum, et sústulit eum de grégibus óvium: * de post fœtántes
          accépit eum,
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Apascentou-os segundo a inocência do seu coração: * e os conduziu com a sabedoria das suas
          mãos.
        </Typography>
      </Language>
    </PageWrapper>
