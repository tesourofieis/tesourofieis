  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Memóriam fecit mirabílium suórum, miséricors et miserátor Dóminus: * escam dedit
          timéntibus se.
        </Typography>
        <Typography className="vernacular">
          Instituiu um memorial das suas maravilhas, o Senhor que é misericordioso e compassivo: *
          deu alimento aos que O temem.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Fiéis são todos seus mandamentos, confirmados em todos os séculos, * feitos em verdade e
          equidade.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          <Typography className="latin">fit reverentia</Typography> Sanctum, et terríbile nomen
          ejus: * inítium sapiéntiæ timor Dómini.
        </Typography>
        <Typography className="vernacular">
          <Typography className="vernacular">inclinar a cabeça</Typography> Santo e terrível é o seu
          nome: * o temor do Senhor é o princípio da sabedoria.
        </Typography>
        <Typography className="latin">
