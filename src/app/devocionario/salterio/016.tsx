  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">
          Probásti cor meum, et visitásti nocte: * igne me examinásti, et non est invénta in me
          iníquitas.
        </Typography>
        <Typography className="vernacular">
          Provastes o meu coração e o visitastes de noite: * no fogo me purificastes e não foi
          encontrada em mim iniquidade.
        </Typography>
        <Typography className="latin">
          Ut non loquátur os meum ópera hóminum: * propter verba labiórum tuórum ego custodívi vias
          duras.
        </Typography>
        <Typography className="vernacular">
          Para que minha boca não fale as obras dos homens: * por causa das palavras de vossos
          lábios, mantive caminhos penosos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Eu clamei, porque me tendes ouvido, ó Deus: * inclinai para mim o vosso ouvido e ouvi as
          minhas palavras.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Manifestai as vossas maravilhosas misericórdias, * Vós que salvais aqueles que em Vós
          esperam.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Inimíci mei ánimam meam circumdedérunt, ádipem suum conclusérunt: * os eórum locútum est
          supérbiam.
        </Typography>
        <Typography className="vernacular">
          Meus inimigos cercaram a minha alma, estão fechados nas suas entranhas: * a sua boca falou
          com soberba.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Arrebataram-me como um leão preparado para a presa: * e como um jovem leão que habita
          esconderijos.
        </Typography>
        <Typography className="latin">
          Exsúrge, Dómine, prævéni eum, et supplánta eum: * éripe ánimam meam ab ímpio, frámeam tuam
          ab inimícis manus tuæ.
        </Typography>
        <Typography className="vernacular">
          Levantai-Vos, ó Senhor, desapontai-o e suplantai-o: * livrai a minha alma do ímpio, vossa
          espada dos inimigos de vossa mão.
        </Typography>
        <Typography className="latin">
          Dómine, a paucis de terra dívide eos in vita eórum: * de abscónditis tuis adimplétus est
          venter eórum.
        </Typography>
        <Typography className="vernacular">
          Ó Senhor, separai os bons ainda em vida, que são poucos sobre a terra: * o seu ventre está
          cheio de vossos tesouros.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Eu, porém, comparecerei com justiça na vossa presença: * saciar-me-ei quando aparecer a
          vossa glória.
        </Typography>
      </Language>
    </PageWrapper>
