  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Antes que os montes fossem feitos, ou que a terra e o mundo fossem formados: * Deus sois
          desde toda a eternidade e pelos séculos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Mane sicut herba tránseat, mane flóreat, et tránseat: * véspere décidat, indúret et
          aréscat.
        </Typography>
        <Typography className="vernacular">
          De manhã levanta-se como a erva, pela manhã floresce e passa: * à tarde cai, endurece e
          seca.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Posuísti iniquitátes nostras in conspéctu tuo: * sǽculum nostrum in illuminatióne vultus
          tui.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">
          Anni nostri sicut aránea meditabúntur: * dies annórum nostrórum in ipsis, septuagínta
          anni.
        </Typography>
        <Typography className="vernacular">
          Os nossos anos serão considerados como uma aranha: * os anos da nossa vida são em si
          setenta.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">Quóniam supervénit mansuetúdo: * et corripiémur.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">
          Repléti sumus mane misericórdia tua: * et exsultávimus, et delectáti sumus ómnibus diébus
          nostris.
        </Typography>
        <Typography className="vernacular">
          Fomos cumulados de vossa misericórdia de manhã: * e exultamos de alegria e felicidade
          todos nossos dias.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Brilhe sobre nós a luz do Senhor nosso Deus, dirigi em nós as obras de nossas mãos: * sim,
          dirigi a obra de nossas mãos.
        </Typography>
      </Language>
    </PageWrapper>
  );
