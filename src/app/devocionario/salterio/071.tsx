  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Os reis de Társis e as ilhas Lhe oferecerão dons: * os reis da Arábia e de Sabá Lhe trarão
          presentes.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Resgatará as suas almas das usuras e da iniquidade: * e os seus nomes serão honrados na
          sua presença.
        </Typography>
        <Typography className="latin">
          Et vivet, et dábitur ei de auro Arábiæ, et adorábunt de ipso semper: * tota die benedícent
          ei.
        </Typography>
        <Typography className="vernacular">
          Viverá, apresentar-Lhe-ão do ouro da Arábia e adorá-l'O-ão sempre: * bendi-l'O-ão todo o
          dia.
        </Typography>
        <Typography className="latin">
          Et erit firmaméntum in terra in summis móntium, superextollétur super Líbanum fructus
          ejus: * et florébunt de civitáte sicut fænum terræ.
        </Typography>
        <Typography className="vernacular">
          Haverá mantimento na terra, no cume dos montes, erguer-se-á sobre o Líbano o seu fruto: *
        ...
        <Typography className="latin">
          Et benedíctum nomen majestátis ejus in ætérnum: * et replébitur majestáte ejus omnis
          terra: fiat, fiat.
        </Typography>
        <Typography className="vernacular">
          Bendito seja o nome da sua majestade para sempre: * e encher-se-á da sua majestade toda a
          terra: assim seja, assim seja.
        </Typography>
      </Language>
    </PageWrapper>
  );
