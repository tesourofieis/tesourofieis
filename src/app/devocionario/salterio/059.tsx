  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Deus falou no seu santuário, alegrar-me-ei: * e repartirei a Siquém e medirei o vale dos
          Tabernáculos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Não fostes Vós, ó Deus, que nos repelistes? * Não vireis Vós, ó Deus, com os nossos
          exércitos?
        </Typography>
        <Typography className="latin">
