  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Nem o preço da redenção de sua alma: * estará eternamente em labores e viverá, não
          obstante, até ao fim.
        </Typography>
        <Typography className="latin">
          Non vidébit intéritum, cum víderit sapiéntes moriéntes: * simul insípiens, et stultus
          períbunt.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Deixarão aos estranhos as suas riquezas: * e os seus sepulcros serão para sempre as suas
          habitações.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Et homo, cum in honóre esset, non intelléxit: * comparátus est juméntis insipiéntibus, et
          símilis factus est illis.
        </Typography>
        <Typography className="vernacular">
          O homem, em honra constituído, não entendeu: * foi comparado a bestas irracionais e como
          eles se tornou.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Et dominabúntur eórum justi in matutíno: * et auxílium eórum veteráscet in inférno a
          glória eórum.
        </Typography>
        <Typography className="vernacular">
          Os justos terão domínio sobre eles na manhã: * e da sua glória, o auxílio que tiveram será
        ...
        <Typography className="latin">
          Ne timúeris, cum spanes factus fúerit homo: * et cum multiplicáta fúerit glória domus
          ejus.
        </Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Pois, enquanto vive, será louvada a sua alma: * ele bendizer-Vos-á quando bem lhe
          fizerdes.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Homo, cum in honóre esset, non intelléxit: * comparátus est juméntis insipiéntibus, et
          símilis factus est illis.
        </Typography>
        <Typography className="vernacular">
          O homem, constituído em honra, não entendeu: * foi comparado a bestas irracionais e
          tornou-se semelhante a elas.
        </Typography>
      </Language>
    </PageWrapper>
  );
