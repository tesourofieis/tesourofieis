  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Não, por minha iniquidade ou por pecado meu, ó Senhor: * sem iniquidade segui e ordenei os
          meus passos.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Levantai-Vos em meu encontro e considerai: * e Vós, Senhor, Deus dos exércitos, Deus de
          Israel,
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Cuidai de visitar todas as gentes: * não useis de piedade com todos os que obram
          iniquidade.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Fortitúdinem meam ad Te custódiam, quia, Deus, suscéptor meus es: * Deus meus,
          misericórdia ejus prævéniet me.
        </Typography>
        <Typography className="vernacular">
          Depositarei em Vós a minha fortaleza, pois, ó Deus, sois o meu defensor: * a misericórdia
          do meu Deus antecipar-se-á.
        </Typography>
        <Typography className="latin">
          Deus osténdet mihi super inimícos meos, ne occídas eos: * nequándo obliviscántur pópuli
          mei.
        </Typography>
        <Typography className="vernacular">
          Deus dar-me-á a ver sobre os meus inimigos, não os mateis: * para que se não esqueça o meu
          povo.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Pelo pecado da sua boca, pelas palavras dos seus lábios: * e fiquem presos na sua mesma
          soberba.
        </Typography>
        <Typography className="latin">
          Et de exsecratióne et mendácio annuntiabúntur in consummatióne: * in ira consummatiónis,
          et non erunt.
        </Typography>
        <Typography className="vernacular">
          Publicar-se-ão as suas execrações e mentiras na consumação: * serão convencidos pela vossa
          ira e não subsistirão mais.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Eu, porém, cantarei a vossa fortaleza: * e celebrarei com alegria desde manhã a vossa
          misericórdia.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Vos cantarei, protector meu, pois, ó Deus, sois o meu defensor: * Deus meu, misericórdia
          minha.
        </Typography>
      </Language>
    </PageWrapper>
