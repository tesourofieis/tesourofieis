  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Dos confins da terra clamei a Vós: * quando o meu coração estava angustiado, numa rocha me
          erguestes.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          Quóniam Tu, Deus meus, exaudísti oratiónem meam: * dedísti hereditátem timéntibus nomen
          tuum.
        </Typography>
        <Typography className="vernacular">
          Porque Vós, Deus meu, ouvistes a minha oração: * destes uma herança aos que temem o vosso
          nome.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Ele permanece eternamente na presença de Deus: * quem buscará a sua misericórdia e
          verdade?
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          Assim cantarei um salmo ao vosso nome pelos séculos dos séculos: * para cumprir sem cessar
          os meus votos.
        </Typography>
      </Language>
    </PageWrapper>
