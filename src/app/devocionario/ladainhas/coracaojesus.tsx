  ...
  return (
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="latin">Fili, Redémptor mundi, Deus, miserére nobis.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">Sancta Trínitas, unus Deus, miserére nobis.</Typography>
        <Typography className="vernacular">
          Santíssima Trindade, que sois um só Deus, tende piedade de nós.
        </Typography>
        <Typography className="latin">Cor Jesu, Filii Patris æterni, miserére nobis.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">Cor Jesu, maiestatis infinitæ, miserére nobis.</Typography>
        <Typography className="vernacular">
          Coração de Jesus, majestade infinita, tende piedade de nós.
        </Typography>
        <Typography className="latin">Cor Jesu, templum Dei sanctum, miserére nobis.</Typography>
        <Typography className="vernacular">
          Coração de Jesus, templo santo de Deus, tende piedade de nós.
        </Typography>
        <Typography className="latin">Cor Jesu, tabernaculum Altissimi, miserére nobis.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">Cor Jesu, omni laude dignissimum, miserére nobis.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="vernacular">
          Coração de Jesus, no qual estão todos os tesouros da sabedoria e ciência, tende piedade de
          nós.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">Cor Jesu, saturatum opprobriis, miserére nobis.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">Cor Jesu, lancea perforatum, miserére nobis.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">Cor Jesu, victima peccatorum, miserére nobis.</Typography>
        <Typography className="vernacular">
          Coração de Jesus, vítima dos pecadores, tende piedade de nós.
        </Typography>
        <Typography className="latin">Cor Jesu, salus in te sperantium, miserére nobis.</Typography>
        <Typography className="vernacular">
          Coração de Jesus, salvação dos que em vós esperam, tende piedade de nós.
        </Typography>
        <Typography className="latin">Cor Jesu, spes in te morientium, miserére nobis.</Typography>
        <Typography className="vernacular">
        ...
        <Typography className="latin">
          ...
          petentibus, tu veniam concede placatus in nomine ejusdem Filii tui Jesu Christi: Qui tecum
          vivit et regnat in sæcula sæculorum. Amen.
        </Typography>
        <Typography className="vernacular">
          Deus Omnipotente e Eterno, olhai o Coração do vosso dilectíssimo Filho e os louvores e
          reparações que pelos pecadores vos tem tributado; e aos que invocam vossa misericórdia,
          vós, aplacado, sede fácil no perdão, pelo mesmo Jesus Cristo que Convosco vive e reina
          para sempre, na unidade do Espírito Santo. Amen.
        </Typography>
      </Language>
    </PageWrapper>
  );
