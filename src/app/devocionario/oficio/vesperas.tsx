  ...
  return (
    <PageWrapper>
      ...
      <Typography className="aside">
        Meditemos na descida da cruz, o corpo de Jesus Cristo colocado nos braços de sua santa Mãe e
        na instituição do adorável Sacramento da Eucaristia.
      </Typography>
      ...
      <Tabs>
        <TabItem label="Depois da Purificação">
          <Language>
            ...
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Dum esset Rex in acubitu suo, nardus
              mea dedit odorem suavitatis.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Estando o Rei no seu repouso,
              exalou o meu frasco um suavíssimo cheiro.
            </Typography>
          </Language>
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Læva ejus sub capite meo, et dextera
              ilius amplexabitur me.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Sua mão esquerda estará debaixo
              de minha cabeça, e a sua direita me dará um abraço.
            </Typography>
          </Language>
          ...
          <Language>
            <Typography className="latin">
              ...
              Jerusalem; ideo dilexit me rex, et introduxit me in cubiculom suum.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Sou negra, mas sou formosa, ó
              filhas de Jerusalém; por isso o Rei me amou, e me levou a seu aposento.
            </Typography>
          </Language>
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Jam hiems transiit, imber abiit et
              recessit: surge, amica mea, et veni.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Já se foi o Inverno, e passou o
              chuveiro; levanta-te e vem, ó minha amada.
            </Typography>
          </Language>
          ...
          <Language>
            ...
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Especiosa sois, e suave nas
              vossas delicias, ó santa Mãe de Deus.
            </Typography>
          </Language>
          ...
          <Language>
            ...
            <Typography className="vernacular">
              Eu fui criada desde o princípio, antes dos séculos, e não deixarei de existir até ao
              fim dos séculos, e exerci diante dele o meu ministério na morada santa.
            </Typography>
            <Typography className="latin">
          ...
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Beata Mater et intacta Virgo, gloriosa
              Regina mundi, intercede pro nobis ad Dominum.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Santa Mãe e Virgem intacta,
              gloriosa Rainha do mundo, intercedei a Deus por nós.
            </Typography>
            <Typography className="latin">
          ...
          <Language>
            ...
            <Typography className="latin">
              Concede nos famulos tuos, quǽsumus, Domine Deus, perpetua mentis et corporis sanitate
              gaudere: et gloriosa beatæ Mariæ semper Virginis intercessione, a præsenti liberari
              tristitia, et æterna perfrui lætitia. Per Dominum nostrum Jesum Christum.
            </Typography>
            <Typography className="vernacular">
              Senhor Deus, nós Vos suplicamos que concedais a vossos servos lograr uma perpétua
              saúde de corpo e alma, e que pela intercessão gloriosa da bem-aventurada sempre Virgem
              Maria sejamos livres da presente tristeza, e gozemos da eterna alegria. Por Jesus
              Cristo nosso Senhor.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Amen.
        ...
        <TabItem label="No Advento">
          ...
          <Language>
            ...
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>A graça derramou-se nos vossos
              lábios.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Propterea benedixit te Deus in
              æternum.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Por isso vos abençoou Deus para
              sempre.
            </Typography>
            <Typography className="latin">
        ...
        <TabItem label="No Natal">
          ...
          <Language>
            ...
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Magnum hæreditatis mysterium: templum
              Dei factus est uterus nescientis virum: non est pollutus ex ea carnem assumens; omnes
              gentes venient, dicentes: Gloria tibi, Domine.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> Grande mystério de herança: o
          ...
          <Language>
            <Typography className="latin">
              ...
              <Typography className="vernacular">
                Magnum hæreditatis mysterium: templum Dei factus est uterus nescientis virum: non
                est pollutus ex ea carnem assumens; omnes gentes venient, dicentes: Gloria tibi,
                Domine.
              </Typography>
            </Typography>
            <Typography className="vernacular">
              ...
              <Typography className="vernacular">
                Grande mystério de herança: o ventre daquela que não conheceu varão, é feito templo
                de Deus; o qual se não manchou, tomando dela carne humana. Virão todas as gentes,
