  ...
  return (
    <PageWrapper>
      ...
      <Typography className="aside">
        Meditemos na flagelação, na coroação de espinhos e na condenação à morte. Podemos ainda
        meditar na descida do Espírito Santo, que se deu nesta mesma hora.
      </Typography>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          <Typography className="vernacular">Ant.</Typography> A Virgem Maria foi exaltada ao tálamo
          celeste, onde o Rei dos reis está sentado num trono de estrelas.
        </Typography>
      </Language>
      ...
      <Tabs>
        <TabItem label="Depois da Purificação">
          ...
          <Language>
            ...
            <Typography className="latin">
              Deus, qui salutis aeternae, beatae Mariae virginitate fecunda, humano generi praemia
              praestitisti: tribue, quaesumus; ut ipsam pro nobis intercedere sentiamus, per quam
              meruimus auctorem vitae suscipere, Dominum nostrum Jesum Christum Filium tuum: Qui
              tecum vivit et regnat...
            </Typography>
            <Typography className="vernacular">
              Ó Deus, que pela virgindade fecunda da B. Maria, participastes ao género humano os
              prémios da salvação eterna: concedei-nos, Vos rogamos, que experimentemos quanto é
              poderosa a nosso favor a intercessão daquela Virgem, pela qual merecemos receber o
              autor da vida nosso Senhor Jesus Cristo, Filho vosso: que convosco Vive e reina...
            </Typography>
            <Typography className="latin">
