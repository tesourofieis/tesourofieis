  ...
  return (
    <PageWrapper>
      ...
      <Typography className="aside">
        Meditemos em Jesus morrendo na cruz, na agitação da natureza neste momento, na destruição do
        reino de Satanás, e na Igreja nascendo do lado aberto do seu Divino Esposo preso à Santa
        Cruz.
      </Typography>
      ...
      <Tabs>
        <TabItem label="Depois da Purificação">
          ...
          <Language>
            ...
            <Typography className="vernacular">
              Assim como o cinamomo e o bálsamo, que difundem cheiro, dei eu fragrância: como a
              mirra escolhida, dei cheiro de suavidade.
            </Typography>
            <Typography className="latin">
          ...
          <Language>
            ...
            <Typography className="latin">
              Famulorum tuorum, quaesumus, Domine, delictis ignosce: ut qui tibi placere de actibus
              nostris non valemus, Genitricis Filii tui Domini nostri intercessione salvemur: Qui
              tecum vivit et regnat...
            </Typography>
            <Typography className="vernacular">
              Perdoai, Senhor, como Vos pedimos, os delictos dos vossos servos; para que não podendo
              agradar-Vos com as nossas obras, sejamos salvos, pela intercessão da Virgem Mãe de
              vosso Filhos e Senhor nosso: Que convosco vive e reina...
            </Typography>
            <Typography className="latin">
        ...
        <TabItem label="No Advento">
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Ecce ancilla Domini: fiat mihi
        ...
        <TabItem label="No Natal">
          ...
          <Language>
            <Typography className="latin">
              In plateis sicut cinnamomum et balsamum aromatizans odorem dedi: quasi myrrha electa,
              dedi suavitatem odoris.
            </Typography>
            <Typography className="vernacular">
              Nas praças assim como o cinamomo e o bálsamo, que difundem cheiro, dei eu fragrância;
              como a mirra, dei cheiro de suavidade.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Deo grátias.
            </Typography>
