  ...
  return (
    <PageWrapper>
      ...
      <Typography className="aside">
        Meditemos nos ultrajes, sofrimentos e açoites, suportados por Jesus Cristo em casa de
        Caifás. Igualmente na aparição à Santa Virgem após a ressurreição e na visita das santas
        mulheres ao sepulcro.
      </Typography>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          <Typography className="vernacular">Ant.</Typography> Maria foi exaltada ao céu; os anjos
          se alegram, louvam, e glorificam o Senhor.
        </Typography>
      </Language>
      ...
      <Tabs>
        <TabItem label="Depois da Purificação">
          ...
          <Language>
            ...
            <Typography className="vernacular">
              Quem é esta que aparece como a aurora quando desponta, formosa como a lua, eleita,
              como o sol, terrível como um exército formado em linha?
            </Typography>
            <Typography className="latin">
            ...
            <Typography className="latin">
              <Typography className="versicle"> ℣. </Typography>Dignare me laudare te, Virgo
              sacrata.
            </Typography>
            <Typography className="vernacular">
              <Typography className="versicle"> ℣. </Typography>Dignai-vos, sagrada Virgem, de que
              eu vos louve.
            </Typography>
            <Typography className="latin">
              <Typography className="response"> ℟. </Typography> Da mihi virtutem contra hostes
              tuos.
            </Typography>
            <Typography className="vernacular">
              <Typography className="response"> ℟. </Typography> Dai-me esforço contra vossos
              inimigos.
            </Typography>
          </Language>
          ...
          <Language>
            ...
            <Typography className="latin">
              Deus, qui virginalem aulam beatae Mariae in qua habitares, eligere dignatus es: da,
              quaesumus, ut sua nos defensione munitos; jucundos facias suae interesse
              commemorationi. Qui vivis et regnas...
            </Typography>
            <Typography className="vernacular">
              Ó Deus, que Vos dignastes eleger puríssimas entranhas da bem-aventurada Virgem Maria
              para vossa morada: concedei-nos que com o presente culto, que alegres lhe tributamos,
              nos façamos beneméritos do seu patrocínio. Vós que viveis e reinais...
            </Typography>
            <Typography className="latin">
        ...
        <TabItem label="No Advento">
          <Language>
            <Typography className="latin">
              <Typography className="latin">Ant.</Typography> Missus est Gabriel Angelus ad Maríam,
              Vírginem, desponsatam Joseph.
            </Typography>
            <Typography className="vernacular">
              <Typography className="vernacular">Ant.</Typography> O Anjo Gabriel foi enviado a
              Maria Virgem, desposada com José.
            </Typography>
          </Language>
