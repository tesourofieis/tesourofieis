...
export default function PagePentepi30() {
  return (
    <PageWrapper>
      <H1 text="Terceiro Domingo depois da Epifania" />
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Ó Deus omnipotente e eterno, olhai benigno para a nossa fraqueza e estendei-nos a dextra
          da vossa majestade para nos proteger continuamente. Por nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          vós próprios, caríssimos, mas deixai a justiça de Deus, pois está escrito: «A vingança
          pertence-me; Eu é que a exercerei, diz o Senhor». Se o vosso inimigo tem fome, dai-lhe de
          comer; se tem sede, dai-lhe de beber; pois, se assim procederdes, reunireis brasas de fogo
          sobre a sua cabeça. Não vos deixeis vencer pelo mal; mas triunfai do mal, praticando o
          bem.
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Naquele tempo, descendo Jesus do monte, era acompanhado por numerosas pessoas. Eis que foi
          ter com Ele um leproso, adorando-O e dizendo-Lhe: «Senhor, se quiserdes, podeis curar-me».
          Então Jesus, estendendo a mão, tocou-o e disse: «Quero; sê curado». E no mesmo instante
          ficou limpo da lepra. E Jesus disse-lhe: «Ouve: não digas nada a ninguém; mas vai,
          mostra-te aos sacerdotes e oferece-lhes a dádiva que Moisés prescreveu, a fim de que ela
          seja testemunha da tua cura». E entrando Jesus em Cafarnaum, aproximou-se d’Ele um
          centurião, pedindo e dizendo: «Senhor, o meu servo está na cama paralítico e sofre
          cruelmente». E Jesus disse-lhe: «Eu irei e o curarei». Mas o centurião respondeu-Lhe:
          «Senhor, não sou digno de que entreis sob o meu telhado; dizei somente uma palavra e o meu
          servo será curado. Pois eu, que sou um homem submisso à autoridade dos meus superiores,
          tenho soldados sob as minhas ordens e digo a um deles: Vai. E ele vai. E digo a um outro:
          Vem, E ele vem. E digo a meu servo: Faz isto. E ele faz». Ouvindo Jesus isto, mostrou-se
          admirado, e disse: «Em verdade vos digo, que não encontrei, ainda, uma fé tão grande em
          Israel! Assim vos digo: que muitos virão do Oriente e do Ocidente e terão lugar no
          banquete com Abraão, Isaque e Jacob no reino dos céus; mas os filhos do reino serão
          lançados nas trevas exteriores, onde haverá choro e ranger de dentes». Então Jesus disse
          ao centurião: «Vai; e que se faça segundo a tua crença». E naquela hora ficou curado o
          servo.
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          tornai-nos dignos, Vos suplicamos, de receberdes com eficácia os seus efeitos. Por nosso
          Senhor...
        </Typography>
      </Language>
    </PageWrapper>
