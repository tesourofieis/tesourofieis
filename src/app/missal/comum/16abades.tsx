    ...
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">
          ...
          ipsíus. (T. P. Allelúja allelúja.) <Typography className="latin">Ps. ibid., 1</Typography>{" "}
      ...
      <Language>
        <Typography className="latin">
          Intercéssio nos, quǽsumus, Dómine, beáti <Typography className="latin">N.</Typography>{" "}
          Abbátis comméndet: ut, quod nostris méritis non valémus, ejus patrocínio assequámur. Per
          Dóminum nostrum...
        </Typography>
        <Typography className="vernacular">
          Que a intercessão do B. Abade <Typography className="vernacular">N.</Typography> nos
          favoreça junto de Vós, Senhor, Vos suplicamos, a fim de que aquilo que não podemos
          conseguir com os nossos méritos o alcancemos com seu patrocínio. Por nosso Senhor...
        </Typography>
      </Language>

      <H3 text="Epístola" />

      <Typography className="em">Ecl. 45, 1-6</Typography>
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          placávit. Gloríficávit illum in conspéctu regum, et jussit illi coram pópulo suo, et
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          coroa de pedras preciosas. Concedestes-lhe a vida, que Vos suplicara, e prolongastes-lhe a
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          quid ergo erit nobis? Jesus autem dixit illis: Amen, dico vobis, quod vos, qui secuti
        ...
        <Typography className="vernacular">
          ...
          no tempo da regeneração, o Filho do homem se sentar no trono da sua glória, também vos
          sentareis sobre doze tronos para julgar as doze tribos de Israel. Todo aquele que deixar a
          sua casa, ou os seus irmãos, ou os seus campos, ou o seu pai, ou a sua mãe, ou a sua
      ...
      <Language>
        <Typography className="latin">
          Desidérium ánimæ ejus tribuísti ei, Dómine, et voluntáte labiórum ejus non fraudásti eum:
          posuísti in cápite ejus corónam de lápide pretióso. (T. P. Allelúja.)
        </Typography>
        <Typography className="vernacular">
          Concedestes-lhe o desejo da sua alma e não desprezastes a prece dos seus lábios.
          Impusestes na sua cabeça uma coroa de pedras preciosas. (T. P. Aleluia).
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">N.</Typography> Abbas, quǽsumus, in salútem nobis proveníre
          depóscat. Per Dóminum...
        </Typography>
        <Typography className="vernacular">
          Vos imploramos, Senhor, que o vosso santo Abade{" "}
          <Typography className="vernacular">N.</Typography> nos alcance que a hóstia, oferecida no
          vosso altar, nos proporcione a salvação. Por nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          família a sua medida de trigo. (T. P. Aleluia.)
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          ...
          conversatiónis ejus experiámur insígnia, et intercessiónis percipiámus suffrágia. Per
          Dóminum nostrum...
        </Typography>
        <Typography className="vernacular">
          Que a recepção do vosso sacramento, Senhor, unida às preces do B.{" "}
          <Typography className="vernacular">N.</Typography> Abade, nos sirva de protecção, a fim de
