    ...
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">
          Da nobis, quǽsumus, Dómine, Deus noster, sanctárum Vírginum et Mártyrum tuárum{" "}
        ...
        <Typography className="vernacular">
          ...
          devoção a vitória das vossas santas Virgens e Mártires{" "}
          ...
          celebrar dignamente os seus méritos, ao menos possamos oferecer-lhes as nossas humildes
      ...
      <Language>
        <Typography className="latin">
          Inténde, quǽsumus, Dómine, múnera altáribus tuis pro sanctárum Vírginum et Mártyrum tuárum{" "}
          <Typography className="latin">N.</Typography> et{" "}
        ...
        <Typography className="vernacular">
          ...
          altares para celebrar a festa das vossas santas Virgens e Mártires{" "}
          <Typography className="vernacular">N.</Typography> e{" "}
      ...
      <Language>
        ...
        <Typography className="vernacular">
          ...
          <Typography className="text-red-500">N.</Typography>, guardemos com o coração puro o que
