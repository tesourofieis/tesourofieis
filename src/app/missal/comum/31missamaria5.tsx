    ...
    <PageWrapper>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Bendita e venerável sois, ó Virgem Maria, que fostes Mãe do Salvador, sem que a vossa
          pureza sofresse a mais leve ofensa.
          <Typography className="versicle"> ℣. </Typography>Ó Virgem, Mãe de Deus, Aquele que nem
          todo o universo é capaz de conter, quando se fez homem, esteve encerrado no vosso seio.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="vernacular">
          ...
          Depois de haverdes dado à luz, permanecestes Virgem imaculada: Intercedei por nós, ó Mãe
          de Deus. Aleluia.
        </Typography>
      </Language>
