  ...
  return (
    <PageWrapper>
      ...
      <Typography className="comment">
        ...
        desembaraçar-se dos negócios do século, para agradar somente Aquele a
        quem se entregou (Ep., Off.). O Espírito do Senhor está sobre ele,
        consagra-o e envia-o a pregar o Evangelho aos pobres (Intr.). Foi
        enviado pelo alto a fim de conduzir o povo à penitência (All.). Funda,
        para esse fim, a Congregação do Santíssimo Redemptor (Or.) e, a exemplo
        do Salvador, manda os seus membros aos campos, ás aldeias e vilas a
        anunciar o reino de Deus (Ev.). Obrigou-se por voto a nunca perder um
        momento e jamais cometeu pecado mortal no curso de toda a sua vida.
        Escreveu obras cheias de erudição sagrada e piedade, que lhe valeram o
        título de Doutor da Igreja. Fazendo sobressair a importância da oração
        no plano divino, condensa todo o seu tratado sobre a graça, nesta frase:
        Quem reza, salva-se; quem não reza, condena-se. Santo Afonso teve de
        aceitar o bispado de Santa Águeda dos Godos, perto de Nápoles. Morreu na
        idade de 91 anos, em 1787. O Papa beneditino Pio VII ordenou que
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          Nemo mílitans Deo ímplicat se negótiis sæculáribus: ut ei pláceat, cui
          se probávit. Nam et qui certat in agóne, non coronátur, nisi legítime
        ...
        <Typography className="vernacular">
          ...
          instruir outros. Trabalhai como bom soldado de Jesus Cristo. Aquele
          que se alista no serviço de Deus nunca se embaraça com os negócios do
          mundo, mas deve procurar agradar Àquele a quem se entregou. Aquele que
          combate nos jogos públicos não será coroado se não tiver combatido
