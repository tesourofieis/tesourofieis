  ...
  return (
    <PageWrapper>
      ...
      <Typography className="comment">
        Na Palestina: nascimento para o céu de Santo Agapito, que, tendo apenas quinze annos, foi
        morto em Preneste (Itália) com uma estocada, que lhe alcançou a corôa da imortalidade (275).
      </Typography>
      ...
      <Language>
        <Typography className="latin">
          Lætétur Ecclésia tua, Deus, beáti Agápiti Mártyris tui confísa suffrágiis: atque, ejus
          précibus gloriósis, et devóta permáneat et secúra consístat. Per Dóminum...
        </Typography>
        <Typography className="vernacular">
          Que a vossa Igreja, ó Deus, rejubile com a confiança que lhe dão os sufrágios do B.
          Agapito, vosso Mártir, e que pelas suas gloriosas preces persevere na piedade e se
          conserve na paz. Por nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="latin">
          ...
          fructum affert. Qui amat ánimam suam, perdet earn: et qui odit ánimam suam in hoc mundo,
          in vitam ætérnam custódit earn. Si quis mihi minístrat, me sequátur: et ubi sum ego, illic
          et minister meus erit. Si quis mihi ministráverit, honorificábit eum Pater meus.
        </Typography>
        <Typography className="vernacular">
      ...
      <Language>
        <Typography className="latin">
          ...
          patrocínio liberári. Per Dóminum...
        </Typography>
        <Typography className="vernacular">
          Recebei, Senhor, as ofertas que Vos apresentamos na festa daquele por cuja protecção
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Saciastes, Senhor, a vossa família com os sacrossantos dons; e, Vos suplicamos,
          fortalecei-a sempre pela intercessão daquele cuja festa celebramos. Por nosso Senhor...
        </Typography>
      </Language>
    </PageWrapper>
  );
