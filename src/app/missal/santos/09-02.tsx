  ...
  return (
    <PageWrapper>
      ...
      <Typography className="comment">
        Descendente dos orgulhosos e terríveis invasores, conhecidos pelo nome de Hunos, Estevão foi
        escolhido por Deus, para unir seus súbditos a Cristo e ao seu vigário. O nome de Estevão lhe
        foi dado no baptismo porque sua mãe tivera uma visão do Mártir Santo Estevão, predizendo-lhe
        que havia de converter a Hungria, sendo o seu primeiro rei, após a erecção do pais em reino,
        pelo Papa. Casando-se com a irmã do imperador Santo Henrique, cercou-se, para governar o seu
        reino, de homens de santidade e prudência comprovadas. Passava noites inteiras na
        contemplação das coisas do céu (Intr.), praticando as maiores austeridades, e, auxiliado
        pela rainha, sua piedosa esposa, dava grandes esmolas (Ep.) às viúvas, aos órfãos e às
        igrejas. Com justa razão, a grandeza de seu zelo pela extensão da fé lhe mereceu o titulo de
        Rei apostólico ou de Apostolo da Hungria, recebendo da Santa Sé o privilégio, transmitido
        também aos seus sucessores, de fazer levar a cruz diante de si. Fez construir uma grande
        basílica em honra de Maria, instituindo-a Padroeira da Hungria - seu zelo em propagar e
        fortalecer a fé no pais lhe valeu a glória da realeza celeste (Postcomm.). Morreu em 1038 no
        dia da - Grande Senhora - denominação que, em virtude dum édito do Santo rei, os Húngaros
        dão à festa da Assunção.
      </Typography>
      ...
      <Language>
        <Typography className="latin">
          Concéde, quǽsumus, Ecclésiæ tuæ, omnípotens Deus: ut beátum Stéphanum Confessórem tuum,
          quem regnántem in terris propagatórem hábuit, propugnatórem habére mereátur gloriósum in
          cœlis. Per Dóminum...
        </Typography>
        <Typography className="vernacular">
          Concedei à vossa Igreja, Vos imploramos, ó Deus omnipotente, que o B. Estêvão, vosso
          Confessor, que ela possuiu como seu propagador enquanto reinou na terra, seja agora seu
          defensor na glória dos céus. Por nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          Réspice, quas offérimus, hóstias, omnípotens Deus: et præsta; ut, qui passiónis Dominicae
          mystéria celebrámus, imitémur quod ágimus. Per eúndem Dóminum...
        </Typography>
        <Typography className="vernacular">
          Ó Deus omnipotente, dignai-Vos olhar para estas hóstias, que Vos oferecemos, e permiti
          que, celebrando nós os mystérios da Paixão do Senhor, imitemos o que Vos apresentamos. Por
          nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          Præsta, quǽsumus, omnípotens Deus: ut beáti Stephani Confessóris tui fidem cóngrua
          devotióne sectémur; qui, pro ejúsdem fídei dilatatióne, de terréno regno ad cœléstis regni
          glóriam méruit perveníre. Per Dóminum nostrum...
        </Typography>
        <Typography className="vernacular">
          Concedei-nos, Vos rogamos, ó Deus omnipotente, a graça de imitarmos com a devida devoção
          os exemplos de fé do B. Estêvão, vosso Confessor, o qual pela propagação desta mesma fé
          mereceu transitar da realeza terrestre para a glória do reino celestial. Por nosso
          Senhor...
        </Typography>
      </Language>
    </PageWrapper>
