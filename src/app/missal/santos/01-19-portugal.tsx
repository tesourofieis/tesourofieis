    ...
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">
          Deus, qui beáti Gundisálvi Confessóris tui mentem sancti nóminis tui amóre mirabíliter
          inflammásti: concéde, quæsumus; ut illius vestígiis inhæréntes, semper te cogitémus,
          quæque tibi grata sunt, inflammáto stúdio faciámus. Per Dóminum...
        </Typography>
        <Typography className="vernacular">
          Ó Deus, que maravilhosamente abrasastes no amor ao vosso nome a alma do B. Gonçalo, vosso
          Confessor, dignai-Vos conceder-nos que, seguindo os seus vestígios, pensemos sempre em Vós
          e com fervorosa solicitude façamos o que Vos seja agradável. Por nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          Exáudi, Dómine, pópulum tuum cum Sanctórum tuórum patrocínio supplicántem: ut et
          temporális vitæ nos tríbuas pace gaudére; et ætérnæ reperíre subsídium. Per Dóminum...
        </Typography>
        <Typography className="vernacular">
          Ouvi, Senhor, as súplicas que o vosso povo Vos dirige sob o patrocínio dos vossos Santos;
          e dignai-Vos permitir que gozemos a vossa paz na vida presente e alcancemos o vosso
          auxílio na vida eterna...
        </Typography>
      </Language>
      ...
      <Language>
        <Typography className="latin">
          ...
          <Typography className="latin">ibid., 5</Typography> Vitam pétiit a te: et tribuísti ei
          longitúdinem diérum in sæculum sæculi.
        </Typography>
        <Typography className="vernacular">
          Concedestes-lhe, Senhor, bênçãos escolhidas, as mais suaves, e impusestes na sua cabeça
          uma coroa de pedras preciosas.
          <Typography className="versicle"> ℣. </Typography>
          <Typography className="vernacular">ibid., 5</Typography> Concedestes-lhe a vida que Vos
          suplicou e prolongastes-lhe a duração dos seus dias pelos séculos dos séculos.
        </Typography>
        <Typography className="latin">
          Allelúja, allelúja. Lætábitur justus in Dómino, et sperábit in eo: et laudabúntur omnes
          recti corde. Allelúja.
        </Typography>
        <Typography className="vernacular">
          Aleluia, aleluia. O justo alegrar-se-á no Senhor e n’Ele porá suas esperanças; e todos
          aqueles cujo coração é recto serão glorificados. Aleluia.
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Atendei, Senhor, ás preces e ás oblatas dos vossos fiéis, a fim de que Vos sejam
          agradáveis nesta festa dos vossos Santos e nos alcancem o auxílio da vossa bondade. Por
          nosso Senhor...
        </Typography>
      </Language>
      ...
      <Language>
        ...
        <Typography className="vernacular">
          Deixai-Vos aplacar, Senhor, pela intercessão dos vossos Santos; e permiti, Vos rogamos,
          que estes sacrifícios, que aogra celebrámos, nos sirvam de auxílio para a salvação eterna.
          Por nosso Senhor...
        </Typography>
      </Language>
