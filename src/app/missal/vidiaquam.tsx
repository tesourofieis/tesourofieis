    ...
    <PageWrapper>
      ...
      <Language>
        <Typography className="latin">
          Vidi aquam egrediéntem de templo a látere dextro, allelúja: et omnes ad quos pervénit aqua
          ista salvi facti sunt et dicent: allelúja, allelúja.
        </Typography>
        <Typography className="vernacular">
          Vi a água que saía do lado direito do Templo, aleluia: e todos aqueles em quem esta água
          tocou foram salvos; e dirão: aleluia, aleluia.
        </Typography>
        <Typography className="latin">
        ...
        <Typography className="latin">
          <Typography className="response"> ℟. </Typography> Et salutáre tuum da nobis. Allelúja.
        </Typography>
        <Typography className="vernacular">
